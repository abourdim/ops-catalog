...
const LANG={en:{title:'Stylometry Defeater',subtitle:'Writing style anonymization',disconnected:'Idle',connected:'Transforming',ready:'Stylometry Defeater ready!',logCleared:'Log cleared',copied:'Copied!',copyFail:'Copy failed',splashHint:'tap to skip',langChanged:'Language → English',themeChanged:'Theme →',simStarted:'Transform started',simStopped:'Transform stopped',t_mosque:'Mosque',t_zellige:'Zellige',t_andalus:'Andalus',t_riad:'Riad',t_medina:'Medina',t_space:'Space',t_jungle:'Jungle',t_robot:'Robot'},fr:{title:'Anti-Stylometrie',subtitle:'Anonymisation du style',disconnected:'Inactif',connected:'Transformation',ready:'Pret!',logCleared:'Efface',copied:'Copie!',copyFail:'Echec',splashHint:'appuyer',langChanged:'Langue → Francais',themeChanged:'Theme →',simStarted:'Demarre',simStopped:'Arrete',t_mosque:'Mosquee',t_zellige:'Zellige',t_andalus:'Andalous',t_riad:'Riad',t_medina:'Medina',t_space:'Espace',t_jungle:'Jungle',t_robot:'Robot'},ar:{title:'مضاد القياسات الأسلوبية',subtitle:'إخفاء هوية أسلوب الكتابة',disconnected:'خامل',connected:'تحويل',ready:'جاهز!',logCleared:'تم المسح',copied:'تم النسخ!',copyFail:'فشل',splashHint:'انقر للتخطي',langChanged:'اللغة ← العربية',themeChanged:'المظهر ←',simStarted:'بدأ التحويل',simStopped:'توقف',t_mosque:'مسجد',t_zellige:'زليج',t_andalus:'أندلس',t_riad:'رياض',t_medina:'مدينة',t_space:'فضاء',t_jungle:'أدغال',t_robot:'روبوت'}};
let currentLang='en';
