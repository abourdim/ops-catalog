...
en:{
    ...
    gloss1_term: 'Pseudorange',
    gloss1_def: 'The estimated distance between a GPS receiver and a satellite, calculated from signal travel time. Four pseudoranges determine 3D position plus clock correction.',
    ...
    theory: 'Metadata Scrubber demonstrates key principles from escape and evasion. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Spy Network Graph',related1_desc:'Build and explore a force-directed network graph',related1_path:'../../03-spy-browser/web-network-map/index.html',related2_name:'Panic Button — Emergency Alert',related2_desc:'Broadcast emergency alerts and wipe sensitive data',related2_path:'../../01-spy-microbit/bit-panic-button/index.html',related3_name:'Photo Forensics',related3_desc:'Select a photo to extract hidden EXIF metadata',related3_path:'../../03-spy-browser/web-metadata-detective/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'esc-forensic-evidence-planter',pathPrev_path:'../../55-escape-evasion/esc-forensic-evidence-planter/index.html',pathNext_name:'esc-secure-comms-hardener',pathNext_path:'../../55-escape-evasion/esc-secure-comms-hardener/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
...
fr:{tooltipTitle:'Infobulles intelligentes',tooltipToggle:'Activer les infobulles',tip_start:'Lancer la simulation et observer la visualisation s\x27animer',tip_stop:'Mettre en pause la simulation en conservant l\x27état actuel',tip_reset:'Effacer toutes les données et revenir aux conditions initiales',tip_slider:'Glisser pour ajuster ce paramètre — la visualisation se met à jour en temps réel',tip_theme:'Basculer entre 8 thèmes visuels dont 2 thèmes clairs islamiques',tip_help:'Ouvrir le panneau d\x27aide avec FAQ, guides, wiki et défis',explorerTitle:'Explorateur d\x27espace paramétrique',explorerStart:'Auto-Explorer',explorerStop:'Arrêter l\x27exploration',explorerProgress:'Exploration des combinaisons...',explorerResult:'Exploration terminée',explorerInfo:'Teste systématiquement min/milieu/max pour chaque curseur et enregistre les résultats',title:'Nettoyeur de Metadonnees',subtitle:'Suppression EXIF et traces',disconnected:'Inactif',connected:'Nettoyage',mainSection:'Moteur de Nettoyage',mainDesc:'Suppression EXIF, GPS, auteur',sectionA:'Operations',sectionC:'Comment ca marche',start:'Demarrer',stop:'Arreter',filesScrubbed:'Fichiers',tagsRemoved:'Tags',gpsStripped:'GPS',peerTitle:'ð¥ Peer Mode',peerConnect:'Connect',peerDisconnect:'Disconnect',peerStatus:'Peer Status',peerSend:'Sent',peerReceive:'Received',peerInfo:'Open this app in two tabs to sync parameters via BroadcastChannel',heatmapTitle:'ð Activity Heatmap',heatmapToday:'Today',heatmapStreak:'Streak',heatmapTotal:'Total',heatmapLegend:'Less \u2192 More',cleanness:'Statut',howItWorksText:'Le nettoyage supprime les metadonnees identifiantes des fichiers.',activityLog:'Journal',eventsMsg:'Evenements',clear:'Effacer',copy:'Copier',export:'Exporter',filterAll:'Tout',settings:'Parametres',language:'Langue',theme:'Theme',soundEffects:'Sons',help:'Aide',faq:'FAQ',howto:'Guide',wiki:'Wiki',howto_1:'L écran principal affiche la simulation Metadata Scrubber. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Evaluate the threat environment and identify surveillance or',howto_2:'Demarrer.',howto_3:'Observer.',howto_4:'Verifier.',wiki_exif_title:'EXIF',wiki_exif:'Info camera.',wiki_gps_title:'GPS',wiki_gps:'Localisation.',wiki_privacy_title:'Confidentialite',wiki_privacy:'Local.',t_mosque:'Mosquee',t_zellige:'Zellige',t_andalus:'Andalous',t_riad:'Riad',t_medina:'Medina',t_space:'Espace',t_jungle:'Jungle',t_robot:'Robot',ready:'Pret!',logCleared:'Efface',copied:'Copie!',copyFail:'Echec',splashHint:'appuyer',working:'En cours...',langChanged:'Langue → Francais',themeChanged:'Theme →',simStarted:'Nettoyage demarre',simStopped:'Arrete',opDone:'Nettoye',step1Title:'Évaluer la situation',step1Desc:'Évalue l\'environnement de menace et identifie les méthodes de surveillance. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Choisir la technique',step2Desc:'Sélectionne la méthode d\'évasion ou de contre-surveillance appropriée. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Exécuter l\'évasion',step3Desc:'Applique la technique choisie pour éviter la détection. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Vérifier la sécurité',step4Desc:'Confirme que tu as échappé à la détection et opères en sécurité. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',sectionCode:'Code Appareil',faq_q1:'Que fait cette appli ?',faq_a1:'Metadata Scrubber est une simulation interactive qui démontre les concepts de évasion. EXIF, GPS coordinates, author & hidden tag removal. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment ça marche ?',faq_a2:'La simulation tourne dans ton navigateur. Elle modélise de vrais anti-surveillance techniques.',faq_q3:'Que dois-je essayer ?',faq_a3:'Appuie sur le bouton principal et regarde ! 🎯 Puis change les réglages pour voir l\'effet.',faq_q4:'C\'est quoi la vraie science ?',faq_a4:'C\'est du vrai counter-surveillance and privacy ! Les mêmes principes utilisés par les professionnels. 🧪',faq_q5:'Je peux le casser ?',faq_a5:'Essaie le Labo ! Pousse les paramètres à l\'extrême et observe. C\'est comme ça qu\'on découvre ! 💡',faq_q6:'Quel matériel ?',faq_a6:'Pour la version réelle, il te faut a computer with Python 3. Regarde 📦 Code Appareil !',faq_q7:'C\'est sûr ?',faq_a7:'Absolument sûr ! 🛡️ Tout tourne localement. Pas d\'internet requis.',faq_q8:'Que faire ensuite ?',faq_a8:'Essaie Esc Traffic Camouflage and Esc Anti Forensics Toolkit ! Chacune enseigne quelque chose de différent. 🚀',demo_s1:'Bienvenue ! Explorons cette simulation ensemble. Regarde la section principale. 🔬',demo_s2:'Clique sur le bouton d\'action pour démarrer. Regarde la visualisation réagir ! ⚡',demo_s3:'Change un réglage — essaie un curseur ou une liste. Tu vois le changement ? 🔄',demo_s4:'Vérifie les résultats — les graphiques montrent ce qui se passe. 📊',demo_s5:'Super ! 🎉 Tu connais les bases. Essaie le Labo pour aller plus loin !',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Counter-Surveillance',learn1Desc:'How to detect if you are being monitored',learn1Tag:'Privacy',learn2Title:'Data Protection',learn2Desc:'How to erase digital traces and protect files',learn2Tag:'Security',learn3Title:'Communication Security',learn3Desc:'How to communicate without being intercepted',learn3Tag:'COMSEC',learn4Title:'Evasion Techniques',learn4Desc:'How to avoid tracking and maintain privacy',learn4Tag:'Tradecraft',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Avancé 🔴',learnLevel:'Niveau :',learnTimeVal:'30 min ⏱',learnTime:'Durée :',learnAgeVal:'14+ 🧒',
    ...
    theory: 'Metadata Scrubber démontre les principes clés de évasion. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
...
ar:{tooltipTitle:'تلميحات ذكية',tooltipToggle:'تبديل التلميحات',tip_start:'ابدأ المحاكاة وشاهد الرسم البياني ينبض بالحياة',tip_stop:'أوقف المحاكاة مؤقتاً مع الحفاظ على الحالة الحالية',tip_reset:'امسح جميع البيانات وعد إلى الشروط الأولية',tip_slider:'اسحب لضبط هذا المعامل — يتحدث الرسم البياني في الوقت الفعلي',tip_theme:'بدّل بين 8 مظاهر مرئية منها تصميمان إسلاميان فاتحان',tip_help:'افتح لوحة المساعدة مع الأسئلة الشائعة والأدلة والويكي والتحديات',explorerTitle:'مستكشف فضاء المعاملات',explorerStart:'استكشاف تلقائي',explorerStop:'إيقاف الاستكشاف',explorerProgress:'جارٍ استكشاف التوليفات...',explorerResult:'اكتمل الاستكشاف',explorerInfo:'يختبر بشكل منهجي الحد الأدنى/الوسط/الأقصى لكل منزلق ويسجل النتائج',title:'منظف البيانات الوصفية',subtitle:'محاكاة إزالة EXIF والآثار',disconnected:'خامل',connected:'تنظيف',peerTitle:'ð¥ Mode Pair',peerConnect:'Connecter',peerDisconnect:'D\xe9connecter',peerStatus:'Statut pair',peerSend:'Envoy\xe9',peerReceive:'Re\xe7u',peerInfo:'Ouvrez cette app dans deux onglets pour synchroniser les param\xe8tres',heatmapTitle:'ð Carte d\x27activit\xe9',heatmapToday:'Aujourd\x27hui',heatmapStreak:'S\xe9rie',heatmapTotal:'Total',heatmapLegend:'Moins \u2192 Plus',mainSection:'محرك التنظيف',mainDesc:'إزالة EXIF وGPS والمؤلف',sectionA:'عمليات التنظيف',sectionC:'كيف يعمل',start:'بدء',stop:'إيقاف',filesScrubbed:'ملفات منظفة',tagsRemoved:'علامات محذوفة',gpsStripped:'GPS محذوف',cleanness:'الحالة',howItWorksText:'تنظيف البيانات الوصفية يزيل المعلومات التعريفية من الملفات.',activityLog:'سجل النشاط',eventsMsg:'الأحداث',clear:'مسح',copy:'نسخ',export:'تصدير',filterAll:'الكل',settings:'الإعدادات',language:'اللغة',theme:'المظهر',soundEffects:'مؤثرات صوتية',help:'مساعدة',faq:'أسئلة شائعة',howto:'كيف تستخدم',wiki:'ويكي',howto_1:'تعرض الشاشة الرئيسية محاكاة Metadata Scrubber. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Evaluate the threat environment and identify surveillance or',howto_2:'انقر بدء.',howto_3:'شاهد التنظيف.',howto_4:'راجع السجل.',wiki_exif_title:'EXIF',wiki_exif:'معلومات الكاميرا.',wiki_gps_title:'GPS',wiki_gps:'بيانات الموقع.',wiki_privacy_title:'الخصوصية',wiki_privacy:'كل شيء محلي.',t_mosque:'مسجد',t_zellige:'زليج',t_andalus:'أندلس',t_riad:'رياض',t_medina:'مدينة',t_space:'فضاء',t_jungle:'أدغال',t_robot:'روبوت',ready:'جاهز!',logCleared:'تم المسح',copied:'تم النسخ!',copyFail:'فشل',splashHint:'انقر للتخطي',working:'جارٍ...',langChanged:'اللغة ← العربية',themeChanged:'المظهر ←',simStarted:'بدأ التنظيف',simStopped:'توقف',opDone:'تم التنظيف',step1Title:'تقييم الوضع',step1Desc:'قيّم بيئة التهديد وحدد أساليب المراقبة أو التتبع. شاهد التصور يتحدث في الوقت الفعلي أثناء هذه المرحلة. يعرض الشاشة بالضبط ما يحدث داخلياً — كل لون وحركة يمثل تحولاً محدداً في البيانات.',step2Title:'اختيار التقنية',step2Desc:'اختر طريقة التهرب أو التمويه أو مكافحة المراقبة المناسبة. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',step3Title:'تنفيذ التهرب',step3Desc:'طبّق التقنية المختارة لتجنب الاكتشاف أو الهروب من المراقبة. تحول هذه المرحلة بيانات الإدخال باستخدام الخوارزمية المعروضة. قارن القيم قبل وبعد لفهم العلاقة الرياضية.',step4Title:'التحقق من الأمان',step4Desc:'تأكد من نجاح التهرب وأنك تعمل بشكل آمن. ناتج هذه المرحلة يغذي المرحلة التالية. حاول التوقف هنا لفحص الحالة الوسيطة.',sectionCode:'كود الجهاز',faq_q1:'ماذا يفعل هذا التطبيق؟',faq_a1:'Metadata Scrubber هي محاكاة تفاعلية توضح مفاهيم الهروب والتملص. EXIF, GPS coordinates, author & hidden tag removal. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف يعمل؟',faq_a2:'المحاكاة تعمل في متصفحك. تنمذج anti-surveillance techniques حقيقية خطوة بخطوة.',faq_q3:'ماذا أجرب أولاً؟',faq_a3:'اضغط على الزر الرئيسي وشاهد! 🎯 ثم عدّل الإعدادات لترى التأثير.',faq_q4:'ما العلم الحقيقي؟',faq_a4:'هذا counter-surveillance and privacy حقيقي! نفس المبادئ المستخدمة من المحترفين. 🧪',faq_q5:'هل يمكنني كسره؟',faq_a5:'جرب المختبر! ادفع المعلمات للحدود القصوى وشاهد. هكذا يكتشف العلماء! 💡',faq_q6:'ما العتاد المطلوب؟',faq_a6:'للنسخة الحقيقية تحتاج a computer with Python 3. تفقد 📦 كود الجهاز!',faq_q7:'هل هو آمن؟',faq_a7:'آمن تماماً! 🛡️ كل شيء يعمل محلياً. لا حاجة للإنترنت.',faq_q8:'ماذا بعد؟',faq_a8:'جرب Esc Traffic Camouflage and Esc Anti Forensics Toolkit! كل واحد يعلّم شيئاً مختلفاً. 🚀',demo_s1:'مرحباً! لنستكشف هذه المحاكاة معاً. انظر إلى القسم الرئيسي أعلاه. 🔬',demo_s2:'اضغط زر الإجراء الرئيسي للبدء. شاهد التصور يستجيب! ⚡. تفاعل مع عناصر التحكم. كل زر ومنزلق يغير معاملاً محدداً. راقب كيف يستجيب التصور فوراً — هذه العلاقة بين السبب والنتيجة أساسية.',demo_s3:'غيّر إعداداً — جرب شريط تمرير أو قائمة منسدلة. هل ترى التغيير؟ 🔄',demo_s4:'تحقق من النتائج — الرسوم البيانية تُظهر ما يحدث. 📊',demo_s5:'رائع! 🎉 أنت تعرف الأساسيات. جرب المختبر للتعمق أكثر!',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'Counter-Surveillance',learn1Desc:'How to detect if you are being monitored',learn1Tag:'Privacy',learn2Title:'Data Protection',learn2Desc:'How to erase digital traces and protect files',learn2Tag:'Security',learn3Title:'Communication Security',learn3Desc:'How to communicate without being intercepted',learn3Tag:'COMSEC',learn4Title:'Evasion Techniques',learn4Desc:'How to avoid tracking and maintain privacy',learn4Tag:'Tradecraft',sectionLearn:'ماذا ستتعلم',learnLevelVal:'متقدم 🔴',learnLevel:'المستوى:',learnTimeVal:'30 min ⏱',learnTime:'المدة:',learnAgeVal:'14+ 🧒',
    ...
    theory: 'Metadata Scrubber يوضح المبادئ الأساسية في الهروب والتملص. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
