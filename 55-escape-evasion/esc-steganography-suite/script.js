/* Steganography Suite — Hidden data in media simulation — Workshop DIY v1.2 */
...
const LANG={en:{kidsMode:'Kids Mode',kidsMascotHi:'Hi there, Agent!',kidsMission:'Mission Timer',kidsMissionDone:'Mission Complete!',kidsStickers:'Stickers',
 ...
 gloss1_term: 'LSB Insertion',
 gloss1_def: 'Least Significant Bit insertion — replacing the lowest bit of each pixel with a message bit. Changes are invisible to the eye but detectable by statistical analysis.',
 ...
 theory: 'Steganography Suite demonstrates key principles from escape and evasion. Steganography hides data within cover media (images, audio, video) so its existence is undetectable. Unlike encryption, the goal is to hide the communication itself. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 theory: 'Steganography Suite démontre les principes clés de évasion. Steganography hides data within cover media (images, audio, video) so its existence is undetectable. Unlike encryption, the goal is to hide the communication itself. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 theory: 'Steganography Suite يوضح المبادئ الأساسية في الهروب والتملص. Steganography hides data within cover media (images, audio, video) so its existence is undetectable. Unlike encryption, the goal is to hide the communication itself. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
