...
en:{
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Attack Simulator',related1_desc:'Enter a password and watch different attacks try to crack it',related1_path:'../../03-spy-browser/web-password-cracker/index.html',related2_name:'Invisible Ink — Self-Destructing Messages',related2_desc:'Send messages that vanish after reading',related2_path:'../../01-spy-microbit/bit-invisible-ink/index.html',related3_name:'Digital Footprint Scanner',related3_desc:'Enter a username to search across platforms',related3_path:'../../03-spy-browser/web-dark-profile/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'esc-airgap-jumper',pathPrev_path:'../../55-escape-evasion/esc-airgap-jumper/index.html',pathNext_name:'esc-burner-identity-gen',pathNext_path:'../../55-escape-evasion/esc-burner-identity-gen/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
