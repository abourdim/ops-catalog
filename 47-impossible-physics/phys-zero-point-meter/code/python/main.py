#!/usr/bin/env python3
"""
Zero-Point Energy Meter
⚛️ Zero-Point Energy Meter — Vacuum fluctuation measurement

Workshop-DIY Educational Project

Process:
    Step 1: Configure the physical constants and initial conditions for the experiment.
    Step 2: Start the simulation and observe the physics phenomenon in action.
    Step 3: Capture quantitative measurements from the simulated experiment.
    Step 4: Compare your experimental results with theoretical predictions.
...
APP_NAME = "phys-zero-point-meter"
