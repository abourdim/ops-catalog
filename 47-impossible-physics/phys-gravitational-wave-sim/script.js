...
const LANG={en:{
    ...
    printBtn: '🖨️ طباعة',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'Dead Drop — نقل رسائل BLE',related1_desc:'شفّر وتبادل رسائل سرية عبر محاكاة BLE',related1_path:'../../44-acoustic-warfare/sonic-dolphin-attack-lab/index.html',related2_name:'Dead Drop — نقل رسائل BLE',related2_desc:'شفّر وتبادل رسائل سرية عبر محاكاة BLE',related2_path:'../../45-time-manipulation/chrono-packet-time-machine/index.html',related3_name:'Gait ID \\u2014 WiFi Person Identification',related3_desc:'WiFi channel state information identifies people by walking pattern',related3_path:'../../43-bio-radio/bio-walking-gait-id/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'phys-faraday-rotation-lab',pathPrev_path:'../../47-impossible-physics/phys-faraday-rotation-lab/index.html',pathNext_name:'الراديو الهولوغرافي',pathNext_path:'../../47-impossible-physics/phys-holographic-radio/index.html'}};
