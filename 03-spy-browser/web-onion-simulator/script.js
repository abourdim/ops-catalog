...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Frequency Hunter',related1_desc:'Spectrum analyzer & hidden transmitter hunt',related1_path:'../../02-spy-esp32/esp-frequency-hunter/index.html',related2_name:'Shake Cipher — Pattern Unlock',related2_desc:'Create secret shake patterns to encrypt and unlock messages',related2_path:'../../01-spy-microbit/bit-shake-cipher/index.html',related3_name:'WiFi Packet Radar',related3_desc:'Real-time 802.11 frame capture and visualization',related3_path:'../../02-spy-esp32/esp-packet-sniffer/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Spy Network Graph',pathPrev_path:'../../03-spy-browser/web-network-map/index.html',pathNext_name:'Attack Simulator',pathNext_path:'../../03-spy-browser/web-password-cracker/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
