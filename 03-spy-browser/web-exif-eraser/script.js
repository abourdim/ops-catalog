...
const LANG = {
  en: {
    ...
    howto_4: 'Try the challenges in Section C to test your privacy awareness skills.',
  ...
  fr: {
    ...
    howto_4: 'Essayez les défis de la Section C pour tester vos compétences en confidentialité.',
  ...
  ar: {
    ...
    howto_4: 'جرّب التحديات في القسم ج لاختبار مهارات الخصوصية.',
