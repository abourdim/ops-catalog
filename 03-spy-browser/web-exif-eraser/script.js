/**
 * Workshop DIY — EXIF Eraser v1.0
 * Metadata Scrubber — Strip hidden data from photos before sharing
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-C07710',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master EXIF Eraser \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'EXIF Eraser', subtitle: '🧹 scan · 🔍 reveal · 🛡️ protect',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'EXIF Eraser — Metadata Scrubber', mainDesc: 'Strip hidden data from photos before sharing',
 sectionA: 'How It Works', sectionB: 'Comparison Lab', sectionC: 'Challenge',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Exif Eraser simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how EXIF (Exchangeable Image File Format) is metadata embedded i',
 ...
 wiki_exif_title: '📷 EXIF Data', wiki_exif: 'Exchangeable Image File Format — metadata standard embedded in JPEG, TIFF, and RAW files by cameras and phones.',
 wiki_gps_title: '📍 GPS Geotagging', wiki_gps: 'Most smartphones embed GPS coordinates in photos by default. This reveals exactly where a photo was taken.',
 ...
 wiki_scrub_title: '🧹 Metadata Scrubbing', wiki_scrub: 'The process of removing EXIF, IPTC, and XMP metadata blocks from image files while preserving visual quality.',
 working: 'Scrubbing…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🧹 EXIF Eraser ready!',
 ...
 themeChanged: '🎨 Theme →',
 uploadHint: 'Drop an image or click to upload (or use sample)',
 useSample: 'Use sample image', reset: 'Reset',
 privacyRisk: 'Privacy Risk:', metadataBefore: 'Metadata (Before)',
 metaBeforeDesc: 'Hidden data found in this image', scrubNow: 'Scrub Metadata',
 metadataAfter: 'Metadata (After)', metaAfterDesc: 'Clean — no hidden data remains',
 fieldsBefore: 'Fields Before', fieldsAfter: 'Fields After', fieldsRemoved: 'Removed',
 step1Title: 'What is EXIF Data?', step1Desc: 'EXIF (Exchangeable Image File Format) is metadata embedded in every photo. It includes camera settings, GPS location, timestamps, device info, and more. Most people have no idea this data exists.',
 step2Title: 'Why Is It Dangerous?', step2Desc: 'When you share a photo online, anyone can extract your GPS coordinates (where you were), your device model, exact time the photo was taken, and even your name. Stalkers, advertisers, and hackers love this data.',
 step3Title: 'How Scrubbing Works', step3Desc: 'EXIF data lives in specific byte ranges within the image file. Scrubbing removes those byte segments while preserving the visual image data. The result is a clean image with zero metadata leakage.',
 step4Title: 'Best Practices', step4Desc: 'Always scrub metadata before sharing photos online. Disable GPS tagging in your camera app. Use EXIF erasers regularly. Be especially careful with photos that show your home, school, or regular locations.',
 beforeScrub: 'Before Scrub', afterScrub: 'After Scrub',
 compareLoad: 'Load an image to see comparison', compareRun: 'Scrub the image first',
 batchScrub: 'Batch Scrub (3 Samples)',
 challenge1Title: 'Challenge 1: Find the Spy', challenge1Desc: 'A photo was posted online. Can you determine the GPS coordinates, device, and time it was taken? Click to generate a mystery image and analyze its metadata.',
 challenge2Title: 'Challenge 2: Spot the Difference', challenge2Desc: 'Two versions of the same image — one has metadata, one is clean. Can you tell which is which just by looking? (Hint: they look identical!)',
 challenge3Title: 'Challenge 3: Privacy Audit', challenge3Desc: 'Scrub 5 images as fast as you can. Each image has different metadata risks. Try to achieve a perfect privacy score!',
 startChallenge: 'Start Challenge',
 imageLoaded: '📷 Image loaded — metadata extracted',
 scrubComplete: '🧹 Metadata scrubbed — image is clean!',
 fieldFound: 'field(s) of hidden data found',
 allClean: '✅ All metadata removed',
 riskHigh: 'HIGH', riskMedium: 'MEDIUM', riskLow: 'LOW', riskClean: 'CLEAN',
 challengeComplete: '🏆 Challenge complete!',
 batchComplete: '📦 Batch scrub complete — all images cleaned',sectionCode:'Device Code',faq_q1:'What is EXIF Eraser?',faq_a1:'Exif Eraser is an interactive simulation that demonstrates covert operations concepts. Strip hidden data from photos before sharing. Everything runs in your browser — no hardware or installation needed. Adjust the controls, observe the results, and build real understanding through experimentation.',faq_q2:'How does the simulation work?',faq_a2:'The simulation models real digital security behavior in your browser. You control the inputs using sliders and buttons, and the visualization updates in real time to show you the results.',faq_q3:'What do the controls do?',faq_a3:'Press "Start" to begin. Each button and slider changes a specific parameter — the visualization responds immediately so you can see the effect. Check the How-To tab for a step-by-step guide.',faq_q4:'What is the science behind this?',faq_a4:'This app is based on real digital security principles used by professionals. The simulation applies the same math and physics — the difference is that here you can safely experiment without expensive equipment.',faq_q5:'What should I experiment with?',faq_a5:'Change one parameter at a time and observe the effect. Try extreme values to find the limits. Then combine changes to see how different factors interact. The challenges section gives you specific experiments to try.',faq_q6:'What hardware do I need for the real version?',faq_a6:'The simulation needs no hardware. To build the real project, you need Browser only. See the Device Code section for wiring diagrams and ready-to-use firmware.',faq_q7:'Is my data private?',faq_a7:'Yes. Everything runs locally in your browser using JavaScript. No data is sent to any server, no account is needed, and the app works completely offline. Your experiments stay on your device.',faq_q8:'What should I explore next?',faq_a8:'Try Web Burner Chat and Web Cipher Suite. Each app in this category teaches a different aspect of digital security. Try systematically: set all controls to their defaults, then change one variable at a time. Record what happens at minimum, midpoint, and maximum values. This methodical approach is exactly how researchers and engineers characterize real systems.',demo_s1:'Welcome to EXIF Eraser! Look at the main display — this is where the digital security simulation runs.',demo_s2:'Upload an image or click "Use sample image" to load a demo photo. Watch how the visualization reacts.',demo_s3:'Try adjusting the controls. Each slider or button changes a specific parameter of the simulation.',demo_s4:'Scroll down to see "How It Works" for detailed data. The numbers and charts update as the simulation runs.',demo_s5:'Great job! Now try the challenges section to test your understanding of digital security.',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Cryptography',learn1Desc:'How secret codes protect messages from spies. Watch the simulation to see this happen in real time. The visualization makes the invisible visible.',learn1Tag:'Cybersecurity',learn2Title:'Wireless Communication',learn2Desc:'How devices send invisible signals through the air. The controls let you experiment with different conditions. Each change reveals how this principle responds.',learn2Tag:'Wireless',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Try the challenges section to test your understanding. Real engineers use these same concepts daily.',learn3Tag:'Security',learn4Title:'Math in Security',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare results with different settings to build intuition. The data panels show precise measurements.',learn4Tag:'Math',sectionLearn:'What You Shall Learn',learnLevelVal:'Beginner 🟢',learnLevel:'Level:',learnTimeVal:'15 min ⏱',learnTime:'Time:',learnAgeVal:'10+ 🧒',kidTitle:'For Young Explorers',kidIntro:'Welcome to Exif Eraser! This is like a science experiment on your computer. You get to control a real covert operations simulation — press buttons, move sliders, and watch what happens on screen. Try changing the controls and watch how EXIF (Exchangeable Image File Format) is metadata Nothing can break — it is all just a simulation running safely in your browser!',kidSafe:'Completely safe! Nothing you do here can break anything. It all runs inside your browser like a game.',kidTry:'Press the big Start button and watch the screen change. Then try moving sliders to see what they do.',kidParent:'This app teaches digital security concepts through hands-on simulation. Suitable for STEM education in physics, electronics, and computer science.',ch1Title:'Encrypt & Decode',ch1Desc:'Encrypt a message using the built-in cipher, then try to decode it manually without looking at the key. What patterns can you spot in the ciphertext?',ch2Title:'Stealth Test',ch2Desc:'Try to complete the mission with the lowest possible signal footprint. Can you reduce emissions below the detection threshold?',ch3Title:'Interception Race',ch3Desc:'Start a transmission and see how quickly you can intercept it from the other side. What affects the detection time?',codeTitle:'How This App Works',codeLang:'JavaScript',codeSnippet:'const canvas = document.getElementById("mainCanvas");\\nconst ctx = canvas.getContext("2d");\\n\\nfunction draw() {\\n ctx.clearRect(0, 0, canvas.width, canvas.height);\\n // Draw your visualization here\\n ctx.fillStyle = "#00ff88";\\n ctx.fillRect(x, y, width, height);\\n requestAnimationFrame(draw);\\n}\\n\\ndraw();',codeExplain:'Every app uses an HTML5 Canvas for real-time visualization. The draw() function runs ~60 times per second via requestAnimationFrame. It clears the screen, draws the current state, and schedules the next frame. This is the same technique used in games and data dashboards. The simulation logic updates variables that draw() reads to show the current state.',purpose:'EXIF Eraser: Strip hidden data from photos before sharing. This simulation lets you experiment hands-on instead of just reading theory. Every parameter you change produces visible results, building real intuition for how the system behaves. The workflow goes from What is EXIF Data? through Why Is It Dangerous? to How Scrubbing Works and Best Practices.',guideTitle:'What Am I Looking At?',guideCanvas:'The main area shows a live visualization of the simulation. Colors and movement represent data changing in real time.',guideControls:'The buttons below the main display control the simulation. Start begins it, Stop pauses it, Reset clears everything.',guideSections:'Below the main card, "How It Works" and "Comparison Lab" show detailed data and analysis. Click the section headers to expand or collapse them.',guideStatus:'The colored dot in the top-right corner shows the connection status. Green means running, red means stopped.',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Anti-Forensics Engine',related1_desc:'Secure wipe, log sanitization & timestamp obfuscation',related1_path:'../../55-escape-evasion/esc-anti-forensics-toolkit/index.html',related2_name:'Panic Button — Emergency Alert',related2_desc:'Broadcast emergency alerts and wipe sensitive data',related2_path:'../../01-spy-microbit/bit-panic-button/index.html',related3_name:'Device Radar',related3_desc:'Scan for WiFi devices in range',related3_path:'../../02-spy-esp32/esp-dead-zone/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Digital Footprint Scanner',pathPrev_path:'../../03-spy-browser/web-dark-profile/index.html',pathNext_name:'Photo Forensics',pathNext_path:'../../03-spy-browser/web-metadata-detective/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 theory: 'Exif Eraser demonstrates key principles from covert operations. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-C07710',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez EXIF Eraser \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 mainSection: 'EXIF Eraser — Nettoyeur de métadonnées', mainDesc: 'Supprimez les données cachées des photos avant de les partager',
 sectionA: 'Comment ça marche', sectionB: 'Labo de comparaison', sectionC: 'Défis',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Exif Eraser. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how EXIF (Exchangeable Image File Format) is metadata embedded i',
 ...
 wiki_exif_title: '📷 Données EXIF', wiki_exif: 'Format d\'échange d\'image — standard de métadonnées intégré dans les fichiers JPEG, TIFF et RAW.',
 wiki_gps_title: '📍 Géolocalisation GPS', wiki_gps: 'La plupart des smartphones intègrent des coordonnées GPS dans les photos par défaut.',
 wiki_privacy_title: '🔒 Confidentialité', wiki_privacy: 'Local-first, privacy-first. Toutes les données restent dans ton navigateur.',
 wiki_scrub_title: '🧹 Nettoyage de métadonnées', wiki_scrub: 'Le processus de suppression des blocs EXIF, IPTC et XMP des fichiers image.',
 working: 'Nettoyage…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🧹 EXIF Eraser prêt !',
 ...
 themeChanged: '🎨 Thème →',
 uploadHint: 'Déposez une image ou cliquez pour télécharger (ou utilisez un exemple)',
 useSample: 'Utiliser un exemple', reset: 'Réinitialiser',
 privacyRisk: 'Risque de confidentialité :', metadataBefore: 'Métadonnées (Avant)',
 metaBeforeDesc: 'Données cachées trouvées dans cette image', scrubNow: 'Nettoyer les métadonnées',
 metadataAfter: 'Métadonnées (Après)', metaAfterDesc: 'Propre — aucune donnée cachée ne reste',
 fieldsBefore: 'Champs avant', fieldsAfter: 'Champs après', fieldsRemoved: 'Supprimés',
 step1Title: 'Qu\'est-ce que l\'EXIF ?', step1Desc: 'L\'EXIF est un format de métadonnées intégré dans chaque photo. Il contient les réglages de l\'appareil, la localisation GPS, les horodatages et plus encore.',
 step2Title: 'Pourquoi c\'est dangereux ?', step2Desc: 'Quand vous partagez une photo en ligne, n\'importe qui peut extraire vos coordonnées GPS, votre modèle d\'appareil et l\'heure exacte de la prise de vue.',
 step3Title: 'Comment ça fonctionne', step3Desc: 'Les données EXIF se trouvent dans des plages d\'octets spécifiques. Le nettoyage supprime ces segments tout en préservant l\'image visuelle.',
 step4Title: 'Bonnes pratiques', step4Desc: 'Nettoyez toujours les métadonnées avant de partager des photos. Désactivez le marquage GPS dans votre appareil photo.',
 beforeScrub: 'Avant nettoyage', afterScrub: 'Après nettoyage',
 compareLoad: 'Chargez une image pour voir la comparaison', compareRun: 'Nettoyez d\'abord l\'image',
 batchScrub: 'Nettoyage par lot (3 exemples)',
 challenge1Title: 'Défi 1 : Trouvez l\'espion', challenge1Desc: 'Une photo a été postée en ligne. Pouvez-vous déterminer les coordonnées GPS, l\'appareil et l\'heure ?',
 challenge2Title: 'Défi 2 : Trouvez la différence', challenge2Desc: 'Deux versions de la même image — une a des métadonnées, l\'autre est propre. Pouvez-vous les distinguer ?',
 challenge3Title: 'Défi 3 : Audit de confidentialité', challenge3Desc: 'Nettoyez 5 images le plus vite possible. Essayez d\'obtenir un score parfait !',
 startChallenge: 'Commencer le défi',
 imageLoaded: '📷 Image chargée — métadonnées extraites',
 scrubComplete: '🧹 Métadonnées nettoyées — image propre !',
 fieldFound: 'champ(s) de données cachées trouvés',
 ...
 theory: 'Exif Eraser démontre les principes clés de opérations secrètes. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 mainSection: 'ممحاة EXIF — منظف البيانات الوصفية', mainDesc: 'أزل البيانات المخفية من الصور قبل مشاركتها',
 sectionA: 'كيف يعمل', sectionB: 'مختبر المقارنة', sectionC: 'التحدي',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Exif Eraser. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how EXIF (Exchangeable Image File Format) is metadata embedded i',
 ...
 wiki_exif_title: '📷 بيانات EXIF', wiki_exif: 'صيغة ملف الصور القابل للتبادل — معيار بيانات وصفية مدمج في ملفات JPEG و TIFF و RAW.',
 wiki_gps_title: '📍 تحديد الموقع GPS', wiki_gps: 'معظم الهواتف الذكية تدمج إحداثيات GPS في الصور افتراضيًا.',
 wiki_privacy_title: '🔒 الخصوصية', wiki_privacy: 'محلي أولًا، خصوصية أولًا. كل البيانات تبقى في متصفحك.',
 wiki_scrub_title: '🧹 تنظيف البيانات الوصفية', wiki_scrub: 'عملية إزالة كتل EXIF و IPTC و XMP من ملفات الصور مع الحفاظ على الجودة البصرية.',
 working: 'جارٍ التنظيف…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🧹 ممحاة EXIF جاهزة!',
 ...
 themeChanged: '🎨 المظهر ←',
 uploadHint: 'أسقط صورة أو انقر للتحميل (أو استخدم نموذج)',
 useSample: 'استخدم صورة نموذجية', reset: 'إعادة ضبط',
 privacyRisk: 'مخاطر الخصوصية:', metadataBefore: 'البيانات الوصفية (قبل)',
 metaBeforeDesc: 'بيانات مخفية موجودة في هذه الصورة', scrubNow: 'تنظيف البيانات الوصفية',
 metadataAfter: 'البيانات الوصفية (بعد)', metaAfterDesc: 'نظيف — لا توجد بيانات مخفية',
 fieldsBefore: 'حقول قبل', fieldsAfter: 'حقول بعد', fieldsRemoved: 'تم الإزالة',
 step1Title: 'ما هي بيانات EXIF؟', step1Desc: 'EXIF هو تنسيق بيانات وصفية مدمج في كل صورة. يتضمن إعدادات الكاميرا، موقع GPS، الطوابع الزمنية ومعلومات الجهاز.',
 step2Title: 'لماذا هو خطير؟', step2Desc: 'عندما تشارك صورة عبر الإنترنت، يمكن لأي شخص استخراج إحداثيات GPS الخاصة بك، وطراز جهازك، والوقت الدقيق لالتقاط الصورة.',
 step3Title: 'كيف يعمل التنظيف', step3Desc: 'بيانات EXIF موجودة في نطاقات بايت محددة داخل ملف الصورة. التنظيف يزيل هذه الأجزاء مع الحفاظ على بيانات الصورة المرئية.',
 step4Title: 'أفضل الممارسات', step4Desc: 'نظّف البيانات الوصفية دائمًا قبل مشاركة الصور. عطّل وسم GPS في تطبيق الكاميرا.',
 beforeScrub: 'قبل التنظيف', afterScrub: 'بعد التنظيف',
 compareLoad: 'حمّل صورة لرؤية المقارنة', compareRun: 'نظّف الصورة أولاً',
 batchScrub: 'تنظيف دفعة (3 نماذج)',
 challenge1Title: 'التحدي 1: اعثر على الجاسوس', challenge1Desc: 'تم نشر صورة على الإنترنت. هل يمكنك تحديد إحداثيات GPS والجهاز ووقت الالتقاط؟',
 challenge2Title: 'التحدي 2: اكتشف الفرق', challenge2Desc: 'نسختان من نفس الصورة — واحدة تحتوي بيانات وصفية والأخرى نظيفة. هل يمكنك التمييز؟',
 challenge3Title: 'التحدي 3: تدقيق الخصوصية', challenge3Desc: 'نظّف 5 صور بأسرع وقت ممكن. حاول تحقيق درجة خصوصية مثالية!',
 startChallenge: 'ابدأ التحدي',
 imageLoaded: '📷 تم تحميل الصورة — تم استخراج البيانات الوصفية',
 scrubComplete: '🧹 تم تنظيف البيانات الوصفية — الصورة نظيفة!',
 fieldFound: 'حقل(حقول) من البيانات المخفية تم العثور عليها',
 ...
 theory: 'Exif Eraser يوضح المبادئ الأساسية في العمليات السرية. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ EXIF SIMULATION ENGINE ═══════ */

const SAMPLE_CAMERAS = ['iPhone 15 Pro', 'Samsung Galaxy S24 Ultra', 'Google Pixel 8', 'Canon EOS R5', 'Sony A7 IV', 'Huawei P60 Pro'];
const SAMPLE_LENSES = ['4.25mm f/1.78', '6.3mm f/2.2', '3.5mm f/1.8', 'RF 24-105mm f/4L', 'FE 28-70mm f/3.5-5.6', '5.5mm f/1.9'];
const SAMPLE_SOFTWARE = ['iOS 17.4', 'One UI 6.1', 'Android 14', 'Adobe Lightroom 7.1', 'Capture One 23', 'GIMP 2.10'];
const SAMPLE_CITIES = [
...
function generateFakeExif() {
 const city = randomPick(SAMPLE_CITIES);
 const camIdx = randomInt(0, SAMPLE_CAMERAS.length - 1);
 const date = new Date(Date.now() - randomInt(0, 365 * 24 * 60 * 60 * 1000));
 const iso = [100, 200, 400, 800, 1600, 3200][randomInt(0, 5)];
 const fstop = [1.4, 1.8, 2.0, 2.8, 4.0, 5.6, 8.0][randomInt(0, 6)];
 const shutter = ['1/30', '1/60', '1/125', '1/250', '1/500', '1/1000'][randomInt(0, 5)];

 return {
 'Camera Make': SAMPLE_CAMERAS[camIdx].split('')[0],
 'Camera Model': SAMPLE_CAMERAS[camIdx],
 'Lens': SAMPLE_LENSES[camIdx],
 'Software': SAMPLE_SOFTWARE[camIdx],
 'Date/Time': date.toISOString().replace('T', '').slice(0, 19),
 'GPS Latitude': city.lat.toFixed(6) + '°',
 'GPS Longitude': city.lng.toFixed(6) + '°',
 'GPS Location': city.name,
 'ISO Speed': iso.toString(),
 'F-Stop': 'f/' + fstop,
 'Shutter Speed': shutter + 's',
 'Image Width': randomInt(3000, 8000) + 'px',
 'Image Height': randomInt(2000, 6000) + 'px',
 'Color Space': 'sRGB',
 'Orientation': 'Horizontal (normal)',
 'Flash': randomPick(['Off', 'On', 'Auto']),
 'White Balance': randomPick(['Auto', 'Daylight', 'Cloudy']),
 'Exposure Mode': randomPick(['Auto', 'Manual', 'Aperture Priority']),
 'Copyright': randomPick(['', 'All Rights Reserved', '(c) 2024 Photographer']),
 'Artist': randomPick(['', 'Agent Smith', 'Unknown', 'Ahmed B.']),
 'Unique Image ID': Math.random().toString(36).slice(2, 14).toUpperCase(),
 };
}

function drawSampleImage(canvas) {
 canvas.width = 400;
 canvas.height = 280;
 const ctx = canvas.getContext('2d');
 ...
 ctx.fillRect(0, 160, 400, 120);

 // Mosque silhouette
 ctx.fillStyle = '#0d1b2a';
 ctx.fillRect(140, 90, 120, 70);
 // Dome
 ctx.beginPath();
 ctx.arc(200, 90, 60, Math.PI, 0);
 ctx.fill();
 // Minaret
 ctx.fillRect(120, 50, 16, 110);
 ctx.fillRect(264, 50, 16, 110);
 // Crescent on top
 ...
 ctx.fillStyle = '#0d1b2a';
 ctx.beginPath();
 ctx.arc(205, 38, 9, 0, Math.PI * 2);
 ctx.fill();

 // Stars
 ctx.fillStyle = '#ffffff';
 for (let i = 0; i < 20; i++) {
 const x = randomInt(10, 390);
 const y = randomInt(5, 80);
...
function renderMetaTable(tableEl, data, scrubbed) {
 tableEl.innerHTML = '';
 const entries = Object.entries(data);
 entries.forEach(([key, val]) => {
 const tr = document.createElement('tr');
 if (scrubbed) tr.className = 'scrubbed';
 tr.innerHTML = `<th>${key}</th><td>${scrubbed ? '—' : (val || '(empty)')}</td>`;
 tableEl.appendChild(tr);
 });
}

function updateRiskBadge(exifData, scrubbed) {
 const area = $('riskArea');
 ...
 if (scrubbed) {
 badge.className = 'risk-badge risk-clean';
 badge.textContent = s.riskClean || 'CLEAN';
 return;
 }

 const hasGPS = exifData['GPS Latitude'] && exifData['GPS Latitude'] !== '—';
 const hasArtist = exifData['Artist'] && exifData['Artist'] !== '';
 const fields = Object.values(exifData).filter(v => v && v !== '' && v !== '(empty)').length;

 if (hasGPS && hasArtist) {
 badge.className = 'risk-badge risk-high';
 badge.textContent = s.riskHigh || 'HIGH';
 } else if (hasGPS || fields > 12) {
 badge.className = 'risk-badge risk-medium';
 badge.textContent = s.riskMedium || 'MEDIUM';
 } else {
 badge.className = 'risk-badge risk-low';
 badge.textContent = s.riskLow || 'LOW';
 }
}

function loadImage(fromFile) {
 const canvas = $('previewCanvas');
 if (!canvas) return;

 if (fromFile) {
 // If user uploaded a real file, draw it on canvas
 const reader = new FileReader();
 reader.onload = (e) => {
 const img = new Image();
 img.onload = () => {
 canvas.width = Math.min(img.width, 400);
 canvas.height = Math.min(img.height, 280);
 const ctx = canvas.getContext('2d');
...
function afterImageLoad() {
 currentExifData = generateFakeExif();
 isScrubbed = false;
 imageLoaded = true;

 const s = LANG[currentLang];
 const fieldCount = Object.keys(currentExifData).length;

 // Show before metadata
 const metaBefore = $('metaBefore');
 const metaAfter = $('metaAfter');
 const statsRow = $('statsRow');
 if (metaBefore) metaBefore.style.display = 'block';
 if (metaAfter) metaAfter.style.display = 'none';
 if (statsRow) statsRow.style.display = 'none';

 renderMetaTable($('metaTableBefore'), currentExifData, false);
 updateRiskBadge(currentExifData, false);

 const scrubBtn = $('scrubBtn');
 const resetBtn = $('resetBtn');
 const batchBtn = $('batchBtn');
 if (scrubBtn) scrubBtn.disabled = false;
 ...
 const entries = Object.entries(currentExifData).slice(0, 8);
 entries.forEach(([k, v]) => {
 const div = document.createElement('div');
 div.style.cssText = 'font-size:0.68rem;margin-bottom:2px;';
 div.innerHTML = `<span style="color:var(--accent)">${k}:</span> <span class="diff-highlight">${v}</span>`;
 compareBefore.appendChild(div);
 });
 }

 log(`${s.imageLoaded} — ${fieldCount} ${s.fieldFound}`, 'success');
 setStatus(true);

 // Log each dangerous field
 if (currentExifData['GPS Latitude']) log(`📍 GPS: ${currentExifData['GPS Location']} (${currentExifData['GPS Latitude']}, ${currentExifData['GPS Longitude']})`, 'error');
 if (currentExifData['Camera Model']) log(`📱 Device: ${currentExifData['Camera Model']}`, 'info');
 if (currentExifData['Date/Time']) log(`🕐 Timestamp: ${currentExifData['Date/Time']}`, 'info');
 if (currentExifData['Artist'] && currentExifData['Artist'] !== '') log(`👤 Artist: ${currentExifData['Artist']}`, 'error');
}

function scrubMetadata() {
 if (!currentExifData || isScrubbed) return;
 const s = LANG[currentLang];

 showToast(s.working, 0);
 log('🧹 Starting metadata scrub...', 'tx');

 let idx = 0;
 const keys = Object.keys(currentExifData);
...
function finishScrub() {
 ...
 // Show after metadata
 const metaAfter = $('metaAfter');
 if (metaAfter) metaAfter.style.display = 'block';
 renderMetaTable($('metaTableAfter'), currentExifData, true);
 updateRiskBadge(currentExifData, true);

 // Stats
 const statsRow = $('statsRow');
 if (statsRow) statsRow.style.display = 'flex';
 const fb = $('statFieldsBefore');
 const fa = $('statFieldsAfter');
 const fr = $('statRemoved');
 if (fb) fb.textContent = fieldCount;
 if (fa) fa.textContent = '0';
 if (fr) fr.textContent = fieldCount;
 ...
 entries.forEach(([k]) => {
 const div = document.createElement('div');
 div.style.cssText = 'font-size:0.68rem;margin-bottom:2px;color:var(--text-muted);';
 div.innerHTML = `<span style="color:var(--accent)">${k}:</span> <span style="text-decoration:line-through;opacity:0.4;">—</span>`;
 compareAfter.appendChild(div);
 });
 }

 const scrubBtn = $('scrubBtn');
 if (scrubBtn) scrubBtn.disabled = true;

 log(s.scrubComplete, 'success');
 log(s.allClean, 'success');
 playSound('success');
}
...
function resetApp() {
 ...
 ['metaBefore', 'metaAfter', 'riskArea', 'statsRow'].forEach(id => {
 const el = $(id);
 if (el) el.style.display = 'none';
 });
 ...
 const compareAfter = $('compareAfter');
 const s = LANG[currentLang];
 if (compareBefore) compareBefore.innerHTML = `<span class="hint">${s.compareLoad}</span>`;
 if (compareAfter) compareAfter.innerHTML = `<span class="hint">${s.compareRun}</span>`;

 setStatus(false);
 log('🔄 Reset complete', 'info');
}

function runBatchScrub() {
 const s = LANG[currentLang];
 log('📦 Starting batch scrub (3 images)...', 'tx');
 showToast(s.working, 0);

 let count = 0;
 const batchInterval = setInterval(() => {
 count++;
 const fakeExif = generateFakeExif();
 const fields = Object.keys(fakeExif).length;
 log(`📷 Image ${count}: ${fakeExif['Camera Model']} — ${fields} fields → scrubbed ✓`, 'success');

 if (count >= 3) {
 clearInterval(batchInterval);
 hideToast();
 log(s.batchComplete, 'success');
 playSound('success');
 }
 }, 800);
}
...
function runChallenge1() {
 const s = LANG[currentLang];
 const exif = generateFakeExif();
 log('🕵️ Mystery photo analyzed...', 'tx');
 const result = $('challenge1Result');
 if (result) {
 result.innerHTML = `
 <div style="margin-top:6px;font-size:0.75rem;">
 <div>📍 <strong>Location:</strong> ${exif['GPS Location']} (${exif['GPS Latitude']}, ${exif['GPS Longitude']})</div>
 <div>📱 <strong>Device:</strong> ${exif['Camera Model']}</div>
 <div>🕐 <strong>Time:</strong> ${exif['Date/Time']}</div>
 <div>👤 <strong>Artist:</strong> ${exif['Artist'] || 'Unknown'}</div>
 <div style="margin-top:4px;color:#ef4444;">⚠️ All this data was hidden in a single photo!</div>
 </div>
 `;
 }
 log(`${s.challengeComplete} Location: ${exif['GPS Location']}`, 'success');
 playSound('success');
}

function runChallenge2() {
 const s = LANG[currentLang];
 log('👁️ Comparing two image versions...', 'tx');
 const result = $('challenge2Result');
 if (result) {
 result.innerHTML = `
 <div style="margin-top:6px;font-size:0.75rem;">
 <div>🔴 <strong>Image A:</strong> 4.2 MB — contains 21 EXIF fields (GPS, device, name)</div>
 <div>🟢 <strong>Image B:</strong> 4.1 MB — contains 0 EXIF fields (clean)</div>
 <div style="margin-top:4px;">🤔 <strong>Visually identical!</strong> The only difference is invisible metadata.</div>
 <div style="margin-top:4px;color:var(--accent);">💡 Lesson: You cannot see metadata — you must actively remove it!</div>
 </div>
 `;
 }
 log(`${s.challengeComplete} Images look identical but metadata differs!`, 'success');
 playSound('success');
}

function runChallenge3() {
 const s = LANG[currentLang];
 log('⏱️ Privacy audit started — scrubbing 5 images...', 'tx');
 showToast(s.working, 0);
 const result = $('challenge3Result');
 let score = 0;
 let count = 0;
 ...
 count++;
 const exif = generateFakeExif();
 const hasGPS = exif['GPS Latitude'] !== undefined;
 const risk = hasGPS ? 'HIGH' : 'MEDIUM';
 score += hasGPS ? 20 : 15;
 log(` 📷 Image ${count}/5: ${exif['Camera Model']} [${risk}] → scrubbed ✓`, 'success');
 ...
 result.innerHTML = `
 <div style="margin-top:6px;font-size:0.75rem;">
 <div>🏆 <strong>Privacy Score: ${score}/100</strong></div>
 <div>📷 Images scrubbed: 5/5</div>
 <div>🧹 Total fields removed: ${randomInt(80, 105)}</div>
 <div style="margin-top:4px;color:var(--accent);">⭐ ${score >= 90 ? 'Perfect! You are a privacy expert!' : 'Good job! Keep practicing!'}</div>
 </div>
 `;
 }
 log(`${s.challengeComplete} Privacy Score: ${score}/100`, 'success');
 playSound('success');
 }
 }, 600);
}

function initExifApp() {
 // Upload zone
 ...
 const scrubBtn = $('scrubBtn');
 const batchBtn = $('batchBtn');
 const c1 = $('challenge1Btn');
 const c2 = $('challenge2Btn');
 const c3 = $('challenge3Btn');

 if (sampleBtn) sampleBtn.onclick = () => loadImage(null);
 if (resetBtn) resetBtn.onclick = resetApp;
 if (scrubBtn) scrubBtn.onclick = scrubMetadata;
 if (batchBtn) batchBtn.onclick = runBatchScrub;
 if (c1) c1.onclick = runChallenge1;
 if (c2) c2.onclick = runChallenge2;
 if (c3) c3.onclick = runChallenge3;
}
