...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-94B83C',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Cipher Suite \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 howto_1:'The main display shows the Cipher Suite simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 howto_3:'Scroll down to the expandable sections. "Cipher Reference & Analysis" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_caesar_title: 'Caesar Cipher', wiki_caesar:'Shifts each letter by a fixed number. Used by Julius Caesar (~58 BC). This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_vigenere_title: 'Vigenere Cipher', wiki_vigenere:'Polyalphabetic cipher using a keyword. Resisted cryptanalysis for 300 years. Encryption transforms readable data into scrambled ciphertext using a mathematical algorithm and a secret key. Without the correct key, the data appears random. Strong encryption uses keys so large that guessing them would take billions of years.',
 wiki_rsa_title: 'RSA Algorithm', wiki_rsa:'Asymmetric encryption based on factoring large numbers. Foundation of TLS/SSL. Encryption transforms readable data into scrambled ciphertext using a mathematical algorithm and a secret key. Without the correct key, the data appears random. Strong encryption uses keys so large that guessing them would take billions of years.',
 wiki_aes_title: 'AES Encryption', wiki_aes:'Advanced Encryption Standard. Our demo uses XOR-based simulation. Encryption transforms readable data into scrambled ciphertext using a mathematical algorithm and a secret key. Without the correct key, the data appears random. Strong encryption uses keys so large that guessing them would take billions of years.',
 wiki_otp_title: 'One-Time Pad', wiki_otp:'Mathematically unbreakable when used correctly. Used by spies in the Cold War. Bluetooth Low Energy (BLE) uses 2.4 GHz radio in 40 channels, hopping between them to avoid interference. Advertising packets let devices announce their presence without a connection. BLE is designed for low power — a coin cell battery can last months.',
 wiki_stego_title: 'Steganography', wiki_stego:'Hides messages in images using LSB encoding, invisible to the human eye. Bluetooth Low Energy (BLE) uses 2.4 GHz radio in 40 channels, hopping between them to avoid interference. Advertising packets let devices announce their presence without a connection. BLE is designed for low power — a coin cell battery can last months.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-94B83C',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Cipher Suite \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 theory: 'Cipher Suite démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Cipher Suite. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 theory: 'Cipher Suite يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
