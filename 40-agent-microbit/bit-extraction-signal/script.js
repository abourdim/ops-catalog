...
const LANG = {
  en: {
    ...
    howto_4: 'Wait for rescue acknowledgment or click "Cancel" to stop the beacon.',
  ...
  fr: {
    ...
    howto_4: 'Attends l\'accusé de réception ou clique sur "Annuler" pour arrêter la balise.',
  ...
  ar: {
    ...
    howto_4: 'انتظر تأكيد الإنقاذ أو انقر "إلغاء" لإيقاف المنارة.',
