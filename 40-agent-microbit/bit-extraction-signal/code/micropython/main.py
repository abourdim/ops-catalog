"""
bit-extraction-signal — micro:bit MicroPython
🚁 extraction signal — emergency beacon
...
# ── Configuration ──
APP_NAME = "bit-extraction-signal"
RADIO_GROUP = 238
RADIO_POWER = 6  # 0-7

# ── Process Overview ──
# Step 1: Encode agent ID, status, and location into a compact binary frame.
# Step 2: The beacon transmits the frame on the emergency frequency.
# Step 3: The signal repeats every N seconds (faster for higher priority).
# Step 4: The rescue team receives, decodes, and acknowledges the beacon.
