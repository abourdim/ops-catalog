/**
 * bit-micro-beacon-trail — Workshop DIY v1.0
 * BLE Beacon Trail Simulator
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-F66316',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Micro Beacon Trail \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Micro Beacon Trail', subtitle: 'Drop BLE beacons to mark and follow paths',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Beacon Trail — BLE Breadcrumbs', mainDesc: 'Drop BLE beacons to mark and follow paths',
 ...
 howto_1:'The main display shows the Micro Beacon Trail simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_ble_title: '📡 BLE Beacons', wiki_ble: 'Bluetooth Low Energy beacons are small transmitters that broadcast their identity. They use minimal power and can run for years on a coin cell battery.',
 wiki_ibeacon_title: '📍 iBeacon Protocol', wiki_ibeacon:'iBeacon is Apple\. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_path_title: '🗻 Path Tracking', wiki_path: 'Path tracking uses ordered beacon sequences as breadcrumbs. By following beacons in order and using RSSI for proximity, you can retrace a route.',
 wiki_indoor_title: '🏢 Indoor Navigation', wiki_indoor: 'Indoor navigation with BLE beacons enables wayfinding in buildings where GPS is unavailable. Trilateration from multiple beacons estimates position.',
 howItWorks_1: 'Drop a beacon at your current location — each beacon gets a unique ID and timestamp.',
 howItWorks_2: 'The beacon broadcasts a BLE advertisement packet containing its UUID, major/minor values.',
 howItWorks_3: 'A follower scans for beacons and visits them in order, following the breadcrumb trail.',
 howItWorks_4: 'RSSI (signal strength) indicates proximity — stronger signal means you are closer to the beacon.',
 lab_1: 'Create a trail by clicking on the canvas — each click drops a beacon at that position.',
 lab_2: 'Press "Follow Trail" and watch the position arrow navigate from beacon to beacon with signal guidance.',
 lab_3: 'Test with varying beacon density — drop beacons close together vs. far apart and compare accuracy.',
 lab_4: 'Measure trail accuracy by comparing the followed path to the original beacon positions.',
 challenge_1: 'Create a loop trail that returns to the starting beacon — can you close the loop perfectly?',
 challenge_2: 'Follow a trail with 50% of the beacons missing — how accurately can you navigate the gaps?',
 challenge_3: 'Design a secret trail with coded beacons — hide a message in the beacon sequence for others to decode.',
 dropBeacon: 'Drop Beacon', followTrail: 'Follow Trail', clearTrail: 'Clear Trail',
 beaconCountLabel: 'Beacons', trailDistanceLabel: 'Distance',
 beaconListEmpty: 'Click on the map to drop beacons',
 beaconDropped: '📍 Beacon #{n} dropped at ({x}, {y})',
 trailCleared: '🧹 Trail cleared',
 followStart: '🚶 Following trail...',
 followDone: '✅ Trail followed!',
 followNoBeacons: '⚠️ Drop some beacons first!',
 approaching: '📶 Approaching beacon #{n} — RSSI: {rssi} dBm',
 reached: '✅ Reached beacon #{n}',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📍 Beacon Trail ready!',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-F66316',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Micro Beacon Trail \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Micro Beacon Trail', subtitle: 'Posez des balises BLE pour marquer et suivre un chemin',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Piste de Balises — Fil d\'Ariane BLE', mainDesc: 'Posez des balises BLE pour marquer et suivre un chemin',
 ...
 wiki_ble_title: '📡 Balises BLE', wiki_ble: 'Les balises Bluetooth Low Energy sont de petits émetteurs qui diffusent leur identité. Elles consomment très peu d\'énergie et peuvent fonctionner pendant des années.',
 wiki_ibeacon_title: '📍 Protocole iBeacon', wiki_ibeacon: 'iBeacon est le standard BLE d\'Apple. Chaque balise diffuse un UUID, une valeur majeure et une valeur mineure pour identifier sa position.',
 wiki_path_title: '🗻 Suivi de chemin', wiki_path: 'Le suivi de chemin utilise des séquences ordonnées de balises comme fil d\'Ariane. En suivant les balises dans l\'ordre et en utilisant le RSSI, on peut retracer un itinéraire.',
 wiki_indoor_title: '🏢 Navigation intérieure', wiki_indoor: 'La navigation intérieure avec des balises BLE permet de se repérer dans les btiments où le GPS est indisponible. La trilatération estime la position.',
 howItWorks_1: 'Posez une balise à votre position — chaque balise reçoit un identifiant unique et un horodatage.',
 howItWorks_2: 'La balise diffuse un paquet BLE contenant son UUID, ses valeurs majeure/mineure.',
 howItWorks_3: 'Un suiveur scanne les balises et les visite dans l\'ordre, suivant le fil d\'Ariane.',
 howItWorks_4: 'Le RSSI (puissance du signal) indique la proximité — un signal plus fort signifie que vous êtes plus proche.',
 lab_1: 'Créez une piste en cliquant sur le canevas — chaque clic pose une balise à cette position.',
 lab_2: 'Appuyez sur "Suivre la piste" et regardez la flèche naviguer de balise en balise avec guidage signal.',
 lab_3: 'Testez avec des densités de balises variées — proches vs éloignées et comparez la précision.',
 lab_4: 'Mesurez la précision de la piste en comparant le chemin suivi aux positions originales des balises.',
 challenge_1: 'Créez une boucle qui revient à la balise de départ — pouvez-vous fermer la boucle parfaitement ?',
 challenge_2: 'Suivez une piste avec 50% des balises manquantes — naviguez-vous avec précision malgré les trous ?',
 challenge_3: 'Concevez une piste secrète avec des balises codées — cachez un message dans la séquence pour que d\'autres le décodent.',
 dropBeacon: 'Poser une balise', followTrail: 'Suivre la piste', clearTrail: 'Effacer la piste',
 beaconCountLabel: 'Balises', trailDistanceLabel: 'Distance',
 beaconListEmpty: 'Cliquez sur la carte pour poser des balises',
 beaconDropped: '📍 Balise #{n} posée à ({x}, {y})',
 trailCleared: '🧹 Piste effacée',
 followStart: '🚶 Suivi de la piste...',
 followDone: '✅ Piste suivie !',
 followNoBeacons: '⚠️ Posez des balises d\'abord !',
 approaching: '📶 Approche de la balise #{n} — RSSI : {rssi} dBm',
 reached: '✅ Balise #{n} atteinte',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📍 Piste de Balises prête !',
 ...
 theory: 'Micro Beacon Trail démontre les principes clés de agents autonomes. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Micro Beacon Trail', subtitle: 'ضع إشارات BLE لتحديد المسارات ومتابعتها',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مسار الإشارات — فتات خبز BLE', mainDesc: 'ضع إشارات BLE لتحديد المسارات ومتابعتها',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Micro Beacon Trail. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_ble_title: '📡 إشارات BLE', wiki_ble: 'إشارات البلوتوث منخفضة الطاقة هي أجهزة إرسال صغيرة تبث هويتها. تستهلك طاقة قليلة جدًا ويمكن أن تعمل لسنوات ببطارية زر.',
 wiki_ibeacon_title: '📍 بروتوكول iBeacon', wiki_ibeacon: 'iBeacon هو معيار BLE من Apple. كل إشارة تبث UUID وقيمة رئيسية وقيمة فرعية لتحديد موقعها وسياقها.',
 wiki_path_title: '🗻 تتبع المسار', wiki_path: 'يستخدم تتبع المسار تسلسلات مرتبة من الإشارات كفتات خبز. بمتابعة الإشارات بالترتيب واستخدام RSSI للقرب، يمكنك إعادة تتبع الطريق.',
 wiki_indoor_title: '🏢 الملاحة الداخلية', wiki_indoor: 'تتيح الملاحة الداخلية بإشارات BLE التوجيه في المباني حيث لا يتوفر GPS. التثليث من عدة إشارات يقدر الموقع.',
 howItWorks_1: 'ضع إشارة في موقعك الحالي — كل إشارة تحصل على معرف فريد وطابع زمني.',
 howItWorks_2: 'تبث الإشارة حزمة إعلان BLE تحتوي على UUID والقيم الرئيسية/الفرعية.',
 howItWorks_3: 'يقوم المتتبع بمسح الإشارات وزيارتها بالترتيب، متتبعًا مسار فتات الخبز.',
 howItWorks_4: 'يشير RSSI (قوة الإشارة) إلى القرب — إشارة أقوى تعني أنك أقرب للإشارة.',
 lab_1: 'أنشئ مسارًا بالنقر على اللوحة — كل نقرة تضع إشارة في ذلك الموقع.',
 lab_2: 'اضغط "تتبع المسار" وشاهد سهم الموقع ينتقل من إشارة لأخرى مع توجيه الإشارة.',
 lab_3: 'اختبر بكثافات مختلفة — ضع إشارات قريبة مقابل بعيدة وقارن الدقة.',
 lab_4: 'قِس دقة المسار بمقارنة المسار المتبع بمواقع الإشارات الأصلية.',
 challenge_1: 'أنشئ مسارًا دائريًا يعود إلى إشارة البداية — هل يمكنك إغلاق الحلقة بشكل مثالي؟',
 challenge_2: 'تتبع مسارًا مع فقدان 50% من الإشارات — ما مدى دقة تنقلك في الفجوات؟',
 challenge_3: 'صمم مسارًا سريًا بإشارات مشفرة — أخفِ رسالة في تسلسل الإشارات ليفك الآخرون شفرتها.',
 dropBeacon: 'وضع إشارة', followTrail: 'تتبع المسار', clearTrail: 'مسح المسار',
 beaconCountLabel: 'الإشارات', trailDistanceLabel: 'المسافة',
 beaconListEmpty: 'انقر على الخريطة لوضع إشارات',
 beaconDropped: '📍 إشارة #{n} وُضعت في ({x}، {y})',
 trailCleared: '🧹 تم مسح المسار',
 followStart: '🚶 تتبع المسار...',
 followDone: '✅ تم تتبع المسار!',
 followNoBeacons: '⚠️ ضع بعض الإشارات أولاً!',
 approaching: '📶 الاقتراب من الإشارة #{n} — RSSI: {rssi} ديسيبل',
 reached: '✅ تم الوصول للإشارة #{n}',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '📍 مسار الإشارات جاهز!',
 ...
 theory: 'Micro Beacon Trail يوضح المبادئ الأساسية في الوكلاء المستقلون. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ BEACON TRAIL SIMULATION ═══════ */

let beacons = [];
let beaconIdCounter = 0;
let trailCanvas, trailCtx;
let followerPos = null;
let followAnimId = null;
let isFollowing = false;

function initBeaconTrail() {
 ...
 const wrap = $('trailMapWrap');
 if (!wrap) return;
 const rect = wrap.getBoundingClientRect();
 trailCanvas.width = rect.width;
 trailCanvas.height = 350;
 drawTrail();
 }
 resizeCanvas();
 window.addEventListener('resize', resizeCanvas);

 // Click to drop beacon on canvas
 trailCanvas.addEventListener('click', function(e) {
 if (isFollowing) return;
 const rect = trailCanvas.getBoundingClientRect();
 const x = (e.clientX - rect.left) * (trailCanvas.width / rect.width);
 const y = (e.clientY - rect.top) * (trailCanvas.height / rect.height);
 dropBeaconAt(x, y);
 });
 ...
 if (dropBtn) dropBtn.onclick = function() { dropBeaconAuto(); };
 if (followBtn) followBtn.onclick = function() { startFollowTrail(); };
 if (clearBtn) clearBtn.onclick = function() { clearTrailData(); };
}

function generateBeaconId() {
 beaconIdCounter++;
 const hex = beaconIdCounter.toString(16).toUpperCase().padStart(4, '0');
 return 'BCN-' + hex;
}

function simulateRSSI(distance) {
 // RSSI = -10 * n * log10(d) + A
 // n = path loss exponent (~2 indoors), A = RSSI at 1m (~-59)
 if (distance < 1) distance = 1;
 const n = 2.0;
 const A = -59;
 const rssi = A - 10 * n * Math.log10(distance / 10);
 // Add noise
 const noise = (Math.random() - 0.5) * 6;
 return Math.round(rssi + noise);
}

function dropBeaconAt(x, y) {
 const id = generateBeaconId();
 const beacon = {
 id: id,
 num: beacons.length + 1,
 x: Math.round(x),
 y: Math.round(y),
 timestamp: new Date().toLocaleTimeString(),
 rssi: simulateRSSI(50 + Math.random() * 100)
 };
 beacons.push(beacon);
 const s = LANG[currentLang];
 const msg = s.beaconDropped.replace('{n}', beacon.num).replace('{x}', beacon.x).replace('{y}', beacon.y);
 log(msg, 'tx');
 playSound('click');
 updateBeaconUI();
 drawTrail();
...
function dropBeaconAuto() {
 ...
 x = Math.max(margin, Math.min(w - margin, last.x + Math.cos(angle) * dist));
 y = Math.max(margin, Math.min(h - margin, last.y + Math.sin(angle) * dist));
 }
 dropBeaconAt(x, y);
}
...
function clearTrailData() {
 ...
 followerPos = null;
 isFollowing = false;
 if (followAnimId) { cancelAnimationFrame(followAnimId); followAnimId = null; }
 updateBeaconUI();
 drawTrail();
 const s = LANG[currentLang];
 log(s.trailCleared, 'info');
 playSound('click');
}
...
function calcTrailDistance() {
 ...
 const dx = beacons[i].x - beacons[i - 1].x;
 const dy = beacons[i].y - beacons[i - 1].y;
...
function updateBeaconUI() {
 // Update count
 const countEl = $('beaconCount');
 if (countEl) countEl.textContent = beacons.length;

 // Update distance
 const distEl = $('trailDistance');
 if (distEl) {
 const d = calcTrailDistance();
 distEl.textContent = (d / 10).toFixed(1) + ' m';
 }
 ...
 if (!listEl) return;
 if (beacons.length === 0) {
 listEl.innerHTML = '<em data-i18n="beaconListEmpty" style="opacity:.5">' + LANG[currentLang].beaconListEmpty + '</em>';
 return;
 }
 listEl.innerHTML = beacons.map(function(b) {
 return '<div class="beacon-item">' +
 '<span class="b-id">#' + b.num + '' + b.id + '</span>' +
 '<span>' + b.timestamp + '</span>' +
 '<span class="b-rssi">' + b.rssi + ' dBm</span>' +
 '</div>';
 }).join('');
}
...
function drawTrail() {
 ...
 ctx.setLineDash([6, 4]);
 ctx.beginPath();
 ctx.moveTo(beacons[0].x, beacons[0].y);
 for (let i = 1; i < beacons.length; i++) {
 ctx.lineTo(beacons[i].x, beacons[i].y);
 }
 ctx.stroke();
 ctx.setLineDash([]);

 // Draw beacons as pulsing dots
 ...
 // Outer glow
 ctx.beginPath();
 ctx.arc(b.x, b.y, radius + 8, 0, Math.PI * 2);
 ctx.fillStyle = accent.replace(')', ', 0.1)').replace('rgb', 'rgba');
 if (ctx.fillStyle === accent) ctx.fillStyle = 'rgba(212,160,60,0.1)';
 ctx.fill();
 ...
 ctx.textAlign = 'center';
 ctx.fillText('#' + b.num, b.x, b.y - radius - 6);
 });

 // Draw follower position
 if (followerPos) {
 drawFollowerArrow(ctx, followerPos.x, followerPos.y, followerPos.angle || 0);
 }
}

function drawFollowerArrow(ctx, x, y, angle) {
 ctx.save();
 ctx.translate(x, y);
 ctx.rotate(angle);
...
function startFollowTrail() {
 if (isFollowing) return;
 if (beacons.length < 2) {
 log(LANG[currentLang].followNoBeacons, 'error');
 playSound('error');
 return;
 }
 ...
 isFollowing = true;
 const s = LANG[currentLang];
 log(s.followStart, 'info');
 setStatus(true);
 showToast(s.followStart, 0);

 let currentIdx = 0;
 let progress = 0;
 var speed = 0.015;

 followerPos = { x: beacons[0].x, y: beacons[0].y, angle: 0 };

 function animate() {
 if (!isFollowing || currentIdx >= beacons.length - 1) {
 isFollowing = false;
 hideToast();
 if (currentIdx >= beacons.length - 1) {
 log(s.followDone, 'success');
 playSound('success');
 }
 setStatus(false);
 drawTrail();
 ...
 if (progress >= 1) {
 progress = 0;
 var reachedMsg = s.reached.replace('{n}', beacons[currentIdx + 1].num);
 log(reachedMsg, 'success');
 currentIdx++;
 if (currentIdx >= beacons.length - 1) {
 followerPos.x = beacons[currentIdx].x;
 followerPos.y = beacons[currentIdx].y;
 drawTrail();
 animate();
 return;
 }
 ...
 var from = beacons[currentIdx];
 var to = beacons[currentIdx + 1];
 followerPos.x = from.x + (to.x - from.x) * progress;
 followerPos.y = from.y + (to.y - from.y) * progress;
 followerPos.angle = Math.atan2(to.y - from.y, to.x - from.x) + Math.PI / 2;

 // Update RSSI for the target beacon based on distance
 var dx = to.x - followerPos.x;
 var dy = to.y - followerPos.y;
 var dist = Math.sqrt(dx * dx + dy * dy);
 to.rssi = simulateRSSI(dist);

 // Log approaching every ~25%
 if (Math.abs(progress - 0.25) < speed || Math.abs(progress - 0.5) < speed || Math.abs(progress - 0.75) < speed) {
 var appMsg = s.approaching.replace('{n}', to.num).replace('{rssi}', to.rssi);
 log(appMsg, 'rx');
 }

 updateBeaconUI();
 drawTrail();
 followAnimId = requestAnimationFrame(animate);
 }

 followAnimId = requestAnimationFrame(animate);
}

// Continuous pulsing animation for beacons
function startBeaconPulseLoop() {
 function pulseFrame() {
 if (beacons.length > 0 && !isFollowing) drawTrail();
