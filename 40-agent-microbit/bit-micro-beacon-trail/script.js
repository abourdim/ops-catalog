...
const LANG = {
  en: {
    ...
    howto_1: 'Click on the trail map to drop beacons along your desired path.',
    howto_2: 'Press "Follow Trail" to watch the position marker navigate between beacons.',
    howto_3: 'Observe the RSSI values in the beacon list — they change as the follower moves.',
    howto_4: 'Use Settings to customize theme, language, and sound effects.',
    ...
    wiki_ibeacon_title: '📍 iBeacon Protocol', wiki_ibeacon: 'iBeacon is Apple\'s BLE beacon standard. Each beacon broadcasts a UUID, major value, and minor value to identify its location and context.',
  ...
  fr: {
    ...
    howto_1: 'Cliquez sur la carte pour poser des balises le long du chemin souhaité.',
    howto_2: 'Appuyez sur "Suivre la piste" pour voir le marqueur naviguer entre les balises.',
    howto_3: 'Observez les valeurs RSSI dans la liste — elles changent à mesure que le suiveur se déplace.',
    howto_4: 'Utilisez les Paramètres pour personnaliser le thème, la langue et les effets sonores.',
  ...
  ar: {
    ...
    howto_1: 'انقر على خريطة المسار لوضع إشارات على طول المسار المطلوب.',
    howto_2: 'اضغط على "تتبع المسار" لمشاهدة مؤشر الموقع ينتقل بين الإشارات.',
    howto_3: 'راقب قيم RSSI في القائمة — تتغير مع تحرك المتتبع.',
    howto_4: 'استخدم الإعدادات لتخصيص المظهر واللغة والمؤثرات الصوتية.',
