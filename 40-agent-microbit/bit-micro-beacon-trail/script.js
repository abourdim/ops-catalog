...
const LANG = {
  ...
  fr: {
    ...
    wiki_indoor_title: '🏢 Navigation intérieure', wiki_indoor: 'La navigation intérieure avec des balises BLE permet de se repérer dans les bâtiments où le GPS est indisponible. La trilatération estime la position.',
