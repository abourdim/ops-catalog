...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-0212D0',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Wrist Communicator \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Wrist Communicator', subtitle: '⌚ send secret messages through tap patterns',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Wrist Communicator — Tap Code', mainDesc: 'Send secret messages through tap patterns',
 ...
 howto_1:'The main display shows the Wrist Communicator simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_tapcode_title: '🔐 Tap Code',
 wiki_tapcode: 'Tap code is a cipher used to encode messages by tapping pairs of numbers that correspond to a row and column in a 5x5 grid. It was famously used by prisoners of war to communicate secretly through walls.',
 wiki_polybius_title: '📐 Polybius Square',
 wiki_polybius: 'The Polybius square is a device invented by the ancient Greek historian Polybius for fractionating plaintext characters so they can be represented by a smaller set of symbols. Each letter is identified by its row and column in a 5x5 grid.',
 wiki_haptic_title: '🤚 Haptic Communication',
 wiki_haptic: 'Haptic communication uses touch to convey information. From Braille to vibration-based wearables, haptic systems allow non-visual, non-auditory message transmission — perfect for covert or accessible communication.',
 wiki_pow_title: '🏛️ POW Communication',
 wiki_pow: 'During the Vietnam War, American POWs used tap code extensively to communicate between cells. They tapped on walls, used broom handles, and even coughed in patterns to spell out messages without guards detecting them.',
 stepA1: 'A 5x5 grid (Polybius square) maps each letter to a (row, column) pair. K is merged with C to fit 26 letters into 25 cells.',
 stepA2: 'To send a letter, tap the row number, pause briefly, then tap the column number. For example, M = row 3, column 2 → tap 3 times, pause, tap 2 times.',
 stepA3: 'The receiver counts the taps before and after the pause, then looks up the letter in the grid to decode it.',
 stepA4: 'Repeat for each letter in the message. A longer pause separates letters. This is the same method POWs used to communicate through walls.',
 labB1: 'Type a message in the input field above and click "Encode" to see its full tap-code sequence.',
 labB2: 'Tap the big TAP button manually — the app counts your taps and decodes each letter using timing gaps.',
 labB3: 'Use the "Play" button to hear the tap sequence with audio beeps. Adjust the speed to practice receiving at different rates.',
 challengeTitle1: 'Challenge 1: Decode by Ear',
 challengeDesc1: 'Click "Play" on an encoded message without looking at the pattern. Listen to the taps and decode the message using only the grid. Can you get it right?',
 challengeTitle2: 'Challenge 2: Speed Encode',
 challengeDesc2: 'Encode your full name by tapping it out on the TAP button in under 30 seconds. Check the decoded output to see if it matches!',
 challengeTitle3: 'Challenge 3: Shorthand Code',
 challengeDesc3: 'Create your own shorthand abbreviations for common words (e.g., "HI" = 2 letters instead of "HELLO" = 5). Design a codebook and test it with a partner!',
 tapBtn: 'TAP',
 encodeBtn: 'Encode',
 playBtn: 'Play',
 speedLabel: 'Speed:',
 ...
 tapRow: 'Row',
 tapCol: 'Col',
 decodedLetter: 'Decoded',
 encodedMsg: 'Encoded tap sequence',
 playing: 'Playing...',
 playDone: 'Playback complete',
 tapReset: 'Tap input reset',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '⌚ Wrist Communicator ready!',
 ...
 theory: 'Wrist Communicator demonstrates key principles from autonomous agents. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 title: 'Wrist Communicator', subtitle: '⌚ envoyer des messages secrets par tapotements',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Communicateur Poignet — Code Tap', mainDesc: 'Envoyez des messages secrets par tapotements',
 ...
 wiki_tapcode_title: '🔐 Code Tap',
 wiki_tapcode: 'Le code tap est un chiffre utilisé pour encoder des messages en tapant des paires de nombres correspondant à une ligne et une colonne dans une grille 5x5. Il a été célèbrement utilisé par les prisonniers de guerre pour communiquer secrètement à travers les murs.',
 wiki_polybius_title: '📐 Carré de Polybe',
 wiki_polybius: 'Le carré de Polybe est un dispositif inventé par l\'historien grec ancien Polybe pour fractionner les caractères en clair afin qu\'ils puissent être représentés par un plus petit ensemble de symboles.',
 wiki_haptic_title: '🤚 Communication Haptique',
 wiki_haptic: 'La communication haptique utilise le toucher pour transmettre de l\'information. Du Braille aux wearables à vibration, les systèmes haptiques permettent la transmission de messages non-visuelle et non-auditive.',
 wiki_pow_title: '🏛️ Communication des Prisonniers de Guerre',
 wiki_pow: 'Pendant la guerre du Vietnam, les prisonniers de guerre américains utilisaient intensivement le code tap pour communiquer entre cellules. Ils tapaient sur les murs et même toussaient en motifs pour épeler des messages.',
 stepA1: 'Une grille 5x5 (carré de Polybe) associe chaque lettre à une paire (ligne, colonne). K est fusionné avec C pour faire tenir 26 lettres dans 25 cases.',
 stepA2: 'Pour envoyer une lettre, tapez le numéro de ligne, faites une courte pause, puis tapez le numéro de colonne. Par exemple, M = ligne 3, colonne 2 → tapez 3 fois, pause, tapez 2 fois.',
 stepA3: 'Le récepteur compte les taps avant et après la pause, puis cherche la lettre dans la grille pour la décoder.',
 stepA4: 'Répétez pour chaque lettre du message. Une pause plus longue sépare les lettres. C\'est la même méthode utilisée par les prisonniers de guerre pour communiquer à travers les murs.',
 labB1: 'Tapez un message dans le champ ci-dessus et cliquez "Encoder" pour voir sa séquence tap complète.',
 labB2: 'Tapez le gros bouton TAP manuellement — l\'appli compte vos taps et décode chaque lettre grce aux intervalles de temps.',
 labB3: 'Utilisez le bouton "Jouer" pour entendre la séquence avec des bips audio. Ajustez la vitesse pour vous entraîner à recevoir à différents rythmes.',
 challengeTitle1: 'Défi 1 : Décoder à l\'Oreille',
 challengeDesc1: 'Cliquez "Jouer" sur un message encodé sans regarder le motif. Écoutez les taps et décodez le message en utilisant seulement la grille.',
 challengeTitle2: 'Défi 2 : Encodage Rapide',
 challengeDesc2: 'Encodez votre nom complet en tapant sur le bouton TAP en moins de 30 secondes. Vérifiez la sortie décodée !',
 challengeTitle3: 'Défi 3 : Code Abrégé',
 challengeDesc3: 'Créez vos propres abréviations pour les mots courants (ex : "SLT" = 3 lettres au lieu de "SALUT" = 5). Concevez un livre de codes et testez-le avec un partenaire !',
 tapBtn: 'TAP',
 encodeBtn: 'Encoder',
 playBtn: 'Jouer',
 speedLabel: 'Vitesse :',
 ...
 speedMedium: 'Moyen',
 speedFast: 'Rapide',
 sendPlaceholder: 'Tapez un message...',
 tapRow: 'Ligne',
 tapCol: 'Col',
 decodedLetter: 'Décodé',
 encodedMsg: 'Séquence tap encodée',
 playing: 'Lecture...',
 playDone: 'Lecture terminée',
 tapReset: 'Saisie tap réinitialisée',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '⌚ Communicateur Poignet prêt !',
 ...
 theory: 'Wrist Communicator démontre les principes clés de agents autonomes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Wrist Communicator', subtitle: '⌚ أرسل رسائل سرية عبر أنماط النقر',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'جهاز المعصم — رمز النقر', mainDesc: 'أرسل رسائل سرية عبر أنماط النقر',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Wrist Communicator. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_tapcode_title: '🔐 رمز النقر',
 wiki_tapcode: 'رمز النقر هو شفرة تستخدم لترميز الرسائل عن طريق النقر على أزواج من الأرقام تتوافق مع صف وعمود في شبكة 5×5. استخدمه أسرى الحرب بشكل مشهور للتواصل سرًا عبر الجدران.',
 wiki_polybius_title: '📐 مربع بوليبيوس',
 wiki_polybius: 'مربع بوليبيوس هو جهاز اخترعه المؤرخ اليوناني القديم بوليبيوس لتجزئة أحرف النص العادي بحيث يمكن تمثيلها بمجموعة أصغر من الرموز.',
 wiki_haptic_title: '🤚 التواصل اللمسي',
 wiki_haptic: 'التواصل اللمسي يستخدم اللمس لنقل المعلومات. من بريل إلى الأجهزة القابلة للارتداء بالاهتزاز، تسمح الأنظمة اللمسية بنقل الرسائل بدون رؤية أو سمع.',
 wiki_pow_title: '🏛️ تواصل أسرى الحرب',
 wiki_pow: 'خلال حرب فيتنام، استخدم أسرى الحرب الأمريكيون رمز النقر بشكل مكثف للتواصل بين الزنازين. كانوا ينقرون على الجدران ويسعلون بأنماط لتهجئة الرسائل.',
 stepA1: 'شبكة 5×5 (مربع بوليبيوس) تربط كل حرف بزوج (صف، عمود). يتم دمج K مع C لتناسب 26 حرفًا في 25 خلية.',
 stepA2: 'لإرسال حرف، انقر رقم الصف، توقف قليلاً، ثم انقر رقم العمود. مثلاً، M = صف 3، عمود 2 → انقر 3 مرات، توقف، انقر مرتين.',
 stepA3: 'يعدّ المستقبل النقرات قبل وبعد التوقف، ثم يبحث عن الحرف في الشبكة لفك ترميزه.',
 stepA4: 'كرر لكل حرف في الرسالة. توقف أطول يفصل الحروف. هذه نفس الطريقة التي استخدمها أسرى الحرب للتواصل عبر الجدران.',
 labB1: 'اكتب رسالة في حقل الإدخال أعلاه وانقر "ترميز" لرؤية تسلسل النقر الكامل.',
 labB2: 'اضغط زر TAP الكبير يدويًا — التطبيق يعد نقراتك ويفك ترميز كل حرف باستخدام فجوات التوقيت.',
 labB3: 'استخدم زر "تشغيل" لسماع تسلسل النقر مع أصوات بيب. اضبط السرعة للتمرن على الاستقبال بمعدلات مختلفة.',
 challengeTitle1: 'التحدي 1: فك الترميز بالأذن',
 challengeDesc1: 'انقر "تشغيل" على رسالة مرمّزة دون النظر إلى النمط. استمع للنقرات وفك ترميز الرسالة باستخدام الشبكة فقط.',
 challengeTitle2: 'التحدي 2: الترميز السريع',
 challengeDesc2: 'رمّز اسمك الكامل بالنقر على زر TAP في أقل من 30 ثانية. تحقق من المخرجات المفكوكة لمعرفة إن كانت تتطابق!',
 challengeTitle3: 'التحدي 3: رمز مختصر',
 challengeDesc3: 'ابتكر اختصاراتك الخاصة للكلمات الشائعة. صمم كتاب رموز واختبره مع شريك!',
 tapBtn: 'انقر',
 encodeBtn: 'ترميز',
 playBtn: 'تشغيل',
 speedLabel: 'السرعة:',
 ...
 tapCol: 'عمود',
 decodedLetter: 'مفكوك',
 encodedMsg: 'تسلسل النقر المرمّز',
 playing: 'جارٍ التشغيل...',
 playDone: 'انتهى التشغيل',
 tapReset: 'تم إعادة تعيين إدخال النقر',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '⌚ جهاز المعصم جاهز!',
 ...
 theory: 'Wrist Communicator يوضح المبادئ الأساسية في الوكلاء المستقلون. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
function setLanguage(lang) {
 ...
 if (sendInput && s.sendPlaceholder) sendInput.placeholder = s.sendPlaceholder;
...
// Polybius square: 5x5 grid, A-Z with K merged into C
const POLYBIUS = [
 ['A','B','C','D','E'],
 ['F','G','H','I','J'],
 ['L','M','N','O','P'],
...
const LETTER_POS = {};
POLYBIUS.forEach((row, r) => {
 row.forEach((ch, c) => {
 LETTER_POS[ch] = { row: r + 1, col: c + 1 };
 });
});
LETTER_POS['K'] = LETTER_POS['C']; // K merged with C

// Decode (row, col) → letter (1-indexed)
function decodeTap(row, col) {
 if (row < 1 || row > 5 || col < 1 || col > 5) return null;
 return POLYBIUS[row - 1][col - 1];
}

// Encode text → array of {letter, row, col}
function encodeText(text) {
 const result = [];
 const upper = text.toUpperCase().replace(/[^A-Z ]/g, '');
 for (const ch of upper) {
 if (ch === '') {
 result.push({ letter: '', row: 0, col: 0 });
 } else {
 const pos = LETTER_POS[ch];
 if (pos) result.push({ letter: ch === 'K' ? 'C(K)' : ch, row: pos.row, col: pos.col });
 }
 }
 return result;
}

// Format encoded array to display string
function formatEncoded(encoded) {
 return encoded.map(e => e.row === 0 ? '/' : `${e.row},${e.col}`).join('');
}

// Build the 5x5 grid in the DOM
function buildTapGrid() {
 const grid = $('tapGrid');
 if (!grid) return;
 grid.innerHTML = '';
 // Header row: empty + col numbers
 const empty = document.createElement('div');
 empty.className = 'tap-cell header-cell';
 empty.textContent = '';
 grid.appendChild(empty);
 for (let c = 1; c <= 5; c++) {
 const hdr = document.createElement('div');
 hdr.className = 'tap-cell header-cell';
 hdr.textContent = c;
 ...
 rh.className = 'tap-cell header-cell';
 rh.textContent = r + 1;
 grid.appendChild(rh);
 // Cells
 for (let c = 0; c < 5; c++) {
...
function highlightCell(row, col) {
 document.querySelectorAll('.tap-cell.highlight').forEach(c => c.classList.remove('highlight'));
 if (row < 1 || col < 1) return;
 const cell = document.querySelector(`.tap-cell[data-row="${row}"][data-col="${col}"]`);
 if (cell) cell.classList.add('highlight');
}

// Clear highlight after delay
function clearHighlight(ms) {
 setTimeout(() => {
 document.querySelectorAll('.tap-cell.highlight').forEach(c => c.classList.remove('highlight'));
 }, ms || 1200);
}

// Play a short beep for a tap
...
// ── Tap input state machine ──
let tapCount = 0;
let tapPhase = 'row'; // 'row' or 'col'
let tapRowVal = 0;
let tapColVal = 0;
let tapGapTimer = null;
let tapLetterTimer = null;
let decodedMessage = '';
let isPlaying = false;

const GAP_MS = 600; // pause between row and col taps
const LETTER_MS = 1400; // pause between letters
...
function handleTap() {
 ...
 // Clear timers
 if (tapGapTimer) clearTimeout(tapGapTimer);
 if (tapLetterTimer) clearTimeout(tapLetterTimer);

 // After GAP_MS of silence, transition from row→col or col→decode
 tapGapTimer = setTimeout(() => {
 if (tapPhase === 'row') {
 tapRowVal = Math.min(tapCount, 5);
 tapCount = 0;
 tapPhase = 'col';
 updateTapDisplay();
 // After LETTER_MS of no further taps, reset (timeout)
 tapLetterTimer = setTimeout(() => {
 resetTapInput();
 }, LETTER_MS + GAP_MS);
 } else {
 // col phase done → decode
 tapColVal = Math.min(tapCount, 5);
 tapCount = 0;
 const letter = decodeTap(tapRowVal, tapColVal);
 if (letter) {
 decodedMessage += letter;
 highlightCell(tapRowVal, tapColVal);
 clearHighlight(1200);
 const s = LANG[currentLang];
 const patternEl = $('tapPattern');
 if (patternEl) patternEl.textContent = `${tapRowVal},${tapColVal} = ${letter}`;
 const msgEl = $('decodedMsg');
 if (msgEl) msgEl.textContent = decodedMessage;
 log(`🔓 ${tapRowVal},${tapColVal} → ${letter}`, 'rx');
 }
 tapPhase = 'row';
 tapRowVal = 0;
 tapColVal = 0;
...
function updateTapDisplay() {
 ...
 if (!patternEl) return;
 const s = LANG[currentLang];
 if (tapPhase === 'row' && tapCount > 0) {
 patternEl.textContent = `${s.tapRow}: ${'● '.repeat(tapCount).trim()}`;
 } else if (tapPhase === 'col' && tapCount === 0) {
 patternEl.textContent = `${s.tapRow}: ${tapRowVal} → ${s.tapCol}: ...`;
 } else if (tapPhase === 'col' && tapCount > 0) {
 patternEl.textContent = `${s.tapRow}: ${tapRowVal} → ${s.tapCol}: ${'● '.repeat(tapCount).trim()}`;
 }
}

function resetTapInput() {
 tapCount = 0;
 tapPhase = 'row';
 tapRowVal = 0;
 tapColVal = 0;
 if (tapGapTimer) { clearTimeout(tapGapTimer); tapGapTimer = null; }
 if (tapLetterTimer) { clearTimeout(tapLetterTimer); tapLetterTimer = null; }
}

// ── Encode text from input ──
function encodeInputMessage() {
 const input = $('sendInput');
 if (!input || !input.value.trim()) return;
 const text = input.value.trim();
 const encoded = encodeText(text);
 const display = formatEncoded(encoded);
 const patternEl = $('encodedPattern');
 if (patternEl) patternEl.textContent = display;
 log(`🔐 Encoded "${text.toUpperCase()}" → ${display}`, 'tx');
 playSound('success');
 // Store for playback
 window._lastEncoded = encoded;
}

// ── Playback: auto-play tap sequence ──
async function playTapSequence() {
 const encoded = window._lastEncoded;
 if (!encoded || encoded.length === 0) return;
 if (isPlaying) return;
 isPlaying = true;
 const s = LANG[currentLang];
 showToast(s.playing, 0);
 log('▶ ' + s.playing, 'info');

 const speedSel = $('tapSpeed');
 const speed = speedSel ? speedSel.value : 'medium';
 const tapDelay = speed === 'slow' ? 400 : speed === 'fast' ? 120 : 220;
 const gapDelay = speed === 'slow' ? 700 : speed === 'fast' ? 250 : 400;
 const letterDelay = speed === 'slow' ? 1200 : speed === 'fast' ? 500 : 800;
 ...
 playTapBeep();
 const tapAreaEl = $('tapArea');
 if (tapAreaEl) { tapAreaEl.style.transform = 'scale(0.92)'; }
 await sleep(tapDelay / 2);
 if (tapAreaEl) { tapAreaEl.style.transform = ''; }
 await sleep(tapDelay / 2);
 }
 // Gap
 ...
 const patternEl = $('tapPattern');
 if (patternEl) patternEl.textContent = `${item.row},${item.col} = ${item.letter}`;
 await sleep(letterDelay);
 clearHighlight(0);
 }
...
function initTapCode() {
 ...
 if (tapArea) {
 tapArea.addEventListener('mousedown', e => { e.preventDefault(); handleTap(); });
 tapArea.addEventListener('touchstart', e => { e.preventDefault(); handleTap(); }, { passive: false });
 }

 // Encode button
 const encBtn = $('encodeBtn');
 if (encBtn) encBtn.addEventListener('click', encodeInputMessage);

 // Enter key in input
 const sendInput = $('sendInput');
 if (sendInput) sendInput.addEventListener('keydown', e => {
 if (e.key === 'Enter') encodeInputMessage();
 });

 // Playback button
 const playBtn = $('playbackBtn');
 if (playBtn) playBtn.addEventListener('click', playTapSequence);

 // Double-click tap area to reset decoded message
 if (tapArea) tapArea.addEventListener('dblclick', () => {
 decodedMessage = '';
 const msgEl = $('decodedMsg');
 ...
 resetTapInput();
 log(LANG[currentLang].tapReset, 'info');
 });
}
