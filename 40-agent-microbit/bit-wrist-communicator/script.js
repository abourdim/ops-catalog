...
const LANG = {
  en: {
    ...
    howto_1: 'Look at the 5x5 grid to find your letter\'s row and column position.',
    howto_2: 'Tap the big TAP button: tap the row count, wait a moment, then tap the column count.',
    howto_3: 'Watch the decoded letter appear. A longer pause starts the next letter.',
    howto_4: 'Or type a message and click "Encode" to see and hear the full tap sequence.',
  ...
  fr: {
    ...
    howto_1: 'Regardez la grille 5x5 pour trouver la position ligne/colonne de votre lettre.',
    howto_2: 'Tapez le gros bouton TAP : tapez le nombre de lignes, attendez, puis tapez le nombre de colonnes.',
    howto_3: 'Regardez la lettre décodée apparaître. Une pause plus longue commence la lettre suivante.',
    howto_4: 'Ou tapez un message et cliquez "Encoder" pour voir et entendre la séquence complète.',
  ...
  ar: {
    ...
    howto_1: 'انظر إلى الشبكة 5×5 لإيجاد موقع الصف والعمود لحرفك.',
    howto_2: 'اضغط زر TAP الكبير: انقر عدد الصف، انتظر لحظة، ثم انقر عدد العمود.',
    howto_3: 'شاهد الحرف المفكوك يظهر. توقف أطول يبدأ الحرف التالي.',
    howto_4: 'أو اكتب رسالة وانقر "ترميز" لرؤية وسماع تسلسل النقر الكامل.',
