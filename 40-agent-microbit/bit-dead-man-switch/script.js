...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-8F4488',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Dead Man Switch \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Dead Man Switch', subtitle: '💀 Dead Man\'s Switch — Motion Monitor',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Dead Man\'s Switch — Motion Monitor',
 mainDesc: 'Alert when movement stops — safety watchdog system',
 ...
 howto_1:'The main display shows the Dead Man Switch simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_dms_title: '💀 Dead Man\'s Switch',
 wiki_dms: 'A fail-safe mechanism requiring continuous operator input. If input stops, the system assumes the operator is incapacitated and triggers a safety response.',
 wiki_watchdog_title: '⏱️ Watchdog Timers',
 wiki_watchdog: 'A hardware or software timer that must be periodically reset. If not reset in time, it triggers a corrective action — used in embedded systems to detect crashes.',
 wiki_inactivity_title: '📡 Inactivity Detection',
 wiki_inactivity: 'Using sensors (accelerometer, gyroscope) to detect lack of movement. Thresholds define what counts as motion vs. stillness.',
 wiki_safety_title: '🛡️ Safety Systems',
 wiki_safety: 'Engineered systems designed to prevent harm: automatic shutoffs, emergency alerts, redundant controls, and fail-safe defaults protect operators and bystanders.',
 howItWorks_1: 'The accelerometer continuously monitors movement intensity and direction.',
 howItWorks_2: 'A watchdog timer resets every time motion is detected above the threshold.',
 howItWorks_3: 'If the timer expires (no motion detected), an emergency alert is triggered.',
 howItWorks_4: 'The alert broadcasts location data and an SOS signal via radio.',
 lab_1: 'Test with different timeout values (5s to 60s) using the slider.',
 lab_2: 'Use mouse movement over the canvas as a motion simulation input.',
 lab_3: 'Observe the ACTIVE to WARNING to ALERT state transition in real time.',
 lab_4: 'Configure sensitivity: fast movements reset the timer, slow ones may not.',
 challenge_1: 'Set the timeout to 10 seconds and trigger the alert at exactly 0:00.',
 challenge_2: 'Keep the switch alive for 2 full minutes using only mouse movement.',
 challenge_3: 'Design a two-stage alert: WARNING beep at 50%, full ALERT at 0%.',
 motionGraphLabel: 'Motion Activity',
 statusActive: 'ACTIVE', statusWarning: 'WARNING', statusAlert: 'ALERT TRIGGERED',
 timeoutLabel: 'Timeout:',
 activateBtn: 'Activate Switch', deactivateBtn: 'Deactivate', moveSimBtn: 'Simulate Movement',
 alertLogLabel: 'Alert Log', noAlerts: 'No alerts yet',
 switchActivated: '🟢 Dead Man\'s Switch ACTIVATED',
 switchDeactivated: '🔴 Dead Man\'s Switch deactivated',
 motionDetected: '📳 Motion detected — timer reset',
 warningState: '⚠️ WARNING — movement slowing!',
 alertTriggered: '🚨 ALERT TRIGGERED — no motion detected!',
 sosBroadcast: '📡 SOS broadcast sent — emergency signal!',
 simMotion: '🖱️ Simulated motion injected',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '💀 Dead Man\'s Switch ready!',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-8F4488',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Dead Man Switch \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Dead Man Switch', subtitle: '💀 Interrupteur d\'Homme Mort — Moniteur de Mouvement',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Interrupteur d\'Homme Mort — Moniteur de Mouvement',
 mainDesc: 'Alerte quand le mouvement s\'arrête — système de surveillance',
 sectionA: 'Comment ça marche', sectionB: 'Laboratoire', sectionC: 'Défi',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Dead Man Switch. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_dms_title: '💀 Interrupteur d\'Homme Mort',
 wiki_dms: 'Un mécanisme de sécurité nécessitant une entrée continue de l\'opérateur. Si l\'entrée s\'arrête, le système suppose que l\'opérateur est incapacité.',
 wiki_watchdog_title: '⏱️ Minuteurs de Surveillance',
 wiki_watchdog: 'Un minuteur matériel ou logiciel qui doit être réinitialisé périodiquement. Utilisé dans les systèmes embarqués pour détecter les plantages.',
 wiki_inactivity_title: '📡 Détection d\'Inactivité',
 wiki_inactivity: 'Utilisation de capteurs (accéléromètre, gyroscope) pour détecter l\'absence de mouvement. Les seuils définissent ce qui compte comme mouvement.',
 wiki_safety_title: '🛡️ Systèmes de Sécurité',
 wiki_safety: 'Systèmes conçus pour prévenir les dommages : arrêts automatiques, alertes d\'urgence, contrôles redondants et défauts de sécurité.',
 howItWorks_1: 'L\'accéléromètre surveille en continu l\'intensité et la direction du mouvement.',
 howItWorks_2: 'Un minuteur de surveillance se réinitialise à chaque mouvement détecté au-dessus du seuil.',
 howItWorks_3: 'Si le minuteur expire (aucun mouvement détecté), une alerte d\'urgence est déclenchée.',
 howItWorks_4: 'L\'alerte diffuse les données de localisation et un signal SOS par radio.',
 lab_1: 'Testez avec différentes valeurs de délai (5s à 60s) avec le curseur.',
 lab_2: 'Utilisez le mouvement de la souris sur le canvas comme simulation de mouvement.',
 lab_3: 'Observez la transition ACTIF → ATTENTION → ALERTE en temps réel.',
 lab_4: 'Configurez la sensibilité : mouvements rapides réinitialisent, lents peut-être pas.',
 challenge_1: 'Réglez le délai à 10 secondes et déclenchez l\'alerte à exactement 0:00.',
 challenge_2: 'Maintenez l\'interrupteur actif pendant 2 minutes avec la souris uniquement.',
 challenge_3: 'Concevez une alerte à deux étapes : BIP d\'avertissement à 50%, ALERTE complète à 0%.',
 motionGraphLabel: 'Activité de Mouvement',
 statusActive: 'ACTIF', statusWarning: 'ATTENTION', statusAlert: 'ALERTE DÉCLENCHÉE',
 timeoutLabel: 'Délai :',
 activateBtn: 'Activer', deactivateBtn: 'Désactiver', moveSimBtn: 'Simuler Mouvement',
 alertLogLabel: 'Journal d\'Alertes', noAlerts: 'Aucune alerte',
 switchActivated: '🟢 Interrupteur d\'Homme Mort ACTIVÉ',
 switchDeactivated: '🔴 Interrupteur d\'Homme Mort désactivé',
 motionDetected: '📳 Mouvement détecté — minuteur réinitialisé',
 warningState: '⚠️ ATTENTION — mouvement ralentit !',
 alertTriggered: '🚨 ALERTE DÉCLENCHÉE — aucun mouvement détecté !',
 sosBroadcast: '📡 Signal SOS envoyé — urgence !',
 simMotion: '🖱️ Mouvement simulé injecté',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '💀 Interrupteur d\'Homme Mort prêt !',
 ...
 theory: 'Dead Man Switch démontre les principes clés de agents autonomes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'مفتاح الرجل الميت', subtitle: '💀 مفتاح الرجل الميت — مراقب الحركة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مفتاح الرجل الميت — مراقب الحركة',
 mainDesc: 'تنبيه عند توقف الحركة — نظام مراقبة السلامة',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Dead Man Switch. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_dms_title: '💀 مفتاح الرجل الميت',
 wiki_dms: 'آلية أمان تتطلب إدخالًا مستمرًا من المشغّل. إذا توقف الإدخال، يفترض النظام أن المشغّل عاجز ويُطلق استجابة أمان.',
 wiki_watchdog_title: '⏱️ مؤقتات المراقبة',
 wiki_watchdog: 'مؤقت يجب إعادة ضبطه دوريًا. إذا لم يُعاد ضبطه في الوقت المحدد، يُطلق إجراءً تصحيحيًا — يُستخدم في الأنظمة المدمجة.',
 wiki_inactivity_title: '📡 كشف عدم النشاط',
 wiki_inactivity: 'استخدام أجهزة الاستشعار (مقياس التسارع، الجيروسكوب) لكشف عدم الحركة. العتبات تحدد ما يُعتبر حركة مقابل سكون.',
 wiki_safety_title: '🛡️ أنظمة السلامة',
 wiki_safety: 'أنظمة مصممة لمنع الأذى: إيقاف تلقائي، تنبيهات طوارئ، تحكم مكرر، وإعدادات افتراضية آمنة.',
 howItWorks_1: 'يراقب مقياس التسارع باستمرار شدة واتجاه الحركة.',
 howItWorks_2: 'يُعاد ضبط مؤقت المراقبة في كل مرة يُكتشف فيها حركة فوق العتبة.',
 howItWorks_3: 'إذا انتهت مهلة المؤقت (لم تُكتشف حركة)، يُطلق تنبيه طوارئ.',
 howItWorks_4: 'يبث التنبيه بيانات الموقع وإشارة SOS عبر الراديو.',
 lab_1: 'اختبر بقيم مهلة مختلفة (5 إلى 60 ثانية) باستخدام الشريط.',
 lab_2: 'استخدم حركة الماوس فوق اللوحة كمحاكاة للحركة.',
 lab_3: 'لاحظ الانتقال من نشط إلى تحذير إلى تنبيه في الوقت الفعلي.',
 lab_4: 'اضبط الحساسية: الحركات السريعة تُعيد الضبط، البطيئة قد لا تفعل.',
 challenge_1: 'اضبط المهلة على 10 ثوانٍ وأطلق التنبيه عند 0:00 بالضبط.',
 challenge_2: 'حافظ على المفتاح نشطًا لمدة دقيقتين كاملتين باستخدام الماوس فقط.',
 challenge_3: 'صمم تنبيهًا من مرحلتين: صفير تحذيري عند 50%، تنبيه كامل عند 0%.',
 motionGraphLabel: 'نشاط الحركة',
 statusActive: 'نشط', statusWarning: 'تحذير', statusAlert: 'تم إطلاق التنبيه',
 timeoutLabel: 'المهلة:',
 activateBtn: 'تفعيل', deactivateBtn: 'إلغاء التفعيل', moveSimBtn: 'محاكاة حركة',
 alertLogLabel: 'سجل التنبيهات', noAlerts: 'لا توجد تنبيهات بعد',
 switchActivated: '🟢 مفتاح الرجل الميت مُفعَّل',
 switchDeactivated: '🔴 مفتاح الرجل الميت مُعطَّل',
 motionDetected: '📳 تم اكتشاف حركة — إعادة ضبط المؤقت',
 warningState: '⚠️ تحذير — الحركة تتباطأ!',
 alertTriggered: '🚨 تم إطلاق التنبيه — لم يُكتشف أي حركة!',
 sosBroadcast: '📡 تم إرسال بث SOS — إشارة طوارئ!',
 simMotion: '🖱️ تم حقن حركة محاكاة',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '💀 مفتاح الرجل الميت جاهز!',
 ...
 theory: 'Dead Man Switch يوضح المبادئ الأساسية في الوكلاء المستقلون. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
let dmsActive = false;
let dmsTimeout = 15; // seconds
let dmsRemaining = 15;
let dmsInterval = null;
let dmsState = 'active'; // 'active' | 'warning' | 'alert'
let motionData = [];
...
function initDeadManSwitch() {
 ...
 // Fill with initial empty data
 for (let i = 0; i < motionCanvas.width; i++) motionData.push(0);
 drawMotionGraph();

 // Mouse movement over canvas = motion input
 motionCanvas.addEventListener('mousemove', (e) => {
 if (!dmsActive) return;
 const rect = motionCanvas.getBoundingClientRect();
 const dx = e.movementX || 0;
 const dy = e.movementY || 0;
 const mag = Math.min(Math.sqrt(dx * dx + dy * dy) / 5, 1);
 if (mag > 0.1) {
 onMotionDetected(mag);
 }
 });

 // Also respond to touch on mobile
 motionCanvas.addEventListener('touchmove', (e) => {
 if (!dmsActive) return;
 onMotionDetected(0.7);
 }, { passive: true });

 window.addEventListener('resize', () => {
 if (!motionCanvas) return;
 motionCanvas.width = motionCanvas.offsetWidth;
 while (motionData.length < motionCanvas.width) motionData.push(0);
 });
 }

 // DeviceMotion API for real accelerometer data
 if (window.DeviceMotionEvent) {
 window.addEventListener('devicemotion', (e) => {
 if (!dmsActive) return;
 const acc = e.accelerationIncludingGravity;
 if (!acc) return;
 const mag = Math.sqrt(acc.x * acc.x + acc.y * acc.y + acc.z * acc.z) - 9.8;
 if (Math.abs(mag) > 2) {
 onMotionDetected(Math.min(Math.abs(mag) / 15, 1));
 }
 });
 }

 // Timeout slider
 const slider = $('timeoutSlider');
 const valDisplay = $('timeoutValue');
 if (slider) {
 slider.addEventListener('input', () => {
 dmsTimeout = parseInt(slider.value);
 if (valDisplay) valDisplay.textContent = dmsTimeout;
 if (dmsActive && dmsState !== 'alert') {
 dmsRemaining = dmsTimeout;
 updateTimerDisplay();
 }
 });
 }
 ...
 const simBtn = $('moveSimBtn');

 if (actBtn) actBtn.addEventListener('click', () => { activateSwitch(); playSound('click'); });
 if (deactBtn) deactBtn.addEventListener('click', () => { deactivateSwitch(); playSound('click'); });
 if (simBtn) simBtn.addEventListener('click', () => { simulateMotion(); playSound('click'); });

 // Start the motion graph animation loop
 requestAnimationFrame(motionAnimLoop);
}
...
function activateSwitch() {
 ...
 dmsRemaining = dmsTimeout;
 dmsState = 'active';
 updateSwitchState('active');
 log(LANG[currentLang].switchActivated, 'success');
 setStatus(true);

 dmsInterval = setInterval(() => {
 if (!dmsActive) return;
 dmsRemaining = Math.max(0, dmsRemaining - 0.1);
 updateTimerDisplay();

 // State transitions
 const pct = dmsRemaining / dmsTimeout;
 if (pct <= 0) {
 if (dmsState !== 'alert') triggerAlert();
 } else if (pct <= 0.2 && dmsState === 'active') {
 dmsState = 'warning';
 updateSwitchState('warning');
 log(LANG[currentLang].warningState, 'error');
 playSound('error');
 }
 }, 100);
}
...
function deactivateSwitch() {
 dmsActive = false;
 if (dmsInterval) { clearInterval(dmsInterval); dmsInterval = null; }
 dmsState = 'active';
 dmsRemaining = dmsTimeout;
 updateSwitchState('active');
 updateTimerDisplay();
 log(LANG[currentLang].switchDeactivated, 'info');
 setStatus(false);
}

function onMotionDetected(magnitude) {
 if (!dmsActive || dmsState === 'alert') return;
 motionMagnitude = Math.max(motionMagnitude, magnitude);
 const now = Date.now();
 // Throttle logging
 if (now - lastMotionTime > 2000) {
 lastMotionTime = now;
 log(LANG[currentLang].motionDetected, 'info');
 }
 // Reset watchdog
 dmsRemaining = dmsTimeout;
 if (dmsState === 'warning') {
...
function simulateMotion() {
 if (!dmsActive) return;
 motionMagnitude = 0.8;
 onMotionDetected(0.8);
 log(LANG[currentLang].simMotion, 'tx');
}

function triggerAlert() {
 dmsState = 'alert';
 dmsRemaining = 0;
 updateSwitchState('alert');
 updateTimerDisplay();
 log(LANG[currentLang].alertTriggered, 'error');
 playSound('error');

 // SOS broadcast simulation
 setTimeout(() => {
 log(LANG[currentLang].sosBroadcast, 'tx');
 sendAppMessage('SOS', { status: 'alert', timestamp: new Date().toISOString() });
 }, 500);
 ...
 // Stop the interval, require manual reactivation
 if (dmsInterval) { clearInterval(dmsInterval); dmsInterval = null; }
 dmsActive = false;
}

function addAlertLogEntry() {
 const alertLog = $('alertLog');
 if (!alertLog) return;
 // Remove "no alerts" placeholder
 const placeholder = alertLog.querySelector('[data-i18n="noAlerts"]');
 if (placeholder) placeholder.remove();

 const entry = document.createElement('div');
 entry.className = 'alert-entry';
 const ts = new Date().toLocaleTimeString();
 entry.textContent = `[${ts}] ${LANG[currentLang].alertTriggered}`;
...
function playAlarmSound() {
 ...
 gain.gain.value = 0.08;
 gain.gain.exponentialRampToValueAtTime(0.001, t + 0.25 + i * 0.25);
 osc.start(t + i * 0.25);
 osc.stop(t + 0.25 + i * 0.25);
 }
}

function updateSwitchState(state) {
 const statusEl = $('switchStatus');
 const timerEl = $('watchdogTimer');
 const s = LANG[currentLang];
 if (statusEl) {
 statusEl.className = 'switch-status state-' + state;
 if (state === 'active') statusEl.textContent = s.statusActive;
 else if (state === 'warning') statusEl.textContent = s.statusWarning;
 else if (state === 'alert') statusEl.textContent = s.statusAlert;
 }
 if (timerEl) {
 timerEl.className = 'watchdog-timer state-' + state;
 }
}
...
function updateTimerDisplay() {
 const timerEl = $('watchdogTimer');
 if (!timerEl) return;
 const secs = Math.ceil(dmsRemaining);
...
function drawMotionGraph() {
 ...
 // Draw grid lines
 motionCtx.strokeStyle = 'rgba(255,255,255,0.05)';
 motionCtx.lineWidth = 1;
 for (let y = 0; y < h; y += 30) {
 motionCtx.beginPath();
 motionCtx.moveTo(0, y);
 motionCtx.lineTo(w, y);
 motionCtx.stroke();
 }

 // Draw threshold line at 10%
 motionCtx.strokeStyle = 'rgba(255,152,0,0.3)';
 motionCtx.setLineDash([4, 4]);
 motionCtx.beginPath();
 motionCtx.moveTo(0, h - h * 0.1);
 motionCtx.lineTo(w, h - h * 0.1);
 motionCtx.stroke();
 motionCtx.setLineDash([]);

 // Draw motion line
 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#4caf50';
 motionCtx.strokeStyle = dmsState === 'alert' ? '#f44336' : dmsState === 'warning' ? '#ff9800' : accent;
 motionCtx.lineWidth = 2;
 motionCtx.beginPath();
 const startIdx = Math.max(0, motionData.length - w);
 for (let i = startIdx; i < motionData.length; i++) {
 const x = i - startIdx;
 const y = h - motionData[i] * h * 0.9;
 if (i === startIdx) motionCtx.moveTo(x, y);
 else motionCtx.lineTo(x, y);
 }
 motionCtx.stroke();

 // Fill under the line
 motionCtx.lineTo(w, h);
 motionCtx.lineTo(0, h);
 motionCtx.closePath();
 motionCtx.fillStyle = (dmsState === 'alert' ? 'rgba(244,67,54,0.1)' : dmsState === 'warning' ? 'rgba(255,152,0,0.1)' : 'rgba(76,175,80,0.1)');
 motionCtx.fill();
}

function motionAnimLoop() {
 // Push new data point
 const decay = motionMagnitude * 0.8;
 motionData.push(motionMagnitude);
 motionMagnitude *= 0.85; // decay
 if (motionMagnitude < 0.01) motionMagnitude = 0;

 // Keep array bounded
 if (motionData.length > 2000) motionData.splice(0, motionData.length - 2000);
