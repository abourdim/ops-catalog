...
const LANG = {
  en: {
    ...
    howto_1: 'Click "Activate Switch" to start the watchdog timer.',
    howto_2: 'Move your mouse over the motion canvas to simulate movement.',
    howto_3: 'Watch the timer count down — it resets on detected motion.',
    howto_4: 'If the timer reaches zero, the alert triggers with sound and log entry.',
  ...
  fr: {
    ...
    howto_1: 'Cliquez sur "Activer" pour démarrer le minuteur de surveillance.',
    howto_2: 'Déplacez la souris sur le canvas pour simuler un mouvement.',
    howto_3: 'Observez le compte à rebours — il se réinitialise à chaque mouvement.',
    howto_4: 'Si le minuteur atteint zéro, l\'alerte se déclenche avec son et journal.',
  ...
  ar: {
    ...
    howto_1: 'انقر "تفعيل" لبدء مؤقت المراقبة.',
    howto_2: 'حرّك الماوس فوق لوحة الحركة لمحاكاة الحركة.',
    howto_3: 'راقب العد التنازلي — يُعاد ضبطه عند اكتشاف حركة.',
    howto_4: 'إذا وصل المؤقت إلى الصفر، يُطلق التنبيه مع صوت وتسجيل.',
