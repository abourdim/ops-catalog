...
const LANG = {
 ...
 title: 'Invisible Fence', subtitle: '🔲 map · 🔐 secure · 🛡️ protect',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Invisible Fence — Perimeter Security', mainDesc: 'Map and monitor a sensor perimeter network',
 ...
 howto_1:'The main display shows the Invisible Fence simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_perimeter_title: '🔲 Perimeter Security', wiki_perimeter: 'Perimeter security protects the boundary of an area using physical or electronic barriers. Sensors detect unauthorized entry and trigger alerts.',
 wiki_sensor_title: '📡 Sensor Networks', wiki_sensor: 'Wireless sensor networks use distributed nodes that communicate to monitor an environment. Each node covers a zone and reports to a central controller.',
 wiki_zone_title: '🗺️ Zone Mapping', wiki_zone: 'Zone mapping divides a perimeter into segments, each monitored by one or more sensors. Overlapping zones ensure complete coverage without gaps.',
 wiki_breach_title: '🚨 Breach Detection', wiki_breach: 'Breach detection identifies when an unauthorized entity crosses the perimeter. Sensors compare readings against thresholds to trigger immediate alerts.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🛡️ Invisible Fence ready!',
 ...
 themeChanged: '🎨 Theme →',
 // Fence-specific keys
 addSensor: 'Add Sensor', activate: 'Activate Fence', deactivate: 'Deactivate',
 simulateIntruder: 'Simulate Intruder', breaches: 'Breaches:',
 zoneSecure: 'ALL ZONES SECURE', zoneBreach: 'BREACH — ZONE',
 breachAlertLabel: 'BREACH',
 noSensors: 'Click "Add Sensor" then click on the map to place sensors',
 sensorPlaced: 'Sensor placed', sensorPrefix: 'S',
 fenceActivated: 'Fence activated — monitoring perimeter',
 fenceDeactivated: 'Fence deactivated',
 intruderMode: 'Click on map to place intruder',
 intruderPlaced: 'Intruder placed — tracking',
 breachDetected: 'BREACH detected',
 intruderCleared: 'Intruder cleared',
 placeSensorsFirst: 'Place sensors first',
 clickToPlace: 'Click on map to place sensor',
 sensorActive: 'Active', sensorTriggered: 'Triggered', sensorOffline: 'Offline',
 step1: 'Sensors are placed around the perimeter of the area to protect. Each sensor node monitors its surroundings using motion, infrared, or trip-wire detection.',
 step2: 'Each sensor covers a zone — a segment of the perimeter. Together they form a continuous fence line with overlapping coverage.',
 step3: 'When someone crosses the boundary, the nearest sensor detects the breach and triggers an alert. The system identifies which zone was compromised.',
 step4: 'The alert is sent wirelessly to the central unit (your screen). The operator sees the breach location in real-time and can respond immediately.',
 lab1: 'Design a perimeter layout by placing sensors around the map edges. Try to cover all entry points with minimal sensors.',
 lab2: 'Test coverage gaps: activate the fence and look for uncovered areas (shown as dark zones). Can you find a path through?',
 lab3: 'Simulate an intruder path: click "Simulate Intruder" then click on the map to set a moving intruder. Watch which sensors trigger.',
 lab4: 'Optimize sensor placement: adjust sensor positions to eliminate gaps while using the fewest sensors possible.',
 challenge1_title: 'Challenge 1 — Minimum Security',
 challenge1_desc: 'Secure a rectangular room using the fewest sensors possible. Can you cover the entire perimeter with only 4 sensors?',
 challenge2_title: 'Challenge 2 — Find the Gap',
 ...
 theory: 'Invisible Fence demonstrates key principles from autonomous agents. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-6ED74C',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Invisible Fence \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Invisible Fence', subtitle: '🔲 cartographier · 🔐 sécuriser · 🛡️ protéger',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Clôture Invisible — Sécurité Périmétrique', mainDesc: 'Cartographier et surveiller un réseau de capteurs périmétrique',
 ...
 howto_1:'L écran principal affiche la simulation Invisible Fence. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_perimeter_title: '🔲 Sécurité Périmétrique', wiki_perimeter: 'La sécurité périmétrique protège les limites d\'une zone à l\'aide de barrières physiques ou électroniques. Les capteurs détectent les entrées non autorisées et déclenchent des alertes.',
 wiki_sensor_title: '📡 Réseaux de Capteurs', wiki_sensor: 'Les réseaux de capteurs sans fil utilisent des nœuds distribués qui communiquent pour surveiller un environnement. Chaque nœud couvre une zone et rapporte à un contrôleur central.',
 wiki_zone_title: '🗺️ Cartographie de Zones', wiki_zone: 'La cartographie de zones divise un périmètre en segments, chacun surveillé par un ou plusieurs capteurs. Les zones chevauchantes assurent une couverture complète.',
 wiki_breach_title: '🚨 Détection d\'Intrusion', wiki_breach: 'La détection d\'intrusion identifie quand une entité non autorisée franchit le périmètre. Les capteurs comparent les lectures aux seuils pour déclencher des alertes immédiates.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🛡️ Clôture Invisible prête !',
 ...
 themeChanged: '🎨 Thème →',
 addSensor: 'Ajouter Capteur', activate: 'Activer Clôture', deactivate: 'Désactiver',
 simulateIntruder: 'Simuler Intrus', breaches: 'Intrusions :',
 zoneSecure: 'TOUTES LES ZONES SÉCURISÉES', zoneBreach: 'INTRUSION — ZONE',
 breachAlertLabel: 'INTRUSION',
 noSensors: 'Cliquez "Ajouter Capteur" puis cliquez sur la carte pour placer des capteurs',
 sensorPlaced: 'Capteur placé', sensorPrefix: 'C',
 fenceActivated: 'Clôture activée — surveillance du périmètre',
 fenceDeactivated: 'Clôture désactivée',
 intruderMode: 'Cliquez sur la carte pour placer l\'intrus',
 intruderPlaced: 'Intrus placé — suivi en cours',
 breachDetected: 'INTRUSION détectée',
 intruderCleared: 'Intrus supprimé',
 placeSensorsFirst: 'Placez des capteurs d\'abord',
 clickToPlace: 'Cliquez sur la carte pour placer un capteur',
 sensorActive: 'Actif', sensorTriggered: 'Déclenché', sensorOffline: 'Hors ligne',
 step1: 'Des capteurs sont placés autour du périmètre de la zone à protéger. Chaque nœud capteur surveille son environnement par détection de mouvement, infrarouge ou fil-piège.',
 step2: 'Chaque capteur couvre une zone — un segment du périmètre. Ensemble ils forment une ligne de clôture continue avec une couverture chevauchante.',
 step3: 'Quand quelqu\'un franchit la limite, le capteur le plus proche détecte l\'intrusion et déclenche une alerte. Le système identifie quelle zone a été compromise.',
 step4: 'L\'alerte est envoyée sans fil à l\'unité centrale (votre écran). L\'opérateur voit l\'emplacement de l\'intrusion en temps réel et peut réagir immédiatement.',
 lab1: 'Concevez un plan de périmètre en plaçant des capteurs autour des bords de la carte. Essayez de couvrir tous les points d\'entrée avec un minimum de capteurs.',
 lab2: 'Testez les failles de couverture : activez la clôture et cherchez les zones non couvertes (zones sombres). Pouvez-vous trouver un passage ?',
 lab3: 'Simulez un chemin d\'intrus : cliquez sur "Simuler Intrus" puis cliquez sur la carte pour placer un intrus mobile. Observez quels capteurs se déclenchent.',
 lab4: 'Optimisez le placement des capteurs : ajustez les positions pour éliminer les failles en utilisant le moins de capteurs possible.',
 challenge1_title: 'Défi 1 — Sécurité Minimale',
 challenge1_desc: 'Sécurisez une pièce rectangulaire avec le moins de capteurs possible. Pouvez-vous couvrir tout le périmètre avec seulement 4 capteurs ?',
 challenge2_title: 'Défi 2 — Trouvez la Faille',
 ...
 theory: 'Invisible Fence démontre les principes clés de agents autonomes. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Invisible Fence', subtitle: '🔲 خريطة · 🔐 أمان · 🛡️ حماية',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'السياج الخفي — أمن المحيط', mainDesc: 'رسم ومراقبة شبكة مستشعرات محيطية',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Invisible Fence. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 wiki_perimeter_title: '🔲 أمن المحيط', wiki_perimeter: 'أمن المحيط يحمي حدود منطقة باستخدام حواجز مادية أو إلكترونية. تكشف المستشعرات الدخول غير المصرح به وتطلق التنبيهات.',
 wiki_sensor_title: '📡 شبكات المستشعرات', wiki_sensor: 'تستخدم شبكات المستشعرات اللاسلكية عقدًا موزعة تتواصل لمراقبة البيئة. تغطي كل عقدة منطقة وترسل التقارير إلى وحدة تحكم مركزية.',
 wiki_zone_title: '🗺️ رسم المناطق', wiki_zone: 'رسم المناطق يقسم المحيط إلى أجزاء، كل جزء يراقبه مستشعر أو أكثر. المناطق المتداخلة تضمن تغطية كاملة بدون فجوات.',
 wiki_breach_title: '🚨 كشف الاختراق', wiki_breach: 'كشف الاختراق يحدد متى يعبر كيان غير مصرح به المحيط. تقارن المستشعرات القراءات بالعتبات لإطلاق تنبيهات فورية.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🛡️ السياج الخفي جاهز!',
 ...
 themeChanged: '🎨 المظهر ←',
 addSensor: 'إضافة مستشعر', activate: 'تفعيل السياج', deactivate: 'إلغاء التفعيل',
 simulateIntruder: 'محاكاة متسلل', breaches: 'اختراقات:',
 zoneSecure: 'جميع المناطق آمنة', zoneBreach: 'اختراق — المنطقة',
 breachAlertLabel: 'اختراق',
 noSensors: 'انقر "إضافة مستشعر" ثم انقر على الخريطة لوضع المستشعرات',
 sensorPlaced: 'تم وضع المستشعر', sensorPrefix: 'م',
 fenceActivated: 'تم تفعيل السياج — مراقبة المحيط',
 fenceDeactivated: 'تم إلغاء تفعيل السياج',
 intruderMode: 'انقر على الخريطة لوضع المتسلل',
 intruderPlaced: 'تم وضع المتسلل — تتبع جارٍ',
 breachDetected: 'تم كشف اختراق',
 intruderCleared: 'تم إزالة المتسلل',
 placeSensorsFirst: 'ضع المستشعرات أولاً',
 clickToPlace: 'انقر على الخريطة لوضع مستشعر',
 sensorActive: 'نشط', sensorTriggered: 'مُفعَّل', sensorOffline: 'غير متصل',
 step1: 'توضع المستشعرات حول محيط المنطقة المراد حمايتها. تراقب كل عقدة مستشعر محيطها باستخدام كشف الحركة أو الأشعة تحت الحمراء أو سلك التعثر.',
 step2: 'يغطي كل مستشعر منطقة — جزء من المحيط. معًا يشكلون خط سياج متواصل بتغطية متداخلة.',
 step3: 'عندما يعبر شخص الحدود، يكشف أقرب مستشعر الاختراق ويطلق تنبيهًا. يحدد النظام أي منطقة تم اختراقها.',
 step4: 'يُرسل التنبيه لاسلكيًا إلى الوحدة المركزية (شاشتك). يرى المشغل موقع الاختراق في الوقت الحقيقي ويمكنه الاستجابة فورًا.',
 lab1: 'صمم تخطيط محيط بوضع المستشعرات حول حواف الخريطة. حاول تغطية جميع نقاط الدخول بأقل عدد من المستشعرات.',
 lab2: 'اختبر فجوات التغطية: فعّل السياج وابحث عن المناطق غير المغطاة (المناطق المظلمة). هل تستطيع إيجاد ممر؟',
 lab3: 'حاكِ مسار متسلل: انقر على "محاكاة متسلل" ثم انقر على الخريطة لوضع متسلل متحرك. راقب أي المستشعرات تتفعل.',
 lab4: 'حسّن وضع المستشعرات: اضبط المواقع للقضاء على الفجوات مع استخدام أقل عدد ممكن من المستشعرات.',
 challenge1_title: 'التحدي 1 — الحد الأدنى من الأمان',
 challenge1_desc: 'أمّن غرفة مستطيلة بأقل عدد ممكن من المستشعرات. هل تستطيع تغطية المحيط بالكامل بـ 4 مستشعرات فقط؟',
 challenge2_title: 'التحدي 2 — أوجد الفجوة',
 ...
 challenge3_desc: 'يحاول متسلل عبور المحيط متجنبًا مناطق الكشف. أعد تصميم سياجك حتى لا يوجد ممر عبر المناطق غير المراقبة.',step1Title:'تجهيز',step1Desc:'اختر وكوّن معدات الميدان للمهمة. شاهد التصور يتحدث في الوقت الفعلي أثناء هذه المرحلة. يعرض الشاشة بالضبط ما يحدث داخلياً — كل لون وحركة يمثل تحولاً محدداً في البيانات.',step2Title:'نشر',step2Desc:'فعّل المستشعرات وأنشئ قنوات اتصال آمنة. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',step3Title:'مراقبة',step3Desc:'تتبع الإشارات وحلل البيانات وراقب الشذوذ في الوقت الفعلي. تحول هذه المرحلة بيانات الإدخال باستخدام الخوارزمية المعروضة. قارن القيم قبل وبعد لفهم العلاقة الرياضية.',step4Title:'استخراج',step4Desc:'اجمع النتائج وأنشئ التقارير وأمّن الاستخبارات المجمّعة. ناتج هذه المرحلة يغذي المرحلة التالية. حاول التوقف هنا لفحص الحالة الوسيطة.',sectionCode:'كود الجهاز',faq_q1:'ما هو Invisible Fence؟',faq_a1:'Invisible Fence هي محاكاة تفاعلية توضح مفاهيم الوكلاء المستقلون. Map and monitor a sensor perimeter network. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في الاتصالات التكتيكية. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من الاتصالات التكتيكية. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج RPi + micro:bit. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من الاتصالات التكتيكية.',demo_s1:'مرحباً في Invisible Fence! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة الاتصالات التكتيكية.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالاتصالات التكتيكية.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'Field Equipment',learn1Desc:'How agents select and configure mission gear. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'Tradecraft',learn2Title:'Covert Comms',learn2Desc:'How to set up secure communication channels. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'COMSEC',learn3Title:'Surveillance',learn3Desc:'How to monitor areas and detect threats. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'Intel',learn4Title:'Extraction',learn4Desc:'How to collect and secure intelligence safely. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'Operations',sectionLearn:'ماذا ستتعلم',learnLevelVal:'متقدم 🔴',learnLevel:'المستوى:',learnTimeVal:'30 min ⏱',learnTime:'المدة:',learnAgeVal:'14+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Invisible Fence! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـالوكلاء المستقلون — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how Select and configure your field equipment for the لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم الاتصالات التكتيكية من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',ch1Title:'تشفير وفك تشفير',ch1Desc:'شفّر رسالة ثم حاول فك تشفيرها يدوياً بدون النظر للمفتاح. ما الأنماط التي تلاحظها؟',ch2Title:'اختبار التخفي',ch2Desc:'حاول إكمال المهمة بأقل بصمة إشارة ممكنة. هل يمكنك النزول تحت عتبة الكشف؟',ch3Title:'سباق الاعتراض',ch3Desc:'ابدأ بثاً وقِس سرعة اعتراضه. ما الذي يؤثر على وقت الكشف؟',codeTitle:'كود البداية',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'يشغّل هذا الكود راديو micro:bit على المجموعة 42 بأقصى طاقة. عند الضغط على الزر A يبث "HELLO". أي رسالة مستلمة تمرر على شاشة LED.',purpose:'Invisible Fence: Map and monitor a sensor perimeter network. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ الوكلاء المستقلون',
 wiki_history: 'BLE was introduced in Bluetooth 4.0 (2010) by Nokia. It reduced power consumption by 90% compared to classic Bluetooth, enabling battery-powered sensors. يبني Invisible Fence على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Invisible Fence',
 wiki_math: 'الرياضيات وراء Invisible Fence: BLE uses Gaussian Frequency Shift Keying (GFSK) modulation at 1 Mbps. The modulation index of 0.5 provides optimal bandwidth efficiency. Channel capacity follows Shannon: C = B·log₂(1+S/N). Doubling bandwidth doubles capacity, but doubling signal power only adds one bit per symbol. Signal-to-Noise Ratio (SNR) in dB = 10·log₁₀(Psignal/Pnoise). Every 3 dB increase doubles the signal power relative to noise.',
 ...
 theory: 'Invisible Fence يوضح المبادئ الأساسية في الوكلاء المستقلون. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ INVISIBLE FENCE — PERIMETER SIMULATION ═══════ */

const SENSOR_RADIUS = 50; // detection radius in px
let sensors = []; // {x, y, state:'active'|'triggered'|'offline', id}
let fenceActive = false;
let intruderMode = false;
let addSensorMode = false;
let intruder = null; // {x, y, dx, dy}
let intruderAnim = null;
let breachTotal = 0;
let perimeterCanvas, perimeterCtx;

function initPerimeterCanvas() {
 const wrap = $('perimeterMapWrap');
 perimeterCanvas = $('perimeterCanvas');
 if (!perimeterCanvas || !wrap) return;

 function resize() {
 perimeterCanvas.width = wrap.clientWidth;
 perimeterCanvas.height = wrap.clientHeight;
 drawPerimeter();
 }
 resize();
 ...
 perimeterCanvas.addEventListener('click', onCanvasClick);
}
...
function onCanvasClick(e) {
 ...
 placeSensor(x, y);
 addSensorMode = false;
 perimeterCanvas.style.cursor = 'crosshair';
 return;
 }
...
function placeSensor(x, y) {
 ...
 sensors.push({ x, y, state: 'active', id });
 log(`📡 ${s.sensorPlaced} ${s.sensorPrefix}${id} (${Math.round(x)}, ${Math.round(y)})`, 'success');
 playSound('success');
 showToast(`${s.sensorPlaced} ${s.sensorPrefix}${id}`, 1500);
 updateSensorList();
 drawPerimeter();
}

function placeIntruder(x, y) {
 const s = LANG[currentLang];
 if (sensors.length === 0) {
 log(`⚠️ ${s.placeSensorsFirst}`, 'error');
 playSound('error');
 return;
 }
 // Random direction
 ...
 const speed = 1.2;
 intruder = { x, y, dx: Math.cos(angle) * speed, dy: Math.sin(angle) * speed };
 log(`🕵️ ${s.intruderPlaced} (${Math.round(x)}, ${Math.round(y)})`, 'info');
 playSound('click');
 showToast(s.intruderPlaced, 1500);
 if (!intruderAnim) startIntruderAnimation();
}

function startIntruderAnimation() {
 function tick() {
 if (!intruder) { intruderAnim = null; return; }
 const w = perimeterCanvas.width;
 const h = perimeterCanvas.height;

 // Move intruder
 intruder.x += intruder.dx;
 intruder.y += intruder.dy;

 // Bounce off edges
 if (intruder.x < 5 || intruder.x > w - 5) intruder.dx *= -1;
 if (intruder.y < 5 || intruder.y > h - 5) intruder.dy *= -1;
 intruder.x = Math.max(5, Math.min(w - 5, intruder.x));
 intruder.y = Math.max(5, Math.min(h - 5, intruder.y));

 // Check breach detection
 if (fenceActive) checkBreach();

 drawPerimeter();
 intruderAnim = requestAnimationFrame(tick);
 }
 intruderAnim = requestAnimationFrame(tick);
}
...
function checkBreach() {
 ...
 if (sensor.state === 'offline') return;
 const dist = Math.hypot(intruder.x - sensor.x, intruder.y - sensor.y);
 ...
 breachZone = idx + 1;
 breached = true;
 log(`🚨 ${s.breachDetected} — ${s.sensorPrefix}${sensor.id} (Zone ${breachZone})`, 'error');
 playSound('error');
 updateBreachCount();
 updateSensorList();
 }
 ...
 // Update zone status
 const zoneEl = $('zoneStatus');
 const alertEl = $('breachAlert');
 const hasTriggered = sensors.some(s => s.state === 'triggered');

 if (hasTriggered) {
 const triggeredIdx = sensors.findIndex(s => s.state === 'triggered');
 if (zoneEl) {
 zoneEl.textContent = `${s.zoneBreach} ${triggeredIdx + 1}`;
 zoneEl.className = 'zone-status breach';
 }
 if (alertEl) alertEl.classList.add('visible');
 } else {
 if (zoneEl) {
 zoneEl.textContent = s.zoneSecure;
 zoneEl.className = 'zone-status secure';
 }
...
function drawPerimeter() {
 ...
 // Coverage circles (when fence active)
 if (fenceActive) {
 sensors.forEach(sensor => {
 if (sensor.state === 'offline') return;
 const color = sensor.state === 'triggered'
 ? 'rgba(255,23,68,0.12)'
 : 'rgba(0,200,83,0.08)';
 ctx.beginPath();
 ctx.arc(sensor.x, sensor.y, SENSOR_RADIUS, 0, Math.PI * 2);
 ctx.fillStyle = color;
 ctx.fill();

 // Detection radius border
 ctx.beginPath();
 ctx.arc(sensor.x, sensor.y, SENSOR_RADIUS, 0, Math.PI * 2);
 ctx.strokeStyle = sensor.state === 'triggered'
 ? 'rgba(255,23,68,0.5)'
 : 'rgba(0,200,83,0.3)';
 ctx.lineWidth = 1.5;
 ctx.setLineDash([4, 4]);
 ...
 // Fence line connecting sensors in order
 if (sensors.length >= 2) {
 ctx.beginPath();
 ctx.moveTo(sensors[0].x, sensors[0].y);
 for (let i = 1; i < sensors.length; i++) {
 ctx.lineTo(sensors[i].x, sensors[i].y);
 }
 ctx.closePath();
 ...
 sensors.forEach(sensor => {
 // Outer glow
 const glowColor = sensor.state === 'triggered' ? 'rgba(255,23,68,0.4)'
 : sensor.state === 'offline' ? 'rgba(100,100,100,0.3)'
 : 'rgba(0,200,83,0.4)';
 ctx.beginPath();
 ...
 // Inner node
 const nodeColor = sensor.state === 'triggered' ? '#ff1744'
 : sensor.state === 'offline' ? '#666'
 : '#00c853';
 ctx.beginPath();
 ...
 ctx.textAlign = 'center';
 ctx.fillText(`${LANG[currentLang].sensorPrefix}${sensor.id}`, sensor.x, sensor.y - 16);
 });
 ...
 // Trail glow
 ctx.beginPath();
 ctx.arc(intruder.x, intruder.y, 14, 0, Math.PI * 2);
 ctx.fillStyle = 'rgba(255,152,0,0.25)';
 ctx.fill();

 // Main dot
 ctx.beginPath();
 ctx.arc(intruder.x, intruder.y, 8, 0, Math.PI * 2);
 ctx.fillStyle = '#ff9800';
 ctx.fill();

 // Center
 ctx.beginPath();
 ctx.arc(intruder.x, intruder.y, 3, 0, Math.PI * 2);
 ctx.fillStyle = '#fff';
 ctx.fill();
 }
}
...
function updateSensorList() {
 const listEl = $('sensorList');
 if (!listEl) return;
 const s = LANG[currentLang];

 if (sensors.length === 0) {
 listEl.innerHTML = `<div style="opacity:0.5; text-align:center; padding:1rem; font-size:0.85rem;" data-i18n="noSensors">${s.noSensors}</div>`;
 return;
 }

 listEl.innerHTML = sensors.map(sensor => {
 const stateLabel = sensor.state === 'triggered' ? s.sensorTriggered
 : sensor.state === 'offline' ? s.sensorOffline
 : s.sensorActive;
 return `<div class="sensor-list-item">
 <span><span class="dot ${sensor.state}"></span>${s.sensorPrefix}${sensor.id}</span>
 <span>${stateLabel}</span>
 </div>`;
 }).join('');
}

function updateBreachCount() {
 const el = $('breachCount');
 if (el) el.textContent = breachTotal;
}

function activateFence() {
 const s = LANG[currentLang];
 if (sensors.length === 0) {
 log(`⚠️ ${s.placeSensorsFirst}`, 'error');
 playSound('error');
 ...
 fenceActive = true;
 setStatus(true);
 log(`🔒 ${s.fenceActivated}`, 'success');
 playSound('success');
 showToast(s.fenceActivated, 2000);
 drawPerimeter();
}
...
function deactivateFence() {
 ...
 fenceActive = false;
 setStatus(false);
 // Reset triggered sensors
 sensors.forEach(sensor => { if (sensor.state === 'triggered') sensor.state = 'active'; });
 // Clear intruder
 if (intruder) {
 intruder = null;
 if (intruderAnim) { cancelAnimationFrame(intruderAnim); intruderAnim = null; }
 }
 // Reset zone status
 const zoneEl = $('zoneStatus');
 if (zoneEl) { zoneEl.textContent = s.zoneSecure; zoneEl.className = 'zone-status secure'; }
 const alertEl = $('breachAlert');
 if (alertEl) alertEl.classList.remove('visible');

 log(`🔓 ${s.fenceDeactivated}`, 'info');
 playSound('click');
 updateSensorList();
 drawPerimeter();
}

function initFenceControls() {
 const addBtn = $('addSensorBtn');
 const actBtn = $('activateBtn');
 const deactBtn = $('deactivateBtn');
 const intBtn = $('intruderBtn');

 if (addBtn) addBtn.onclick = () => {
 const s = LANG[currentLang];
 addSensorMode = true;
 intruderMode = false;
 perimeterCanvas.style.cursor = 'copy';
 showToast(s.clickToPlace, 2000);
 log(`📍 ${s.clickToPlace}`, 'info');
 };

 if (actBtn) actBtn.onclick = activateFence;
 if (deactBtn) deactBtn.onclick = deactivateFence;
 ...
 intruderMode = true;
 addSensorMode = false;
 perimeterCanvas.style.cursor = 'cell';
 showToast(s.intruderMode, 2000);
 log(`🕵️ ${s.intruderMode}`, 'info');
 };
}
