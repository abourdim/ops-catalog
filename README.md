...
> Interactive catalog of 488 hands-on DIY hardware, radio, and security projects across 55 categories. Trilingual (EN/FR/AR) with a built-in voting system.

---

## Overview

The **Ops Catalog** is a self-contained, single-page web application that serves as the master directory for the Workshop-DIY educational lab. It organizes 488 project ideas into 55 categories spanning radio frequency engineering, cybersecurity, embedded hardware, signal intelligence, acoustic science, swarm computing, and more.
...
| 15 | :ghost: | WiFi Monitor -- Spy | 6 | WiFi Adapter |
...
| 24 | :camping: | Ham -- Emergency | 4 | Mixed |
...
| # | Icon | Category | Apps | Hardware |
|---|------|----------|------|----------|
| 35 | :satellite: | Antenna -- Build & Test | 13 | HackRF |
...
| 41 | :satellite: | Agent + Antenna | 5 | RPi + HackRF |
| 42 | :skull: | Agent -- Ultimate Kits | 7 | Full Stack |

### Frontier Categories (13 categories)
...
| 51 | :performing_arts: | Social Engineering -- Human Hacking | 15 | Mixed |
| 52 | :electric_plug: | Hardware Implants -- Physical Access | 15 | Mixed |
| 53 | :lock: | Crypto Attacks -- Breaking Ciphers | 15 | Mixed |
| 54 | :boom: | RF Warfare -- Electronic Combat | 15 | HackRF |
| 55 | :runner: | Escape & Evasion -- Counter-Surveillance | 15 | Mixed |
...
Each of the 55 category folders contains individual app directories. The file layout depends on the target hardware:
...
- **Live search** -- Filter projects instantly by keyword across all 488 entries
