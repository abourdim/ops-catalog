#!/usr/bin/env python3
"""
Ultrasonic Data Link
20kHz+ Acoustic Modem

Workshop-DIY Educational Project

Process:
    Step 1: Create a specific acoustic signal with precise frequency and amplitude.
    Step 2: The sound wave travels through air, walls, or other media to the target.
    Step 3: Microphones or sensors capture the acoustic energy and convert it to data.
    Step 4: Signal processing extracts hidden information or maps the acoustic environment.
...
APP_NAME = "sonic-ultrasonic-data-link"
