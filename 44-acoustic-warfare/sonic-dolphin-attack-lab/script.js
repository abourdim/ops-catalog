...
const LANG = {
  en: {
    ...
    themeChanged: '🎨 Theme →',
  ,step1Title:'Generate Sound',step1Desc:'Agent A writes a secret message and enters a shared key.',step2Title:'Propagate',step2Desc:'The message is encrypted using XOR cipher with the shared key.',step3Title:'Detect & Capture',step3Desc:'The encrypted message is "dropped" via BLE broadcast into the air.',step4Title:'Analyze & Decode',step4Desc:'Agent B scans, receives the drop, and decrypts with the same key.',sectionCode:'Device Code'},
  fr: {
    ...
    themeChanged: '🎨 Thème →',
  ,step1Title:'Générer le son',step1Desc:'L\'agent A écrit un message secret et entre une clé partagée.',step2Title:'Propager',step2Desc:'Le message est chiffré avec le chiffrement XOR et la clé partagée.',step3Title:'Détecter et capturer',step3Desc:'Le message chiffré est "déposé" par diffusion BLE dans les airs.',step4Title:'Analyser et décoder',step4Desc:'L\'agent B scanne, reçoit le drop et déchiffre avec la même clé.',sectionCode:'Code Appareil'},
  ar: {
