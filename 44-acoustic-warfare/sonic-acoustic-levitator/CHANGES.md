...
- Generate Sound step card
- Propagate step card
- Detect & Capture step card
- Analyze & Decode step card
- Standing Wave Nodes section
- Levitation Physics section
- Challenge section
