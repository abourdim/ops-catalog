...
const LANG = {
 ...
 title: 'Dns Exfiltration Engine', subtitle: '📨 encrypt · 📡 drop · 🔓 decrypt',
 ...
 howto_1:'The main display shows the Dark Dns Exfiltration Engine simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Agent A writes a secret message and enters a shared key.',
 ...
 theory: 'Dark Dns Exfiltration Engine demonstrates key principles from retro computing. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 title: 'Dns Exfiltration Engine', subtitle: '📨 chiffrer · 📡 déposer · 🔓 déchiffrer',
 ...
 theory: 'Dark Dns Exfiltration Engine démontre les principes clés de informatique rétro. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Dns Exfiltration Engine', subtitle: '📨 تشفير · 📡 إيداع · 🔓 فك تشفير',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Dark Dns Exfiltration Engine. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Agent A writes a secret message and enters a shared key.',
 ...
 theory: 'Dark Dns Exfiltration Engine يوضح المبادئ الأساسية في الحوسبة القديمة. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'Dead Drop — نقل رسائل BLE',related1_desc:'شفّر وتبادل رسائل سرية عبر محاكاة BLE',related1_path:'../../49-ai-radio/ai-neural-demodulator/index.html',related2_name:'Dead Drop — نقل رسائل BLE',related2_desc:'شفّر وتبادل رسائل سرية عبر محاكاة BLE',related2_path:'../../49-ai-radio/ai-dream-radio/index.html',related3_name:'متحكم توجيه الحزمة',related3_desc:'توجيه حزم الهوائي إلكترونيًا بالتحكم في الطور',related3_path:'../../36-ant-pi/pi-phased-array/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'Dead Drop — نقل رسائل BLE',pathPrev_path:'../../48-dark-arts/dark-cable-tap-detector/index.html',pathNext_name:'محلل البرامج الثابتة',pathNext_path:'../../48-dark-arts/dark-evil-firmware-flasher/index.html',
