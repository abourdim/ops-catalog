...
const LANG = {
  en: {
    ...
    themeChanged: '🎨 Theme →',step1Title:'Identify Target',step1Desc:'Agent A writes a secret message and enters a shared key.',step2Title:'Prepare Attack',step2Desc:'The message is encrypted using XOR cipher with the shared key.',step3Title:'Execute',step3Desc:'The encrypted message is "dropped" via BLE broadcast into the air.',step4Title:'Defend',step4Desc:'Agent B scans, receives the drop, and decrypts with the same key.',sectionCode:'Device Code',faq_q1:'What does this app do?',faq_a1:'It simulates security testing! 🔬 You get to experiment with attack and defense techniques in a safe sandbox.',faq_q2:'How does it work?',faq_a2:'The simulation runs in your browser. It models real attack and defense techniques so you can see what happens step by step.',faq_q3:'What should I try first?',faq_a3:'Press the main button and watch! 🎯 Then tweak the settings to see how different parameters change the results.',faq_q4:'What\'s the real science?',faq_a4:'This is real cybersecurity offense and defense! The same principles are used by professionals in the field. 🧪',faq_q5:'Can I break it?',faq_a5:'Try the Lab section! Push the parameters to extremes and see what happens. That\'s how scientists discover new things! 💡',faq_q6:'What hardware do I need?',faq_a6:'For the real version, you\'ll need a computer with Python 3. Check the 📦 Device Code section for ready-to-use firmware!',faq_q7:'Is it safe to use?',faq_a7:'Absolutely safe! 🛡️ Everything runs locally in your browser. No internet required, no data leaves your device.',faq_q8:'What should I try next?',faq_a8:'Try Dark Rubber Ducky Generator and Dark Dns Exfiltration Engine! Each teaches something different. 🚀',demo_s1:'Welcome! Let\'s explore this simulation together. Look at the main section above. 🔬',demo_s2:'Click the primary action button to start. Watch the visualization respond in real time! ⚡',demo_s3:'Now change a setting — try a slider or dropdown. See how the output changes? 🔄',demo_s4:'Check the results — the graphs and numbers show what\'s happening under the hood. 📊',demo_s5:'Awesome! 🎉 You\'ve got the basics. Try the Lab section below for deeper experiments!',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Vulnerability Analysis',learn1Desc:'How to find weaknesses in systems',learn1Tag:'Offensive',learn2Title:'Defense Techniques',learn2Desc:'How to protect against real attack methods',learn2Tag:'Defensive',learn3Title:'Forensics',learn3Desc:'How to trace and analyze security incidents',learn3Tag:'Analysis',learn4Title:'Ethics',learn4Desc:'Why understanding attacks makes you a better defender',learn4Tag:'Ethics',sectionLearn:'What You Shall Learn',learnLevelVal:'Advanced 🔴',learnLevel:'Level:',learnTimeVal:'30 min ⏱',learnTime:'Time:',learnAgeVal:'14+ 🧒',learnAge:'Ages:'},
  fr: {
  ...
  ar: {
    ...
    themeChanged: '🎨 المظهر ←',step1Title:'تحديد الهدف',step1Desc:'العميل أ يكتب رسالة سرية ويدخل مفتاحًا مشتركًا.',step2Title:'تحضير الهجوم',step2Desc:'يتم تشفير الرسالة باستخدام شيفرة XOR مع المفتاح المشترك.',step3Title:'تنفيذ',step3Desc:'الرسالة المشفرة تُودَع عبر بث BLE في الهواء.',step4Title:'دفاع',step4Desc:'العميل ب يمسح ويستقبل الإيداع ويفك تشفيره بنفس المفتاح.',sectionCode:'كود الجهاز',faq_q1:'ماذا يفعل هذا التطبيق؟',faq_a1:'يحاكي security testing! 🔬 يمكنك التجربة مع attack and defense techniques في بيئة آمنة.',faq_q2:'كيف يعمل؟',faq_a2:'المحاكاة تعمل في متصفحك. تنمذج attack and defense techniques حقيقية خطوة بخطوة.',faq_q3:'ماذا أجرب أولاً؟',faq_a3:'اضغط على الزر الرئيسي وشاهد! 🎯 ثم عدّل الإعدادات لترى التأثير.',faq_q4:'ما العلم الحقيقي؟',faq_a4:'هذا cybersecurity offense and defense حقيقي! نفس المبادئ المستخدمة من المحترفين. 🧪',faq_q5:'هل يمكنني كسره؟',faq_a5:'جرب المختبر! ادفع المعلمات للحدود القصوى وشاهد. هكذا يكتشف العلماء! 💡',faq_q6:'ما العتاد المطلوب؟',faq_a6:'للنسخة الحقيقية تحتاج a computer with Python 3. تفقد 📦 كود الجهاز!',faq_q7:'هل هو آمن؟',faq_a7:'آمن تماماً! 🛡️ كل شيء يعمل محلياً. لا حاجة للإنترنت.',faq_q8:'ماذا بعد؟',faq_a8:'جرب Dark Rubber Ducky Generator and Dark Dns Exfiltration Engine! كل واحد يعلّم شيئاً مختلفاً. 🚀',demo_s1:'مرحباً! لنستكشف هذه المحاكاة معاً. انظر إلى القسم الرئيسي أعلاه. 🔬',demo_s2:'اضغط زر الإجراء الرئيسي للبدء. شاهد التصور يستجيب! ⚡',demo_s3:'غيّر إعداداً — جرب شريط تمرير أو قائمة منسدلة. هل ترى التغيير؟ 🔄',demo_s4:'تحقق من النتائج — الرسوم البيانية تُظهر ما يحدث. 📊',demo_s5:'رائع! 🎉 أنت تعرف الأساسيات. جرب المختبر للتعمق أكثر!',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'Vulnerability Analysis',learn1Desc:'How to find weaknesses in systems',learn1Tag:'Offensive',learn2Title:'Defense Techniques',learn2Desc:'How to protect against real attack methods',learn2Tag:'Defensive',learn3Title:'Forensics',learn3Desc:'How to trace and analyze security incidents',learn3Tag:'Analysis',learn4Title:'Ethics',learn4Desc:'Why understanding attacks makes you a better defender',learn4Tag:'Ethics',sectionLearn:'ماذا ستتعلم',learnLevelVal:'متقدم 🔴',learnLevel:'المستوى:',learnTimeVal:'30 min ⏱',learnTime:'المدة:',learnAgeVal:'14+ 🧒',learnAge:'العمر:'}
};
