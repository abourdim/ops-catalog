...
const LANG={
 ...
 wiki_mitm: 'MITM: E_K1(P) = D_K2(C). E_K1(P). This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_2des: '2DES: C = E_K2(E_K1(P)). This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_3des: '3DES: C = E_K3(D_K2(E_K1(P))). MITM. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Clock Station Dashboard',related1_desc:'GPS-disciplined NTP time server',related1_path:'../../37-pi-core/pi-clock-station/index.html',related2_name:'GPS Spoofing Simulator',related2_desc:'Simulate satellite spoofing and position manipulation',related2_path:'../../54-rf-warfare/rfw-gps-spoofing-sim/index.html',related3_name:'Phishing Campaign Builder',related3_desc:'Build phishing emails and landing pages to understand attack vectors',related3_path:'../../51-social-engineering/se-phishing-campaign-builder/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Length Extension Attack',pathPrev_path:'../../53-crypto-attacks/cry-length-extension-lab/index.html',pathNext_name:'Padding Oracle Attack',pathNext_path:'../../53-crypto-attacks/cry-padding-oracle-lab/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 keyBitsLabel:'Taille de Cle (bits par cle)',keyBitsHint:'Chaque cle du mini-chiffrement',peerTitle:'👥 Peer Mode',peerConnect:'Connect',peerDisconnect:'Disconnect',peerStatus:'Peer Status',peerSend:'Sent',peerReceive:'Received',peerInfo:'Open this app in two tabs to sync parameters via BroadcastChannel',heatmapTitle:'📅 Activity Heatmap',heatmapToday:'Today',heatmapStreak:'Streak',heatmapTotal:'Total',heatmapLegend:'Less \u2192 More',
 ...
 title:'مختبر هجوم اللقاء في المنتصف',subtitle:'اكسر التشفير المزدوج 2DES بمقايضة الوقت والذاكرة',peerTitle:'👥 Mode Pair',peerConnect:'Connecter',peerDisconnect:'D\xe9connecter',peerStatus:'Statut pair',peerSend:'Envoy\xe9',peerReceive:'Re\xe7u',peerInfo:'Ouvrez cette app dans deux onglets pour synchroniser les param\xe8tres',heatmapTitle:'📅 Carte d\x27activit\xe9',heatmapToday:'Aujourd\x27hui',heatmapStreak:'S\xe9rie',heatmapTotal:'Total',heatmapLegend:'Moins \u2192 Plus',
