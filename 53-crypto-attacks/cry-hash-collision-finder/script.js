...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Pi Zero Drop Box — Network Implant Lab',related1_desc:'Simulate Raspberry Pi Zero drop box deployment for network penetration testing',related1_path:'../../52-hardware-implants/imp-pi-zero-dropbox/index.html',related2_name:'Mesh Network Dashboard',related2_desc:'LoRa mesh messaging node for off-grid communication',related2_path:'../../37-pi-core/pi-mesh-node/index.html',related3_name:'Covert Audio Implant — TSCM Training Lab',related3_desc:'Simulate hidden microphone implants and learn technical surveillance countermeasures',related3_path:'../../52-hardware-implants/imp-covert-audio-implant/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Randomness Tester',pathPrev_path:'../../53-crypto-attacks/cry-entropy-analyzer/index.html',pathNext_name:'KPA Key Recovery',pathNext_path:'../../53-crypto-attacks/cry-known-plaintext-attack/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
