...
const LANG={
  en:{
    ...
    gloss2_term: 'S-Box',
    gloss2_def: 'Substitution Box — a lookup table that replaces each byte with another byte. In AES, the S-box is designed to resist linear and differential cryptanalysis.',
    gloss3_term: 'Latency',
    ...
    theory: 'Padding Oracle Lab demonstrates key principles from crypto attacks. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. AES (Advanced Encryption Standard) is a symmetric block cipher using 128-bit blocks and 128/192/256-bit keys. It applies 10-14 rounds of substitution-permutation. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Frequency Deconfliction Manager',related1_desc:'Spectrum allocation, conflict detection, and frequency planning',related1_path:'../../54-rf-warfare/rfw-frequency-deconfliction/index.html',related2_name:'Camera Trap Dashboard',related2_desc:'Motion-triggered camera with IR night vision',related2_path:'../../37-pi-core/pi-camera-trap/index.html',related3_name:'APRS Dashboard',related3_desc:'APRS iGate and digipeater infrastructure node',related3_path:'../../37-pi-core/pi-igate-digipeater/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Meet-in-the-Middle Attack',pathPrev_path:'../../53-crypto-attacks/cry-meet-in-middle-lab/index.html',pathNext_name:'Quantum Attack Simulator',pathNext_path:'../../53-crypto-attacks/cry-quantum-key-cracker/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
    ...
    achieveExperimenter:'Experimenter — changed 5+ parameters'
  ,
    printBtn: '🖨️ Print Worksheet',quizTab:'Quiz',quizTitle:'Test Your Knowledge',quizRetry:'Retry',quizCorrect:'Correct!',quizWrong:'Wrong!',quizScore:'Score',quiz_q1:'AES uses which type of encryption?',quiz_q1a:'Asymmetric',quiz_q1b:'Symmetric',quiz_q1c:'Hashing',quiz_q1d:'Encoding',quiz_q1_answer:'1',quiz_q2:'What is machine learning?',quiz_q2a:'Programming robots',quiz_q2b:'Systems that learn from data',quiz_q2c:'Manual computation',quiz_q2d:'Hardware design',quiz_q2_answer:'1',quiz_q3:'What is a hash function?',quiz_q3a:'Encryption method',quiz_q3b:'One-way function producing fixed-size output',quiz_q3c:'Compression algorithm',quiz_q3d:'Random number generator',quiz_q3_answer:'1',quiz_q4:'What is public key cryptography?',quiz_q4a:'Using same key for encrypt/decrypt',quiz_q4b:'Using a key pair (public and private)',quiz_q4c:'No keys needed',quiz_q4d:'Password-based only',quiz_q4_answer:'1',quiz_q5:'What key size does AES-256 use?',quiz_q5a:'128 bits',quiz_q5b:'192 bits',quiz_q5c:'256 bits',quiz_q5d:'512 bits',quiz_q5_answer:'2',realworldTitle:'🌍 Real-World Stories',realworld1:'The SolarWinds attack (2020) compromised 18,000 organizations by hiding malware inside trusted software updates. Attackers had 9 months of undetected access to US Treasury, Commerce, and Homeland Security systems.',realworld2:'Heartbleed (2014) was a buffer overflow in OpenSSL that let attackers read 64KB of server memory per request — potentially grabbing private keys, passwords, and session tokens from any HTTPS server worldwide.',realworld3:'Alan Turing\'s team at Bletchley Park cracked the Enigma machine during WWII, reading 84,000 encrypted German messages per month by 1945. This achievement shortened the war by an estimated 2 years.',experimentTitle:'🔬 Experiments',experiment_1_title:'Baseline Measurement',experiment_1:'Set all controls to default values and record the initial readings. These are your baseline measurements. Good scientists always establish a baseline before changing variables — it gives you a reference point to measure all future changes against.',experiment_2_title:'Sensitivity Analysis',experiment_2:'Change one parameter to its minimum value, record the result, then set it to maximum. The difference reveals the system\'s sensitivity to that variable. Repeat for each control. In AI frontier, knowing which parameters matter most helps you focus your efforts efficiently.',experiment_3_title:'Interaction Effects',experiment_3:'After testing parameters individually, change two simultaneously. Does the combined effect equal the sum of individual effects? Or is there a synergy (or cancellation)? Non-linear interactions are common in AI frontier and reveal the hidden complexity beneath simple-looking systems.',proTipTitle:'💡 Pro Tips',proTip1:'Use your browser\\x27s Performance tab to measure frame rate. If the simulation drops below 30fps, reduce the data points or update interval for smoother animation.',proTip2:'Export simulation data using the Copy button, paste into a spreadsheet, and create your own charts. Comparing multiple runs in a chart reveals patterns invisible on screen.',funFactTitle:'🎯 Did You Know?',funFact:'A 256-bit AES key has more possible combinations (2²⁵⁶) than atoms in the observable universe (≈2²⁶⁶). Even checking a trillion keys per second, brute-forcing would take longer than the age of the universe.',mistakeTitle:'⚠️ Common Mistakes',mistake1:'Changing multiple parameters at once makes it impossible to isolate cause and effect. Always change ONE variable at a time.',mistake2:'Skipping the baseline measurement. Without knowing the default behavior, you cannot measure how your changes affect the system.',mistake3:'Ignoring the activity log. It records every event with timestamps — essential for understanding sequences and debugging unexpected results.',voiceTitle:'🎤 Voice',voiceOn:'Voice ON',voiceOff:'Voice OFF',voiceListening:'Listening...',voiceCmd:'Command recognised',voiceHelp:'Say: start, stop, reset, help, theme, next, previous',voice_cmds:'start / stop / reset / help / theme / next / previous',shareTitle:'📤 Share',shareBtn:'📤 Share',shareCopied:'Copied to clipboard!',shareGenerate:'Generate Summary',shareExport:'Export JSON',missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-9A5186',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Padding Oracle Lab \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',},
  fr:{tooltipTitle:'Infobulles intelligentes',tooltipToggle:'Activer les infobulles',tip_start:'Lancer la simulation et observer la visualisation s\x27animer',tip_stop:'Mettre en pause la simulation en conservant l\x27état actuel',tip_reset:'Effacer toutes les données et revenir aux conditions initiales',tip_slider:'Glisser pour ajuster ce paramètre — la visualisation se met à jour en temps réel',tip_theme:'Basculer entre 8 thèmes visuels dont 2 thèmes clairs islamiques',tip_help:'Ouvrir le panneau d\x27aide avec FAQ, guides, wiki et défis',explorerTitle:'Explorateur d\x27espace paramétrique',explorerStart:'Auto-Explorer',explorerStop:'Arrêter l\x27exploration',explorerProgress:'Exploration des combinaisons...',explorerResult:'Exploration terminée',explorerInfo:'Teste systématiquement min/milieu/max pour chaque curseur et enregistre les résultats',title:'Labo Oracle de Rembourrage',subtitle:'Exploitez l\'oracle de rembourrage CBC',mainSection:'Attaque Oracle',mainDesc:'Simulez l\'attaque sur AES-CBC',ptLabel:'Texte Clair Secret',ptHint:'Ce message sera chiffre; essayez de le recuperer',encrypt:'Chiffrer',startAttack:'Lancer Attaque',stop:'Arreter',results:'Resultats',peerTitle:'ð¥ Peer Mode',peerConnect:'Connect',peerDisconnect:'Disconnect',peerStatus:'Peer Status',peerSend:'Sent',peerReceive:'Received',peerInfo:'Open this app in two tabs to sync parameters via BroadcastChannel',heatmapTitle:'ð Activity Heatmap',heatmapToday:'Today',heatmapStreak:'Streak',heatmapTotal:'Total',heatmapLegend:'Less \u2192 More',vizTitle:'Visualisation',vizHint:'Regardez l\'oracle reveler le texte octet par octet',sectionA:'Reference',sectionB:'Maths',settings:'Parametres',language:'Langue',theme:'Theme',soundEffects:'Effets sonores',help:'Aide',faq:'FAQ',howto:'Guide',wiki:'Wiki',activityLog:'Journal',ready:'Pret',splashHint:'appuyer pour passer',langChanged:'Langue -> Francais',themeChanged:'Theme ->',encrypted:'Message chiffre',attacking:'Attaque en cours...',decrypted:'Dechiffre!',padValid:'Rembourrage valide',padInvalid:'Rembourrage invalide' + 'autres systemes.',
    howto_1:'L écran principal affiche la simulation Padding Oracle Lab. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for Padding Oracle Lab. Choose your',howto_2:'Cliquez Chiffrer.',howto_3:'Cliquez Lancer Attaque.',howto_4:'Regardez la recuperation.',
    ...
    theory: 'Padding Oracle Lab démontre les principes clés de attaques crypto. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. AES (Advanced Encryption Standard) is a symmetric block cipher using 128-bit blocks and 128/192/256-bit keys. It applies 10-14 rounds of substitution-permutation. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
  ...
  ar:{tooltipTitle:'تلميحات ذكية',tooltipToggle:'تبديل التلميحات',tip_start:'ابدأ المحاكاة وشاهد الرسم البياني ينبض بالحياة',tip_stop:'أوقف المحاكاة مؤقتاً مع الحفاظ على الحالة الحالية',tip_reset:'امسح جميع البيانات وعد إلى الشروط الأولية',tip_slider:'اسحب لضبط هذا المعامل — يتحدث الرسم البياني في الوقت الفعلي',tip_theme:'بدّل بين 8 مظاهر مرئية منها تصميمان إسلاميان فاتحان',tip_help:'افتح لوحة المساعدة مع الأسئلة الشائعة والأدلة والويكي والتحديات',explorerTitle:'مستكشف فضاء المعاملات',explorerStart:'استكشاف تلقائي',explorerStop:'إيقاف الاستكشاف',explorerProgress:'جارٍ استكشاف التوليفات...',explorerResult:'اكتمل الاستكشاف',explorerInfo:'يختبر بشكل منهجي الحد الأدنى/الوسط/الأقصى لكل منزلق ويسجل النتائج',title:'مختبر هجوم الحشو',subtitle:'استغل هجوم الحشو لفك التشفير بايت ببايت',peerTitle:'ð¥ Mode Pair',peerConnect:'Connecter',peerDisconnect:'D\xe9connecter',peerStatus:'Statut pair',peerSend:'Envoy\xe9',peerReceive:'Re\xe7u',peerInfo:'Ouvrez cette app dans deux onglets pour synchroniser les param\xe8tres',heatmapTitle:'ð Carte d\x27activit\xe9',heatmapToday:'Aujourd\x27hui',heatmapStreak:'S\xe9rie',heatmapTotal:'Total',heatmapLegend:'Moins \u2192 Plus',mainSection:'هجوم أوراكل الحشو',mainDesc:'حاكي هجوم الحشو على AES-CBC',ptLabel:'النص السري',ptHint:'سيتم تشفير هذه الرسالة، حاول استرجاعها',encrypt:'تشفير',startAttack:'بدء الهجوم',stop:'إيقاف',results:'النتائج',vizTitle:'تصور الهجوم',vizHint:'شاهد الأوراكل يسرّب النص بايت ببايت',sectionA:'مرجع الهجوم',sectionB:'تعمق رياضي',settings:'الإعدادات',language:'اللغة',theme:'المظهر',soundEffects:'مؤثرات صوتية',help:'مساعدة',faq:'أسئلة شائعة',howto:'كيف تستخدم',wiki:'ويكي',activityLog:'سجل النشاط',ready:'جاهز',splashHint:'انقر للتخطي',langChanged:'اللغة <- العربية',themeChanged:'المظهر <-',encrypted:'تم التشفير',attacking:'جاري الهجوم...',decrypted:'تم فك التشفير!',padValid:'حشو صالح',padInvalid:'حشو غير صالح',
    ...
    theory: 'Padding Oracle Lab يوضح المبادئ الأساسية في هجمات التشفير. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. AES (Advanced Encryption Standard) is a symmetric block cipher using 128-bit blocks and 128/192/256-bit keys. It applies 10-14 rounds of substitution-permutation. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
