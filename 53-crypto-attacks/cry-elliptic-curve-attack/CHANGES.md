# Changelog — Elliptic Curve Attack
...
- Choose Algorithm step card
- Set Up Attack step card
- Execute Attack step card
- Analyze Results step card
- Curve Reference section
- Math Deep Dive section
