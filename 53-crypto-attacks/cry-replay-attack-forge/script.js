...
const LANG={
  en:{
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Pretexting Simulator',related1_desc:'Craft and test social engineering pretexts in a safe environment',related1_path:'../../51-social-engineering/se-pretexting-simulator/index.html',related2_name:'NFC Skimmer Sim — Contactless Card Attack Lab',related2_desc:'Simulate NFC/RFID skimming attacks and learn detection techniques',related2_path:'../../52-hardware-implants/imp-nfc-skimmer-sim/index.html',related3_name:'Burst Transmitter — Quick Data Bursts',related3_desc:'Compress, encrypt, and transmit data in millisecond bursts',related3_path:'../../39-agent-gear/pi-burst-transmitter/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Quantum Attack Simulator',pathPrev_path:'../../53-crypto-attacks/cry-quantum-key-cracker/index.html',pathNext_name:'Factoring Lab',pathNext_path:'../../53-crypto-attacks/cry-rsa-factoring-race/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
  ...
  fr:{tooltipTitle:'Infobulles intelligentes',tooltipToggle:'Activer les infobulles',tip_start:'Lancer la simulation et observer la visualisation s\x27animer',tip_stop:'Mettre en pause la simulation en conservant l\x27état actuel',tip_reset:'Effacer toutes les données et revenir aux conditions initiales',tip_slider:'Glisser pour ajuster ce paramètre — la visualisation se met à jour en temps réel',tip_theme:'Basculer entre 8 thèmes visuels dont 2 thèmes clairs islamiques',tip_help:'Ouvrir le panneau d\x27aide avec FAQ, guides, wiki et défis',explorerTitle:'Explorateur d\x27espace paramétrique',explorerStart:'Auto-Explorer',explorerStop:'Arrêter l\x27exploration',explorerProgress:'Exploration des combinaisons...',explorerResult:'Exploration terminée',explorerInfo:'Teste systématiquement min/milieu/max pour chaque curseur et enregistre les résultats',title:'Forge Attaque Rejeu',subtitle:'Capturez et rejouez des jetons d\'authentification',mainSection:'Labo Attaque Rejeu',mainDesc:'Interceptez et rejouez des jetons captures',authenticate:'Authentifier',capture:'Capturer Jeton',replay:'Attaque Rejeu',useNonce:'Activer protection nonce',results:'Resultats',vizTitle:'Trafic Reseau',peerTitle:'ð¥ Peer Mode',peerConnect:'Connect',peerDisconnect:'Disconnect',peerStatus:'Peer Status',peerSend:'Sent',peerReceive:'Received',peerInfo:'Open this app in two tabs to sync parameters via BroadcastChannel',heatmapTitle:'ð Activity Heatmap',heatmapToday:'Today',heatmapStreak:'Streak',heatmapTotal:'Total',heatmapLegend:'Less \u2192 More',vizHint:'Regardez les paquets circuler',sectionA:'Reference',sectionB:'Strategies Defense',settings:'Parametres',language:'Langue',theme:'Theme',soundEffects:'Sons',help:'Aide',faq:'FAQ',howto:'Guide',wiki:'Wiki',activityLog:'Journal',ready:'Pret',splashHint:'appuyer pour passer',langChanged:'Langue -> Francais',themeChanged:'Theme ->',authSuccess:'Authentification reussie',captured:'Jeton capture par l\'attaquant!',replaySuccess:'Rejeu REUSSI - acces non autorise!',replayBlocked:'Rejeu BLOQUE - nonce deja utilise!',noToken:'Aucun jeton capture',howto_1:'L écran principal affiche la simulation Replay Attack Forge. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for Replay Attack Forge. Choose you',howto_2:'Cliquez Capturer.',howto_3:'Cliquez Rejeu.',howto_4:'Activez le nonce.',
    ...
    theory: 'Replay Attack Forge démontre les principes clés de attaques crypto. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
  ...
  ar:{tooltipTitle:'تلميحات ذكية',tooltipToggle:'تبديل التلميحات',tip_start:'ابدأ المحاكاة وشاهد الرسم البياني ينبض بالحياة',tip_stop:'أوقف المحاكاة مؤقتاً مع الحفاظ على الحالة الحالية',tip_reset:'امسح جميع البيانات وعد إلى الشروط الأولية',tip_slider:'اسحب لضبط هذا المعامل — يتحدث الرسم البياني في الوقت الفعلي',tip_theme:'بدّل بين 8 مظاهر مرئية منها تصميمان إسلاميان فاتحان',tip_help:'افتح لوحة المساعدة مع الأسئلة الشائعة والأدلة والويكي والتحديات',explorerTitle:'مستكشف فضاء المعاملات',explorerStart:'استكشاف تلقائي',explorerStop:'إيقاف الاستكشاف',explorerProgress:'جارٍ استكشاف التوليفات...',explorerResult:'اكتمل الاستكشاف',explorerInfo:'يختبر بشكل منهجي الحد الأدنى/الوسط/الأقصى لكل منزلق ويسجل النتائج',title:'تزوير هجوم الإعادة',subtitle:'التقط وأعد تشغيل رموز المصادقة',mainSection:'مختبر هجوم الإعادة',peerTitle:'ð¥ Mode Pair',peerConnect:'Connecter',peerDisconnect:'D\xe9connecter',peerStatus:'Statut pair',peerSend:'Envoy\xe9',peerReceive:'Re\xe7u',peerInfo:'Ouvrez cette app dans deux onglets pour synchroniser les param\xe8tres',heatmapTitle:'ð Carte d\x27activit\xe9',heatmapToday:'Aujourd\x27hui',heatmapStreak:'S\xe9rie',heatmapTotal:'Total',heatmapLegend:'Moins \u2192 Plus',mainDesc:'اعترض وأعد تشغيل الرموز الملتقطة',authenticate:'مصادقة',capture:'التقاط الرمز',replay:'هجوم الإعادة',useNonce:'تفعيل حماية nonce',results:'النتائج',vizTitle:'حركة الشبكة',vizHint:'شاهد الحزم تتدفق بين العميل والمهاجم والخادم',sectionA:'مرجع',sectionB:'استراتيجيات الدفاع',settings:'الإعدادات',language:'اللغة',theme:'المظهر',soundEffects:'مؤثرات',help:'مساعدة',faq:'أسئلة شائعة',howto:'كيف تستخدم',wiki:'ويكي',activityLog:'سجل',ready:'جاهز',splashHint:'انقر للتخطي',langChanged:'اللغة <- العربية',themeChanged:'المظهر <-',authSuccess:'نجحت المصادقة',captured:'تم التقاط الرمز!',replaySuccess:'نجح هجوم الإعادة - وصول غير مصرح!',replayBlocked:'تم حظر الإعادة - nonce مستخدم!',noToken:'لم يتم التقاط رمز بعد',howto_1:'تعرض الشاشة الرئيسية محاكاة Replay Attack Forge. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Configure the parameters for Replay Attack Forge. Choose you',howto_2:'اضغط التقاط.',howto_3:'اضغط هجوم الإعادة.',howto_4:'فعّل حماية nonce.',
    ...
    theory: 'Replay Attack Forge يوضح المبادئ الأساسية في هجمات التشفير. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
