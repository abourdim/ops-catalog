...
const LANG={
 ...
 howto_1:'The main display shows the Birthday Paradox Demo simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Configure the parameters for Birthday Paradox Demo. Choose y',howto_2:'Press the "Start" button. The main visualization will start animating. Watch carefully — colors, movement, and numbers all represent real data from the simulation. The status indicator in the top-right turns green when running.',howto_3:'Scroll down to the expandable sections. "Attack Reference" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',howto_4:'Now experiment: change one parameter at a time. Press Stop, adjust a slider, then Start again. Compare the new output with what you saw before. This is how real engineers and scientists work — isolate one variable, observe the effect, and build understanding step by step.',
 wiki_birthday: 'This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_attack: '2^(n/2) This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_defense: 'This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'BBS Console',related1_desc:'AX.25 packet radio bulletin board system',related1_path:'../../37-pi-core/pi-packet-bbs/index.html',related2_name:'Credential Harvester',related2_desc:'Understand how fake login pages steal credentials',related2_path:'../../51-social-engineering/se-credential-harvester/index.html',related3_name:'Kiosk Dashboard',related3_desc:'Multi-display RF monitoring dashboard kiosk',related3_path:'../../37-pi-core/pi-kiosk/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Side Channel Analysis',pathPrev_path:'../../53-crypto-attacks/cry-aes-side-channel/index.html',pathNext_name:'Padding Oracle Lab',pathNext_path:'../../53-crypto-attacks/cry-bleichenbacher-attack/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 hashBitsLabel:'Taille du Hachage (bits)',hashBitsHint:'Plus petit = collisions plus rapides',peerTitle:'👥 Peer Mode',peerConnect:'Connect',peerDisconnect:'Disconnect',peerStatus:'Peer Status',peerSend:'Sent',peerReceive:'Received',peerInfo:'Open this app in two tabs to sync parameters via BroadcastChannel',heatmapTitle:'📅 Activity Heatmap',heatmapToday:'Today',heatmapStreak:'Streak',heatmapTotal:'Total',heatmapLegend:'Less \u2192 More',
 ...
 howto_1:'L écran principal affiche la simulation Birthday Paradox Demo. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for Birthday Paradox Demo. Choose y',howto_2:'Cliquez Trouver Collision.',howto_3:'Lancez la simulation pour des statistiques.',howto_4:'Affichez la courbe theorique.',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Birthday Paradox Demo. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Configure the parameters for Birthday Paradox Demo. Choose y',howto_2:'انقر ايجاد تصادم.',howto_3:'شغل المحاكاة للاحصائيات.',howto_4:'اعرض المنحنى النظري.',
