/**
 * SDR AIS Maritime — Workshop DIY v1.2
 * Decode AIS maritime vessel tracking
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-4C0419',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master SDR AIS Maritime \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 theory: 'Ais Maritime demonstrates key principles from signal processing. Radar transmits electromagnetic pulses and measures reflections to detect objects. Range, velocity, and angle can be determined from the echo characteristics. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-4C0419',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez SDR AIS Maritime \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 theory: 'Ais Maritime démontre les principes clés de traitement du signal. Radar transmits electromagnetic pulses and measures reflections to detect objects. Range, velocity, and angle can be determined from the echo characteristics. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 theory: 'Ais Maritime يوضح المبادئ الأساسية في معالجة الإشارات. Radar transmits electromagnetic pulses and measures reflections to detect objects. Range, velocity, and angle can be determined from the echo characteristics. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'خط انابيب المستقبل',related1_desc:'DSP خطوة بخطوة: من الهوائي الى الصوت',related1_path:'../../33-sdr-learning/sdr-build-receiver/index.html',related2_name:'مولد الاشارات',related2_desc:'انشئ اشارات اختبار مع شكل الموجة والطيف',related2_path:'../../27-sdr-dsp/sdr-signal-generator/index.html',related3_name:'\\u0645\\u062f\\u064a\\u0631 \\u0641\\u0636 \\u0627\\u0644\\u062a\\u0639\\u0627\\u0631\\u0636',related3_desc:'\\u062a\\u062e\\u0635\\u064a\\u0635 \\u0627\\u0644\\u0637\\u064a\\u0641 \\u0648\\u0643\\u0634\\u0641 \\u0627\\u0644\\u062a\\u0639\\u0627\\u0631\\u0636',related3_path:'../../54-rf-warfare/rfw-frequency-deconfliction/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'فك تشفير ACARS',pathPrev_path:'../../29-sdr-aviation/sdr-acars-decoder/index.html',pathNext_name:'خريطة البرق',pathNext_path:'../../29-sdr-aviation/sdr-lightning/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ماذا تعني SDR؟',quiz_q1a:'مرحل بيانات الإشارة',quiz_q1b:'الراديو المعرف بالبرمجيات',quiz_q1c:'مستقبل رقمي آمن',quiz_q1d:'معدل بيانات قياسي',quiz_q1_answer:'1',quiz_q2:'ما الذي يستبدله SDR بالبرمجيات؟',quiz_q2a:'الهوائي',quiz_q2b:'مكونات الراديو المادية',quiz_q2c:'مصدر الطاقة',quiz_q2d:'الشاشة',quiz_q2_answer:'1',quiz_q3:'ما هو التعلم الآلي؟',quiz_q3a:'برمجة الروبوتات',quiz_q3b:'أنظمة تتعلم من البيانات',quiz_q3c:'حساب يدوي',quiz_q3d:'تصميم العتاد',quiz_q3_answer:'1',quiz_q4:'على ماذا يعتمد RTL-SDR؟',quiz_q4a:'FPGA',quiz_q4b:'شريحة RTL2832U',quiz_q4c:'راسبيري باي',quiz_q4d:'أردوينو',quiz_q4_answer:'1',quiz_q5:'ما هي الشبكة العصبية؟',quiz_q5a:'أسلاك مادية',quiz_q5b:'نظام حوسبة مستوحى من الخلايا العصبية',quiz_q5c:'شبكة اجتماعية',quiz_q5d:'شبكة راديو',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'يولد مصادم الهادرونات الكبير في سيرن 1 بيتابايت في الثانية أثناء التصادمات. في عام 2012 أكد بوزون هيغز مكملاً النموذج القياسي للفيزياء.',realworld2:'رصد مرصد ليغو موجات الجاذبية عام 2015 مؤكدًا تنبؤ أينشتاين قبل 100 عام. قاست المستشعرات تشوهات في الزمكان بمقدار 10⁻²¹ متر.',realworld3:'يتواصل المسبار فويجر 1 الذي أُطلق عام 1977 من مسافة 24 مليار كم باستخدام مرسل بقدرة 23 واط. تستغرق الإشارات أكثر من 22 ساعة في كل اتجاه.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في عمليات الاستخبارات معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في عمليات الاستخبارات وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'SDR AIS Maritime يوضح مفهومًا أساسيًا في عمليات الاستخبارات. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في SDR AIS Maritime لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في عمليات الاستخبارات هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ SDR وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال عمليات الاستخبارات يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'استخدم متوسط FFT من 16-64 إطارًا لتمييز الإشارات الحقيقية عن تغيرات أرضية الضوضاء.',proTip2:'استخدم مرشح نطاق قبل SDR لرفض الإشارات القوية خارج النطاق. يمكن لمحطة FM قريبة أن تقلل حساسية جهاز الاستقبال.',funFactTitle:'🎯 هل تعلم؟',funFact:'النجم النيوتروني كثيف لدرجة أن ملعقة صغيرة من مادته ستزن حوالي 6 مليارات طن على الأرض.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
(function(){var canvas=$('aisRadar'),lb=$('aisVessels'),stB=$('aisStartBtn'),spB=$('aisStopBtn'),cE=$('aisCount');if(!canvas)return;var ctx=canvas.getContext('2d'),run=false,anim=null;
var NM=['EVER GIVEN','MSC OSCAR','MAERSK LINE','CMA CGM','HAPAG LLOYD','COSCO STAR','YANG MING','ZIM ATLAS','PIL PIONEER'];var VT=['Cargo','Tanker','Container','Fishing','Passenger','Tug','Bulk Carrier'];var FL=['PA','LR','MH','SG','HK','MT','NO','MA','DZ'];
var vs=[];function gv(){return{mmsi:2e8+Math.random()*6e8|0,nm:NM[Math.random()*NM.length|0],tp:VT[Math.random()*VT.length|0],fl:FL[Math.random()*FL.length|0],sp:(Math.random()*18).toFixed(1),hd:Math.random()*360|0,x:Math.random()*canvas.width,y:Math.random()*canvas.height,vx:(Math.random()-.5)*.5,vy:(Math.random()-.5)*.5,co:'hsl('+(Math.random()*360|0)+',70%,60%)'}}for(var i=0;i<8;i++)vs.push(gv());
function dr(t){var W=canvas.width,H=canvas.height,cx=W/2,cy=H/2;ctx.fillStyle='#0a1a0a';ctx.fillRect(0,0,W,H);ctx.strokeStyle='rgba(0,200,80,.15)';ctx.lineWidth=1;for(var r=40;r<Math.max(W,H);r+=60){ctx.beginPath();ctx.arc(cx,cy,r,0,Math.PI*2);ctx.stroke();}for(var a=0;a<Math.PI*2;a+=Math.PI/6){ctx.beginPath();ctx.moveTo(cx,cy);ctx.lineTo(cx+Math.cos(a)*W,cy+Math.sin(a)*H);ctx.stroke();}var sw=(t*.001)%(Math.PI*2);ctx.save();ctx.globalAlpha=.3;ctx.fillStyle='#00c850';ctx.beginPath();ctx.moveTo(cx,cy);ctx.arc(cx,cy,Math.max(W,H),sw-.4,sw);ctx.closePath();ctx.fill();ctx.restore();
vs.forEach(function(v){v.x+=v.vx;v.y+=v.vy;if(v.x<0||v.x>W)v.vx*=-1;if(v.y<0||v.y>H)v.vy*=-1;ctx.save();ctx.translate(v.x,v.y);ctx.rotate(v.hd*Math.PI/180);ctx.fillStyle=v.co;ctx.beginPath();ctx.moveTo(0,-8);ctx.lineTo(-5,6);ctx.lineTo(5,6);ctx.closePath();ctx.fill();ctx.restore();ctx.fillStyle='#aaa';ctx.font='9px monospace';ctx.fillText(v.nm.substring(0,10),v.x+8,v.y-4);});ctx.fillStyle='#00c850';ctx.font='11px Orbitron,monospace';ctx.fillText('161.975 MHz AIS Vessels: '+vs.length,8,16);}
function ul(){if(!lb)return;lb.innerHTML='';vs.forEach(function(v){var r=document.createElement('tr');r.innerHTML='<td style="color:#00c850;font-weight:bold">'+v.mmsi+'</td><td>'+v.nm+'</td><td>'+v.tp+'</td><td>'+v.fl+'</td><td>'+v.sp+'kn</td><td>'+v.hd+'°</td>';lb.appendChild(r);});}
var lu=0;function an(t){if(!run)return;dr(t);if(t-lu>3e3){if(Math.random()>.6&&vs.length<15){var nv=gv();vs.push(nv);if(cE)cE.textContent=vs.length;log('\u{1F6A2} AIS: '+nv.nm,'rx');}ul();lu=t;}anim=requestAnimationFrame(an);}
if(stB)stB.onclick=function(){if(run)return;run=true;setStatus(true);log('AIS started','success');anim=requestAnimationFrame(an);};if(spB)spB.onclick=function(){run=false;setStatus(false);if(anim)cancelAnimationFrame(anim);log('AIS stopped','info');};dr(0);ul();})();
