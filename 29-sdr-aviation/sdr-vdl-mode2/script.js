/**
 * SDR VDL Mode 2 — Workshop DIY v1.2
 * Decode VDL Mode 2 aviation data link messages
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-6BC7E1',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master SDR VDL Mode 2 \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 theory: 'Vdl Mode2 démontre les principes clés de traitement du signal. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 theory: 'Vdl Mode2 يوضح المبادئ الأساسية في معالجة الإشارات. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'الماسح الصناعي',related1_desc:'مراقبة ترددات SCADA/ICS',related1_path:'../../31-sdr-iot/sdr-industrial/index.html',related2_name:'القسم الرئيسي',related2_desc:'صِف مشروعك هنا',related2_path:'../../31-sdr-iot/sdr-keyfob/index.html',related3_name:'\\u0645\\u062d\\u0627\\u0643\\u064a \\u0627\\u0644\\u062d\\u0631\\u0628 \\u0627\\u0644\\u0625\\u0644\\u0643\\u062a\\u0631\\u0648\\u0646\\u064a\\u0629',related3_desc:'\\u0645\\u062d\\u0627\\u0643\\u0627\\u0629 \\u0627\\u0644\\u062a\\u0634\\u0648\\u064a\\u0634 \\u0648\\u0627\\u0644\\u0625\\u062c\\u0631\\u0627\\u0621\\u0627\\u062a \\u0627\\u0644\\u0645\\u0636\\u0627\\u062f\\u0629',related3_path:'../../54-rf-warfare/rfw-electronic-warfare-sim/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'متتبع الراديوسوند',pathPrev_path:'../../29-sdr-aviation/sdr-radiosonde/index.html',pathNext_name:'ماسح VHF',pathNext_path:'../../29-sdr-aviation/sdr-vhf-airband/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ما العلاقة بين طول الموجة والتردد؟',quiz_q1a:'تناسب طردي',quiz_q1b:'تناسب عكسي',quiz_q1c:'لا علاقة',quiz_q1d:'أسية',quiz_q1_answer:'1',quiz_q2:'كم بت في البايت؟',quiz_q2a:'4',quiz_q2b:'8',quiz_q2c:'16',quiz_q2d:'32',quiz_q2_answer:'1',quiz_q3:'ماذا يفعل التعديل للإشارة؟',quiz_q3a:'يحذفها',quiz_q3b:'يشفر المعلومات على موجة حاملة',quiz_q3c:'يجعلها أعلى',quiz_q3d:'يوقف الإرسال',quiz_q3_answer:'1',quiz_q4:'ماذا تعني SDR؟',quiz_q4a:'مرحل بيانات الإشارة',quiz_q4b:'الراديو المعرف بالبرمجيات',quiz_q4c:'مستقبل رقمي آمن',quiz_q4d:'معدل بيانات قياسي',quiz_q4_answer:'1',quiz_q5:'ما هو البت؟',quiz_q5a:'8 بايتات',quiz_q5b:'أصغر وحدة بيانات (0 أو 1)',quiz_q5c:'نوع من الأسلاك',quiz_q5d:'نطاق تردد',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'يولد مصادم الهادرونات الكبير في سيرن 1 بيتابايت في الثانية أثناء التصادمات. في عام 2012 أكد بوزون هيغز مكملاً النموذج القياسي للفيزياء.',realworld2:'رصد مرصد ليغو موجات الجاذبية عام 2015 مؤكدًا تنبؤ أينشتاين قبل 100 عام. قاست المستشعرات تشوهات في الزمكان بمقدار 10⁻²¹ متر.',realworld3:'يتواصل المسبار فويجر 1 الذي أُطلق عام 1977 من مسافة 24 مليار كم باستخدام مرسل بقدرة 23 واط. تستغرق الإشارات أكثر من 22 ساعة في كل اتجاه.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في عمليات الاستخبارات معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في عمليات الاستخبارات وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'SDR VDL Mode 2 يوضح مفهومًا أساسيًا في عمليات الاستخبارات. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في SDR VDL Mode 2 لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في عمليات الاستخبارات هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ SDR وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال عمليات الاستخبارات يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'استخدم متوسط FFT من 16-64 إطارًا لتمييز الإشارات الحقيقية عن تغيرات أرضية الضوضاء.',proTip2:'استخدم مرشح نطاق قبل SDR لرفض الإشارات القوية خارج النطاق. يمكن لمحطة FM قريبة أن تقلل حساسية جهاز الاستقبال.',funFactTitle:'🎯 هل تعلم؟',funFact:'يصل البرق إلى درجة حرارة 30,000 درجة مئوية — خمس مرات أسخن من سطح الشمس.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
(function(){var canvas=$('vdlWaveform'),tbl=$('vdlFrames'),stB=$('vdlStartBtn'),spB=$('vdlStopBtn'),cE=$('vdlCount');if(!canvas)return;var ctx=canvas.getContext('2d'),run=false,anim=null,cnt=0;
var RG=['N789UA','G-BNLY','F-GKXA','D-AIMC','A6-EEA','TC-JJM','HZ-AK3','CN-RGN','7T-VJB'];var GR=['EDDF','LFPG','EGLL','OMDB','LTFM','GMMN','DAAG','HECA'];var MT=['ACARS over AVLC','ATN CPDLC','ADS-C','Context Mgmt','XID','GSIF'];
function gf(){var r=RG[Math.random()*RG.length|0],g=GR[Math.random()*GR.length|0],tp=MT[Math.random()*MT.length|0],fq=(136.7+Math.random()*.25).toFixed(3),hex='';for(var i=0;i<16;i++)hex+='0123456789ABCDEF'[Math.random()*16|0];return{rg:r,gr:g,tp:tp,fq:fq,hex:hex,tm:new Date().toLocaleTimeString()};}
function dw(t){var W=canvas.width,H=canvas.height;ctx.fillStyle='#0a0a1a';ctx.fillRect(0,0,W,H);ctx.strokeStyle='rgba(0,229,255,.2)';ctx.lineWidth=1;ctx.beginPath();ctx.arc(W-80,H/2,40,0,Math.PI*2);ctx.stroke();for(var i=0;i<8;i++){var a=i*Math.PI/4+t*.002;ctx.fillStyle='#00e5ff';ctx.beginPath();ctx.arc(W-80+Math.cos(a)*35+Math.random()*6-3,H/2+Math.sin(a)*35+Math.random()*6-3,3,0,Math.PI*2);ctx.fill();}ctx.strokeStyle='#00e5ff';ctx.lineWidth=1.5;ctx.beginPath();for(var x=0;x<W-170;x++){var f=x/W,pwr=-80+20*Math.exp(-Math.pow((f-.4)*10,2))+Math.random()*5,y=H-(pwr+100)*H/60;x===0?ctx.moveTo(x,y):ctx.lineTo(x,y);}ctx.stroke();ctx.fillStyle='#00e5ff';ctx.font='11px Orbitron,monospace';ctx.fillText('136.725-136.975 MHz VDL Mode 2 D8PSK 31.5kbps',8,16);}
function addF(f){if(!tbl)return;var r=document.createElement('tr');r.innerHTML='<td>'+f.tm+'</td><td style="color:#00e5ff;font-weight:bold">'+f.rg+'</td><td>'+f.gr+'</td><td>'+f.tp+'</td><td>'+f.fq+' MHz</td><td style="font-family:monospace;font-size:10px;color:#888">'+f.hex+'</td>';r.style.animation='fadeIn .3s';tbl.insertBefore(r,tbl.firstChild);if(tbl.children.length>40)tbl.removeChild(tbl.lastChild);cnt++;if(cE)cE.textContent=cnt;}
var lm=0;function an(t){if(!run)return;dw(t);if(t-lm>1200+Math.random()*2500){var f=gf();addF(f);log('\u2708 VDL2: '+f.rg+''+f.tp,'rx');lm=t;}anim=requestAnimationFrame(an);}
if(stB)stB.onclick=function(){if(run)return;run=true;setStatus(true);log('VDL Mode 2 started','success');anim=requestAnimationFrame(an);};if(spB)spB.onclick=function(){run=false;setStatus(false);if(anim)cancelAnimationFrame(anim);log('VDL Mode 2 stopped','info');};dw(0);})();
