/**
 * SDR NAVTEX Decoder — Workshop DIY v1.2
 * Decode NAVTEX maritime safety messages
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-515FCF',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master SDR NAVTEX Decoder \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 theory: 'Navtex demonstrates key principles from signal processing. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-515FCF',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez SDR NAVTEX Decoder \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 theory: 'Navtex démontre les principes clés de traitement du signal. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 theory: 'Navtex يوضح المبادئ الأساسية في معالجة الإشارات. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'القسم الرئيسي',related1_desc:'صِف مشروعك هنا',related1_path:'../../31-sdr-iot/sdr-tpms/index.html',related2_name:'\\u0645\\u062E\\u062A\\u0628\\u0631 \\u0627\\u0644\\u0625\\u0639\\u0627\\u062F\\u0629',related2_desc:'\\u0644\\u0645\\u0627\\u0630\\u0627 \\u0627\\u0644\\u0631\\u0645\\u0648\\u0632 \\u0627\\u0644\\u0645\\u062A\\u063A\\u064A\\u0631\\u0629 \\u062A\\u0647\\u0632\\u0645 \\u0627\\u0644\\u0625\\u0639\\u0627\\u062F\\u0629',related2_path:'../../10-hrf-sigint/hrf-replay-lab/index.html',related3_name:'راسم الذبذبات',related3_desc:'عرض الإشارة الزمنية في الوقت الحقيقي',related3_path:'../../32-sdr-tools/sdr-oscilloscope/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'خريطة البرق',pathPrev_path:'../../29-sdr-aviation/sdr-lightning/index.html',pathNext_name:'متتبع الراديوسوند',pathNext_path:'../../29-sdr-aviation/sdr-radiosonde/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'على ماذا يعتمد RTL-SDR؟',quiz_q1a:'FPGA',quiz_q1b:'شريحة RTL2832U',quiz_q1c:'راسبيري باي',quiz_q1d:'أردوينو',quiz_q1_answer:'1',quiz_q2:'ما العلاقة بين طول الموجة والتردد؟',quiz_q2a:'تناسب طردي',quiz_q2b:'تناسب عكسي',quiz_q2c:'لا علاقة',quiz_q2d:'أسية',quiz_q2_answer:'1',quiz_q3:'ماذا تعني SDR؟',quiz_q3a:'مرحل بيانات الإشارة',quiz_q3b:'الراديو المعرف بالبرمجيات',quiz_q3c:'مستقبل رقمي آمن',quiz_q3d:'معدل بيانات قياسي',quiz_q3_answer:'1',quiz_q4:'ما الوحدة الشائعة لقياس قوة الإشارة؟',quiz_q4a:'هرتز',quiz_q4b:'ديسيبل (dBm)',quiz_q4c:'واط فقط',quiz_q4d:'أمتار',quiz_q4_answer:'1',quiz_q5:'ماذا يفعل التعديل للإشارة؟',quiz_q5a:'يحذفها',quiz_q5b:'يشفر المعلومات على موجة حاملة',quiz_q5c:'يجعلها أعلى',quiz_q5d:'يوقف الإرسال',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'رصد مرصد ليغو موجات الجاذبية عام 2015 مؤكدًا تنبؤ أينشتاين قبل 100 عام. قاست المستشعرات تشوهات في الزمكان بمقدار 10⁻²¹ متر.',realworld2:'يتواصل المسبار فويجر 1 الذي أُطلق عام 1977 من مسافة 24 مليار كم باستخدام مرسل بقدرة 23 واط. تستغرق الإشارات أكثر من 22 ساعة في كل اتجاه.',realworld3:'يولد مصادم الهادرونات الكبير في سيرن 1 بيتابايت في الثانية أثناء التصادمات. في عام 2012 أكد بوزون هيغز مكملاً النموذج القياسي للفيزياء.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في عمليات الاستخبارات معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في عمليات الاستخبارات وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'SDR NAVTEX Decoder يوضح مفهومًا أساسيًا في عمليات الاستخبارات. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في SDR NAVTEX Decoder لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في عمليات الاستخبارات هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ SDR وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال عمليات الاستخبارات يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'استخدم مرشح نطاق قبل SDR لرفض الإشارات القوية خارج النطاق. يمكن لمحطة FM قريبة أن تقلل حساسية جهاز الاستقبال.',proTip2:'سجّل بيانات IQ الخام أولاً وحللها لاحقًا. يمكنك دائمًا إعادة معالجة ملفات IQ المحفوظة بإعدادات مختلفة.',funFactTitle:'🎯 هل تعلم؟',funFact:'النجم النيوتروني كثيف لدرجة أن ملعقة صغيرة من مادته ستزن حوالي 6 مليارات طن على الأرض.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
(function(){var canvas=$('navtexWaveform'),ml=$('navtexMessages'),stB=$('navtexStartBtn'),spB=$('navtexStopBtn'),cE=$('navtexCount');if(!canvas)return;var ctx=canvas.getContext('2d'),run=false,anim=null,cnt=0,ph=0;
var ST=['A-Niton','B-Cullercoats','E-Corsen','G-Tarifa','H-Kelibia','J-Algiers','K-Rabat','S-Casablanca','T-Istanbul'];var TP=['NAVIGATIONAL WARNING','WEATHER FORECAST','ICE REPORT','SAR INFORMATION','GALE WARNING','COAST GUARD'];
function gm(){var st=ST[Math.random()*ST.length|0],tp=TP[Math.random()*TP.length|0],body='';if(tp.indexOf('WEATHER')>=0||tp.indexOf('GALE')>=0)body='WIND '+['NW','NE','SW','SE','N','S'][Math.random()*6|0]+''+(10+Math.random()*40|0)+'KT SEA STATE '+(2+Math.random()*6|0);else if(tp.indexOf('NAV')>=0)body='UNLIT BUOY '+(33+Math.random()*5).toFixed(2)+'N '+(5+Math.random()*10).toFixed(2)+'W';else body='MSG '+Date.now().toString(36).toUpperCase()+' ALL STATIONS';return{st:st,tp:tp,body:body,tm:new Date().toLocaleTimeString(),id:String.fromCharCode(65+Math.random()*26|0)+(10+Math.random()*90|0)};}
function dw(t){var W=canvas.width,H=canvas.height;ctx.fillStyle='#0a0a1a';ctx.fillRect(0,0,W,H);ctx.strokeStyle='#4fc3f7';ctx.lineWidth=2;ctx.beginPath();for(var x=0;x<W;x++){var bit=Math.sin(x*.03+ph)>0?1:0;var y=H/2+Math.sin(x*(bit?.12:.06)+t*.002)*H*.35+(Math.random()-.5)*3;x===0?ctx.moveTo(x,y):ctx.lineTo(x,y);}ctx.stroke();ctx.fillStyle='#4fc3f7';ctx.font='11px Orbitron,monospace';ctx.fillText('518 kHz NAVTEX 100 Baud SITOR-B',8,16);ph+=.05;}
function addM(m){if(!ml)return;var d=document.createElement('div');d.style.cssText='padding:8px;margin:4px 0;border:1px solid rgba(79,195,247,.2);border-radius:6px;font-family:monospace;font-size:12px;background:rgba(79,195,247,.05);animation:fadeIn .3s';d.innerHTML='<div style="color:#4fc3f7;font-weight:bold;margin-bottom:4px">ZCZC '+m.id+' ['+m.st+'] '+m.tm+'</div><div style="color:#ffc107;margin-bottom:2px">'+m.tp+'</div><div>'+m.body+'</div><div style="color:#666;margin-top:4px">NNNN</div>';ml.insertBefore(d,ml.firstChild);if(ml.children.length>20)ml.removeChild(ml.lastChild);cnt++;if(cE)cE.textContent=cnt;}
var lm=0;function an(t){if(!run)return;dw(t);if(t-lm>3e3+Math.random()*5e3){var m=gm();addM(m);log('\u{1F30A} NAVTEX: '+m.st+''+m.tp,'rx');lm=t;}anim=requestAnimationFrame(an);}
if(stB)stB.onclick=function(){if(run)return;run=true;setStatus(true);log('NAVTEX started','success');anim=requestAnimationFrame(an);};if(spB)spB.onclick=function(){run=false;setStatus(false);if(anim)cancelAnimationFrame(anim);log('NAVTEX stopped','info');};dw(0);})();
