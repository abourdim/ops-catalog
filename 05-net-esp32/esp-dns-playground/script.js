...
const LANG = {
  en: {
    ...
    howto_4: 'Watch the DNS animation canvas to visualize query resolution flow.',
    ...
    wiki_redirect_title: '🔀 Domain Redirect', wiki_redirect: 'Overriding DNS responses to point domains at different IPs.',
    wiki_esp_title: '📡 ESP32 DNS', wiki_esp: 'ESP32 can run a lightweight DNS server using the DNSServer library.',
    working: 'Working…',
  ...
  fr: {
    ...
    howto_4: 'Regardez l\'animation DNS pour visualiser le flux de resolution.',
  ...
  ar: {
    ...
    howto_4: 'شاهد رسم DNS المتحرك لتصور تدفق حل الاستعلامات.',
