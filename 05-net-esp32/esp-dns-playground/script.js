...
const LANG = {
 ...
 title: 'DNS Playground', subtitle: '🌐 resolve · 🔀 redirect · 🧪 test',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'DNS Playground — Domain Redirector', mainDesc: 'Run a tiny DNS server, redirect domains',
 sectionA: 'Query Log', sectionB: 'DNS Animation', sectionC: 'Challenge',
 addRule: 'Add Rule', resolve: 'Resolve', before: 'Before (Normal DNS)', after: 'After (ESP DNS)',
 startDns: 'Start DNS Server', stopDns: 'Stop', thDomain: 'Domain', thIP: 'Redirect IP',
 challenge1: 'What happens when you redirect a domain to 0.0.0.0?',
 challenge2: 'Can DNS be used for censorship?',
 challenge3: 'Design a parental control DNS filter.',
 revealBtn: 'Reveal',
 challengeReveal1: 'The domain becomes unreachable. This is how ad-blockers and DNS sinkholes work.',
 challengeReveal2: 'Yes. Governments and ISPs can redirect domains to block pages. Users bypass with encrypted DNS (DoH/DoT).',
 challengeReveal3: 'Create rules redirecting harmful domains to a safe page. The ESP32 acts as the network DNS server.',
 dnsStarted: 'DNS server started — intercepting queries',
 dnsStopped: 'DNS server stopped',
 ruleAdded: 'Rule added', ruleRemoved: 'Rule removed',
 resolved: 'Resolved', noMatch: 'No rule match — passed through',
 ...
 howto_1:'The main display shows the Dns Playground simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 howto_3:'Scroll down to the expandable sections. "Query Log" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_dns_title: '🌐 DNS', wiki_dns: 'Translates domains to IPs. Uses UDP port 53. Queries travel: client, resolver, root, TLD, authoritative.',
 wiki_sinkhole_title: '🕳️ DNS Sinkhole', wiki_sinkhole: 'Redirects unwanted domains to a controlled IP. Used for ad-blocking and malware protection.',
 wiki_redirect_title: '🔀 Domain Redirect', wiki_redirect:'Overriding DNS responses to point domains at different IPs. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_esp_title: '📡 ESP32 DNS', wiki_esp:'ESP32 can run a lightweight DNS server using the DNSServer library. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 working: 'Working…',
 ...
 mainSection: 'Terrain DNS — Redirecteur de Domaines', mainDesc: 'Lancez un mini serveur DNS, redirigez des domaines',
 sectionA: 'Journal des Requetes', sectionB: 'Animation DNS', sectionC: 'Defi',
 addRule: 'Ajouter', resolve: 'Resoudre', before: 'Avant (DNS Normal)', after: 'Apres (ESP DNS)',
 startDns: 'Demarrer le Serveur DNS', stopDns: 'Arreter', thDomain: 'Domaine', thIP: 'IP de Redirection',
 dnsStarted: 'Serveur DNS demarre', dnsStopped: 'Serveur DNS arrete',
 ruleAdded: 'Regle ajoutee', ruleRemoved: 'Regle supprimee',
 resolved: 'Resolu', noMatch: 'Pas de correspondance — transmission directe', needDomain: 'Entrez un nom de domaine',
 ...
 wiki_dns_title: '🌐 DNS', wiki_dns: 'Traduit les domaines en IP. Utilise le port UDP 53.',
 wiki_sinkhole_title: '🕳️ Gouffre DNS', wiki_sinkhole: 'Redirige les domaines indesirables vers une IP controlee.',
 wiki_redirect_title: '🔀 Redirection', wiki_redirect: 'Modification des reponses DNS pour pointer vers d\'autres IP.',
 wiki_esp_title: '📡 ESP32 DNS', wiki_esp: 'L\'ESP32 peut executer un serveur DNS leger avec la bibliotheque DNSServer.',
 working: 'En cours…',
 ...
 mainSection: 'ساحة DNS — موجّه النطاقات', mainDesc: 'شغّل خادم DNS صغير وأعد توجيه النطاقات',
 sectionA: 'سجل الاستعلامات', sectionB: 'رسم DNS المتحرك', sectionC: 'تحدي',
 addRule: 'إضافة قاعدة', resolve: 'حلّل', before: 'قبل (DNS عادي)', after: 'بعد (ESP DNS)',
 startDns: 'تشغيل خادم DNS', stopDns: 'إيقاف', thDomain: 'النطاق', thIP: 'عنوان إعادة التوجيه',
 dnsStarted: 'خادم DNS يعمل', dnsStopped: 'خادم DNS متوقف',
 ruleAdded: 'تمت إضافة القاعدة', ruleRemoved: 'تم حذف القاعدة',
 resolved: 'تم الحل', noMatch: 'لا توجد قاعدة مطابقة', needDomain: 'أدخل اسم نطاق',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Dns Playground. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_dns_title: '🌐 DNS', wiki_dns: 'يترجم النطاقات إلى عناوين IP. يستخدم المنفذ UDP 53.',
 wiki_sinkhole_title: '🕳️ حفرة DNS', wiki_sinkhole: 'يعيد توجيه النطاقات غير المرغوبة إلى عنوان IP محكوم.',
 wiki_redirect_title: '🔀 إعادة التوجيه', wiki_redirect: 'تجاوز استجابات DNS للإشارة إلى عناوين IP مختلفة.',
 wiki_esp_title: '📡 ESP32 DNS', wiki_esp: 'يمكن لـ ESP32 تشغيل خادم DNS خفيف باستخدام مكتبة DNSServer.',
 working: 'جارٍ…',
...
/* ═══════ DNS PLAYGROUND SIMULATION ═══════ */

const FAKE_DOMAINS = ['google.com','facebook.com','youtube.com','twitter.com','reddit.com','amazon.com','wikipedia.org','github.com','netflix.com','evil.com','ads.tracker.net','malware.bad','phishing.site','spam.xyz'];
const FAKE_REAL_IPS = ['142.250.80.46','157.240.1.35','172.217.14.206','104.244.42.65','151.101.1.140','176.32.103.205','208.80.154.224','140.82.121.4','54.237.226.164'];
...
function removeRule(btn) {
 ...
 if (tr) tr.remove();
 log(LANG[currentLang].ruleRemoved, 'info');
 playSound('click');
}
...
function getRules() {
 ...
 if (cells.length >= 2) rules[cells[0].textContent.trim()] = cells[1].textContent.trim();
 });
 return rules;
}
...
function resolveDomain(domain) {
 ...
 const fakeRealIP = FAKE_REAL_IPS[Math.floor(Math.random() * FAKE_REAL_IPS.length)];

 if (before) before.textContent = fakeRealIP;

 if (rules[domain]) {
 if (after) after.textContent = rules[domain];
 log(`🔀 ${domain} → ${rules[domain]} (redirected)`, 'success');
 addQueryEntry(domain, rules[domain], true);
 spawnDnsPacket(true);
 } else {
 if (after) after.textContent = fakeRealIP + ' (pass-through)';
 log(`🌐 ${domain} → ${fakeRealIP} (${s.noMatch})`, 'info');
 addQueryEntry(domain, fakeRealIP, false);
 spawnDnsPacket(false);
 }
 playSound('success');
}

function addQueryEntry(domain, result, redirected) {
 const logEl = $('queryLog');
 if (!logEl) return;
 const div = document.createElement('div');
 div.className = 'query-entry';
 div.innerHTML = `<span class="q-time">${new Date().toLocaleTimeString()}</span><span class="q-domain">${domain}</span><span class="q-result">${redirected ? '🔀 ' : ''}${result}</span>`;
 logEl.appendChild(div);
 logEl.scrollTop = logEl.scrollHeight;
}

function initDnsCanvas() {
 dnsCanvas = $('dnsCanvas');
 if (!dnsCanvas) return;
 dnsCtx = dnsCanvas.getContext('2d');
 dnsCanvas.width = dnsCanvas.offsetWidth || 400;
 dnsCanvas.height = 180;

 function draw() {
 dnsCtx.fillStyle = 'rgba(10,10,26,0.12)';
 dnsCtx.fillRect(0, 0, dnsCanvas.width, dnsCanvas.height);
 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#d4a03c';

 // Draw DNS flow labels
 dnsCtx.globalAlpha = 0.2;
 dnsCtx.fillStyle = accent;
 dnsCtx.font = '10px Orbitron, monospace';
 dnsCtx.fillText('CLIENT', 10, 20);
 dnsCtx.fillText('ESP32 DNS', dnsCanvas.width * 0.4, 20);
 dnsCtx.fillText('INTERNET', dnsCanvas.width * 0.8, 20);

 // Draw lines
 dnsCtx.strokeStyle = 'rgba(255,255,255,.06)';
 dnsCtx.setLineDash([4, 6]);
 [0.35, 0.65].forEach(x => {
 dnsCtx.beginPath();
 dnsCtx.moveTo(dnsCanvas.width * x, 0);
 dnsCtx.lineTo(dnsCanvas.width * x, dnsCanvas.height);
 dnsCtx.stroke();
 });
 dnsCtx.setLineDash([]);
 dnsCtx.globalAlpha = 1;

 for (let i = dnsPackets.length - 1; i >= 0; i--) {
 const p = dnsPackets[i];
 p.x += p.vx;
 p.life -= 0.006;
 if (p.life <= 0 || p.x > dnsCanvas.width + 20) { dnsPackets.splice(i, 1); continue; }
 dnsCtx.globalAlpha = p.life;
 dnsCtx.beginPath();
 dnsCtx.arc(p.x, p.y, p.r, 0, Math.PI * 2);
 dnsCtx.fillStyle = p.redirected ? '#ff4444' : accent;
 dnsCtx.fill();
 if (p.redirected && p.x > dnsCanvas.width * 0.35 && p.x < dnsCanvas.width * 0.40) {
 dnsCtx.fillStyle = '#ff4444';
 dnsCtx.font = '8px monospace';
 dnsCtx.fillText('BLOCKED', p.x - 15, p.y - 8);
 }
 }
 dnsCtx.globalAlpha = 1;
...
function spawnDnsPacket(redirected) {
 if (!dnsCanvas) return;
 for (let i = 0; i < 5; i++) {
 dnsPackets.push({
 x: 10 + Math.random() * 20,
 y: 40 + Math.random() * 120,
 vx: redirected ? 1.5 + Math.random() : 2 + Math.random() * 2,
 r: 2 + Math.random() * 3,
...
function initApp() {
 ...
 tr.innerHTML = `<td>${d}</td><td>${ip || '192.168.4.1'}</td><td><button class="btn-sm" onclick="removeRule(this)">✕</button></td>`;
 tbody.appendChild(tr);
 if ($('newDomain')) $('newDomain').value = '';
 if ($('newIP')) $('newIP').value = '';
 log(`${LANG[currentLang].ruleAdded}: ${d} → ${ip || '192.168.4.1'}`, 'success');
 playSound('success');
 };

 const resolveBtn = $('resolveBtn');
 if (resolveBtn) resolveBtn.onclick = () => {
 const d = ($('resolveInput') || {}).value?.trim();
 if (!d) { log(LANG[currentLang].needDomain, 'error'); return; }
 resolveDomain(d);
 };

 const startBtn = $('startDnsBtn');
 const stopBtn = $('stopDnsBtn');
 if (startBtn) startBtn.onclick = () => {
 dnsRunning = true; setStatus(true);
 log(LANG[currentLang].dnsStarted, 'success');
 showToast(LANG[currentLang].dnsStarted, 2000);
 dnsAutoQuery();
 };
 if (stopBtn) stopBtn.onclick = () => {
 dnsRunning = false; if (dnsTimer) clearTimeout(dnsTimer);
 setStatus(false);
 log(LANG[currentLang].dnsStopped, 'info');
 };
}
