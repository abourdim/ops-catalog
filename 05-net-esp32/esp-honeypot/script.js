...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-6AE4C7',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master ESP Honeypot \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'ESP Honeypot', subtitle: '🍯 trap · 📡 log · 🔍 analyze',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'ESP Honeypot — Fake Services', mainDesc: 'Fake SSH, HTTP, FTP that log every connection',
 sectionA: 'Attacker Map', sectionB: 'Credential Harvest', sectionC: 'Challenge',
 attempts: 'Attempts', uniqueIPs: 'Unique IPs', creds: 'Credentials',
 startHoneypot: 'Start Honeypot', stopHoneypot: 'Stop', clearLog: 'Clear Log',
 mapHint: 'Geo-IP locations of simulated attackers',
 thTime: 'Time', thService: 'Service', thUser: 'Username', thPass: 'Password',
 challenge1: 'Why do honeypots help defend a real network?',
 challenge2: 'What is the most common SSH username/password attackers try?',
 challenge3: 'How can you tell a real service from a honeypot?',
 revealBtn: 'Reveal',
 challengeReveal1: 'Honeypots distract attackers from real targets, log their techniques, and provide early warning of intrusions.',
 challengeReveal2: 'root/123456, admin/admin, and root/password are the top three. Automated bots try thousands per hour.',
 challengeReveal3: 'Sophisticated attackers fingerprint service banners and response timing. Good honeypots mimic real services closely.',
 honeypotStarted: 'Honeypot started — listening on all enabled services',
 honeypotStopped: 'Honeypot stopped',
 noServices: 'Enable at least one service first',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Honeypot simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 howto_3:'Scroll down to the expandable sections. "Attacker Map" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_hp_title: '🍯 Honeypots', wiki_hp: 'Decoy systems that mimic real services. Low-interaction honeypots fake banners; high-interaction ones emulate full OS environments.',
 wiki_ssh_title: '🔒 SSH', wiki_ssh: 'Secure Shell, port 22. Used for remote server access. Most attacked service on the internet due to brute-force bots.',
 wiki_cred_title: '🔑 Credential Harvesting', wiki_cred: 'Collecting usernames and passwords that attackers try. Reveals common passwords and attack patterns.',
 wiki_geoip_title: '🗺️ Geo-IP', wiki_geoip: 'Mapping IP addresses to geographic locations. Helps identify attack origin countries and patterns.',
 working: 'Working…',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-6AE4C7',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez ESP Honeypot \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'ESP Pot de Miel', subtitle: '🍯 pieger · 📡 journaliser · 🔍 analyser',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'ESP Honeypot — Faux Services', mainDesc: 'Faux SSH, HTTP, FTP qui enregistrent chaque connexion',
 sectionA: 'Carte des Attaquants', sectionB: 'Recolte de Credentials', sectionC: 'Defi',
 attempts: 'Tentatives', uniqueIPs: 'IPs Uniques', creds: 'Identifiants',
 startHoneypot: 'Demarrer le Honeypot', stopHoneypot: 'Arreter', clearLog: 'Effacer',
 mapHint: 'Localisation geo-IP des attaquants simules',
 thTime: 'Heure', thService: 'Service', thUser: 'Utilisateur', thPass: 'Mot de passe',
 challenge1: 'Pourquoi les honeypots aident-ils a defendre un reseau ?',
 challenge2: 'Quel est le combo utilisateur/mot de passe SSH le plus tente ?',
 challenge3: 'Comment distinguer un vrai service d\'un honeypot ?',
 revealBtn: 'Reveler',
 challengeReveal1: 'Les honeypots detournent les attaquants des vraies cibles et journalisent leurs techniques.',
 challengeReveal2: 'root/123456, admin/admin et root/password sont les trois premiers.',
 challengeReveal3: 'Les attaquants avances analysent les bannieres de service et le timing des reponses.',
 honeypotStarted: 'Honeypot demarre — ecoute sur tous les services actifs',
 honeypotStopped: 'Honeypot arrete',
 noServices: 'Activez au moins un service',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Honeypot. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_hp_title: '🍯 Honeypots', wiki_hp: 'Systemes leurres qui imitent des vrais services. Les honeypots a faible interaction simulent des bannieres.',
 wiki_ssh_title: '🔒 SSH', wiki_ssh: 'Secure Shell, port 22. Utilise pour l\'acces distant aux serveurs. Le service le plus attaque sur Internet.',
 wiki_cred_title: '🔑 Recolte d\'identifiants', wiki_cred: 'Collecte des noms d\'utilisateur et mots de passe tentes par les attaquants.',
 wiki_geoip_title: '🗺️ Geo-IP', wiki_geoip: 'Correspondance des adresses IP aux localisations geographiques.',
 working: 'En cours…',
 ...
 title: 'مصيدة ESP', subtitle: '🍯 اصطد · 📡 سجّل · 🔍 حلّل',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مصيدة ESP — خدمات وهمية', mainDesc: 'SSH و HTTP و FTP وهمية تسجل كل اتصال',
 sectionA: 'خريطة المهاجمين', sectionB: 'حصاد بيانات الدخول', sectionC: 'تحدي',
 attempts: 'محاولات', uniqueIPs: 'عناوين فريدة', creds: 'بيانات دخول',
 startHoneypot: 'تشغيل المصيدة', stopHoneypot: 'إيقاف', clearLog: 'مسح السجل',
 mapHint: 'مواقع المهاجمين المحاكاة جغرافياً',
 thTime: 'الوقت', thService: 'الخدمة', thUser: 'المستخدم', thPass: 'كلمة المرور',
 challenge1: 'لماذا تساعد المصائد في حماية الشبكة الحقيقية؟',
 challenge2: 'ما هو أكثر اسم مستخدم/كلمة مرور SSH يجربها المهاجمون؟',
 challenge3: 'كيف تميز بين خدمة حقيقية ومصيدة؟',
 revealBtn: 'كشف',
 challengeReveal1: 'المصائد تشتت المهاجمين عن الأهداف الحقيقية وتسجل تقنياتهم.',
 challengeReveal2: 'root/123456 و admin/admin و root/password هي الأكثر شيوعاً.',
 challengeReveal3: 'المهاجمون المتقدمون يحللون بصمات الخدمة وتوقيت الاستجابة.',
 honeypotStarted: 'المصيدة تعمل — تستمع على جميع الخدمات المفعلة',
 honeypotStopped: 'المصيدة متوقفة',
 noServices: 'فعّل خدمة واحدة على الأقل',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Honeypot. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_hp_title: '🍯 المصائد', wiki_hp: 'أنظمة خداع تحاكي الخدمات الحقيقية. المصائد منخفضة التفاعل تقلد الشعارات فقط.',
 wiki_ssh_title: '🔒 SSH', wiki_ssh: 'شل آمن، المنفذ 22. يستخدم للوصول عن بعد. أكثر خدمة مهاجمة على الإنترنت.',
 wiki_cred_title: '🔑 حصاد بيانات الدخول', wiki_cred: 'جمع أسماء المستخدمين وكلمات المرور التي يجربها المهاجمون.',
 wiki_geoip_title: '🗺️ جيو-آي بي', wiki_geoip: 'ربط عناوين IP بالمواقع الجغرافية لتحديد أنماط الهجوم.',
 working: 'جارٍ…',
...
const FAKE_IPS = ['185.220.101.42','45.155.205.233','194.165.16.77','103.75.190.11','91.240.118.172','5.188.206.14','162.142.125.222','71.6.199.11','198.235.24.159','43.153.67.88','112.85.42.88','222.186.30.112','218.92.0.107','61.177.172.140','159.89.198.22'];
const FAKE_USERS = ['root','admin','user','test','ubuntu','oracle','postgres','pi','guest','ftpuser','www','mysql','backup','deploy','nagios'];
const FAKE_PASSES = ['123456','password','admin','root','toor','1234','qwerty','letmein','welcome','changeme','test123','passw0rd','12345678','dragon','master'];
const FAKE_CITIES = [
 {name:'Moscow',x:0.58,y:0.28},{name:'Beijing',x:0.78,y:0.33},{name:'Sao Paulo',x:0.32,y:0.68},
 {name:'Lagos',x:0.48,y:0.55},{name:'Mumbai',x:0.68,y:0.42},{name:'Seoul',x:0.82,y:0.32},
 {name:'Tehran',x:0.60,y:0.36},{name:'Jakarta',x:0.78,y:0.58},{name:'Hanoi',x:0.77,y:0.40},
 {name:'Bucharest',x:0.55,y:0.30},{name:'Bogota',x:0.25,y:0.55},{name:'Cairo',x:0.55,y:0.38},
 {name:'Berlin',x:0.52,y:0.27},{name:'Toronto',x:0.22,y:0.30},{name:'Sydney',x:0.88,y:0.72}
];
const SERVICES = ['SSH','HTTP','FTP'];

let honeypotRunning = false;
...
function genAttack() {
 const enabledSvcs = [];
 if ($('sshToggle') && $('sshToggle').checked) enabledSvcs.push('SSH');
 if ($('httpToggle') && $('httpToggle').checked) enabledSvcs.push('HTTP');
 if ($('ftpToggle') && $('ftpToggle').checked) enabledSvcs.push('FTP');
 if (enabledSvcs.length === 0) return null;

 const svc = randItem(enabledSvcs);
 const ip = randItem(FAKE_IPS);
 const user = randItem(FAKE_USERS);
 const pass = randItem(FAKE_PASSES);
 const city = randItem(FAKE_CITIES);
 const time = new Date().toLocaleTimeString();

 return { svc, ip, user, pass, city, time };
}

function addConnEntry(atk) {
 const logEl = $('connLog');
 if (!logEl) return;
 const div = document.createElement('div');
 div.className = 'conn-entry';
 div.innerHTML = `<span class="conn-time">${atk.time}</span><span class="conn-svc">${atk.svc}</span><span class="conn-ip">${atk.ip}</span><span class="conn-cred">${atk.user}:${atk.pass}</span>`;
 logEl.appendChild(div);
 logEl.scrollTop = logEl.scrollHeight;
}

function addCredRow(atk) {
 const tbody = $('credTable');
 if (!tbody) return;
 const tr = document.createElement('tr');
 tr.innerHTML = `<td>${atk.time}</td><td>${atk.svc}</td><td>${atk.user}</td><td style="color:#fca5a5">${atk.pass}</td>`;
 tbody.insertBefore(tr, tbody.firstChild);
}

function updateStats() {
 const ta = $('totalAttempts');
 const ui = $('uniqueIPs');
 const ch = $('credsHarvested');
 if (ta) ta.textContent = attackData.length;
 if (ui) ui.textContent = seenIPs.size;
 if (ch) ch.textContent = attackData.length;
}

function addMapDot(city) {
 mapDots.push({ x: city.x, y: city.y, name: city.name, life: 1.0 });
}
...
function initMapCanvas() {
 ...
 function drawMap() {
 mapCtx.fillStyle = 'rgba(10,10,26,0.12)';
 ...
 // Equator
 mapCtx.beginPath();
 mapCtx.moveTo(0, mapCanvas.height * 0.5);
 mapCtx.lineTo(mapCanvas.width, mapCanvas.height * 0.5);
 mapCtx.stroke();
 mapCtx.setLineDash([]);
 ...
 const d = mapDots[i];
 d.life -= 0.004;
 if (d.life <= 0) { mapDots.splice(i, 1); continue; }

 const px = d.x * mapCanvas.width;
 const py = d.y * mapCanvas.height;

 // Pulse ring
 mapCtx.globalAlpha = d.life * 0.3;
 mapCtx.beginPath();
 mapCtx.arc(px, py, 12 * (1 - d.life) + 4, 0, Math.PI * 2);
 mapCtx.strokeStyle = accent;
 mapCtx.lineWidth = 1;
 mapCtx.stroke();

 // Dot
 mapCtx.globalAlpha = d.life;
 mapCtx.beginPath();
 ...
 mapCtx.font = '9px Orbitron, monospace';
 mapCtx.fillText(d.name, px + 6, py - 4);
 }
 }
...
function doAttackTick() {
 if (!honeypotRunning) return;
 const atk = genAttack();
 if (!atk) return;
 ...
 log(`🍯 ${atk.svc} ${atk.ip} → ${atk.user}:${atk.pass}`, 'rx');
 playSound('click');

 // Random interval
 const delay = 800 + Math.random() * 3000;
 honeypotTimer = setTimeout(doAttackTick, delay);
}

function startHoneypot() {
 const s = LANG[currentLang];
 const anyOn = ($('sshToggle') && $('sshToggle').checked) ||
 ($('httpToggle') && $('httpToggle').checked) ||
 ($('ftpToggle') && $('ftpToggle').checked);
 if (!anyOn) { log(s.noServices, 'error'); showToast(s.noServices, 1500); return; }

 honeypotRunning = true;
 setStatus(true);
 log(s.honeypotStarted, 'success');
 showToast(s.honeypotStarted, 2000);
 doAttackTick();
}

function stopHoneypot() {
 honeypotRunning = false;
 if (honeypotTimer) { clearTimeout(honeypotTimer); honeypotTimer = null; }
 setStatus(false);
 log(LANG[currentLang].honeypotStopped, 'info');
}

function clearConnLog() {
 const el = $('connLog');
 if (el) el.innerHTML = '';
 const tb = $('credTable');
 if (tb) tb.innerHTML = '';
...
function initApp() {
 ...
 const clearBtn = $('clearConnBtn');

 if (startBtn) startBtn.onclick = startHoneypot;
 if (stopBtn) stopBtn.onclick = stopHoneypot;
 if (clearBtn) clearBtn.onclick = clearConnLog;
}
