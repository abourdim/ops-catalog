...
const LANG = {
  en: {
    ...
    howto_1: 'Toggle services ON/OFF using the switches in the main card.',
    howto_2: 'Click Start Honeypot to begin receiving simulated attack traffic.',
    howto_3: 'Watch the connection log fill with fake login attempts and credentials.',
    howto_4: 'Open the Attacker Map to see where attacks originate on the geo-IP canvas.',
  ...
  fr: {
    ...
    howto_1: 'Active/desactive les services avec les interrupteurs dans la carte principale.',
    howto_2: 'Clique sur Demarrer le Honeypot pour recevoir le trafic d\'attaque simule.',
    howto_3: 'Observe le journal de connexions se remplir de tentatives de login.',
    howto_4: 'Ouvre la Carte des Attaquants pour voir les origines geo-IP.',
  ...
  ar: {
    ...
    howto_1: 'فعّل/أوقف الخدمات باستخدام المفاتيح في البطاقة الرئيسية.',
    howto_2: 'اضغط تشغيل المصيدة لبدء استقبال حركة الهجوم المحاكاة.',
    howto_3: 'راقب سجل الاتصالات يمتلئ بمحاولات الدخول الوهمية.',
    howto_4: 'افتح خريطة المهاجمين لرؤية مصادر الهجمات على خريطة جغرافية.',
