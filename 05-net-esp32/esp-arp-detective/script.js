...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-6E745D',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master ARP Detective \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'ARP Detective', subtitle: '🔎 scan · 🛡️ detect · ⚠️ alert',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'ARP Detective — Spoof Detector', mainDesc: 'Monitor ARP tables, spot MITM attacks',
 sectionA: 'Network Topology', sectionB: 'MITM Visualization', sectionC: 'Challenge',
 devices: 'Devices', spoofs: 'Spoofs', arpPackets: 'ARP Packets',
 startScan: 'Start Scan', stopScan: 'Stop', injectSpoof: 'Inject Spoof',
 thIP: 'IP Address', thMAC: 'MAC Address', thVendor: 'Vendor', thStatus: 'Status',
 spoofAlert: 'ARP SPOOF DETECTED — Possible MITM Attack!',
 mitmHint: 'Shows how ARP spoofing enables man-in-the-middle interception',
 scanStarted: 'ARP scan started — monitoring network', scanStopped: 'ARP scan stopped',
 spoofInjected: 'ARP spoof injected — duplicate MAC detected!',
 deviceFound: 'Device found', normal: 'Normal', spoofed: 'SPOOFED',
 challenge1: 'What is ARP and why is it vulnerable?', challenge2: 'How does a MITM attack work via ARP spoofing?', challenge3: 'How can you defend against ARP spoofing?',
 revealBtn: 'Reveal',
 challengeReveal1: 'ARP maps IP to MAC. Vulnerable because no authentication — any device can claim any mapping.',
 challengeReveal2: 'Attacker sends fake ARP replies claiming the gateway IP belongs to their MAC.',
 challengeReveal3: 'Use static ARP entries, DAI on switches, encrypted protocols, and monitor for duplicate mappings.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Arp Detective simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_arp_title: '📡 ARP', wiki_arp: 'Address Resolution Protocol. Maps Layer 3 (IP) to Layer 2 (MAC). Stateless and unauthenticated.',
 wiki_mac_title: '🏷️ MAC Address', wiki_mac: '48-bit hardware address. Format: AA:BB:CC:DD:EE:FF. First 3 bytes identify vendor.',
 wiki_mitm_title: '🕵️ MITM', wiki_mitm: 'Man-in-the-Middle. Attacker positions between victim and gateway to intercept traffic.',
 wiki_dai_title: '🛡️ DAI', wiki_dai: 'Dynamic ARP Inspection. Switch feature that validates ARP against DHCP snooping database.',
 working: 'Working…',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-6E745D',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez ARP Detective \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Detective ARP', subtitle: '🔎 scanner · 🛡️ detecter · ⚠️ alerter',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'Detective ARP — Detecteur de Spoofing', mainDesc: 'Surveillez les tables ARP, detectez les attaques MITM',
 sectionA: 'Topologie Reseau', sectionB: 'Visualisation MITM', sectionC: 'Defi',
 devices: 'Appareils', spoofs: 'Usurpations', arpPackets: 'Paquets ARP',
 startScan: 'Demarrer le Scan', stopScan: 'Arreter', injectSpoof: 'Injecter un Spoof',
 scanStarted: 'Scan ARP demarre', scanStopped: 'Scan ARP arrete',
 spoofInjected: 'Spoof ARP injecte — MAC duplique detecte!', deviceFound: 'Appareil trouve', normal: 'Normal', spoofed: 'USURPE',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Arp Detective. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_arp_title: '📡 ARP', wiki_arp: 'Protocole de resolution d\'adresses. Mappe IP vers MAC. Sans etat et sans authentification.',
 wiki_mac_title: '🏷️ Adresse MAC', wiki_mac: 'Adresse materielle 48 bits. Format: AA:BB:CC:DD:EE:FF.',
 wiki_mitm_title: '🕵️ MITM', wiki_mitm: 'Man-in-the-Middle. L\'attaquant se positionne entre la victime et la passerelle.',
 wiki_dai_title: '🛡️ DAI', wiki_dai: 'Dynamic ARP Inspection. Fonctionnalite de switch qui valide les paquets ARP.',
 working: 'En cours…',
 ...
 theory: 'Arp Detective démontre les principes clés de sécurité réseau. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'محقق ARP', subtitle: '🔎 امسح · 🛡️ اكتشف · ⚠️ نبّه',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'محقق ARP — كاشف التزييف', mainDesc: 'راقب جداول ARP واكتشف هجمات MITM',
 sectionA: 'طوبولوجيا الشبكة', sectionB: 'تصور MITM', sectionC: 'تحدي',
 devices: 'أجهزة', spoofs: 'تزييفات', arpPackets: 'حزم ARP',
 startScan: 'بدء المسح', stopScan: 'إيقاف', injectSpoof: 'حقن تزييف',
 scanStarted: 'مسح ARP بدأ', scanStopped: 'مسح ARP توقف',
 spoofInjected: 'تم حقن تزييف ARP — تم اكتشاف MAC مكرر!', deviceFound: 'تم العثور على جهاز', normal: 'طبيعي', spoofed: 'مزيّف',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Arp Detective. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_arp_title: '📡 ARP', wiki_arp: 'بروتوكول تحليل العناوين. يربط الطبقة 3 (IP) بالطبقة 2 (MAC). بدون حالة وبدون مصادقة.',
 wiki_mac_title: '🏷️ عنوان MAC', wiki_mac: 'عنوان مادي 48 بت. الصيغة: AA:BB:CC:DD:EE:FF.',
 wiki_mitm_title: '🕵️ MITM', wiki_mitm: 'الرجل في المنتصف. المهاجم يتموضع بين الضحية والبوابة لاعتراض الحركة.',
 wiki_dai_title: '🛡️ DAI', wiki_dai: 'فحص ARP الديناميكي. ميزة في المحولات تتحقق من حزم ARP.',
 working: 'جارٍ…',
 ...
 theory: 'Arp Detective يوضح المبادئ الأساسية في أمن الشبكات. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ ARP DETECTIVE SIMULATION ═══════ */

const VENDORS = ['Apple','Samsung','Intel','Cisco','TP-Link','Raspberry Pi','Espressif','Dell','HP','Huawei'];
const BASE_DEVICES = [
 {ip:'192.168.1.1',mac:'AA:BB:CC:00:11:01',vendor:'Cisco',isGateway:true},
 {ip:'192.168.1.10',mac:'AA:BB:CC:00:11:10',vendor:'Apple'},
 {ip:'192.168.1.20',mac:'AA:BB:CC:00:11:20',vendor:'Samsung'},
 {ip:'192.168.1.30',mac:'AA:BB:CC:00:11:30',vendor:'Intel'},
 {ip:'192.168.1.40',mac:'AA:BB:CC:00:11:40',vendor:'Raspberry Pi'},
 {ip:'192.168.1.50',mac:'AA:BB:CC:00:11:50',vendor:'Espressif'},
];
...
let spoofTotal = 0;
let packetTotal = 0;
let topoCanvas, topoCtx, mitmCanvas, mitmCtx;

function revealChallenge(idx) { const el=$('answer'+idx); if(el) el.classList.toggle('visible'); playSound('click'); }

function randMAC() { return 'XX:XX:XX:'+[0,1,2].map(()=>Math.floor(Math.random()*256).toString(16).padStart(2,'0').toUpperCase()).join(':'); }

function addArpEntry(dev, isSpoofed) {
 const s = LANG[currentLang];
 const tbody = $('arpTableBody');
 if (!tbody) return;
 const tr = document.createElement('tr');
 if (isSpoofed) tr.className = 'spoofed';
 tr.innerHTML = `<td>${dev.ip}</td><td>${dev.mac}</td><td>${dev.vendor}</td><td>${isSpoofed ? '⚠️ '+s.spoofed : '✅ '+s.normal}</td>`;
 tbody.appendChild(tr);

 arpEntries.push({...dev, spoofed: isSpoofed});
 packetTotal++;
 if (isSpoofed) spoofTotal++;

 const dc=$('deviceCount'), sc=$('spoofCount'), pc=$('packetCount');
 if(dc) dc.textContent = new Set(arpEntries.map(e=>e.ip)).size;
 if(sc) sc.textContent = spoofTotal;
 if(pc) pc.textContent = packetTotal;
}

function doScanTick() {
 if (!scanning) return;
 const idx = Math.floor(Math.random() * BASE_DEVICES.length);
 const dev = {...BASE_DEVICES[idx]};
 addArpEntry(dev, false);
 log(`📡 ARP: ${dev.ip} → ${dev.mac} (${dev.vendor})`, 'rx');
 packetTotal++;
 const pc=$('packetCount'); if(pc) pc.textContent=packetTotal;
 scanTimer = setTimeout(doScanTick, 1200 + Math.random() * 2500);
}

function injectSpoof() {
 const s = LANG[currentLang];
 const gatewayIP = '192.168.1.1';
 const attackerMAC = 'DE:AD:BE:EF:' + Math.floor(Math.random()*256).toString(16).padStart(2,'0').toUpperCase() + ':' + Math.floor(Math.random()*256).toString(16).padStart(2,'0').toUpperCase();
 addArpEntry({ip: gatewayIP, mac: attackerMAC, vendor: '??? Unknown'}, true);

 spoofDetected = true;
 const alert = $('alertBar');
 if (alert) alert.classList.add('active');
 log(`⚠️ ${s.spoofInjected} ${gatewayIP} → ${attackerMAC}`, 'error');
 showToast(s.spoofInjected, 3000);
 playSound('error');
 drawMITM();
}
...
function initTopoCanvas() {
 ...
 topoCanvas.width = topoCanvas.offsetWidth || 400;
 ...
 topoCtx.fillStyle = accent;
 topoCtx.beginPath(); topoCtx.arc(cx, 40, 12, 0, Math.PI*2); topoCtx.fill();
 topoCtx.fillStyle = '#fff'; topoCtx.font = '9px Orbitron,monospace'; topoCtx.textAlign = 'center';
 topoCtx.fillText('GATEWAY', cx, 60);
 topoCtx.fillText('192.168.1.1', cx, 72);

 // Devices in a circle
 const unique = [];
 const seen = new Set();
 arpEntries.forEach(e => { if(!seen.has(e.ip) || e.spoofed) { seen.add(e.ip); unique.push(e); }});
 const devs = unique.filter(d => d.ip !== '192.168.1.1');
 devs.forEach((d, i) => {
 const angle = (i / Math.max(devs.length, 1)) * Math.PI * 1.5 + Math.PI * 0.25;
 const r = 90;
 const dx = cx + Math.cos(angle) * r;
 const dy = cy + 30 + Math.sin(angle) * (r * 0.6);

 // Line to gateway
 topoCtx.strokeStyle = d.spoofed ? '#ff4444' : 'rgba(255,255,255,.1)';
 topoCtx.lineWidth = d.spoofed ? 2 : 1;
 topoCtx.beginPath(); topoCtx.moveTo(cx, 40); topoCtx.lineTo(dx, dy); topoCtx.stroke();

 // Node
 topoCtx.fillStyle = d.spoofed ? '#ff4444' : accent;
 topoCtx.beginPath(); topoCtx.arc(dx, dy, 8, 0, Math.PI*2); topoCtx.fill();
 topoCtx.fillStyle = d.spoofed ? '#fca5a5' : 'rgba(255,255,255,.6)';
 topoCtx.font = '7px monospace'; topoCtx.textAlign = 'center';
 topoCtx.fillText(d.ip.split('.').pop(), dx, dy + 20);
 topoCtx.fillText(d.vendor.slice(0,8), dx, dy + 30);
 });
...
function drawMITM() {
 mitmCanvas = $('mitmCanvas');
 if (!mitmCanvas) return;
 mitmCtx = mitmCanvas.getContext('2d');
 mitmCanvas.width = mitmCanvas.offsetWidth || 400;
 mitmCanvas.height = 200;
 const w = mitmCanvas.width, h = mitmCanvas.height;
 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#d4a03c';
 let frame = 0;

 function draw() {
 mitmCtx.clearRect(0, 0, w, h);
 frame++;
 // Victim
 mitmCtx.fillStyle = accent; mitmCtx.beginPath(); mitmCtx.arc(60, h/2, 15, 0, Math.PI*2); mitmCtx.fill();
 mitmCtx.fillStyle = '#fff'; mitmCtx.font = '9px Orbitron'; mitmCtx.textAlign = 'center';
 mitmCtx.fillText('VICTIM', 60, h/2 + 28);
 // Attacker
 mitmCtx.fillStyle = '#ff4444'; mitmCtx.beginPath(); mitmCtx.arc(w/2, h/2, 15, 0, Math.PI*2); mitmCtx.fill();
 mitmCtx.fillStyle = '#fca5a5'; mitmCtx.fillText('ATTACKER', w/2, h/2 + 28);
 // Gateway
 mitmCtx.fillStyle = accent; mitmCtx.beginPath(); mitmCtx.arc(w-60, h/2, 15, 0, Math.PI*2); mitmCtx.fill();
 mitmCtx.fillStyle = '#fff'; mitmCtx.fillText('GATEWAY', w-60, h/2 + 28);

 // Arrows with animation
 const offset = (frame % 30) / 30;
 // Victim → Attacker
 drawArrow(mitmCtx, 80, h/2, w/2-20, h/2, '#ff4444', offset);
 // Attacker → Gateway
 drawArrow(mitmCtx, w/2+20, h/2, w-80, h/2, '#ff4444', offset);
 // Normal path (dashed, faded)
 mitmCtx.setLineDash([4,4]); mitmCtx.globalAlpha = 0.15; mitmCtx.strokeStyle = accent;
 mitmCtx.beginPath(); mitmCtx.moveTo(80, h/2-20); mitmCtx.lineTo(w-80, h/2-20); mitmCtx.stroke();
 mitmCtx.setLineDash([]); mitmCtx.globalAlpha = 1;
 mitmCtx.fillStyle = 'rgba(255,255,255,.15)'; mitmCtx.font = '8px monospace';
 mitmCtx.fillText('Normal path (bypassed)', w/2, h/2-28);

 if (spoofDetected) requestAnimationFrame(draw);
 }
 draw();
}

function drawArrow(ctx, x1, y1, x2, y2, color, offset) {
 ctx.strokeStyle = color; ctx.lineWidth = 2;
 ctx.beginPath(); ctx.moveTo(x1, y1); ctx.lineTo(x2, y2); ctx.stroke();
 // Animated dot
 const dx = x2-x1, dy = y2-y1;
 ctx.fillStyle = '#fff';
 ctx.beginPath(); ctx.arc(x1+dx*offset, y1+dy*offset, 3, 0, Math.PI*2); ctx.fill();
}

function initApp() {
 initTopoCanvas();
 const scanBtn=$('scanBtn'), stopBtn=$('stopScanBtn'), injBtn=$('injectBtn');
 if(scanBtn) scanBtn.onclick = () => {
 scanning=true; setStatus(true);
 log(LANG[currentLang].scanStarted,'success');
 showToast(LANG[currentLang].scanStarted,2000);
 doScanTick();
 };
 if(stopBtn) stopBtn.onclick = () => {
 scanning=false; if(scanTimer)clearTimeout(scanTimer);
 setStatus(false); log(LANG[currentLang].scanStopped,'info');
 };
 if(injBtn) injBtn.onclick = injectSpoof;
}
