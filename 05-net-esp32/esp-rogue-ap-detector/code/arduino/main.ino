/*
 * esp-rogue-ap-detector — ESP32 Arduino
 ...
 *
 * Process:
 *   Step 1: ESP32 scans all WiFi channels and records AP fingerprints (BSSID, SSID, channel, encryption).
 *   Step 2: Fingerprints are stored in a known-good database for comparison.
 *   Step 3: On each scan, new APs are compared against the database for mismatches.
 *   Step 4: If an AP shares the SSID but has a different BSSID or channel, it is flagged as a rogue.
 */
...
// ── Configuration ──
#define APP_NAME "esp-rogue-ap-detector"
#define LED_PIN 2
