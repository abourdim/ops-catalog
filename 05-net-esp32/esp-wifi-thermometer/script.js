...
const LANG = {
  en: {
    ...
    howto_1: 'Move your cursor over the heatmap canvas to see RSSI values change.',
    howto_2: 'Click Start Walk Mode to auto-generate heatmap data points.',
    howto_3: 'Open Room Layout to see the floor plan with AP positions and walls.',
    howto_4: 'Check Signal Analysis for an RSSI-over-time graph.',
    wiki_rssi_title: '📶 RSSI', wiki_rssi: 'Received Signal Strength Indicator. Measured in dBm. Range: -30 (excellent) to -90 (unusable).',
    wiki_heat_title: '🌡️ Heatmap', wiki_heat: 'Color-coded visualization of signal strength for network planning.',
    ...
    wiki_survey_title: '🗺️ Site Survey', wiki_survey: 'Walking through a building with a WiFi analyzer to map coverage.',
    working: 'Working…',
