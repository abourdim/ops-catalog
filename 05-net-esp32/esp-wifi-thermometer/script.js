...
const LANG = {
 ...
 title: 'WiFi Thermometer', subtitle: '🌡️ measure · 🗺️ map · 📡 analyze',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'WiFi Thermometer — Signal Heatmap', mainDesc: 'Map WiFi signal strength as a live heatmap',
 sectionA: 'Room Layout', sectionB: 'Signal Analysis', sectionC: 'Challenge',
 startWalk: 'Start Walk Mode', stopWalk: 'Stop', clearHeat: 'Clear Heatmap',
 roomHint: 'Floor plan with AP locations and wall obstacles',
 graphHint: 'RSSI over time as you walk through the heatmap',
 walkStarted: 'Walk mode started — move cursor to map signal', walkStopped: 'Walk mode stopped',
 heatCleared: 'Heatmap cleared',
 challenge1: 'What affects WiFi signal strength the most?', challenge2: 'What is a good RSSI value?', challenge3: 'Where would you place APs to eliminate dead zones?',
 revealBtn: 'Reveal',
 challengeReveal1: 'Distance, walls (concrete/metal), interference from other devices, and antenna orientation.',
 challengeReveal2: '-30 to -50 dBm is excellent. -50 to -60 good. -60 to -70 fair. Below -70 weak. Below -80 unusable.',
 challengeReveal3: 'Place APs high on walls/ceilings, avoid corners, use a grid with overlapping coverage, consider wall materials.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Wifi Thermometer simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 howto_3:'Scroll down to the expandable sections. "Room Layout" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_rssi_title: '📶 RSSI', wiki_rssi: 'Received Signal Strength Indicator. Measured in dBm. Range: -30 (excellent) to -90 (unusable).',
 wiki_heat_title: '🌡️ Heatmap', wiki_heat:'Color-coded visualization of signal strength for network planning. Signal-to-noise ratio (SNR) determines how well you can extract useful information. In the real world, noise comes from thermal energy, other transmitters, and electronic components. Engineers design systems to maximize SNR through filters, amplifiers, and antenna design.',
 wiki_prop_title: '📡 Signal Propagation', wiki_prop: 'WiFi signals weaken with distance and are absorbed by walls, floors, and furniture.',
 wiki_survey_title: '🗺️ Site Survey', wiki_survey:'Walking through a building with a WiFi analyzer to map coverage. WiFi (IEEE 802.11) operates on 2.4 GHz and 5 GHz bands. Devices find networks through beacon frames broadcast by access points every ~100ms. Modern WiFi uses OFDM modulation to achieve speeds over 1 Gbps by sending data on multiple subcarriers simultaneously.',
 working: 'Working…',
 ...
 title: 'Thermometre WiFi', subtitle: '🌡️ mesurer · 🗺️ cartographier · 📡 analyser',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'Thermometre WiFi — Carte de Chaleur', mainDesc: 'Cartographiez la puissance du signal WiFi',
 sectionA: 'Plan de Salle', sectionB: 'Analyse du Signal', sectionC: 'Defi',
 startWalk: 'Mode Marche', stopWalk: 'Arreter', clearHeat: 'Effacer la Carte',
 walkStarted: 'Mode marche demarre', walkStopped: 'Mode marche arrete', heatCleared: 'Carte effacee',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Wifi Thermometer. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 title: 'مقياس حرارة WiFi', subtitle: '🌡️ قِس · 🗺️ ارسم · 📡 حلّل',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مقياس حرارة WiFi — خريطة حرارية للإشارة', mainDesc: 'ارسم خريطة حرارية لقوة إشارة WiFi',
 sectionA: 'مخطط الغرفة', sectionB: 'تحليل الإشارة', sectionC: 'تحدي',
 startWalk: 'وضع المشي', stopWalk: 'إيقاف', clearHeat: 'مسح الخريطة',
 walkStarted: 'وضع المشي بدأ', walkStopped: 'وضع المشي توقف', heatCleared: 'تم مسح الخريطة',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Wifi Thermometer. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
...
/* ═══════ WIFI THERMOMETER SIMULATION ═══════ */

const APS = [
 { x: 0.25, y: 0.3, name: 'HomeWiFi_5G', power: -30 },
 { x: 0.7, y: 0.2, name: 'Office_Net', power: -35 },
 { x: 0.5, y: 0.8, name: 'Guest_WiFi', power: -40 },
];

// Walls that attenuate signal
const WALLS = [
 { x1: 0.45, y1: 0, x2: 0.45, y2: 0.6 },
 { x1: 0, y1: 0.55, x2: 0.7, y2: 0.55 },
 { x1: 0.7, y1: 0.4, x2: 1, y2: 0.4 },
];

let heatCanvas, heatCtx, roomCanvas2, roomCtx2, graphCanvas, graphCtx;
let heatPoints = [];
let rssiHistory = [];
let walking = false;
let walkTimer = null;
let walkX = 0.5, walkY = 0.5;
...
function countWalls(px, py, apx, apy) {
 let count = 0;
 WALLS.forEach(w => { if (lineSegmentIntersect(px,py,apx,apy,w.x1,w.y1,w.x2,w.y2)) count++; });
 return count;
}

function calcRSSI(px, py) {
 let best = -100;
 APS.forEach(ap => {
 const dx = px - ap.x, dy = py - ap.y;
 const dist = Math.sqrt(dx*dx + dy*dy);
 let rssi = ap.power - dist * 80; // distance attenuation
 rssi -= countWalls(px, py, ap.x, ap.y) * 12; // wall attenuation
 rssi += (Math.random() - 0.5) * 4; // noise
 if (rssi > best) best = rssi;
 });
 return Math.max(-95, Math.min(-20, Math.round(best)));
}

function rssiToColor(rssi) {
 const t = Math.max(0, Math.min(1, (rssi + 90) / 60)); // -90...-30 → 0...1
...
function initHeatmap() {
 heatCanvas = $('heatmapCanvas');
 if (!heatCanvas) return;
 heatCtx = heatCanvas.getContext('2d');
 heatCanvas.width = heatCanvas.offsetWidth || 400;
 heatCanvas.height = 300;

 // Background
 heatCtx.fillStyle = '#0a0a1a';
 heatCtx.fillRect(0, 0, heatCanvas.width, heatCanvas.height);

 // Draw AP markers
 drawAPMarkers(heatCtx, heatCanvas.width, heatCanvas.height);

 // Mouse move for RSSI reading
 heatCanvas.addEventListener('mousemove', e => {
 const rect = heatCanvas.getBoundingClientRect();
 const px = (e.clientX - rect.left) / rect.width;
 const py = (e.clientY - rect.top) / rect.height;
 const rssi = calcRSSI(px, py);
 updateRSSIDisplay(rssi);

 // Paint heat point
 const cx = px * heatCanvas.width, cy = py * heatCanvas.height;
 heatCtx.beginPath();
 heatCtx.arc(cx, cy, 8, 0, Math.PI * 2);
 heatCtx.fillStyle = rssiToColor(rssi);
 heatCtx.fill();
 heatPoints.push({ x: px, y: py, rssi });
 });

 // Click to place measurement
 heatCanvas.addEventListener('click', e => {
 const rect = heatCanvas.getBoundingClientRect();
 const px = (e.clientX - rect.left) / rect.width;
 const py = (e.clientY - rect.top) / rect.height;
 const rssi = calcRSSI(px, py);
 log(`📶 RSSI at (${(px*100).toFixed(0)}%, ${(py*100).toFixed(0)}%): ${rssi} dBm`, 'rx');
...
function drawAPMarkers(ctx, w, h) {
 APS.forEach(ap => {
...
function updateRSSIDisplay(rssi) {
 ...
 if (fill) {
 const pct = Math.max(0, Math.min(100, (rssi + 90) / 0.6));
 fill.style.width = pct + '%';
 fill.style.background = rssiToColor(rssi);
 }
}

function initRoomCanvas() {
 roomCanvas2 = $('roomCanvas');
 if (!roomCanvas2) return;
 roomCtx2 = roomCanvas2.getContext('2d');
 roomCanvas2.width = roomCanvas2.offsetWidth || 400;
 roomCanvas2.height = 250;

 function draw() {
 const ctx = roomCtx2, w = roomCanvas2.width, h = roomCanvas2.height;
 ...
 ctx.fillStyle = '#fff'; ctx.font = '8px Orbitron'; ctx.textAlign = 'center';
 ctx.fillText(ap.name, x, y + 18);
 });

 // Walker position
 if (walking) {
 ctx.fillStyle = '#ff4444';
 ctx.beginPath(); ctx.arc(walkX * w, walkY * h, 5, 0, Math.PI * 2); ctx.fill();
 }
...
function drawGraph() {
 ...
 ctx.fillText(y + ' dBm', 45, py + 3);
 }

 if (rssiHistory.length < 2) return;
 const step = w / Math.max(rssiHistory.length - 1, 1);
 ctx.beginPath();
...
function walkTick() {
 if (!walking) return;
 walkX += (Math.random() - 0.5) * 0.06;
 walkY += (Math.random() - 0.5) * 0.06;
 walkX = Math.max(0.05, Math.min(0.95, walkX));
 walkY = Math.max(0.05, Math.min(0.95, walkY));

 const rssi = calcRSSI(walkX, walkY);
 updateRSSIDisplay(rssi);
 rssiHistory.push(rssi);
 drawGraph();
 ...
 const cx = walkX * heatCanvas.width, cy = walkY * heatCanvas.height;
 heatCtx.beginPath(); heatCtx.arc(cx, cy, 10, 0, Math.PI * 2);
 heatCtx.fillStyle = rssiToColor(rssi); heatCtx.fill();
 }

 if (rssiHistory.length % 5 === 0) log(`🌡️ Walk: RSSI ${rssi} dBm at (${(walkX*100).toFixed(0)}%, ${(walkY*100).toFixed(0)}%)`, 'rx');

 walkTimer = setTimeout(walkTick, 300);
}
...
function initApp() {
 ...
 const walkBtn = $('walkBtn'), stopBtn = $('stopWalkBtn'), clearBtn = $('clearHeatBtn');
 if (walkBtn) walkBtn.onclick = () => {
 walking = true; setStatus(true);
 log(LANG[currentLang].walkStarted, 'success');
 walkTick();
 };
 if (stopBtn) stopBtn.onclick = () => {
 walking = false; if (walkTimer) clearTimeout(walkTimer);
 setStatus(false); log(LANG[currentLang].walkStopped, 'info');
 };
 if (clearBtn) clearBtn.onclick = () => {
 heatPoints = []; rssiHistory = [];
 if (heatCanvas && heatCtx) {
 heatCtx.fillStyle = '#0a0a1a'; heatCtx.fillRect(0, 0, heatCanvas.width, heatCanvas.height);
 drawAPMarkers(heatCtx, heatCanvas.width, heatCanvas.height);
 }
 drawGraph();
 log(LANG[currentLang].heatCleared, 'info');
 };
}
