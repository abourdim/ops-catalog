...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-B2AD24',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Captive Portal Lab \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Captive Portal Lab', subtitle: '🚪 design · 📶 connect · 🔓 authenticate',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Captive Portal Lab — WiFi Login Designer', mainDesc: 'Design captive portals like hotel WiFi',
 sectionA: 'Portal Preview', sectionB: 'Connection Flow Diagram', sectionC: 'Challenge',
 portalTitle: 'Portal Title', portalLogo: 'Logo Emoji', portalTerms: 'Terms & Conditions',
 updatePreview: 'Update Preview', simulateFlow: 'Simulate Connection', connectBtn: 'Connect to Internet',
 flowConnect: 'Connect', flowRedirect: 'Redirect', flowPortal: 'Portal', flowAuth: 'Auth', flowInternet: 'Internet',
 previewUpdated: 'Portal preview updated',
 flowStep1: 'Device connecting to WiFi AP...', flowStep2: 'DNS redirect to portal...', flowStep3: 'Captive portal displayed...', flowStep4: 'User authenticating...', flowStep5: 'Internet access granted!',
 challenge1: 'Why are captive portals a security risk?', challenge2: 'How does the ESP32 force users to the portal page?', challenge3: 'Design a secure captive portal authentication system.',
 revealBtn: 'Reveal',
 challengeReveal1: 'Evil twin attacks: an attacker creates a fake WiFi with a captive portal to harvest credentials.',
 challengeReveal2: 'The ESP32 runs a DNS server redirecting ALL domains to its IP, plus an HTTP server serving the portal.',
 challengeReveal3: 'Use HTTPS, validate server-side, implement rate limiting, use session tokens, never store plaintext passwords.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Captive Portal simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 howto_3:'Scroll down to the expandable sections. "Portal Preview" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_cp_title: '🚪 Captive Portal', wiki_cp: 'A network access control method. Users must interact with a web page before accessing the internet.',
 wiki_ap_title: '📶 Access Point', wiki_ap: 'ESP32 in SoftAP mode creates its own WiFi network. Clients connect and receive an IP via DHCP.',
 wiki_evil_title: '😈 Evil Twin', wiki_evil: 'A rogue access point that mimics a legitimate one. Combined with a captive portal, it can steal credentials.',
 wiki_dhcp_title: '📋 DHCP', wiki_dhcp: 'Dynamic Host Configuration Protocol. Automatically assigns IP addresses to devices joining the network.',
 working: 'Working…',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-B2AD24',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Captive Portal Lab \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Labo Portail Captif', subtitle: '🚪 designer · 📶 connecter · 🔓 authentifier',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'Labo Portail Captif — Concepteur WiFi', mainDesc: 'Concevez des portails captifs comme le WiFi d\'hotel',
 sectionA: 'Apercu du Portail', sectionB: 'Diagramme de Flux', sectionC: 'Defi',
 updatePreview: 'Mettre a Jour', simulateFlow: 'Simuler la Connexion', connectBtn: 'Se Connecter',
 previewUpdated: 'Apercu du portail mis a jour',
 flowStep1: 'Connexion au point d\'acces...', flowStep2: 'Redirection DNS...', flowStep3: 'Portail captif affiche...', flowStep4: 'Authentification...', flowStep5: 'Acces internet accorde!',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Captive Portal. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_cp_title: '🚪 Portail Captif', wiki_cp: 'Methode de controle d\'acces reseau. L\'utilisateur doit interagir avant d\'acceder a internet.',
 wiki_ap_title: '📶 Point d\'Acces', wiki_ap: 'L\'ESP32 en mode SoftAP cree son propre reseau WiFi.',
 wiki_evil_title: '😈 Evil Twin', wiki_evil: 'Un point d\'acces pirate qui imite un reseau legitime pour voler des identifiants.',
 wiki_dhcp_title: '📋 DHCP', wiki_dhcp: 'Protocole qui attribue automatiquement des adresses IP aux appareils.',
 working: 'En cours…',
 ...
 title: 'مختبر البوابة الأسيرة', subtitle: '🚪 صمّم · 📶 اتصل · 🔓 صادق',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مختبر البوابة الأسيرة — مصمم تسجيل WiFi', mainDesc: 'صمّم بوابات أسيرة مثل WiFi الفندق',
 sectionA: 'معاينة البوابة', sectionB: 'مخطط تدفق الاتصال', sectionC: 'تحدي',
 updatePreview: 'تحديث المعاينة', simulateFlow: 'محاكاة الاتصال', connectBtn: 'الاتصال بالإنترنت',
 previewUpdated: 'تم تحديث معاينة البوابة',
 flowStep1: 'جاري الاتصال بنقطة الوصول...', flowStep2: 'إعادة توجيه DNS...', flowStep3: 'عرض البوابة الأسيرة...', flowStep4: 'جاري المصادقة...', flowStep5: 'تم منح الوصول للإنترنت!',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Captive Portal. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_cp_title: '🚪 البوابة الأسيرة', wiki_cp: 'طريقة للتحكم في الوصول للشبكة. يجب على المستخدم التفاعل قبل الوصول.',
 wiki_ap_title: '📶 نقطة الوصول', wiki_ap: 'ESP32 في وضع SoftAP ينشئ شبكة WiFi خاصة به.',
 wiki_evil_title: '😈 التوأم الشرير', wiki_evil: 'نقطة وصول مزيفة تحاكي شبكة شرعية لسرقة بيانات الدخول.',
 wiki_dhcp_title: '📋 DHCP', wiki_dhcp: 'بروتوكول يعيّن عناوين IP تلقائياً للأجهزة المتصلة.',
 working: 'جارٍ…',
 ...
 theory: 'Captive Portal يوضح المبادئ الأساسية في أمن الشبكات. WiFi (802.11) operates on 2.4 GHz and 5 GHz bands. It uses OFDM modulation to transmit data across multiple subcarriers simultaneously. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
function updatePortalPreview() {
 const title = ($('portalTitle') || {}).value || 'WiFi Portal';
 const logo = ($('portalLogo') || {}).value || '📶';
 const terms = ($('portalTerms') || {}).value || '';
 const pt = $('prevTitle'), pl = $('prevLogo'), ptr = $('prevTerms');
 if (pt) pt.textContent = title;
 if (pl) pl.textContent = logo;
 if (ptr) ptr.textContent = terms;
 log(LANG[currentLang].previewUpdated, 'success');
 playSound('success');
}
...
async function simulateFlow() {
 ...
 activateStep(1);
 log('📶 ' + s.flowStep1, 'tx');
 showToast(s.flowStep1, 1500);
 await new Promise(r => setTimeout(r, 1500));

 // Step 2: Redirect
 activateStep(2);
 log('🔀 ' + s.flowStep2, 'tx');
 showToast(s.flowStep2, 1500);
 drawFlowAnim(1);
 await new Promise(r => setTimeout(r, 1500));

 // Step 3: Portal
 activateStep(3);
 log('🚪 ' + s.flowStep3, 'info');
 showToast(s.flowStep3, 1500);
 drawFlowAnim(2);
 await new Promise(r => setTimeout(r, 1500));
 ...
 activateStep(4);
 log('🔑 ' + s.flowStep4, 'tx');
 showToast(s.flowStep4, 1500);
 drawFlowAnim(3);
 await new Promise(r => setTimeout(r, 1500));

 // Step 5: Internet
 activateStep(5);
 log('🌐 ' + s.flowStep5, 'success');
 showToast(s.flowStep5, 2000);
 drawFlowAnim(4);
 setStatus(true);
 playSound('success');
}
...
function initFlowCanvas() {
 ...
 flowCanvas.width = flowCanvas.offsetWidth || 400;
 flowCanvas.height = 180;
 drawFlowAnim(0);
}

function drawFlowAnim(activeIdx) {
 ...
 const nodes = [
 { x: 50, label: 'DEVICE', icon: '📱' },
 { x: w * 0.25, label: 'WiFi AP', icon: '📶' },
 { x: w * 0.5, label: 'DNS+HTTP', icon: '🔀' },
 { x: w * 0.75, label: 'PORTAL', icon: '🚪' },
 { x: w - 50, label: 'INTERNET', icon: '🌐' },
 ];

 // Draw connecting lines
 for (let i = 0; i < nodes.length - 1; i++) {
 ctx.strokeStyle = i < activeIdx ? accent : 'rgba(255,255,255,.1)';
 ctx.lineWidth = i < activeIdx ? 2 : 1;
 ctx.beginPath();
 ctx.moveTo(nodes[i].x + 15, h / 2);
 ctx.lineTo(nodes[i + 1].x - 15, h / 2);
 ctx.stroke();
 ...
 ctx.fillStyle = '#fff';
 ctx.beginPath();
 ctx.arc(nodes[i].x + 15 + dx * t, h / 2, 3, 0, Math.PI * 2);
 ctx.fill();
 }
 }
 ...
 // Draw nodes
 nodes.forEach((n, i) => {
 ctx.fillStyle = i <= activeIdx ? accent : 'rgba(255,255,255,.2)';
 ctx.beginPath();
 ctx.arc(n.x, h / 2, 18, 0, Math.PI * 2);
 ctx.fill();
 ctx.font = '16px sans-serif';
 ctx.textAlign = 'center';
 ctx.fillText(n.icon, n.x, h / 2 + 5);
 ctx.fillStyle = i <= activeIdx ? '#fff' : 'rgba(255,255,255,.3)';
 ctx.font = '8px Orbitron, monospace';
 ctx.fillText(n.label, n.x, h / 2 + 35);
 });
}

function initApp() {
 initFlowCanvas();
 const upBtn = $('updatePreviewBtn');
 const simBtn = $('simulateFlowBtn');
 const connBtn = $('portalConnectBtn');
 if (upBtn) upBtn.onclick = updatePortalPreview;
 if (simBtn) simBtn.onclick = simulateFlow;
 if (connBtn) connBtn.onclick = () => {
 log('🔑 User clicked Connect — authenticating...', 'tx');
 simulateFlow();
 };
}
