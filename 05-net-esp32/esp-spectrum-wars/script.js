...
const LANG = {
  en: {
    ...
    howto_1: 'Click Start Battle to begin the bandwidth competition simulation.',
    howto_2: 'Add or remove devices to see how throughput changes.',
    howto_3: 'Open Throughput Graph to see per-device bandwidth over time.',
    howto_4: 'Check Collision Visualization to see packets colliding on the spectrum.',
    ...
    wiki_ofdma_title: '🔀 OFDMA', wiki_ofdma: 'WiFi 6: splits channels into sub-channels for simultaneous multi-device access.',
