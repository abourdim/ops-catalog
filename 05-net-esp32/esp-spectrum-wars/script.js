...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-0B8D72',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Spectrum Wars \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Spectrum Wars', subtitle: '⚔️ compete · 📡 transmit · 💥 collide',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Spectrum Wars — Bandwidth Battle', mainDesc: 'Multiple devices compete for bandwidth, visualize collisions',
 sectionA: 'Throughput Graph', sectionB: 'Collision Visualization', sectionC: 'Challenge',
 devicesLabel: 'Devices', collisions: 'Collisions', avgMbps: 'Avg Mbps',
 startBattle: 'Start Battle', stopBattle: 'Stop', addDevice: '+ Add Device', removeDevice: '- Remove',
 throughputHint: 'Per-device throughput over time — watch it degrade with more competitors',
 collisionHint: 'When signals overlap, packets collide and must be retransmitted',
 battleStarted: 'Spectrum battle started!', battleStopped: 'Battle stopped',
 deviceAdded: 'Device added — competition intensifies!', deviceRemoved: 'Device removed',
 maxDevices: 'Maximum 8 devices', minDevices: 'Minimum 2 devices',
 challenge1: 'Why does adding more devices slow everyone down?', challenge2: 'What is the hidden node problem?', challenge3: 'How do modern WiFi standards reduce collisions?',
 revealBtn: 'Reveal',
 challengeReveal1: 'WiFi is shared. Devices take turns (CSMA/CA). More devices = more waiting, more collisions, more retransmissions.',
 challengeReveal2: 'Two devices that cannot hear each other transmit to the same AP simultaneously, causing collisions. RTS/CTS helps.',
 challengeReveal3: 'WiFi 6 uses OFDMA to divide channels into sub-channels. MU-MIMO sends to multiple devices at once.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Spectrum Wars simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 howto_3:'Scroll down to the expandable sections. "Throughput Graph" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_spectrum_title: '📡 RF Spectrum', wiki_spectrum: 'WiFi uses 2.4 GHz and 5 GHz bands. Each has multiple channels. Overlapping channels cause interference.',
 wiki_csma_title: '🔄 CSMA/CA', wiki_csma: 'Collision avoidance. Devices sense the channel, wait if busy, transmit with random backoff.',
 wiki_ofdma_title: '🔀 OFDMA', wiki_ofdma:'WiFi 6: splits channels into sub-channels for simultaneous multi-device access. WiFi (IEEE 802.11) operates on 2.4 GHz and 5 GHz bands. Devices find networks through beacon frames broadcast by access points every ~100ms. Modern WiFi uses OFDM modulation to achieve speeds over 1 Gbps by sending data on multiple subcarriers simultaneously.',
 wiki_mimo_title: '📡 MU-MIMO', wiki_mimo: 'Multi-User MIMO. AP uses multiple antennas to communicate with several devices simultaneously.',
 working: 'Working…',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-0B8D72',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Spectrum Wars \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Guerres du Spectre', subtitle: '⚔️ rivaliser · 📡 transmettre · 💥 collisionner',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'Guerres du Spectre — Bataille de Bande Passante', mainDesc: 'Plusieurs appareils rivalisent pour la bande passante',
 sectionA: 'Graphique de Debit', sectionB: 'Visualisation des Collisions', sectionC: 'Defi',
 devicesLabel: 'Appareils', collisions: 'Collisions', avgMbps: 'Moy Mbps',
 startBattle: 'Demarrer', stopBattle: 'Arreter', addDevice: '+ Ajouter', removeDevice: '- Retirer',
 battleStarted: 'Bataille du spectre lancee!', battleStopped: 'Bataille arretee',
 deviceAdded: 'Appareil ajoute!', deviceRemoved: 'Appareil retire',
 maxDevices: 'Maximum 8 appareils', minDevices: 'Minimum 2 appareils',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Spectrum Wars. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 title: 'حروب الطيف', subtitle: '⚔️ تنافس · 📡 أرسل · 💥 تصادم',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'حروب الطيف — معركة النطاق الترددي', mainDesc: 'أجهزة متعددة تتنافس على النطاق الترددي',
 sectionA: 'رسم الإنتاجية', sectionB: 'تصور التصادمات', sectionC: 'تحدي',
 devicesLabel: 'أجهزة', collisions: 'تصادمات', avgMbps: 'متوسط Mbps',
 startBattle: 'بدء المعركة', stopBattle: 'إيقاف', addDevice: '+ إضافة جهاز', removeDevice: '- إزالة',
 battleStarted: 'بدأت معركة الطيف!', battleStopped: 'توقفت المعركة',
 deviceAdded: 'تمت إضافة جهاز!', deviceRemoved: 'تم إزالة جهاز',
 maxDevices: 'الحد الأقصى 8 أجهزة', minDevices: 'الحد الأدنى جهازان',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Spectrum Wars. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
...
/* ═══════ SPECTRUM WARS SIMULATION ═══════ */

const DEV_COLORS = ['#ff4444','#44ff44','#4488ff','#ff44ff','#ffaa00','#00ffaa','#ff8844','#8844ff'];
const DEV_NAMES = ['ESP32-A','ESP32-B','Phone-C','Laptop-D','Tablet-E','Camera-F','Printer-G','IoT-H'];
...
let specCanvas, specCtx, tpCanvas, tpCtx, colCanvas, colCtx;
let collisionFlashes = [];

function revealChallenge(idx) { const el=$('answer'+idx); if(el) el.classList.toggle('visible'); playSound('click'); }

function createDevice(idx) {
 return {
 id: idx, name: DEV_NAMES[idx] || 'Dev-' + idx, color: DEV_COLORS[idx % DEV_COLORS.length],
 channel: 6, // all on same channel for max collision
 throughput: 50, throughputHist: [],
 txPhase: Math.random() * Math.PI * 2, txFreq: 0.5 + Math.random() * 1.5,
 active: true
 };
}

function initDevices(count) {
 devices = [];
 for (let i = 0; i < count; i++) devices.push(createDevice(i));
 renderDeviceList();
}
...
function renderDeviceList() {
 ...
 div.innerHTML = `<div style="display:flex;align-items:center"><span class="dev-color" style="background:${d.color}"></span><span class="dev-name">${d.name}</span></div><span class="dev-stats" id="devStats${d.id}">${d.throughput.toFixed(1)} Mbps</span>`;
 el.appendChild(div);
 });
 const dn = $('deviceNum'); if(dn) dn.textContent = devices.length;
}
...
function battleTick() {
 ...
 const maxBW = 100; // total channel bandwidth in Mbps
 let tickCollisions = 0;

 // Simulate CSMA/CA with collisions
 devices.forEach(d => {
 // Each device tries to transmit
 const collisionProb = Math.min(0.8, (n - 1) * 0.12); // more devices = more collisions
 const collided = Math.random() < collisionProb;

 if (collided) {
 tickCollisions++;
 d.throughput = Math.max(0, d.throughput * 0.85 + Math.random() * 5);
 } else {
 const fairShare = maxBW / n;
 d.throughput = d.throughput * 0.7 + (fairShare + (Math.random() - 0.5) * fairShare * 0.4) * 0.3;
 }
 d.throughput = Math.max(0.5, Math.min(maxBW * 0.8, d.throughput));
 d.throughputHist.push(d.throughput);
 if (d.throughputHist.length > 60) d.throughputHist.shift();

 const el = $('devStats' + d.id);
 if (el) el.textContent = d.throughput.toFixed(1) + ' Mbps';
 });

 totalCollisions += tickCollisions;
 if (tickCollisions > 0) {
 collisionFlashes.push({ x: Math.random(), y: Math.random(), life: 1 });
 }

 // Update stats
 const cn = $('collisionNum'); if(cn) cn.textContent = totalCollisions;
 const avg = devices.reduce((s,d) => s + d.throughput, 0) / Math.max(n, 1);
 const at = $('avgThroughput'); if(at) at.textContent = avg.toFixed(1);

 throughputHistory.push(avg);
 if (throughputHistory.length > 60) throughputHistory.shift();

 if (tickCollisions > 2) log(`💥 ${tickCollisions} collisions this tick — throughput degrading`, 'error');

 battleTimer = setTimeout(battleTick, 500);
}
...
function initSpectrumCanvas() {
 ...
 specCanvas.height = 220;

 function draw() {
 const ctx = specCtx, w = specCanvas.width, h = specCanvas.height;
 ctx.fillStyle = 'rgba(10,10,26,0.15)';
 ctx.fillRect(0, 0, w, h);
 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#d4a03c';

 // Channel labels
 ctx.fillStyle = 'rgba(255,255,255,.15)'; ctx.font = '9px Orbitron,monospace'; ctx.textAlign = 'center';
 for (let ch = 1; ch <= 11; ch++) {
 const x = (ch / 12) * w;
 ctx.fillText('Ch' + ch, x, h - 5);
 ctx.strokeStyle = 'rgba(255,255,255,.03)'; ctx.beginPath(); ctx.moveTo(x, 0); ctx.lineTo(x, h - 15); ctx.stroke();
 }

 // Draw device signals as waveforms centered on channel 6
 const time = Date.now() / 1000;
 devices.forEach(d => {
 const centerX = (6 / 12) * w;
 const spread = w * 0.15;
 ctx.beginPath();
 for (let px = centerX - spread; px <= centerX + spread; px += 2) {
 const dx = (px - centerX) / spread;
 const envelope = Math.max(0, 1 - dx * dx); // parabolic envelope
 const signal = envelope * (d.throughput / 100) * (h * 0.35);
 const wave = Math.sin(time * d.txFreq * 5 + d.txPhase + px * 0.1) * signal * 0.3;
 const y = h * 0.5 - signal - wave;
 if (px === centerX - spread) ctx.moveTo(px, h * 0.5); else ctx.lineTo(px, y);
 }
 ctx.lineTo(centerX + spread, h * 0.5);
 ctx.closePath();
 ...
 f.life -= 0.03;
 if (f.life <= 0) { collisionFlashes.splice(i, 1); continue; }
 ctx.globalAlpha = f.life;
 ctx.fillStyle = '#ff4444';
 ctx.font = '14px sans-serif'; ctx.textAlign = 'center';
 ctx.fillText('💥', f.x * w, 20 + f.y * (h - 40));
 }
 ctx.globalAlpha = 1;
...
function initThroughputCanvas() {
 tpCanvas = $('throughputCanvas');
 if (!tpCanvas) return;
 tpCtx = tpCanvas.getContext('2d');
 tpCanvas.width = tpCanvas.offsetWidth || 400;
 tpCanvas.height = 160;

 function draw() {
 const ctx = tpCtx, w = tpCanvas.width, h = tpCanvas.height;
 ...
 ctx.fillStyle = 'rgba(255,255,255,.15)'; ctx.font = '8px monospace'; ctx.textAlign = 'right';
 ctx.fillText(y + ' Mbps', 42, py + 3);
 }

 // Per-device throughput lines
 devices.forEach(d => {
 if (d.throughputHist.length < 2) return;
 const step = w / 60;
 ctx.beginPath();
 d.throughputHist.forEach((v, i) => {
 const x = i * step;
 const y = h - (v / 100) * h;
...
function initCollisionCanvas() {
 colCanvas = $('collisionCanvas');
 if (!colCanvas) return;
 colCtx = colCanvas.getContext('2d');
 colCanvas.width = colCanvas.offsetWidth || 400;
 colCanvas.height = 200;
 ...
 // Spawn packets from devices if battle running
 if (battleRunning && Math.random() < 0.3) {
 const d = devices[Math.floor(Math.random() * devices.length)];
 if (d) packets.push({ x: 20, y: 30 + (d.id / devices.length) * (h - 60), vx: 2 + Math.random() * 2, color: d.color, life: 1, id: d.id });
 }

 // Draw & check collisions
 for (let i = packets.length - 1; i >= 0; i--) {
 const p = packets[i];
 p.x += p.vx;
 p.life -= 0.008;
 if (p.life <= 0 || p.x > w) { packets.splice(i, 1); continue; }

 // Check collision with nearby packets from different devices
 let collided = false;
 for (let j = 0; j < packets.length; j++) {
 if (i === j || packets[j].id === p.id) continue;
 const dx = packets[j].x - p.x, dy = packets[j].y - p.y;
 if (Math.abs(dx) < 15 && Math.abs(dy) < 20) { collided = true; break; }
 }
 ...
 // Labels
 ctx.fillStyle = 'rgba(255,255,255,.15)'; ctx.font = '9px Orbitron'; ctx.textAlign = 'left';
 ctx.fillText('TRANSMITTERS', 5, 15);
 ctx.textAlign = 'right';
 ctx.fillText('ACCESS POINT', w - 5, 15);

 // AP
 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#d4a03c';
 ctx.fillStyle = accent; ctx.beginPath(); ctx.arc(w - 30, h / 2, 12, 0, Math.PI * 2); ctx.fill();
 ctx.fillStyle = '#fff'; ctx.font = '10px sans-serif'; ctx.textAlign = 'center';
 ctx.fillText('📶', w - 30, h / 2 + 4);

 if (packets.length > 100) packets = packets.slice(-60);
 requestAnimationFrame(draw);
 }
 requestAnimationFrame(draw);
}
...
function initApp() {
 initDevices(3);
 initSpectrumCanvas();
 initThroughputCanvas();
 initCollisionCanvas();

 const startBtn = $('startBattleBtn'), stopBtn = $('stopBattleBtn');
 const addBtn = $('addDeviceBtn'), remBtn = $('removeDeviceBtn');

 if (startBtn) startBtn.onclick = () => {
 battleRunning = true; totalCollisions = 0; throughputHistory = [];
 devices.forEach(d => d.throughputHist = []);
 setStatus(true);
 log(LANG[currentLang].battleStarted, 'success');
 showToast(LANG[currentLang].battleStarted, 2000);
 battleTick();
 };
 if (stopBtn) stopBtn.onclick = () => {
 battleRunning = false; if (battleTimer) clearTimeout(battleTimer);
 setStatus(false); log(LANG[currentLang].battleStopped, 'info');
 };
 if (addBtn) addBtn.onclick = () => {
 const s = LANG[currentLang];
 if (devices.length >= 8) { log(s.maxDevices, 'error'); return; }
 devices.push(createDevice(devices.length));
 renderDeviceList();
 log(s.deviceAdded + ' (' + devices.length + ' total)', 'success');
 playSound('success');
 };
 if (remBtn) remBtn.onclick = () => {
 const s = LANG[currentLang];
 if (devices.length <= 2) { log(s.minDevices, 'error'); return; }
 devices.pop();
 renderDeviceList();
 log(s.deviceRemoved + ' (' + devices.length + ' remaining)', 'info');
 playSound('click');
 };
}
