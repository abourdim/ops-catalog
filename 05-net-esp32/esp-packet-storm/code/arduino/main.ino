/*
 * esp-packet-storm — ESP32 Arduino
 ...
 *
 * Process:
 *   Step 1: The generator creates fake network packets with realistic headers.
 *   Step 2: Each packet type (TCP, UDP, ICMP, ARP) has its own header structure and color.
 *   Step 3: The matrix-style canvas shows packets flowing in real-time.
 *   Step 4: The hex inspector shows raw packet bytes like Wireshark.
 */
...
// ── Configuration ──
#define APP_NAME "esp-packet-storm"
#define LED_PIN 2
