/*
 * esp-mesh-whisper — ESP32 Arduino
 * 🕸️ mesh · 🔄 heal · 💬 whisper
 *
 ...
 *
 * Process:
 *   Step 1: ESP32 nodes form a mesh network, each connecting to nearby neighbors.
 *   Step 2: Messages use BFS routing to find the shortest path between nodes.
 *   Step 3: When a node dies, the mesh detects the failure and reroutes traffic.
 *   Step 4: Self-healing rebuilds links automatically when nodes come back online.
 */
...
// ── Configuration ──
#define APP_NAME "esp-mesh-whisper"
#define LED_PIN 2
