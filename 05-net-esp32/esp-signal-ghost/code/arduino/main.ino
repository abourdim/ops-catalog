/*
 * esp-signal-ghost — ESP32 Arduino
 * 👻 spoof · 🔄 cycle · 🌊 flood
 *
 ...
 *
 * Process:
 *   Step 1: ESP32 generates random MAC addresses at high speed.
 *   Step 2: Each MAC sends probe requests, making the network see a new device.
 *   Step 3: Network equipment fills its tables with ghost entries, causing confusion.
 *   Step 4: The chaos meter shows how much the network is disrupted.
 */
...
// ── Configuration ──
#define APP_NAME "esp-signal-ghost"
#define LED_PIN 2
