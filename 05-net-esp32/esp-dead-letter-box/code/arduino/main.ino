/*
 * esp-dead-letter-box — ESP32 Arduino
 * 📦 scan · 🔐 decrypt · 📂 extract
 *
 ...
 *
 * Process:
 *   Step 1: An ESP32 creates a hidden WiFi access point — invisible to normal scans.
 *   Step 2: Agents who know the SSID connect and access the encrypted file vault.
 *   Step 3: Files are XOR-encrypted. Only agents with the key can decrypt them.
 *   Step 4: The dead drop is ephemeral — the ESP32 can be powered off and moved.
 */
...
// ── Configuration ──
#define APP_NAME "esp-dead-letter-box"
#define LED_PIN 2
