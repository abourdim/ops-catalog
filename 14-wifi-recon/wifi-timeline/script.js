...
en:{
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Frequency Analysis',related1_desc:'HackRF WiFi channel analyzer simulation',related1_path:'../../16-wifi-hackrf/wifi-frequency-forensics/index.html',related2_name:'Security Audit Dashboard',related2_desc:'WiFi security checklist & vulnerability scanner',related2_path:'../../17-wifi-classroom/wifi-security-audit/index.html',related3_name:'Ghost Detector',related3_desc:'Radar scan for hidden devices',related3_path:'../../15-wifi-spy/wifi-ghost-detector/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Sonar Radar',pathPrev_path:'../../14-wifi-recon/wifi-sonar/index.html',pathNext_name:'',pathNext_path:'',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
