...
Process:
    Step 1: AP sends its random nonce (ANonce) to the client
    Step 2: Client generates SNonce, derives PTK, sends SNonce with MIC proof
    Step 3: AP derives PTK, verifies MIC, sends encrypted GTK with MIC
    Step 4: Client confirms GTK installation, handshake complete
...
APP_NAME = "wifi-handshake-theater"
