...
en:{kidsMode:'Kids Mode',kidsMascotHi:'Hi there, Agent!',kidsMission:'Mission Timer',kidsMissionDone:'Mission Complete!',kidsStickers:'Stickers',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Network Crime Scene',related1_desc:'Analyze logs and find the intruder',related1_path:'../../17-wifi-classroom/wifi-network-detective/index.html',related2_name:'WiFi Fundamentals Lab',related2_desc:'Interactive WiFi channel & frequency explorer',related2_path:'../../17-wifi-classroom/wifi-101-lab/index.html',related3_name:'Covert Exfiltration',related3_desc:'DNS tunneling & steganography simulation',related3_path:'../../15-wifi-spy/wifi-covert-exfil/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Channel Heatmap',pathPrev_path:'../../14-wifi-recon/wifi-channel-heatmap/index.html',pathNext_name:'Deauth Monitor',pathNext_path:'../../14-wifi-recon/wifi-deauth-detector/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
