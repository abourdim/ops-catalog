...
const LANG={
en:{title:'Ghost Detector — Hidden WiFi Devices',subtitle:'Find hidden WiFi devices',disconnected:'Disconnected',connected:'Scanning',mainSection:'Ghost Detector',mainDesc:'Radar scan for hidden devices',sectionA:'Device List',sectionC:'How It Works',start:'Scan',stop:'Stop',totalDevices:'Devices',ghosts:'Ghosts',visible:'Visible',progress:'Progress',howItWorksText:'Ghost detection identifies WiFi devices hiding their presence. Devices that don\'t broadcast SSIDs can still be found through probe requests, data frame analysis, and RF fingerprinting.',activityLog:'Activity Log',eventsMsg:'Events & messages',clear:'Clear',copy:'Copy',export:'Export',filterAll:'All',settings:'Settings',language:'Language',theme:'Theme',soundEffects:'Sound effects',help:'Help',faq:'FAQ',howto:'How-To',wiki:'Wiki',faq_q1:'What is a ghost device?',faq_a1:'A WiFi device not broadcasting its SSID.',faq_q2:'Is this real?',faq_a2:'No, simulation only.',faq_q3:'How are ghosts detected?',faq_a3:'Through probe requests and RF analysis.',faq_q4:'Is my data private?',faq_a4:'Yes. Everything runs locally.',howto_1:'Click Scan to start radar.',howto_2:'Watch for purple ghost blips.',howto_3:'Check Device List for details.',howto_4:'Monitor the activity log.',wiki_t1:'Ghost Devices',wiki_d1:'Hidden devices detectable via probes.',wiki_t2:'Privacy',wiki_d2:'All data stays in your browser.',t_mosque:'Mosque',t_zellige:'Zellige',t_andalus:'Andalus',t_riad:'Riad',t_medina:'Medina',t_space:'Space',t_jungle:'Jungle',t_robot:'Robot',ready:'Ghost Detector ready!',logCleared:'Log cleared',copied:'Copied!',copyFail:'Copy failed',splashHint:'tap to skip',working:'Working...',langChanged:'Language → English',themeChanged:'Theme →',simStarted:'Radar scan started',simStopped:'Scan stopped',ghostFound:'Ghost device detected!',deviceFound:'Device found',step1Title:'Scan Airwaves',step1Desc:'WiFi adapter scans all channels to discover nearby access points and clients.',step2Title:'Identify Targets',step2Desc:'Detected devices are fingerprinted by MAC, SSID, signal strength, and encryption type.',step3Title:'Analyze Traffic',step3Desc:'Captured frames are decoded to reveal communication patterns and vulnerabilities.',step4Title:'Detect Threats',step4Desc:'Security analysis identifies rogue APs, weak encryption, and suspicious activity.'},
