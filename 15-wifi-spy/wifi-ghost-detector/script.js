...
en:{kidsMode:'Kids Mode',kidsMascotHi:'Hi there, Agent!',kidsMission:'Mission Timer',kidsMissionDone:'Mission Complete!',kidsStickers:'Stickers',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Network Crime Scene',related1_desc:'Analyze logs and find the intruder',related1_path:'../../17-wifi-classroom/wifi-network-detective/index.html',related2_name:'Frame Dissector',related2_desc:'Hex dump with color-coded 802.11 fields',related2_path:'../../14-wifi-recon/wifi-packet-microscope/index.html',related3_name:'Channel Heatmap',related3_desc:'14-channel congestion visualization',related3_path:'../../14-wifi-recon/wifi-channel-heatmap/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Covert Exfiltration',pathPrev_path:'../../15-wifi-spy/wifi-covert-exfil/index.html',pathNext_name:'Invisibility Test',pathNext_path:'../../15-wifi-spy/wifi-invisibility-test/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
