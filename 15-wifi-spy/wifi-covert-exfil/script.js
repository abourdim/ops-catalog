...
en:{kidsMode:'Kids Mode',kidsMascotHi:'Hi there, Agent!',kidsMission:'Mission Timer',kidsMissionDone:'Mission Complete!',kidsStickers:'Stickers',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'WiFi Fundamentals Lab',related1_desc:'Interactive WiFi channel & frequency explorer',related1_path:'../../17-wifi-classroom/wifi-101-lab/index.html',related2_name:'Spectrum Dashboard',related2_desc:'Real-time 2.4GHz and 5GHz band monitoring',related2_path:'../../16-wifi-hackrf/wifi-full-spectrum/index.html',related3_name:'Security Audit Dashboard',related3_desc:'WiFi security checklist & vulnerability scanner',related3_path:'../../17-wifi-classroom/wifi-security-audit/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'',pathPrev_path:'',pathNext_name:'Ghost Detector',pathNext_path:'../../15-wifi-spy/wifi-ghost-detector/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
