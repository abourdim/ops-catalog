...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-9CC0B8',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master WiFi RF Lineup \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'WiFi RF Lineup', subtitle: 'Identify devices by RF signatures. WiFi fingerprinting',
 disconnected: 'Idle', connected: 'Scanning',
 mainSection: 'RF Fingerprinting', mainDesc: 'Device identification via RF signature analysis',
 sectionA: 'Device Lineup', sectionB: 'How It Works',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Rf Lineup simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how WiFi adapter scans all channels to discover nearby access po',
 ...
 howto_3:'Scroll down to the expandable sections. "Device Lineup" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_log_title: '📜 Activity Log', wiki_log:'Timestamped log with filtering. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 ...
 ready: '📻 RF Lineup ready!',
 start: 'Scan', stop: 'Stop',
 devices: 'Devices', confidence: 'Match', signature: 'Signature', scans: 'Scans',
 simStarted: 'RF scanning started', simStopped: 'Scanning stopped',
 deviceFound: 'Device fingerprint captured',
 howItWorksText: 'RF fingerprinting identifies devices by analyzing their unique radio frequency emission patterns. Hardware imperfections create subtle but consistent variations in signals. This simulation generates synthetic RF signatures and demonstrates how devices can be identified by their radio characteristics.',
 ...
 theory: 'Rf Lineup demonstrates key principles from WiFi surveillance. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-9CC0B8',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez WiFi RF Lineup \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Identification RF WiFi', subtitle: 'Identifier les appareils par signatures RF',
 disconnected: 'Inactif', connected: 'Analyse',
 mainSection: 'Empreintes RF', mainDesc: 'Identification des appareils par analyse RF',
 sectionA: 'Liste des Appareils', sectionB: 'Comment ca marche',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Rf Lineup. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how WiFi adapter scans all channels to discover nearby access po',
 ...
 wiki_privacy_title: '🔒 Confidentialite', wiki_privacy: 'Tout reste local.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📻 Identification RF prete!',
 start: 'Scanner', stop: 'Arreter',
 devices: 'Appareils', confidence: 'Correspondance', signature: 'Signature', scans: 'Scans',
 simStarted: 'Analyse RF demarree', simStopped: 'Analyse arretee',
 deviceFound: 'Empreinte capturee',
 howItWorksText: 'L\'empreinte RF identifie les appareils en analysant leurs emissions radio uniques. Les imperfections materielles creent des variations subtiles.',
 ...
 theory: 'Rf Lineup démontre les principes clés de surveillance WiFi. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'بصمات RF للأجهزة', subtitle: 'تحديد الأجهزة من خلال بصمات التردد اللاسلكي',
 disconnected: 'خامل', connected: 'مسح',
 mainSection: 'بصمات RF', mainDesc: 'تحديد الأجهزة عبر تحليل بصمات التردد',
 sectionA: 'قائمة الأجهزة', sectionB: 'كيف يعمل',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Rf Lineup. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how WiFi adapter scans all channels to discover nearby access po',
 ...
 ready: '📻 بصمات RF جاهزة!',
 start: 'مسح', stop: 'إيقاف',
 devices: 'أجهزة', confidence: 'تطابق', signature: 'بصمة', scans: 'عمليات مسح',
 simStarted: 'بدأ المسح', simStopped: 'توقف المسح',
 deviceFound: 'تم التقاط بصمة جهاز',
 howItWorksText: 'بصمة RF تحدد الأجهزة من خلال تحليل أنماط انبعاثات الترددات الراديوية الفريدة. عيوب التصنيع تخلق اختلافات دقيقة لكن ثابتة.',
 ...
 theory: 'Rf Lineup يوضح المبادئ الأساسية في مراقبة الواي فاي. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ APP LOGIC — WiFi RF Lineup ═══════ */
let simRunning=false,simInterval=null;
let rfCanvas,rfCtx,rfDevices=[],scanCount=0;
const DEV_TYPES=['Smartphone','Laptop','Tablet','IoT Sensor','Smart Watch','Router','Drone','Camera'];
const COLORS=['#22c55e','#3b82f6','#a855f7','#ef4444','#f59e0b','#06b6d4','#ec4899','#84cc16'];

function genSignature(){const pts=[];for(let i=0;i<64;i++)pts.push(Math.random()*0.6+0.2+Math.sin(i*0.3)*0.15);return pts;}

function genDevice(){
 return{type:DEV_TYPES[Math.floor(Math.random()*DEV_TYPES.length)],mac:'XX:XX:XX:XX:XX:XX'.replace(/X/g,()=>'0123456789ABCDEF'[Math.floor(Math.random()*16)]),signature:genSignature(),confidence:70+Math.floor(Math.random()*30),color:COLORS[Math.floor(Math.random()*COLORS.length)],freq:2412+Math.floor(Math.random()*13)*5};
}

function initRfCanvas(){
 rfCanvas=$('rfCanvas');if(!rfCanvas)return;
 rfCtx=rfCanvas.getContext('2d');rfCanvas.width=rfCanvas.offsetWidth*2;rfCanvas.height=rfCanvas.offsetHeight*2;rfCtx.scale(2,2);
}

function drawRfViz(){
 if(!rfCtx)return;
 const w=rfCanvas.offsetWidth,h=rfCanvas.offsetHeight;
 rfCtx.fillStyle='rgba(10,10,26,0.12)';rfCtx.fillRect(0,0,w,h);
 // Grid
 rfCtx.strokeStyle='rgba(255,255,255,0.04)';rfCtx.lineWidth=0.5;
 for(let y=0;y<h;y+=20){rfCtx.beginPath();rfCtx.moveTo(0,y);rfCtx.lineTo(w,y);rfCtx.stroke();}
 // Draw signatures for last 4 devices
 rfDevices.slice(-4).forEach((dev,idx)=>{
 const baseY=20+idx*(h/4);
 rfCtx.strokeStyle=dev.color;rfCtx.lineWidth=1.5;rfCtx.globalAlpha=0.8;
 rfCtx.beginPath();
 dev.signature.forEach((v,i)=>{
 const x=(i/64)*w;const y=baseY+(v*h/5);
 const jitter=Math.sin(Date.now()/500+i*0.5)*2;
 i===0?rfCtx.moveTo(x,y+jitter):rfCtx.lineTo(x,y+jitter);
 });
 rfCtx.stroke();rfCtx.globalAlpha=1;
 rfCtx.fillStyle=dev.color;rfCtx.font='9px monospace';
 rfCtx.fillText(`${dev.type} ${dev.confidence}%`,5,baseY+8);
 });
}

function addDeviceToList(d){
 const list=$('deviceList');if(!list)return;
 const el=document.createElement('div');el.className='packet-item';
 el.innerHTML=`<span class="pkt-type" style="color:${d.color}">${d.type}</span><span class="pkt-data">${d.mac} | ${d.freq}MHz</span><span class="pkt-size">${d.confidence}%</span>`;
...
function simTick(){
 scanCount++;
 const d=genDevice();rfDevices.push(d);
 if(rfDevices.length>20)rfDevices.shift();
 addDeviceToList(d);
 $('devVal').textContent=rfDevices.length;
 $('confVal').textContent=d.confidence+'%';
 $('sigVal').textContent=d.type;
 $('scanVal').textContent=scanCount;
 log(`${LANG[currentLang].deviceFound}: ${d.type} @ ${d.freq}MHz (${d.confidence}%)`,'tx');
}

function startSim(){
 if(simRunning)return;simRunning=true;setStatus(true);
 $('startBtn').disabled=true;$('stopBtn').disabled=false;
 rfDevices=[];scanCount=0;initRfCanvas();
 log(LANG[currentLang].simStarted,'success');
 simInterval=setInterval(simTick,1000);
 (function loop(){if(!simRunning)return;drawRfViz();requestAnimationFrame(loop)})();
}
