...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-B36886',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Go-Box Dashboard \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 howto_1:'The main display shows the Kit Go Box simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select the operating band and tune to the target frequency.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-B36886',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Go-Box Dashboard \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Kit Go Box. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select the operating band and tune to the target frequency.',
...
Object.assign(LANG.fr, {start:'Allumer',stop:'Éteindre',simStarted:'Station allumée',simStopped:'Station éteinte',theoryTitle:'Théorie Go-Box',theoryDesc:'Une Go-Box est une station radio amateur portable autonome construite dans une mallette robuste pour un déploiement rapide en cas d\'urgence. Elle comprend généralement un émetteur-récepteur, alimentation/batterie, accord d\'antenne, cbles et accessoires. Une go-box bien organisée peut être installée en minutes et fonctionner sur batterie pendant de longues périodes.',battery:'Batterie',temp:'Température',power:'Consommation',checkedItems:'Vérifiés'});
