...
const LANG = {
 ...
 title: 'Solar Storm Shield', subtitle: '📨 encrypt · 📡 drop · 🔓 decrypt',
 ...
 howto_1:'The main display shows the Civ Solar Storm Shield simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Agent A writes a secret message and enters a shared key.',
 ...
 title: 'Solar Storm Shield', subtitle: '📨 chiffrer · 📡 déposer · 🔓 déchiffrer',
 ...
 title: 'Solar Storm Shield', subtitle: '📨 تشفير · 📡 إيداع · 🔓 فك تشفير',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Civ Solar Storm Shield. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Agent A writes a secret message and enters a shared key.',
 ...
 theory: 'Civ Solar Storm Shield يوضح المبادئ الأساسية في أمن الشبكات. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'سباق الشبكة',related1_desc:'تنقل عبر طوبولوجيا الشبكة',related1_path:'../../06-net-browser/web-packet-racer/index.html',related2_name:'Tor in a Box — توجيه بصلي فيزيائي',related2_desc:'3 ESP32 كعقد ترحيل، تشفير متعدد الطبقات حقيقي',related2_path:'../../08-net-multi/esp-tor-in-a-box/index.html',related3_name:'شبكة البصل',related3_desc:'بناء دوائر عبر عقد الترحيل',related3_path:'../../06-net-browser/web-darknet-simulator/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'Dead Drop — نقل رسائل BLE',pathPrev_path:'../../50-civilization-hacks/civ-seed-vault-beacon/index.html',pathNext_name:'Dead Drop — نقل رسائل BLE',pathNext_path:'../../50-civilization-hacks/civ-space-debris-tracker/index.html',
