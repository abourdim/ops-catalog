#!/usr/bin/env python3
"""
Bio Heartbeat Cipher
Your heartbeat encrypts messages

Workshop-DIY Educational Project

Process:
    Step 1: micro:bit detects heartbeat via pulse sensor. Each beat\
    Step 2: Heart rate variability (HRV) provides true biological randomness from the autonomic nervous system.
    Step 3: R-R intervals are hashed and mixed to create one-time pad keys with high entropy.
    Step 4: Message XOR key = ciphertext. The key is never reused, providing perfect secrecy.
