...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-05060F',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Bio Skin Galvanic Key \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 step4Title: 'Key Output', step4Desc: '256-bit AES key generated from GSR entropy. Each key is biometrically unique. The output of this stage feeds into the next one. Try pausing here to examine the intermediate state — understanding each step separately builds deeper insight.',
 ch1Title: 'Stress Key', ch1Desc: 'Generate a key while stressed vs calm. Are both equally random?. Think about why this happens — the answer reveals a fundamental principle of how the system works. Try to explain it before revealing the answer.',
 ch2Title: 'Twin Test', ch2Desc: 'Two people generate keys. Even twins produce different GSR patterns. This challenge tests whether you understand the underlying mechanism, not just the surface behavior. Experiment with different approaches before checking the solution.',
 ch3Title: 'Entropy Analysis', ch3Desc: 'Generate 100 keys and check distribution. Is it uniform?. Real engineers face this exact problem. Your approach to solving it mirrors professional troubleshooting methodology.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-05060F',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Bio Skin Galvanic Key \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 step4Title: 'Cl\u00e9 de sortie', step4Desc: 'Clu00e9 AES 256 bits gu00e9nu00e9ru00e9e. Unique biomu00e9triquement. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',
 ch1Title: 'Cl\u00e9 Stress', ch1Desc: 'Gu00e9nu00e9rez stressu00e9 vs calme. Les deux alu00e9atoires?. Réfléchissez à pourquoi cela se produit — la réponse révèle un principe fondamental. Essayez d expliquer avant de révéler la réponse.',
 ch2Title: 'Test Jumeaux', ch2Desc: 'Mu00eame jumeaux, diffu00e9rents motifs GSR. Ce défi teste votre compréhension du mécanisme sous-jacent. Expérimentez différentes approches avant de vérifier la solution.',
 ch3Title: 'Analyse Entropie', ch3Desc: 'Gu00e9nu00e9rez 100 clu00e9s. Distribution uniforme?. Les vrais ingénieurs font face à ce problème exact. Votre approche reflète la méthodologie professionnelle de dépannage.',
