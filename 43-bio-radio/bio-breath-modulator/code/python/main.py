...
Breathing modulates RF carrier

Workshop-DIY Educational Project

Process:
    Step 1: Thermistor near nostrils detects airflow temperature changes during breathing.
    Step 2: ADC captures breathing waveform. Low-pass filter extracts the slow envelope.
    Step 3: Breathing envelope modulates 433.92 MHz carrier via frequency deviation.
    Step 4: Receiver demodulates FM signal to reconstruct breathing pattern remotely.
