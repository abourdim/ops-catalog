/**
 * Workshop DIY — Bio Voice RF Fingerprint v1.0
 * Voice harmonics as RF authentication — Self-contained
 */
...
const LANG={en:{kidsMode:'Kids Mode',kidsMascotHi:'Hi there, Agent!',kidsMission:'Mission Timer',kidsMissionDone:'Mission Complete!',kidsStickers:'Stickers',
 ...
 title:'Bio Voice RF Fingerprint',subtitle:'Voice harmonics as RF authentication',disconnected:'Disconnected',connected:'Connected',mainSection:'Voice RF \u2014 Harmonic Authentication',mainDesc:'Voice harmonic patterns create unique RF authentication fingerprints',sectionA:'A \u2014 How It Works',sectionC:'C \u2014 Challenges',btn1:'Start Analysis',btn1Stop:'Stop',btn2:'Deep Voice',btn3:'High Voice',btn4:'Authenticate',stat1:'Hz F0',stat2:'formants',stat3:'match',stat4:'profiles',step1Title:'Voice Capture',step1Desc:'Microphone captures voice with fundamental frequency and harmonic overtones. Watch the visualization update in real time as this stage processes. The display shows exactly what is happening internally — each color and movement represents a specific data transformation.',step2Title:'Spectrum Analysis',step2Desc:'FFT reveals harmonic structure unique to each person. Notice how the indicators change during this phase. The activity log records every event, letting you trace the exact sequence of operations and verify the results.',step3Title:'Formant Extraction',step3Desc:'Vocal tract resonances (F1-F3) are unique to each person\'s anatomy. This stage transforms the input data using the algorithm shown in the visualization. Compare the before and after values to understand the mathematical relationship.',step4Title:'RF Fingerprint',step4Desc:'Spectral features encoded into an RF signature for authentication. The output of this stage feeds into the next one. Try pausing here to examine the intermediate state — understanding each step separately builds deeper insight.',ch1Title:'Voice Twin',ch1Desc:'Can two people produce matching voice fingerprints?. Think about why this happens — the answer reveals a fundamental principle of how the system works. Try to explain it before revealing the answer.',ch2Title:'Whisper Auth',ch2Desc:'Does authentication work when whispering?. This challenge tests whether you understand the underlying mechanism, not just the surface behavior. Experiment with different approaches before checking the solution.',ch3Title:'Environment Test',ch3Desc:'Test in different rooms. How does acoustics affect matching?. Real engineers face this exact problem. Your approach to solving it mirrors professional troubleshooting methodology.',howto_1:'The main display shows the Voice Rf Fingerprint simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Microphone captures voice with fundamental frequency and har',howto_2:'Press the "Start" button. The main visualization will start animating. Watch carefully — colors, movement, and numbers all represent real data from the simulation. The status indicator in the top-right turns green when running.',howto_3:'Scroll down to the expandable sections. "A \u2014 How It Works" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',wiki1_title:'\ud83c\udfa4 Voice Harmonics',wiki1_text:'F0 produces harmonics at 2*F0, 3*F0 etc. Vocal tract shapes these into formants.',wiki2_title:'\ud83d\udd12 RF Authentication',wiki2_text:'Voice spectrum converted to hash fingerprint. Compares spectral features, not raw audio.',activityLog:'Activity Log',eventsMsg:'Events & messages',clear:'Clear',copy:'Copy',export:'Export',filterAll:'All',settings:'\u2699\ufe0f Settings',language:'Language',theme:'Theme',help:'\u2753 Help',faq:'FAQ',howto:'How-To',wiki:'Wiki',soundEffects:'\ud83d\udd0a Sound effects',breathingGuide:'Breathing guide',dhikrTap:'Tap',musicMode:'Music reactive',splashHint:'tap to skip',working:'Working\u2026',t_mosque:'Mosque',t_zellige:'Zellige',t_andalus:'Andalus',t_riad:'Riad',t_medina:'Medina',t_space:'Space',t_jungle:'Jungle',t_robot:'Robot',ready:'\ud83c\udfa4 Voice RF Fingerprint ready \u2014 speak to authenticate!',logCleared:'Log cleared',copied:'Copied!',copyFail:'Copy failed',langChanged:'\ud83c\udf10 Language \u2192 English',themeChanged:'\ud83c\udfa8 Theme \u2192',sectionCode:'Device Code',faq_q1:'What is Bio Voice RF Fingerprint?',faq_a1:'Bio Voice RF Fingerprint lets you voice harmonic patterns create unique rf authentication fingerprints. Everything runs as a simulation in your browser — no hardware needed to learn the concepts.',faq_q2:'How does the simulation work?',faq_a2:'The simulation models real biomedical signals behavior in your browser. You control the inputs using sliders and buttons, and the visualization updates in real time to show you the results.',faq_q3:'What do the controls do?',faq_a3:'Press "Start" to begin. Each button and slider changes a specific parameter — the visualization responds immediately so you can see the effect. Check the How-To tab for a step-by-step guide.',faq_q4:'What is the science behind this?',faq_a4:'This app is based on real biomedical signals principles used by professionals. The simulation applies the same math and physics — the difference is that here you can safely experiment without expensive equipment.',faq_q5:'What should I experiment with?',faq_a5:'Change one parameter at a time and observe the effect. Try extreme values to find the limits. Then combine changes to see how different factors interact. The challenges section gives you specific experiments to try.',faq_q6:'What hardware do I need for the real version?',faq_a6:'The simulation needs no hardware. To build the real project, you need Mixed. See the Device Code section for wiring diagrams and ready-to-use firmware.',faq_q7:'Is my data private?',faq_a7:'Yes. Everything runs locally in your browser using JavaScript. No data is sent to any server, no account is needed, and the app works completely offline. Your experiments stay on your device.',faq_q8:'What should I explore next?',faq_a8:'Try Bio Body Antenna and Bio Brainwave Radio. Each app in this category teaches a different aspect of biomedical signals.',demo_s1:'Welcome to Bio Voice RF Fingerprint! Look at the main display — this is where the biomedical signals simulation runs.',demo_s2:'Click Start Analysis to begin voice capture. Watch how the visualization reacts.',demo_s3:'Try adjusting the controls. Each slider or button changes a specific parameter of the simulation.',demo_s4:'Scroll down to see "A \u2014 How It Works" for detailed data. The numbers and charts update as the simulation runs.',demo_s5:'Great job! Now try the challenges section to test your understanding of biomedical signals.',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Biosignals',learn1Desc:'How your body generates electrical signals. Watch the simulation to see this happen in real time. The visualization makes the invisible visible.',learn1Tag:'Biology',learn2Title:'Bio-Radio',learn2Desc:'How body signals can be converted to radio waves. The controls let you experiment with different conditions. Each change reveals how this principle responds.',learn2Tag:'RF',learn3Title:'Neural Signals',learn3Desc:'How nerves transmit electrical impulses. Try the challenges section to test your understanding. Real engineers use these same concepts daily.',learn3Tag:'Neuroscience',learn4Title:'Biometric ID',learn4Desc:'How unique body patterns identify individuals. Compare results with different settings to build intuition. The data panels show precise measurements.',learn4Tag:'Biometrics',sectionLearn:'What You Shall Learn',learnLevelVal:'Intermediate 🟡',learnLevel:'Level:',learnTimeVal:'20 min ⏱',learnTime:'Time:',learnAgeVal:'12+ 🧒',kidTitle:'For Young Explorers',kidIntro:'Welcome to Voice Rf Fingerprint! This is like a science experiment on your computer. You get to control a real bioelectronics simulation — press buttons, move sliders, and watch what happens on screen. Try changing the controls and watch how Microphone captures voice with fundamental frequen Nothing can break — it is all just a simulation running safely in your browser!',kidSafe:'Completely safe! Nothing you do here can break anything. It all runs inside your browser like a game.',kidTry:'Press the big Start button and watch the screen change. Then try moving sliders to see what they do.',kidParent:'This app teaches biomedical signals concepts through hands-on simulation. Suitable for STEM education in physics, electronics, and computer science.',codeTitle:'How This App Works',codeLang:'JavaScript',codeSnippet:'const canvas = document.getElementById("mainCanvas");\\nconst ctx = canvas.getContext("2d");\\n\\nfunction draw() {\\n ctx.clearRect(0, 0, canvas.width, canvas.height);\\n // Draw your visualization here\\n ctx.fillStyle = "#00ff88";\\n ctx.fillRect(x, y, width, height);\\n requestAnimationFrame(draw);\\n}\\n\\ndraw();',codeExplain:'Every app uses an HTML5 Canvas for real-time visualization. The draw() function runs ~60 times per second via requestAnimationFrame. It clears the screen, draws the current state, and schedules the next frame. This is the same technique used in games and data dashboards. The simulation logic updates variables that draw() reads to show the current state.',wiki_concept_title:'🔬 What is Bio Voice RF Fingerprint?',wiki_concept:'Bio Voice RF Fingerprint is a technique used in biomedical signals. Voice harmonic patterns create unique RF authentication fingerprints. In professional settings, this technology requires Mixed and specialized training. This simulation lets you explore the same principles safely in your browser, with instant visual feedback for every parameter change.',wiki_howworks_title:'⚙️ How It Works',wiki_howworks:'The process has four stages. First: Microphone captures voice with fundamental frequency and harmonic overtones. Second: FFT reveals harmonic structure unique to each person. The simulation runs these stages in real time, showing you intermediate results at each step. In real biomedical signals, each stage involves specialized equipment and careful calibration — here, the computer handles the hard parts so you can focus on understanding the principles.',wiki_realworld_title:'🌍 Real-World Applications',wiki_realworld:'Bio Voice RF Fingerprint has practical applications in biomedical signals. Professionals use similar techniques with Mixed in controlled environments. The principles demonstrated here apply to real-world scenarios — the same math, the same physics, just different scale and equipment. Understanding these fundamentals is the first step toward working with real systems.',wiki_safety_title:'🛡️ Safety & Privacy',wiki_safety:'This simulation runs entirely in your browser. No data is transmitted to any server. No hardware is needed, and nothing you do here affects any real system. This is a safe learning environment — experiment freely without risk. All settings and results are stored locally and disappear when you close the tab.',purpose:'Bio Voice RF Fingerprint: Voice harmonic patterns create unique RF authentication fingerprints. This simulation lets you experiment hands-on instead of just reading theory. Every parameter you change produces visible results, building real intuition for how the system behaves. The workflow goes from Voice Capture through Spectrum Analysis to Formant Extraction and RF Fingerprint.',guideTitle:'What Am I Looking At?',guideCanvas:'The main area shows a live visualization of the simulation. Colors and movement represent data changing in real time.',guideControls:'The buttons below the main display control the simulation. Start begins it, Stop pauses it, Reset clears everything.',guideSections:'Below the main card, "A \u2014 How It Works" and "Data" show detailed data and analysis. Click the section headers to expand or collapse them.',guideStatus:'The colored dot in the top-right corner shows the connection status. Green means running, red means stopped.',
 wiki_history_title: '📜 History of Bioelectronics',
 wiki_history: 'Claude Shannon founded information theory in 1948, establishing the mathematical framework for signal transmission and proving fundamental capacity limits. Voice Rf Fingerprint builds on this foundation, letting you explore these historical concepts through interactive simulation.',
 wiki_math_title: '📐 Mathematics Behind Voice Rf Fingerprint',
 wiki_math: 'The mathematics behind Voice Rf Fingerprint: Signal-to-Noise Ratio (SNR) in dB = 10·log₁₀(Psignal/Pnoise). Every 3 dB increase doubles the signal power relative to noise. Wavelength λ = c/f where c = 3×10⁸ m/s. A 2.4 GHz signal has λ = 12.5 cm. Antenna size is typically λ/4 to λ/2. An N-point FFT produces N/2 frequency bins with resolution Δf = fs/N. Windowing (Hamming, Blackman) reduces spectral leakage at the cost of frequency resolution.',
 ...
 gloss3_term: 'Frequency Resolution',
 gloss3_def: 'The minimum frequency difference the FFT can distinguish, equal to sample rate divided by FFT size (Δf = fs/N). More samples give finer resolution.',
 ...
 theory: 'Voice Rf Fingerprint demonstrates key principles from bioelectronics. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. The Fast Fourier Transform converts time-domain signals to frequency-domain in O(N·log N) operations. It reveals the spectral content of any signal. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
...
fr:{narratorTitle:'Narrateur Auto',narratorScanning:'Recherche de signaux...',narratorDetected:'Signal d\x27tect\x27! Activit\x27: HAUTE',narratorProcessing:'Traitement des donn\x27es...',narratorWarning:'Alerte: anomalie d\x27tect\x27e',narratorAcquired:'Signal acquis avec succ\x27s',whatifTitle:'Et si?',whatifIncrease:'Augmenter',whatifDecrease:'Diminuer',tooltipTitle:'Infobulles intelligentes',tooltipToggle:'Activer les infobulles',tip_start:'Lancer la simulation et observer la visualisation s\x27animer',tip_stop:'Mettre en pause la simulation en conservant l\x27état actuel',tip_reset:'Effacer toutes les données et revenir aux conditions initiales',tip_slider:'Glisser pour ajuster ce paramètre — la visualisation se met à jour en temps réel',tip_theme:'Basculer entre 8 thèmes visuels dont 2 thèmes clairs islamiques',tip_help:'Ouvrir le panneau d\x27aide avec FAQ, guides, wiki et défis',explorerTitle:'Explorateur d\x27espace paramétrique',explorerStart:'Auto-Explorer',explorerStop:'Arrêter l\x27exploration',explorerProgress:'Exploration des combinaisons...',explorerResult:'Exploration terminée',explorerInfo:'Teste systématiquement min/milieu/max pour chaque curseur et enregistre les résultats',title:'Bio Empreinte Vocale RF',subtitle:'Harmoniques vocales comme authentification RF',disconnected:'D\u00e9connect\u00e9',connected:'Connect\u00e9',mainSection:'Voix RF \u2014 Authentification Harmonique',mainDesc:'Les harmoniques vocales cr\u00e9ent des empreintes RF uniques',sectionA:'A \u2014 Comment \u00e7a marche',peerTitle:'👥 Peer Mode',peerConnect:'Connect',peerDisconnect:'Disconnect',peerStatus:'Peer Status',peerSend:'Sent',peerReceive:'Received',peerInfo:'Open this app in two tabs to sync parameters via BroadcastChannel',heatmapTitle:'📅 Activity Heatmap',heatmapToday:'Today',heatmapStreak:'Streak',heatmapTotal:'Total',heatmapLegend:'Less \u2192 More',sectionC:'C \u2014 D\u00e9fis',btn1:'D\u00e9marrer Analyse',btn1Stop:'Arr\u00eat',btn2:'Voix Grave',btn3:'Voix Aigu\u00eb',btn4:'Authentifier',stat1:'Hz F0',stat2:'formants',stat3:'match',stat4:'profils',step1Title:'Capture Vocale',step1Desc:'Micro capture la voix avec fru00e9quence fondamentale. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Analyse Spectrale',step2Desc:'FFT ru00e9vu00e8le la structure harmonique unique. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Extraction Formants',step3Desc:'Ru00e9sonances du tractus vocal uniques u00e0 chaque personne. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Empreinte RF',step4Desc:'Caractu00e9ristiques spectrales encodu00e9es en signature RF. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',ch1Title:'Jumeau Vocal',ch1Desc:'Deux personnes peuvent-elles matcher?. Réfléchissez à pourquoi cela se produit — la réponse révèle un principe fondamental. Essayez d expliquer avant de révéler la réponse.',ch2Title:'Auth Murmure',ch2Desc:'L\'authentification fonctionne en murmurant?. Ce défi teste votre compréhension du mécanisme sous-jacent. Expérimentez différentes approches avant de vérifier la solution.',ch3Title:'Test Environnement',ch3Desc:'Testez dans diffu00e9rentes piu00e8ces. Les vrais ingénieurs font face à ce problème exact. Votre approche reflète la méthodologie professionnelle de dépannage.',howto_1:'L écran principal affiche la simulation Voice Rf Fingerprint. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Microphone captures voice with fundamental frequency and har',howto_2:'Essayez diff\u00e9rents types de voix.',howto_3:'Cliquez Authentifier pour enregistrer ou matcher.',wiki1_title:'\ud83c\udfa4 Harmoniques',wiki1_text:'F0 produit des harmoniques. Le tractus vocal les fa\u00e7onne en formants.',wiki2_title:'\ud83d\udd12 Auth RF',wiki2_text:'Spectre vocal converti en empreinte hash.',activityLog:'Journal',eventsMsg:'\u00c9v\u00e9nements',clear:'Effacer',copy:'Copier',export:'Exporter',filterAll:'Tout',settings:'\u2699\ufe0f Param\u00e8tres',language:'Langue',theme:'Th\u00e8me',help:'\u2753 Aide',faq:'FAQ',howto:'Guide',wiki:'Wiki',soundEffects:'\ud83d\udd0a Sons',breathingGuide:'Respiration',dhikrTap:'Tap',musicMode:'Musique',splashHint:'appuyer',working:'En cours\u2026',t_mosque:'Mosqu\u00e9e',t_zellige:'Zellige',t_andalus:'Andalous',t_riad:'Riad',t_medina:'M\u00e9dina',t_space:'Espace',t_jungle:'Jungle',t_robot:'Robot',ready:'\ud83c\udfa4 Empreinte vocale pr\u00eate!',logCleared:'Effac\u00e9',copied:'Copi\u00e9!',copyFail:'\u00c9chec',langChanged:'\ud83c\udf10 Fran\u00e7ais',themeChanged:'\ud83c\udfa8 \u2192',sectionCode:'Code Appareil',faq_q1:'Que fait cette appli ?',faq_a1:'Voice Rf Fingerprint est une simulation interactive qui démontre les concepts de bioélectronique. Voice harmonic patterns create unique RF authentication fingerprints. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment ça marche ?',faq_a2:'La simulation tourne dans ton navigateur. Elle modélise de vrais body signals into radio.',faq_q3:'Que dois-je essayer ?',faq_a3:'Appuie sur le bouton principal et regarde ! 🎯 Puis change les réglages pour voir l\'effet.',faq_q4:'C\'est quoi la vraie science ?',faq_a4:'C\'est du vrai biometric radio technology ! Les mêmes principes utilisés par les professionnels. 🧪',faq_q5:'Je peux le casser ?',faq_a5:'Essaie le Labo ! Pousse les paramètres à l\'extrême et observe. C\'est comme ça qu\'on découvre ! 💡',faq_q6:'Quel matériel ?',faq_a6:'Pour la version réelle, il te faut a computer with Python 3. Regarde 📦 Code Appareil !',faq_q7:'C\'est sûr ?',faq_a7:'Absolument sûr ! 🛡️ Tout tourne localement. Pas d\'internet requis.',faq_q8:'Que faire ensuite ?',faq_a8:'Essaie Bio Muscle Telegraph and Bio Pupil Morse ! Chacune enseigne quelque chose de différent. 🚀',demo_s1:'Bienvenue ! Explorons cette simulation ensemble. Regarde la section principale. 🔬',demo_s2:'Clique sur le bouton d\'action pour démarrer. Regarde la visualisation réagir ! ⚡',demo_s3:'Change un réglage — essaie un curseur ou une liste. Tu vois le changement ? 🔄',demo_s4:'Vérifie les résultats — les graphiques montrent ce qui se passe. 📊',demo_s5:'Super ! 🎉 Tu connais les bases. Essaie le Labo pour aller plus loin !',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Biosignals',learn1Desc:'How your body generates electrical signals',learn1Tag:'Biology',learn2Title:'Bio-Radio',learn2Desc:'How body signals can be converted to radio waves',learn2Tag:'RF',learn3Title:'Neural Signals',learn3Desc:'How nerves transmit electrical impulses',learn3Tag:'Neuroscience',learn4Title:'Biometric ID',learn4Desc:'How unique body patterns identify individuals',learn4Tag:'Biometrics',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Intermédiaire 🟡',learnLevel:'Niveau :',learnTimeVal:'20 min ⏱',learnTime:'Durée :',learnAgeVal:'12+ 🧒',
 ...
 theory: 'Voice Rf Fingerprint démontre les principes clés de bioélectronique. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. The Fast Fourier Transform converts time-domain signals to frequency-domain in O(N·log N) operations. It reveals the spectral content of any signal. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
...
ar:{narratorTitle:'الراوي التلقائي',narratorScanning:'...جاري البحث عن إشارات',narratorDetected:'!تم اكتشاف إشارة',narratorProcessing:'...معالجة البيانات',narratorWarning:'تحذير: تم اكتشاف شذوذ',narratorAcquired:'تم الحصول على الإشارة بنجاح',whatifTitle:'ماذا لو؟',whatifIncrease:'زيادة',whatifDecrease:'تقليل',tooltipTitle:'تلميحات ذكية',tooltipToggle:'تبديل التلميحات',tip_start:'ابدأ المحاكاة وشاهد الرسم البياني ينبض بالحياة',tip_stop:'أوقف المحاكاة مؤقتاً مع الحفاظ على الحالة الحالية',tip_reset:'امسح جميع البيانات وعد إلى الشروط الأولية',tip_slider:'اسحب لضبط هذا المعامل — يتحدث الرسم البياني في الوقت الفعلي',tip_theme:'بدّل بين 8 مظاهر مرئية منها تصميمان إسلاميان فاتحان',tip_help:'افتح لوحة المساعدة مع الأسئلة الشائعة والأدلة والويكي والتحديات',explorerTitle:'مستكشف فضاء المعاملات',explorerStart:'استكشاف تلقائي',explorerStop:'إيقاف الاستكشاف',explorerProgress:'جارٍ استكشاف التوليفات...',explorerResult:'اكتمل الاستكشاف',explorerInfo:'يختبر بشكل منهجي الحد الأدنى/الوسط/الأقصى لكل منزلق ويسجل النتائج',title:'\u0628\u0635\u0645\u0629 \u0627\u0644\u0635\u0648\u062a RF',peerTitle:'👥 Mode Pair',peerConnect:'Connecter',peerDisconnect:'D\xe9connecter',peerStatus:'Statut pair',peerSend:'Envoy\xe9',peerReceive:'Re\xe7u',peerInfo:'Ouvrez cette app dans deux onglets pour synchroniser les param\xe8tres',heatmapTitle:'📅 Carte d\x27activit\xe9',heatmapToday:'Aujourd\x27hui',heatmapStreak:'S\xe9rie',heatmapTotal:'Total',heatmapLegend:'Moins \u2192 Plus',subtitle:'\u062a\u0648\u0627\u0641\u0642\u064a\u0627\u062a \u0627\u0644\u0635\u0648\u062a \u0643\u0645\u0635\u0627\u062f\u0642\u0629 RF',disconnected:'\u063a\u064a\u0631 \u0645\u062a\u0635\u0644',connected:'\u0645\u062a\u0635\u0644',mainSection:'\u0628\u0635\u0645\u0629 \u0635\u0648\u062a\u064a\u0629 RF \u2014 \u0645\u0635\u0627\u062f\u0642\u0629',mainDesc:'\u0623\u0646\u0645\u0627\u0637 \u0627\u0644\u062a\u0648\u0627\u0641\u0642\u064a\u0627\u062a \u0627\u0644\u0635\u0648\u062a\u064a\u0629 \u062a\u0646\u0634\u0626 \u0628\u0635\u0645\u0627\u062a RF \u0641\u0631\u064a\u062f\u0629',sectionA:'\u0623 \u2014 \u0643\u064a\u0641 \u064a\u0639\u0645\u0644',sectionC:'\u062c \u2014 \u062a\u062d\u062f\u064a\u0627\u062a',btn1:'\u0628\u062f\u0621 \u0627\u0644\u062a\u062d\u0644\u064a\u0644',btn1Stop:'\u0625\u064a\u0642\u0627\u0641',btn2:'\u0635\u0648\u062a \u0639\u0645\u064a\u0642',btn3:'\u0635\u0648\u062a \u0639\u0627\u0644\u064a',btn4:'\u0645\u0635\u0627\u062f\u0642\u0629',stat1:'Hz F0',stat2:'\u0641\u0648\u0631\u0645\u0627\u0646\u062a',stat3:'\u062a\u0637\u0627\u0628\u0642',stat4:'\u0645\u0644\u0641\u0627\u062a',step1Title:'\u0627\u0644\u062a\u0642\u0627\u0637 \u0627\u0644\u0635\u0648\u062a',step1Desc:'\u0627\u0644\u0645\u064a\u0643\u0631\u0648\u0641\u0648\u0646 \u064a\u0644\u062a\u0642\u0637 \u0627\u0644\u0635\u0648\u062a \u0645\u0639 \u0627\u0644\u062a\u0631\u062f\u062f \u0627\u0644\u0623\u0633\u0627\u0633\u064a.',step2Title:'\u062a\u062d\u0644\u064a\u0644 \u0627\u0644\u0637\u064a\u0641',step2Desc:'FFT \u064a\u0643\u0634\u0641 \u0628\u0646\u064a\u0629 \u0627\u0644\u062a\u0648\u0627\u0641\u0642\u064a\u0627\u062a \u0627\u0644\u0641\u0631\u064a\u062f\u0629.',step3Title:'\u0627\u0633\u062a\u062e\u0631\u0627\u062c \u0627\u0644\u0641\u0648\u0631\u0645\u0627\u0646\u062a',step3Desc:'\u0631\u0646\u064a\u0646 \u0627\u0644\u0645\u0633\u0627\u0631 \u0627\u0644\u0635\u0648\u062a\u064a \u0641\u0631\u064a\u062f \u0644\u0643\u0644 \u0634\u062e\u0635.',step4Title:'\u0628\u0635\u0645\u0629 RF',step4Desc:'\u0627\u0644\u0645\u064a\u0632\u0627\u062a \u0627\u0644\u0637\u064a\u0641\u064a\u0629 \u062a\u064f\u0634\u0641\u0631 \u0643\u062a\u0648\u0642\u064a\u0639 RF.',ch1Title:'\u062a\u0648\u0623\u0645 \u0635\u0648\u062a\u064a',ch1Desc:'\u0647\u0644 \u064a\u0645\u0643\u0646 \u0644\u0634\u062e\u0635\u064a\u0646 \u0627\u0644\u062a\u0637\u0627\u0628\u0642\u061f',ch2Title:'\u0645\u0635\u0627\u062f\u0642\u0629 \u0627\u0644\u0647\u0645\u0633',ch2Desc:'u0647u0644 u062au0639u0645u0644 u0639u0646u062f u0627u0644u0647u0645u0633u061f. يختبر هذا التحدي فهمك للآلية الكامنة وليس السلوك السطحي فقط. جرب أساليب مختلفة قبل التحقق من الحل.',ch3Title:'\u0627\u062e\u062a\u0628\u0627\u0631 \u0628\u064a\u0626\u064a',ch3Desc:'\u0627\u062e\u062a\u0628\u0631 \u0641\u064a \u063a\u0631\u0641 \u0645\u062e\u062a\u0644\u0641\u0629.',howto_1:'تعرض الشاشة الرئيسية محاكاة Voice Rf Fingerprint. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Microphone captures voice with fundamental frequency and har',howto_2:'\u062c\u0631\u0628 \u0623\u0635\u0648\u0627\u062a \u0645\u062e\u062a\u0644\u0641\u0629.',howto_3:'\u0627\u0646\u0642\u0631 \u0645\u0635\u0627\u062f\u0642\u0629 \u0644\u0644\u062a\u0633\u062c\u064a\u0644.',wiki1_title:'\ud83c\udfa4 \u0627\u0644\u062a\u0648\u0627\u0641\u0642\u064a\u0627\u062a',wiki1_text:'F0 \u064a\u0646\u062a\u062c \u062a\u0648\u0627\u0641\u0642\u064a\u0627\u062a. \u0627\u0644\u0645\u0633\u0627\u0631 \u064a\u0634\u0643\u0644\u0647\u0627 \u0641\u0648\u0631\u0645\u0627\u0646\u062a.',wiki2_title:'\ud83d\udd12 \u0645\u0635\u0627\u062f\u0642\u0629 RF',wiki2_text:'\u0627\u0644\u0637\u064a\u0641 \u064a\u062a\u062d\u0648\u0644 \u0625\u0644\u0649 \u0628\u0635\u0645\u0629 \u0647\u0634.',activityLog:'\u0633\u062c\u0644',eventsMsg:'\u0623\u062d\u062f\u0627\u062b',clear:'\u0645\u0633\u062d',copy:'\u0646\u0633\u062e',export:'\u062a\u0635\u062f\u064a\u0631',filterAll:'\u0627\u0644\u0643\u0644',settings:'\u2699\ufe0f \u0625\u0639\u062f\u0627\u062f\u0627\u062a',language:'\u0644\u063a\u0629',theme:'\u0645\u0638\u0647\u0631',help:'\u2753 \u0645\u0633\u0627\u0639\u062f\u0629',faq:'\u0623\u0633\u0626\u0644\u0629',howto:'\u062f\u0644\u064a\u0644',wiki:'\u0648\u064a\u0643\u064a',soundEffects:'\ud83d\udd0a \u0635\u0648\u062a',breathingGuide:'\u062a\u0646\u0641\u0633',dhikrTap:'\u0627\u0636\u063a\u0637',musicMode:'\u0645\u0648\u0633\u064a\u0642\u0649',splashHint:'\u0627\u0646\u0642\u0631',working:'\u062c\u0627\u0631\u064d\u2026',t_mosque:'\u0645\u0633\u062c\u062f',t_zellige:'\u0632\u0644\u064a\u062c',t_andalus:'\u0623\u0646\u062f\u0644\u0633',t_riad:'\u0631\u064a\u0627\u0636',t_medina:'\u0645\u062f\u064a\u0646\u0629',t_space:'\u0641\u0636\u0627\u0621',t_jungle:'\u0623\u062f\u063a\u0627\u0644',t_robot:'\u0631\u0648\u0628\u0648\u062a',ready:'\ud83c\udfa4 \u0628\u0635\u0645\u0629 \u0627\u0644\u0635\u0648\u062a \u062c\u0627\u0647\u0632\u0629!',logCleared:'\u062a\u0645 \u0627\u0644\u0645\u0633\u062d',copied:'\u062a\u0645!',copyFail:'\u0641\u0634\u0644',langChanged:'\ud83c\udf10 \u0627\u0644\u0639\u0631\u0628\u064a\u0629',themeChanged:'\ud83c\udfa8 \u2190',sectionCode:'كود الجهاز',faq_q1:'ماذا يفعل هذا التطبيق؟',faq_a1:'Voice Rf Fingerprint هي محاكاة تفاعلية توضح مفاهيم الإلكترونيات الحيوية. Voice harmonic patterns create unique RF authentication fingerprints. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف يعمل؟',faq_a2:'المحاكاة تعمل في متصفحك. تنمذج body signals into radio حقيقية خطوة بخطوة.',faq_q3:'ماذا أجرب أولاً؟',faq_a3:'اضغط على الزر الرئيسي وشاهد! 🎯 ثم عدّل الإعدادات لترى التأثير.',faq_q4:'ما العلم الحقيقي؟',faq_a4:'هذا biometric radio technology حقيقي! نفس المبادئ المستخدمة من المحترفين. 🧪',faq_q5:'هل يمكنني كسره؟',faq_a5:'جرب المختبر! ادفع المعلمات للحدود القصوى وشاهد. هكذا يكتشف العلماء! 💡',faq_q6:'ما العتاد المطلوب؟',faq_a6:'للنسخة الحقيقية تحتاج a computer with Python 3. تفقد 📦 كود الجهاز!',faq_q7:'هل هو آمن؟',faq_a7:'آمن تماماً! 🛡️ كل شيء يعمل محلياً. لا حاجة للإنترنت.',faq_q8:'ماذا بعد؟',faq_a8:'جرب Bio Muscle Telegraph and Bio Pupil Morse! كل واحد يعلّم شيئاً مختلفاً. 🚀',demo_s1:'مرحباً! لنستكشف هذه المحاكاة معاً. انظر إلى القسم الرئيسي أعلاه. 🔬',demo_s2:'اضغط زر الإجراء الرئيسي للبدء. شاهد التصور يستجيب! ⚡',demo_s3:'غيّر إعداداً — جرب شريط تمرير أو قائمة منسدلة. هل ترى التغيير؟ 🔄',demo_s4:'تحقق من النتائج — الرسوم البيانية تُظهر ما يحدث. 📊',demo_s5:'رائع! 🎉 أنت تعرف الأساسيات. جرب المختبر للتعمق أكثر!',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'Biosignals',learn1Desc:'How your body generates electrical signals',learn1Tag:'Biology',learn2Title:'Bio-Radio',learn2Desc:'How body signals can be converted to radio waves',learn2Tag:'RF',learn3Title:'Neural Signals',learn3Desc:'How nerves transmit electrical impulses',learn3Tag:'Neuroscience',learn4Title:'Biometric ID',learn4Desc:'How unique body patterns identify individuals',learn4Tag:'Biometrics',sectionLearn:'ماذا ستتعلم',learnLevelVal:'متوسط 🟡',learnLevel:'المستوى:',learnTimeVal:'20 min ⏱',learnTime:'المدة:',learnAgeVal:'12+ 🧒',
 ...
 theory: 'Voice Rf Fingerprint يوضح المبادئ الأساسية في الإلكترونيات الحيوية. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. The Fast Fourier Transform converts time-domain signals to frequency-domain in O(N·log N) operations. It reveals the spectral content of any signal. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
function initVoiceApp(){
 ...
 function frame(){
 ctx.fillStyle='rgba(0,0,0,.12)';ctx.fillRect(0,0,W,H);t+=.016;
 if(analyzing){
 const v=voices[currentVoice];fundamental=v.f0+Math.sin(t*3)*10+Math.random()*5;
 for(let i=0;i<128;i++){const freq=i*40;let amp=0;
 ...
 spectrumData[i]=spectrumData[i]*.85+amp*.15+(Math.random()-.5)*.01}
 }

 // Spectrum bars
 const barW=W/128;
 spectrumData.forEach((v,i)=>{
 const h=v*H*.7;const hue=i/128*240;
 ctx.fillStyle=`hsla(${hue},80%,50%,${.3+v*.5})`;
 ...
 ctx.strokeStyle='rgba(255,255,255,.2)';ctx.setLineDash([2,4]);
 for(let h=1;h<=8;h++){const x=fundamental*h/40*barW;if(x<W){ctx.beginPath();ctx.moveTo(x,0);ctx.lineTo(x,H);ctx.stroke();ctx.fillStyle='rgba(255,255,255,.4)';ctx.font='8px Orbitron';ctx.fillText(`H${h}`,x+2,15)}}
 ctx.setLineDash([]);
 // Formant regions
 v.formants.forEach((f,i)=>{const x=f/40*barW;ctx.fillStyle=v.color+'33';ctx.fillRect(x-15,0,30,H);ctx.fillStyle=v.color;ctx.font='10px Orbitron';ctx.fillText(`F${i+1}`,x-5,30)});
 }

 // Fingerprint hash display
 ctx.fillStyle='rgba(0,0,0,.6)';ctx.fillRect(W-220,H-60,210,52);
 ctx.fillStyle='#ffcc00';ctx.font='9px Orbitron';
 const hash=spectrumData.slice(0,16).map(v=>Math.round(v*255).toString(16).padStart(2,'0')).join('');
 ctx.fillText(`FP: ${hash.slice(0,32)}`,W-212,H-42);
 ctx.fillStyle='rgba(255,255,255,.4)';ctx.font='8px Orbitron';
 ctx.fillText(`F0: ${Math.round(fundamental)}Hz Voice: ${currentVoice}`,W-212,H-22);
 ctx.fillText(`Profiles: ${voiceProfiles.length}`,W-212,H-12);

 // Waveform display
 ctx.fillStyle='rgba(0,0,0,.3)';ctx.fillRect(5,5,180,60);
 ctx.strokeStyle=voices[currentVoice].color;ctx.lineWidth=1.5;
 ctx.beginPath();
 for(let x=0;x<180;x++){const y=35+Math.sin(x*.05*fundamental/50+t*10)*20*Math.sin(x*.02);if(x===0)ctx.moveTo(x+5,y);else ctx.lineTo(x+5,y)}
 ctx.stroke();
 ctx.fillStyle='rgba(255,255,255,.3)';ctx.font='8px Orbitron';ctx.fillText('WAVEFORM',10,18);

 // Stats
 const sf=$('statF0'),sp=$('statProfiles'),sm=$('statMatch'),sfo=$('statFormants');
 if(sf)sf.textContent=Math.round(fundamental);
 if(sp)sp.textContent=voiceProfiles.length;
 if(sfo)sfo.textContent=voices[currentVoice].formants.length;
 ...
 if(startBtn)startBtn.onclick=()=>{analyzing=!analyzing;setStatus(analyzing);const span=startBtn.querySelector('[data-i18n]');if(span)span.textContent=analyzing?LANG[currentLang].btn1Stop:LANG[currentLang].btn1;log(analyzing?'\ud83c\udfa4 Voice analysis started':'Stopped','info')};
 if(deepBtn)deepBtn.onclick=()=>{currentVoice='deep';log('Voice: Deep (male ~95Hz)','info');playSound('click')};
 if(highBtn)highBtn.onclick=()=>{currentVoice='high';log('Voice: High (female ~220Hz)','info');playSound('click')};
 if(authBtn)authBtn.onclick=()=>{
 const hash=spectrumData.slice(0,16).map(v=>Math.round(v*255).toString(16).padStart(2,'0')).join('');
 voiceProfiles.push(hash);
 const match=voiceProfiles.length>1&&voiceProfiles[voiceProfiles.length-1].slice(0,8)===voiceProfiles[voiceProfiles.length-2].slice(0,8);
 const sm=$('statMatch');if(sm)sm.textContent=match?'MATCH':'NEW';
 log(`\ud83d\udd12 Auth: ${hash.slice(0,24)}... ${match?'MATCH \u2705':'NEW PROFILE \ud83d\udfe2'}`,'success');
 showToast(match?'Voice matched!':'New voice registered',1500);
 };
}
