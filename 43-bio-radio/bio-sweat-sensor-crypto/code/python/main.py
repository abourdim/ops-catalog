#!/usr/bin/env python3
"""
Bio Sweat Sensor Crypto
Sweat chemistry as crypto seed

Workshop-DIY Educational Project

Process:
    Step 1: Bio-sensors measure sweat pH, NaCl concentration, and humidity.
    Step 2: Skin temperature adds thermal entropy from activity and environment.
    Step 3: Multiple chemical markers create a unique bio-signature.
    Step 4: Chemical values hashed into a cryptographic seed unique to each person.
...
APP_NAME = "bio-sweat-sensor-crypto"
