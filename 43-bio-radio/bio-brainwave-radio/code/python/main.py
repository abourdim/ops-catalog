...
Process:
    Step 1: Electrodes detect tiny brain electrical signals (10-100 microvolts).
    Step 2: Fast Fourier Transform decomposes signals into Delta, Theta, Alpha, Beta bands.
    Step 3: Brain state data modulates a radio carrier. Focus level controls modulation.
    Step 4: micro:bit transmits the signal. Another micro:bit receives and decodes brain state.
