...
Process:
    Step 1: Pulse sensor detects heartbeat via PPG on the fingertip.
    Step 2: Each node broadcasts BPM. Nearby nodes auto-connect.
    Step 3: Nodes gradually adjust BPM toward neighbors.
    Step 4: Sync percentage shows harmony level.
