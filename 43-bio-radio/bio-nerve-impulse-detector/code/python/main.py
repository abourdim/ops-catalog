#!/usr/bin/env python3
"""
Bio Nerve Impulse Detector
Detect nerve impulses via RF

Workshop-DIY Educational Project

Process:
    Step 1: Neurons fire action potentials: -70mV to +40mV in ~1ms creating EM emissions.
    Step 2: HackRF SDR with high-gain antenna detects faint nerve emissions.
    Step 3: Band-pass filtering and averaging extract nerve signals from noise.
    Step 4: Different nerves have different conduction velocities (1-120 m/s).
...
APP_NAME = "bio-nerve-impulse-detector"
