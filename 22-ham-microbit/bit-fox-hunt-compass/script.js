...
const LANG = {
  en: {
    ...
    howto_1: 'Press "New Hunt" to hide a fox at a random location on the field.',
    howto_2: 'Use N/S/E/W buttons to move your position on the map.',
    howto_3: 'Watch the signal bar and direction arrow — move toward stronger signal.',
    howto_4: 'When you are close enough, the fox is revealed. Try to find it in as few steps as possible!',
  ...
  fr: {
    ...
    howto_1: 'Appuyez sur "Nouvelle chasse" pour cacher un renard a un endroit aleatoire.',
    howto_2: 'Utilisez les boutons N/S/E/O pour deplacer votre position sur la carte.',
    howto_3: 'Surveillez la barre de signal et la fleche — deplacez-vous vers le signal plus fort.',
    howto_4: 'Quand vous etes assez pres, le renard est revele. Essayez de le trouver en un minimum de pas !',
  ...
  ar: {
    ...
    howto_1: 'اضغط "صيد جديد" لاخفاء ثعلب في موقع عشوائي على الميدان.',
    howto_2: 'استخدم ازرار ش/ج/شر/غ لتحريك موقعك على الخريطة.',
    howto_3: 'راقب شريط الاشارة وسهم الاتجاه — تحرك نحو الاشارة الاقوى.',
    howto_4: 'عندما تكون قريبا بما فيه الكفاية، يتم كشف الثعلب. حاول العثور عليه بأقل عدد من الخطوات!',
