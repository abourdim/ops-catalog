...
const LANG = {
  en: {
    ...
    howto_4: 'Click individual LEDs to toggle them and experiment with custom patterns.',
  ...
  ar: {
    ...
    howto_4: 'انقر على كل LED لتبديلها وتجربة أنماط مخصصة.',
