...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-C54B43',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Signal Meter \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Signal Meter', subtitle: '📶 signal · 📊 measure · 💡 learn',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Signal Meter — S-Meter Display', mainDesc: 'Measure radio signal strength on a 5x5 LED grid',
 sectionA: 'How It Works', sectionB: 'Lab', sectionC: 'Challenge',
 signalLevel: 'Signal Level', noiseFloor: 'Noise Floor', autoScan: 'Auto Scan',
 snrLabel: 'SNR',
 stepA1: 'The antenna picks up a radio signal from the air. The signal strength depends on transmitter power, distance, and obstacles.',
 stepA2: 'An ADC (analog-to-digital converter) measures the voltage from the receiver, converting the analog signal to a digital number.',
 stepA3: 'The digital value is converted to dBm and then to S-units. Each S-unit equals 6 dB. S9 = -73 dBm.',
 stepA4: 'The LED matrix displays a bar graph: columns fill from bottom to top based on signal strength, giving a visual S-meter.',
 labB1: 'Map signal strength to LED patterns: adjust the signal slider and observe how the bar graph fills columns from left to right.',
 labB2: 'Calibrate the S-meter: compare the dBm value with the S-unit reading. Verify that each S-unit step equals 6 dB.',
 labB3: 'Measure SNR: adjust the noise floor slider and observe how the signal-to-noise ratio changes. A higher SNR means a cleaner signal.',
 labB4: 'Compare analog vs digital meter: watch how the LED bar graph approximates a traditional analog S-meter needle movement.',
 challengeC1: 'Design a custom LED pattern for each S-level: create unique visual patterns for S1, S5, and S9 that go beyond simple bar graphs.',
 challengeC2: 'Find the signal in the noise: set a high noise floor and slowly adjust the signal level. At what SNR can you first detect the signal on the display?',
 challengeC3: 'Build a peak-hold meter: modify the display so the highest signal level is remembered and shown as a single bright LED above the current bar.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1: 'The main display shows the Signal Meter simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select the operating band and tune to the target frequency.',
 howto_2: 'Adjust the Noise Floor slider to add background noise and see how SNR changes. Take note of how the visualization changes. Each visual element represents a specific data value or process state. The colors encode information: brighter typically means higher values or more activity.',
 howto_3: 'Click Auto Scan to watch an animated sweep from weak to strong signal levels. Now look at the data panels below the main visualization. The numbers update in real time and correspond to what you see visually. Matching the numbers to the visual helps build quantitative understanding.',
 howto_4: 'Click individual LEDs to toggle them and experiment with custom patterns. The key insight is the relationship between your input and the system output. Try predicting what will happen before you make each change — this prediction-testing cycle is how experts develop intuition.',
 wiki_smeter_title: '📶 S-Meter Scale', wiki_smeter: 'S1=-121 dBm, S2=-115 dBm... S9=-73 dBm. Above S9, readings are S9+10, S9+20, etc. Each S-unit = 6 dB.',
 wiki_db_title: '📊 dB and dBm', wiki_db: 'dB is a ratio (relative). dBm is power relative to 1 milliwatt (absolute). -73 dBm = S9 by convention.',
 wiki_snr_title: '📉 Signal-to-Noise Ratio', wiki_snr: 'SNR = signal level minus noise floor in dB. Higher SNR means cleaner reception. Below ~6 dB SNR, signals become hard to decode.',
 wiki_led_title: '💡 LED Matrix Programming', wiki_led: 'The micro:bit has a 5x5 LED matrix (25 LEDs). Each LED can be on/off or have brightness levels 0-9. Bar graphs use columns as signal indicators.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📶 Signal Meter ready!',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-C54B43',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Signal Meter \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Signal Meter', subtitle: '📶 signal · 📊 mesurer · 💡 apprendre',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'S-Mètre — Affichage Signal', mainDesc: 'Mesurez la puissance du signal radio sur une grille LED 5x5',
 sectionA: 'Comment ça marche', sectionB: 'Labo', sectionC: 'Défi',
 signalLevel: 'Niveau du signal', noiseFloor: 'Plancher de bruit', autoScan: 'Balayage auto',
 snrLabel: 'RSB',
 stepA1: 'L\'antenne capte un signal radio. La puissance dépend de l\'émetteur, de la distance et des obstacles.',
 stepA2: 'Un CAN (convertisseur analogique-numérique) mesure la tension du récepteur et convertit le signal en nombre numérique.',
 stepA3: 'La valeur numérique est convertie en dBm puis en unités S. Chaque unité S = 6 dB. S9 = -73 dBm.',
 stepA4: 'La matrice LED affiche un graphique en barres : les colonnes se remplissent de bas en haut selon la puissance du signal.',
 labB1: 'Mapper la puissance du signal sur des motifs LED : ajustez le curseur et observez le remplissage des colonnes de gauche à droite.',
 labB2: 'Calibrer le S-mètre : comparez la valeur dBm avec la lecture en unité S. Vérifiez que chaque pas S = 6 dB.',
 labB3: 'Mesurer le RSB : ajustez le curseur de bruit et observez le changement du rapport signal/bruit. Un RSB élevé = signal plus propre.',
 labB4: 'Comparer mètre analogique vs numérique : observez comment le graphique LED simule le mouvement d\'une aiguille S-mètre analogique.',
 challengeC1: 'Créer un motif LED unique pour chaque niveau S : des motifs visuels pour S1, S5 et S9 au-delà des simples barres.',
 challengeC2: 'Trouver le signal dans le bruit : mettez un bruit élevé et ajustez lentement le signal. À quel RSB détectez-vous le signal ?',
 challengeC3: 'Construire un mètre à maintien de crête : la LED la plus haute mémorise le pic de signal au-dessus de la barre actuelle.',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1: 'L écran principal affiche la simulation Signal Meter. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Select the operating band and tune to the target frequency.',
 howto_2: 'Ajustez le curseur Plancher de bruit pour ajouter du bruit et voir le RSB changer.',
 howto_3: 'Cliquez Balayage auto pour voir un balayage animé des niveaux de signal. Regardez les panneaux de données sous la visualisation principale. Les chiffres se mettent à jour en temps réel et correspondent à ce que vous voyez visuellement.',
 howto_4: 'Cliquez sur chaque LED pour la basculer et expérimenter des motifs personnalisés.',
 wiki_smeter_title: '📶 Échelle S-Mètre', wiki_smeter: 'S1=-121 dBm, S2=-115 dBm... S9=-73 dBm. Au-dessus de S9 : S9+10, S9+20, etc. Chaque unité S = 6 dB.',
 wiki_db_title: '📊 dB et dBm', wiki_db: 'dB est un ratio (relatif). dBm est une puissance par rapport à 1 milliwatt (absolu). -73 dBm = S9 par convention.',
 wiki_snr_title: '📉 Rapport Signal/Bruit', wiki_snr: 'RSB = niveau du signal moins plancher de bruit en dB. RSB élevé = meilleure réception. En dessous de ~6 dB, le signal est difficile à décoder.',
 wiki_led_title: '💡 Programmation Matrice LED', wiki_led: 'Le micro:bit a une matrice LED 5x5 (25 LED). Chaque LED peut être on/off ou avoir des niveaux 0-9. Les barres utilisent les colonnes comme indicateurs.',
 working: 'En cours…',
 ...
 title: 'Signal Meter', subtitle: '📶 إشارة · 📊 قياس · 💡 تعلّم',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مقياس الإشارة — عرض S-Meter', mainDesc: 'قياس قوة الإشارة اللاسلكية على شبكة LED مقاس 5×5',
 sectionA: 'كيف يعمل', sectionB: 'المختبر', sectionC: 'التحدي',
 signalLevel: 'مستوى الإشارة', noiseFloor: 'أرضية الضوضاء', autoScan: 'مسح تلقائي',
 snrLabel: 'نسبة إشارة/ضوضاء',
 stepA1: 'يلتقط الهوائي إشارة لاسلكية من الهواء. تعتمد قوة الإشارة على طاقة المرسل والمسافة والعوائق.',
 stepA2: 'يقيس المحوّل التناظري-الرقمي (ADC) الجهد من المستقبل ويحوّل الإشارة التناظرية إلى رقم رقمي.',
 stepA3: 'تُحوَّل القيمة الرقمية إلى dBm ثم إلى وحدات S. كل وحدة S تساوي 6 dB. S9 = -73 dBm.',
 stepA4: 'تعرض مصفوفة LED رسمًا بيانيًا شريطيًا: تمتلئ الأعمدة من الأسفل إلى الأعلى حسب قوة الإشارة.',
 labB1: 'ربط قوة الإشارة بأنماط LED: اضبط شريط التمرير ولاحظ كيف تمتلئ الأعمدة من اليسار إلى اليمين.',
 labB2: 'معايرة مقياس S: قارن قيمة dBm مع قراءة وحدة S. تحقق أن كل خطوة S تساوي 6 dB.',
 labB3: 'قياس نسبة الإشارة/الضوضاء: اضبط شريط الضوضاء ولاحظ تغيّر النسبة. نسبة أعلى = إشارة أنظف.',
 labB4: 'مقارنة المقياس التناظري بالرقمي: شاهد كيف يحاكي الرسم البياني LED حركة إبرة مقياس S التناظري.',
 challengeC1: 'صمم نمط LED مخصص لكل مستوى S: أنشئ أنماطًا بصرية فريدة لـ S1 و S5 و S9 تتجاوز الأشرطة البسيطة.',
 challengeC2: 'اعثر على الإشارة في الضوضاء: اضبط أرضية ضوضاء عالية واضبط الإشارة ببطء. عند أي نسبة إشارة/ضوضاء تكتشف الإشارة؟',
 challengeC3: 'بناء مقياس احتفاظ بالذروة: عدّل العرض بحيث يُحفظ أعلى مستوى إشارة ويُظهر كـ LED ساطع فوق الشريط الحالي.',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Signal Meter. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select the operating band and tune to the target frequency.',
 howto_2: 'اضبط شريط أرضية الضوضاء لإضافة ضوضاء ومشاهدة تغيّر نسبة الإشارة/الضوضاء. لاحظ كيف يتغير التصور. كل عنصر مرئي يمثل قيمة بيانات محددة أو حالة عملية. الألوان تشفر المعلومات: الأكثر سطوعاً عادة يعني قيماً أعلى.',
 howto_3: 'انقر مسح تلقائي لمشاهدة مسح متحرك لمستويات الإشارة من الضعيف إلى القوي. انظر الآن إلى لوحات البيانات أسفل التصور الرئيسي. تتحدث الأرقام في الوقت الفعلي وتتوافق مع ما تراه بصرياً.',
 howto_4: 'انقر على كل LED لتبديلها وتجربة أنماط مخصصة. الفكرة الأساسية هي العلاقة بين مدخلاتك ومخرجات النظام. حاول التنبؤ بما سيحدث قبل كل تغيير.',
 wiki_smeter_title: '📶 مقياس S', wiki_smeter: 'S1=-121 dBm، S2=-115 dBm... S9=-73 dBm. فوق S9: S9+10، S9+20 إلخ. كل وحدة S = 6 dB.',
 wiki_db_title: '📊 dB و dBm', wiki_db: 'dB نسبة (نسبي). dBm قدرة بالنسبة لـ 1 ميلي واط (مطلق). -73 dBm = S9 بالاصطلاح.',
 wiki_snr_title: '📉 نسبة الإشارة إلى الضوضاء', wiki_snr: 'نسبة إ/ض = مستوى الإشارة ناقص أرضية الضوضاء بـ dB. نسبة أعلى = استقبال أنظف. أقل من ~6 dB يصعب فك التشفير.',
 wiki_led_title: '💡 برمجة مصفوفة LED', wiki_led: 'يحتوي micro:bit على مصفوفة LED مقاس 5×5 (25 LED). كل LED يمكن تشغيلها/إيقافها أو ضبط سطوعها 0-9. الأشرطة تستخدم الأعمدة كمؤشرات.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '📶 مقياس الإشارة جاهز!',
...
/* ═══════ SIGNAL METER SIMULATION ═══════ */

let ledCells = [];
let autoScanTimer = null;
let autoScanning = false;

// S-meter scale: S1=-121 dBm, each S-unit = 6 dB, S9=-73 dBm
function dBmToSUnit(dBm) {
 if (dBm <= -127) return { label: 'S0', numeric: 0 };
 const sRaw = (dBm + 127) / 6;
 if (sRaw <= 9) {
 const s = Math.max(0, Math.min(9, Math.round(sRaw)));
 return { label: 'S' + s, numeric: s };
 }
 const over = Math.round(dBm - (-73));
 return { label: 'S9+' + over + 'dB', numeric: 9 + over / 10 };
}
...
function initLedGrid() {
 ...
 cell.classList.toggle('led-on');
 cell.classList.remove('led-dim', 'led-bright');
 log(LANG[currentLang].ledToggled, 'info');
 playSound('click');
 });
...
function getLed(row, col) {
 return ledCells[row * 5 + col] || null;
}

function clearLeds() {
 ledCells.forEach(c => c.classList.remove('led-on', 'led-dim', 'led-bright'));
}

function updateBarGraph(dBm, noiseFloor) {
 clearLeds();
 // Map dBm range -120..-30 to 0..5 columns
 const normalized = Math.max(0, Math.min(1, (dBm - (-120)) / 90));
 const cols = Math.round(normalized * 5);

 // Add noise fluctuation
 const noiseDelta = Math.random() * Math.abs(noiseFloor + 120) * 0.02;

 for (let col = 0; col < cols; col++) {
 // Height of this column: earlier columns are full, last column may be partial
 let height;
 if (col < cols - 1) {
 height = 5;
 } else {
 const frac = (normalized * 5) - col;
 height = Math.max(1, Math.round(frac * 5));
 }
 // Add slight noise jitter to height
 const jitter = Math.random() < noiseDelta ? -1 : 0;
 height = Math.max(0, height + jitter);

 for (let row = 0; row < 5; row++) {
 const led = getLed(4 - row, col);
 if (!led) continue;
 if (row < height) {
 if (row >= 4) {
 led.classList.add('led-bright');
 } else if (row >= 2) {
...
function updateSignalDisplay() {
 ...
 if (!signalSlider || !noiseSlider) return;

 const dBm = parseInt(signalSlider.value);
 const noiseFloor = parseInt(noiseSlider.value);
 const snr = dBm - noiseFloor;
 const sUnit = dBmToSUnit(dBm);

 // Update displays
 const sMeterEl = $('sMeterReading');
 const dbEl = $('dbValue');
 const snrEl = $('snrDisplay');
 const sigVal = $('signalValue');
 const noiseVal = $('noiseValue');

 if (sMeterEl) sMeterEl.textContent = sUnit.label;
 if (dbEl) dbEl.textContent = dBm + ' dBm';
 if (snrEl) snrEl.textContent = (LANG[currentLang].snrLabel || 'SNR') + ': ' + snr + ' dB';
 if (sigVal) sigVal.textContent = dBm + ' dBm';
 if (noiseVal) noiseVal.textContent = noiseFloor + ' dBm';

 updateBarGraph(dBm, noiseFloor);
}

function initSignalSliders() {
 const signalSlider = $('signalSlider');
 const noiseSlider = $('noiseSlider');
 if (signalSlider) {
...
function startAutoScan() {
 ...
 const s = LANG[currentLang];
 const signalSlider = $('signalSlider');
 if (!signalSlider) return;

 showToast(s.scanning, 0);
 log(s.scanning, 'tx');
 setStatus(true);

 let val = -120;
 signalSlider.value = val;
 updateSignalDisplay();
...
function initAutoScan() {
 ...
 if (autoScanning && autoScanTimer) {
 clearInterval(autoScanTimer);
 autoScanTimer = null;
 autoScanning = false;
 hideToast();
 setStatus(false);
 log(LANG[currentLang].scanComplete, 'info');
 } else {
 startAutoScan();
 }
 playSound('click');
