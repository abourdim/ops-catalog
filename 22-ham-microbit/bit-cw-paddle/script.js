...
const LANG = {
  en: {
    ...
    howto_4: 'Use Practice mode: a random letter appears — key it in Morse and press Check to verify.',
  ...
  fr: {
    ...
    howto_4: 'Utilise le mode Pratique : une lettre aléatoire apparaît — tape-la en Morse et appuie sur Vérifier.',
  ...
  ar: {
    ...
    howto_4: 'استخدم وضع التمرين: يظهر حرف عشوائي — اكتبه بمورس ثم اضغط تحقق.',
