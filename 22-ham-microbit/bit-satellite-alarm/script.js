...
const LANG = {
  en: {
    ...
    wiki_orbital_title: '🌍 Orbital Mechanics', wiki_orbital: 'Satellites orbit Earth following Kepler\'s laws. The ISS orbits at ~408 km altitude with a 51.6° inclination, completing one orbit every ~92 minutes at 7.66 km/s.',
    wiki_prediction_title: '🔮 Pass Prediction', wiki_prediction: 'A pass occurs when a satellite rises above the observer\'s horizon. Predictions use the satellite\'s orbital elements (TLE) and the observer\'s coordinates to compute rise/set times.',
