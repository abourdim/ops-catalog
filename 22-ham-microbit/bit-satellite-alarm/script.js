...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-5759A8',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Satellite Alarm \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 howto_2: 'Click "Set Alarm" to arm the alert for the next predicted pass. Take note of how the visualization changes. Each visual element represents a specific data value or process state. The colors encode information: brighter typically means higher values or more activity.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-5759A8',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Satellite Alarm \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 howto_2: 'Cliquez sur "Alarme" pour armer l\'alerte pour le prochain passage prédit. Notez comment la visualisation change. Chaque élément visuel représente une valeur de données ou un état de processus spécifique. Les couleurs encodent l information.',
 ...
 howto_2: 'انقر على "تنبيه" لتفعيل الإنذار للمرور القادم. لاحظ كيف يتغير التصور. كل عنصر مرئي يمثل قيمة بيانات محددة أو حالة عملية. الألوان تشفر المعلومات: الأكثر سطوعاً عادة يعني قيماً أعلى.',
