...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-1B3AA0',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Mesh vs Traditional \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 howto_1:'The main display shows the Mesh Vs Traditional simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how WiFi adapter scans all channels to discover nearby access po',
 ...
 howto_3:'Scroll down to the expandable sections. "Topology Canvas" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_mesh_title: '🔀 Mesh Networking', wiki_mesh:'Nodes relay data cooperatively. Self-healing if one node fails. In a mesh network, every node can relay messages for other nodes. This creates multiple paths between any two points — if one node fails, messages automatically route around it. This self-healing property makes mesh networks ideal for emergency communication.',
 wiki_star_title: '📶 Star Topology', wiki_star:'All devices connect to a central point. Simple but single point of failure. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_hop_title: '🔗 Hops', wiki_hop:'Each relay between mesh nodes. More hops = more latency but better coverage. In a mesh network, every node can relay messages for other nodes. This creates multiple paths between any two points — if one node fails, messages automatically route around it. This self-healing property makes mesh networks ideal for emergency communication.',
 wiki_heal_title: '🩹 Self-Healing', wiki_heal:'Mesh detects failed nodes and reroutes traffic automatically. Sensors convert physical phenomena (light, sound, temperature, motion) into electrical signals that a computer can process. The key specifications are sensitivity (smallest change it can detect), range (min to max values), and accuracy (how close to the true value).',
 working: 'Working…',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-1B3AA0',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Mesh vs Traditional \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Mesh Vs Traditional. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how WiFi adapter scans all channels to discover nearby access po',
