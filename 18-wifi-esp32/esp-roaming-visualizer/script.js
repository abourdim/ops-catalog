...
const LANG = {
 ...
 howto_1:'The main display shows the Roaming Visualizer simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how WiFi adapter scans all channels to discover nearby access po',
 ...
 howto_3:'Scroll down to the expandable sections. "Roaming Canvas" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_roam_title: '📱 Roaming', wiki_roam:'Client switches between APs based on signal strength. Signal-to-noise ratio (SNR) determines how well you can extract useful information. In the real world, noise comes from thermal energy, other transmitters, and electronic components. Engineers design systems to maximize SNR through filters, amplifiers, and antenna design.',
 wiki_rssi_title: '📊 RSSI', wiki_rssi:'Received Signal Strength Indicator. Drives roaming decisions. Signal-to-noise ratio (SNR) determines how well you can extract useful information. In the real world, noise comes from thermal energy, other transmitters, and electronic components. Engineers design systems to maximize SNR through filters, amplifiers, and antenna design.',
 wiki_bss_title: '🔄 BSS Transition', wiki_bss:'802.11v allows APs to suggest roaming to clients. WiFi (IEEE 802.11) operates on 2.4 GHz and 5 GHz bands. Devices find networks through beacon frames broadcast by access points every ~100ms. Modern WiFi uses OFDM modulation to achieve speeds over 1 Gbps by sending data on multiple subcarriers simultaneously.',
 wiki_fast_title: '⚡ Fast Roaming', wiki_fast:'802.11r pre-authenticates, reducing handoff to under 50ms. WiFi (IEEE 802.11) operates on 2.4 GHz and 5 GHz bands. Devices find networks through beacon frames broadcast by access points every ~100ms. Modern WiFi uses OFDM modulation to achieve speeds over 1 Gbps by sending data on multiple subcarriers simultaneously.',
 working: 'Working…',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Roaming Visualizer. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how WiFi adapter scans all channels to discover nearby access po',
