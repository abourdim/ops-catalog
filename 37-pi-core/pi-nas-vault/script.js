...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-FB775C',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi NAS Vault \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi NAS Vault', subtitle: '💾 store · 🔒 encrypt · 📁 manage',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'NAS Vault Dashboard', mainDesc: 'Encrypted network-attached storage server',
 sectionA: 'Storage Monitor', sectionB: 'File Browser', sectionC: 'About Encrypted NAS',
 nasInfo1: 'A NAS provides centralized storage with LUKS encryption for data protection.',
 nasInfo2: 'A Pi with USB drives serves as a low-cost NAS with Samba/NFS shares.',
 nasInfo3: 'This dashboard simulates an encrypted NAS with storage and file browsing.',
 nasUnlocked: '💾 Vault unlocked', nasLocked: '🔴 Vault locked',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Nas Vault simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Storage Monitor" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 theory: 'Pi Nas Vault demonstrates key principles from cybersecurity. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-FB775C',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi NAS Vault \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Coffre NAS Pi', subtitle: '💾 stocker · 🔒 chiffrer · 📁 gérer',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord coffre NAS', mainDesc: 'Serveur de stockage réseau chiffré',
 sectionA: 'Moniteur de stockage', sectionB: 'Explorateur de fichiers', sectionC: 'À propos du NAS chiffré',
 nasInfo1: 'Un NAS fournit du stockage centralisé avec chiffrement LUKS.',
 nasInfo2: 'Un Pi avec disques USB sert de NAS avec partages Samba/NFS.',
 nasInfo3: 'Ce tableau de bord simule un NAS chiffré avec stockage et navigation.',
 nasUnlocked: '💾 Coffre déverrouillé', nasLocked: '🔴 Coffre verrouillé',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Nas Vault. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Nas Vault démontre les principes clés de cybersécurité. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'خزنة NAS على Pi', subtitle: '💾 تخزين · 🔒 تشفير · 📁 إدارة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم خزنة NAS', mainDesc: 'خادم تخزين شبكي مشفر',
 sectionA: 'مراقب التخزين', sectionB: 'متصفح الملفات', sectionC: 'حول التخزين الشبكي المشفر',
 nasInfo1: 'NAS يوفر تخزيناً مركزياً مع تشفير LUKS لحماية البيانات.',
 nasInfo2: 'Pi مع أقراص USB يعمل كـ NAS منخفض التكلفة مع مشاركات Samba/NFS.',
 nasInfo3: 'هذه اللوحة تحاكي NAS مشفر مع مراقبة التخزين وتصفح الملفات.',
 nasUnlocked: '💾 تم فتح الخزنة', nasLocked: '🔴 تم قفل الخزنة',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Nas Vault. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Nas Vault يوضح المبادئ الأساسية في الأمن السيبراني. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ NAS VAULT SIMULATION ═══════ */
let nasUnlocked=false;
const NAS_SHARES=[
 {name:'Public',path:'/mnt/vault/public',size:'12.3 GB',files:1847},
 {name:'Documents',path:'/mnt/vault/docs',size:'8.7 GB',files:3421},
 {name:'Media',path:'/mnt/vault/media',size:'156.4 GB',files:892},
 {name:'Backups',path:'/mnt/vault/backup',size:'45.2 GB',files:156},
];
const NAS_FILES=[
 {name:'report-2026.pdf',size:'2.4 MB',mod:'Mar 18'},
 {name:'photos/',size:'--',mod:'Mar 17'},
 {name:'project-backup.tar.gz',size:'1.2 GB',mod:'Mar 16'},
 {name:'radio-recordings/',size:'--',mod:'Mar 15'},
 {name:'config.yaml',size:'4 KB',mod:'Mar 14'},
 {name:'README.md',size:'8 KB',mod:'Mar 13'},
];

function initNASSim(){
 const btn=$('nasToggle');
 if(btn) btn.onclick=toggleNAS;
 populateNAS();
}
function toggleNAS(){
 const s=LANG[currentLang];
 nasUnlocked=!nasUnlocked;
 const lk=$('luksVal'),btn=$('nasToggle');
 if(nasUnlocked){
 if(lk){lk.textContent='OPEN';lk.style.color='#0f0';}
 if(btn) btn.textContent='Lock Vault';
 setStatus(true); log(s.nasUnlocked,'success'); playSound('success');
 const totalGB=222.6, usedGB=222.6*0.65;
 $('usedVal').textContent=usedGB.toFixed(0)+' GB';
 $('freeVal').textContent=(totalGB-usedGB).toFixed(0)+' GB';
 $('nasFiles').textContent=NAS_SHARES.reduce((a,s)=>a+s.files,0);
 $('diskBar').style.width='65%'; $('diskPct').textContent='65%';
 } else {
 if(lk){lk.textContent='LOCKED';lk.style.color='#f00';}
 if(btn) btn.textContent='Unlock Vault';
 setStatus(false); log(s.nasLocked,'error');
 $('usedVal').textContent='-- GB'; $('freeVal').textContent='-- GB';
 $('nasFiles').textContent='--'; $('diskBar').style.width='0%'; $('diskPct').textContent='--';
 }
}
function populateNAS(){
 const sh=$('nasShares'); if(sh) sh.innerHTML=NAS_SHARES.map(s=>`<div style="padding:.4rem;border-bottom:1px solid var(--border);display:flex;justify-content:space-between"><div><strong>${s.name}</strong><br><span style="opacity:.6;font-size:.7rem">${s.path}</span></div><div style="text-align:right">${s.size}<br><span style="opacity:.6;font-size:.7rem">${s.files} files</span></div></div>`).join('');
 const fb=$('fileBrowser'); if(fb) fb.innerHTML=NAS_FILES.map(f=>`<div style="padding:.2rem;border-bottom:1px solid var(--border)">${f.name.endsWith('/')?'📁':'📄'} ${f.name} <span style="float:right;opacity:.6">${f.size} | ${f.mod}</span></div>`).join('');
}
