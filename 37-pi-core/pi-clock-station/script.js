...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-062F3F',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Clock Station \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Clock Station', subtitle: '⏰ sync · 🛰️ gps · 🕐 serve',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Clock Station Dashboard', mainDesc: 'GPS-disciplined NTP time server',
 sectionA: 'Time Accuracy', sectionB: 'NTP Clients', sectionC: 'About GPS Time',
 clockInfo1: 'GPS atomic clocks enable Stratum 1 NTP servers via PPS signal.',
 clockInfo2: 'A Pi with GPS HAT provides sub-microsecond accuracy.',
 clockInfo3: 'This dashboard simulates a GPS NTP server with offset tracking.',
 ntpStarted: '⏰ NTP server started', ntpStopped: '🔴 NTP server stopped',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Clock Station simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Time Accuracy" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 theory: 'Pi Clock Station demonstrates key principles from cybersecurity. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-062F3F',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Clock Station \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Station horloge Pi', subtitle: '⏰ synchroniser · 🛰️ gps · 🕐 servir',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord station horloge', mainDesc: 'Serveur de temps NTP discipliné par GPS',
 sectionA: 'Précision du temps', sectionB: 'Clients NTP', sectionC: 'À propos du temps GPS',
 clockInfo1: 'Les horloges atomiques GPS permettent des serveurs NTP Stratum 1.',
 clockInfo2: 'Un Pi avec HAT GPS fournit une précision sub-microseconde.',
 clockInfo3: 'Ce tableau de bord simule un serveur NTP GPS avec suivi de décalage.',
 ntpStarted: '⏰ Serveur NTP démarré', ntpStopped: '🔴 Serveur NTP arrêté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Clock Station. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Clock Station démontre les principes clés de cybersécurité. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'محطة ساعة Pi', subtitle: '⏰ مزامنة · 🛰️ جي بي إس · 🕐 خدمة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم محطة الساعة', mainDesc: 'خادم وقت NTP منضبط بالـ GPS',
 sectionA: 'دقة الوقت', sectionB: 'عملاء NTP', sectionC: 'حول وقت GPS',
 clockInfo1: 'الساعات الذرية في GPS تتيح خوادم NTP من المستوى الأول.',
 clockInfo2: 'Pi مع وحدة GPS يوفر دقة أقل من ميكروثانية.',
 clockInfo3: 'هذه اللوحة تحاكي خادم NTP GPS مع تتبع الانحراف.',
 ntpStarted: '⏰ بدأ خادم NTP', ntpStopped: '🔴 توقف خادم NTP',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Clock Station. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Clock Station يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ CLOCK STATION SIMULATION ═══════ */
let ntpRunning=false, ntpInterval=null, clockCtx=null, ntpClientsCount=0;
const NTP_CLIENTS_LIST=[
 {ip:'192.168.1.10',name:'Desktop',polls:0},
 {ip:'192.168.1.25',name:'Laptop',polls:0},
 {ip:'192.168.1.50',name:'Router',polls:0},
 {ip:'192.168.1.100',name:'Server',polls:0},
 {ip:'10.0.0.2',name:'VPN Client',polls:0},
];

function initClockSim(){
 const btn=$('clockToggle');
 if(btn) btn.onclick=toggleNTP;
 const c=$('clockCanvas'); if(c) clockCtx=c.getContext('2d');
...
function updateClock(){
 const now=new Date();
 const bc=$('bigClock');
 if(bc) bc.textContent=now.toLocaleTimeString('en-US',{hour12:false})+'.'+String(now.getMilliseconds()).padStart(3,'0');
 const dd=$('dateDisplay');
 if(dd) dd.textContent=now.toLocaleDateString('en-US',{weekday:'long',year:'numeric',month:'long',day:'numeric'});
 const ud=$('utcDisplay');
 if(ud) ud.textContent='UTC: '+now.toISOString().replace('T','').slice(0,23);
}
function toggleNTP(){
 if(ntpRunning){
 ntpRunning=false; if(ntpInterval){clearInterval(ntpInterval);ntpInterval=null;}
 setStatus(false); log(LANG[currentLang].ntpStopped,'error');
 } else {
 ntpRunning=true; setStatus(true); log(LANG[currentLang].ntpStarted,'success'); playSound('success');
 ntpInterval=setInterval(ntpTick,2000);
 }
}
function ntpTick(){
 if(!ntpRunning) return;
 const sats=8+Math.floor(Math.random()*6);
 const offset=(Math.random()*200-100).toFixed(0);
 const sv=$('satsVal'),ov=$('offsetVal'),nc=$('ntpClients');
 if(sv) sv.textContent=sats; if(ov) ov.textContent=offset+' ns';
 // Simulate client polls
 const client=NTP_CLIENTS_LIST[Math.floor(Math.random()*NTP_CLIENTS_LIST.length)];
 client.polls++;
 if(nc) nc.textContent=NTP_CLIENTS_LIST.length;
 populateNTPClients();
 // Draw offset graph
 if(clockCtx){
 const c=$('clockCanvas'), w=c.width, h=c.height;
 clockCtx.fillStyle='rgba(0,0,0,0.1)'; clockCtx.fillRect(0,0,w,h);
 const imgData=clockCtx.getImageData(1,0,w-1,h);
 clockCtx.putImageData(imgData,0,0);
 const y=h/2-(parseInt(offset)/200)*h/2;
 clockCtx.fillStyle=Math.abs(parseInt(offset))<50?'#0f0':'#ff0';
 clockCtx.fillRect(w-2,y,2,2);
 // Zero line
 clockCtx.strokeStyle='rgba(255,255,255,0.1)'; clockCtx.beginPath();
 clockCtx.moveTo(0,h/2); clockCtx.lineTo(w,h/2); clockCtx.stroke();
 }
}
function populateNTPClients(){
 const el=$('ntpClientList'); if(!el) return;
 el.innerHTML=NTP_CLIENTS_LIST.map(c=>`<div style="padding:.3rem;border-bottom:1px solid var(--border);display:flex;justify-content:space-between"><span><span style="color:#0f0">●</span> ${c.name} (${c.ip})</span><span style="font-family:monospace">${c.polls} polls</span></div>`).join('');
}
