...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-57F654',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi iGate Digipeater \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi iGate Digipeater', subtitle: '📍 track · 📡 relay · 🗺️ map',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'APRS Dashboard', mainDesc: 'APRS iGate and digipeater infrastructure node',
 sectionA: 'Station Map', sectionB: 'Packet Monitor', sectionC: 'About APRS',
 aprsInfo1: 'APRS is a digital protocol for real-time position reports, weather, and messages.',
 aprsInfo2: 'An iGate bridges RF and internet. A digipeater retransmits to extend range.',
 aprsInfo3: 'This dashboard simulates an APRS node with station tracking and packet decoding.',
 aprsStarted: '📍 iGate started', aprsStopped: '🔴 iGate stopped',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Igate Digipeater simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Station Map" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-57F654',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi iGate Digipeater \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'iGate Digipéateur Pi', subtitle: '📍 suivre · 📡 relayer · 🗺️ cartographier',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord APRS', mainDesc: 'Noeud d\'infrastructure iGate et digipéateur APRS',
 sectionA: 'Carte des stations', sectionB: 'Moniteur de paquets', sectionC: 'À propos de l\'APRS',
 aprsInfo1: 'APRS est un protocole numérique pour les rapports de position et messages en temps réel.',
 aprsInfo2: 'Un iGate fait le pont entre RF et internet. Un digipéateur retransmet pour étendre la portée.',
 aprsInfo3: 'Ce tableau de bord simule un noeud APRS avec suivi de stations et décodage de paquets.',
 aprsStarted: '📍 iGate démarré', aprsStopped: '🔴 iGate arrêté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Igate Digipeater. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Igate Digipeater démontre les principes clés de cybersécurité. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'بوابة APRS على Pi', subtitle: '📍 تتبع · 📡 ترحيل · 🗺️ خريطة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم APRS', mainDesc: 'عقدة بنية تحتية لبوابة وموجه APRS',
 sectionA: 'خريطة المحطات', sectionB: 'مراقب الحزم', sectionC: 'حول نظام APRS',
 aprsInfo1: 'APRS هو بروتوكول رقمي لتقارير الموقع والطقس والرسائل في الوقت الفعلي.',
 aprsInfo2: 'البوابة تربط بين RF والإنترنت. الموجه يعيد الإرسال لتوسيع المدى.',
 aprsInfo3: 'هذه اللوحة تحاكي عقدة APRS مع تتبع المحطات وفك تشفير الحزم.',
 aprsStarted: '📍 بدأت البوابة', aprsStopped: '🔴 توقفت البوابة',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Igate Digipeater. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Igate Digipeater يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ APRS SIMULATION ═══════ */
let aprsRunning=false, aprsInterval=null, igateRx=0, digiTxC=0;
const APRS_STATIONS=[
 {call:'VE3ABC-9',lat:0.3,lon:0.2,sym:'car',comment:'En route'},
 {call:'W1XYZ-1',lat:0.6,lon:0.4,sym:'house',comment:'Home QTH'},
 {call:'KF7IJK-2',lat:0.5,lon:0.7,sym:'digi',comment:'Digipeater'},
 {call:'N5BOB-9',lat:0.8,lon:0.3,sym:'car',comment:'Mobile'},
 {call:'WX-STAT',lat:0.4,lon:0.8,sym:'wx',comment:'Temp:22C Wind:5kph'},
 {call:'DL1ABC-7',lat:0.2,lon:0.6,sym:'hiker',comment:'On summit'},
];

function initAPRSSim(){
 const btn=$('aprsToggleBtn');
 if(btn) btn.onclick=toggleAPRS;
 drawAPRSMap();
}
function toggleAPRS(){
 if(aprsRunning){
 aprsRunning=false; if(aprsInterval){clearInterval(aprsInterval);aprsInterval=null;}
 setStatus(false); log(LANG[currentLang].aprsStopped,'error');
 const is=$('aprsIs'); if(is) is.textContent='OFF';
 } else {
 aprsRunning=true; setStatus(true); log(LANG[currentLang].aprsStarted,'success');playSound('success');
 const is=$('aprsIs'); if(is){is.textContent='ON';is.style.color='#0f0';}
 aprsInterval=setInterval(aprsTick,2500);
 }
}
function aprsTick(){
 if(!aprsRunning) return;
 const st=APRS_STATIONS[Math.floor(Math.random()*APRS_STATIONS.length)];
 // Move stations slightly
 st.lat+=((Math.random()-0.5)*0.02); st.lon+=((Math.random()-0.5)*0.02);
 st.lat=Math.max(0.05,Math.min(0.95,st.lat)); st.lon=Math.max(0.05,Math.min(0.95,st.lon));
 igateRx++; if(Math.random()>0.5) digiTxC++;
 const ir=$('igateRx'),dt=$('digiTx'),as=$('aprsStations');
 if(ir) ir.textContent=igateRx; if(dt) dt.textContent=digiTxC; if(as) as.textContent=APRS_STATIONS.length;
 const pk=$('aprsPackets');
 if(pk){
 const t=new Date().toLocaleTimeString();
 pk.innerHTML+=`<div>[${t}] ${st.call}>${st.sym==='digi'?'WIDE1-1':''} !${(st.lat*90).toFixed(2)}N/${(st.lon*180).toFixed(2)}W ${st.comment}</div>`;
 pk.scrollTop=pk.scrollHeight;
 }
 log(`📍 ${st.call}: ${st.comment}`,'rx');
 drawAPRSMap();
}
function drawAPRSMap(){
 const c=$('aprsMapCanvas'); if(!c) return;
 const ctx=c.getContext('2d'), w=c.width, h=c.height;
 ctx.fillStyle='#0a1628'; ctx.fillRect(0,0,w,h);
 // Grid
 ctx.strokeStyle='rgba(255,255,255,0.05)'; ctx.lineWidth=0.5;
 for(let i=0;i<10;i++){ctx.beginPath();ctx.moveTo(w/10*i,0);ctx.lineTo(w/10*i,h);ctx.stroke();ctx.beginPath();ctx.moveTo(0,h/10*i);ctx.lineTo(w,h/10*i);ctx.stroke();}
 // Stations
 APRS_STATIONS.forEach(s=>{
 const x=s.lon*w, y=s.lat*h;
 ctx.beginPath(); ctx.arc(x,y,6,0,Math.PI*2);
 ctx.fillStyle=s.sym==='car'?'#0ff':s.sym==='digi'?'#0f0':s.sym==='wx'?'#ff0':'#f80';
 ctx.fill(); ctx.strokeStyle='#fff'; ctx.lineWidth=1; ctx.stroke();
 ctx.fillStyle='#fff'; ctx.font='10px Orbitron,monospace'; ctx.textAlign='center';
 ctx.fillText(s.call,x,y-10);
 });
}
