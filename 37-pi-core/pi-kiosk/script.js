...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-DD33B9',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Kiosk \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Kiosk', subtitle: '📊 display · 📡 monitor · 🖥️ dashboard',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Kiosk Dashboard', mainDesc: 'Multi-display RF monitoring dashboard kiosk',
 sectionA: 'RF Spectrum View', sectionB: 'Display Config', sectionC: 'About RF Dashboards',
 kioskInfo1: 'RF kiosks display multiple SDR data streams on multi-panel displays.',
 kioskInfo2: 'A Pi drives the kiosk showing waterfall, FFT, maps, and metrics.',
 kioskInfo3: 'This dashboard simulates a 4-panel kiosk with configurable layouts.',
 kioskStarted: '📊 Kiosk started', kioskStopped: '🔴 Kiosk stopped',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Kiosk simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "RF Spectrum View" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-DD33B9',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Kiosk \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Kiosque Pi', subtitle: '📊 afficher · 📡 surveiller · 🖥️ tableau',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord Kiosque', mainDesc: 'Kiosque tableau de bord multi-écrans de surveillance RF',
 sectionA: 'Vue du spectre RF', sectionB: 'Configuration d\'affichage', sectionC: 'À propos des tableaux de bord RF',
 kioskInfo1: 'Les kiosques RF affichent plusieurs flux SDR sur des écrans multi-panneaux.',
 kioskInfo2: 'Un Pi pilote le kiosque montrant cascade, FFT, cartes et métriques.',
 kioskInfo3: 'Ce tableau de bord simule un kiosque 4 panneaux avec dispositions configurables.',
 kioskStarted: '📊 Kiosque démarré', kioskStopped: '🔴 Kiosque arrêté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Kiosk. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 title: 'كشك Pi', subtitle: '📊 عرض · 📡 مراقبة · 🖥️ لوحة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم الكشك', mainDesc: 'كشك لوحة مراقبة RF متعدد الشاشات',
 sectionA: 'عرض طيف RF', sectionB: 'إعدادات العرض', sectionC: 'حول لوحات مراقبة RF',
 kioskInfo1: 'أكشاك RF تعرض تدفقات SDR متعددة على شاشات متعددة.',
 kioskInfo2: 'Pi يقود الكشك عارضاً الشلال وFFT والخرائط والمقاييس.',
 kioskInfo3: 'هذه اللوحة تحاكي كشك 4 لوحات مع تخطيطات قابلة للتكوين.',
 kioskStarted: '📊 بدأ الكشك', kioskStopped: '🔴 توقف الكشك',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Kiosk. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
...
/* ═══════ KIOSK SIMULATION ═══════ */
let kioskRunning=false, kioskInterval=null, kioskSec=0;
function initKioskSim(){
 const btn=$('kioskToggle');
 if(btn) btn.onclick=toggleKiosk;
}
function toggleKiosk(){
 if(kioskRunning){
 kioskRunning=false; if(kioskInterval){clearInterval(kioskInterval);kioskInterval=null;}
 setStatus(false); log(LANG[currentLang].kioskStopped,'error');
 } else {
 kioskRunning=true; kioskSec=0; setStatus(true);
 log(LANG[currentLang].kioskStarted,'success'); playSound('success');
 kioskInterval=setInterval(kioskTick,100);
 }
}
function kioskTick(){
 if(!kioskRunning) return;
 kioskSec+=0.1;
 const ut=$('kioskUptime');
 if(ut){const m=Math.floor(kioskSec/60),s=Math.floor(kioskSec%60);ut.textContent=String(m).padStart(2,'0')+':'+String(s).padStart(2,'0');}
 ['kioskC1','kioskC2','kioskC3','kioskC4'].forEach((id,idx)=>{
 const c=$(id); if(!c) return;
 const ctx=c.getContext('2d'), w=c.width, h=c.height;
 ctx.fillStyle='rgba(0,0,0,0.2)'; ctx.fillRect(0,0,w,h);
 const colors=['#0f0','#0ff','#f80','#f0f'];
 ctx.strokeStyle=colors[idx]; ctx.lineWidth=1.5; ctx.beginPath();
 for(let x=0;x<w;x++){
 const n=Math.random()*10;
 const sig=Math.sin(x*0.05+kioskSec*2+idx)*20*(1+idx*0.3);
 const y=h/2-sig-n;
