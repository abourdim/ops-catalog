...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-71BC1B',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Repeater \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Repeater', subtitle: '📡 repeat · 🔊 amplify · 🌐 extend',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Repeater Dashboard', mainDesc: 'Software-defined radio repeater controller',
 sectionA: 'TX/RX Monitor', sectionB: 'Repeater Config', sectionC: 'About Radio Repeaters',
 stateLabel: 'State', enableBtn: 'Enable Repeater', disableBtn: 'Disable Repeater',
 rptInfo1: 'A repeater receives on one frequency and retransmits on another, extending range.',
 rptInfo2: 'Software-defined repeaters on Pi use SDR hardware for flexible digital operation.',
 rptInfo3: 'This dashboard simulates a repeater controller with CTCSS, monitoring, and auto-ID.',
 rptEnabled: '📡 Repeater enabled', rptDisabled: '🔴 Repeater disabled',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Repeater simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "TX/RX Monitor" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-71BC1B',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Repeater \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Répéteur Pi', subtitle: '📡 répéter · 🔊 amplifier · 🌐 étendre',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord du répéteur', mainDesc: 'Contrôleur de répéteur radio défini par logiciel',
 sectionA: 'Moniteur TX/RX', sectionB: 'Configuration du répéteur', sectionC: 'À propos des répéteurs radio',
 stateLabel: 'État', enableBtn: 'Activer répéteur', disableBtn: 'Désactiver répéteur',
 rptInfo1: 'Un répéteur reçoit sur une fréquence et retransmet sur une autre.',
 rptInfo2: 'Les répéteurs logiciels sur Pi utilisent du matériel SDR pour un fonctionnement flexible.',
 rptInfo3: 'Ce tableau de bord simule un contrôleur de répéteur avec CTCSS et identification auto.',
 rptEnabled: '📡 Répéteur activé', rptDisabled: '🔴 Répéteur désactivé',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Repeater. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 title: 'مكرر Pi', subtitle: '📡 تكرار · 🔊 تضخيم · 🌐 توسيع',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم المكرر', mainDesc: 'وحدة تحكم مكرر الراديو المعرّف بالبرمجيات',
 sectionA: 'مراقب الإرسال/الاستقبال', sectionB: 'إعدادات المكرر', sectionC: 'حول مكررات الراديو',
 stateLabel: 'الحالة', enableBtn: 'تفعيل المكرر', disableBtn: 'تعطيل المكرر',
 rptInfo1: 'المكرر يستقبل على تردد ويعيد الإرسال على تردد آخر، مما يوسع المدى.',
 rptInfo2: 'المكررات البرمجية على Pi تستخدم أجهزة SDR للتشغيل الرقمي المرن.',
 rptInfo3: 'هذه اللوحة تحاكي وحدة تحكم مكرر مع CTCSS ومراقبة وتعريف تلقائي.',
 rptEnabled: '📡 تم تفعيل المكرر', rptDisabled: '🔴 تم تعطيل المكرر',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Repeater. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Repeater يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ REPEATER SIMULATION ═══════ */
let rptRunning=false, rptInterval=null, rptTxSec=0;
const RPT_CALLS=['VE3ABC','W1XYZ','KF7IJK','N5BOB','K4SAM','WA2QNF'];

function initRepeaterSim(){
 const btn=$('rptToggleBtn'), idBtn=$('rptIdBtn');
 if(btn) btn.onclick=toggleRepeater;
 if(idBtn) idBtn.onclick=()=>{
 const rl=$('rptLog');
 if(rl){rl.innerHTML+=`<div style="color:#ff0">[CW-ID] DE PI-RPT/R K</div>`;rl.scrollTop=rl.scrollHeight;}
 log('📡 CW ID sent','tx');
 };
}
function toggleRepeater(){
 const s=LANG[currentLang], btn=$('rptToggleBtn');
 if(rptRunning){
 rptRunning=false; if(rptInterval){clearInterval(rptInterval);rptInterval=null;}
 if(btn) btn.textContent=s.enableBtn;
 const st=$('rptState'); if(st) st.textContent='OFF';
 setStatus(false); log(s.rptDisabled,'error');
 } else {
 rptRunning=true;
 if(btn) btn.textContent=s.disableBtn;
 setStatus(true); log(s.rptEnabled,'success'); playSound('success');
 rptInterval=setInterval(rptTick,2000);
 }
}
function rptTick(){
 if(!rptRunning) return;
 const state=$('rptState'), rxBar=$('rxBar'), txBar=$('txBar'), rl=$('rptLog'), timer=$('rptTimer');
 const isActive=Math.random()>0.4;
 if(isActive){
 const call=RPT_CALLS[Math.floor(Math.random()*RPT_CALLS.length)];
 if(state) state.textContent='TX'; if(state) state.style.color='#f80';
 const rxLvl=40+Math.random()*50; const txLvl=60+Math.random()*30;
 if(rxBar) rxBar.style.width=rxLvl+'%'; if(txBar) txBar.style.width=txLvl+'%';
 rptTxSec+=2; if(timer) timer.textContent='TX: '+Math.floor(rptTxSec/60)+':'+String(rptTxSec%60).padStart(2,'0');
 if(rl){rl.innerHTML+=`<div>[RX] ${call} S${Math.floor(rxLvl/10)} → [TX] repeating...</div>`;rl.scrollTop=rl.scrollHeight;}
 log(`📡 ${call} via repeater`,'rx');
 } else {
 if(state) state.textContent='IDLE'; if(state) state.style.color='';
 if(rxBar) rxBar.style.width='5%'; if(txBar) txBar.style.width='0%';
 }
}
