...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-5E6B6A',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi VPN Gateway \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi VPN Gateway', subtitle: '🔐 tunnel · 🛡️ protect · 🌍 connect',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'VPN Gateway Dashboard', mainDesc: 'WireGuard VPN server and gateway manager',
 sectionA: 'Connected Peers', sectionB: 'Tunnel Config', sectionC: 'About WireGuard VPN',
 vpnInfo1: 'WireGuard is a modern, fast, and secure VPN protocol.',
 vpnInfo2: 'A Pi WireGuard gateway encrypts all traffic from connected devices.',
 vpnInfo3: 'This dashboard simulates a WireGuard server managing peers and tunnels.',
 vpnStarted: '🔐 VPN started', vpnStopped: '🔴 VPN stopped',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Vpn Gateway simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Connected Peers" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-5E6B6A',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi VPN Gateway \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 mainSection: 'Tableau de bord passerelle VPN', mainDesc: 'Gestionnaire de serveur VPN WireGuard',
 sectionA: 'Pairs connectés', sectionB: 'Configuration du tunnel', sectionC: 'À propos de WireGuard VPN',
 vpnInfo1: 'WireGuard est un protocole VPN moderne, rapide et sécurisé.',
 vpnInfo2: 'Une passerelle WireGuard sur Pi chiffre tout le trafic des appareils connectés.',
 vpnInfo3: 'Ce tableau de bord simule un serveur WireGuard gérant pairs et tunnels.',
 vpnStarted: '🔐 VPN démarré', vpnStopped: '🔴 VPN arrêté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Vpn Gateway. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Vpn Gateway démontre les principes clés de cybersécurité. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 mainSection: 'لوحة تحكم بوابة VPN', mainDesc: 'مدير خادم وبوابة WireGuard VPN',
 sectionA: 'الأقران المتصلون', sectionB: 'إعدادات النفق', sectionC: 'حول WireGuard VPN',
 vpnInfo1: 'WireGuard هو بروتوكول VPN حديث وسريع وآمن.',
 vpnInfo2: 'بوابة WireGuard على Pi تشفر كل حركة المرور من الأجهزة المتصلة.',
 vpnInfo3: 'هذه اللوحة تحاكي خادم WireGuard يدير الأقران والأنفاق.',
 vpnStarted: '🔐 بدأ VPN', vpnStopped: '🔴 توقف VPN',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Vpn Gateway. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Vpn Gateway يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'أدوات هجوم الخادمة الشريرة',related1_desc:'Simulate evil maid attacks on unattended laptops and learn disk encryption defenses',related1_path:'../../52-hardware-implants/imp-evil-maid-toolkit/index.html',related2_name:'استرجاع المفتاح',related2_desc:'XOR النص المعروف مع المشفر لاسترجاع تيار المفتاح',related2_path:'../../53-crypto-attacks/cry-known-plaintext-attack/index.html',related3_name:'ورشة تزوير الشهادات',related3_desc:'انشئ سلطة جذرية ووسيطة وشهادة طرفية ثم حاول التزوير',related3_path:'../../53-crypto-attacks/cry-certificate-forgery-lab/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'لوحة تحكم موجه Tor',pathPrev_path:'../../37-pi-core/pi-tor-router/index.html',pathNext_name:'وحدة التحكم في غرفة الحرب',pathNext_path:'../../37-pi-core/pi-war-room/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'كيف تبدو SOS بشيفرة مورس؟',quiz_q1a:'---...---',quiz_q1b:'...---...',quiz_q1c:'...-...-',quiz_q1d:'-.-.-.',quiz_q1_answer:'1',quiz_q2:'ما هو التعلم الآلي؟',quiz_q2a:'برمجة الروبوتات',quiz_q2b:'أنظمة تتعلم من البيانات',quiz_q2c:'حساب يدوي',quiz_q2d:'تصميم العتاد',quiz_q2_answer:'1',quiz_q3:'في شيفرة مورس، ما يمثل الحرف E؟',quiz_q3a:'شرطة',quiz_q3b:'نقطة واحدة',quiz_q3c:'نقطتان',quiz_q3d:'نقطة-شرطة',quiz_q3_answer:'1',quiz_q4:'ما هي الشبكة العصبية؟',quiz_q4a:'أسلاك مادية',quiz_q4b:'نظام حوسبة مستوحى من الخلايا العصبية',quiz_q4c:'شبكة اجتماعية',quiz_q4d:'شبكة راديو',quiz_q4_answer:'1',quiz_q5:'من اخترع شيفرة مورس؟',quiz_q5a:'تسلا',quiz_q5b:'صامويل مورس',quiz_q5c:'إديسون',quiz_q5d:'بيل',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'كشفت تسريبات سنودن عام 2013 أن برنامج بريزم التابع لوكالة الأمن القومي جمع البيانات مباشرة من خوادم جوجل وفيسبوك وآبل ومايكروسوفت.',realworld2:'أدى هجوم الفدية على خط أنابيب كولونيال (2021) إلى إغلاق أكبر خط أنابيب وقود في أمريكا لمدة 5 أيام بسبب كلمة مرور VPN واحدة مخترقة.',realworld3:'استعبد بوتنت ميراي (2016) أكثر من 600 ألف جهاز إنترنت الأشياء باستخدام 61 كلمة مرور افتراضية.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في تحليل حركة المرور معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في تحليل حركة المرور وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Pi VPN Gateway يوضح مفهومًا أساسيًا في تحليل حركة المرور. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Pi VPN Gateway لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في تحليل حركة المرور هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ browser وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال تحليل حركة المرور يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'استخدم علامة تبويب الأداء في المتصفح لقياس معدل الإطارات. إذا انخفضت المحاكاة عن 30 إطارًا في الثانية قلل نقاط البيانات.',proTip2:'صدّر بيانات المحاكاة باستخدام زر النسخ والصقها في جدول بيانات وأنشئ مخططاتك الخاصة.',funFactTitle:'🎯 هل تعلم؟',funFact:'عرض أول فيروس كمبيوتر Creeper عام 1971 رسالة على طرفيات ARPANET. وكُتب أول مضاد فيروسات Reaper خصيصًا لملاحقته وحذفه.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
let vpnRunning=false, vpnInterval=null, vpnTxMB=0, vpnRxMB=0;
const VPN_PEERS=[
 {name:'Laptop-Home',ip:'10.0.0.2',last:'now',tx:'125 MB',rx:'340 MB',status:'active'},
 {name:'Phone-Work',ip:'10.0.0.3',last:'2 min ago',tx:'45 MB',rx:'120 MB',status:'active'},
 {name:'Tablet-Guest',ip:'10.0.0.4',last:'1 hour ago',tx:'12 MB',rx:'30 MB',status:'idle'},
 {name:'Server-Cloud',ip:'10.0.0.5',last:'5 min ago',tx:'890 MB',rx:'1.2 GB',status:'active'},
];

function initVPNSim(){
 const btn=$('vpnToggle'), ab=$('addPeerBtn');
 if(btn) btn.onclick=toggleVPN;
 if(ab) ab.onclick=()=>{log('🔐 New peer QR code generated','success');playSound('success');};
 populateVPNPeers();
}
function toggleVPN(){
 if(vpnRunning){
 vpnRunning=false; if(vpnInterval){clearInterval(vpnInterval);vpnInterval=null;}
 setStatus(false); log(LANG[currentLang].vpnStopped,'error');
 const ws=$('wgStatus'); if(ws){ws.textContent='OFF';ws.style.color='';}
 } else {
 vpnRunning=true; setStatus(true); log(LANG[currentLang].vpnStarted,'success'); playSound('success');
 const ws=$('wgStatus'); if(ws){ws.textContent='ON';ws.style.color='#0f0';}
 vpnInterval=setInterval(vpnTick,2000);
 }
}
function vpnTick(){
 if(!vpnRunning) return;
 vpnTxMB+=0.5+Math.random()*2; vpnRxMB+=1+Math.random()*3;
 const tx=$('vpnTx'),rx=$('vpnRx'),pv=$('peersVal');
 if(tx) tx.textContent=vpnTxMB.toFixed(0)+' MB';
 if(rx) rx.textContent=vpnRxMB.toFixed(0)+' MB';
 if(pv) pv.textContent=VPN_PEERS.filter(p=>p.status==='active').length;
}
function populateVPNPeers(){
 const el=$('vpnPeers'); if(!el) return;
 el.innerHTML=VPN_PEERS.map(p=>{
 const c=p.status==='active'?'#0f0':'#888';
 return `<div style="padding:.4rem;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center"><div><span style="color:${c}">●</span> <strong>${p.name}</strong> (${p.ip})<br><span style="opacity:.6;font-size:.75rem">TX: ${p.tx} | RX: ${p.rx}</span></div><span style="opacity:.6;font-size:.75rem">${p.last}</span></div>`;
 }).join('');
 const pv=$('peersVal'); if(pv) pv.textContent=VPN_PEERS.filter(p=>p.status==='active').length;
}
