...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-6AC9AB',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Honeypot Server \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Honeypot Server', subtitle: '🍯 trap · 🔍 detect · 📊 analyze',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Honeypot Dashboard', mainDesc: 'Full-service honeypot for intrusion detection',
 sectionA: 'Attack Monitor', sectionB: 'Service Emulators', sectionC: 'About Honeypots',
 hpInfo1: 'A honeypot is a decoy system to detect unauthorized access.',
 hpInfo2: 'A Pi honeypot emulates SSH, HTTP, FTP, and other services.',
 hpInfo3: 'This dashboard simulates a multi-service honeypot with attack monitoring.',
 hpStarted: '🍯 Honeypot deployed', hpStopped: '🔴 Honeypot stopped',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Honeypot Server simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Attack Monitor" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-6AC9AB',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Honeypot Server \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Serveur pot de miel Pi', subtitle: '🍯 piéger · 🔍 détecter · 📊 analyser',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord pot de miel', mainDesc: 'Pot de miel complet pour la détection d\'intrusions',
 sectionA: 'Moniteur d\'attaques', sectionB: 'Émulateurs de services', sectionC: 'À propos des pots de miel',
 hpInfo1: 'Un pot de miel est un leurre pour détecter les accès non autorisés.',
 hpInfo2: 'Un Pi pot de miel émule SSH, HTTP, FTP et d\'autres services.',
 hpInfo3: 'Ce tableau de bord simule un pot de miel multi-services avec surveillance des attaques.',
 hpStarted: '🍯 Pot de miel déployé', hpStopped: '🔴 Pot de miel arrêté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Honeypot Server. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Honeypot Server démontre les principes clés de cybersécurité. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'خادم مصيدة Pi', subtitle: '🍯 فخ · 🔍 كشف · 📊 تحليل',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم المصيدة', mainDesc: 'مصيدة كاملة الخدمات لكشف التسلل',
 sectionA: 'مراقب الهجمات', sectionB: 'محاكيات الخدمات', sectionC: 'حول المصائد',
 hpInfo1: 'المصيدة هي نظام وهمي لكشف محاولات الوصول غير المصرح بها.',
 hpInfo2: 'مصيدة Pi تحاكي خدمات SSH وHTTP وFTP وغيرها.',
 hpInfo3: 'هذه اللوحة تحاكي مصيدة متعددة الخدمات مع مراقبة الهجمات.',
 hpStarted: '🍯 تم نشر المصيدة', hpStopped: '🔴 توقفت المصيدة',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Honeypot Server. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Honeypot Server يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ HONEYPOT SIMULATION ═══════ */
let hpRunning=false, hpInterval=null, attackCount=0, uniqueIPs=new Set();
const HP_SERVICES=[
 {name:'SSH',port:22,status:'listening',attacks:0},
 {name:'HTTP',port:80,status:'listening',attacks:0},
 {name:'FTP',port:21,status:'listening',attacks:0},
 {name:'Telnet',port:23,status:'listening',attacks:0},
 {name:'SMTP',port:25,status:'listening',attacks:0},
 {name:'MySQL',port:3306,status:'listening',attacks:0},
];
const ATTACK_TYPES=['SSH brute-force','HTTP directory scan','FTP anonymous login','Telnet default creds','SQL injection probe','SMTP relay attempt'];
function rndIP(){return `${Math.floor(Math.random()*200)+10}.${Math.floor(Math.random()*256)}.${Math.floor(Math.random()*256)}.${Math.floor(Math.random()*256)}`;}

function initHoneypotSim(){
 const btn=$('hpToggle');
 if(btn) btn.onclick=toggleHP;
 populateServices();
}
function toggleHP(){
 if(hpRunning){
 hpRunning=false; if(hpInterval){clearInterval(hpInterval);hpInterval=null;}
 setStatus(false); log(LANG[currentLang].hpStopped,'error');
 const s=$('hpStatus'); if(s){s.textContent='OFF';s.style.color='';}
 } else {
 hpRunning=true; setStatus(true); log(LANG[currentLang].hpStarted,'success'); playSound('success');
 const s=$('hpStatus'); if(s){s.textContent='ON';s.style.color='#0f0';}
 hpInterval=setInterval(hpTick,2000);
 }
}
function hpTick(){
 if(!hpRunning) return;
 const ip=rndIP(); uniqueIPs.add(ip); attackCount++;
 const svc=HP_SERVICES[Math.floor(Math.random()*HP_SERVICES.length)]; svc.attacks++;
 const atk=ATTACK_TYPES[Math.floor(Math.random()*ATTACK_TYPES.length)];
 const al=$('attackLog');
 if(al){const t=new Date().toLocaleTimeString();al.innerHTML+=`<div>[${t}] <span style="color:#ff0">${ip}</span> → :${svc.port} (${svc.name}) — ${atk}</div>`;al.scrollTop=al.scrollHeight;}
 log(`🍯 Attack from ${ip}: ${atk}`,'error');
 const av=$('attacksVal'),iv=$('ipsVal');
 if(av) av.textContent=attackCount; if(iv) iv.textContent=uniqueIPs.size;
 populateServices();
}
function populateServices(){
 const el=$('hpServices'); if(!el) return;
 el.innerHTML=HP_SERVICES.map(s=>`<div style="padding:.3rem;border-bottom:1px solid var(--border);display:flex;justify-content:space-between"><span><span style="color:#0f0">●</span> ${s.name} (:${s.port})</span><span style="font-family:monospace">${s.attacks} attacks</span></div>`).join('');
}
