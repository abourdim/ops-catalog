...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-CDCC9B',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Mesh Node \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Mesh Node', subtitle: '🔗 mesh · 📨 message · 🌐 network',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Mesh Network Dashboard', mainDesc: 'LoRa mesh messaging node for off-grid communication',
 sectionA: 'Node Map', sectionB: 'Message Console', sectionC: 'About LoRa Mesh',
 nodesLabel: 'Nodes', msgsLabel: 'Messages', rssiLabel: 'RSSI', snrLabel: 'SNR',
 sendBtn: 'Send', startMeshBtn: 'Start Mesh', stopMeshBtn: 'Stop Mesh',
 channelLabel: 'Channel:', sfLabel: 'SF:',
 meshInfo1: 'LoRa enables very long range communication (up to 15 km) at low bit rates.',
 meshInfo2: 'Mesh networking allows each node to relay messages, extending coverage without infrastructure.',
 meshInfo3: 'This dashboard simulates a LoRa mesh node on Raspberry Pi with a LoRa HAT.',
 meshStarted: '🔗 Mesh node started', meshStopped: '🔴 Mesh node stopped', msgSent: '📨 Message sent',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Mesh Node simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Node Map" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 gloss2_term: 'Self-Healing',
 gloss2_def: 'A mesh network property where if one node fails, traffic automatically reroutes through alternative paths. Recovery time depends on routing protocol convergence speed.',
 ...
 theory: 'Pi Mesh Node demonstrates key principles from cybersecurity. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. Mesh networks connect nodes in a many-to-many topology. Each node can relay traffic for others, creating self-healing paths. No single point of failure. LoRa uses chirp spread spectrum modulation for long-range (10+ km), low-power communication. LoRaWAN adds a network layer for managing IoT devices. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-CDCC9B',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Mesh Node \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Noeud Mesh Pi', subtitle: '🔗 maillage · 📨 message · 🌐 réseau',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord réseau maillé', mainDesc: 'Noeud de messagerie LoRa mesh pour communication hors réseau',
 sectionA: 'Carte des noeuds', sectionB: 'Console de messages', sectionC: 'À propos de LoRa Mesh',
 nodesLabel: 'Noeuds', msgsLabel: 'Messages', rssiLabel: 'RSSI', snrLabel: 'SNR',
 sendBtn: 'Envoyer', startMeshBtn: 'Démarrer Mesh', stopMeshBtn: 'Arrêter Mesh',
 channelLabel: 'Canal :', sfLabel: 'SF :',
 meshInfo1: 'LoRa permet une communication très longue portée (jusqu\'à 15 km) à faible débit.',
 meshInfo2: 'Le réseau maillé permet à chaque noeud de relayer les messages.',
 meshInfo3: 'Ce tableau de bord simule un noeud LoRa mesh sur Raspberry Pi.',
 meshStarted: '🔗 Noeud mesh démarré', meshStopped: '🔴 Noeud mesh arrêté', msgSent: '📨 Message envoyé',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Mesh Node. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 title: 'عقدة شبكة Pi', subtitle: '🔗 شبكة · 📨 رسالة · 🌐 اتصال',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم الشبكة المعشقة', mainDesc: 'عقدة رسائل LoRa mesh للاتصال بدون شبكة',
 sectionA: 'خريطة العقد', sectionB: 'وحدة الرسائل', sectionC: 'حول شبكة LoRa',
 nodesLabel: 'العقد', msgsLabel: 'الرسائل', rssiLabel: 'RSSI', snrLabel: 'SNR',
 sendBtn: 'إرسال', startMeshBtn: 'تشغيل Mesh', stopMeshBtn: 'إيقاف Mesh',
 channelLabel: 'القناة:', sfLabel: 'SF:',
 meshInfo1: 'LoRa تتيح اتصالاً بمدى بعيد جداً (حتى 15 كم) بمعدلات بيانات منخفضة.',
 meshInfo2: 'الشبكة المعشقة تسمح لكل عقدة بترحيل الرسائل.',
 meshInfo3: 'هذه اللوحة تحاكي عقدة LoRa mesh على Raspberry Pi.',
 meshStarted: '🔗 بدأت عقدة الشبكة', meshStopped: '🔴 توقفت عقدة الشبكة', msgSent: '📨 تم إرسال الرسالة',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Mesh Node. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
...
/* ═══════ MESH NODE SIMULATION ═══════ */
let meshRunning=false, meshInterval=null, meshMsgCount=0;
const MESH_NODES=[
 {id:'NODE-A1',name:'Base Camp',x:0.2,y:0.3,hops:0},
 {id:'NODE-B2',name:'Relay Hill',x:0.5,y:0.15,hops:1},
 {id:'NODE-C3',name:'Valley Post',x:0.8,y:0.4,hops:2},
 {id:'NODE-D4',name:'River Watch',x:0.35,y:0.7,hops:1},
 {id:'NODE-E5',name:'Summit',x:0.65,y:0.8,hops:3},
 {id:'NODE-F6',name:'Field Op',x:0.15,y:0.55,hops:1},
];
const MESH_LINKS=[[0,1],[1,2],[0,3],[3,4],[0,5],[1,4]];
const FAKE_MSGS=['Hello from base','All clear at relay','Weather update: clear skies','Check in please','Copy that, over','Emergency supplies needed','Route B blocked, use alternate','Signal strong from summit'];

function initMeshSim(){
 const toggleBtn=$('meshToggleBtn'), sendBtn=$('sendMsgBtn');
 if(toggleBtn) toggleBtn.onclick=toggleMesh;
 if(sendBtn) sendBtn.onclick=sendMeshMsg;
}
function toggleMesh(){
 const s=LANG[currentLang], btn=$('meshToggleBtn');
 if(meshRunning){
 meshRunning=false; if(meshInterval){clearInterval(meshInterval);meshInterval=null;}
 if(btn) btn.textContent=s.startMeshBtn;
 setStatus(false); log(s.meshStopped,'error');
 } else {
 meshRunning=true;
 if(btn) btn.textContent=s.stopMeshBtn;
 setStatus(true); log(s.meshStarted,'success'); playSound('success');
 drawMeshMap(); updateMeshStats();
 meshInterval=setInterval(meshTick,3000);
 }
}
function meshTick(){
 if(!meshRunning) return;
 // Simulate incoming message
 const from=MESH_NODES[Math.floor(Math.random()*MESH_NODES.length)];
 const msg=FAKE_MSGS[Math.floor(Math.random()*FAKE_MSGS.length)];
 meshMsgCount++;
 const el=$('meshMessages');
 if(el){
 const t=new Date().toLocaleTimeString();
 el.innerHTML+=`<div>[${t}] <span style="color:#ff0">${from.id}</span> (${from.name}): ${msg}</div>`;
...
function sendMeshMsg(){
 ...
 const s=LANG[currentLang]; meshMsgCount++;
 const el=$('meshMessages');
 if(el){
 const t=new Date().toLocaleTimeString();
 el.innerHTML+=`<div style="color:#0ff">[${t}] YOU: ${inp.value.trim()}</div>`;
 el.scrollTop=el.scrollHeight;
 }
 log(`${s.msgSent}: ${inp.value.trim()}`,'tx');
 inp.value=''; playSound('success'); updateMeshStats();
}
function drawMeshMap(){
 const c=$('meshCanvas'); if(!c) return;
 const ctx=c.getContext('2d'), w=c.width, h=c.height;
 ctx.clearRect(0,0,w,h);
 // Draw links
 ctx.strokeStyle='rgba(0,255,128,0.3)'; ctx.lineWidth=2;
 MESH_LINKS.forEach(([a,b])=>{
 ctx.beginPath();
 ctx.moveTo(MESH_NODES[a].x*w,MESH_NODES[a].y*h);
 ctx.lineTo(MESH_NODES[b].x*w,MESH_NODES[b].y*h);
 ctx.stroke();
 });
 // Draw nodes
 MESH_NODES.forEach((n,i)=>{
 const x=n.x*w, y=n.y*h;
 ctx.beginPath(); ctx.arc(x,y,8+Math.sin(Date.now()/500+i)*2,0,Math.PI*2);
 ctx.fillStyle=i===0?'#0ff':'#0f0'; ctx.fill();
 ctx.strokeStyle='#fff'; ctx.lineWidth=1; ctx.stroke();
 ctx.fillStyle='#fff'; ctx.font='11px Orbitron,monospace'; ctx.textAlign='center';
 ctx.fillText(n.id,x,y-14);
 ctx.font='9px Tajawal,sans-serif'; ctx.fillStyle='rgba(255,255,255,0.6)';
 ctx.fillText(n.name,x,y+22);
 });
}
function updateMeshStats(){
 const nv=$('nodesVal'),mv=$('msgsVal'),rv=$('rssiVal'),sv=$('snrMeshVal');
 if(nv) nv.textContent=MESH_NODES.length;
 if(mv) mv.textContent=meshMsgCount;
 if(rv) rv.textContent=(-40-Math.random()*50).toFixed(0)+' dBm';
 if(sv) sv.textContent=(5+Math.random()*15).toFixed(1)+' dB';
}
