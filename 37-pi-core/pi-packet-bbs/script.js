...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-C51EC9',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Packet BBS \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Packet BBS', subtitle: '📟 packet · 📋 bulletin · 📡 ax25',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'BBS Console', mainDesc: 'AX.25 packet radio bulletin board system',
 sectionA: 'Message Board', sectionB: 'Station Directory', sectionC: 'About AX.25 Protocol',
 stationsLabel: 'Stations', bulletinsLabel: 'Bulletins', packetsLabel: 'Packets', portLabel: 'TNC Port',
 connectBtn: 'Connect', postBtn: 'Post Bulletin',
 ax25Info1: 'AX.25 is a data link layer protocol for amateur packet radio at 1200 baud.',
 ax25Info2: 'Packet BBS systems have been the backbone of amateur radio digital communication since the 1980s.',
 ax25Info3: 'This dashboard simulates a packet BBS on Raspberry Pi with a TNC.',
 bbsConnected: '📟 BBS connected', bbsDisconnected: '🔴 BBS disconnected',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Packet Bbs simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Message Board" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-C51EC9',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Packet BBS \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'BBS Packet Pi', subtitle: '📟 paquet · 📋 bulletin · 📡 ax25',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Console BBS', mainDesc: 'Système de tableau d\'affichage radio paquet AX.25',
 sectionA: 'Tableau de messages', sectionB: 'Annuaire des stations', sectionC: 'À propos du protocole AX.25',
 stationsLabel: 'Stations', bulletinsLabel: 'Bulletins', packetsLabel: 'Paquets', portLabel: 'Port TNC',
 connectBtn: 'Connecter', postBtn: 'Publier bulletin',
 ax25Info1: 'AX.25 est un protocole de liaison de données pour la radio amateur à 1200 bauds.',
 ax25Info2: 'Les systèmes BBS packet sont l\'épine dorsale de la communication numérique amateur depuis les années 1980.',
 ax25Info3: 'Ce tableau de bord simule un BBS packet sur Raspberry Pi avec un TNC.',
 bbsConnected: '📟 BBS connecté', bbsDisconnected: '🔴 BBS déconnecté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Packet Bbs. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 title: 'لوحة إعلانات Pi', subtitle: '📟 حزمة · 📋 نشرة · 📡 ax25',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'وحدة تحكم BBS', mainDesc: 'نظام لوحة إعلانات راديو الحزم AX.25',
 sectionA: 'لوحة الرسائل', sectionB: 'دليل المحطات', sectionC: 'حول بروتوكول AX.25',
 stationsLabel: 'المحطات', bulletinsLabel: 'النشرات', packetsLabel: 'الحزم', portLabel: 'منفذ TNC',
 connectBtn: 'اتصال', postBtn: 'نشر نشرة',
 ax25Info1: 'AX.25 هو بروتوكول طبقة ربط البيانات لراديو الحزم الهواة بمعدل 1200 بود.',
 ax25Info2: 'أنظمة BBS كانت العمود الفقري للاتصال الرقمي الهواة منذ الثمانينات.',
 ax25Info3: 'هذه اللوحة تحاكي نظام BBS على Raspberry Pi مع TNC.',
 bbsConnected: '📟 BBS متصل', bbsDisconnected: '🔴 BBS غير متصل',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Packet Bbs. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
...
/* ═══════ PACKET BBS SIMULATION ═══════ */
let bbsRunning=false, bbsInterval=null, bbsPackets=0;
const BBS_STATIONS=[
 {call:'VE3ABC',name:'Ottawa BBS',last:'2 min ago'},
 {call:'W1XYZ',name:'Boston Node',last:'5 min ago'},
 {call:'KF7IJK',name:'Portland Relay',last:'12 min ago'},
 {call:'DL1ABC',name:'Berlin Packet',last:'30 min ago'},
 {call:'JA1XYZ',name:'Tokyo BBS',last:'1 hour ago'},
];
const BBS_MSGS=[
 {from:'VE3ABC',subj:'Weekly Net Schedule',date:'2026-03-18',body:'Net meets every Sunday 2000Z on 145.050'},
 {from:'W1XYZ',subj:'Antenna Party This Weekend',date:'2026-03-17',body:'All welcome to help raise the new tower'},
 {from:'KF7IJK',subj:'New Digi Installed',date:'2026-03-16',body:'New digipeater on 144.390 covering the valley'},
 {from:'DL1ABC',subj:'Contest Results',date:'2026-03-15',body:'Congratulations to all participants in the spring sprint'},
 {from:'JA1XYZ',subj:'Propagation Report',date:'2026-03-14',body:'10m opening expected this weekend, conditions improving'},
];
const BBS_TERM_LINES=['*** Welcome to Pi Packet BBS ***','AX.25 TNC initialized on /dev/ttyUSB0','Baud rate: 1200','Frequency: 145.010 MHz','Monitoring for incoming connections...','','Type HELP for commands','Type LIST for message list','Type READ <n> for message details'];

function initBBSSim(){
 const cb=$('bbsConnectBtn'), pb=$('bbsPostBtn');
 if(cb) cb.onclick=toggleBBS;
 if(pb) pb.onclick=()=>{if(bbsRunning){bbsPackets+=3;log('📟 Bulletin posted','tx');playSound('success');const pv=$('packetsVal');if(pv)pv.textContent=bbsPackets;}};
 populateBBSBoard(); populateBBSStations();
}
function toggleBBS(){
 const s=LANG[currentLang];
 if(bbsRunning){
 bbsRunning=false; if(bbsInterval){clearInterval(bbsInterval);bbsInterval=null;}
 setStatus(false); log(s.bbsDisconnected,'error');
 const pv=$('portVal'); if(pv) pv.textContent='OFF';
 } else {
 bbsRunning=true; setStatus(true); log(s.bbsConnected,'success'); playSound('success');
 const pv=$('portVal'); if(pv) pv.textContent='ON';
 const term=$('bbsTerminal'); if(term) term.textContent='';
 let i=0;
 bbsInterval=setInterval(()=>{
 if(i<BBS_TERM_LINES.length){
 const t=$('bbsTerminal'); if(t){t.textContent+=BBS_TERM_LINES[i]+'\n';t.scrollTop=t.scrollHeight;}
 i++;
 } else {
 bbsPackets++;
 const from=BBS_STATIONS[Math.floor(Math.random()*BBS_STATIONS.length)];
 const t=$('bbsTerminal');
 if(t){t.textContent+=`[RX] ${from.call} > BEACON\n`;t.scrollTop=t.scrollHeight;}
 log(`📟 Packet from ${from.call}`,'rx');
 }
 const sv=$('stationsVal'); if(sv) sv.textContent=BBS_STATIONS.length;
 const bv=$('bulletinsVal'); if(bv) bv.textContent=BBS_MSGS.length;
 const pkv=$('packetsVal'); if(pkv) pkv.textContent=bbsPackets;
 },1500);
 }
}
function populateBBSBoard(){
 const el=$('bbsBoard'); if(!el) return;
 el.innerHTML=BBS_MSGS.map((m,i)=>`<div style="padding:.4rem;border-bottom:1px solid var(--border)"><strong>#${i+1}</strong> [${m.from}] <strong>${m.subj}</strong> <span style="opacity:.6;font-size:.7rem">${m.date}</span><br><span style="opacity:.8;font-size:.75rem">${m.body}</span></div>`).join('');
}
function populateBBSStations(){
 const el=$('bbsStations'); if(!el) return;
 el.innerHTML=BBS_STATIONS.map(s=>`<div style="padding:.4rem;border-bottom:1px solid var(--border);display:flex;justify-content:space-between"><span><strong style="font-family:monospace">${s.call}</strong> — ${s.name}</span><span style="opacity:.6;font-size:.75rem">${s.last}</span></div>`).join('');
}
