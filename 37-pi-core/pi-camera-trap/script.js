...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-F8D414',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Camera Trap \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Camera Trap', subtitle: '📷 capture · 🌙 night · 🦊 detect',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Camera Trap Dashboard', mainDesc: 'Motion-triggered camera with IR night vision',
 sectionA: 'Live Feed', sectionB: 'Capture Gallery', sectionC: 'About Camera Traps',
 camInfo1: 'Camera traps use PIR sensors to detect motion, triggering automatic photo capture.',
 camInfo2: 'A Pi with NoIR camera and IR LEDs creates a powerful day/night camera trap.',
 camInfo3: 'This dashboard simulates a field-deployed camera trap with motion detection.',
 camArmed: '📷 Camera armed', camDisarmed: '🔴 Camera disarmed', motionDetected: '🦊 Motion detected!',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Camera Trap simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Live Feed" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-F8D414',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Camera Trap \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Piège caméra Pi', subtitle: '📷 capturer · 🌙 nuit · 🦊 détecter',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord piège caméra', mainDesc: 'Caméra déclenchée par mouvement avec vision nocturne IR',
 sectionA: 'Flux en direct', sectionB: 'Galerie de captures', sectionC: 'À propos des pièges caméra',
 camInfo1: 'Les pièges caméra utilisent des capteurs PIR pour détecter le mouvement.',
 camInfo2: 'Un Pi avec caméra NoIR et LED IR crée un piège caméra jour/nuit puissant.',
 camInfo3: 'Ce tableau de bord simule un piège caméra déployé sur le terrain.',
 camArmed: '📷 Caméra armée', camDisarmed: '🔴 Caméra désarmée', motionDetected: '🦊 Mouvement détecté !',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Camera Trap. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Camera Trap démontre les principes clés de cybersécurité. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'فخ كاميرا Pi', subtitle: '📷 التقاط · 🌙 ليل · 🦊 كشف',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم فخ الكاميرا', mainDesc: 'كاميرا تعمل بالحركة مع رؤية ليلية بالأشعة تحت الحمراء',
 sectionA: 'البث المباشر', sectionB: 'معرض الصور', sectionC: 'حول فخاخ الكاميرا',
 camInfo1: 'فخاخ الكاميرا تستخدم مستشعرات PIR لكشف الحركة والتقاط الصور تلقائياً.',
 camInfo2: 'Pi مع كاميرا NoIR ومصابيح IR يصنع فخ كاميرا قوي للنهار والليل.',
 camInfo3: 'هذه اللوحة تحاكي فخ كاميرا منشور في الميدان مع كشف الحركة.',
 camArmed: '📷 تم تسليح الكاميرا', camDisarmed: '🔴 تم نزع سلاح الكاميرا', motionDetected: '🦊 تم كشف حركة!',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Camera Trap. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Camera Trap يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
let camArmed=false, camInterval=null, captures=0, battery=100;
const ANIMALS=['Fox','Deer','Rabbit','Raccoon','Owl','Coyote','Squirrel','Bird'];

function initCamSim(){
 const armBtn=$('camArmBtn'), snapBtn=$('camSnapBtn');
 if(armBtn) armBtn.onclick=toggleCam;
 if(snapBtn) snapBtn.onclick=()=>{captures++;updateCamStats();addCapture();log('📷 Manual snapshot','tx');playSound('click');};
 drawCamFeed(); setInterval(drawCamFeed,200);
}
function toggleCam(){
 const s=LANG[currentLang];
 if(camArmed){
 camArmed=false; if(camInterval){clearInterval(camInterval);camInterval=null;}
 setStatus(false); log(s.camDisarmed,'error');
 } else {
 camArmed=true; setStatus(true); log(s.camArmed,'success'); playSound('success');
 camInterval=setInterval(()=>{
 if(Math.random()>0.6){
 captures++; battery=Math.max(5,battery-0.5);
 const animal=ANIMALS[Math.floor(Math.random()*ANIMALS.length)];
 log(`${LANG[currentLang].motionDetected} ${animal}`,'success');
 const mv=$('motionVal'); if(mv){mv.textContent='YES';mv.style.color='#f00';setTimeout(()=>{mv.textContent='--';mv.style.color='';},2000);}
 addCapture(animal); updateCamStats(); playSound('success');
 }
 },4000);
 }
}
function drawCamFeed(){
 const c=$('camCanvas'); if(!c) return;
 const ctx=c.getContext('2d'), w=c.width, h=c.height;
 // Simulate camera feed noise
 const imgData=ctx.createImageData(w,h);
 const isNight=new Date().getHours()>=19||new Date().getHours()<6;
 for(let i=0;i<imgData.data.length;i+=4){
 const noise=Math.random()*30;
 if(isNight){imgData.data[i]=noise*0.5;imgData.data[i+1]=noise;imgData.data[i+2]=noise*0.5;}
 else{imgData.data[i]=40+noise;imgData.data[i+1]=60+noise;imgData.data[i+2]=30+noise;}
 imgData.data[i+3]=255;
 }
 ctx.putImageData(imgData,0,0);
 ctx.fillStyle='rgba(255,255,255,0.7)'; ctx.font='12px Orbitron,monospace';
 ctx.fillText(new Date().toLocaleTimeString(),10,20);
 ctx.fillText(camArmed?'[ARMED]':'[STANDBY]',w-120,20);
 if(isNight) ctx.fillText('[IR MODE]',10,h-10);
}
function addCapture(animal){
 const g=$('camGallery'); if(!g) return;
 const d=document.createElement('div');
 d.style.cssText='background:#1a1a2e;border-radius:6px;padding:.4rem;text-align:center;font-size:.7rem';
 d.innerHTML=`<div style="height:60px;background:#111;border-radius:4px;display:flex;align-items:center;justify-content:center;font-size:1.5rem">${animal?'🦊':'📷'}</div><div style="margin-top:.2rem">${animal||'Manual'}<br><span style="opacity:.6">${new Date().toLocaleTimeString()}</span></div>`;
 g.insertBefore(d,g.firstChild);
}
function updateCamStats(){
 const cv=$('capturesVal'),bv=$('batteryVal');
 if(cv) cv.textContent=captures;
 if(bv){bv.textContent=battery.toFixed(0)+'%';bv.style.color=battery<20?'#f00':'';}
}
