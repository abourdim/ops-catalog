...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-84F1F9',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Tor Router \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Tor Router', subtitle: '🧅 anonymize · 🔒 encrypt · 🌐 route',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Tor Router Dashboard', mainDesc: 'Transparent Tor proxy for network anonymization',
 sectionA: 'Circuit Monitor', sectionB: 'Traffic Stats', sectionC: 'About Tor Network',
 torInfo1: 'Tor anonymizes traffic by routing through encrypted relay nodes.',
 torInfo2: 'A Pi Tor Router acts as a transparent proxy for all connected devices.',
 torInfo3: 'This dashboard simulates a Tor router with circuits and bandwidth monitoring.',
 torStarted: '🧅 Tor connected', torStopped: '🔴 Tor disconnected',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Tor Router simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Circuit Monitor" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-84F1F9',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Tor Router \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Routeur Tor Pi', subtitle: '🧅 anonymiser · 🔒 chiffrer · 🌐 router',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord routeur Tor', mainDesc: 'Proxy Tor transparent pour l\'anonymisation réseau',
 sectionA: 'Moniteur de circuits', sectionB: 'Statistiques de trafic', sectionC: 'À propos du réseau Tor',
 torInfo1: 'Tor anonymise le trafic en le routant à travers des noeuds relais chiffrés.',
 torInfo2: 'Un routeur Tor Pi agit comme proxy transparent pour tous les appareils connectés.',
 torInfo3: 'Ce tableau de bord simule un routeur Tor avec circuits et surveillance de bande passante.',
 torStarted: '🧅 Tor connecté', torStopped: '🔴 Tor déconnecté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Tor Router. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 title: 'موجه Tor على Pi', subtitle: '🧅 إخفاء · 🔒 تشفير · 🌐 توجيه',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم موجه Tor', mainDesc: 'وكيل Tor شفاف لإخفاء هوية الشبكة',
 sectionA: 'مراقب الدوائر', sectionB: 'إحصائيات حركة المرور', sectionC: 'حول شبكة Tor',
 torInfo1: 'Tor يخفي هوية حركة المرور عبر توجيهها عبر عقد ترحيل مشفرة.',
 torInfo2: 'موجه Tor على Pi يعمل كوكيل شفاف لجميع الأجهزة المتصلة.',
 torInfo3: 'هذه اللوحة تحاكي موجه Tor مع الدوائر ومراقبة عرض النطاق.',
 torStarted: '🧅 تم الاتصال بـ Tor', torStopped: '🔴 تم قطع اتصال Tor',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Tor Router. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
...
/* ═══════ TOR ROUTER SIMULATION ═══════ */
let torRunning=false, torInterval=null, torCtx=null;
const COUNTRIES=['DE','NL','SE','CH','RO','IS','FI','NO','CZ','LU'];
const RELAYS=['Guard1-Berlin','Middle1-Amsterdam','Exit1-Stockholm','Guard2-Zurich','Middle2-Bucharest'];

function initTorSim(){
 const btn=$('torToggle'), nc=$('newCircuit');
 if(btn) btn.onclick=toggleTor;
 if(nc) nc.onclick=()=>{if(torRunning){buildCircuit();log('🧅 New circuit built','success');playSound('click');}};
 const c=$('torCanvas'); if(c) torCtx=c.getContext('2d');
}
function toggleTor(){
 if(torRunning){
 torRunning=false; if(torInterval){clearInterval(torInterval);torInterval=null;}
 setStatus(false); log(LANG[currentLang].torStopped,'error');
 const ts=$('torStatus'); if(ts){ts.textContent='OFF';ts.style.color='';}
 } else {
 torRunning=true; setStatus(true); log(LANG[currentLang].torStarted,'success'); playSound('success');
 const ts=$('torStatus'); if(ts){ts.textContent='ON';ts.style.color='#0f0';}
 buildCircuit();
 torInterval=setInterval(torTick,1000);
 }
}
function buildCircuit(){
 const guard=RELAYS[Math.floor(Math.random()*2)];
 const middle=RELAYS[2+Math.floor(Math.random()*2)];
 const exit=COUNTRIES[Math.floor(Math.random()*COUNTRIES.length)];
 const ev=$('exitVal'); if(ev) ev.textContent=exit;
 const cv=$('circuitsVal'); if(cv) cv.textContent=parseInt(cv.textContent||0)+1;
 const tc=$('torCircuits'); if(tc){
 tc.innerHTML+=`<div style="padding:.3rem;border-bottom:1px solid var(--border)">🔒 You → <span style="color:#0f0">${guard}</span> → <span style="color:#ff0">${middle}</span> → <span style="color:#f80">Exit (${exit})</span> → Internet</div>`;
 tc.scrollTop=tc.scrollHeight;
 }
}
function torTick(){
 if(!torRunning) return;
 const bw=(50+Math.random()*200).toFixed(0);
 const bv=$('bwVal'); if(bv) bv.textContent=bw+' KB/s';
 if(torCtx){
 const c=$('torCanvas'), w=c.width, h=c.height;
 torCtx.fillStyle='rgba(0,0,0,0.1)'; torCtx.fillRect(0,0,w,h);
 const imgData=torCtx.getImageData(1,0,w-1,h);
 torCtx.putImageData(imgData,0,0);
 const y=h-(parseInt(bw)/250)*h;
 torCtx.fillStyle='#9b59b6'; torCtx.fillRect(w-2,y,2,h-y);
 }
}
