...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-2491B9',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi SDR Station \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi SDR Station', subtitle: '📡 receive · 🔊 demodulate · 📊 analyze',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'SDR Dashboard', mainDesc: 'Dedicated SDR receiver server on Raspberry Pi',
 sectionA: 'Waterfall Display', sectionB: 'Signal Demodulator', sectionC: 'About SDR Technology',
 cpuLabel: 'CPU', ramLabel: 'RAM', tempLabel: 'Temp', uptimeLabel: 'Uptime',
 freqLabel: 'Frequency (MHz):', tuneBtn: 'Tune', startBtn: 'Start SDR', stopBtn: 'Stop SDR',
 gainLabel: 'Gain:', srLabel: 'Sample Rate:', waterfallTitle: 'Waterfall',
 demodLabel: 'Audio Output:',
 sdrInfo1: 'Software-Defined Radio (SDR) replaces traditional hardware components with software running on a general-purpose processor.',
 sdrInfo2: 'An RTL-SDR dongle connected to a Raspberry Pi can receive signals from 24 MHz to 1.766 GHz, covering FM radio, aircraft ADS-B, marine AIS, amateur radio, weather satellites, and more.',
 sdrInfo3: 'This dashboard simulates a dedicated SDR server running rtl_tcp, providing remote access to the SDR hardware over the network.',
 sdrStarted: '📡 SDR receiver started', sdrStopped: '🔴 SDR receiver stopped',
 tuned: '📡 Tuned to', mhz: 'MHz',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Sdr Station simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Waterfall Display" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-2491B9',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi SDR Station \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Station SDR Pi', subtitle: '📡 recevoir · 🔊 démoduler · 📊 analyser',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord SDR', mainDesc: 'Serveur récepteur SDR dédié sur Raspberry Pi',
 sectionA: 'Affichage en cascade', sectionB: 'Démodulateur de signal', sectionC: 'À propos de la technologie SDR',
 cpuLabel: 'CPU', ramLabel: 'RAM', tempLabel: 'Temp', uptimeLabel: 'Uptime',
 freqLabel: 'Fréquence (MHz) :', tuneBtn: 'Syntoniser', startBtn: 'Démarrer SDR', stopBtn: 'Arrêter SDR',
 gainLabel: 'Gain :', srLabel: 'Débit :', waterfallTitle: 'Cascade',
 demodLabel: 'Sortie audio :',
 sdrInfo1: 'La radio logicielle (SDR) remplace les composants matériels traditionnels par un logiciel sur un processeur général.',
 sdrInfo2: 'Un dongle RTL-SDR connecté à un Raspberry Pi peut recevoir des signaux de 24 MHz à 1,766 GHz.',
 sdrInfo3: 'Ce tableau de bord simule un serveur SDR dédié exécutant rtl_tcp, fournissant un accès distant au matériel SDR.',
 sdrStarted: '📡 Récepteur SDR démarré', sdrStopped: '🔴 Récepteur SDR arrêté',
 tuned: '📡 Syntonisé sur', mhz: 'MHz',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Sdr Station. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Sdr Station démontre les principes clés de cybersécurité. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'محطة SDR على Pi', subtitle: '📡 استقبال · 🔊 فك تعديل · 📊 تحليل',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم SDR', mainDesc: 'خادم استقبال SDR مخصص على Raspberry Pi',
 sectionA: 'عرض الشلال', sectionB: 'مزيل تعديل الإشارة', sectionC: 'حول تقنية SDR',
 cpuLabel: 'المعالج', ramLabel: 'الذاكرة', tempLabel: 'الحرارة', uptimeLabel: 'وقت التشغيل',
 freqLabel: 'التردد (ميغاهرتز):', tuneBtn: 'ضبط', startBtn: 'تشغيل SDR', stopBtn: 'إيقاف SDR',
 gainLabel: 'الكسب:', srLabel: 'معدل العينات:', waterfallTitle: 'الشلال',
 demodLabel: 'مخرج الصوت:',
 sdrInfo1: 'الراديو المعرّف بالبرمجيات (SDR) يستبدل المكونات التقليدية ببرنامج يعمل على معالج عام.',
 sdrInfo2: 'دونجل RTL-SDR متصل بـ Raspberry Pi يمكنه استقبال إشارات من 24 ميغاهرتز إلى 1.766 غيغاهرتز.',
 sdrInfo3: 'هذه اللوحة تحاكي خادم SDR مخصص يشغل rtl_tcp، يوفر الوصول عن بعد لأجهزة SDR عبر الشبكة.',
 sdrStarted: '📡 بدأ مستقبل SDR', sdrStopped: '🔴 توقف مستقبل SDR',
 tuned: '📡 تم الضبط على', mhz: 'ميغاهرتز',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Sdr Station. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Sdr Station يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ SDR SIMULATION ENGINE ═══════ */

let sdrRunning = false;
let sdrInterval = null;
let uptimeSeconds = 0;
let waterfallCtx, fftCtx;
let waterfallData = [];
...
function initSDRSim() {
 ...
 if (wfCanvas) waterfallCtx = wfCanvas.getContext('2d');
 if (fftCanvas) fftCtx = fftCanvas.getContext('2d');

 if (startBtn) startBtn.onclick = toggleSDR;
 if (tuneBtn) tuneBtn.onclick = () => {
 const f = parseFloat($('freqInput')?.value || 100);
 const s = LANG[currentLang];
 log(`${s.tuned} ${f.toFixed(1)} ${s.mhz}`, 'success');
 updateFreqLabels(f);
 playSound('click');
 };
 if (gainSlider) gainSlider.oninput = () => {
 const v = gainSlider.value;
 const gv = $('gainVal');
 if (gv) gv.textContent = v + ' dB';
 };

 // Start Pi stats simulation
...
function toggleSDR() {
 ...
 if (sdrRunning) {
 sdrRunning = false;
 if (sdrInterval) { clearInterval(sdrInterval); sdrInterval = null; }
 if (btn) btn.textContent = s.startBtn;
 setStatus(false);
 log(s.sdrStopped, 'error');
 playSound('error');
 } else {
 sdrRunning = true;
 if (btn) btn.textContent = s.stopBtn;
 setStatus(true);
 log(s.sdrStarted, 'success');
 playSound('success');
 sdrInterval = setInterval(sdrTick, 80);
 sdrTick();
 }
}
...
function sdrTick() {
 ...
 ut.textContent = String(m).padStart(2,'0') + ':' + String(sec).padStart(2,'0');
 }
}

function drawWaterfall() {
 if (!waterfallCtx) return;
 const c = $('waterfallCanvas');
 const w = c.width, h = c.height;
 // Shift existing image down
 const imgData = waterfallCtx.getImageData(0, 0, w, h - 1);
 waterfallCtx.putImageData(imgData, 0, 1);
 // Draw new line at top
 const gain = parseInt($('gainSlider')?.value || 25);
 for (let x = 0; x < w; x++) {
 const v = Math.random() * 0.3 + Math.sin(x * 0.05 + uptimeSeconds) * 0.15 + (gain / 100);
 const n = Math.min(1, Math.max(0, v));
 const r = Math.floor(n * 255);
 const g = Math.floor(n * 128);
 const b = Math.floor((1 - n) * 255);
 waterfallCtx.fillStyle = `rgb(${r},${g},${b})`;
 waterfallCtx.fillRect(x, 0, 1, 1);
 }
}
...
function drawFFT() {
 ...
 const c = $('fftCanvas');
 const w = c.width, h = c.height;
 fftCtx.fillStyle = 'rgba(0,0,0,0.3)';
 ...
 const signal = Math.sin(x * 0.02 + uptimeSeconds * 2) * 30 * (gain / 50);
 const peak = (x > w * 0.45 && x < w * 0.55) ? 40 + Math.random() * 20 : 0;
 const y = h - 20 - noise - Math.abs(signal) - peak;
...
function updateAudioMeter() {
 ...
 bar.style.width = v + '%';
 if (lvl) lvl.textContent = (-60 + v * 0.8).toFixed(0) + ' dB';
}

function updateSignalLevel() {
 const el = $('signalLevel');
 if (el) el.textContent = 'SNR: ' + (5 + Math.random() * 25).toFixed(1) + ' dB';
}

function updatePiStats() {
 const cpu = $('cpuVal'), ram = $('ramVal'), temp = $('tempVal');
 if (cpu) cpu.textContent = (15 + Math.random() * (sdrRunning ? 60 : 20)).toFixed(0) + '%';
 if (ram) ram.textContent = (35 + Math.random() * 25).toFixed(0) + '%';
 if (temp) temp.textContent = (42 + Math.random() * 15).toFixed(0) + '°C';
}

function updateFreqLabels(f) {
 const sr = parseFloat($('sampleRate')?.value || 2.048);
 const min = $('wfMinFreq'), max = $('wfMaxFreq');
 if (min) min.textContent = (f - sr / 2).toFixed(1) + ' MHz';
 if (max) max.textContent = (f + sr / 2).toFixed(1) + ' MHz';
}
