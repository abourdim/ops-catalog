...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-349C03',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Radio Recorder \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Radio Recorder', subtitle: '🎙️ record · 📻 scan · 💾 archive',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Recording Dashboard', mainDesc: '24/7 spectrum recording and archiving station',
 sectionA: 'Spectrum Monitor', sectionB: 'Recording Archive', sectionC: 'About Spectrum Recording',
 diskLabel: 'Disk Used', filesLabel: 'Files', recTimeLabel: 'Rec Time', rateLabel: 'Data Rate',
 freqLabel: 'Center Freq (MHz):', recStartBtn: 'Record', recStopBtn: 'Stop',
 recInfo1: 'Spectrum recording captures raw radio frequency data to disk for later analysis.',
 recInfo2: 'A Raspberry Pi with an RTL-SDR can record IQ data continuously.',
 recInfo3: 'This dashboard simulates a 24/7 recording station with disk monitoring and archive.',
 recStarted: '🎙️ Recording started', recStopped: '🔴 Recording stopped',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Radio Recorder simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Spectrum Monitor" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-349C03',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Radio Recorder \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Enregistreur radio Pi', subtitle: '🎙️ enregistrer · 📻 scanner · 💾 archiver',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord d\'enregistrement', mainDesc: 'Station d\'enregistrement du spectre 24h/24',
 sectionA: 'Moniteur de spectre', sectionB: 'Archive des enregistrements', sectionC: 'À propos de l\'enregistrement du spectre',
 diskLabel: 'Disque', filesLabel: 'Fichiers', recTimeLabel: 'Durée', rateLabel: 'Débit',
 freqLabel: 'Fréq. centrale (MHz) :', recStartBtn: 'Enregistrer', recStopBtn: 'Arrêter',
 recInfo1: 'L\'enregistrement du spectre capture les données RF pour analyse ultérieure.',
 recInfo2: 'Un Raspberry Pi avec RTL-SDR peut enregistrer en continu.',
 recInfo3: 'Ce tableau de bord simule une station d\'enregistrement 24h/24.',
 recStarted: '🎙️ Enregistrement démarré', recStopped: '🔴 Enregistrement arrêté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Radio Recorder. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 title: 'مسجل الراديو Pi', subtitle: '🎙️ تسجيل · 📻 مسح · 💾 أرشفة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة التسجيل', mainDesc: 'محطة تسجيل وأرشفة الطيف على مدار الساعة',
 sectionA: 'مراقب الطيف', sectionB: 'أرشيف التسجيلات', sectionC: 'حول تسجيل الطيف',
 diskLabel: 'القرص', filesLabel: 'الملفات', recTimeLabel: 'مدة التسجيل', rateLabel: 'معدل البيانات',
 freqLabel: 'التردد المركزي (ميغاهرتز):', recStartBtn: 'تسجيل', recStopBtn: 'إيقاف',
 recInfo1: 'تسجيل الطيف يلتقط بيانات التردد الراديوي الخام للتحليل لاحقًا.',
 recInfo2: 'Raspberry Pi مع RTL-SDR يمكنه التسجيل بشكل مستمر.',
 recInfo3: 'هذه اللوحة تحاكي محطة تسجيل على مدار الساعة مع مراقبة القرص والأرشيف.',
 recStarted: '🎙️ بدأ التسجيل', recStopped: '🔴 توقف التسجيل',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Radio Recorder. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
...
/* ═══════ RADIO RECORDER SIMULATION ═══════ */
let recRunning=false, recInterval=null, recSeconds=0, recFiles=0, specCtx=null;
const ARCHIVE=[
 {file:'rec_433.0_20260318_0800.raw',freq:'433.0',dur:'1:00:00',size:'3.6 GB'},
 {file:'rec_433.0_20260318_0900.raw',freq:'433.0',dur:'1:00:00',size:'3.6 GB'},
 {file:'rec_145.5_20260317_1400.raw',freq:'145.5',dur:'0:30:00',size:'1.8 GB'},
 {file:'rec_868.0_20260317_2200.raw',freq:'868.0',dur:'2:00:00',size:'7.2 GB'},
 {file:'rec_433.0_20260316_0600.raw',freq:'433.0',dur:'6:00:00',size:'21.6 GB'},
];

function initRecorderSim(){
 const startBtn=$('recStartBtn'), stopBtn=$('recStopBtn');
 if(startBtn) startBtn.onclick=startRec;
 if(stopBtn) stopBtn.onclick=stopRec;
 const c=$('specCanvas'); if(c) specCtx=c.getContext('2d');
 populateArchive();
 setInterval(()=>{if(recRunning) drawSpectrum();},100);
}
function startRec(){
 if(recRunning) return;
 recRunning=true; recSeconds=0; setStatus(true);
 log(LANG[currentLang].recStarted,'success'); playSound('success');
 recInterval=setInterval(()=>{
 recSeconds++;
 const h=Math.floor(recSeconds/3600),m=Math.floor((recSeconds%3600)/60),s=recSeconds%60;
 const rt=$('recTimeVal'); if(rt) rt.textContent=[h,m,s].map(v=>String(v).padStart(2,'0')).join(':');
 const dv=$('diskVal'); if(dv) dv.textContent=(12+recSeconds*0.01).toFixed(1)+'%';
 const rv=$('rateVal'); if(rv) rv.textContent=(0.8+Math.random()*0.4).toFixed(1)+' MB/s';
 if(recSeconds%60===0){recFiles++; const fv=$('filesVal'); if(fv) fv.textContent=ARCHIVE.length+recFiles;}
 },1000);
 const fv=$('filesVal'); if(fv) fv.textContent=ARCHIVE.length;
}
function stopRec(){
 recRunning=false; if(recInterval){clearInterval(recInterval);recInterval=null;}
 setStatus(false); log(LANG[currentLang].recStopped,'error');
}
function drawSpectrum(){
 if(!specCtx) return;
 const c=$('specCanvas'), w=c.width, h=c.height;
 specCtx.fillStyle='rgba(0,0,0,0.15)';
 specCtx.fillRect(0,0,w,h);
 specCtx.strokeStyle='#ff4444'; specCtx.lineWidth=1.5;
 specCtx.beginPath();
 for(let x=0;x<w;x++){
 const noise=Math.random()*15;
 const sig=Math.sin(x*0.03+Date.now()*0.002)*20;
 const peak=(x>w*0.4&&x<w*0.6)?30+Math.random()*15:0;
 const y=h-10-noise-Math.abs(sig)-peak;
 if(x===0) specCtx.moveTo(x,y); else specCtx.lineTo(x,y);
 }
 specCtx.stroke();
}
function populateArchive(){
 const tb=$('archiveBody'); if(!tb) return;
 tb.innerHTML=ARCHIVE.map(a=>`<tr style="border-bottom:1px solid var(--border)"><td style="padding:.3rem;font-family:monospace;font-size:.7rem">${a.file}</td><td style="padding:.3rem">${a.freq} MHz</td><td style="padding:.3rem">${a.dur}</td><td style="padding:.3rem">${a.size}</td></tr>`).join('');
}
