...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-B7BD37',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Print Server \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Print Server', subtitle: '🖨️ print · 📄 queue · 🔧 manage',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Print Server Dashboard', mainDesc: 'Thermal receipt printer output server',
 sectionA: 'Print Queue', sectionB: 'Printer Config', sectionC: 'About Thermal Printing',
 printInfo1: 'Thermal printers use heat on special paper, requiring no ink.',
 printInfo2: 'A Pi print server accepts jobs over the network for thermal output.',
 printInfo3: 'This dashboard simulates a thermal print server with queue management.',
 jobPrinted: '🖨️ Job printed', jobQueued: '📄 Job queued',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Print Server simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Print Queue" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-B7BD37',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Print Server \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Serveur d\'impression Pi', subtitle: '🖨️ imprimer · 📄 file · 🔧 gérer',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord serveur d\'impression', mainDesc: 'Serveur de sortie d\'imprimante thermique',
 sectionA: 'File d\'impression', sectionB: 'Configuration de l\'imprimante', sectionC: 'À propos de l\'impression thermique',
 printInfo1: 'Les imprimantes thermiques utilisent la chaleur sur papier spécial, sans encre.',
 printInfo2: 'Un serveur d\'impression Pi accepte les travaux via le réseau.',
 printInfo3: 'Ce tableau de bord simule un serveur d\'impression thermique.',
 jobPrinted: '🖨️ Travail imprimé', jobQueued: '📄 Travail en file',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Print Server. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Print Server démontre les principes clés de cybersécurité. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'خادم طباعة Pi', subtitle: '🖨️ طباعة · 📄 طابور · 🔧 إدارة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم خادم الطباعة', mainDesc: 'خادم إخراج الطابعة الحرارية',
 sectionA: 'طابور الطباعة', sectionB: 'إعدادات الطابعة', sectionC: 'حول الطباعة الحرارية',
 printInfo1: 'الطابعات الحرارية تستخدم الحرارة على ورق خاص بدون حبر.',
 printInfo2: 'خادم طباعة Pi يقبل المهام عبر الشبكة للطباعة الحرارية.',
 printInfo3: 'هذه اللوحة تحاكي خادم طباعة حراري مع إدارة الطابور.',
 jobPrinted: '🖨️ تمت الطباعة', jobQueued: '📄 تم إضافة المهمة',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Print Server. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 theory: 'Pi Print Server يوضح المبادئ الأساسية في الأمن السيبراني. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
let printJobs=0, printedCount=0, paper=100;
function initPrintSim(){
 const pb=$('printBtn'), tb=$('printTestBtn');
 if(pb) pb.onclick=()=>{const t=$('printText');if(t&&t.value.trim()){addPrintJob(t.value.trim());t.value='';}};
 if(tb) tb.onclick=()=>addPrintJob('=== TEST PAGE === Thermal Printer OK');
 setStatus(true);
}
function addPrintJob(text){
 printJobs++; paper=Math.max(5,paper-2);
 const s=LANG[currentLang];
 log(`${s.jobQueued}: ${text.substring(0,30)}...`,'tx');
 const pq=$('printQueue');
 if(pq){
 const id='JOB-'+String(printJobs).padStart(3,'0');
 pq.innerHTML=`<div style="padding:.3rem;border-bottom:1px solid var(--border);display:flex;justify-content:space-between"><span>${id}: ${text.substring(0,40)}</span><span style="color:#ff0">printing...</span></div>`+pq.innerHTML;
 }
 $('jobsVal').textContent=printJobs; $('paperVal').textContent=paper+'%';
 $('printerStatus').textContent='BUSY'; $('printerStatus').style.color='#f80';
 setTimeout(()=>{
 printedCount++; $('printedVal').textContent=printedCount;
 $('printerStatus').textContent='IDLE'; $('printerStatus').style.color='';
 log(`${s.jobPrinted}`,'success'); playSound('success');
 },1500);
}
