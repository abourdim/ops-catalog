...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-40B472',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi War Room \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi War Room', subtitle: '🖥️ hack · 🔍 analyze · 🛡️ defend',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'War Room Console', mainDesc: 'Portable hacking station with multi-tool dashboard',
 sectionA: 'Network Scanner', sectionB: 'Exploit Toolkit', sectionC: 'About Penetration Testing',
 cpuLabel: 'CPU', ramLabel: 'RAM', tempLabel: 'Temp', hostsLabel: 'Hosts',
 runBtn: 'Run', stopBtn: 'Stop',
 thIP: 'IP', thMAC: 'MAC', thOS: 'OS', thPorts: 'Open Ports', thStatus: 'Status',
 pentestInfo1: 'Penetration testing is the authorized simulation of cyberattacks to evaluate security of systems.',
 pentestInfo2: 'A Pi War Room combines tools like Nmap, Aircrack-ng, and Metasploit on a portable Raspberry Pi.',
 pentestInfo3: 'Always obtain proper authorization before performing any security testing.',
 scanStarted: '🔍 Scan started', scanComplete: '🔍 Scan complete', toolStopped: '🔴 Tool stopped',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi War Room simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Network Scanner" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_debug: 'Common issues when working with cybersecurity: (1) Unexpected results often come from incorrect parameter settings — reset to defaults and change one variable at a time. (2) If the visualization seems frozen, check that the simulation is running (not paused). (3) Noisy or erratic readings usually indicate interference — in real hardware, move away from electronic devices. (4) If calculations seem wrong, verify your units (Hz vs kHz vs MHz). Systematic debugging is a core skill in cybersecurity.',
 wiki_ethics_title: '⚖️ Ethics & Legal Considerations',
 wiki_ethics: 'Cybersecurity carries important ethical and legal responsibilities. Many countries regulate the use of browser and similar equipment. Always obtain proper authorization before testing on systems you do not own. Respect privacy laws and data protection regulations. This simulation is designed for educational purposes — it demonstrates principles without transmitting real signals or accessing real networks. Responsible use of these skills contributes to security for everyone.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-40B472',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi War Room \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Salle de guerre Pi', subtitle: '🖥️ pirater · 🔍 analyser · 🛡️ défendre',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Console de la salle de guerre', mainDesc: 'Station de piratage portable avec tableau de bord multi-outils',
 sectionA: 'Scanneur réseau', sectionB: 'Kit d\'exploitation', sectionC: 'À propos des tests de pénétration',
 cpuLabel: 'CPU', ramLabel: 'RAM', tempLabel: 'Temp', hostsLabel: 'Hôtes',
 runBtn: 'Lancer', stopBtn: 'Arrêter',
 thIP: 'IP', thMAC: 'MAC', thOS: 'OS', thPorts: 'Ports ouverts', thStatus: 'État',
 pentestInfo1: 'Le test de pénétration est la simulation autorisée de cyberattaques pour évaluer la sécurité.',
 pentestInfo2: 'Une salle de guerre Pi combine Nmap, Aircrack-ng et Metasploit sur un Raspberry Pi portable.',
 pentestInfo3: 'Obtenez toujours une autorisation avant d\'effectuer des tests de sécurité.',
 scanStarted: '🔍 Scan démarré', scanComplete: '🔍 Scan terminé', toolStopped: '🔴 Outil arrêté',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi War Room. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 themeChanged: '🎨 Thème →',step1Title:'Connecter le matériel',step1Desc:'Branche les capteurs ou modules radio aux broches GPIO du Raspberry Pi. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Configurer le logiciel',step2Desc:'Installe les bibliothèques et configure le script Python. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Surveiller les données',step3Desc:'Lis les données des capteurs en temps réel et traite-les. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Contrôler et enregistrer',step4Desc:'Déclenche des actions selon les seuils et enregistre les résultats. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que Pi War Room ?',faq_a1:'Pi War Room est une simulation interactive qui démontre les concepts de cybersécurité. Portable hacking station with multi-tool dashboard. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de informatique embarquée. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de informatique embarquée. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut Raspberry Pi. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de informatique embarquée. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans Pi War Room ! Regarde l\'écran principal — c\'est ici que la simulation de informatique embarquée fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de informatique embarquée.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'GPIO Programming',learn1Desc:'How to control electronic pins with Python code. Regarde la simulation pour voir ça en temps réel. La visualisation rend visible l\'invisible.',learn1Tag:'Electronics',learn2Title:'Sensor Integration',learn2Desc:'How to read temperature, light, and motion data. Les contrôles te permettent d\'expérimenter. Chaque changement révèle comment ce principe réagit.',learn2Tag:'Sensors',learn3Title:'Python Scripting',learn3Desc:'How to automate hardware with Python programs. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Programming',learn4Title:'Communication',learn4Desc:'How Raspberry Pi talks to radios and networks. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Networking',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Débutant 🟢',learnLevel:'Niveau :',learnTimeVal:'15 min ⏱',learnTime:'Durée :',learnAgeVal:'10+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Pi War Room ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de cybersécurité — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how Wire up sensors, displays, or radio modules to the Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de informatique embarquée par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',ch1Title:'Balayage de Paramètre',ch1Desc:'Change systématiquement une variable en gardant les autres constantes. Peux-tu trouver la relation entrée-sortie ?',ch2Title:'Cas Limite',ch2Desc:'Pousse un paramètre à sa valeur extrême. Que se passe-t-il ? Le système se comporte-t-il différemment aux limites ?',ch3Title:'Prédis Puis Teste',ch3Desc:'Avant de démarrer, prédis le résultat. Avais-tu raison ? Qu\'as-tu manqué ?',codeTitle:'Code de Démarrage',codeLang:'Python (Raspberry Pi)',codeSnippet:'import subprocess\\nimport json\\nfrom http.server import HTTPServer, SimpleHTTPRequestHandler\\n\\ndef scan_wifi():\\n result = subprocess.run(["iwlist", "wlan0", "scan"], capture_output=True, text=True)\\n networks = []\\n for line in result.stdout.split("\\\\n"):\\n if "ESSID:" in line:\\n networks.append(line.split(\'"\')[1])\\n return networks\\n\\nHTTPServer(("0.0.0.0", 8000), SimpleHTTPRequestHandler).serve_forever()',codeExplain:'Ce script Python tourne sur un Raspberry Pi et crée un serveur web sur le port 8000. L\'endpoint /api/scan déclenche un scan WiFi et retourne la liste des réseaux en JSON. Ton appli navigateur appelle cette API pour obtenir de vraies données du Pi.',purpose:'Pi War Room : Portable hacking station with multi-tool dashboard. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'Kit d\\',related1_desc:'Étudier les techniques d\\',related1_path:'../../51-social-engineering/se-impersonation-toolkit/index.html',related2_name:'Hub d\\',related2_desc:'Collecte SIGINT et analyse du trafic',related2_path:'../../54-rf-warfare/rfw-comms-interception-hub/index.html',related3_name:'Gestionnaire de Deconfliction',related3_desc:'Allocation spectrale et resolution de conflits',related3_path:'../../54-rf-warfare/rfw-frequency-deconfliction/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'Tableau de bord passerelle VPN',pathPrev_path:'../../37-pi-core/pi-vpn-gateway/index.html',pathNext_name:'',pathNext_path:'',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Que signifie IA ?',quiz_q1a:'Entrée automatisée',quiz_q1b:'Intelligence Artificielle',quiz_q1c:'Interface analogique',quiz_q1d:'Intégration active',quiz_q1_answer:'1',quiz_q2:'Comment s\'écrit SOS en code Morse ?',quiz_q2a:'---...---',quiz_q2b:'...---...',quiz_q2c:'...-...-',quiz_q2d:'-.-.-.',quiz_q2_answer:'1',quiz_q3:'En Morse, que représente la lettre E ?',quiz_q3a:'Trait',quiz_q3b:'Un point',quiz_q3c:'Deux points',quiz_q3d:'Point-trait',quiz_q3_answer:'1',quiz_q4:'Qu\'est-ce qu\'un réseau de neurones ?',quiz_q4a:'Fils physiques',quiz_q4b:'Système informatique inspiré des neurones',quiz_q4c:'Réseau social',quiz_q4d:'Réseau radio',quiz_q4_answer:'1',quiz_q5:'Qu\'est-ce que l\'apprentissage automatique ?',quiz_q5a:'Programmer des robots',quiz_q5b:'Systèmes apprenant des données',quiz_q5c:'Calcul manuel',quiz_q5d:'Conception matérielle',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'Le botnet Mirai (2016) a asservi 600 000 appareils IoT en utilisant 61 mots de passe par défaut. Son attaque DDoS de 1,2 Tbps a fait tomber Twitter, Netflix et Reddit.',realworld2:'Les fuites de Snowden en 2013 ont révélé que le programme PRISM de la NSA collectait des données directement depuis les serveurs de Google, Facebook, Apple et Microsoft.',realworld3:'Le ransomware Colonial Pipeline (2021) a fermé le plus grand oléoduc américain pendant 5 jours. Un seul mot de passe VPN compromis a causé des pénuries dans 17 états.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En analyse de trafic, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en analyse de trafic et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'Pi War Room illustre un concept fondamental en analyse de trafic. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans Pi War Room ont des applications directes dans le monde réel. Les professionnels de analyse de trafic utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, browser et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en analyse de trafic implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'Ouvrez la console développeur (F12) pour voir les données brutes derrière la visualisation. La simulation enregistre chaque calcul.',proTip2:'Utilisez l\x27onglet Performance de votre navigateur pour mesurer le taux de rafraîchissement. Si la simulation tombe sous 30fps, réduisez les points de données.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'99% du trafic internet international transite par des cbles à fibres optiques sous-marins. Plus de 550 cbles actifs totalisent 1,4 million de km.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de cybersécurité',
 wiki_history: 'BLE was introduced in Bluetooth 4.0 (2010) by Nokia. It reduced power consumption by 90% compared to classic Bluetooth, enabling battery-powered sensors. Pi War Room s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Pi War Room',
 wiki_math: 'Les mathématiques derrière Pi War Room : BLE uses Gaussian Frequency Shift Keying (GFSK) modulation at 1 Mbps. The modulation index of 0.5 provides optimal bandwidth efficiency. The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance.',
 wiki_advanced_title: '🔬 Techniques avancées',
 wiki_advanced: 'Au-delà des bases de cette simulation, les praticiens avancés de cybersécurité utilisent des techniques sophistiquées. Les algorithmes adaptatifs ajustent automatiquement les paramètres. L apprentissage automatique classifie les signaux avec précision. La corrélation multi-canaux détecte des motifs invisibles à l analyse mono-canal. Les réseaux de capteurs distribués combinent les données de plusieurs emplacements.',
 wiki_compare_title: '⚖️ Comparaison des approches',
 wiki_compare: 'Il existe plusieurs approches pour cybersécurité. Les solutions matérielles avec browser offrent des performances en temps réel. Les simulations logicielles (comme cette app) permettent une expérimentation sûre sans coût de matériel. Les plateformes cloud offrent une évolutivité mais introduisent latence et préoccupations de confidentialité. Cette simulation vous donne les bases pour utiliser efficacement toute approche.',
 wiki_debug_title: '🔧 Guide de dépannage',
 wiki_debug: 'Problèmes courants en cybersécurité : (1) Les résultats inattendus proviennent souvent de paramètres incorrects — réinitialisez et modifiez une variable à la fois. (2) Si la visualisation semble gelée, vérifiez que la simulation tourne. (3) Les lectures erratiques indiquent des interférences. (4) Vérifiez vos unités (Hz vs kHz vs MHz). Le débogage systématique est une compétence essentielle.',
 wiki_ethics_title: '⚖️ Éthique et aspects légaux',
 wiki_ethics: 'Cybersécurité implique des responsabilités éthiques et légales importantes. De nombreux pays réglementent l utilisation de browser. Obtenez toujours une autorisation avant de tester des systèmes que vous ne possédez pas. Respectez les lois sur la vie privée et la protection des données. Cette simulation est conçue à des fins éducatives — elle démontre des principes sans transmettre de signaux réels ni accéder à de vrais réseaux.',
 gloss1_term: 'Advertising Packet',
 gloss1_def: 'A BLE broadcast packet (up to 31 bytes payload) sent on channels 37, 38, 39. Scanners detect these to discover nearby devices without establishing a connection.',
 gloss2_term: 'Bandwidth',
 gloss2_def: 'The range of frequencies a signal occupies. Wider bandwidth allows more data but requires more spectrum. Measured in Hz (kHz, MHz, GHz).',
 ...
 theory: 'Pi War Room démontre les principes clés de cybersécurité. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 faq_q9: 'Quelles erreurs courantes dois-je éviter ?',
 faq_a9: 'L erreur la plus courante est de modifier plusieurs paramètres simultanément, ce qui rend impossible la compréhension de cause à effet. Modifiez toujours un seul élément à la fois. Une autre erreur est d ignorer le journal d activité — il enregistre chaque événement. Enfin, ne sautez pas la section défis : ces questions testent votre compréhension réelle des concepts.',
 faq_q10: 'Quel est le lien avec cybersecurity dans le monde réel ?',
 ...
 title: 'غرفة حرب Pi', subtitle: '🖥️ اختراق · 🔍 تحليل · 🛡️ دفاع',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'وحدة التحكم في غرفة الحرب', mainDesc: 'محطة اختراق محمولة مع لوحة أدوات متعددة',
 sectionA: 'ماسح الشبكة', sectionB: 'مجموعة أدوات الاستغلال', sectionC: 'حول اختبار الاختراق',
 cpuLabel: 'المعالج', ramLabel: 'الذاكرة', tempLabel: 'الحرارة', hostsLabel: 'الأجهزة',
 runBtn: 'تشغيل', stopBtn: 'إيقاف',
 thIP: 'IP', thMAC: 'MAC', thOS: 'النظام', thPorts: 'المنافذ المفتوحة', thStatus: 'الحالة',
 pentestInfo1: 'اختبار الاختراق هو محاكاة مصرح بها للهجمات السيبرانية لتقييم أمن الأنظمة.',
 pentestInfo2: 'غرفة حرب Pi تجمع أدوات مثل Nmap وAircrack-ng وMetasploit على Raspberry Pi محمول.',
 pentestInfo3: 'احصل دائمًا على إذن مناسب قبل إجراء أي اختبار أمني.',
 scanStarted: '🔍 بدأ المسح', scanComplete: '🔍 اكتمل المسح', toolStopped: '🔴 توقفت الأداة',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi War Room. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 themeChanged: '🎨 المظهر ←',step1Title:'توصيل العتاد',step1Desc:'وصّل المستشعرات أو الوحدات بمنافذ GPIO في Raspberry Pi. شاهد التصور يتحدث في الوقت الفعلي أثناء هذه المرحلة. يعرض الشاشة بالضبط ما يحدث داخلياً — كل لون وحركة يمثل تحولاً محدداً في البيانات.',step2Title:'تكوين البرنامج',step2Desc:'ثبّت المكتبات وكوّن سكريبت Python لإعداد العتاد. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',step3Title:'مراقبة البيانات',step3Desc:'اقرأ بيانات المستشعرات في الوقت الفعلي وعالجها. تحول هذه المرحلة بيانات الإدخال باستخدام الخوارزمية المعروضة. قارن القيم قبل وبعد لفهم العلاقة الرياضية.',step4Title:'تحكم وتسجيل',step4Desc:'أطلق إجراءات بناءً على حدود البيانات وسجّل النتائج. ناتج هذه المرحلة يغذي المرحلة التالية. حاول التوقف هنا لفحص الحالة الوسيطة.',sectionCode:'كود الجهاز',faq_q1:'ما هو Pi War Room؟',faq_a1:'Pi War Room هي محاكاة تفاعلية توضح مفاهيم الأمن السيبراني. Portable hacking station with multi-tool dashboard. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في الحوسبة المضمنة. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من الحوسبة المضمنة. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج Raspberry Pi. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من الحوسبة المضمنة. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في Pi War Room! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة الحوسبة المضمنة.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالحوسبة المضمنة.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'GPIO Programming',learn1Desc:'How to control electronic pins with Python code. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'Electronics',learn2Title:'Sensor Integration',learn2Desc:'How to read temperature, light, and motion data. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'Sensors',learn3Title:'Python Scripting',learn3Desc:'How to automate hardware with Python programs. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'Programming',learn4Title:'Communication',learn4Desc:'How Raspberry Pi talks to radios and networks. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'Networking',sectionLearn:'ماذا ستتعلم',learnLevelVal:'مبتدئ 🟢',learnLevel:'المستوى:',learnTimeVal:'15 min ⏱',learnTime:'المدة:',learnAgeVal:'10+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Pi War Room! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـالأمن السيبراني — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how Wire up sensors, displays, or radio modules to the لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم الحوسبة المضمنة من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',ch1Title:'مسح المعاملات',ch1Desc:'غيّر متغيراً واحداً بشكل منهجي مع تثبيت الباقي. هل تجد العلاقة بين المدخل والمخرج؟',ch2Title:'الحالة الحدية',ch2Desc:'ادفع معاملاً لقيمته القصوى. ماذا يحدث؟ هل يتصرف النظام بشكل مختلف عند الحدود؟',ch3Title:'توقع ثم اختبر',ch3Desc:'قبل الضغط على بدء، توقع ما سيحدث. هل كنت محقاً؟ ما الذي فاتك؟',codeTitle:'كود البداية',codeLang:'Python (Raspberry Pi)',codeSnippet:'import subprocess\\nimport json\\nfrom http.server import HTTPServer, SimpleHTTPRequestHandler\\n\\ndef scan_wifi():\\n result = subprocess.run(["iwlist", "wlan0", "scan"], capture_output=True, text=True)\\n networks = []\\n for line in result.stdout.split("\\\\n"):\\n if "ESSID:" in line:\\n networks.append(line.split(\'"\')[1])\\n return networks\\n\\nHTTPServer(("0.0.0.0", 8000), SimpleHTTPRequestHandler).serve_forever()',codeExplain:'يعمل هذا الكود على Raspberry Pi وينشئ خادم ويب على المنفذ 8000. يقوم بمسح شبكات WiFi ويعيد القائمة بصيغة JSON. تطبيق المتصفح يستدعي هذه الواجهة للحصول على بيانات حقيقية.',purpose:'Pi War Room: Portable hacking station with multi-tool dashboard. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ الأمن السيبراني',
 wiki_history: 'BLE was introduced in Bluetooth 4.0 (2010) by Nokia. It reduced power consumption by 90% compared to classic Bluetooth, enabling battery-powered sensors. يبني Pi War Room على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Pi War Room',
 wiki_math: 'الرياضيات وراء Pi War Room: BLE uses Gaussian Frequency Shift Keying (GFSK) modulation at 1 Mbps. The modulation index of 0.5 provides optimal bandwidth efficiency. The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance.',
 wiki_advanced_title: '🔬 تقنيات متقدمة',
 wiki_advanced: 'بما يتجاوز الأساسيات في هذه المحاكاة، يستخدم ممارسو الأمن السيبراني المتقدمون تقنيات متطورة. تضبط الخوارزميات التكيفية المعاملات تلقائياً. يصنف التعلم الآلي الإشارات بدقة عالية. يكتشف الارتباط متعدد القنوات أنماطاً غير مرئية للتحليل أحادي القناة. تجمع شبكات الاستشعار الموزعة البيانات من مواقع متعددة.',
 wiki_compare_title: '⚖️ مقارنة الأساليب',
 wiki_compare: 'هناك عدة أساليب في الأمن السيبراني. توفر الحلول المادية باستخدام browser أداءً في الوقت الفعلي. توفر المحاكاة البرمجية (مثل هذا التطبيق) تجربة آمنة بدون تكلفة المعدات. توفر المنصات السحابية قابلية التوسع لكنها تقدم تأخيراً ومخاوف تتعلق بالخصوصية. تمنحك هذه المحاكاة الأساس لاستخدام أي نهج بفعالية.',
 wiki_debug_title: '🔧 دليل استكشاف الأخطاء',
 wiki_debug: 'مشاكل شائعة في الأمن السيبراني: (1) النتائج غير المتوقعة غالباً ما تأتي من إعدادات معاملات غير صحيحة — أعد التعيين وغير متغيراً واحداً في كل مرة. (2) إذا بدت الرسوم المتحركة متجمدة، تأكد أن المحاكاة تعمل. (3) القراءات المتقطعة تشير عادة إلى التداخل. (4) تحقق من وحداتك (هرتز مقابل كيلوهرتز مقابل ميغاهرتز).',
 wiki_ethics_title: '⚖️ الأخلاقيات والاعتبارات القانونية',
 wiki_ethics: 'الأمن السيبراني يحمل مسؤوليات أخلاقية وقانونية مهمة. تنظم العديد من الدول استخدام browser والمعدات المماثلة. احصل دائماً على إذن مناسب قبل اختبار أنظمة لا تملكها. احترم قوانين الخصوصية وحماية البيانات. هذه المحاكاة مصممة لأغراض تعليمية — تعرض المبادئ دون إرسال إشارات حقيقية أو الوصول لشبكات فعلية.',
 gloss1_term: 'Advertising Packet',
 gloss1_def: 'A BLE broadcast packet (up to 31 bytes payload) sent on channels 37, 38, 39. Scanners detect these to discover nearby devices without establishing a connection.',
 gloss2_term: 'Bandwidth',
 gloss2_def: 'The range of frequencies a signal occupies. Wider bandwidth allows more data but requires more spectrum. Measured in Hz (kHz, MHz, GHz).',
 ...
 theory: 'Pi War Room يوضح المبادئ الأساسية في الأمن السيبراني. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 faq_q9: 'ما الأخطاء الشائعة التي يجب تجنبها؟',
 faq_a9: 'الخطأ الأكثر شيوعاً هو تغيير معاملات متعددة في وقت واحد مما يجعل فهم السبب والنتيجة مستحيلاً. غير دائماً شيئاً واحداً في كل مرة. خطأ شائع آخر هو تجاهل سجل النشاط — فهو يسجل كل حدث ويساعدك على فهم تسلسل العمليات. أخيراً لا تتخط قسم التحديات: تلك الأسئلة تختبر فهمك الحقيقي للمفاهيم.',
 faq_q10: 'كيف يرتبط هذا بـcybersecurity في العالم الحقيقي؟',
 faq_a10: 'تحاكي هذه المحاكاة نفس الفيزياء والرياضيات المستخدمة في الأنظمة المهنية. تتوافق المعاملات التي تضبطها مع إعدادات المعدات الحقيقية. تعرض الرسوم البيانية أنماط بيانات مطابقة لما تراه على الأجهزة المهنية. الفرق الرئيسي هو أن هذا يعمل بأمان في متصفحك — تستخدم الأنظمة الحقيقية أجهزة browser وقد تتطلب تراخيص قانونية للتشغيل.',
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'أدوات انتحال الهوية',related1_desc:'دراسة تقنيات انتحال الهوية',related1_path:'../../51-social-engineering/se-impersonation-toolkit/index.html',related2_name:'\\u0645\\u0631\\u0643\\u0632 \\u0627\\u0639\\u062a\\u0631\\u0627\\u0636 \\u0627\\u0644\\u0627\\u062a\\u0635\\u0627\\u0644\\u0627\\u062a',related2_desc:'\\u062c\\u0645\\u0639 \\u0627\\u0644\\u0627\\u0633\\u062a\\u062e\\u0628\\u0627\\u0631\\u0627\\u062a \\u0648\\u062a\\u062d\\u0644\\u064a\\u0644 \\u0627\\u0644\\u0625\\u0634\\u0627\\u0631\\u0627\\u062a',related2_path:'../../54-rf-warfare/rfw-comms-interception-hub/index.html',related3_name:'\\u0645\\u062f\\u064a\\u0631 \\u0641\\u0636 \\u0627\\u0644\\u062a\\u0639\\u0627\\u0631\\u0636',related3_desc:'\\u062a\\u062e\\u0635\\u064a\\u0635 \\u0627\\u0644\\u0637\\u064a\\u0641 \\u0648\\u0643\\u0634\\u0641 \\u0627\\u0644\\u062a\\u0639\\u0627\\u0631\\u0636',related3_path:'../../54-rf-warfare/rfw-frequency-deconfliction/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'لوحة تحكم بوابة VPN',pathPrev_path:'../../37-pi-core/pi-vpn-gateway/index.html',pathNext_name:'',pathNext_path:'',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ماذا تعني AI؟',quiz_q1a:'إدخال آلي',quiz_q1b:'الذكاء الاصطناعي',quiz_q1c:'واجهة تناظرية',quiz_q1d:'تكامل نشط',quiz_q1_answer:'1',quiz_q2:'كيف تبدو SOS بشيفرة مورس؟',quiz_q2a:'---...---',quiz_q2b:'...---...',quiz_q2c:'...-...-',quiz_q2d:'-.-.-.',quiz_q2_answer:'1',quiz_q3:'في شيفرة مورس، ما يمثل الحرف E؟',quiz_q3a:'شرطة',quiz_q3b:'نقطة واحدة',quiz_q3c:'نقطتان',quiz_q3d:'نقطة-شرطة',quiz_q3_answer:'1',quiz_q4:'ما هي الشبكة العصبية؟',quiz_q4a:'أسلاك مادية',quiz_q4b:'نظام حوسبة مستوحى من الخلايا العصبية',quiz_q4c:'شبكة اجتماعية',quiz_q4d:'شبكة راديو',quiz_q4_answer:'1',quiz_q5:'ما هو التعلم الآلي؟',quiz_q5a:'برمجة الروبوتات',quiz_q5b:'أنظمة تتعلم من البيانات',quiz_q5c:'حساب يدوي',quiz_q5d:'تصميم العتاد',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'استعبد بوتنت ميراي (2016) أكثر من 600 ألف جهاز إنترنت الأشياء باستخدام 61 كلمة مرور افتراضية.',realworld2:'كشفت تسريبات سنودن عام 2013 أن برنامج بريزم التابع لوكالة الأمن القومي جمع البيانات مباشرة من خوادم جوجل وفيسبوك وآبل ومايكروسوفت.',realworld3:'أدى هجوم الفدية على خط أنابيب كولونيال (2021) إلى إغلاق أكبر خط أنابيب وقود في أمريكا لمدة 5 أيام بسبب كلمة مرور VPN واحدة مخترقة.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في تحليل حركة المرور معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في تحليل حركة المرور وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Pi War Room يوضح مفهومًا أساسيًا في تحليل حركة المرور. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Pi War Room لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في تحليل حركة المرور هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ browser وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال تحليل حركة المرور يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'افتح وحدة تحكم المطور في المتصفح (F12) لرؤية البيانات الخام وراء العرض المرئي. تسجل المحاكاة كل عملية حسابية.',proTip2:'استخدم علامة تبويب الأداء في المتصفح لقياس معدل الإطارات. إذا انخفضت المحاكاة عن 30 إطارًا في الثانية قلل نقاط البيانات.',funFactTitle:'🎯 هل تعلم؟',funFact:'99% من حركة الإنترنت الدولية تنتقل عبر كابلات الألياف البصرية تحت البحر. هناك أكثر من 550 كابلًا نشطًا بطول إجمالي 1.4 مليون كم.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
/* ═══════ WAR ROOM SIMULATION ═══════ */
let wrRunning = false, wrInterval = null, wrLineIdx = 0;
const FAKE_HOSTS = [
 {ip:'192.168.1.1',mac:'AA:BB:CC:11:22:33',os:'Linux 5.x',ports:'22,80,443',status:'up'},
 {ip:'192.168.1.10',mac:'DD:EE:FF:44:55:66',os:'Windows 10',ports:'135,445,3389',status:'up'},
 {ip:'192.168.1.25',mac:'11:22:33:AA:BB:CC',os:'macOS 14',ports:'22,5900',status:'up'},
 {ip:'192.168.1.50',mac:'44:55:66:DD:EE:FF',os:'Linux (IoT)',ports:'80,8080',status:'up'},
 {ip:'192.168.1.100',mac:'77:88:99:00:11:22',os:'FreeBSD',ports:'22,53,80',status:'up'},
 {ip:'192.168.1.150',mac:'33:44:55:66:77:88',os:'Android 14',ports:'5555',status:'up'},
];
const EXPLOITS = [
 {name:'CVE-2024-1234',sev:'Critical',target:'OpenSSH < 9.3',desc:'Remote code execution'},
 {name:'CVE-2024-5678',sev:'High',target:'Apache 2.4.x',desc:'Path traversal'},
 {name:'CVE-2023-9012',sev:'Medium',target:'SMB v1',desc:'Information disclosure'},
 {name:'CVE-2024-3456',sev:'High',target:'RDP',desc:'Authentication bypass'},
 {name:'CVE-2023-7890',sev:'Low',target:'FTP',desc:'Anonymous access'},
];
const TERM_LINES = {
 nmap:['Starting Nmap 7.94...','Scanning 256 hosts...','Host 192.168.1.1 is up (0.002s)','22/tcp open ssh','80/tcp open http','443/tcp open https','Host 192.168.1.10 is up (0.005s)','135/tcp open msrpc','445/tcp open microsoft-ds','3389/tcp open ms-wbt-server','Host 192.168.1.25 is up (0.003s)','22/tcp open ssh','5900/tcp open vnc','Nmap done: 256 IPs, 6 hosts up'],
 wifi:['[*] Scanning WiFi networks...','[+] SSID: HomeNet CH:6 -45dBm WPA2','[+] SSID: OfficeWiFi CH:11 -62dBm WPA3','[+] SSID: IoT_Network CH:1 -70dBm WPA2','[+] SSID: Guest CH:6 -78dBm OPEN','[*] Captured 4 networks, 12 clients'],
 sniff:['[*] Starting packet capture on eth0...','[PKT] 192.168.1.10 > 8.8.8.8 DNS A google.com','[PKT] 192.168.1.25 > 192.168.1.1 TCP 443 TLS','[PKT] 192.168.1.50 > 192.168.1.1 HTTP GET /api/data','[PKT] ARP who-has 192.168.1.100 tell 192.168.1.1','[*] 847 packets captured'],
 brute:['[*] Starting brute force on SSH 192.168.1.1...','[ATTEMPT] admin:password123 - FAIL','[ATTEMPT] admin:admin - FAIL','[ATTEMPT] root:toor - FAIL','[ATTEMPT] pi:raspberry - SUCCESS!','[!] Credentials found: pi:raspberry'],
 exploit:['[*] Loading exploit database...','[+] CVE-2024-1234: OpenSSH RCE - VULNERABLE','[+] CVE-2024-5678: Apache traversal - PATCHED','[-] CVE-2023-9012: SMB v1 - NOT FOUND','[+] CVE-2024-3456: RDP bypass - VULNERABLE','[*] Scan complete: 2 vulnerabilities found'],
};

function initWarRoomSim() {
 const runBtn=$('runToolBtn'), stopBtn=$('stopToolBtn');
 if(runBtn) runBtn.onclick=startTool;
 if(stopBtn) stopBtn.onclick=stopTool;
 setInterval(updatePiStats,2000);
 updatePiStats();
 populateHosts();
 populateExploits();
}
function startTool(){
 if(wrRunning) return;
 wrRunning=true; wrLineIdx=0;
 const tool=$('toolSelect')?.value||'nmap';
 const s=LANG[currentLang];
 log(s.scanStarted,'success'); setStatus(true); playSound('success');
 const lines=TERM_LINES[tool]||TERM_LINES.nmap;
 const term=$('terminalOutput');
 if(term) term.textContent='';
 wrInterval=setInterval(()=>{
 if(wrLineIdx>=lines.length){stopTool();log(s.scanComplete,'success');return;}
 if(term) term.textContent+=lines[wrLineIdx]+'\n';
...
function stopTool(){
 wrRunning=false;
 if(wrInterval){clearInterval(wrInterval);wrInterval=null;}
 setStatus(false);
}
function populateHosts(){
 const tb=$('hostTableBody'); if(!tb) return;
 tb.innerHTML='';
 FAKE_HOSTS.forEach(h=>{
 const tr=document.createElement('tr');
 tr.style.borderBottom='1px solid var(--border)';
 tr.innerHTML=`<td style="padding:.3rem;font-family:monospace;font-size:.75rem">${h.ip}</td><td style="padding:.3rem;font-size:.75rem">${h.mac}</td><td style="padding:.3rem;font-size:.75rem">${h.os}</td><td style="padding:.3rem;font-family:monospace;font-size:.75rem">${h.ports}</td><td style="padding:.3rem"><span style="color:#0f0">●</span> ${h.status}</td>`;
 tb.appendChild(tr);
 });
 const hv=$('hostsVal'); if(hv) hv.textContent=FAKE_HOSTS.length;
}
function populateExploits(){
 const el=$('exploitList'); if(!el) return;
 el.innerHTML=EXPLOITS.map(e=>{
 const c=e.sev==='Critical'?'#f00':e.sev==='High'?'#f80':e.sev==='Medium'?'#ff0':'#0f0';
 return `<div style="padding:.4rem;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center"><div><strong>${e.name}</strong> — ${e.target}<br><span style="opacity:.7;font-size:.75rem">${e.desc}</span></div><span style="color:${c};font-weight:bold;font-size:.8rem">${e.sev}</span></div>`;
 }).join('');
}
function updatePiStats(){
 const cpu=$('cpuVal'),ram=$('ramVal'),temp=$('tempVal');
 if(cpu) cpu.textContent=(10+Math.random()*(wrRunning?70:25)).toFixed(0)+'%';
 if(ram) ram.textContent=(30+Math.random()*30).toFixed(0)+'%';
 if(temp) temp.textContent=(40+Math.random()*18).toFixed(0)+'°C';
}
