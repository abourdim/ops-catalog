...
const LANG = {
  en: {
    ...
    howto_1: 'Set your light and motion thresholds using the sliders. Start with default values.',
  ...
  fr: {
    ...
    howto_1: 'Reglez vos seuils de lumiere et de mouvement avec les curseurs. Commencez avec les valeurs par defaut.',
  ...
  ar: {
    ...
    howto_1: 'اضبط عتبات الضوء والحركة باستخدام المنزلقات. ابدأ بالقيم الافتراضية.',
