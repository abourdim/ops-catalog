...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-66C1A2',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Stealth Alarm \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Stealth Alarm', subtitle: '🚨 detect · 🔐 protect · 💡 innovate',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Stealth Alarm — Intrusion Detection', mainDesc: 'Detect intruders with light and motion sensors',
 sectionA: 'How It Works', sectionB: 'Lab — Sensor Simulation', sectionC: 'Challenges',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1: 'The main display shows the Stealth Alarm simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'Press "Arm Alarm" to activate the monitoring system. The status turns green. Take note of how the visualization changes. Each visual element represents a specific data value or process state. The colors encode information: brighter typically means higher values or more activity.',
 howto_3: 'Use "Test Intrusion" or the Lab section to simulate sensor events and watch the alarm react in real time.',
 howto_4: 'Review the Alert History to see all triggered events. Adjust thresholds to balance sensitivity and reliability.',
 wiki_light_title: '💡 Light Sensors',
 wiki_light: 'Light sensors (photoresistors, photodiodes, or LED-based) convert light intensity into electrical signals. The micro:bit uses its LED matrix in reverse to detect ambient light levels from 0 to 255.',
 wiki_accel_title: '📐 Accelerometer',
 wiki_accel: 'An accelerometer measures acceleration forces in 3 axes. At rest, it reads gravity (~1g). Movement adds forces. The magnitude sqrt(x2+y2+z2) gives overall motion intensity.',
 wiki_threshold_title: '📊 Threshold Detection',
 wiki_threshold: 'Threshold detection compares sensor values against a set boundary. Values above trigger actions. Hysteresis (different on/off thresholds) prevents rapid toggling near the boundary.',
 wiki_security_title: '🔒 Security Systems',
 wiki_security: 'Modern security systems combine multiple sensors (PIR motion, door contacts, vibration, cameras) with logic controllers. They use zones, delays, and communication protocols to detect and report intrusions.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🚨 Stealth Alarm ready!',
 ...
 themeChanged: '🎨 Theme →',
 // Alarm-specific keys
 statusArmed: 'ARMED', statusDisarmed: 'DISARMED', statusTriggered: 'TRIGGERED',
 lightLevel: 'Light Level', motionLevel: 'Motion Level',
 lightThresholdLabel: 'Light Threshold', motionThresholdLabel: 'Motion Threshold',
 armAlarm: 'Arm Alarm', disarmAlarm: 'Disarm', testIntrusion: 'Test Intrusion',
 alertHistoryTitle: 'Alert History', noAlerts: 'No alerts yet',
 alarmArmed: '🔐 Alarm armed — monitoring sensors',
 alarmDisarmed: '🔓 Alarm disarmed',
 alarmTriggered: '🚨 INTRUSION DETECTED!',
 triggerLight: 'Light', triggerMotion: 'Motion',
 noiseLabel: 'Simulation Noise',
 simDoor: 'Simulate Door Open', simShake: 'Simulate Shake',
 useAmbientLight: 'Use device light sensor (Ambient Light API)',
 useDeviceMotion: 'Use device accelerometer (DeviceMotion)',
 labHint: 'Adjust noise to see how sensor fluctuations affect detection. Use the buttons to simulate intrusion events, or enable real device sensors for live data.',
 stepA1: 'The micro:bit continuously samples the light sensor and accelerometer at regular intervals, reading ambient light (0-255) and motion magnitude.',
 stepA2: 'Each reading is compared against user-defined thresholds. If light exceeds the light threshold OR motion exceeds the motion threshold, an intrusion is suspected.',
 stepA3: 'When a threshold is breached while the alarm is armed, the system triggers an alert: the LED matrix flashes, the buzzer sounds, and the event is logged with a timestamp.',
 stepA4: 'All triggered events are recorded in the alert history with the sensor type (light or motion), the value that caused the trigger, and the exact time. This log helps analyze patterns and reduce false alarms.',
 challenge1Title: 'Challenge 1: Bypass the Alarm',
 challenge1Desc: 'Try to open the door (increase light) and move around without triggering the alarm. Find the sweet spot where sensor values stay below the thresholds. How slowly can you move?',
 challenge2Title: 'Challenge 2: Find Optimal Thresholds',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-66C1A2',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Stealth Alarm \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Stealth Alarm', subtitle: '🚨 detecter · 🔐 proteger · 💡 innover',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'Alarme Furtive — Detection d\'Intrusion', mainDesc: 'Detectez les intrus avec des capteurs de lumiere et de mouvement',
 sectionA: 'Comment ca Marche', sectionB: 'Labo — Simulation de Capteurs', sectionC: 'Defis',
 ...
 howto_1: 'L écran principal affiche la simulation Stealth Alarm. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'Appuyez sur "Armer l\'Alarme" pour activer la surveillance. Le statut passe au vert.',
 howto_3: 'Utilisez "Tester Intrusion" ou la section Labo pour simuler des evenements et observer l\'alarme reagir en temps reel.',
 howto_4: 'Consultez l\'historique des alertes pour voir tous les evenements. Ajustez les seuils pour equilibrer sensibilite et fiabilite.',
 wiki_light_title: '💡 Capteurs de Lumiere',
 wiki_light: 'Les capteurs de lumiere (photoresistances, photodiodes ou LED) convertissent l\'intensite lumineuse en signaux electriques. Le micro:bit utilise sa matrice LED en mode inverse pour detecter la lumiere ambiante de 0 a 255.',
 wiki_accel_title: '📐 Accelerometre',
 wiki_accel: 'Un accelerometre mesure les forces d\'acceleration sur 3 axes. Au repos, il lit la gravite (~1g). Le mouvement ajoute des forces. La magnitude sqrt(x2+y2+z2) donne l\'intensite globale.',
 wiki_threshold_title: '📊 Detection par Seuil',
 wiki_threshold: 'La detection par seuil compare les valeurs des capteurs a une limite fixee. Les valeurs au-dessus declenchent des actions. L\'hysteresis empeche les basculements rapides pres de la limite.',
 wiki_security_title: '🔒 Systemes de Securite',
 wiki_security: 'Les systemes de securite modernes combinent plusieurs capteurs (PIR, contacts de porte, vibration, cameras) avec des controleurs logiques. Ils utilisent des zones, delais et protocoles de communication.',
 working: 'En cours…',
 t_mosque: 'Mosquee', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🚨 Alarme furtive prete !',
 ...
 themeChanged: '🎨 Theme →',
 statusArmed: 'ARMEE', statusDisarmed: 'DESARMEE', statusTriggered: 'DECLENCHEE',
 lightLevel: 'Niveau de Lumiere', motionLevel: 'Niveau de Mouvement',
 lightThresholdLabel: 'Seuil de Lumiere', motionThresholdLabel: 'Seuil de Mouvement',
 armAlarm: 'Armer l\'Alarme', disarmAlarm: 'Desarmer', testIntrusion: 'Tester Intrusion',
 alertHistoryTitle: 'Historique des Alertes', noAlerts: 'Aucune alerte',
 alarmArmed: '🔐 Alarme armee — surveillance des capteurs',
 alarmDisarmed: '🔓 Alarme desarmee',
 alarmTriggered: '🚨 INTRUSION DETECTEE !',
 triggerLight: 'Lumiere', triggerMotion: 'Mouvement',
 noiseLabel: 'Bruit de Simulation',
 simDoor: 'Simuler Ouverture Porte', simShake: 'Simuler Secousse',
 useAmbientLight: 'Utiliser le capteur de lumiere (API Ambient Light)',
 useDeviceMotion: 'Utiliser l\'accelerometre (DeviceMotion)',
 labHint: 'Ajustez le bruit pour voir comment les fluctuations affectent la detection. Utilisez les boutons pour simuler des intrusions, ou activez les vrais capteurs.',
 stepA1: 'Le micro:bit echantillonne continuellement le capteur de lumiere et l\'accelerometre a intervalles reguliers, lisant la lumiere ambiante (0-255) et la magnitude du mouvement.',
 stepA2: 'Chaque lecture est comparee aux seuils definis. Si la lumiere depasse le seuil OU le mouvement depasse le seuil, une intrusion est suspectee.',
 stepA3: 'Quand un seuil est franchi et l\'alarme est armee, le systeme declenche une alerte : la matrice LED clignote, le buzzer sonne, et l\'evenement est enregistre.',
 stepA4: 'Tous les evenements sont enregistres dans l\'historique avec le type de capteur, la valeur qui a cause le declenchement, et l\'heure exacte.',
 challenge1Title: 'Defi 1 : Contourner l\'Alarme',
 challenge1Desc: 'Essayez d\'ouvrir la porte et de bouger sans declencher l\'alarme. Trouvez le point ou les valeurs restent sous les seuils.',
 challenge2Title: 'Defi 2 : Trouver les Seuils Optimaux',
 ...
 theory: 'Stealth Alarm démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Stealth Alarm', subtitle: '🚨 اكتشف · 🔐 احمِ · 💡 ابتكر',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'الإنذار الخفي — كشف التسلل', mainDesc: 'اكتشف المتسللين بأجهزة استشعار الضوء والحركة',
 sectionA: 'كيف يعمل', sectionB: 'المختبر — محاكاة الاستشعار', sectionC: 'التحديات',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Stealth Alarm. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'اضغط "تفعيل الإنذار" لبدء المراقبة. يتحول المؤشر إلى الأخضر. لاحظ كيف يتغير التصور. كل عنصر مرئي يمثل قيمة بيانات محددة أو حالة عملية. الألوان تشفر المعلومات: الأكثر سطوعاً عادة يعني قيماً أعلى.',
 howto_3: 'استخدم "اختبار التسلل" أو قسم المختبر لمحاكاة أحداث الاستشعار ومشاهدة الإنذار يتفاعل.',
 howto_4: 'راجع سجل التنبيهات لرؤية جميع الأحداث. اضبط العتبات لتحقيق التوازن بين الحساسية والموثوقية.',
 wiki_light_title: '💡 مستشعرات الضوء',
 wiki_light: 'مستشعرات الضوء تحوّل شدة الضوء إلى إشارات كهربائية. يستخدم micro:bit مصفوفة LED بشكل عكسي لاكتشاف مستويات الإضاءة المحيطة من 0 إلى 255.',
 wiki_accel_title: '📐 مقياس التسارع',
 wiki_accel: 'مقياس التسارع يقيس قوى التسارع على 3 محاور. في حالة السكون، يقرأ الجاذبية (~1g). الحركة تضيف قوى. المقدار sqrt(x2+y2+z2) يعطي شدة الحركة الإجمالية.',
 wiki_threshold_title: '📊 كشف العتبة',
 wiki_threshold: 'كشف العتبة يقارن قيم المستشعرات بحد معيّن. القيم فوق الحد تطلق إجراءات. التباطؤ (عتبات تشغيل/إيقاف مختلفة) يمنع التبديل السريع قرب الحد.',
 wiki_security_title: '🔒 أنظمة الأمان',
 wiki_security: 'أنظمة الأمان الحديثة تجمع بين مستشعرات متعددة (حركة PIR، جهات اتصال الأبواب، اهتزاز، كاميرات) مع وحدات تحكم منطقية. تستخدم مناطق وتأخيرات وبروتوكولات اتصال.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🚨 الإنذار الخفي جاهز!',
 ...
 themeChanged: '🎨 المظهر ←',
 statusArmed: 'مُفعَّل', statusDisarmed: 'مُعطَّل', statusTriggered: 'تم الإطلاق!',
 lightLevel: 'مستوى الضوء', motionLevel: 'مستوى الحركة',
 lightThresholdLabel: 'عتبة الضوء', motionThresholdLabel: 'عتبة الحركة',
 armAlarm: 'تفعيل الإنذار', disarmAlarm: 'إيقاف', testIntrusion: 'اختبار التسلل',
 alertHistoryTitle: 'سجل التنبيهات', noAlerts: 'لا توجد تنبيهات بعد',
 alarmArmed: '🔐 الإنذار مفعّل — مراقبة المستشعرات',
 alarmDisarmed: '🔓 تم إيقاف الإنذار',
 alarmTriggered: '🚨 تم كشف تسلل!',
 triggerLight: 'ضوء', triggerMotion: 'حركة',
 noiseLabel: 'ضوضاء المحاكاة',
 simDoor: 'محاكاة فتح الباب', simShake: 'محاكاة اهتزاز',
 useAmbientLight: 'استخدام مستشعر الضوء (Ambient Light API)',
 useDeviceMotion: 'استخدام مقياس التسارع (DeviceMotion)',
 labHint: 'اضبط الضوضاء لترى كيف تؤثر تقلبات المستشعر على الكشف. استخدم الأزرار لمحاكاة أحداث التسلل، أو فعّل مستشعرات الجهاز الحقيقية.',
 stepA1: 'يقوم micro:bit بقراءة مستشعر الضوء ومقياس التسارع باستمرار على فترات منتظمة، ويقرأ الإضاءة المحيطة (0-255) ومقدار الحركة.',
 stepA2: 'تُقارن كل قراءة بالعتبات المحددة. إذا تجاوز الضوء عتبة الضوء أو تجاوزت الحركة عتبة الحركة، يُشتبه في تسلل.',
 stepA3: 'عند تجاوز العتبة والإنذار مفعّل، يطلق النظام تنبيهًا: تومض مصفوفة LED، يصدر الجرس صوتًا، ويُسجَّل الحدث بطابع زمني.',
 stepA4: 'تُسجَّل جميع الأحداث في سجل التنبيهات مع نوع المستشعر والقيمة التي تسببت في الإطلاق والوقت الدقيق.',
 challenge1Title: 'التحدي 1: تجاوز الإنذار',
 challenge1Desc: 'حاول فتح الباب والتحرك دون إطلاق الإنذار. اعثر على النقطة التي تبقى فيها قيم المستشعرات تحت العتبات.',
 challenge2Title: 'التحدي 2: إيجاد العتبات المثلى',
 ...
 theory: 'Stealth Alarm يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ STEALTH ALARM SIMULATION ═══════ */

let alarmState = 'disarmed'; // disarmed | armed | triggered
let simInterval = null;
let currentLight = 20;
let currentMotion = 30;
let doorOpenEvent = false;
let shakeEvent = false;
let useRealLight = false;
let useRealMotion = false;
let alertCount = 0;
...
function initAlarm() {
 ...
 const lightThr = $('lightThreshold');
 const motionThr = $('motionThreshold');
 const noiseSlider = $('noiseSlider');
 const simDoorBtn = $('simDoorBtn');
 const simShakeBtn = $('simShakeBtn');
 const ambientChk = $('useAmbientLight');
 const motionChk = $('useDeviceMotion');

 if (armBtn) armBtn.onclick = armAlarm;
 if (disarmBtn) disarmBtn.onclick = disarmAlarm;
 if (testBtn) testBtn.onclick = testIntrusion;

 if (lightThr) lightThr.oninput = () => {
 const v = $('lightThresholdVal');
 if (v) v.textContent = lightThr.value;
 };
 if (motionThr) motionThr.oninput = () => {
 const v = $('motionThresholdVal');
 if (v) v.textContent = motionThr.value;
 };
 if (noiseSlider) noiseSlider.oninput = () => {
 const v = $('noiseVal');
 if (v) v.textContent = noiseSlider.value;
 };

 if (simDoorBtn) simDoorBtn.onclick = () => {
 doorOpenEvent = true;
 log('💡 Door open simulated — light spike!', 'tx');
 playSound('click');
 };
 if (simShakeBtn) simShakeBtn.onclick = () => {
 shakeEvent = true;
 log('📳 Shake simulated — motion spike!', 'tx');
 playSound('click');
 };

 if (ambientChk) ambientChk.onchange = () => {
 useRealLight = ambientChk.checked;
 if (useRealLight) initAmbientLightSensor();
 else log('💡 Ambient light sensor disabled', 'info');
 };
 if (motionChk) motionChk.onchange = () => {
 useRealMotion = motionChk.checked;
 if (useRealMotion) initDeviceMotionSensor();
 else log('📳 Device motion sensor disabled', 'info');
 };

 // Start the simulation loop
 simInterval = setInterval(simulationTick, 200);
}

function armAlarm() {
 if (alarmState === 'armed') return;
 alarmState = 'armed';
 updateAlarmDisplay();
 const s = LANG[currentLang];
 log(s.alarmArmed, 'success');
 setStatus(true);
 showToast(s.alarmArmed, 2000);
}
...
function testIntrusion() {
 ...
 log('🧪 Test intrusion triggered!', 'tx');
}

function triggerAlarm(sensorType, value) {
 if (alarmState !== 'armed') return;
 alarmState = 'triggered';
 updateAlarmDisplay();
 const s = LANG[currentLang];
 const label = sensorType === 'light' ? s.triggerLight : s.triggerMotion;
 log(`${s.alarmTriggered} [${label}: ${value}]`, 'error');
 playSound('error');
 addAlertEntry(sensorType, value);
 showToast(s.alarmTriggered, 3000);

 // Auto-rearm after 3 seconds
 setTimeout(() => {
 if (alarmState === 'triggered') {
 alarmState = 'armed';
 updateAlarmDisplay();
 log('🔐 Alarm re-armed automatically', 'info');
 }
 }, 3000);
}
...
function updateAlarmDisplay() {
 ...
 if (!el) return;
 const s = LANG[currentLang];
 el.classList.remove('armed', 'disarmed', 'triggered');
 el.classList.add(alarmState);
 if (alarmState === 'armed') el.textContent = s.statusArmed;
 else if (alarmState === 'triggered') el.textContent = s.statusTriggered;
 else el.textContent = s.statusDisarmed;
}

function addAlertEntry(sensorType, value) {
 const history = $('alertHistory');
 if (!history) return;
 // Remove the "no alerts" placeholder
 const placeholder = history.querySelector('[data-i18n="noAlerts"]');
 ...
 entry.innerHTML = `<span class="alert-time">[${now}]</span> <span class="alert-type">${label}</span> = ${value} (#${alertCount})`;
...
function simulationTick() {
 const noiseSlider = $('noiseSlider');
 const noise = noiseSlider ? parseInt(noiseSlider.value) : 10;

 // Light simulation
 if (!useRealLight) {
 let baseLight = 20; // dark room baseline
 if (doorOpenEvent) {
 baseLight = 200 + Math.random() * 55; // door open = bright
 doorOpenEvent = false;
 setTimeout(() => { doorOpenEvent = false; }, 100); // single spike
 }
 currentLight = Math.max(0, Math.min(255,
 baseLight + (Math.random() - 0.5) * noise * 2
 ));
 }

 // Motion simulation
 if (!useRealMotion) {
 let baseMotion = 20; // resting baseline
 if (shakeEvent) {
 baseMotion = 250 + Math.random() * 200; // shake = big spike
 shakeEvent = false;
 }
 currentMotion = Math.max(0, Math.min(500,
 baseMotion + (Math.random() - 0.5) * noise * 3
 ));
 }

 // Update gauges
 updateGauge('lightGauge', 'lightValue', currentLight, 255);
 updateGauge('motionGauge', 'motionValue', currentMotion, 500);

 // Threshold check (only when armed)
 if (alarmState === 'armed') {
 const lightThr = $('lightThreshold');
 const motionThr = $('motionThreshold');
 const lt = lightThr ? parseInt(lightThr.value) : 128;
 const mt = motionThr ? parseInt(motionThr.value) : 150;

 if (currentLight > lt) {
 triggerAlarm('light', Math.round(currentLight));
 } else if (currentMotion > mt) {
 triggerAlarm('motion', Math.round(currentMotion));
 }
 }
}

function updateGauge(gaugeId, valueId, value, max) {
 const gauge = $(gaugeId);
 const valEl = $(valueId);
 if (gauge) {
 const pct = Math.min(100, (value / max) * 100);
 gauge.style.width = pct + '%';
 // Check if above threshold for danger color
 const lightThr = $('lightThreshold');
 const motionThr = $('motionThreshold');
 if (gaugeId === 'lightGauge' && lightThr && value > parseInt(lightThr.value)) {
 gauge.classList.add('danger');
 } else if (gaugeId === 'motionGauge' && motionThr && value > parseInt(motionThr.value)) {
 gauge.classList.add('danger');
 } else {
...
function initAmbientLightSensor() {
 ...
 if (useRealLight) {
 currentLight = Math.min(255, sensor.illuminance);
 }
 });
 sensor.start();
 log('💡 Ambient light sensor active', 'success');
 } catch (e) {
 log('💡 Ambient light sensor not available: ' + e.message, 'error');
 }
 } else {
 log('💡 Ambient Light API not supported in this browser', 'error');
 }
}

function initDeviceMotionSensor() {
 ...
 currentMotion = Math.min(500, mag * 20); // scale for display
 };
 window.addEventListener('devicemotion', handler);
 log('📳 Device motion sensor active', 'success');
 } else {
 log('📳 DeviceMotion not supported in this browser', 'error');
 }
}
