...
const LANG = {
  en: {
    ...
    howto_2: 'Press "Arm Alarm" to activate the monitoring system. The status turns green.',
  ...
  ar: {
    ...
    howto_2: 'اضغط "تفعيل الإنذار" لبدء المراقبة. يتحول المؤشر إلى الأخضر.',
