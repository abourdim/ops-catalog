...
const LANG = {
 ...
 title: 'Micro Wire', subtitle: '🎙️ stream · 📡 transmit · 📝 transcribe',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Micro Wire — Audio Spy Link', mainDesc: 'Stream and transcribe audio over BLE simulation',
 sectionA: 'How It Works', sectionB: 'Lab', sectionC: 'Challenge',
 startListening: 'Start Listening', stop: 'Stop', transcribe: 'Transcribe',
 transcriptPlaceholder: 'Transcript will appear here...',
 packetsSent: 'Packets', bytesTransferred: 'Bytes', latency: 'Latency',
 step1: 'The micro:bit microphone captures ambient sound as analog signal variations.',
 step2: 'Audio is sampled at 8-bit resolution / 8 kHz — producing 8,000 bytes per second.',
 step3: 'Samples are packetized into 20-byte BLE packets for wireless transmission.',
 step4: 'The receiver reconstructs the waveform from packets and plays back the audio stream.',
 labIntro: 'Use the Web Audio API to capture your microphone input (or a simulated sine wave if permission is denied). Watch the real-time waveform and experiment with simulated BLE packetization.',
 packetLoss: 'Packet loss', sampleRate: 'Sample rate',
 labStart: 'Start Mic / Sim', labStop: 'Stop',
 labNote: 'Tip: Increase packet loss to see how missing BLE packets distort the waveform.',
 challenge1Title: 'Challenge 1 — Noisy Word',
 challenge1Desc: 'Set packet loss to 30%. Click Transcribe and try to identify the spy phrase from the garbled output. How many attempts does it take?',
 challenge2Title: 'Challenge 2 — Max Throughput',
 challenge2Desc: 'At 8 kHz / 8-bit, calculate the maximum BLE throughput needed. How many 20-byte packets per second must be sent? Compare with BLE 4.2 limits.',
 challenge3Title: 'Challenge 3 — Voice Compression',
 challenge3Desc: 'Design a simple compression scheme: use 4-bit delta encoding instead of raw 8-bit samples. How much bandwidth do you save? What quality is lost?',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1: 'The main display shows the Micro Wire simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'Watch the waveform canvas and volume meter update in real time as audio is captured.',
 howto_3: 'Click "Transcribe" to generate a simulated spy-themed transcription from the audio stream.',
 howto_4: 'Open the Lab section to experiment with packet loss and sample rate sliders. The key insight is the relationship between your input and the system output. Try predicting what will happen before you make each change — this prediction-testing cycle is how experts develop intuition.',
 wiki_sampling_title: '🎵 Audio Sampling',
 wiki_sampling: 'Sound is digitized by measuring amplitude at fixed intervals. The Nyquist theorem requires sampling at 2x the highest frequency. At 8 kHz we capture frequencies up to 4 kHz — enough for voice.',
 wiki_ble_title: '📡 BLE Data Channels',
 wiki_ble: 'BLE uses 37 data channels (2.4 GHz). Each packet carries up to 20 bytes (BLE 4.0/4.1) or 244 bytes (BLE 5.0+). Connection intervals of 7.5 ms to 4 s control throughput.',
 wiki_transcription_title: '📝 Voice Transcription',
 wiki_transcription: 'Real transcription uses speech-to-text models (like Whisper or Google STT). This app simulates it with random phrases to demonstrate the concept without cloud services.',
 wiki_microbit_title: '🔌 micro:bit Microphone',
 wiki_microbit: 'The micro:bit V2 MEMS microphone detects sound levels and patterns. MakeCode and MicroPython expose it via simple APIs for sound-triggered events and level readings.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🎙️ Micro Wire ready!',
 ...
 theory: 'Micro Wire demonstrates key principles from covert operations. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 title: 'Micro Wire', subtitle: '🎙️ diffuser · 📡 transmettre · 📝 transcrire',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Micro Wire — Lien Audio Espion', mainDesc: 'Diffusion et transcription audio par simulation BLE',
 sectionA: 'Comment ça marche', sectionB: 'Labo', sectionC: 'Défi',
 startListening: 'Écouter', stop: 'Arrêter', transcribe: 'Transcrire',
 transcriptPlaceholder: 'La transcription apparaîtra ici...',
 packetsSent: 'Paquets', bytesTransferred: 'Octets', latency: 'Latence',
 step1: 'Le microphone du micro:bit capte le son ambiant sous forme de variations analogiques.',
 step2: 'L\'audio est échantillonné en 8 bits / 8 kHz — soit 8 000 octets par seconde.',
 step3: 'Les échantillons sont empaquetés en paquets BLE de 20 octets pour la transmission sans fil.',
 step4: 'Le récepteur reconstruit la forme d\'onde à partir des paquets et rejoue le flux audio.',
 labIntro: 'Utilisez l\'API Web Audio pour capturer l\'entrée micro (ou une onde sinusoïdale simulée si l\'accès est refusé). Observez la forme d\'onde en temps réel et expérimentez avec la packetisation BLE simulée.',
 packetLoss: 'Perte de paquets', sampleRate: 'Taux d\'échantillonnage',
 labStart: 'Démarrer Micro / Sim', labStop: 'Arrêter',
 labNote: 'Astuce : augmentez la perte de paquets pour voir comment les paquets BLE manquants déforment la forme d\'onde.',
 challenge1Title: 'Défi 1 — Mot brouillé',
 challenge1Desc: 'Réglez la perte de paquets à 30%. Cliquez Transcrire et essayez d\'identifier la phrase espion dans le texte brouillé. Combien d\'essais faut-il ?',
 challenge2Title: 'Défi 2 — Débit maximal',
 challenge2Desc: 'À 8 kHz / 8 bits, calculez le débit BLE maximal nécessaire. Combien de paquets de 20 octets par seconde faut-il envoyer ? Comparez avec les limites BLE 4.2.',
 challenge3Title: 'Défi 3 — Compression vocale',
 challenge3Desc: 'Concevez un schéma de compression simple : encodage delta 4 bits au lieu d\'échantillons bruts 8 bits. Quelle bande passante économisez-vous ? Quelle qualité est perdue ?',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1: 'L écran principal affiche la simulation Micro Wire. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'Observez le canevas de forme d\'onde et le VU-mètre se mettre à jour en temps réel.',
 howto_3: 'Cliquez "Transcrire" pour générer une transcription espion simulée du flux audio.',
 howto_4: 'Ouvrez la section Labo pour expérimenter avec les curseurs de perte de paquets et de taux.',
 wiki_sampling_title: '🎵 Échantillonnage audio',
 wiki_sampling: 'Le son est numérisé en mesurant l\'amplitude à intervalles fixes. Le théorème de Nyquist exige un échantillonnage à 2x la fréquence max. À 8 kHz, on capture jusqu\'à 4 kHz — suffisant pour la voix.',
 wiki_ble_title: '📡 Canaux de données BLE',
 wiki_ble: 'Le BLE utilise 37 canaux de données (2,4 GHz). Chaque paquet transporte jusqu\'à 20 octets (BLE 4.0/4.1) ou 244 octets (BLE 5.0+). Les intervalles de connexion de 7,5 ms à 4 s contrôlent le débit.',
 wiki_transcription_title: '📝 Transcription vocale',
 wiki_transcription: 'La vraie transcription utilise des modèles speech-to-text (Whisper, Google STT). Cette appli simule avec des phrases aléatoires pour illustrer le concept sans services cloud.',
 wiki_microbit_title: '🔌 Microphone micro:bit',
 wiki_microbit: 'Le microphone MEMS du micro:bit V2 détecte les niveaux et motifs sonores. MakeCode et MicroPython l\'exposent via des API simples pour événements sonores et lectures de niveau.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🎙️ Micro Wire prêt !',
 ...
 theory: 'Micro Wire démontre les principes clés de opérations secrètes. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Micro Wire', subtitle: '🎙️ بث · 📡 نقل · 📝 تفريغ',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مايكرو واير — رابط تجسس صوتي', mainDesc: 'بث وتفريغ الصوت عبر محاكاة BLE',
 sectionA: 'كيف يعمل', sectionB: 'المختبر', sectionC: 'التحدي',
 startListening: 'بدء الاستماع', stop: 'إيقاف', transcribe: 'تفريغ',
 transcriptPlaceholder: 'سيظهر التفريغ هنا...',
 packetsSent: 'الحزم', bytesTransferred: 'البايتات', latency: 'زمن الاستجابة',
 step1: 'يلتقط ميكروفون micro:bit الصوت المحيط كتغيرات إشارة تناظرية.',
 step2: 'يُعيَّن الصوت بدقة 8 بت / 8 كيلوهرتز — مما ينتج 8000 بايت في الثانية.',
 step3: 'تُعبَّأ العينات في حزم BLE بحجم 20 بايت للإرسال اللاسلكي.',
 step4: 'يعيد المستقبل بناء شكل الموجة من الحزم ويشغّل دفق الصوت.',
 labIntro: 'استخدم واجهة Web Audio لالتقاط صوت الميكروفون (أو موجة جيبية محاكاة إذا رُفض الإذن). شاهد شكل الموجة في الوقت الحقيقي وجرّب تعبئة حزم BLE المحاكاة.',
 packetLoss: 'فقدان الحزم', sampleRate: 'معدل العينات',
 labStart: 'تشغيل الميكروفون / المحاكاة', labStop: 'إيقاف',
 labNote: 'نصيحة: ارفع فقدان الحزم لرؤية كيف تشوّه الحزم المفقودة شكل الموجة.',
 challenge1Title: 'التحدي 1 — كلمة مشوّشة',
 challenge1Desc: 'اضبط فقدان الحزم على 30%. انقر تفريغ وحاول تحديد العبارة السرية من النص المشوّش. كم محاولة تحتاج؟',
 challenge2Title: 'التحدي 2 — أقصى إنتاجية',
 challenge2Desc: 'عند 8 كيلوهرتز / 8 بت، احسب أقصى إنتاجية BLE مطلوبة. كم حزمة 20 بايت في الثانية يجب إرسالها؟ قارن مع حدود BLE 4.2.',
 challenge3Title: 'التحدي 3 — ضغط الصوت',
 challenge3Desc: 'صمّم مخطط ضغط بسيط: استخدم ترميز دلتا 4 بت بدلاً من عينات 8 بت الخام. كم عرض نطاق توفّر؟ ما الجودة المفقودة؟',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Micro Wire. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'شاهد لوحة شكل الموجة ومقياس الصوت يتحدّثان في الوقت الحقيقي.',
 howto_3: 'انقر "تفريغ" لتوليد تفريغ تجسسي محاكى من دفق الصوت.',
 howto_4: 'افتح قسم المختبر لتجربة أشرطة تمرير فقدان الحزم ومعدل العينات. الفكرة الأساسية هي العلاقة بين مدخلاتك ومخرجات النظام. حاول التنبؤ بما سيحدث قبل كل تغيير.',
 wiki_sampling_title: '🎵 أخذ العينات الصوتية',
 wiki_sampling: 'يُرقمَن الصوت بقياس السعة على فترات ثابتة. تتطلب نظرية نيكويست أخذ العينات بضعف أعلى تردد. عند 8 كيلوهرتز نلتقط ترددات حتى 4 كيلوهرتز — كافٍ للصوت البشري.',
 wiki_ble_title: '📡 قنوات بيانات BLE',
 wiki_ble: 'يستخدم BLE 37 قناة بيانات (2.4 جيجاهرتز). كل حزمة تحمل حتى 20 بايت (BLE 4.0/4.1) أو 244 بايت (BLE 5.0+). فترات الاتصال من 7.5 مللي ثانية إلى 4 ثوانٍ تتحكم بالإنتاجية.',
 wiki_transcription_title: '📝 تفريغ الصوت',
 wiki_transcription: 'التفريغ الحقيقي يستخدم نماذج تحويل الكلام لنص (مثل Whisper أو Google STT). هذا التطبيق يحاكي بعبارات عشوائية لشرح المفهوم بدون خدمات سحابية.',
 wiki_microbit_title: '🔌 ميكروفون micro:bit',
 wiki_microbit: 'يكشف ميكروفون MEMS في micro:bit V2 مستويات وأنماط الصوت. MakeCode وMicroPython يعرضانه عبر واجهات بسيطة لأحداث الصوت وقراءات المستوى.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🎙️ مايكرو واير جاهز!',
 ...
 theory: 'Micro Wire يوضح المبادئ الأساسية في العمليات السرية. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ MICRO-WIRE AUDIO SIMULATION ═══════ */

let wireAudioCtx = null;
let wireAnalyser = null;
let wireSource = null;
let wireStream = null;
let wireAnimFrame = null;
let wireListening = false;
let wirePacketCount = 0;
let wireByteCount = 0;
let wireStatsInterval = null;
let wireSimOsc = null;

const SPY_PHRASES_EN = [
 'AGENT BRAVO: The package arrives at midnight.',
 'CONTROL: Proceed to extraction point delta.',
 'OPERATIVE: Surveillance confirms target in building.',
 'HANDLER: Switch to encrypted channel seven.',
 'FIELD UNIT: Cover blown — abort mission immediately.',
 'DISPATCH: Asset confirmed at rendezvous coordinates.',
 'INTEL: Signal intercepted — decryption in progress.',
 'BASE: Activate protocol NIGHTFALL immediately.',
 'SHADOW: Target is moving northeast on foot.',
 'OVERWATCH: All units hold position until further notice.',
];

const SPY_PHRASES_FR = [
 'AGENT BRAVO: Le colis arrive à minuit.',
 'CONTRÔLE: Procédez au point d\'extraction delta.',
 'OPÉRATEUR: Surveillance confirme cible dans le btiment.',
 'COMMANDANT: Passez au canal crypté sept.',
 'UNITÉ TERRAIN: Couverture grillée — abandon immédiat.',
 'DISPATCH: Agent confirmé aux coordonnées de rendez-vous.',
 'RENSEIGNEMENT: Signal intercepté — décryptage en cours.',
 'BASE: Activez le protocole NUIT NOIRE immédiatement.',
 'OMBRE: La cible se déplace au nord-est à pied.',
 'VIGIE: Toutes les unités maintiennent position.',
];

const SPY_PHRASES_AR = [
 'العميل برافو: الطرد يصل عند منتصف الليل.',
 'القيادة: توجّه إلى نقطة الاستخراج دلتا.',
 'العنصر: المراقبة تؤكد وجود الهدف في المبنى.',
 'المشرف: انتقل إلى القناة المشفّرة سبعة.',
 'الوحدة الميدانية: الغطاء انكشف — أجهض المهمة فورًا.',
 'الإرسال: تأكّد العنصر عند إحداثيات نقطة اللقاء.',
 'الاستخبارات: إشارة مُعترضة — فك التشفير جارٍ.',
 'القاعدة: فعّل بروتوكول الليل الأسود فورًا.',
 'الظل: الهدف يتحرك شمال شرق سيرًا على الأقدام.',
 'المراقبة: جميع الوحدات تحافظ على مواقعها.',
];

function getSpyPhrases() {
 if (currentLang === 'fr') return SPY_PHRASES_FR;
 if (currentLang === 'ar') return SPY_PHRASES_AR;
 return SPY_PHRASES_EN;
}

function getPacketLoss() {
 const slider = $('packetLossSlider');
...
function drawWaveform(analyser, canvas) {
 ...
 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#33ff33';
 ctx.lineWidth = 2;
 ...
 // simulate packet loss — replace lost samples with 128 (silence)
 const val = (Math.random() < loss) ? 128 : data[i];
 const y = (val / 255) * h;
 ...
 const volBar = $('volumeMeter');
 if (volBar) volBar.style.width = Math.min(100, rms * 300) + '%';

 // Simulate BLE packetization stats
 const samplesPerFrame = Math.floor(8000 / 60); // ~133 samples at 8kHz per frame
 const packetsThisFrame = Math.ceil(samplesPerFrame / 20);
 const lostPackets = Math.floor(packetsThisFrame * loss);
 const sentPackets = packetsThisFrame - lostPackets;
 wirePacketCount += sentPackets;
 wireByteCount += sentPackets * 20;

 wireAnimFrame = requestAnimationFrame(() => drawWaveform(analyser, canvas));
}

function updateStreamStats() {
 const pEl = $('statPackets');
 const bEl = $('statBytes');
 const lEl = $('statLatency');
 if (pEl) pEl.textContent = wirePacketCount.toLocaleString();
 if (bEl) {
 const kb = wireByteCount / 1024;
 bEl.textContent = kb < 1024 ? kb.toFixed(1) + ' KB' : (kb / 1024).toFixed(2) + ' MB';
 }
 if (lEl) {
 const baseLat = 7.5; // BLE min connection interval in ms
 const loss = getPacketLoss();
 const simLat = baseLat + (loss * 50) + (Math.random() * 5);
 lEl.textContent = simLat.toFixed(1) + ' ms';
 }
}

function startListening() {
 if (wireListening) {
 log(LANG[currentLang].alreadyListening, 'info');
 return;
 }
 ...
 if (!wireAudioCtx) wireAudioCtx = new (window.AudioContext || window.webkitAudioContext)();

 wireAnalyser = wireAudioCtx.createAnalyser();
 wireAnalyser.fftSize = 2048;

 // Try real microphone first, fall back to sine wave
 navigator.mediaDevices.getUserMedia({ audio: true }).then(stream => {
 wireStream = stream;
 wireSource = wireAudioCtx.createMediaStreamSource(stream);
 wireSource.connect(wireAnalyser);
 wireListening = true;
 setStatus(true);
 drawWaveform(wireAnalyser, canvas);
 wireStatsInterval = setInterval(updateStreamStats, 500);
 log(LANG[currentLang].micStarted, 'success');
 playSound('success');
 }).catch(() => {
 // Fallback: generate a sine wave
 wireSimOsc = wireAudioCtx.createOscillator();
 wireSimOsc.type = 'sine';
 wireSimOsc.frequency.value = 440;
 const gain = wireAudioCtx.createGain();
 gain.gain.value = 0.3;
 wireSimOsc.connect(gain);
 gain.connect(wireAnalyser);
 wireSimOsc.start();
 wireListening = true;
 setStatus(true);
 drawWaveform(wireAnalyser, canvas);
 wireStatsInterval = setInterval(updateStreamStats, 500);
 log(LANG[currentLang].micDenied, 'info');
...
function stopListening() {
 if (!wireListening) {
 log(LANG[currentLang].notListening, 'info');
 return;
 }
 wireListening = false;
 if (wireAnimFrame) cancelAnimationFrame(wireAnimFrame);
 if (wireStatsInterval) clearInterval(wireStatsInterval);
 if (wireStream) {
 wireStream.getTracks().forEach(t => t.stop());
 wireStream = null;
 }
 if (wireSimOsc) {
 try { wireSimOsc.stop(); } catch {}
 wireSimOsc = null;
 }
 if (wireSource) {
 try { wireSource.disconnect(); } catch {}
 wireSource = null;
 }
 setStatus(false);
 const volBar = $('volumeMeter');
 if (volBar) volBar.style.width = '0%';
 log(LANG[currentLang].streamStopped, 'info');
 playSound('click');
}
...
function doTranscribe() {
 ...
 log(s.transcribing, 'tx');
 showToast(s.transcribing, 2000);

 const phrases = getSpyPhrases();
 const loss = getPacketLoss();

 setTimeout(() => {
 let phrase = phrases[Math.floor(Math.random() * phrases.length)];

 // Apply noise based on packet loss
 if (loss > 0) {
 ...
 area.textContent += `[${timestamp}] ${phrase}\n`;
 area.scrollTop = area.scrollHeight;
 log(`📝 ${phrase.substring(0, 50)}...`, 'rx');
 playSound('success');
 }, 800 + Math.random() * 700);
}

function initMicroWire() {
 // Main card buttons
 const listenBtn = $('listenBtn');
 const stopBtn = $('stopBtn');
 const transcribeBtn = $('transcribeBtn');
 if (listenBtn) listenBtn.onclick = () => { startListening(); playSound('click'); };
 if (stopBtn) stopBtn.onclick = () => { stopListening(); };
 if (transcribeBtn) transcribeBtn.onclick = () => { doTranscribe(); playSound('click'); };

 // Lab section buttons
 const labStartBtn = $('labStartBtn');
 const labStopBtn = $('labStopBtn');
 if (labStartBtn) labStartBtn.onclick = () => { startListening(); playSound('click'); };
 if (labStopBtn) labStopBtn.onclick = () => { stopListening(); };

 // Packet loss slider
 const plSlider = $('packetLossSlider');
 const plValue = $('packetLossValue');
 if (plSlider && plValue) {
 plSlider.addEventListener('input', () => {
 plValue.textContent = plSlider.value + '%';
 });
 }

 // Sample rate slider
 const srSlider = $('sampleRateSlider');
 const srValue = $('sampleRateValue');
 if (srSlider && srValue) {
 srSlider.addEventListener('input', () => {
 srValue.textContent = srSlider.value + ' Hz';
 });
 }
}
