...
const LANG = {
  en: {
    ...
    howto_4: 'Open the Lab section to experiment with packet loss and sample rate sliders.',
  ...
  ar: {
    ...
    howto_4: 'افتح قسم المختبر لتجربة أشرطة تمرير فقدان الحزم ومعدل العينات.',
