...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-4A7660',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Agent Id \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Agent Id', subtitle: '🪪 identity · 🔐 crypto · 📡 BLE',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Agent ID — Identity Auth', mainDesc: 'Create and verify encrypted agent identities via BLE',
 sectionA: 'How It Works', sectionB: 'Lab', sectionC: 'Challenge',
 noAgent: 'NO AGENT', generateFirst: 'Generate an identity first',
 publicKeyLabel: 'Public Key', noKeyYet: 'No key generated yet',
 genBtn: 'Generate Identity', broadcastBtn: 'Broadcast ID', verifyBtn: 'Verify Agent',
 verified: 'VERIFIED', impostor: 'IMPOSTOR',
 verifiedMsg: 'Agent identity is authentic!', impostorMsg: 'WARNING — Forged identity detected!',
 generating: 'Generating key pair...', generated: 'Agent identity created!',
 broadcasting: 'Broadcasting signed token via BLE...', broadcastDone: 'BLE broadcast complete',
 verifying: 'Scanning for nearby agent...', noIdentity: 'Generate an identity first!',
 step1Title: 'Generate Keys', step1Desc: 'A public/private key pair is created. The private key stays secret, the public key is shared.',
 step2Title: 'Sign Identity', step2Desc: 'Your agent ID (codename + clearance + hash) is signed with the private key to create a token.',
 step3Title: 'Broadcast via BLE', step3Desc: 'The signed ID token is broadcast as a BLE advertisement packet for nearby agents to receive.',
 step4Title: 'Verify Signature', step4Desc: 'The receiver uses the sender\'s public key to verify the signature. Match = VERIFIED, mismatch = IMPOSTOR.',
 labExp1Title: 'Experiment 1: Multiple Identities', labExp1Desc: 'Generate several agent identities and observe how each has a unique key pair and hash. Notice that even small changes produce completely different hashes.',
 labMultiGen: 'Generate 3 Agents',
 labExp2Title: 'Experiment 2: Forge an ID', labExp2Desc: 'Try to create a fake ID token by tampering with the signature. See what happens when verification is attempted on a forged identity.',
 labForge: 'Forge Identity',
 labExp3Title: 'Experiment 3: Authentic vs Forged', labExp3Desc: 'Compare verification results of an authentic identity versus a forged one side by side. Understand why cryptographic signatures cannot be faked without the private key.',
 labCompare: 'Compare Both',
 forgeResult: 'Forged identity FAILED verification — signature mismatch!',
 authResult: 'Authentic identity PASSED verification — signature valid!',
 ch1Title: 'Fake ID Challenge', ch1Desc: 'Try to create a fake agent ID that passes verification. Can you fool the system? Hint: you would need the original private key.',
 ch2Title: 'Multi-Factor Auth', ch2Desc: 'Design a system where an agent must prove identity using both a signed token AND a time-based one-time code. How would you implement the second factor?',
 ch3Title: 'Revocation System', ch3Desc: 'What happens if an agent\'s private key is compromised? Design a revocation list system that invalidates stolen identities. How would you distribute the revocation list via BLE?',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Agent Id simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how A public/private key pair is created. The private key stays ',
 ...
 wiki_sig_title: '🔏 Digital Signatures', wiki_sig: 'A digital signature proves that a message was created by a known sender and was not altered. It uses asymmetric cryptography: sign with private key, verify with public key.',
 wiki_pkcrypto_title: '🔑 Public Key Cryptography', wiki_pkcrypto: 'Also called asymmetric cryptography. A key pair is generated: a public key (shared freely) and a private key (kept secret). Data encrypted with one can only be decrypted with the other.',
 wiki_idverify_title: '🪪 Identity Verification', wiki_idverify: 'Identity verification confirms someone is who they claim to be. Digital systems use certificates, tokens, or challenge-response protocols tied to cryptographic keys.',
 wiki_bleauth_title: '📡 BLE Authentication', wiki_bleauth: 'Bluetooth Low Energy can broadcast small data packets. By including a signed identity token in a BLE advertisement, nearby devices can verify identity without pairing.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🪪 Agent ID ready — generate your identity!',
 ...
 wiki_compare: 'There are several approaches to covert operations. Hardware-based solutions using BBC micro:bit offer real-time performance and direct signal access. Software simulations (like this app) provide safe experimentation without equipment cost. Cloud-based platforms offer scalability but introduce latency and privacy concerns. Each approach has trade-offs: cost vs. fidelity, speed vs. safety, simplicity vs. capability. This simulation gives you the conceptual foundation to use any approach effectively.',
 ...
 gloss2_term: 'Header',
 gloss2_def: 'Metadata prepended to a packet containing source/destination addresses, protocol info, and error-checking fields. Headers enable routing and delivery.',
 gloss3_term: 'Collision',
 gloss3_def: 'When two different inputs produce the same hash output. A secure hash function makes finding collisions computationally infeasible (requires ~2^(n/2) attempts).',
 ...
 theory: 'Agent Id demonstrates key principles from covert operations. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Cryptographic hash functions map arbitrary data to fixed-size digests. They must be one-way (irreversible), collision-resistant, and avalanche (small input change → big output change). The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-4A7660',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Agent Id \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Agent Id', subtitle: '🪪 identité · 🔐 crypto · 📡 BLE',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Agent ID — Auth Identité', mainDesc: 'Créer et vérifier des identités d\'agents chiffrées via BLE',
 sectionA: 'Comment ça marche', sectionB: 'Labo', sectionC: 'Défi',
 noAgent: 'AUCUN AGENT', generateFirst: 'Génère d\'abord une identité',
 publicKeyLabel: 'Clé Publique', noKeyYet: 'Aucune clé générée',
 genBtn: 'Générer Identité', broadcastBtn: 'Diffuser ID', verifyBtn: 'Vérifier Agent',
 verified: 'VÉRIFIÉ', impostor: 'IMPOSTEUR',
 verifiedMsg: 'L\'identité de l\'agent est authentique !', impostorMsg: 'ALERTE — Identité falsifiée détectée !',
 generating: 'Génération de la paire de clés...', generated: 'Identité d\'agent créée !',
 broadcasting: 'Diffusion du token signé via BLE...', broadcastDone: 'Diffusion BLE terminée',
 verifying: 'Recherche d\'un agent à proximité...', noIdentity: 'Génère d\'abord une identité !',
 step1Title: 'Générer les Clés', step1Desc: 'Une paire clé publique/privée est créée. La clé privée reste secrète, la publique est partagée.',
 step2Title: 'Signer l\'Identité', step2Desc: 'Ton ID agent (nom de code + niveau + hash) est signé avec la clé privée pour créer un token.',
 step3Title: 'Diffuser via BLE', step3Desc: 'Le token signé est diffusé comme paquet BLE pour que les agents à proximité le reçoivent.',
 step4Title: 'Vérifier la Signature', step4Desc: 'Le récepteur utilise la clé publique de l\'émetteur pour vérifier la signature. Match = VÉRIFIÉ, écart = IMPOSTEUR.',
 labExp1Title: 'Expérience 1 : Identités Multiples', labExp1Desc: 'Génère plusieurs identités d\'agents et observe comment chacune possède une paire de clés et un hash uniques.',
 labMultiGen: 'Générer 3 Agents',
 labExp2Title: 'Expérience 2 : Falsifier un ID', labExp2Desc: 'Essaie de créer un faux token en modifiant la signature. Vois ce qui se passe quand on tente de vérifier une identité falsifiée.',
 labForge: 'Falsifier Identité',
 labExp3Title: 'Expérience 3 : Authentique vs Falsifié', labExp3Desc: 'Compare les résultats de vérification d\'une identité authentique versus falsifiée. Comprends pourquoi les signatures cryptographiques ne peuvent être falsifiées sans la clé privée.',
 labCompare: 'Comparer les Deux',
 forgeResult: 'L\'identité falsifiée a ÉCHOUÉ — signature invalide !',
 authResult: 'L\'identité authentique a RÉUSSI — signature valide !',
 ch1Title: 'Défi Faux ID', ch1Desc: 'Essaie de créer un faux ID qui passe la vérification. Peux-tu tromper le système ? Indice : il faudrait la clé privée originale.',
 ch2Title: 'Auth Multi-Facteurs', ch2Desc: 'Conçois un système où un agent doit prouver son identité avec un token signé ET un code temporaire. Comment implémenter le second facteur ?',
 ch3Title: 'Système de Révocation', ch3Desc: 'Que se passe-t-il si la clé privée d\'un agent est compromise ? Conçois un système de liste de révocation. Comment la distribuer via BLE ?',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Agent Id. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how A public/private key pair is created. The private key stays ',
 ...
 wiki_sig_title: '🔏 Signatures Numériques', wiki_sig: 'Une signature numérique prouve qu\'un message a été créé par un expéditeur connu et n\'a pas été altéré. Elle utilise la cryptographie asymétrique.',
 wiki_pkcrypto_title: '🔑 Cryptographie à Clé Publique', wiki_pkcrypto: 'Aussi appelée cryptographie asymétrique. Une paire de clés est générée : une clé publique (partagée) et une clé privée (secrète). Ce qui est chiffré avec l\'une ne peut être déchiffré qu\'avec l\'autre.',
 wiki_idverify_title: '🪪 Vérification d\'Identité', wiki_idverify: 'La vérification d\'identité confirme qu\'une personne est bien qui elle prétend être. Les systèmes numériques utilisent des certificats, tokens ou protocoles défi-réponse.',
 wiki_bleauth_title: '📡 Authentification BLE', wiki_bleauth: 'Le Bluetooth Low Energy peut diffuser de petits paquets de données. En incluant un token d\'identité signé dans une annonce BLE, les appareils à proximité peuvent vérifier l\'identité sans appairage.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🪪 Agent ID prêt — génère ton identité !',
 ...
 themeChanged: '🎨 Thème →',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que Agent Id ?',faq_a1:'Agent Id est une simulation interactive qui démontre les concepts de opérations secrètes. Create and verify encrypted agent identities via BLE. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de opérations secrètes. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de opérations secrètes. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut BBC micro:bit V2. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de opérations secrètes. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans Agent Id ! Regarde l\'écran principal — c\'est ici que la simulation de opérations secrètes fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de opérations secrètes.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Cryptographie',learn1Desc:'How secret codes protect messages from spies. Regarde la simulation pour voir ça en temps réel. La visualisation rend visible l\'invisible.',learn1Tag:'Cybersécurité',learn2Title:'Communication sans fil',learn2Desc:'How devices send invisible signals through the air. Les contrôles te permettent d\'expérimenter. Chaque changement révèle comment ce principe réagit.',learn2Tag:'Sans fil',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Sécurité',learn4Title:'Maths en sécurité',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Maths',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Débutant 🟢',learnLevel:'Niveau :',learnTimeVal:'15 min ⏱',learnTime:'Durée :',learnAgeVal:'10+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Agent Id ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de opérations secrètes — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how A public/private key pair is created. The private Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de opérations secrètes par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',codeTitle:'Code de Démarrage',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'Ce code active la radio du micro:bit sur le groupe 42 à pleine puissance. Quand le bouton A est pressé, il diffuse "HELLO". Tout message reçu défile sur l\'écran LED. Les numéros de groupe fonctionnent comme des canaux.',purpose:'Agent Id : Create and verify encrypted agent identities via BLE. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'esc-dead-drop-network',related1_desc:'',related1_path:'../../55-escape-evasion/esc-dead-drop-network/index.html',related2_name:'esc-airgap-jumper',related2_desc:'',related2_path:'../../55-escape-evasion/esc-airgap-jumper/index.html',related3_name:'Radar d\\',related3_desc:'Scanner les appareils WiFi à portée',related3_path:'../../02-spy-esp32/esp-dead-zone/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'',pathPrev_path:'',pathNext_name:'Dead Drop — Transfert BLE',pathNext_path:'../../01-spy-microbit/bit-dead-drop/index.html',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Qu\'est-ce que l\'apprentissage automatique ?',quiz_q1a:'Programmer des robots',quiz_q1b:'Systèmes apprenant des données',quiz_q1c:'Calcul manuel',quiz_q1d:'Conception matérielle',quiz_q1_answer:'1',quiz_q2:'Qu\'est-ce qu\'une boîte aux lettres morte ?',quiz_q2a:'Connexion échouée',quiz_q2b:'Lieu secret pour échanger des messages',quiz_q2c:'Antenne cassée',quiz_q2d:'Fréquence vide',quiz_q2_answer:'1',quiz_q3:'En Morse, que représente la lettre E ?',quiz_q3a:'Trait',quiz_q3b:'Un point',quiz_q3c:'Deux points',quiz_q3d:'Point-trait',quiz_q3_answer:'1',quiz_q4:'Quel langage est couramment utilisé pour programmer le micro:bit ?',quiz_q4a:'Java',quiz_q4b:'MicroPython',quiz_q4c:'Ruby',quiz_q4d:'Swift',quiz_q4_answer:'1',quiz_q5:'Qui a inventé le code Morse ?',quiz_q5a:'Tesla',quiz_q5b:'Samuel Morse',quiz_q5c:'Edison',quiz_q5d:'Bell',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'Les stations de nombres diffusent des messages chiffrés par ondes courtes aux agents de terrain depuis la Guerre froide. UVB-76 émet un bourdonnement monotone depuis 1982.',realworld2:'L\'affaire Aldrich Ames (1994) a révélé comment une taupe de la CIA utilisait des boîtes aux lettres mortes pour transmettre des renseignements classifiés à l\'Union soviétique pendant près d\'une décennie.',realworld3:'L\'opération Ivy Bells (1970-80) était une mission conjointe NSA/Marine pour intercepter les cbles de communication sous-marins soviétiques en mer d\'Okhotsk.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En opérations secrètes, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en opérations secrètes et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'Agent Id illustre un concept fondamental en opérations secrètes. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans Agent Id ont des applications directes dans le monde réel. Les professionnels de opérations secrètes utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, micro:bit et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en opérations secrètes implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'L\x27accéléromètre du micro:bit est sensible aux changements de température. Laissez votre appareil chauffer 2 minutes avant les mesures précises.',proTip2:'Vérifiez toujours le niveau de batterie avant les opérations terrain. Un micro:bit mourant produit des lectures capteur peu fiables.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'Pendant la Guerre froide, la CIA a construit une libellule robot dans les années 1970 pour transporter un microphone miniature. Le projet Insectothopter a été abandonné car il ne pouvait pas voler dans le vent.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de opérations secrètes',
 wiki_history: 'Encryption dates back to ancient Egypt (1900 BCE). The Caesar cipher, Enigma machine, and modern AES represent key milestones in cryptographic evolution. Agent Id s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Agent Id',
 wiki_math: 'Les mathématiques derrière Agent Id : Modern encryption relies on computational hardness: integer factorization (RSA), discrete logarithms (Diffie-Hellman), and elliptic curves (ECC). Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time. Birthday paradox: collision probability exceeds 50% after ~2^(n/2) hashes, not 2^n. For SHA-256, that is 2^128 — still computationally infeasible.',
 ...
 wiki_compare: 'Il existe plusieurs approches pour opérations secrètes. Les solutions matérielles avec BBC micro:bit offrent des performances en temps réel. Les simulations logicielles (comme cette app) permettent une expérimentation sûre sans coût de matériel. Les plateformes cloud offrent une évolutivité mais introduisent latence et préoccupations de confidentialité. Cette simulation vous donne les bases pour utiliser efficacement toute approche.',
 ...
 theory: 'Agent Id démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Cryptographic hash functions map arbitrary data to fixed-size digests. They must be one-way (irreversible), collision-resistant, and avalanche (small input change → big output change). La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Agent Id', subtitle: '🪪 هوية · 🔐 تشفير · 📡 بلوتوث',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'هوية العميل — مصادقة الهوية', mainDesc: 'إنشاء والتحقق من هويات العملاء المشفرة عبر BLE',
 sectionA: 'كيف يعمل', sectionB: 'المختبر', sectionC: 'التحدي',
 noAgent: 'لا يوجد عميل', generateFirst: 'أنشئ هوية أولاً',
 publicKeyLabel: 'المفتاح العام', noKeyYet: 'لم يتم إنشاء مفتاح بعد',
 genBtn: 'إنشاء هوية', broadcastBtn: 'بث الهوية', verifyBtn: 'التحقق من عميل',
 verified: 'تم التحقق', impostor: 'محتال',
 verifiedMsg: 'هوية العميل أصلية!', impostorMsg: 'تحذير — تم اكتشاف هوية مزورة!',
 generating: 'جارٍ إنشاء زوج المفاتيح...', generated: 'تم إنشاء هوية العميل!',
 broadcasting: 'جارٍ بث التوكن الموقّع عبر BLE...', broadcastDone: 'اكتمل البث عبر BLE',
 verifying: 'جارٍ البحث عن عميل قريب...', noIdentity: 'أنشئ هوية أولاً!',
 step1Title: 'إنشاء المفاتيح', step1Desc: 'يتم إنشاء زوج مفاتيح عام/خاص. المفتاح الخاص يبقى سرياً، والعام يتم مشاركته.',
 step2Title: 'توقيع الهوية', step2Desc: 'يتم توقيع هوية العميل (الاسم الرمزي + المستوى + الهاش) بالمفتاح الخاص لإنشاء توكن.',
 step3Title: 'البث عبر BLE', step3Desc: 'يتم بث التوكن الموقّع كحزمة إعلان BLE ليستقبلها العملاء القريبون.',
 step4Title: 'التحقق من التوقيع', step4Desc: 'يستخدم المستقبل المفتاح العام للمرسل للتحقق من التوقيع. تطابق = تم التحقق، عدم تطابق = محتال.',
 labExp1Title: 'تجربة 1: هويات متعددة', labExp1Desc: 'أنشئ عدة هويات ولاحظ كيف أن لكل واحدة زوج مفاتيح وهاش فريد. لاحظ أن التغييرات الصغيرة تنتج هاشات مختلفة تماماً.',
 labMultiGen: 'إنشاء 3 عملاء',
 labExp2Title: 'تجربة 2: تزوير هوية', labExp2Desc: 'حاول إنشاء توكن مزيف بالتلاعب بالتوقيع. شاهد ما يحدث عند محاولة التحقق من هوية مزورة.',
 labForge: 'تزوير هوية',
 labExp3Title: 'تجربة 3: أصلي مقابل مزور', labExp3Desc: 'قارن نتائج التحقق بين هوية أصلية ومزورة. افهم لماذا لا يمكن تزوير التوقيعات بدون المفتاح الخاص.',
 labCompare: 'مقارنة الاثنين',
 forgeResult: 'الهوية المزورة فشلت في التحقق — عدم تطابق التوقيع!',
 authResult: 'الهوية الأصلية نجحت في التحقق — التوقيع صالح!',
 ch1Title: 'تحدي الهوية المزيفة', ch1Desc: 'حاول إنشاء هوية مزيفة تجتاز التحقق. هل يمكنك خداع النظام؟ تلميح: ستحتاج المفتاح الخاص الأصلي.',
 ch2Title: 'المصادقة متعددة العوامل', ch2Desc: 'صمم نظاماً يجب فيه على العميل إثبات هويته باستخدام توكن موقّع ورمز مؤقت. كيف ستنفذ العامل الثاني؟',
 ch3Title: 'نظام الإلغاء', ch3Desc: 'ماذا يحدث إذا تم اختراق المفتاح الخاص لعميل؟ صمم نظام قائمة إلغاء يبطل الهويات المسروقة. كيف ستوزع قائمة الإلغاء عبر BLE؟',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Agent Id. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how A public/private key pair is created. The private key stays ',
 ...
 wiki_sig_title: '🔏 التوقيعات الرقمية', wiki_sig: 'التوقيع الرقمي يثبت أن الرسالة أُنشئت بواسطة مرسل معروف ولم يتم تعديلها. يستخدم التشفير غير المتماثل: التوقيع بالمفتاح الخاص، والتحقق بالعام.',
 wiki_pkcrypto_title: '🔑 تشفير المفتاح العام', wiki_pkcrypto: 'يُسمى أيضاً التشفير غير المتماثل. يتم إنشاء زوج مفاتيح: مفتاح عام (يُشارك بحرية) ومفتاح خاص (يبقى سرياً). ما يُشفّر بأحدهما لا يُفك إلا بالآخر.',
 wiki_idverify_title: '🪪 التحقق من الهوية', wiki_idverify: 'التحقق من الهوية يؤكد أن شخصاً ما هو فعلاً من يدّعي أنه. تستخدم الأنظمة الرقمية شهادات وتوكنات وبروتوكولات تحدي-استجابة مرتبطة بمفاتيح تشفيرية.',
 wiki_bleauth_title: '📡 مصادقة BLE', wiki_bleauth: 'يمكن لتقنية البلوتوث منخفض الطاقة بث حزم بيانات صغيرة. بتضمين توكن هوية موقّع في إعلان BLE، يمكن للأجهزة القريبة التحقق من الهوية بدون اقتران.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🪪 هوية العميل جاهزة — أنشئ هويتك!',
 ...
 themeChanged: '🎨 المظهر ←',sectionCode:'كود الجهاز',faq_q1:'ما هو Agent Id؟',faq_a1:'Agent Id هي محاكاة تفاعلية توضح مفاهيم العمليات السرية. Create and verify encrypted agent identities via BLE. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في العمليات السرية. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من العمليات السرية. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج BBC micro:bit V2. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من العمليات السرية. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في Agent Id! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة العمليات السرية.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالعمليات السرية.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'التشفير',learn1Desc:'How secret codes protect messages from spies. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'أمن سيبراني',learn2Title:'الاتصال اللاسلكي',learn2Desc:'How devices send invisible signals through the air. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'لاسلكي',learn3Title:'أمن العمليات',learn3Desc:'How to keep your operations secret and secure. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'أمان',learn4Title:'الرياضيات في الأمن',learn4Desc:'How numbers and algorithms make unbreakable codes. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'رياضيات',sectionLearn:'ماذا ستتعلم',learnLevelVal:'مبتدئ 🟢',learnLevel:'المستوى:',learnTimeVal:'15 min ⏱',learnTime:'المدة:',learnAgeVal:'10+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Agent Id! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـالعمليات السرية — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how A public/private key pair is created. The private لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم العمليات السرية من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',codeTitle:'كود البداية',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'يشغّل هذا الكود راديو micro:bit على المجموعة 42 بأقصى طاقة. عند الضغط على الزر A يبث "HELLO". أي رسالة مستلمة تمرر على شاشة LED.',purpose:'Agent Id: Create and verify encrypted agent identities via BLE. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ العمليات السرية',
 wiki_history: 'Encryption dates back to ancient Egypt (1900 BCE). The Caesar cipher, Enigma machine, and modern AES represent key milestones in cryptographic evolution. يبني Agent Id على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Agent Id',
 wiki_math: 'الرياضيات وراء Agent Id: Modern encryption relies on computational hardness: integer factorization (RSA), discrete logarithms (Diffie-Hellman), and elliptic curves (ECC). Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time. Birthday paradox: collision probability exceeds 50% after ~2^(n/2) hashes, not 2^n. For SHA-256, that is 2^128 — still computationally infeasible.',
 ...
 wiki_compare: 'هناك عدة أساليب في العمليات السرية. توفر الحلول المادية باستخدام BBC micro:bit أداءً في الوقت الفعلي. توفر المحاكاة البرمجية (مثل هذا التطبيق) تجربة آمنة بدون تكلفة المعدات. توفر المنصات السحابية قابلية التوسع لكنها تقدم تأخيراً ومخاوف تتعلق بالخصوصية. تمنحك هذه المحاكاة الأساس لاستخدام أي نهج بفعالية.',
 ...
 theory: 'Agent Id يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Cryptographic hash functions map arbitrary data to fixed-size digests. They must be one-way (irreversible), collision-resistant, and avalanche (small input change → big output change). تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'esc-dead-drop-network',related1_desc:'',related1_path:'../../55-escape-evasion/esc-dead-drop-network/index.html',related2_name:'esc-airgap-jumper',related2_desc:'',related2_path:'../../55-escape-evasion/esc-airgap-jumper/index.html',related3_name:'رادار الأجهزة',related3_desc:'فحص أجهزة WiFi في النطاق',related3_path:'../../02-spy-esp32/esp-dead-zone/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'',pathPrev_path:'',pathNext_name:'Dead Drop — نقل رسائل BLE',pathNext_path:'../../01-spy-microbit/bit-dead-drop/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ما هو التعلم الآلي؟',quiz_q1a:'برمجة الروبوتات',quiz_q1b:'أنظمة تتعلم من البيانات',quiz_q1c:'حساب يدوي',quiz_q1d:'تصميم العتاد',quiz_q1_answer:'1',quiz_q2:'ما هو صندوق البريد الميت؟',quiz_q2a:'اتصال فاشل',quiz_q2b:'موقع سري لتبادل الرسائل',quiz_q2c:'هوائي مكسور',quiz_q2d:'تردد فارغ',quiz_q2_answer:'1',quiz_q3:'في شيفرة مورس، ما يمثل الحرف E؟',quiz_q3a:'شرطة',quiz_q3b:'نقطة واحدة',quiz_q3c:'نقطتان',quiz_q3d:'نقطة-شرطة',quiz_q3_answer:'1',quiz_q4:'ما اللغة الشائعة لبرمجة micro:bit؟',quiz_q4a:'جافا',quiz_q4b:'مايكروبايثون',quiz_q4c:'روبي',quiz_q4d:'سويفت',quiz_q4_answer:'1',quiz_q5:'من اخترع شيفرة مورس؟',quiz_q5a:'تسلا',quiz_q5b:'صامويل مورس',quiz_q5c:'إديسون',quiz_q5d:'بيل',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'تبث محطات الأرقام رسائل مشفرة عبر الموجات القصيرة للعملاء الميدانيين منذ الحرب الباردة.',realworld2:'كشفت قضية ألدريتش أيمز (1994) كيف استخدم عميل مزدوج نقاط التسليم السرية لنقل معلومات استخبارية مصنفة للاتحاد السوفيتي لمدة عقد تقريبًا.',realworld3:'كانت عملية آيفي بيلز في السبعينيات والثمانينيات مهمة مشتركة بين وكالة الأمن القومي والبحرية للتنصت على كابلات الاتصالات السوفيتية تحت البحر.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في عمليات سرية معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في عمليات سرية وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Agent Id يوضح مفهومًا أساسيًا في عمليات سرية. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Agent Id لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في عمليات سرية هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ micro:bit وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال عمليات سرية يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'مقياس التسارع في micro:bit حساس لتغيرات درجة الحرارة. اترك جهازك يسخن لمدة دقيقتين قبل أخذ قياسات دقيقة.',proTip2:'تحقق دائمًا من مستوى البطارية قبل العمليات الميدانية. ينتج micro:bit الذي تنفد بطاريته قراءات مستشعر غير موثوقة.',funFactTitle:'🎯 هل تعلم؟',funFact:'خلال الحرب الباردة، بنت وكالة المخابرات المركزية يعسوبًا آليًا في السبعينيات لحمل ميكروفون مصغر. تم التخلي عن المشروع لأنه لم يستطع الطيران في الرياح.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
const CODENAMES = [
 'SHADOW', 'PHOENIX', 'VIPER', 'FALCON', 'GHOST', 'RAVEN', 'COBRA', 'STORM',
 'HAWK', 'WOLF', 'TITAN', 'CIPHER', 'SPECTRE', 'APEX', 'NEXUS', 'ONYX',
 'BLAZE', 'FROST', 'DAGGER', 'ECHO', 'PULSE', 'NOVA', 'ZERO', 'OMEGA'
];
const CLEARANCE_LEVELS = ['ALPHA', 'BETA', 'GAMMA', 'OMEGA'];
const AGENT_EMOJIS = ['🕵️', '🥷', '🦊', '🐺', '🦅', '🐍', '🤖', '🦇'];

let currentAgent = null;

// Simple hash function (simulated SHA-256)
function simpleHash(str) {
 ...
 seed ^= seed >>> 15;
 hash += (seed >>> 0).toString(16).padStart(4, '0');
 }
 return hash.slice(0, 64);
}

// Simulated key pair using simple math
function generateKeyPair() {
 const p = 61 + Math.floor(Math.random() * 200);
 const q = 53 + Math.floor(Math.random() * 200);
 const n = p * q;
 const phi = (p - 1) * (q - 1);
 let e = 17;
 while (phi % e === 0) e += 2;
 // Simulated private key (simplified modular inverse)
 let d = 1;
 while ((d * e) % phi !== 1) d++;
 if (d > 100000) d = d % 10000 + 3; // keep it reasonable for simulation
 return {
 publicKey: { e, n },
 privateKey: { d, n },
 pubHash: simpleHash(`${e}-${n}`).slice(0, 32)
 };
}

// Sign: "encrypt" hash with private key (simplified)
function signData(hash, privateKey) {
 const numHash = parseInt(hash.slice(0, 8), 16) % privateKey.n;
 // Simplified signing: (hash ^ d) mod n
 let sig = 1;
 let base = numHash % privateKey.n;
 let exp = privateKey.d % 1000; // keep reasonable
 for (let i = 0; i < exp; i++) {
 sig = (sig * base) % privateKey.n;
 }
 return sig.toString(16).padStart(8, '0') + '-' + simpleHash(hash + sig).slice(0, 24);
}

// Verify: check signature against public key
function verifySignature(hash, signature, publicKey) {
 // Re-sign with the stored private key info embedded in the agent
 // For simulation: we just check consistency
 const numHash = parseInt(hash.slice(0, 8), 16) % publicKey.n;
 const expectedSuffix = simpleHash(hash + (numHash % publicKey.n)).slice(0, 8);
 return signature.includes(expectedSuffix.slice(0, 4));
}

function generateAgent() {
 const s = LANG[currentLang];
 showToast(s.generating, 1500);
 log('🔐 ' + s.generating, 'info');
 ...
 const uid = simpleHash(codename + clearance + Date.now());
 const idHash = simpleHash(codename + clearance + uid);
 const signature = signData(idHash, keyPair.privateKey);

 currentAgent = {
 codename, clearance, emoji, uid, idHash, signature,
 keyPair, timestamp: Date.now()
 };

 // Update UI
 const codenameEl = $('agentCodename');
 const clearanceEl = $('agentClearance');
 const uidEl = $('agentUid');
 const photoEl = $('agentPhoto');
 const pubKeyEl = $('pubKeyHash');
 const stampEl = $('verifyStamp');
 const resultEl = $('verifyResult');

 if (codenameEl) codenameEl.textContent = codename;
 if (clearanceEl) {
 clearanceEl.innerHTML = '';
 const badge = document.createElement('span');
 badge.className = 'id-badge level-' + clearance.toLowerCase();
 badge.textContent = clearance;
 clearanceEl.appendChild(badge);
 }
 if (uidEl) uidEl.textContent = 'UID: ' + uid.slice(0, 32) + '...';
 if (photoEl) photoEl.textContent = emoji;
 if (pubKeyEl) pubKeyEl.textContent = keyPair.pubHash + '...';
 if (stampEl) { stampEl.className = 'verify-stamp'; stampEl.textContent = ''; }
 if (resultEl) resultEl.textContent = '';

 log('🪪 ' + s.generated + ' → ' + codename + ' [' + clearance + ']', 'success');
 log('🔑 Public key: ' + keyPair.pubHash.slice(0, 16) + '...', 'info');
 setStatus(true);
 playSound('success');
 hideToast();
 }, 800);
...
function broadcastIdentity() {
 const s = LANG[currentLang];
 if (!currentAgent) {
 log('⚠️ ' + s.noIdentity, 'error');
 playSound('error');
 return;
 }

 showToast(s.broadcasting, 3000);
 log('📡 ' + s.broadcasting, 'tx');

 // Simulate BLE packet broadcast
 const packets = [
 'ADV_IND [0x01] Flags: LE General Discoverable',
 'ADV_DATA [0x09] Name: AGENT-' + currentAgent.codename,
 'ADV_DATA [0xFF] Mfr: ' + currentAgent.idHash.slice(0, 16),
 'ADV_DATA [0x16] SvcData: SIG:' + currentAgent.signature.slice(0, 16) + '...',
 'ADV_DATA [0x0A] TxPower: -4 dBm',
 ];
...
function verifyAgent() {
 ...
 showToast(s.verifying, 2000);
 log('🔍 ' + s.verifying, 'info');

 setTimeout(() => {
 // Simulate receiving a broadcast — 80% chance it's the real agent
 const isAuthentic = Math.random() > 0.2;
 const stampEl = $('verifyStamp');
 const resultEl = $('verifyResult');
 const cardEl = $('agentCard');

 // Remove previous stamp animation
 if (stampEl) {
 stampEl.className = 'verify-stamp';
 stampEl.textContent = '';
 void stampEl.offsetWidth; // force reflow
 }

 if (isAuthentic) {
 log('📥 RX Received signed token from AGENT-' + currentAgent.codename, 'rx');
 log('🔓 Decrypting signature with public key...', 'info');
 setTimeout(() => {
 log('✅ ' + s.verifiedMsg, 'success');
 if (stampEl) {
 stampEl.textContent = s.verified;
 stampEl.classList.add('verified');
 }
 if (resultEl) {
 resultEl.style.color = '#2ecc71';
 resultEl.textContent = '✅ ' + s.verifiedMsg;
 }
 playSound('success');
 }, 600);
 } else {
 const fakeCodename = CODENAMES[Math.floor(Math.random() * CODENAMES.length)];
 log('📥 RX Received signed token from AGENT-' + fakeCodename, 'rx');
 log('🔓 Decrypting signature with public key...', 'info');
 setTimeout(() => {
 log('❌ ' + s.impostorMsg, 'error');
 if (stampEl) {
 stampEl.textContent = s.impostor;
 stampEl.classList.add('impostor');
 }
 if (resultEl) {
 resultEl.style.color = '#e74c3c';
 resultEl.textContent = '❌ ' + s.impostorMsg;
 }
 playSound('error');
 }, 600);
 }
...
// Lab: Generate 3 agents
function labMultiGen() {
 const resultEl = $('labMultiResult');
 if (!resultEl) return;
 resultEl.innerHTML = '';
 ...
 const uid = simpleHash(codename + clearance + Date.now() + i);
 const div = document.createElement('div');
 div.style.cssText = 'padding:0.4rem;margin:0.3rem 0;border-radius:6px;background:rgba(var(--accent-rgb,200,170,100),0.06);border:1px solid rgba(var(--accent-rgb,200,170,100),0.15);font-size:0.75rem;font-family:monospace;';
 div.innerHTML = '<strong>' + AGENT_EMOJIS[i % AGENT_EMOJIS.length] + '' + codename + '</strong> [' + clearance + ']<br>UID: ' + uid.slice(0, 24) + '...<br>PubKey: ' + kp.pubHash.slice(0, 20) + '...';
 resultEl.appendChild(div);
 log('🧪 Lab: Agent #' + (i + 1) + ' → ' + codename + ' [' + clearance + '] PK:' + kp.pubHash.slice(0, 12) + '...', 'info');
 }
 playSound('success');
}
...
function labForge() {
 const s = LANG[currentLang];
 const resultEl = $('labForgeResult');
 if (!resultEl) return;

 const fakeName = CODENAMES[Math.floor(Math.random() * CODENAMES.length)];
 const fakeHash = simpleHash(fakeName + 'FORGED' + Date.now());
 const fakeSig = 'FORGED-' + Math.random().toString(16).slice(2, 18);

 log('🧪 Lab: Attempting to forge identity for ' + fakeName + '...', 'info');
 log('🧪 Lab: Created fake signature: ' + fakeSig.slice(0, 16) + '...', 'tx');

 setTimeout(() => {
 log('❌ ' + s.forgeResult, 'error');
 resultEl.innerHTML = '<div style="padding:0.5rem;margin:0.3rem 0;border-radius:6px;background:#e74c3c22;border:1px solid #e74c3c55;font-size:0.8rem;color:#e74c3c;"><strong>❌ ' + s.impostor + '</strong><br>' + s.forgeResult + '</div>';
 playSound('error');
 }, 800);
}

// Lab: Compare authentic vs forged
function labCompare() {
 const s = LANG[currentLang];
 const resultEl = $('labCompareResult');
 if (!resultEl) return;
 ...
 const idHash = simpleHash(agent.codename + agent.clearance + Date.now());

 log('🧪 Lab: Comparing authentic vs forged for ' + agent.codename + '...', 'info');

 resultEl.innerHTML =
 '<div style="display:grid;grid-template-columns:1fr 1fr;gap:0.5rem;margin-top:0.5rem;">' +
 '<div style="padding:0.5rem;border-radius:6px;background:#2ecc7122;border:1px solid #2ecc7155;font-size:0.75rem;">' +
 '<strong style="color:#2ecc71;">✅ ' + s.verified + '</strong><br>' +
 'Agent: ' + agent.codename + '<br>' +
 'Key: ' + agent.keyPair.pubHash.slice(0, 16) + '...<br>' +
 '<em>' + s.authResult + '</em></div>' +
 '<div style="padding:0.5rem;border-radius:6px;background:#e74c3c22;border:1px solid #e74c3c55;font-size:0.75rem;">' +
 '<strong style="color:#e74c3c;">❌ ' + s.impostor + '</strong><br>' +
 'Agent: ' + agent.codename + ' (fake)<br>' +
 'Key: FORGED-' + Math.random().toString(16).slice(2, 10) + '...<br>' +
 '<em>' + s.forgeResult + '</em></div></div>';

 log('✅ ' + s.authResult, 'success');
 log('❌ ' + s.forgeResult, 'error');
 playSound('success');
}
...
function init() {
 ...
 const labMultiGenBtn = $('labMultiGenBtn');
 const labForgeBtn = $('labForgeBtn');
 const labCompareBtn = $('labCompareBtn');

 if (genBtn) genBtn.onclick = () => { generateAgent(); playSound('click'); };
 if (broadcastBtn) broadcastBtn.onclick = () => { broadcastIdentity(); playSound('click'); };
 if (verifyBtn) verifyBtn.onclick = () => { verifyAgent(); playSound('click'); };
 if (labMultiGenBtn) labMultiGenBtn.onclick = () => { labMultiGen(); playSound('click'); };
 if (labForgeBtn) labForgeBtn.onclick = () => { labForge(); playSound('click'); };
 if (labCompareBtn) labCompareBtn.onclick = () => { labCompare(); playSound('click'); };
