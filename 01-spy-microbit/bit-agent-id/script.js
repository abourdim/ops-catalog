...
const LANG = {
  en: {
    ...
    howto_4: 'Open the Lab section to experiment with forging and comparing identities.',
  ...
  fr: {
    ...
    howto_4: 'Ouvre la section Labo pour expérimenter avec la falsification et la comparaison d\'identités.',
  ...
  ar: {
    ...
    howto_4: 'افتح قسم المختبر لتجربة التزوير ومقارنة الهويات.',
