"""
bit-agent-id — micro:bit MicroPython
🪪 identity · 🔐 crypto · 📡 BLE
...
# ── Configuration ──
APP_NAME = "bit-agent-id"
RADIO_GROUP = 32
RADIO_POWER = 6  # 0-7

# ── Process Overview ──
# Step 1: A public/private key pair is created. The private key stays secret, the public key is shared.
# Step 2: Your agent ID (codename + clearance + hash) is signed with the private key to create a token.
# Step 3: The signed ID token is broadcast as a BLE advertisement packet for nearby agents to receive.
# Step 4: The receiver uses the sender\
