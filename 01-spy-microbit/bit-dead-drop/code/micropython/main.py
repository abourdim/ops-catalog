"""
bit-dead-drop — micro:bit MicroPython
...
# ── Configuration ──
APP_NAME = "bit-dead-drop"
RADIO_GROUP = 225
RADIO_POWER = 6  # 0-7

# ── Process Overview ──
# Step 1: Agent A writes a secret message and enters a shared key.
# Step 2: The message is encrypted using XOR cipher with the shared key.
# Step 3: The encrypted message is "dropped" via BLE broadcast into the air.
# Step 4: Agent B scans, receives the drop, and decrypts with the same key.
