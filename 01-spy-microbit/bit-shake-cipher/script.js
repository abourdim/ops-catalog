...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-B2AD1F',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Shake Cipher \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Shake Cipher', subtitle: '📳 shake · 🔐 cipher · 🔓 unlock',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Shake Cipher — Pattern Unlock', mainDesc: 'Create secret shake patterns to encrypt and unlock messages',
 sectionA: 'How It Works', sectionB: 'Lab — Shake Recorder', sectionC: 'Challenges',
 accelTitle: 'Accelerometer', patternTitle: 'Shake Pattern',
 patternHint: 'Move your mouse or shake your device to record',
 recordBtn: 'Record Pattern', patternEmpty: 'No pattern recorded yet',
 lockTitle: 'Message Lock', lockBtn: 'Lock', unlockBtn: 'Shake to Unlock',
 noLocked: 'No locked message', msgPlaceholder: 'Type your secret message...',
 stepA1: 'The micro:bit accelerometer measures movement on 3 axes (X, Y, Z) — detecting tilts, shakes, and gestures in real time.',
 stepA2: 'When you shake the device, the app records a sequence of acceleration values with timestamps, creating your unique shake pattern.',
 stepA3: 'The pattern is used as a key to encrypt your message. A hash of the shake sequence scrambles the text so only the same pattern can unlock it.',
 stepA4: 'To unlock, you reproduce the shake pattern. The app uses Dynamic Time Warping (DTW) to compare patterns, allowing slight timing variations while keeping security.',
 labTitle: 'Interactive Shake Recorder', labDesc: 'Move your mouse (or shake device) in the area below to simulate accelerometer input',
 simHint: 'Move here to generate accelerometer data',
 labCompareTitle: 'Pattern Comparison', labCompareDesc: 'Record two patterns and compare their similarity using DTW algorithm',
 labRecordA: 'Record A', labRecordB: 'Record B', labCompare: 'Compare',
 labPatternA: 'Pattern A: not recorded', labPatternB: 'Pattern B: not recorded',
 challengeTitle1: '🏅 Challenge 1 — Pattern Complexity',
 challengeDesc1: 'Record a pattern using at least 3 different movement directions (left-right, up-down, forward-back). Can you create a pattern that scores above 80% when you repeat it, but below 30% when someone else tries?',
 challengeTitle2: '🏅 Challenge 2 — Brute Force Test',
 challengeDesc2: 'Lock a message with your pattern. Now try unlocking it with 5 completely random shake patterns. How many false positives occur? What does this tell you about the security of physical authentication?',
 challengeTitle3: '🏅 Challenge 3 — False Positive Threshold',
 challengeDesc3: 'Experiment with the match threshold: at what percentage does the system become too lenient (letting wrong patterns through) vs. too strict (rejecting your own pattern)? Find the sweet spot between security and usability.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1: 'The main display shows the Shake Cipher simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 howto_4: 'Check the match score — the higher the percentage, the closer your unlock pattern matches the original.',
 wiki_accel_title: '📊 Accelerometer', wiki_accel: 'A sensor that measures proper acceleration (g-force) along 3 axes. The micro:bit accelerometer range is +/- 2g with 10-bit resolution.',
 wiki_pattern_title: '🔐 Pattern Recognition', wiki_pattern: 'Algorithms that identify regularities in data. Here we use Dynamic Time Warping (DTW) to match shake patterns despite timing variations.',
 wiki_auth_title: '🛡️ Physical Authentication', wiki_auth: 'Using physical actions (gestures, shakes, movements) as passwords. More intuitive than text passwords but requires pattern matching algorithms.',
 wiki_sensors_title: '📡 micro:bit Sensors', wiki_sensors: 'The micro:bit v2 includes: accelerometer, magnetometer, temperature sensor, microphone, touch sensor, and light level sensor.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📳 Shake Cipher ready!',
 ...
 theory: 'Shake Cipher demonstrates key principles from covert operations. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-B2AD1F',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Shake Cipher \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Shake Cipher', subtitle: '📳 secouer · 🔐 chiffrer · 🔓 déverrouiller',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Shake Cipher — Déverrouillage', mainDesc: 'Créez des motifs de secousse secrets pour chiffrer et déverrouiller des messages',
 sectionA: 'Comment ça marche', sectionB: 'Labo — Enregistreur', sectionC: 'Défis',
 accelTitle: 'Accéléromètre', patternTitle: 'Motif de secousse',
 patternHint: 'Bougez la souris ou secouez votre appareil pour enregistrer',
 recordBtn: 'Enregistrer le motif', patternEmpty: 'Aucun motif enregistré',
 lockTitle: 'Verrouillage de message', lockBtn: 'Verrouiller', unlockBtn: 'Secouer pour déverrouiller',
 noLocked: 'Aucun message verrouillé', msgPlaceholder: 'Tapez votre message secret...',
 stepA1: 'L\'accéléromètre du micro:bit mesure le mouvement sur 3 axes (X, Y, Z) — détectant inclinaisons, secousses et gestes en temps réel.',
 stepA2: 'Quand vous secouez l\'appareil, l\'appli enregistre une séquence de valeurs d\'accélération avec horodatage, créant votre motif de secousse unique.',
 stepA3: 'Le motif sert de clé pour chiffrer votre message. Un hash de la séquence brouille le texte pour que seul le même motif puisse le déverrouiller.',
 stepA4: 'Pour déverrouiller, reproduisez le motif. L\'appli utilise le Dynamic Time Warping (DTW) pour comparer les motifs, tolérant de légères variations de timing.',
 labTitle: 'Enregistreur interactif', labDesc: 'Bougez la souris (ou secouez) dans la zone ci-dessous pour simuler l\'accéléromètre',
 simHint: 'Bougez ici pour générer des données',
 labCompareTitle: 'Comparaison de motifs', labCompareDesc: 'Enregistrez deux motifs et comparez leur similarité avec l\'algorithme DTW',
 labRecordA: 'Enregistrer A', labRecordB: 'Enregistrer B', labCompare: 'Comparer',
 labPatternA: 'Motif A : non enregistré', labPatternB: 'Motif B : non enregistré',
 challengeTitle1: '🏅 Défi 1 — Complexité du motif',
 challengeDesc1: 'Enregistrez un motif avec au moins 3 directions (gauche-droite, haut-bas, avant-arrière). Pouvez-vous créer un motif qui obtient plus de 80% quand vous le répétez, mais moins de 30% quand quelqu\'un d\'autre essaie ?',
 challengeTitle2: '🏅 Défi 2 — Test de force brute',
 challengeDesc2: 'Verrouillez un message avec votre motif. Essayez de le déverrouiller avec 5 motifs aléatoires. Combien de faux positifs ? Qu\'est-ce que cela révèle sur la sécurité de l\'authentification physique ?',
 challengeTitle3: '🏅 Défi 3 — Seuil de faux positifs',
 challengeDesc3: 'Expérimentez avec le seuil de correspondance : à quel pourcentage le système devient-il trop permissif (laissant passer les mauvais motifs) vs. trop strict (rejetant votre propre motif) ?',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1: 'L écran principal affiche la simulation Shake Cipher. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 howto_4: 'Vérifiez le score — plus le pourcentage est élevé, plus votre motif de déverrouillage correspond à l\'original.',
 wiki_accel_title: '📊 Accéléromètre', wiki_accel: 'Un capteur mesurant l\'accélération (force g) sur 3 axes. La plage du micro:bit est +/- 2g avec une résolution de 10 bits.',
 wiki_pattern_title: '🔐 Reconnaissance de motifs', wiki_pattern: 'Algorithmes identifiant des régularités dans les données. Ici on utilise le DTW pour comparer les motifs malgré les variations de timing.',
 wiki_auth_title: '🛡️ Authentification physique', wiki_auth: 'Utiliser des actions physiques (gestes, secousses) comme mots de passe. Plus intuitif mais nécessite des algorithmes de correspondance.',
 wiki_sensors_title: '📡 Capteurs micro:bit', wiki_sensors: 'Le micro:bit v2 inclut : accéléromètre, magnétomètre, capteur de température, microphone, capteur tactile et capteur de lumière.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📳 Shake Cipher prêt !',
 ...
 theory: 'Shake Cipher démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Shake Cipher', subtitle: '📳 هزّ · 🔐 تشفير · 🔓 فتح',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'شفرة الهز — فتح بالنمط', mainDesc: 'أنشئ أنماط هز سرية لتشفير وفتح الرسائل',
 sectionA: 'كيف يعمل', sectionB: 'المختبر — مسجل الهز', sectionC: 'التحديات',
 accelTitle: 'مقياس التسارع', patternTitle: 'نمط الهز',
 patternHint: 'حرّك الفأرة أو هزّ جهازك للتسجيل',
 recordBtn: 'تسجيل النمط', patternEmpty: 'لم يتم تسجيل أي نمط بعد',
 lockTitle: 'قفل الرسالة', lockBtn: 'قفل', unlockBtn: 'هزّ لفتح القفل',
 noLocked: 'لا توجد رسالة مقفلة', msgPlaceholder: 'اكتب رسالتك السرية...',
 stepA1: 'يقيس مقياس التسارع في micro:bit الحركة على 3 محاور (X، Y، Z) — يكتشف الميل والهز والإيماءات في الوقت الفعلي.',
 stepA2: 'عندما تهزّ الجهاز، يسجل التطبيق تسلسل قيم التسارع مع الطوابع الزمنية، مما يُنشئ نمط هز فريد خاص بك.',
 stepA3: 'يُستخدم النمط كمفتاح لتشفير رسالتك. تجزئة تسلسل الهز تشوّش النص بحيث لا يمكن فك تشفيره إلا بنفس النمط.',
 stepA4: 'للفتح، أعد إنتاج نمط الهز. يستخدم التطبيق خوارزمية DTW لمقارنة الأنماط، مما يسمح بتفاوتات طفيفة في التوقيت مع الحفاظ على الأمان.',
 labTitle: 'مسجل الهز التفاعلي', labDesc: 'حرّك الفأرة (أو هزّ الجهاز) في المنطقة أدناه لمحاكاة مدخلات مقياس التسارع',
 simHint: 'حرّك هنا لتوليد بيانات التسارع',
 labCompareTitle: 'مقارنة الأنماط', labCompareDesc: 'سجّل نمطين وقارن تشابههما باستخدام خوارزمية DTW',
 labRecordA: 'تسجيل أ', labRecordB: 'تسجيل ب', labCompare: 'مقارنة',
 labPatternA: 'النمط أ: غير مسجل', labPatternB: 'النمط ب: غير مسجل',
 challengeTitle1: '🏅 التحدي 1 — تعقيد النمط',
 challengeDesc1: 'سجّل نمطًا باستخدام 3 اتجاهات حركة مختلفة على الأقل. هل يمكنك إنشاء نمط يحقق أكثر من 80% عند تكراره، لكن أقل من 30% عندما يحاول شخص آخر؟',
 challengeTitle2: '🏅 التحدي 2 — اختبار القوة الغاشمة',
 challengeDesc2: 'اقفل رسالة بنمطك. حاول فتحها بـ 5 أنماط عشوائية. كم عدد الإيجابيات الخاطئة؟ ماذا يخبرك هذا عن أمان المصادقة الفيزيائية؟',
 challengeTitle3: '🏅 التحدي 3 — عتبة الإيجابيات الخاطئة',
 challengeDesc3: 'جرّب مع عتبة المطابقة: عند أي نسبة يصبح النظام متساهلاً جدًا (يسمح بمرور الأنماط الخاطئة) مقابل صارم جدًا (يرفض نمطك)؟ اعثر على التوازن.',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Shake Cipher. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 howto_4: 'تحقق من نتيجة المطابقة — كلما ارتفعت النسبة، كان نمط الفتح أقرب للأصلي.',
 wiki_accel_title: '📊 مقياس التسارع', wiki_accel: 'مستشعر يقيس التسارع (قوة الجاذبية) على 3 محاور. نطاق micro:bit هو +/- 2g بدقة 10 بت.',
 wiki_pattern_title: '🔐 التعرف على الأنماط', wiki_pattern: 'خوارزميات تحدد الانتظامات في البيانات. هنا نستخدم DTW لمطابقة أنماط الهز رغم تفاوتات التوقيت.',
 wiki_auth_title: '🛡️ المصادقة الفيزيائية', wiki_auth: 'استخدام الإجراءات الفيزيائية (إيماءات، هز، حركات) ككلمات مرور. أكثر سهولة لكن تتطلب خوارزميات مطابقة.',
 wiki_sensors_title: '📡 مستشعرات micro:bit', wiki_sensors: 'يتضمن micro:bit v2: مقياس تسارع، مقياس مغناطيسي، مستشعر حرارة، ميكروفون، مستشعر لمس، ومستشعر مستوى الضوء.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '📳 شفرة الهز جاهزة!',
 ...
 theory: 'Shake Cipher يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
function init() {
 ...
 // Shake Cipher simulation
 initShakeCipher();

 log(LANG[currentLang].ready, 'success');
}

/* ═══════ SHAKE CIPHER — Simulation Logic ═══════ */

(function() {

 // --- State ---
 let currentAccel = { x: 0, y: 0, z: 0 };
 let mainPattern = []; // recorded lock pattern
 let isRecording = false;
 let recordTarget = 'main'; // 'main' | 'unlock' | 'labA' | 'labB'
 let recordBuffer = [];
 let recordTimer = null;
 let lockedCipher = null; // { cipher: Uint8Array, hash: number[] }
 let originalMessage = '';
 let labPatternA = [];
 let labPatternB = [];
 ...
 function updateAccelBars(x, y, z) {
 currentAccel = { x, y, z };
 const ax = $('accelX'), ay = $('accelY'), az = $('accelZ');
 if (ax) ax.style.height = Math.max(4, Math.abs(x) * 8) + 'px';
 if (ay) ay.style.height = Math.max(4, Math.abs(y) * 8) + 'px';
 if (az) az.style.height = Math.max(4, Math.abs(z) * 8) + 'px';
 const coords = $('simCoords');
 if (coords) coords.textContent = `X:${x.toFixed(1)} Y:${y.toFixed(1)} Z:${z.toFixed(1)}`;
 }
 ...
 const x = Math.max(-12, Math.min(12, dx * 0.5));
 const y = Math.max(-12, Math.min(12, dy * 0.5));
 const z = Math.max(-12, Math.min(12, (Math.abs(dx) + Math.abs(dy)) * 0.3 - 3));
 updateAccelBars(x, y, z);
 if (isRecording) {
 recordBuffer.push({ x, y, z, t: Date.now() });
 }
 }
 ...
 if (target === 'main' || target === 'unlock') {
 const btn = $('recordBtn');
 const unlockBtnEl = $('unlockBtn');
 if (target === 'main' && btn) {
 btn.innerHTML = `<span class="btn-icon recording-indicator">⏺</span> <span data-i18n="stopRecord">${s.stopRecord}</span>`;
 btn.onclick = () => stopRecording();
 }
 if (target === 'unlock' && unlockBtnEl) {
 unlockBtnEl.innerHTML = `<span class="btn-icon recording-indicator">⏺</span> <span data-i18n="stopRecord">${s.stopRecord}</span>`;
 unlockBtnEl.onclick = () => stopRecording();
 }
 }

 log(s.recording, 'info');
 showToast(s.recording, 0);

 // Auto-stop after 4 seconds
 recordTimer = setTimeout(() => stopRecording(), 4000);
 }
 ...
 hideToast();
 const s = LANG[currentLang];
 const pattern = normalizePattern(recordBuffer);

 if (recordTarget === 'main') {
 mainPattern = pattern;
 displayPattern('patternDisplay', pattern);
 const btn = $('recordBtn');
 if (btn) {
 btn.innerHTML = `<span class="btn-icon">🔴</span> <span data-i18n="recordBtn">${s.recordBtn}</span>`;
 btn.onclick = () => startRecording('main');
 }
 log(`${s.recordingDone} (${pattern.length}${s.patternPoints})`, 'success');
 } else if (recordTarget === 'unlock') {
 const unlockBtnEl = $('unlockBtn');
 if (unlockBtnEl) {
 unlockBtnEl.innerHTML = `<span class="btn-icon">🔓</span> <span data-i18n="unlockBtn">${s.unlockBtn}</span>`;
 unlockBtnEl.onclick = () => startRecording('unlock');
 }
 attemptUnlock(pattern);
 } else if (recordTarget === 'labA') {
 labPatternA = pattern;
 displayPattern('labPatternA', pattern);
 log(`${s.labRecordDone} A (${pattern.length}${s.patternPoints})`, 'success');
 enableLabCompare();
 } else if (recordTarget === 'labB') {
 labPatternB = pattern;
 displayPattern('labPatternB', pattern);
 log(`${s.labRecordDone} B (${pattern.length}${s.patternPoints})`, 'success');
 enableLabCompare();
 }
 ...
 result.push({ x: raw[i].x, y: raw[i].y, z: raw[i].z, t: raw[i].t - raw[0].t });
 }
 return result;
 }

 function displayPattern(elId, pattern) {
 const el = $(elId);
 if (!el) return;
 if (pattern.length === 0) {
 el.textContent = LANG[currentLang].patternEmpty;
 return;
 }
 const summary = pattern.map(p =>
 `[${p.x.toFixed(1)},${p.y.toFixed(1)},${p.z.toFixed(1)}]`
 ).join('');
 el.textContent = `${pattern.length} pts: ${summary}`;
 }

 // --- DTW (Dynamic Time Warping) Simplified ---
 function dtwDistance(a, b) {
 if (a.length === 0 || b.length === 0) return Infinity;
 const n = a.length, m = b.length;
 // Use reduced matrix for memory efficiency
 ...
 Math.pow(a[i-1].x - b[j-1].x, 2) +
 Math.pow(a[i-1].y - b[j-1].y, 2) +
 Math.pow(a[i-1].z - b[j-1].z, 2)
 );
 ...
 const maxExpectedDist = maxLen * 15; // rough upper bound
 const similarity = Math.max(0, Math.min(100, (1 - dist / maxExpectedDist) * 100));
 return Math.round(similarity);
 }

 // --- Encryption (XOR with pattern hash) ---
 function patternHash(pattern) {
 // Simple hash: sum of all values modulo 256 per position
 const hash = [];
 for (let i = 0; i < 256; i++) {
 const p = pattern[i % pattern.length];
 const v = Math.abs(Math.round((p.x * 17 + p.y * 31 + p.z * 53 + i * 7) * 100));
 hash.push(v % 256);
 }
 return hash;
 }

 function xorEncrypt(text, hash) {
 const encoder = new TextEncoder();
 const bytes = encoder.encode(text);
 const cipher = new Uint8Array(bytes.length);
 for (let i = 0; i < bytes.length; i++) {
 cipher[i] = bytes[i] ^ hash[i % hash.length];
 }
 return cipher;
 }

 function xorDecrypt(cipher, hash) {
 const bytes = new Uint8Array(cipher.length);
 for (let i = 0; i < cipher.length; i++) {
 bytes[i] = cipher[i] ^ hash[i % hash.length];
 }
 const decoder = new TextDecoder();
 return decoder.decode(bytes);
 }

 function cipherToHex(cipher) {
 return Array.from(cipher).map(b => b.toString(16).padStart(2, '0')).join('');
 }
 ...
 log(s.noPattern, 'error');
 showToast(s.noPattern, 2000);
 return;
 }
 if (!msg) {
 log(s.noMessage, 'error');
 showToast(s.noMessage, 2000);
 return;
 }

 const hash = patternHash(mainPattern);
 const cipher = xorEncrypt(msg, hash);
 lockedCipher = { cipher, hash };
 originalMessage = msg;

 const lockedEl = $('lockedMsg');
 if (lockedEl) lockedEl.textContent = '🔒 ' + cipherToHex(cipher);

 const unlockBtnEl = $('unlockBtn');
 if (unlockBtnEl) unlockBtnEl.disabled = false;

 if (input) input.value = '';
 log(s.locked, 'success');
 showToast(s.locked, 2000);
 playSound('success');
 }

 function attemptUnlock(unlockPattern) {
 const s = LANG[currentLang];
 if (!lockedCipher) {
 log(s.noLockedMsg, 'error');
 return;
 }

 const similarity = patternSimilarity(mainPattern, unlockPattern);
 const scoreEl = $('matchScore');
 if (scoreEl) scoreEl.textContent = `${s.matchResult}${similarity}%`;

 const THRESHOLD = 55;
 if (similarity >= THRESHOLD) {
 // Decrypt with original hash
 const decrypted = xorDecrypt(lockedCipher.cipher, lockedCipher.hash);
 const lockedEl = $('lockedMsg');
 if (lockedEl) lockedEl.textContent = '🔓 ' + decrypted;
 log(`${s.unlocked} (${similarity}%)`, 'success');
 showToast(`${s.unlocked} ${similarity}%`, 3000);
 playSound('success');
 } else {
 log(`${s.unlockFail} (${similarity}%)`, 'error');
 showToast(`${s.unlockFail} ${similarity}%`, 3000);
 playSound('error');
 }
 }

 // --- Lab ---
 function enableLabCompare() {
 const btn = $('labCompare');
 if (btn && labPatternA.length > 0 && labPatternB.length > 0) {
 btn.disabled = false;
 }
 }

 function labComparePatterns() {
 const s = LANG[currentLang];
 if (labPatternA.length === 0 || labPatternB.length === 0) {
 log(s.labNeedBoth, 'error');
 return;
 }
 const similarity = patternSimilarity(labPatternA, labPatternB);
 const scoreEl = $('labMatchScore');
 if (scoreEl) scoreEl.textContent = `${s.labCompareResult}${similarity}%`;
 log(`${s.labCompareResult}${similarity}%`, similarity >= 55 ? 'success' : 'info');
 playSound(similarity >= 55 ? 'success' : 'click');
 }

 // --- Init ---
 window.initShakeCipher = function() {
 // Mouse-based accelerometer simulation
 document.addEventListener('mousemove', onMouseMove);

 // DeviceMotion for mobile
 ...
 if (recordBtnEl) recordBtnEl.onclick = () => startRecording('main');

 const lockBtnEl = $('lockBtn');
 if (lockBtnEl) lockBtnEl.onclick = lockMessage;

 const unlockBtnEl = $('unlockBtn');
 if (unlockBtnEl) unlockBtnEl.onclick = () => startRecording('unlock');

 // Lab buttons
 const labRecA = $('labRecordA');
 if (labRecA) labRecA.onclick = () => startRecording('labA');

 const labRecB = $('labRecordB');
 if (labRecB) labRecB.onclick = () => startRecording('labB');

 const labCmp = $('labCompare');
 if (labCmp) labCmp.onclick = labComparePatterns;

 // Sim area enhanced tracking
 const simArea = $('simArea');
 if (simArea) {
 simArea.addEventListener('mousemove', (e) => {
 const rect = simArea.getBoundingClientRect();
 const cx = rect.left + rect.width / 2;
 const cy = rect.top + rect.height / 2;
 const x = ((e.clientX - cx) / (rect.width / 2)) * 10;
 const y = ((e.clientY - cy) / (rect.height / 2)) * 10;
 const z = Math.sin(Date.now() / 200) * 3;
 updateAccelBars(x, y, z);
 if (isRecording) {
 recordBuffer.push({ x, y, z, t: Date.now() });
 }
 ...
 log('📊 Accelerometer simulation active (mouse/touch)', 'info');
 };
