...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-997606',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Field Scanner \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Field Scanner', subtitle: '📡 scan · 🔐 assess · 🛡️ protect',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Field Scanner — Threat HUD', mainDesc: 'Multi-sensor threat assessment dashboard',
 ...
 howto_1: 'The main display shows the Field Scanner simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how All five sensors (light, temperature, accelerometer, compass',
 ...
 howto_4: 'Try the Challenges to test your understanding of sensor fusion and threat classification.',
 howItWorks1: 'All five sensors (light, temperature, accelerometer, compass, microphone) are polled simultaneously every scan cycle.',
 howItWorks2: 'Each raw reading is normalized to a 0–100 scale for consistent comparison across different sensor ranges.',
 howItWorks3: 'The threat algorithm combines all normalized readings using configurable weights to produce a single composite score.',
 howItWorks4: 'The composite score determines the alert level: GREEN (below 30), YELLOW (30–70), or RED (above 70).',
 wiki_fusion_title: '🔗 Sensor Fusion', wiki_fusion: 'Sensor fusion combines data from multiple sensors to produce more accurate and reliable information than any single sensor alone.',
 wiki_threat_title: '🚨 Threat Assessment', wiki_threat: 'Threat assessment uses weighted algorithms to classify environmental conditions into safety levels based on sensor data.',
 wiki_hud_title: '🖥️ HUD Design', wiki_hud: 'A heads-up display presents critical data in a clear, scannable format using gauges, color coding, and real-time updates.',
 wiki_microbit_title: '🤖 micro:bit Sensors', wiki_microbit: 'The micro:bit v2 includes light, temperature, accelerometer, compass, and microphone sensors, all accessible via simple APIs.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📡 Field Scanner ready!',
 ...
 theory: 'Field Scanner demonstrates key principles from covert operations. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-997606',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Field Scanner \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Field Scanner', subtitle: '📡 scanner · 🔐 évaluer · 🛡️ protéger',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Scanner de Terrain — HUD Menace', mainDesc: 'Tableau de bord multi-capteurs d\'évaluation des menaces',
 ...
 howto_1: 'L écran principal affiche la simulation Field Scanner. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how All five sensors (light, temperature, accelerometer, compass',
 ...
 howto_4: 'Essaie les Défis pour tester ta compréhension de la fusion de capteurs.',
 howItWorks1: 'Les cinq capteurs (lumière, température, accéléromètre, boussole, microphone) sont interrogés simultanément à chaque cycle.',
 howItWorks2: 'Chaque lecture brute est normalisée sur une échelle 0–100 pour une comparaison cohérente.',
 howItWorks3: 'L\'algorithme de menace combine toutes les lectures normalisées avec des poids configurables pour produire un score composite.',
 howItWorks4: 'Le score composite détermine le niveau d\'alerte : VERT (< 30), JAUNE (30–70) ou ROUGE (> 70).',
 wiki_fusion_title: '🔗 Fusion de Capteurs', wiki_fusion: 'La fusion de capteurs combine les données de plusieurs capteurs pour produire une information plus précise qu\'un seul capteur.',
 wiki_threat_title: '🚨 Évaluation des Menaces', wiki_threat: 'L\'évaluation utilise des algorithmes pondérés pour classer les conditions environnementales en niveaux de sécurité.',
 wiki_hud_title: '🖥️ Design HUD', wiki_hud: 'Un affichage tête haute présente les données critiques de manière claire avec des jauges, des codes couleur et des mises à jour en temps réel.',
 wiki_microbit_title: '🤖 Capteurs micro:bit', wiki_microbit: 'Le micro:bit v2 inclut des capteurs de lumière, température, accéléromètre, boussole et microphone, tous accessibles via des APIs simples.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📡 Scanner de terrain prêt !',
 ...
 themeChanged: '🎨 Thème →',
 threatGreen: 'NIVEAU DE MENACE : VERT', threatYellow: 'NIVEAU DE MENACE : JAUNE', threatRed: 'NIVEAU DE MENACE : ROUGE',
 gaugeLight: 'Lumière', gaugeTemp: 'Température', gaugeMotion: 'Mouvement', gaugeSound: 'Son', gaugeMag: 'Magnétique',
 startScan: 'Démarrer Scan', stopScan: 'Stop',
 labSimulators: 'Simulateurs de Capteurs', labRules: 'Règles de Menace Personnalisées', labHud: 'HUD Temps Réel',
 applyRules: 'Appliquer', rulesPlaceholder: 'light > 80 => +20\nmotion > 60 => +30\nsound > 70 => +25',
 challenge1Title: 'Défi 1 : Calibration de Salle',
 challenge1Desc: 'Calibre les seuils des capteurs pour ta salle actuelle. Ajuste les curseurs dans le Labo jusqu\'à ce que le HUD affiche VERT pour les conditions normales.',
 challenge2Title: 'Défi 2 : Détection d\'Intrus',
 challenge2Desc: 'Configure le scanner pour détecter l\'entrée d\'une personne. Utilise les seuils de mouvement et de son pour déclencher une alerte ROUGE uniquement pour une personne.',
 challenge3Title: 'Défi 3 : Catégorie de Menace Personnalisée',
 challenge3Desc: 'Crée une nouvelle catégorie de menace (ex : ORANGE pour les événements météo) en utilisant l\'éditeur de règles. Combine au moins 3 capteurs.',
 scanStarted: '📡 Scan démarré — interrogation des capteurs...',
 ...
 theory: 'Field Scanner démontre les principes clés de opérations secrètes. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Field Scanner', subtitle: '📡 مسح · 🔐 تقييم · 🛡️ حماية',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'ماسح الميدان — شاشة التهديد', mainDesc: 'لوحة تقييم التهديدات متعددة المستشعرات',
 ...
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Field Scanner. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how All five sensors (light, temperature, accelerometer, compass',
 ...
 howto_4: 'جرّب التحديات لاختبار فهمك لدمج المستشعرات وتصنيف التهديدات.',
 howItWorks1: 'يتم استطلاع المستشعرات الخمسة (ضوء، حرارة، تسارع، بوصلة، ميكروفون) في وقت واحد كل دورة مسح.',
 howItWorks2: 'يتم تطبيع كل قراءة خام إلى مقياس 0–100 للمقارنة المتسقة.',
 howItWorks3: 'خوارزمية التهديد تجمع كل القراءات المطبّعة بأوزان قابلة للتكوين لإنتاج نتيجة مركبة.',
 howItWorks4: 'النتيجة المركبة تحدد مستوى التنبيه: أخضر (أقل من 30)، أصفر (30–70) أو أحمر (أكثر من 70).',
 wiki_fusion_title: '🔗 دمج المستشعرات', wiki_fusion: 'دمج المستشعرات يجمع البيانات من عدة مستشعرات لإنتاج معلومات أكثر دقة من أي مستشعر وحده.',
 wiki_threat_title: '🚨 تقييم التهديدات', wiki_threat: 'تقييم التهديدات يستخدم خوارزميات موزونة لتصنيف الظروف البيئية إلى مستويات أمان.',
 wiki_hud_title: '🖥️ تصميم شاشة العرض', wiki_hud: 'شاشة العرض الرأسية تعرض البيانات الحرجة بوضوح باستخدام المقاييس والألوان والتحديثات الفورية.',
 wiki_microbit_title: '🤖 مستشعرات micro:bit', wiki_microbit: 'يتضمن micro:bit v2 مستشعرات ضوء وحرارة وتسارع وبوصلة وميكروفون، كلها متاحة عبر واجهات بسيطة.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '📡 ماسح الميدان جاهز!',
 ...
 themeChanged: '🎨 المظهر ←',
 threatGreen: 'مستوى التهديد: أخضر', threatYellow: 'مستوى التهديد: أصفر', threatRed: 'مستوى التهديد: أحمر',
 gaugeLight: 'الضوء', gaugeTemp: 'الحرارة', gaugeMotion: 'الحركة', gaugeSound: 'الصوت', gaugeMag: 'المغناطيسي',
 startScan: 'بدء المسح', stopScan: 'إيقاف',
 labSimulators: 'محاكيات المستشعرات', labRules: 'قواعد تهديد مخصصة', labHud: 'شاشة عرض فورية',
 applyRules: 'تطبيق', rulesPlaceholder: 'light > 80 => +20\nmotion > 60 => +30\nsound > 70 => +25',
 challenge1Title: 'التحدي 1: معايرة الغرفة',
 challenge1Desc: 'عاير حدود المستشعرات لغرفتك الحالية. اضبط المنزلقات في المختبر حتى يعرض HUD أخضر للظروف العادية وأصفر عند فتح نافذة.',
 challenge2Title: 'التحدي 2: اكتشاف الدخيل',
 challenge2Desc: 'اضبط الماسح لاكتشاف دخول شخص. استخدم حدود الحركة والصوت لتفعيل تنبيه أحمر فقط عند دخول شخص.',
 challenge3Title: 'التحدي 3: فئة تهديد مخصصة',
 challenge3Desc: 'صمم فئة تهديد جديدة (مثلاً: برتقالي لأحداث الطقس) باستخدام محرر القواعد. اجمع 3 مستشعرات على الأقل.',
 scanStarted: '📡 بدأ المسح — استطلاع المستشعرات...',
 scanStopped: '🛑 توقف المسح',
 intruderDetected: '🚨 تم اكتشاف دخيل — ذروة حركة!',
 rulesApplied: '✅ تم تطبيق قواعد التهديد المخصصة',
 threatAssessment: 'التهديد',step1Title:'تكوين',step1Desc:'All five sensors (light, temperature, accelerometer, compass, microphone) are polled simultaneously every scan cycle.',step2Title:'معالجة',step2Desc:'Each raw reading is normalized to a 0–100 scale for consistent comparison across different sensor ranges.',step3Title:'إرسال',step3Desc:'The threat algorithm combines all normalized readings using configurable weights to produce a single composite score.',step4Title:'تحقق',step4Desc:'The composite score determines the alert level: GREEN (below 30), YELLOW (30–70), or RED (above 70).',sectionCode:'كود الجهاز',faq_q1:'ما هو Field Scanner؟',faq_a1:'Field Scanner هي محاكاة تفاعلية توضح مفاهيم العمليات السرية. Multi-sensor threat assessment dashboard. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في العمليات السرية. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من العمليات السرية. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج BBC micro:bit V2. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من العمليات السرية. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في Field Scanner! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة العمليات السرية.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالعمليات السرية.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'التشفير',learn1Desc:'How secret codes protect messages from spies. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'أمن سيبراني',learn2Title:'الاتصال اللاسلكي',learn2Desc:'How devices send invisible signals through the air. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'لاسلكي',learn3Title:'أمن العمليات',learn3Desc:'How to keep your operations secret and secure. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'أمان',learn4Title:'الرياضيات في الأمن',learn4Desc:'How numbers and algorithms make unbreakable codes. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'رياضيات',sectionLearn:'ماذا ستتعلم',learnLevelVal:'مبتدئ 🟢',learnLevel:'المستوى:',learnTimeVal:'15 min ⏱',learnTime:'المدة:',learnAgeVal:'10+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Field Scanner! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـالعمليات السرية — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how All five sensors (light, temperature, acceleromete لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم العمليات السرية من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',ch1Title:'تشفير وفك تشفير',ch1Desc:'شفّر رسالة ثم حاول فك تشفيرها يدوياً بدون النظر للمفتاح. ما الأنماط التي تلاحظها؟',ch2Title:'اختبار التخفي',ch2Desc:'حاول إكمال المهمة بأقل بصمة إشارة ممكنة. هل يمكنك النزول تحت عتبة الكشف؟',ch3Title:'سباق الاعتراض',ch3Desc:'ابدأ بثاً وقِس سرعة اعتراضه. ما الذي يؤثر على وقت الكشف؟',codeTitle:'كود البداية',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'يشغّل هذا الكود راديو micro:bit على المجموعة 42 بأقصى طاقة. عند الضغط على الزر A يبث "HELLO". أي رسالة مستلمة تمرر على شاشة LED.',purpose:'Field Scanner: Multi-sensor threat assessment dashboard. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ العمليات السرية',
 wiki_history: 'BLE was introduced in Bluetooth 4.0 (2010) by Nokia. It reduced power consumption by 90% compared to classic Bluetooth, enabling battery-powered sensors. يبني Field Scanner على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Field Scanner',
 wiki_math: 'الرياضيات وراء Field Scanner: BLE uses Gaussian Frequency Shift Keying (GFSK) modulation at 1 Mbps. The modulation index of 0.5 provides optimal bandwidth efficiency. Scanning n ports on m hosts requires n×m probes. Parallelism and timeouts determine scan duration: T = (n×m×timeout)/concurrency.',
 ...
 theory: 'Field Scanner يوضح المبادئ الأساسية في العمليات السرية. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ FIELD SCANNER — SENSOR SIMULATION ═══════ */

let scanInterval = null;
let scanning = false;
let sensorData = { light: 0, temp: 22, motion: 0, sound: 0, mag: 180 };
let customRules = [];

// Sensor weights for threat calculation
const SENSOR_WEIGHTS = { light: 0.15, temp: 0.15, motion: 0.30, sound: 0.25, mag: 0.15 };

// Normalize raw sensor values to 0–100
function normalizeSensor(name, value) {
 switch (name) {
 case 'light': return (value / 255) * 100;
 case 'temp': return ((value + 10) / 60) * 100; // -10 to 50 → 0 to 100
 case 'motion': return (value / 2000) * 100;
 case 'sound': return (value / 255) * 100;
 case 'mag': return (value / 360) * 100;
 default: return 0;
 }
}
...
function calcThreatScore() {
 let score = 0;
 for (const [name, weight] of Object.entries(SENSOR_WEIGHTS)) {
 score += normalizeSensor(name, sensorData[name]) * weight;
 }
 // Apply custom rules bonus
 for (const rule of customRules) {
 const val = normalizeSensor(rule.sensor, sensorData[rule.sensor]);
 if (val > rule.threshold) score += rule.bonus;
 }
...
// Get bar color based on normalized percentage
function getBarColor(pct) {
 if (pct > 75) return '#ff1744';
...
function updateGauge(name, value, unit, min, max) {
 ...
 barEl.style.background = getBarColor(pct);
}

// Update all gauges from sensorData
function updateAllGauges() {
 updateGauge('light', sensorData.light, '', 0, 255);
 updateGauge('temp', sensorData.temp, '°C', -10, 50);
 updateGauge('motion', sensorData.motion, ' mg', 0, 2000);
 updateGauge('sound', sensorData.sound, '', 0, 255);
 updateGauge('mag', sensorData.mag, '°', 0, 360);
}
...
function updateThreatIndicator() {
 ...
 const el = $('threatLevel');
 if (!el) return;
 el.className = 'threat-indicator ' + level;
 const s = LANG[currentLang];
 const labelKey = 'threat' + level.charAt(0).toUpperCase() + level.slice(1);
 const span = el.querySelector('[data-i18n]');
 if (span) {
 span.dataset.i18n = labelKey;
 span.textContent = s[labelKey] || ('THREAT: ' + level.toUpperCase());
 }
 return { score, level };
}

// Add entry to threat log
function addThreatLogEntry(score, level) {
 const logEl = $('threatLog');
 if (!logEl) return;
 const time = new Date().toLocaleTimeString();
 const entry = document.createElement('div');
 entry.className = 'log-entry ' + level;
 entry.textContent = `[${time}] ${LANG[currentLang].threatAssessment}: ${Math.round(score)} — ${level.toUpperCase()}`;
...
// Add simulated noise to sensor readings
...
function simulateScan() {
 ...
 sensorData.light = Math.max(0, Math.min(255, addNoise(sensorData.light, 20)));
 sensorData.temp = Math.max(-10, Math.min(50, addNoise(sensorData.temp, 2)));
 sensorData.motion = Math.max(0, Math.min(2000, addNoise(sensorData.motion, 80)));
 sensorData.sound = Math.max(0, Math.min(255, addNoise(sensorData.sound, 15)));
 sensorData.mag = Math.max(0, Math.min(360, addNoise(sensorData.mag, 10)));

 // Random events: intruder spike (5% chance)
 if (Math.random() < 0.05) {
 sensorData.motion = Math.min(2000, sensorData.motion + 800 + Math.random() * 600);
 sensorData.sound = Math.min(255, sensorData.sound + 80 + Math.random() * 60);
 log(LANG[currentLang].intruderDetected, 'error');
 playSound('error');
 }

 // Gradual drift back toward baseline
 sensorData.light += (128 - sensorData.light) * 0.02;
 sensorData.temp += (22 - sensorData.temp) * 0.02;
 sensorData.motion += (100 - sensorData.motion) * 0.05;
 sensorData.sound += (30 - sensorData.sound) * 0.03;
 sensorData.mag += (180 - sensorData.mag) * 0.02;

 updateAllGauges();
 const result = updateThreatIndicator();
 if (result) addThreatLogEntry(result.score, result.level);
}
...
function startScan() {
 if (scanning) return;
 scanning = true;
 // Add scanning class for scan-line animation
 document.querySelectorAll('.sensor-gauge').forEach(g => g.classList.add('scanning'));
...
function stopScan() {
 ...
 document.querySelectorAll('.sensor-gauge').forEach(g => g.classList.remove('scanning'));
 setStatus(false);
...
function parseCustomRules(text) {
 ...
 if (match) {
 rules.push({ sensor: match[1], threshold: parseInt(match[2]), bonus: parseInt(match[3]) });
 }
 }
 return rules;
}

// Initialize lab sliders
function initLabSliders() {
 const sliders = [
 { id: 'simLight', valId: 'simLightVal', key: 'light' },
 { id: 'simTemp', valId: 'simTempVal', key: 'temp' },
 { id: 'simMotion', valId: 'simMotionVal', key: 'motion' },
 { id: 'simSound', valId: 'simSoundVal', key: 'sound' },
 { id: 'simMag', valId: 'simMagVal', key: 'mag' },
 ];
...
function initHudCanvas() {
 ...
 hudCtx.fillStyle = 'rgba(0,0,0,0.15)';
 hudCtx.fillRect(0, 0, w, h);

 // Radar circles
 hudCtx.strokeStyle = 'rgba(0,200,83,0.2)';
 hudCtx.lineWidth = 1;
 for (let i = 1; i <= 3; i++) {
 hudCtx.beginPath();
 hudCtx.arc(cx, cy, r * i / 3, 0, Math.PI * 2);
 hudCtx.stroke();
 }

 // Crosshairs
 hudCtx.strokeStyle = 'rgba(0,200,83,0.15)';
 hudCtx.beginPath();
 hudCtx.moveTo(cx - r, cy); hudCtx.lineTo(cx + r, cy);
 hudCtx.moveTo(cx, cy - r); hudCtx.lineTo(cx, cy + r);
 hudCtx.stroke();

 // Sweep line
 hudScanAngle += 0.02;
 const sx = cx + Math.cos(hudScanAngle) * r;
 const sy = cy + Math.sin(hudScanAngle) * r;
 const grad = hudCtx.createLinearGradient(cx, cy, sx, sy);
 const score = calcThreatScore();
 const color = score > 70 ? '255,23,68' : score > 30 ? '255,214,0' : '0,200,83';
 ...
 // Sweep arc fade
 hudCtx.fillStyle = `rgba(${color},0.05)`;
 hudCtx.beginPath();
 hudCtx.moveTo(cx, cy);
 hudCtx.arc(cx, cy, r, hudScanAngle - 0.5, hudScanAngle);
 hudCtx.closePath();
 hudCtx.fill();

 // Sensor blips (5 dots at normalized distances)
 const sensors = [
 { name: 'light', angle: 0 },
 { name: 'temp', angle: Math.PI * 0.4 },
 { name: 'motion', angle: Math.PI * 0.8 },
 { name: 'sound', angle: Math.PI * 1.2 },
 { name: 'mag', angle: Math.PI * 1.6 },
 ];
 for (const s of sensors) {
 const norm = normalizeSensor(s.name, sensorData[s.name]) / 100;
 const dist = norm * r;
 const bx = cx + Math.cos(s.angle) * dist;
 const by = cy + Math.sin(s.angle) * dist;
 const blipColor = norm > 0.7 ? '#ff1744' : norm > 0.3 ? '#ffd600' : '#00c853';
 hudCtx.fillStyle = blipColor;
 hudCtx.beginPath();
 hudCtx.arc(bx, by, 4, 0, Math.PI * 2);
 hudCtx.fill();
 // Glow
 hudCtx.fillStyle = blipColor.replace(')', ',0.3)').replace('rgb', 'rgba');
 hudCtx.beginPath();
 hudCtx.arc(bx, by, 8, 0, Math.PI * 2);
 hudCtx.fill();
 }

 // Score text
 hudCtx.fillStyle = `rgba(${color},0.9)`;
 hudCtx.font = '700 16px Orbitron, monospace';
 hudCtx.textAlign = 'center';
 hudCtx.fillText(Math.round(score), cx, cy + 6);

 // Labels
 hudCtx.font = '500 9px Orbitron, monospace';
 hudCtx.fillStyle = 'rgba(255,255,255,0.4)';
 const labels = ['LGT', 'TMP', 'MOT', 'SND', 'MAG'];
 for (let i = 0; i < sensors.length; i++) {
 const lx = cx + Math.cos(sensors[i].angle) * (r + 14);
 const ly = cy + Math.sin(sensors[i].angle) * (r + 14);
 hudCtx.fillText(labels[i], lx, ly);
 }

 hudAnim = requestAnimationFrame(drawHud);
 }
 drawHud();
}
...
function init() {
 ...
 // Apply custom rules button
 const applyBtn = $('applyRulesBtn');
 if (applyBtn) {
 applyBtn.onclick = () => {
 const editor = $('rulesEditor');
 if (editor) {
 customRules = parseCustomRules(editor.value);
 log(LANG[currentLang].rulesApplied, 'success');
 playSound('success');
 updateThreatIndicator();
 }
 };
