"""
bit-field-scanner — micro:bit MicroPython
📡 scan · 🔐 assess · 🛡️ protect
...
# ── Configuration ──
APP_NAME = "bit-field-scanner"
RADIO_GROUP = 43
RADIO_POWER = 6  # 0-7

# ── Process Overview ──
# Step 1: All five sensors (light, temperature, accelerometer, compass, microphone) are polled simultaneously every scan cycle.
# Step 2: Each raw reading is normalized to a 0–100 scale for consistent comparison across different sensor ranges.
# Step 3: The threat algorithm combines all normalized readings using configurable weights to produce a single composite score.
# Step 4: The composite score determines the alert level: GREEN (below 30), YELLOW (30–70), or RED (above 70).
