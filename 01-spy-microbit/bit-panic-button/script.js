...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-10CC3B',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Panic Button \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Panic Button', subtitle: '🆘 alert · 🔐 wipe · 📡 broadcast',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Panic Button — Emergency Alert',
 mainDesc: 'Broadcast emergency alerts and wipe sensitive data',
 ...
 howto_1:'The main display shows the Panic Button simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_emergency_title: '📡 Emergency Broadcast',
 wiki_emergency: 'An emergency broadcast sends a distress signal on all available radio channels so any nearby device can receive the alert.',
 wiki_secureerase_title: '🗑️ Secure Erase',
 wiki_secureerase: 'Secure erase overwrites data with random bytes before deletion, making recovery impossible even with forensic tools.',
 wiki_deadman_title: '💀 Dead Man Switch',
 wiki_deadman: 'A dead-man switch triggers automatically when a user fails to perform a periodic action, used as a safety mechanism.',
 wiki_radio_title: '📻 micro:bit Radio Broadcast',
 wiki_radio: 'The micro:bit radio module uses 2.4 GHz to send and receive messages between devices within range, on configurable groups.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🆘 Panic Button ready!',
 ...
 theory: 'Panic Button demonstrates key principles from covert operations. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-10CC3B',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Panic Button \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Panic Button', subtitle: '🆘 alerte · 🔐 effacement · 📡 diffusion',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Bouton Panique — Alerte d\'urgence',
 mainDesc: 'Diffuser des alertes d\'urgence et effacer les données sensibles',
 ...
 wiki_emergency_title: '📡 Diffusion d\'urgence',
 wiki_emergency: 'Une diffusion d\'urgence envoie un signal de détresse sur tous les canaux radio pour que tout appareil à proximité reçoive l\'alerte.',
 wiki_secureerase_title: '🗑️ Effacement sécurisé',
 wiki_secureerase: 'L\'effacement sécurisé écrase les données avec des octets aléatoires avant suppression, rendant la récupération impossible.',
 wiki_deadman_title: '💀 Interrupteur d\'homme mort',
 wiki_deadman: 'Un interrupteur d\'homme mort se déclenche automatiquement quand l\'utilisateur ne fait pas une action périodique.',
 wiki_radio_title: '📻 Radio micro:bit',
 wiki_radio: 'Le module radio du micro:bit utilise le 2.4 GHz pour envoyer et recevoir des messages entre appareils à portée.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🆘 Bouton Panique prêt !',
 ...
 theory: 'Panic Button démontre les principes clés de opérations secrètes. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Panic Button', subtitle: '🆘 تنبيه · 🔐 مسح · 📡 بث',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'زر الذعر — تنبيه طوارئ',
 mainDesc: 'بث تنبيهات الطوارئ ومسح البيانات الحساسة',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Panic Button. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_emergency_title: '📡 بث الطوارئ',
 wiki_emergency: 'بث الطوارئ يرسل إشارة استغاثة على جميع قنوات الراديو المتاحة حتى يتلقى أي جهاز قريب التنبيه.',
 wiki_secureerase_title: '🗑️ المسح الآمن',
 wiki_secureerase: 'المسح الآمن يستبدل البيانات ببايتات عشوائية قبل الحذف، مما يجعل الاسترداد مستحيلًا حتى بالأدوات الجنائية.',
 wiki_deadman_title: '💀 مفتاح الرجل الميت',
 wiki_deadman: 'مفتاح الرجل الميت يُفعّل تلقائيًا عندما يفشل المستخدم في تنفيذ إجراء دوري، ويُستخدم كآلية أمان.',
 wiki_radio_title: '📻 بث راديو micro:bit',
 wiki_radio: 'وحدة راديو micro:bit تستخدم 2.4 جيجاهرتز لإرسال واستقبال الرسائل بين الأجهزة ضمن النطاق، على مجموعات قابلة للتكوين.',
 working: 'جارٍ…',
 ...
 panicLabel: 'ذعر',
 cancelBtn: 'إلغاء',
 vaultEmpty: 'لا توجد ملفات محمّلة. استخدم المختبر لتحميل ملفات سرية.',
 step1_title: 'اكتشاف الذعر',
 step1_desc: 'يضغط المستخدم على زر الطوارئ مما يُفعّل بروتوكول الذعر.',
 step2_title: 'بدء العد التنازلي',
 step2_desc: 'عد تنازلي لمدة 5 ثوانٍ يمنحك نافذة للإلغاء في حالة الخطأ.',
 step3_title: 'بث التنبيه',
 step3_desc: 'يتم بث إشارة الطوارئ على جميع قنوات الراديو في آن واحد.',
 step4_title: 'مسح آمن للبيانات',
 step4_desc: 'يتم استبدال جميع الملفات الحساسة ببيانات عشوائية ثم حذفها نهائيًا.',
 labDesc: 'حمّل ملفات سرية مزيفة، اضبط العد التنازلي، اختبر تسلسل الذعر، وتحقق من تدمير البيانات.',
 countdownLabel: 'العد التنازلي (ث):',
 loadFiles: 'تحميل ملفات سرية',
 testPanic: 'اختبار تسلسل الذعر',
 verifyWipe: 'التحقق من المسح',
 resetLab: 'إعادة تعيين',
 challengeDesc: 'ادفع مهاراتك أبعد مع هذه التحديات المتقدمة.',
 ch1_title: 'الإلغاء قبل المسح',
 ch1_desc: 'ابدأ تسلسل الذعر وألغه قبل اكتمال مسح البيانات. هل يمكنك التغلب على الساعة؟',
 ch2_title: 'وضع الذعر الصامت',
 ch2_desc: 'صمّم ذعرًا صامتًا يمسح البيانات دون بث تنبيه. لا أحد يرى الإشارة.',
 ch3_title: 'مفتاح الرجل الميت',
 ch3_desc: 'نفّذ مفتاح الرجل الميت: إذا لم يضغط المستخدم على زر كل 30 ثانية، يتم تفعيل الذعر تلقائيًا.',
 panicTriggered: 'تم تفعيل الذعر!',
 countdownMsg: 'مسح البيانات خلال',
 broadcasting: 'جارٍ بث تنبيه الطوارئ...',
 broadcastCh: 'TX قناة',
 wipingFile: 'مسح الملف:',
 overwriting: 'استبدال ببيانات عشوائية...',
 wipeComplete: 'تم المسح — 0 ملفات متبقية',
 panicCancelled: 'تم إلغاء الذعر — العودة للوضع الطبيعي.',
 filesLoaded: 'تم تحميل الملفات السرية في الخزنة',
 noFilesToWipe: 'لا توجد ملفات في الخزنة للمسح.',
 alreadyActive: 'تسلسل الذعر نشط بالفعل!',
 wipeVerified: 'تم التحقق من الخزنة — جميع البيانات مُدمّرة.',
 wipeNotDone: 'البيانات لا تزال موجودة! لم يتم تنفيذ المسح.',
 resetDone: 'تمت إعادة تعيين النظام — تم تفريغ الخزنة.',
 sequenceComplete: 'اكتملت تسلسل الطوارئ.',step1Title:'تكوين',step1Desc:'اضبط معلمات المحاكاة واختر طريقة التشفير. شاهد التصور يتحدث في الوقت الفعلي أثناء هذه المرحلة. يعرض الشاشة بالضبط ما يحدث داخلياً — كل لون وحركة يمثل تحولاً محدداً في البيانات.',step2Title:'معالجة',step2Desc:'تتم معالجة البيانات عبر الخوارزمية أو التقنية المختارة. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',step3Title:'إرسال',step3Desc:'يتم إرسال الإشارة أو الرسالة المعالجة عبر قناة الاتصال. تحول هذه المرحلة بيانات الإدخال باستخدام الخوارزمية المعروضة. قارن القيم قبل وبعد لفهم العلاقة الرياضية.',step4Title:'تحقق',step4Desc:'يقوم المستقبل بفك التشفير والتحقق من البيانات المستلمة. ناتج هذه المرحلة يغذي المرحلة التالية. حاول التوقف هنا لفحص الحالة الوسيطة.',sectionCode:'كود الجهاز',faq_q1:'ما هو Panic Button؟',faq_a1:'Panic Button هي محاكاة تفاعلية توضح مفاهيم العمليات السرية. Broadcast emergency alerts and wipe sensitive data. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في العمليات السرية. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من العمليات السرية. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج BBC micro:bit V2. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من العمليات السرية. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في Panic Button! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة العمليات السرية.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالعمليات السرية.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'التشفير',learn1Desc:'How secret codes protect messages from spies. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'أمن سيبراني',learn2Title:'الاتصال اللاسلكي',learn2Desc:'How devices send invisible signals through the air. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'لاسلكي',learn3Title:'أمن العمليات',learn3Desc:'How to keep your operations secret and secure. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'أمان',learn4Title:'الرياضيات في الأمن',learn4Desc:'How numbers and algorithms make unbreakable codes. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'رياضيات',sectionLearn:'ماذا ستتعلم',learnLevelVal:'مبتدئ 🟢',learnLevel:'المستوى:',learnTimeVal:'15 min ⏱',learnTime:'المدة:',learnAgeVal:'10+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Panic Button! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـالعمليات السرية — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how Set up the simulation parameters and choose your e لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم العمليات السرية من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',ch1Title:'تشفير وفك تشفير',ch1Desc:'شفّر رسالة ثم حاول فك تشفيرها يدوياً بدون النظر للمفتاح. ما الأنماط التي تلاحظها؟',ch2Title:'اختبار التخفي',ch2Desc:'حاول إكمال المهمة بأقل بصمة إشارة ممكنة. هل يمكنك النزول تحت عتبة الكشف؟',ch3Title:'سباق الاعتراض',ch3Desc:'ابدأ بثاً وقِس سرعة اعتراضه. ما الذي يؤثر على وقت الكشف؟',codeTitle:'كود البداية',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'يشغّل هذا الكود راديو micro:bit على المجموعة 42 بأقصى طاقة. عند الضغط على الزر A يبث "HELLO". أي رسالة مستلمة تمرر على شاشة LED.',purpose:'Panic Button: Broadcast emergency alerts and wipe sensitive data. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ العمليات السرية',
 wiki_history: 'BLE was introduced in Bluetooth 4.0 (2010) by Nokia. It reduced power consumption by 90% compared to classic Bluetooth, enabling battery-powered sensors. يبني Panic Button على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Panic Button',
 wiki_math: 'الرياضيات وراء Panic Button: BLE uses Gaussian Frequency Shift Keying (GFSK) modulation at 1 Mbps. The modulation index of 0.5 provides optimal bandwidth efficiency. The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance. Channel capacity follows Shannon: C = B·log₂(1+S/N). Doubling bandwidth doubles capacity, but doubling signal power only adds one bit per symbol.',
 ...
 theory: 'Panic Button يوضح المبادئ الأساسية في العمليات السرية. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
const SECRET_FILES = [
 { name: 'mission_orders.enc', icon: '📄', classification: 'TOP SECRET' },
 { name: 'agent_contacts.db', icon: '👤', classification: 'CLASSIFIED' },
 { name: 'crypto_keys.pem', icon: '🔑', classification: 'TOP SECRET' },
 { name: 'safe_house_coords.gpx', icon: '📍', classification: 'SECRET' },
 { name: 'comm_frequencies.dat', icon: '📡', classification: 'CLASSIFIED' },
 { name: 'extraction_plan.pdf', icon: '🗺️', classification: 'TOP SECRET' },
 { name: 'field_report_delta.doc', icon: '📝', classification: 'SECRET' },
 { name: 'biometric_scans.bin', icon: '🧬', classification: 'TOP SECRET' },
];
...
function loadSecretFiles() {
 vaultFiles = SECRET_FILES.map(f => ({ ...f }));
 renderVault();
 const s = LANG[currentLang];
 log('🔐 ' + s.filesLoaded, 'success');
 showToast(s.filesLoaded, 2000);
 playSound('success');
}
...
function renderVault() {
 ...
 vault.innerHTML = `<div class="vault-status" data-i18n="vaultEmpty">${LANG[currentLang].vaultEmpty}</div>`;
 return;
 }
 vault.innerHTML = vaultFiles.map((f, i) => `
 <div class="vault-file" id="vaultFile${i}">
 <span class="file-icon">${f.icon}</span>
 <span class="file-name">${f.name}</span>
 <span class="file-class">${f.classification}</span>
 </div>
 `).join('');
}
...
function startPanicSequence() {
 const s = LANG[currentLang];
 if (panicActive) {
 log('⚠️ ' + s.alreadyActive, 'error');
 return;
 }
 if (vaultFiles.length === 0) {
 log('⚠️ ' + s.noFilesToWipe, 'error');
 playSound('error');
 return;
 }
 ...
 if (panicBtn) panicBtn.classList.add('active');
 if (cancelBtn) cancelBtn.style.display = 'block';
 if (countdownDisplay) countdownDisplay.classList.add('flashing');

 log('🚨 ' + s.panicTriggered, 'error');
 playSound('error');
 setStatus(true);
...
function updateCountdownDisplay() {
 ...
 const s = LANG[currentLang];
 if (display) {
 display.textContent = countdownValue > 0 ? `${s.countdownMsg} ${countdownValue}s` : '';
 }
}

function cancelPanic() {
 if (!panicActive || wipeInProgress) return;
 const s = LANG[currentLang];
 ...
 if (panicBtn) panicBtn.classList.remove('active');
 ...
 log('✅ ' + s.panicCancelled, 'success');
 showToast(s.panicCancelled, 2000);
 playSound('success');
 setStatus(false);
}

async function executePanicProtocol() {
 const s = LANG[currentLang];
 const countdownDisplay = $('countdownDisplay');
 const broadcastStatus = $('broadcastStatus');
 const cancelBtn = $('cancelBtn');
 ...
 // Phase 1: Broadcast emergency alert
 if (broadcastStatus) {
 broadcastStatus.textContent = s.broadcasting;
 broadcastStatus.classList.add('active');
 }

 const channels = [1, 5, 12, 25, 42, 77, 99];
 for (const ch of channels) {
 log(`📡 ${s.broadcastCh} ${ch}: SOS EMERGENCY ALERT`, 'tx');
 await sleep(150);
 }
 log('📡 Emergency broadcast sent on all channels', 'success');
 ...
 // Phase 2: Secure data wipe
 wipeInProgress = true;
 if (cancelBtn) cancelBtn.style.display = 'none';

 const wipeProgress = $('wipeProgress');
 const wipeBar = $('wipeBar');
 if (wipeProgress) wipeProgress.style.display = 'block';

 for (let i = 0; i < vaultFiles.length; i++) {
 const file = vaultFiles[i];
 const fileEl = $(`vaultFile${i}`);

 log(`🗑️ ${s.wipingFile} ${file.name}`, 'info');
 await sleep(200);
 log(`🔀 ${s.overwriting}`, 'info');
 await sleep(300);

 if (fileEl) fileEl.classList.add('wiped');

 const progress = Math.round(((i + 1) / vaultFiles.length) * 100);
 if (wipeBar) wipeBar.style.width = progress + '%';
 ...
 const vault = $('dataVault');
 if (vault) {
 vault.innerHTML = `<div class="vault-status">${s.wipeComplete}</div>`;
 }

 if (wipeBar) wipeBar.style.width = '100%';
 await sleep(500);
 if (wipeProgress) wipeProgress.style.display = 'none';
 ...
 log('🔒 ' + s.sequenceComplete, 'success');
 showToast(s.wipeComplete, 3000);
 playSound('success');
 setStatus(false);
}
...
function verifyWipe() {
 const s = LANG[currentLang];
 if (vaultFiles.length === 0) {
 log('✅ ' + s.wipeVerified, 'success');
 showToast(s.wipeVerified, 2000);
 playSound('success');
 } else {
 log('⚠️ ' + s.wipeNotDone, 'error');
 playSound('error');
 }
}

function resetPanicLab() {
 const s = LANG[currentLang];
 if (countdownTimer) {
 clearInterval(countdownTimer);
 countdownTimer = null;
 ...
 if (panicBtn) panicBtn.classList.remove('active');
 if (cancelBtn) cancelBtn.style.display = 'none';
 if (countdownDisplay) { countdownDisplay.textContent = ''; countdownDisplay.classList.remove('flashing'); }
 if (broadcastStatus) { broadcastStatus.textContent = ''; broadcastStatus.classList.remove('active'); }
 if (wipeProgress) wipeProgress.style.display = 'none';
 if (wipeBar) wipeBar.style.width = '0%';

 renderVault();
 log('🔄 ' + s.resetDone, 'info');
 showToast(s.resetDone, 2000);
 setStatus(false);
}
...
function initPanicButton() {
 const panicBtn = $('panicBtn');
 const cancelBtn = $('cancelBtn');
 const loadBtn = $('loadFilesBtn');
 const testBtn = $('testPanicBtn');
 const verifyBtn = $('verifyWipeBtn');
 const resetBtn = $('resetLabBtn');
 const slider = $('countdownSlider');
 const sliderVal = $('countdownVal');

 if (panicBtn) panicBtn.addEventListener('click', startPanicSequence);
 if (cancelBtn) cancelBtn.addEventListener('click', cancelPanic);
 if (loadBtn) loadBtn.addEventListener('click', loadSecretFiles);
 if (testBtn) testBtn.addEventListener('click', startPanicSequence);
 if (verifyBtn) verifyBtn.addEventListener('click', verifyWipe);
 if (resetBtn) resetBtn.addEventListener('click', resetPanicLab);

 if (slider && sliderVal) {
 slider.addEventListener('input', () => {
 countdownDuration = parseInt(slider.value, 10);
 sliderVal.textContent = countdownDuration;
 });
 }
