...
const LANG = {
  en: {
    ...
    howto_1: 'Load secret files into the data vault using the Lab section.',
    howto_2: 'Press the big red PANIC button to start the emergency sequence.',
    howto_3: 'Watch the countdown, broadcast alert, and data wipe in action.',
    howto_4: 'Verify that all data has been securely destroyed after the wipe.',
  ...
  fr: {
    ...
    howto_1: 'Chargez des fichiers secrets dans le coffre via la section Labo.',
    howto_2: 'Appuyez sur le gros bouton rouge PANIQUE pour démarrer la séquence d\'urgence.',
    howto_3: 'Observez le compte à rebours, l\'alerte diffusée et l\'effacement des données.',
    howto_4: 'Vérifiez que toutes les données ont été détruites de manière sécurisée.',
  ...
  ar: {
    ...
    howto_1: 'حمّل الملفات السرية في الخزنة باستخدام قسم المختبر.',
    howto_2: 'اضغط على زر الذعر الأحمر الكبير لبدء تسلسل الطوارئ.',
    howto_3: 'شاهد العد التنازلي وتنبيه البث ومسح البيانات أثناء العمل.',
    howto_4: 'تحقق من أن جميع البيانات قد تم تدميرها بشكل آمن بعد المسح.',
