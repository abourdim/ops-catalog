...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-DD248A',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Spy Compass \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Spy Compass', subtitle: '🧭 navigate · 🔐 decode · 🏆 explore',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Spy Compass — Waypoint Navigation',
 mainDesc: 'Navigate to secret locations using compass bearings',
 sectionA: 'How It Works', sectionB: 'Lab — Map View', sectionC: 'Challenge',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Spy Compass simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_mag_title: '🧲 Magnetometer',
 wiki_mag: 'A magnetometer measures the strength and direction of magnetic fields. In navigation, it detects Earth\'s field to determine compass heading.',
 wiki_bearing_title: '🧭 Compass Bearing',
 wiki_bearing: 'A bearing is an angle measured clockwise from North (0\u00b0) to the direction of a target. East = 90\u00b0, South = 180\u00b0, West = 270\u00b0.',
 wiki_waypoint_title: '📍 Waypoint Navigation',
 wiki_waypoint: 'Waypoint navigation involves moving from point to point using bearings. Each waypoint has coordinates or a bearing from a reference point.',
 wiki_microbit_title: '💻 micro:bit Compass',
 wiki_microbit: 'The micro:bit v2 includes an LSM303AGR magnetometer. After calibration, it provides heading data for compass applications.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🧭 Spy Compass ready!',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-DD248A',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Spy Compass \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Spy Compass', subtitle: '🧭 naviguer · 🔐 décoder · 🏆 explorer',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Boussole Espion — Navigation par Points',
 mainDesc: 'Naviguez vers des lieux secrets en utilisant des relèvements',
 sectionA: 'Comment ça marche', sectionB: 'Labo — Vue Carte', sectionC: 'Défi',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Spy Compass. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_mag_title: '🧲 Magnétomètre',
 wiki_mag: 'Un magnétomètre mesure la force et la direction des champs magnétiques. En navigation, il détecte le champ terrestre pour le cap.',
 wiki_bearing_title: '🧭 Relèvement',
 wiki_bearing: 'Un relèvement est un angle mesuré dans le sens horaire depuis le Nord (0\u00b0) vers la cible. Est = 90\u00b0, Sud = 180\u00b0, Ouest = 270\u00b0.',
 wiki_waypoint_title: '📍 Navigation par Points',
 wiki_waypoint: 'La navigation par points consiste à se déplacer de point en point en utilisant des relèvements.',
 wiki_microbit_title: '💻 Boussole micro:bit',
 wiki_microbit: 'Le micro:bit v2 intègre un magnétomètre LSM303AGR. Après calibration, il fournit les données de cap pour les applications boussole.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🧭 Boussole espion prête !',
 ...
 themeChanged: '🎨 Thème →',
 wp1Name: 'Base Alpha', wp2Name: 'Tour Bravo', wp3Name: 'Bunker Charlie',
 wpSelect: '-- Choisir une cible --',
 navBtnText: 'Naviguer',
 distReady: 'Sélectionnez une cible pour commencer',
 arrivedText: '🎯 Arrivé ! Mission accomplie !',
 howWork1: 'Le magnétomètre lit le champ magnétique terrestre et détecte la direction du Nord magnétique.',
 howWork2: 'Le cap (0\u00b0\u2013360\u00b0) est calculé à partir des axes X et Y du magnétomètre.',
 howWork3: 'Le relèvement vers le point cible est comparé à votre cap pour calculer l\'angle de rotation.',
 howWork4: 'Une flèche sur la boussole vous guide — tournez jusqu\'à ce que l\'aiguille soit alignée.',
 labDesc: 'Observez votre position et votre trace sur la carte pendant la navigation.',
 ch1Title: 'Défi 1 :', ch1Desc: 'Naviguez les yeux bandés en utilisant uniquement les signaux audio du cap. Réfléchissez à pourquoi cela se produit — la réponse révèle un principe fondamental. Essayez d expliquer avant de révéler la réponse.',
 ch2Title: 'Défi 2 :', ch2Desc: 'Trouvez le chemin le plus court passant par les 3 points dans l\'ordre. Ce défi teste votre compréhension du mécanisme sous-jacent. Expérimentez différentes approches avant de vérifier la solution.',
 ch3Title: 'Défi 3 :', ch3Desc: 'Calculez manuellement le relèvement de Base Alpha à Bunker Charlie avec un rapporteur.',
 navStarted: 'Navigation démarrée',
 navTarget: 'Cible :',
 navBearing: 'Relèvement :',
 navArrived: 'Vous êtes arrivé à',
 distTo: 'Diff. relèvement :',
 noTarget: 'Veuillez d\'abord sélectionner une cible',step1Title:'Configurer',step1Desc:'Configure les paramètres de simulation et choisis ta méthode de chiffrement. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Traiter',step2Desc:'Les données sont traitées par l\'algorithme ou la technique choisie. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Transmettre',step3Desc:'Le signal ou message traité est envoyé par le canal de communication. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Vérifier',step4Desc:'Le récepteur décode, vérifie et valide les données reçues. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que Spy Compass ?',faq_a1:'Spy Compass est une simulation interactive qui démontre les concepts de opérations secrètes. Navigate to secret locations using compass bearings. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de opérations secrètes. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de opérations secrètes. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut BBC micro:bit V2. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de opérations secrètes. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans Spy Compass ! Regarde l\'écran principal — c\'est ici que la simulation de opérations secrètes fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de opérations secrètes.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Cryptographie',learn1Desc:'How secret codes protect messages from spies. Regarde la simulation pour voir ça en temps réel. La visualisation rend visible l\'invisible.',learn1Tag:'Cybersécurité',learn2Title:'Communication sans fil',learn2Desc:'How devices send invisible signals through the air. Les contrôles te permettent d\'expérimenter. Chaque changement révèle comment ce principe réagit.',learn2Tag:'Sans fil',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Sécurité',learn4Title:'Maths en sécurité',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Maths',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Débutant 🟢',learnLevel:'Niveau :',learnTimeVal:'15 min ⏱',learnTime:'Durée :',learnAgeVal:'10+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Spy Compass ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de opérations secrètes — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how Set up the simulation parameters and choose your e Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de opérations secrètes par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',codeTitle:'Code de Démarrage',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'Ce code active la radio du micro:bit sur le groupe 42 à pleine puissance. Quand le bouton A est pressé, il diffuse "HELLO". Tout message reçu défile sur l\'écran LED. Les numéros de groupe fonctionnent comme des canaux.',purpose:'Spy Compass : Navigate to secret locations using compass bearings. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'esc-vpn-chain-builder',related1_desc:'',related1_path:'../../55-escape-evasion/esc-vpn-chain-builder/index.html',related2_name:'EXIF Eraser — Nettoyeur de métadonnées',related2_desc:'Supprimez les données cachées des photos avant de les partager',related2_path:'../../03-spy-browser/web-exif-eraser/index.html',related3_name:'Radar d\\',related3_desc:'Scanner les appareils WiFi à portée',related3_path:'../../02-spy-esp32/esp-dead-zone/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'Shake Cipher — Déverrouillage',pathPrev_path:'../../01-spy-microbit/bit-shake-cipher/index.html',pathNext_name:'Alarme Furtive — Detection d\\',pathNext_path:'../../01-spy-microbit/bit-stealth-alarm/index.html',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Que signifie SIGINT ?',quiz_q1a:'Signal Integration',quiz_q1b:'Signals Intelligence',quiz_q1c:'Simple Interception',quiz_q1d:'System Intelligence',quiz_q1_answer:'1',quiz_q2:'Quel langage est couramment utilisé pour programmer le micro:bit ?',quiz_q2a:'Java',quiz_q2b:'MicroPython',quiz_q2c:'Ruby',quiz_q2d:'Swift',quiz_q2_answer:'1',quiz_q3:'Qui a inventé le code Morse ?',quiz_q3a:'Tesla',quiz_q3b:'Samuel Morse',quiz_q3c:'Edison',quiz_q3d:'Bell',quiz_q3_answer:'1',quiz_q4:'Que signifie IA ?',quiz_q4a:'Entrée automatisée',quiz_q4b:'Intelligence Artificielle',quiz_q4c:'Interface analogique',quiz_q4d:'Intégration active',quiz_q4_answer:'1',quiz_q5:'En Morse, que représente la lettre E ?',quiz_q5a:'Trait',quiz_q5b:'Un point',quiz_q5c:'Deux points',quiz_q5d:'Point-trait',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'L\'opération Ivy Bells (1970-80) était une mission conjointe NSA/Marine pour intercepter les cbles de communication sous-marins soviétiques en mer d\'Okhotsk.',realworld2:'Les stations de nombres diffusent des messages chiffrés par ondes courtes aux agents de terrain depuis la Guerre froide. UVB-76 émet un bourdonnement monotone depuis 1982.',realworld3:'L\'affaire Aldrich Ames (1994) a révélé comment une taupe de la CIA utilisait des boîtes aux lettres mortes pour transmettre des renseignements classifiés à l\'Union soviétique pendant près d\'une décennie.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En opérations secrètes, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en opérations secrètes et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'Spy Compass illustre un concept fondamental en opérations secrètes. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans Spy Compass ont des applications directes dans le monde réel. Les professionnels de opérations secrètes utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, micro:bit et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en opérations secrètes implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'Utilisez des numéros de groupe radio supérieurs à 100 pour éviter les interférences. Les groupes par défaut 0-10 sont encombrés.',proTip2:'L\x27accéléromètre du micro:bit est sensible aux changements de température. Laissez votre appareil chauffer 2 minutes avant les mesures précises.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'Pendant la Guerre froide, la CIA a construit une libellule robot dans les années 1970 pour transporter un microphone miniature. Le projet Insectothopter a été abandonné car il ne pouvait pas voler dans le vent.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de opérations secrètes',
 wiki_history: 'Encryption dates back to ancient Egypt (1900 BCE). The Caesar cipher, Enigma machine, and modern AES represent key milestones in cryptographic evolution. Spy Compass s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Spy Compass',
 wiki_math: 'Les mathématiques derrière Spy Compass : Modern encryption relies on computational hardness: integer factorization (RSA), discrete logarithms (Diffie-Hellman), and elliptic curves (ECC). Channel capacity follows Shannon: C = B·log₂(1+S/N). Doubling bandwidth doubles capacity, but doubling signal power only adds one bit per symbol. Signal-to-Noise Ratio (SNR) in dB = 10·log₁₀(Psignal/Pnoise). Every 3 dB increase doubles the signal power relative to noise.',
 ...
 theory: 'Spy Compass démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Spy Compass', subtitle: '🧭 تنقّل · 🔐 فكّ الشفرة · 🏆 استكشف',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'بوصلة الجاسوس — الملاحة بالنقاط',
 mainDesc: 'انتقل إلى مواقع سرية باستخدام اتجاهات البوصلة',
 sectionA: 'كيف يعمل', sectionB: 'المختبر — عرض الخريطة', sectionC: 'التحدي',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Spy Compass. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_mag_title: '🧲 مقياس المغناطيسية',
 wiki_mag: 'يقيس مقياس المغناطيسية قوة واتجاه المجالات المغناطيسية. في الملاحة، يكتشف مجال الأرض لتحديد اتجاه البوصلة.',
 wiki_bearing_title: '🧭 سمت البوصلة',
 wiki_bearing: 'السمت هو زاوية تُقاس باتجاه عقارب الساعة من الشمال (0°) إلى اتجاه الهدف. شرق = 90°، جنوب = 180°، غرب = 270°.',
 wiki_waypoint_title: '📍 الملاحة بالنقاط',
 wiki_waypoint: 'تتضمن الملاحة بالنقاط التنقل من نقطة إلى أخرى باستخدام الاتجاهات. لكل نقطة إحداثيات أو سمت.',
 wiki_microbit_title: '💻 بوصلة micro:bit',
 wiki_microbit: 'يتضمن micro:bit v2 مقياس مغناطيسية LSM303AGR. بعد المعايرة، يوفر بيانات الاتجاه لتطبيقات البوصلة.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🧭 بوصلة الجاسوس جاهزة!',
 ...
 theory: 'Spy Compass يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ SPY COMPASS SIMULATION ═══════ */

const WAYPOINTS = [
 { name: 'wp1Name', bearing: 45, x: 0.75, y: 0.2 },
 { name: 'wp2Name', bearing: 160, x: 0.3, y: 0.8 },
 { name: 'wp3Name', bearing: 290, x: 0.15, y: 0.35 }
];
...
function startNavigation() {
 ...
 if (!val || val < 1 || val > 3) {
 log(LANG[currentLang].noTarget, 'error');
 showToast(LANG[currentLang].noTarget, 2000);
 return;
 }
 targetIndex = val - 1;
 navigating = true;
 arrivedSeconds = 0;
 arrivedTimer = null;
 trailPoints = [{ x: simPos.x, y: simPos.y }];

 const s = LANG[currentLang];
 const wpName = s[WAYPOINTS[targetIndex].name];
 log(`${s.navStarted} — ${s.navTarget} ${wpName} (${s.navBearing} ${WAYPOINTS[targetIndex].bearing}\u00b0)`, 'success');
 showToast(`${s.navTarget} ${wpName}`, 2000);
 setStatus(true);
 playSound('success');

 // Hide arrived indicator
 const ai = $('arrivedIndicator');
 if (ai) ai.classList.remove('visible');
}

function compassLoop() {
 // Simulate heading drift if no device orientation
 if (!useDeviceOrientation) {
 headingVelocity += (Math.random() - 0.5) * 0.4;
 headingVelocity *= 0.98;
 if (navigating && targetIndex >= 0) {
 // Slowly steer toward target bearing
 const tb = WAYPOINTS[targetIndex].bearing;
 let diff = tb - currentHeading;
 if (diff > 180) diff -= 360;
 if (diff < -180) diff += 360;
 headingVelocity += diff * 0.002;
 }
 currentHeading = (currentHeading + headingVelocity + 360) % 360;
 }

 // Update heading display
 const hd = $('headingDisplay');
 if (hd) hd.textContent = Math.round(currentHeading) + '\u00b0';
 ...
 if (navigating && targetIndex >= 0) {
 const tb = WAYPOINTS[targetIndex].bearing;
 let diff = Math.abs(tb - currentHeading);
 if (diff > 180) diff = 360 - diff;

 const dd = $('distDisplay');
 if (dd) dd.textContent = `${LANG[currentLang].distTo} ${diff.toFixed(1)}\u00b0`;

 // Simulate position movement toward target
 const wp = WAYPOINTS[targetIndex];
 const dx = wp.x - simPos.x;
 const dy = wp.y - simPos.y;
 const dist = Math.sqrt(dx * dx + dy * dy);
 if (dist > 0.01) {
 simPos.x += dx * 0.003;
 simPos.y += dy * 0.003;
 trailPoints.push({ x: simPos.x, y: simPos.y });
 }

 // Arrived detection: bearing diff < 5 for 3 seconds
 if (diff < 5) {
 arrivedSeconds += 1 / 60;
 if (arrivedSeconds >= 3) {
 onArrived();
 ...
 compassAnim = requestAnimationFrame(compassLoop);
}
...
function onArrived() {
 ...
 if (ai) ai.classList.remove('visible');
 // Force reflow
 void (ai && ai.offsetWidth);
 if (ai) ai.classList.add('visible');

 const dd = $('distDisplay');
 if (dd) dd.textContent = `${s.navArrived} ${wpName}!`;

 log(`🎯 ${s.navArrived} ${wpName}!`, 'success');
 showToast(s.arrivedText, 3000);
 playSound('success');
 setStatus(false);

 // Reset sim position after short delay
 setTimeout(() => {
 simPos = { x: 0.5, y: 0.5 };
 }, 2000);
}
...
function drawCompass() {
 ...
 const len = i % 90 === 0 ? 18 : i % 30 === 0 ? 12 : 6;
 ctx.beginPath();
 ctx.moveTo(0, -r + 2);
 ctx.lineTo(0, -r + 2 + len);
 ctx.strokeStyle = i % 90 === 0 ? accent : 'rgba(255,255,255,0.3)';
 ctx.lineWidth = i % 90 === 0 ? 2.5 : 1;
 ctx.stroke();
 ctx.restore();
 }
 ...
 // Target bearing arrow (if navigating)
 if (navigating && targetIndex >= 0) {
 const tb = WAYPOINTS[targetIndex].bearing;
 ctx.save();
 ...
 ctx.fill();
 // Line from center toward target
 ctx.beginPath();
 ctx.moveTo(0, 0);
 ctx.lineTo(0, -r + 65);
...
function drawMap() {
 ...
 const ctx = canvas.getContext('2d');
 // Responsive width
 const rect = canvas.parentElement ? canvas.parentElement.getBoundingClientRect() : { width: 600 };
 canvas.width = Math.max(300, Math.floor(rect.width - 4));
 canvas.height = 300;
 const w = canvas.width, h = canvas.height;
 ...
 ctx.beginPath();
 ctx.moveTo(trailPoints[0].x * w, trailPoints[0].y * h);
 for (let i = 1; i < trailPoints.length; i++) {
 ctx.lineTo(trailPoints[i].x * w, trailPoints[i].y * h);
 }
 ctx.strokeStyle = accent;
 ctx.lineWidth = 2;
 ctx.globalAlpha = 0.6;
 ...
 ctx.fillStyle = i === targetIndex ? '#33ff33' : 'rgba(255,255,255,0.5)';
 ctx.fill();
 ctx.strokeStyle = accent;
 ctx.lineWidth = 2;
 ctx.stroke();
 ...
 ctx.textAlign = 'center';
 ctx.fillText(s[wp.name], px, py - 14);
 ctx.fillStyle = 'rgba(255,255,255,0.5)';
 ctx.font = '10px Orbitron, monospace';
 ctx.fillText(wp.bearing + '\u00b0', px, py + 22);
 });

 // Current position
 const px = simPos.x * w, py = simPos.y * h;
 ctx.beginPath();
