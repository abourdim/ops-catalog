...
const LANG = {
  en: {
    ...
    ch1Title: 'Challenge 1:', ch1Desc: 'Navigate blindfolded using only compass heading audio cues.',
    ch2Title: 'Challenge 2:', ch2Desc: 'Find the shortest path visiting all 3 waypoints in order.',
  ...
  fr: {
    ...
    ch1Title: 'Défi 1 :', ch1Desc: 'Naviguez les yeux bandés en utilisant uniquement les signaux audio du cap.',
    ch2Title: 'Défi 2 :', ch2Desc: 'Trouvez le chemin le plus court passant par les 3 points dans l\'ordre.',
  ...
  ar: {
    ...
    ch1Title: 'التحدي 1:', ch1Desc: 'تنقّل معصوب العينين باستخدام إشارات صوتية للاتجاه فقط.',
    ch2Title: 'التحدي 2:', ch2Desc: 'اعثر على أقصر مسار يمر بجميع النقاط الثلاث بالترتيب.',
