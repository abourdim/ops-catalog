...
const LANG = {
  en: {
    ...
    howto_1: 'Open the app and observe the compass needle rotating in real time.',
    howto_2: 'Select a target waypoint from the dropdown and press Navigate.',
    howto_3: 'Turn your device until the compass needle aligns with the target bearing arrow.',
    howto_4: 'When the bearing difference is less than 5\u00b0 for 3 seconds, you have arrived!',
  ...
  fr: {
    ...
    howto_1: 'Ouvrez l\'appli et observez l\'aiguille tourner en temps réel.',
    howto_2: 'Sélectionnez un point cible dans le menu et appuyez sur Naviguer.',
    howto_3: 'Tournez votre appareil jusqu\'à ce que l\'aiguille soit alignée avec le relèvement cible.',
    howto_4: 'Quand la différence de relèvement est inférieure à 5\u00b0 pendant 3 secondes, vous êtes arrivé !',
  ...
  ar: {
    ...
    howto_1: 'افتح التطبيق وراقب إبرة البوصلة تدور في الوقت الحقيقي.',
    howto_2: 'اختر نقطة هدف من القائمة واضغط على تنقّل.',
    howto_3: 'أدر جهازك حتى تتوافق إبرة البوصلة مع سهم السمت المستهدف.',
    howto_4: 'عندما يكون فرق السمت أقل من 5° لمدة 3 ثوانٍ، تكون قد وصلت!',
