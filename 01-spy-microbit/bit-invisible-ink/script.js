 ...
 * Invisible Ink: Self-Destructing Messages Simulation
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-FAEE98',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Invisible Ink \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Invisible Ink', subtitle: '🔏 invisible ink · 🔥 self-destruct · 👁️ read receipts',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Invisible Ink — Self-Destructing Messages', mainDesc: 'Send messages that vanish after reading',
 ...
 howto_1:'The main display shows the Invisible Ink simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_ephemeral_title: '🔏 Ephemeral Messaging', wiki_ephemeral: 'Messages designed to disappear after being read. Used in apps like Snapchat and Signal for privacy.',
 wiki_timer_title: '🔥 Self-Destruct Timer', wiki_timer: 'A countdown mechanism that triggers message deletion after a set time. Prevents long-term data retention.',
 wiki_receipt_title: '👁️ Read Receipts', wiki_receipt: 'Confirmation that a message has been opened. Tracks when the recipient viewed the content.',
 wiki_forensics_title: '🔍 Digital Forensics', wiki_forensics: 'The science of recovering and investigating digital data. Even "deleted" data can sometimes be recovered from memory or logs.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🔏 Invisible Ink ready!',
 ...
 theory: 'Invisible Ink demonstrates key principles from covert operations. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-FAEE98',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Invisible Ink \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Invisible Ink', subtitle: '🔏 encre invisible · 🔥 auto-destruction · 👁️ accusés de lecture',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Encre Invisible — Messages Auto-Destructeurs', mainDesc: 'Envoyez des messages qui disparaissent après lecture',
 ...
 wiki_ephemeral_title: '🔏 Messagerie Éphémère', wiki_ephemeral: 'Messages conçus pour disparaître après lecture. Utilisés dans des applis comme Snapchat et Signal pour la confidentialité.',
 wiki_timer_title: '🔥 Minuteur d\'Auto-Destruction', wiki_timer: 'Un mécanisme de compte à rebours qui déclenche la suppression du message après un temps défini.',
 wiki_receipt_title: '👁️ Accusés de Lecture', wiki_receipt: 'Confirmation qu\'un message a été ouvert. Suit le moment où le destinataire a vu le contenu.',
 wiki_forensics_title: '🔍 Forensique Numérique', wiki_forensics: 'La science de la récupération et de l\'investigation des données numériques. Même les données « supprimées » peuvent parfois être récupérées.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🔏 Encre Invisible prête !',
 ...
 theory: 'Invisible Ink démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Invisible Ink', subtitle: '🔏 حبر خفي · 🔥 تدمير ذاتي · 👁️ إيصالات قراءة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'الحبر الخفي — رسائل ذاتية التدمير', mainDesc: 'أرسل رسائل تختفي بعد القراءة',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Invisible Ink. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_ephemeral_title: '🔏 الرسائل المؤقتة', wiki_ephemeral: 'رسائل مصممة لتختفي بعد القراءة. تُستخدم في تطبيقات مثل سناب شات وسيغنال للخصوصية.',
 wiki_timer_title: '🔥 مؤقت التدمير الذاتي', wiki_timer: 'آلية عد تنازلي تُطلق حذف الرسالة بعد وقت محدد. يمنع الاحتفاظ بالبيانات على المدى الطويل.',
 wiki_receipt_title: '👁️ إيصالات القراءة', wiki_receipt: 'تأكيد بأن الرسالة قد فُتحت. يتتبع متى شاهد المستلم المحتوى.',
 wiki_forensics_title: '🔍 الطب الشرعي الرقمي', wiki_forensics: 'علم استرداد البيانات الرقمية والتحقيق فيها. حتى البيانات "المحذوفة" يمكن أحيانًا استردادها من الذاكرة أو السجلات.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🔏 الحبر الخفي جاهز!',
 ...
 theory: 'Invisible Ink يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
let currentDestructTimer = null;
let destructionLogEntries = [];
...
function initInvisibleInk() {
 ...
 // Character count
 if (composeArea && charCount) {
 composeArea.addEventListener('input', () => {
 charCount.textContent = `${composeArea.value.length} / 280`;
 });
 }
 ...
 const s = LANG[currentLang];
 if (s && s.composePlaceholder) composeArea.placeholder = s.composePlaceholder;
 };
 updatePlaceholder();
 // Observe lang changes
 const origSetLang = setLanguage;
 // We hook into setLanguage by patching — but safer to just call updatePlaceholder after
 }

 // Send button
 if (sendBtn) {
 sendBtn.addEventListener('click', () => {
 const text = composeArea ? composeArea.value.trim() : '';
 const s = LANG[currentLang];
 if (!text) {
 ...
 const timer = timerSelect ? parseInt(timerSelect.value, 10) : 10;
 enqueueMessage(text, timer);
 if (composeArea) {
 composeArea.value = '';
 ...
 // Screenshot detection (visibility change + keydown)
 document.addEventListener('keydown', e => {
 ...
 // Rough heuristic: if a message is displaying and tab loses focus, could be screenshot
 const msgEl = $('receivedMsg');
 if (msgEl && msgEl.classList.contains('visible') && document.hidden) {
 onScreenshotAttempt();
 }
 });
}

function enqueueMessage(text, timerSeconds) {
 const s = LANG[currentLang];
 const id = Date.now().toString(36) + Math.random().toString(36).slice(2, 6);

 // Simulate encryption
 log(`🔐 ${s.msgEncrypting}`, 'tx');
 showToast(s.msgEncrypting, 1200);
 playSound('click');

 setTimeout(() => {
 // Simulate BLE transfer
 log(`📡 ${s.msgTransmitting}`, 'tx');
 showToast(s.msgTransmitting, 1000);

 setTimeout(() => {
 const msg = { id, text, timerSeconds, sentAt: new Date() };
 messageQueue.push(msg);
 updateQueueBadge();
 log(`📨 ${s.msgQueued} (#${messageQueue.length}) — ${timerSeconds}s`, 'info');
 setStatus(true);
 playSound('success');
 hideToast();

 addDestructionLogEntry(`[${new Date().toLocaleTimeString()}] SENT — "${text.slice(0, 30)}${text.length > 30 ? '...' : ''}" (${timerSeconds}s)`);
...
function displayReceivedMessage(msg) {
 ...
 const countdown = $('destructCountdown');
 const timerValue = $('timerValue');
 const timerBar = $('timerBar');
 const burnArea = $('burnArea');

 if (!msgEl || !msgText) return;

 // Reset state
 burnArea && burnArea.classList.remove('active');
 msgEl.classList.remove('burning');

 // Show message
 msgText.textContent = msg.text;
 const readTime = new Date();
 if (msgMeta) msgMeta.textContent = `${s.readAt} ${readTime.toLocaleTimeString()}`;
 msgEl.classList.add('visible');
 msgEl.style.opacity = '1';

 // Read receipt
 if (readReceipt) {
 readReceipt.textContent = `👁️ ${s.msgOpened} — ${readTime.toLocaleTimeString()}`;
 readReceipt.classList.add('active');
 }
 log(`👁️ ${s.msgOpened} — ${readTime.toLocaleTimeString()}`, 'rx');
 playSound('success');
 addDestructionLogEntry(`[${readTime.toLocaleTimeString()}] READ — "${msg.text.slice(0, 30)}${msg.text.length > 30 ? '...' : ''}"`);

 // Start countdown
 let remaining = msg.timerSeconds;
 const total = msg.timerSeconds;
 if (countdown) countdown.classList.add('active');
 if (timerValue) timerValue.textContent = remaining;
 if (timerBar) timerBar.style.width = '100%';

 currentDestructTimer = setInterval(() => {
 remaining--;
 if (timerValue) timerValue.textContent = Math.max(0, remaining);
 if (timerBar) timerBar.style.width = `${(remaining / total) * 100}%`;

 if (remaining <= 0) {
 clearInterval(currentDestructTimer);
 currentDestructTimer = null;
 burnMessage(msg, msgEl, msgText, countdown, burnArea, readReceipt);
 }
 }, 1000);
}

function burnMessage(msg, msgEl, msgText, countdown, burnArea, readReceipt) {
 const s = LANG[currentLang];
 log(`🔥 ${s.msgBurning}`, 'info');
 ...
 // Scramble chars then dissolve them one by one
 ...
 // Done burning
 setTimeout(() => {
 msgEl.classList.remove('visible', 'burning');
 msgEl.style.opacity = '0';
 if (countdown) countdown.classList.remove('active');
 if (burnArea) {
 burnArea.textContent = LANG[currentLang].burnComplete;
 burnArea.classList.add('active');
 }
 if (readReceipt) readReceipt.classList.remove('active');
 log(`💀 ${s.msgDestroyed} — ${new Date().toLocaleTimeString()}`, 'success');
 addDestructionLogEntry(`[${new Date().toLocaleTimeString()}] DESTROYED — "${msg.text.slice(0, 30)}${msg.text.length > 30 ? '...' : ''}"`);
 playSound('success');

 // After a brief pause, process next
 setTimeout(() => {
 if (burnArea) burnArea.classList.remove('active');
 processNextMessage();
 }, 2000);
 }, 300);
 return;
 ...
 // Scramble phase: replace with random chars
 let scrambleCount = 0;
 ...
 charEl.classList.add('dissolving');
 setTimeout(() => {
 ...
 idx++;
 const delay = Math.max(20, 800 / text.length);
...
function onScreenshotAttempt() {
 const s = LANG[currentLang];
 const msgEl = $('receivedMsg');
 if (!msgEl || !msgEl.classList.contains('visible')) return;

 log(`📸 ${s.screenshotDetected}`, 'error');
 showToast(s.screenshotDetected, 2000);
 playSound('error');
 addDestructionLogEntry(`[${new Date().toLocaleTimeString()}] SCREENSHOT ATTEMPT DETECTED`);

 // Accelerate destruction: clear current timer and burn immediately
 if (currentDestructTimer) {
 clearInterval(currentDestructTimer);
 currentDestructTimer = null;
 const msgText = $('msgText');
 const countdown = $('destructCountdown');
 const burnArea = $('burnArea');
 const readReceipt = $('readReceipt');
 burnMessage({ text: msgText ? msgText.textContent : '', id: 'forced' }, msgEl, msgText, countdown, burnArea, readReceipt);
 }
}

function addDestructionLogEntry(entry) {
 destructionLogEntries.push(entry);
 const logEl = $('destructionLog');
 if (!logEl) return;
