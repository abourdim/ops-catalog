...
const LANG = {
  en: {
    ...
    howto_4: 'Watch the message appear, count down, and burn away.',
  ...
  fr: {
    ...
    howto_4: 'Regardez le message apparaître, compter et brûler.',
  ...
  ar: {
    ...
    howto_4: 'شاهد الرسالة تظهر، العد التنازلي، ثم الاحتراق.',
