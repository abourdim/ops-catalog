...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-CB1622',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master RF Remote Control \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'RF Remote Control', subtitle: '🎮 design · 📡 transmit · 🔐 verify',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'RF Remote Control — Build Your Protocol',
 mainDesc: 'Design custom radio commands to control devices',
 sectionA: 'How It Works', sectionB: 'Lab', sectionC: 'Challenge',
 frameBuilderTitle: 'Protocol Frame Builder',
 lblPreamble: 'Preamble', lblAddress: 'Address', lblCommand: 'Command',
 lblPayload: 'Payload', lblChecksum: 'Checksum',
 cmdGridTitle: 'Command Buttons',
 cmdUp: 'UP', cmdDown: 'DOWN', cmdLeft: 'LEFT', cmdRight: 'RIGHT', cmdA: 'A', cmdB: 'B',
 deviceTitle: 'Virtual Device',
 frameInspTitle: 'Frame Inspector',
 noFrameYet: 'No frame sent yet',
 errorRateLabel: 'Error rate:', checksumLabel: 'Checksum:',
 csIdle: 'IDLE', csPass: 'PASS', csFail: 'FAIL',
 txSending: 'TX frame', rxReceived: 'RX frame', rxCorrupted: 'RX corrupted',
 checksumOk: 'Checksum PASS', checksumFail: 'Checksum FAIL — frame rejected',
 deviceMoved: 'Device moved', deviceIgnored: 'Command ignored (bad checksum)',
 step1: 'Define your frame structure: preamble, address, command, payload, and checksum fields.',
 step2: 'Encode a command: each button maps to a unique hex code inserted into the command field.',
 step3: 'Add a checksum: XOR all frame bytes together to produce an error-detection value.',
 step4: 'Transmit and verify: the receiver recalculates the checksum and accepts or rejects the frame.',
 lab1: 'Design your own frame format by editing the preamble, address, and payload fields.',
 lab2: 'Increase the error rate slider and observe how random bit flips corrupt your frames.',
 lab3: 'Compare results with and without checksum verification enabled.',
 lab4: 'Watch the Frame Inspector to see raw hex bytes of every transmitted and received frame.',
 challenge1: 'Design a protocol with ACK: after sending a command, wait for the device to acknowledge receipt before sending the next one.',
 challenge2: 'Detect and correct 1-bit errors: implement a Hamming-style parity scheme so the receiver can fix single-bit corruptions.',
 challenge3: 'Build a replay attack: capture a valid frame and re-transmit it to see if the device obeys. Then add a sequence number to defend against it.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1: 'The main display shows the Rf Remote Control simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Configure the parameters for RF Remote Control. Choose your ',
 howto_2: 'Press a command button (UP, DOWN, LEFT, RIGHT, A, B) to build and transmit a frame.',
 howto_3: 'Watch the Frame Inspector for the hex dump and the checksum pass/fail indicator.',
 howto_4: 'Slide the Error Rate to inject noise and see how checksums detect corrupted frames.',
 wiki_radio_title: '📡 Radio Protocols',
 wiki_radio: 'Radio protocols define how devices communicate wirelessly. They specify frequency, modulation, frame format, and error handling rules.',
 wiki_frame_title: '📦 Frame Structure',
 wiki_frame: 'A frame is the basic transmission unit. It typically includes a preamble for synchronization, an address to identify the receiver, a command or data payload, and a checksum for integrity.',
 wiki_checksum_title: '🔢 Checksums',
 wiki_checksum: 'Checksums are computed values appended to a frame so the receiver can verify data integrity. XOR checksum is the simplest: XOR all bytes together.',
 wiki_error_title: '🛡️ Error Detection',
 wiki_error: 'Error detection lets the receiver know if data was corrupted during transmission. Common methods include parity bits, CRC, and checksums.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📡 RF Remote Control ready!',
 ...
 theory: 'Rf Remote Control demonstrates key principles from satellite comms. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. Modulation encodes data onto a carrier wave by varying its amplitude (AM), frequency (FM), or phase (PM). Digital schemes like QAM combine amplitude and phase. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 title: 'Telecommande RF', subtitle: '🎮 concevoir · 📡 transmettre · 🔐 verifier',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'Telecommande RF — Construis ton Protocole',
 mainDesc: 'Concois des commandes radio pour controler des appareils',
 sectionA: 'Comment ca marche', sectionB: 'Labo', sectionC: 'Defi',
 frameBuilderTitle: 'Constructeur de Trame',
 lblPreamble: 'Preambule', lblAddress: 'Adresse', lblCommand: 'Commande',
 lblPayload: 'Donnees', lblChecksum: 'Checksum',
 cmdGridTitle: 'Boutons de Commande',
 cmdUp: 'HAUT', cmdDown: 'BAS', cmdLeft: 'GAUCHE', cmdRight: 'DROITE', cmdA: 'A', cmdB: 'B',
 deviceTitle: 'Appareil Virtuel',
 frameInspTitle: 'Inspecteur de Trame',
 noFrameYet: 'Aucune trame envoyee',
 errorRateLabel: 'Taux d\'erreur :', checksumLabel: 'Checksum :',
 csIdle: 'REPOS', csPass: 'OK', csFail: 'ERREUR',
 txSending: 'TX trame', rxReceived: 'RX trame', rxCorrupted: 'RX corrompue',
 checksumOk: 'Checksum OK', checksumFail: 'Checksum ERREUR — trame rejetee',
 deviceMoved: 'Appareil deplace', deviceIgnored: 'Commande ignoree (mauvais checksum)',
 step1: 'Definis la structure de ta trame : preambule, adresse, commande, donnees et checksum.',
 step2: 'Encode une commande : chaque bouton correspond a un code hex insere dans le champ commande.',
 step3: 'Ajoute un checksum : XOR de tous les octets de la trame pour produire une valeur de detection d\'erreur.',
 step4: 'Transmets et verifie : le recepteur recalcule le checksum et accepte ou rejette la trame.',
 lab1: 'Concois ton propre format de trame en modifiant les champs preambule, adresse et donnees.',
 lab2: 'Augmente le curseur d\'erreur et observe comment les inversions de bits corrompent tes trames.',
 lab3: 'Compare les resultats avec et sans verification de checksum.',
 lab4: 'Observe l\'Inspecteur de Trame pour voir les octets hex bruts de chaque trame envoyee et recue.',
 challenge1: 'Concois un protocole avec ACK : apres avoir envoye une commande, attends que l\'appareil confirme la reception avant d\'envoyer la suivante.',
 challenge2: 'Detecte et corrige les erreurs de 1 bit : implemente un schema de parite style Hamming pour que le recepteur puisse corriger les corruptions a un bit.',
 challenge3: 'Construis une attaque par rejeu : capture une trame valide et retransmets-la pour voir si l\'appareil obeit. Puis ajoute un numero de sequence pour t\'en defendre.',
 ...
 howto_1: 'L écran principal affiche la simulation Rf Remote Control. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for RF Remote Control. Choose your ',
 howto_2: 'Appuie sur un bouton de commande (HAUT, BAS, GAUCHE, DROITE, A, B) pour construire et transmettre une trame.',
 howto_3: 'Observe l\'Inspecteur de Trame pour le dump hex et l\'indicateur checksum OK/ERREUR.',
 howto_4: 'Deplace le curseur Taux d\'Erreur pour injecter du bruit et voir comment les checksums detectent les trames corrompues.',
 wiki_radio_title: '📡 Protocoles Radio',
 wiki_radio: 'Les protocoles radio definissent comment les appareils communiquent sans fil. Ils specifient la frequence, la modulation, le format de trame et les regles de gestion d\'erreur.',
 wiki_frame_title: '📦 Structure de Trame',
 wiki_frame: 'Une trame est l\'unite de transmission de base. Elle inclut generalement un preambule pour la synchronisation, une adresse pour identifier le recepteur, une commande ou donnees utiles, et un checksum pour l\'integrite.',
 wiki_checksum_title: '🔢 Checksums',
 wiki_checksum: 'Les checksums sont des valeurs calculees ajoutees a une trame pour que le recepteur puisse verifier l\'integrite des donnees. Le checksum XOR est le plus simple : XOR de tous les octets.',
 wiki_error_title: '🛡️ Detection d\'Erreurs',
 wiki_error: 'La detection d\'erreurs permet au recepteur de savoir si les donnees ont ete corrompues pendant la transmission. Les methodes courantes incluent les bits de parite, le CRC et les checksums.',
 working: 'En cours…',
 t_mosque: 'Mosquee', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📡 Telecommande RF prete !',
 ...
 theory: 'Rf Remote Control démontre les principes clés de communications satellite. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. Modulation encodes data onto a carrier wave by varying its amplitude (AM), frequency (FM), or phase (PM). Digital schemes like QAM combine amplitude and phase. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'جهاز تحكم لاسلكي', subtitle: '🎮 صمّم · 📡 أرسل · 🔐 تحقّق',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'جهاز تحكم لاسلكي — ابنِ بروتوكولك',
 mainDesc: 'صمّم أوامر لاسلكية مخصصة للتحكم في الأجهزة',
 sectionA: 'كيف يعمل', sectionB: 'المختبر', sectionC: 'التحدي',
 frameBuilderTitle: 'منشئ إطار البروتوكول',
 lblPreamble: 'المقدمة', lblAddress: 'العنوان', lblCommand: 'الأمر',
 lblPayload: 'البيانات', lblChecksum: 'المجموع',
 cmdGridTitle: 'أزرار الأوامر',
 cmdUp: 'أعلى', cmdDown: 'أسفل', cmdLeft: 'يسار', cmdRight: 'يمين', cmdA: 'أ', cmdB: 'ب',
 deviceTitle: 'الجهاز الافتراضي',
 frameInspTitle: 'فاحص الإطار',
 noFrameYet: 'لم يتم إرسال أي إطار بعد',
 errorRateLabel: 'معدل الخطأ:', checksumLabel: 'المجموع التحققي:',
 csIdle: 'خامل', csPass: 'نجاح', csFail: 'فشل',
 txSending: 'إرسال إطار TX', rxReceived: 'استقبال إطار RX', rxCorrupted: 'RX تالف',
 checksumOk: 'المجموع التحققي صحيح', checksumFail: 'المجموع التحققي خاطئ — الإطار مرفوض',
 deviceMoved: 'الجهاز تحرّك', deviceIgnored: 'الأمر مُتجاهَل (مجموع تحققي خاطئ)',
 step1: 'حدّد بنية الإطار: المقدمة، العنوان، الأمر، البيانات، والمجموع التحققي.',
 step2: 'شفّر أمرًا: كل زر يُربط بكود ست عشري فريد يُدرج في حقل الأمر.',
 step3: 'أضف مجموعًا تحققيًا: اعمل XOR لجميع بايتات الإطار لإنتاج قيمة كشف الأخطاء.',
 step4: 'أرسل وتحقّق: المستقبل يعيد حساب المجموع التحققي ويقبل أو يرفض الإطار.',
 lab1: 'صمّم تنسيق الإطار الخاص بك عبر تعديل حقول المقدمة والعنوان والبيانات.',
 lab2: 'ارفع مؤشر معدل الخطأ ولاحظ كيف تُفسد التقلبات العشوائية للبتات إطاراتك.',
 lab3: 'قارن النتائج مع وبدون تفعيل التحقق من المجموع.',
 lab4: 'راقب فاحص الإطار لرؤية البايتات الست عشرية الخام لكل إطار مُرسل ومُستقبل.',
 challenge1: 'صمّم بروتوكولًا مع تأكيد (ACK): بعد إرسال أمر، انتظر تأكيد الاستلام من الجهاز قبل إرسال الأمر التالي.',
 challenge2: 'اكتشف وصحّح أخطاء البت الواحد: طبّق مخطط تماثل على طريقة هامنج ليتمكن المستقبل من إصلاح التلف في بت واحد.',
 challenge3: 'ابنِ هجوم إعادة التشغيل: التقط إطارًا صالحًا وأعد إرساله لترى هل يطيع الجهاز. ثم أضف رقم تسلسل للدفاع ضده.',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Rf Remote Control. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Configure the parameters for RF Remote Control. Choose your ',
 howto_2: 'اضغط زر أمر (أعلى، أسفل، يسار، يمين، أ، ب) لبناء وإرسال إطار.',
 howto_3: 'راقب فاحص الإطار لتفريغ الست عشري ومؤشر نجاح/فشل المجموع التحققي.',
 howto_4: 'حرّك مؤشر معدل الخطأ لحقن الضوضاء وشاهد كيف تكشف المجاميع التحققية الإطارات التالفة.',
 wiki_radio_title: '📡 بروتوكولات لاسلكية',
 wiki_radio: 'بروتوكولات الراديو تحدد كيف تتواصل الأجهزة لاسلكيًا. تحدد التردد والتعديل وتنسيق الإطار وقواعد معالجة الأخطاء.',
 wiki_frame_title: '📦 بنية الإطار',
 wiki_frame: 'الإطار هو وحدة الإرسال الأساسية. يتضمن عادةً مقدمة للمزامنة، وعنوانًا لتحديد المستقبل، وأمرًا أو بيانات مفيدة، ومجموعًا تحققيًا للسلامة.',
 wiki_checksum_title: '🔢 المجاميع التحققية',
 wiki_checksum: 'المجاميع التحققية هي قيم محسوبة تُلحق بالإطار ليتمكن المستقبل من التحقق من سلامة البيانات. مجموع XOR هو الأبسط: XOR لجميع البايتات.',
 wiki_error_title: '🛡️ كشف الأخطاء',
 wiki_error: 'كشف الأخطاء يتيح للمستقبل معرفة ما إذا تلفت البيانات أثناء الإرسال. الطرق الشائعة تشمل بتات التماثل وCRC والمجاميع التحققية.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '📡 جهاز التحكم اللاسلكي جاهز!',
 ...
 theory: 'Rf Remote Control يوضح المبادئ الأساسية في اتصالات الأقمار. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. Modulation encodes data onto a carrier wave by varying its amplitude (AM), frequency (FM), or phase (PM). Digital schemes like QAM combine amplitude and phase. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
// Robot state
let robotX = 102; // center of 240 - 36
let robotY = 72; // center of 180 - 36
const STEP = 24;
const BOUNDS = { minX: 0, maxX: 204, minY: 0, maxY: 144 };
let trails = [];
...
function buildFrame(cmdCode) {
 const preamble = hexToByte($('fieldPreamble').value);
 const address = hexToByte($('fieldAddress').value);
 const command = cmdCode & 0xFF;
 const payload = hexToByte($('fieldPayload').value);
 const bytes = [preamble, address, command, payload];
 // XOR checksum
 let checksum = 0;
 for (const b of bytes) checksum ^= b;
 bytes.push(checksum);
 // Update UI fields
 $('fieldCommand').value = byteToHex(command);
 $('fieldChecksum').value = byteToHex(checksum);
 return bytes;
}

function injectErrors(bytes) {
 const rate = parseInt($('errorRate').value) || 0;
 if (rate === 0) return bytes.slice();
...
function renderFrameHex(txBytes, rxBytes) {
 const inspector = $('frameInspector');
 if (!inspector) return;
 const labels = ['preamble', 'addr', 'cmd', 'payload', 'checksum'];
 const cssClass = ['hex-preamble', 'hex-addr', 'hex-cmd', 'hex-payload', 'hex-checksum'];

 let html = '<strong>TX:</strong> ';
 txBytes.forEach((b, i) => {
 html += `<span class="hex-byte ${cssClass[i] || ''}">${byteToHex(b)}</span>`;
 });
 html += '<br><strong>RX:</strong> ';
 rxBytes.forEach((b, i) => {
 const corrupted = b !== txBytes[i] ? ' hex-corrupted' : '';
 html += `<span class="hex-byte ${cssClass[i] || ''}${corrupted}">${byteToHex(b)}</span>`;
 });
 inspector.innerHTML = html;
}

function updateChecksumStatus(pass) {
 const el = $('checksumStatus');
 if (!el) return;
 const s = LANG[currentLang];
 el.classList.remove('pass', 'fail', 'idle');
 if (pass) {
 el.classList.add('pass');
 el.textContent = s.csPass;
 } else {
 el.classList.add('fail');
 el.textContent = s.csFail;
 }
}

function moveRobot(cmd) {
 switch (cmd) {
 case 'UP': robotY = Math.max(BOUNDS.minY, robotY - STEP); break;
 case 'DOWN': robotY = Math.min(BOUNDS.maxY, robotY + STEP); break;
 case 'LEFT': robotX = Math.max(BOUNDS.minX, robotX - STEP); break;
 case 'RIGHT': robotX = Math.min(BOUNDS.maxX, robotX + STEP); break;
 case 'A': /* action: pulse */ break;
 case 'B': /* action: reset position */
 robotX = 102; robotY = 72; trails = []; break;
 }
 const robot = $('deviceRobot');
 if (robot) {
 // Add trail dot
 const display = $('deviceDisplay');
 if (display && cmd !== 'B') {
 const dot = document.createElement('div');
 dot.className = 'device-trail';
 dot.style.left = (robotX + 14) + 'px';
 dot.style.top = (robotY + 14) + 'px';
 ...
 if (cmd === 'B') {
 // Clear trails
 trails.forEach(t => { if (t.parentElement) t.parentElement.removeChild(t); });
 trails = [];
 }
 ...
 setTimeout(() => { robot.style.transform = ''; }, 200);
 }
 }
}
...
function sendCommand(cmd) {
 const s = LANG[currentLang];
 const cmdCode = CMD_MAP[cmd];
 if (cmdCode == null) return;

 // Build frame
 const txBytes = buildFrame(cmdCode);
 const txHex = txBytes.map(byteToHex).join('');
 log(`${s.txSending}: [${txHex}] cmd=${cmd}`, 'tx');

 // Inject errors
 const rxBytes = injectErrors(txBytes);
 const rxHex = rxBytes.map(byteToHex).join('');
 const isCorrupted = txHex !== rxHex;

 if (isCorrupted) {
 log(`${s.rxCorrupted}: [${rxHex}]`, 'rx');
 } else {
 log(`${s.rxReceived}: [${rxHex}]`, 'rx');
 }

 // Render hex inspector
 renderFrameHex(txBytes, rxBytes);

 // Verify checksum
 const pass = verifyChecksum(rxBytes);
 updateChecksumStatus(pass);

 if (pass) {
 log(s.checksumOk, 'success');
 moveRobot(cmd);
 log(`${s.deviceMoved} ${cmd}`, 'info');
 setStatus(true);
 playSound('success');
 } else {
 log(s.checksumFail, 'error');
 log(s.deviceIgnored, 'error');
 setStatus(false);
 playSound('error');
 }

 showToast(pass ? s.checksumOk : s.checksumFail, 1500);
}

function initRFSimulation() {
 // Command buttons
 const grid = $('cmdGrid');
 if (grid) {
 ...
 // Error rate slider
 const slider = $('errorRate');
 const sliderVal = $('errorRateVal');
 if (slider && sliderVal) {
 ...
 // Reset checksum status
 const csEl = $('checksumStatus');
 if (csEl) {
 csEl.classList.add('idle');
 csEl.textContent = LANG[currentLang].csIdle;
 }
 ...
 switch (e.key) {
 case 'ArrowUp': e.preventDefault(); sendCommand('UP'); break;
 case 'ArrowDown': e.preventDefault(); sendCommand('DOWN'); break;
 case 'ArrowLeft': e.preventDefault(); sendCommand('LEFT'); break;
 case 'ArrowRight': e.preventDefault(); sendCommand('RIGHT'); break;
 case 'a': case 'A': sendCommand('A'); break;
 case 'b': case 'B': sendCommand('B'); break;
 }
 });
}
