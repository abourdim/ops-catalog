...
const LANG = {
  en: {
    ...
    howto_1: 'Edit the Preamble, Address, and Payload fields to customize your protocol frame format.',
  ...
  fr: {
    ...
    howto_1: 'Modifie les champs Preambule, Adresse et Donnees pour personnaliser le format de ta trame.',
  ...
  ar: {
    ...
    howto_1: 'عدّل حقول المقدمة والعنوان والبيانات لتخصيص تنسيق إطار البروتوكول.',
