...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-5ED2BA',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Frequency Duel \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Frequency Duel', subtitle: '📊 visualize · 📡 transmit · 🔍 analyze',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Frequency Duel — 2.4GHz Waterfall', mainDesc: 'See your signal in the 2.4GHz spectrum',
 ...
 howto_1: 'The main display shows the Frequency Duel simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Configure the parameters for Frequency Duel. Choose your inp',
 howto_2: 'Use the channel slider (0–83) to select a micro:bit frequency channel. Take note of how the visualization changes. Each visual element represents a specific data value or process state. The colors encode information: brighter typically means higher values or more activity.',
 howto_3: 'Adjust the power slider (0–7) to control signal strength. Now look at the data panels below the main visualization. The numbers update in real time and correspond to what you see visually. Matching the numbers to the visual helps build quantitative understanding.',
 howto_4: 'Press Transmit to send a burst — watch the green spike appear on the waterfall. The key insight is the relationship between your input and the system output. Try predicting what will happen before you make each change — this prediction-testing cycle is how experts develop intuition.',
 wiki_band_title: '📡 2.4GHz Band', wiki_band: 'The 2.4GHz ISM band spans 2.400–2.4835 GHz. It is license-free worldwide and used by WiFi (802.11b/g/n), Bluetooth, Zigbee, micro:bit, and more.',
 wiki_waterfall_title: '📊 Waterfall Display', wiki_waterfall: 'A waterfall (spectrogram) shows frequency on the X-axis and time on the Y-axis. Color intensity represents signal power. New data appears at the bottom, scrolling upward.',
 wiki_interference_title: '⚡ Interference', wiki_interference: 'Interference occurs when multiple signals overlap in frequency and time. In the 2.4GHz band, WiFi uses wide 20MHz channels while micro:bit uses narrow 1MHz channels.',
 wiki_channels_title: '🔧 Channel Selection', wiki_channels: 'The micro:bit has 84 channels (0–83), each 1MHz wide, starting at 2.400GHz. WiFi channels 1, 6, and 11 are the most common — avoid them for best results.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📊 Waterfall simulator ready!',
 ...
 themeChanged: '🎨 Theme →',
 legendMicrobit: 'micro:bit', legendWifi: 'WiFi', legendBt: 'Bluetooth', legendNoise: 'Noise',
 transmitBtn: 'Transmit', channelLabel: 'Channel', powerLabel: 'Power',
 interferenceLabel: 'Interference',
 howItWorks1: 'The 2.4GHz ISM band (2.400–2.485 GHz) is shared by WiFi, Bluetooth, micro:bit, and many other devices.',
 howItWorks2: 'The waterfall display shows radio energy over time — each row is a spectrum snapshot, scrolling upward.',
 howItWorks3: 'The micro:bit uses 84 channels of 1MHz width each across the 2.4GHz band.',
 howItWorks4: 'Interference appears as overlapping colored signals — finding clear channels is key to reliable communication.',
 lab1: 'Adjust the channel slider and observe where your signal lands on the waterfall.',
 lab2: 'Change the power level and see how signal strength affects visibility and interference.',
 lab3: 'Find a clear channel that avoids the WiFi bumps at channels 1, 6, and 11.',
 lab4: 'Compare narrow micro:bit signals versus wide WiFi channels to understand bandwidth differences.',
 challenge1: 'Find the quietest channel — transmit with zero interference detected.',
 challenge2: 'Transmit without WiFi interference — avoid all three WiFi hotspots on the band.',
 challenge3: 'Identify all signal types — recognize micro:bit, WiFi, Bluetooth, and noise by color and pattern.',
 txSent: 'TX burst on channel',
 txPower: 'power',
 ...
 theory: 'Frequency Duel demonstrates key principles from satellite comms. The electromagnetic spectrum is divided into bands allocated by regulators. Spectrum is a finite resource — efficient use is critical for modern communications. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-5ED2BA',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Frequency Duel \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Frequency Duel', subtitle: '📊 visualiser · 📡 transmettre · 🔍 analyser',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Duel de Fréquences — Cascade 2.4GHz', mainDesc: 'Visualisez votre signal dans le spectre 2.4GHz',
 ...
 howto_1: 'L écran principal affiche la simulation Frequency Duel. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for Frequency Duel. Choose your inp',
 howto_2: 'Utilisez le curseur de canal (0–83) pour sélectionner un canal de fréquence micro:bit.',
 howto_3: 'Ajustez le curseur de puissance (0–7) pour contrôler l\'intensité du signal. Regardez les panneaux de données sous la visualisation principale. Les chiffres se mettent à jour en temps réel et correspondent à ce que vous voyez visuellement.',
 howto_4: 'Appuyez sur Transmettre pour envoyer une rafale — observez le pic vert sur la cascade.',
 wiki_band_title: '📡 Bande 2.4GHz', wiki_band: 'La bande ISM 2.4GHz s\'étend de 2.400 à 2.4835 GHz. Elle est libre de licence et utilisée par WiFi, Bluetooth, Zigbee, micro:bit, et plus.',
 wiki_waterfall_title: '📊 Affichage en cascade', wiki_waterfall: 'Une cascade (spectrogramme) montre la fréquence sur l\'axe X et le temps sur l\'axe Y. L\'intensité de la couleur représente la puissance du signal.',
 wiki_interference_title: '⚡ Interférences', wiki_interference: 'Les interférences surviennent quand plusieurs signaux se chevauchent en fréquence et en temps. Le WiFi utilise des canaux larges de 20MHz contre 1MHz pour le micro:bit.',
 wiki_channels_title: '🔧 Sélection de canal', wiki_channels: 'Le micro:bit a 84 canaux (0–83), chacun large de 1MHz, à partir de 2.400GHz. Les canaux WiFi 1, 6, et 11 sont les plus courants — évitez-les.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📊 Simulateur de cascade prêt !',
 ...
 themeChanged: '🎨 Thème →',
 legendMicrobit: 'micro:bit', legendWifi: 'WiFi', legendBt: 'Bluetooth', legendNoise: 'Bruit',
 transmitBtn: 'Transmettre', channelLabel: 'Canal', powerLabel: 'Puissance',
 interferenceLabel: 'Interférences',
 howItWorks1: 'La bande ISM 2.4GHz (2.400–2.485 GHz) est partagée par WiFi, Bluetooth, micro:bit et de nombreux autres appareils.',
 howItWorks2: 'La cascade montre l\'énergie radio au fil du temps — chaque ligne est un instantané du spectre, défilant vers le haut.',
 howItWorks3: 'Le micro:bit utilise 84 canaux de 1MHz de largeur chacun à travers la bande 2.4GHz.',
 howItWorks4: 'Les interférences apparaissent comme des signaux colorés qui se chevauchent — trouver des canaux libres est essentiel.',
 lab1: 'Ajustez le curseur de canal et observez où votre signal atterrit sur la cascade.',
 lab2: 'Changez le niveau de puissance et voyez comment l\'intensité affecte la visibilité et les interférences.',
 lab3: 'Trouvez un canal libre qui évite les bosses WiFi aux canaux 1, 6 et 11.',
 lab4: 'Comparez les signaux étroits du micro:bit aux canaux WiFi larges pour comprendre les différences de bande passante.',
 challenge1: 'Trouvez le canal le plus calme — transmettez sans aucune interférence détectée.',
 challenge2: 'Transmettez sans interférence WiFi — évitez les trois points WiFi de la bande.',
 challenge3: 'Identifiez tous les types de signaux — reconnaissez micro:bit, WiFi, Bluetooth et bruit par couleur et motif.',
 txSent: 'Rafale TX sur canal',
 txPower: 'puissance',
 ...
 theory: 'Frequency Duel démontre les principes clés de communications satellite. The electromagnetic spectrum is divided into bands allocated by regulators. Spectrum is a finite resource — efficient use is critical for modern communications. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Frequency Duel', subtitle: '📊 تصوّر · 📡 أرسل · 🔍 حلّل',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مبارزة التردد — شلال 2.4GHz', mainDesc: 'شاهد إشارتك في طيف 2.4GHz',
 ...
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Frequency Duel. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Configure the parameters for Frequency Duel. Choose your inp',
 howto_2: 'استخدم منزلق القناة (0–83) لتحديد قناة تردد micro:bit. لاحظ كيف يتغير التصور. كل عنصر مرئي يمثل قيمة بيانات محددة أو حالة عملية. الألوان تشفر المعلومات: الأكثر سطوعاً عادة يعني قيماً أعلى.',
 howto_3: 'اضبط منزلق الطاقة (0–7) للتحكم في قوة الإشارة. انظر الآن إلى لوحات البيانات أسفل التصور الرئيسي. تتحدث الأرقام في الوقت الفعلي وتتوافق مع ما تراه بصرياً.',
 howto_4: 'اضغط إرسال لإطلاق دفعة — شاهد الذروة الخضراء تظهر على الشلال. الفكرة الأساسية هي العلاقة بين مدخلاتك ومخرجات النظام. حاول التنبؤ بما سيحدث قبل كل تغيير.',
 wiki_band_title: '📡 نطاق 2.4GHz', wiki_band: 'نطاق ISM 2.4GHz يمتد من 2.400 إلى 2.4835 GHz. مجاني الترخيص عالميًا ويستخدمه WiFi وBluetooth وZigbee وmicro:bit وغيرها.',
 wiki_waterfall_title: '📊 عرض الشلال', wiki_waterfall: 'الشلال (مخطط طيفي) يعرض التردد على المحور X والوقت على المحور Y. شدة اللون تمثل قوة الإشارة. البيانات الجديدة تظهر في الأسفل وتتدحرج لأعلى.',
 wiki_interference_title: '⚡ التداخل', wiki_interference: 'يحدث التداخل عندما تتراكب عدة إشارات في التردد والوقت. WiFi يستخدم قنوات عريضة 20MHz بينما micro:bit يستخدم قنوات ضيقة 1MHz.',
 wiki_channels_title: '🔧 اختيار القناة', wiki_channels: 'micro:bit لديه 84 قناة (0–83)، كل منها بعرض 1MHz، بدءًا من 2.400GHz. قنوات WiFi 1 و6 و11 هي الأكثر شيوعًا — تجنبها.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '📊 محاكي الشلال جاهز!',
 ...
 theory: 'Frequency Duel يوضح المبادئ الأساسية في اتصالات الأقمار. The electromagnetic spectrum is divided into bands allocated by regulators. Spectrum is a finite resource — efficient use is critical for modern communications. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
/* ═══════ 2.4GHz WATERFALL SIMULATION ═══════ */

let wfCanvas, wfCtx, wfWidth, wfHeight;
let wfRunning = false;
let wfAnimId = null;
let txBurstFrames = 0; // countdown for transmit burst visual
const BAND_MHZ = 85; // 2400–2485 MHz = 85 columns
const SCROLL_INTERVAL = 80; // ms between new rows

// WiFi channels center frequencies (relative to 2400 MHz)
// WiFi ch1 = 2412 MHz (col 12), ch6 = 2437 (col 37), ch11 = 2462 (col 62)
// Each WiFi channel is ~20MHz wide
const WIFI_CENTERS = [12, 37, 62];
const WIFI_HALF_WIDTH = 10; // +/- 10 columns = 20MHz

// Generate one row of spectrum data (0–255 per column)
function generateSpectrumRow(channel, power, isTxBurst) {
 const row = new Uint8Array(BAND_MHZ);

 // 1. Noise floor (random low values)
 for (let i = 0; i < BAND_MHZ; i++) {
 row[i] = 8 + Math.random() * 18;
 }

 // 2. WiFi bumps (wide Gaussian-ish humps)
 for (const center of WIFI_CENTERS) {
 const wifiStrength = 60 + Math.random() * 50; // variable WiFi power
 for (let i = 0; i < BAND_MHZ; i++) {
 const dist = Math.abs(i - center);
 if (dist <= WIFI_HALF_WIDTH) {
 const falloff = 1 - (dist / WIFI_HALF_WIDTH);
 const bump = wifiStrength * falloff * falloff;
 row[i] = Math.min(255, row[i] + bump);
 }
 }
 }

 // 3. Bluetooth hopping (narrow random spikes)
 const btCount = 2 + Math.floor(Math.random() * 4);
 for (let b = 0; b < btCount; b++) {
 const btCol = Math.floor(Math.random() * BAND_MHZ);
 const btPow = 30 + Math.random() * 60;
 row[btCol] = Math.min(255, row[btCol] + btPow);
 // Sometimes spread 1 col
 if (btCol > 0) row[btCol - 1] = Math.min(255, row[btCol - 1] + btPow * 0.3);
 if (btCol < BAND_MHZ - 1) row[btCol + 1] = Math.min(255, row[btCol + 1] + btPow * 0.3);
 }

 // 4. micro:bit transmit burst (green spike at selected channel)
 if (isTxBurst && channel >= 0 && channel < BAND_MHZ) {
 const txPow = 80 + (power / 7) * 175; // scale 0-7 to 80-255
 row[channel] = Math.min(255, row[channel] + txPow);
 // Slight spread for realism
 if (channel > 0) row[channel - 1] = Math.min(255, row[channel - 1] + txPow * 0.2);
 if (channel < BAND_MHZ - 1) row[channel + 1] = Math.min(255, row[channel + 1] + txPow * 0.2);
 }

 return row;
}

// Map power value to a color
// blue (weak) → green (medium) → yellow (strong) → red (very strong)
function powerToColor(val, isMicrobit) {
 if (isMicrobit) {
 // micro:bit signals are rendered green
 const a = Math.min(1, val / 180);
 return `rgba(51, 255, 51, ${0.3 + a * 0.7})`;
 }
 // General heatmap
 if (val < 30) return `rgba(20, 20, 60, 0.9)`; // noise floor (dark)
 if (val < 80) return `rgba(0, ${80 + val}, 255, 0.9)`; // blue (weak)
 if (val < 140) return `rgba(0, ${val + 80}, ${200 - val}, 0.9)`; // green (medium)
 if (val < 200) return `rgba(${val + 30}, ${255 - (val - 140)}, 0, 0.9)`; // yellow (strong)
 return `rgba(255, ${Math.max(0, 80 - (val - 200))}, 0, 0.9)`; // red (very strong)
}

// Calculate interference for current channel
function calcInterference(channel) {
 let interference = 0;
 for (const center of WIFI_CENTERS) {
 const dist = Math.abs(channel - center);
 if (dist <= WIFI_HALF_WIDTH) {
 interference += (1 - dist / WIFI_HALF_WIDTH) * 100;
 }
 }
 return Math.min(100, Math.round(interference));
}

// Draw one new waterfall row at bottom
function drawWaterfallRow() {
 if (!wfCtx) return;
 const ch = parseInt($('channelSlider')?.value || 40);
 const pw = parseInt($('powerSlider')?.value || 4);
 const isBurst = txBurstFrames > 0;
 if (isBurst) txBurstFrames--;

 const row = generateSpectrumRow(ch, pw, isBurst);
 const colW = wfWidth / BAND_MHZ;
 const rowH = 2;

 // Scroll existing content up
 const imgData = wfCtx.getImageData(0, rowH, wfWidth, wfHeight - rowH);
 wfCtx.putImageData(imgData, 0, 0);

 // Draw new row at bottom
 for (let i = 0; i < BAND_MHZ; i++) {
 const isMb = isBurst && (i >= ch - 1 && i <= ch + 1);
 wfCtx.fillStyle = powerToColor(row[i], isMb);
 wfCtx.fillRect(i * colW, wfHeight - rowH, colW + 1, rowH);
 }

 // Update interference meter
 const interference = calcInterference(ch);
 const meter = $('interferenceLevel');
 const txt = $('interferenceText');
 if (meter) meter.value = interference;
 if (txt) txt.textContent = interference + '%';
}
...
function startWaterfall() {
 ...
 if (!wfRunning) return;
 drawWaterfallRow();
 wfAnimId = setTimeout(tick, SCROLL_INTERVAL);
 }
 tick();
 log('📊 Waterfall display started', 'info');
}
...
function doTransmit() {
 ...
 const pw = parseInt($('powerSlider')?.value || 4);
 const s = LANG[currentLang];
 txBurstFrames = 12; // visible for ~1 second

 const interference = calcInterference(ch);
 log(`📡 ${s.txSent} ${ch} — ${s.txPower} ${pw}`, 'tx');

 if (interference === 0) {
 log(`✅ ${s.interferenceNone}`, 'success');
 } else if (interference < 30) {
 log(`⚠️ ${s.interferenceLow} (${interference}%)`, 'info');
 } else if (interference < 70) {
 log(`⚠️ ${s.interferenceMed} (${interference}%)`, 'info');
 } else {
 log(`🔴 ${s.interferenceHigh} (${interference}%)`, 'error');
 }
 playSound('click');
 setStatus(true);
...
// Wire up waterfall controls
function initWaterfall() {
 // Slider value display updates
 const chSlider = $('channelSlider');
 const chValue = $('channelValue');
 const pwSlider = $('powerSlider');
 const pwValue = $('powerValue');

 if (chSlider && chValue) {
 chSlider.addEventListener('input', () => {
 chValue.textContent = chSlider.value;
 });
 }
 if (pwSlider && pwValue) {
 ...
 // Transmit button
 const txBtn = $('txBtn');
 if (txBtn) txBtn.addEventListener('click', doTransmit);
