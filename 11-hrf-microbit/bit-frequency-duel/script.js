...
const LANG = {
  en: {
    ...
    howto_4: 'Press Transmit to send a burst — watch the green spike appear on the waterfall.',
  ...
  ar: {
    ...
    howto_4: 'اضغط إرسال لإطلاق دفعة — شاهد الذروة الخضراء تظهر على الشلال.',
