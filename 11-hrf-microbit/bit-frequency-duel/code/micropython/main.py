"""
bit-frequency-duel — micro:bit MicroPython
...
# ── Configuration ──
APP_NAME = "bit-frequency-duel"
RADIO_GROUP = 191
RADIO_POWER = 6  # 0-7

# ── Process Overview ──
# Step 1: The 2.4GHz ISM band (2.400–2.485 GHz) is shared by WiFi, Bluetooth, micro:bit, and many other devices.
# Step 2: The waterfall display shows radio energy over time — each row is a spectrum snapshot, scrolling upward.
# Step 3: The micro:bit uses 84 channels of 1MHz width each across the 2.4GHz band.
# Step 4: Interference appears as overlapping colored signals — finding clear channels is key to reliable communication.
