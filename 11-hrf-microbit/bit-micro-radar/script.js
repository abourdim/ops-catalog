...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-4C41C1',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Micro Radar \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Micro Radar', subtitle: '📡 scan · 🗺️ map · 🎯 detect',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Micro Radar — EM Map', mainDesc: 'Build a radar display from sensor data',
 sectionA: 'How It Works', sectionB: 'Lab', sectionC: 'Challenge',
 startSweep: 'Start Sweep', stopSweep: 'Stop',
 rangeLabel: 'Range:', detectedLabel: 'Detected:', modeLabel: 'Mode:',
 modeActive: 'Active', modePassive: 'Passive',
 noObjects: 'No objects detected yet.',
 sweepStarted: '📡 Radar sweep started', sweepStopped: '🛑 Radar sweep stopped',
 objectDetected: '🎯 Object detected', objectPlaced: '📍 Object placed on map',
 rangeChanged: '📏 Range changed to', modeChanged: '🔄 Mode changed to',
 step1: 'The sweep line rotates, simulating antenna direction scanning across 360 degrees.',
 step2: 'At each angle, sensors detect reflected or emitted electromagnetic signals from objects.',
 step3: 'Detected signals are plotted on polar coordinates — angle determines direction, distance determines radius.',
 step4: 'Over a full rotation, the radar builds a complete map of all surrounding objects.',
 labIntro: 'Experiment with the radar simulation. Click the canvas to place virtual objects, then watch them appear as blips during a sweep.',
 labPlace: '🎯 Place Objects', labPlaceDesc: 'Click on the radar canvas to place virtual objects at any position. Each click adds a new target.',
 labWatch: '📡 Watch Detection', labWatchDesc: 'Start a sweep and observe how objects light up as bright blips when the sweep line passes over them.',
 labRange: '📏 Adjust Range', labRangeDesc: 'Change the range selector to zoom in (10m) or out (100m). Range rings rescale to match.',
 labMode: '🔄 Compare Modes', labModeDesc: 'In Active mode, all objects are visible. In Passive mode, only emitting objects appear on the radar.',
 ch1Title: 'Full Sweep Identification', ch1Desc: 'Identify all objects in a single 360-degree sweep. Can you name every detected target before the sweep completes?',
 ch2Title: 'Moving Target Tracker', ch2Desc: 'Track a moving target across multiple sweeps. Predict its next position based on observed bearing and distance changes.',
 ch3Title: 'Stealth Detection', ch3Desc: 'Detect the stealth object that only appears as a faint blip. Switch between Active and Passive modes to find it.',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Micro Radar simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Configure the parameters for Micro Radar. Choose your input ',
 ...
 wiki_radar_title: '📡 Radar Principles', wiki_radar: 'Radar (Radio Detection and Ranging) works by sending out electromagnetic waves and measuring reflections. The time delay and angle reveal object position and distance.',
 wiki_polar_title: '🎯 Polar Coordinates', wiki_polar: 'Unlike Cartesian (x,y) grids, polar coordinates use angle and distance from a center point. This is natural for radar displays where the antenna is at the origin.',
 wiki_em_title: '⚡ EM Detection', wiki_em: 'Electromagnetic detection includes both active (sending signals and listening for echoes) and passive (listening for signals emitted by objects) methods.',
 wiki_microbit_title: '🤖 micro:bit Sensors', wiki_microbit: 'The micro:bit has an accelerometer (motion/tilt) and magnetometer (compass/direction). These can simulate radar antenna orientation and sweep control.',
 working: 'Working…',
 ...
 gloss1_term: 'Doppler Shift',
 gloss1_def: 'Frequency change caused by relative motion between transmitter and receiver. Approaching objects shift frequency up; receding objects shift it down. fd = 2v·f₀/c.',
 gloss2_term: 'Latency',
 ...
 theory: 'Micro Radar demonstrates key principles from satellite comms. Radar transmits electromagnetic pulses and measures reflections to detect objects. Range, velocity, and angle can be determined from the echo characteristics. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-4C41C1',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Micro Radar \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Micro Radar', subtitle: '📡 scanner · 🗺️ cartographier · 🎯 détecter',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Micro Radar — Carte EM', mainDesc: 'Construire un affichage radar à partir de capteurs',
 sectionA: 'Comment ça marche', sectionB: 'Labo', sectionC: 'Défi',
 startSweep: 'Lancer le balayage', stopSweep: 'Arrêter',
 rangeLabel: 'Portée :', detectedLabel: 'Détectés :', modeLabel: 'Mode :',
 modeActive: 'Actif', modePassive: 'Passif',
 noObjects: 'Aucun objet détecté pour le moment.',
 sweepStarted: '📡 Balayage radar lancé', sweepStopped: '🛑 Balayage radar arrêté',
 objectDetected: '🎯 Objet détecté', objectPlaced: '📍 Objet placé sur la carte',
 rangeChanged: '📏 Portée changée à', modeChanged: '🔄 Mode changé en',
 step1: 'La ligne de balayage tourne, simulant le scan directionnel de l\'antenne sur 360 degrés.',
 step2: 'À chaque angle, les capteurs détectent les signaux électromagnétiques réfléchis ou émis par les objets.',
 step3: 'Les signaux détectés sont tracés en coordonnées polaires — l\'angle détermine la direction, la distance détermine le rayon.',
 step4: 'Sur une rotation complète, le radar construit une carte de tous les objets environnants.',
 labIntro: 'Expérimentez avec la simulation radar. Cliquez sur le canevas pour placer des objets virtuels, puis regardez-les apparaître pendant un balayage.',
 labPlace: '🎯 Placer des objets', labPlaceDesc: 'Cliquez sur le canevas radar pour placer des objets virtuels. Chaque clic ajoute une nouvelle cible.',
 labWatch: '📡 Observer la détection', labWatchDesc: 'Lancez un balayage et observez comment les objets s\'illuminent comme des points lumineux quand la ligne passe au-dessus.',
 labRange: '📏 Ajuster la portée', labRangeDesc: 'Changez le sélecteur de portée pour zoomer (10m) ou dézoomer (100m). Les anneaux se redimensionnent.',
 labMode: '🔄 Comparer les modes', labModeDesc: 'En mode Actif, tous les objets sont visibles. En mode Passif, seuls les objets émetteurs apparaissent.',
 ch1Title: 'Identification complète', ch1Desc: 'Identifiez tous les objets en un seul balayage de 360 degrés. Pouvez-vous nommer chaque cible avant la fin du balayage ?',
 ch2Title: 'Suivi de cible mobile', ch2Desc: 'Suivez une cible en mouvement sur plusieurs balayages. Prédisez sa prochaine position à partir du relèvement et de la distance.',
 ch3Title: 'Détection furtive', ch3Desc: 'Détectez l\'objet furtif qui n\'apparaît que comme un faible écho. Basculez entre modes Actif et Passif pour le trouver.',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Micro Radar. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for Micro Radar. Choose your input ',
 ...
 wiki_radar_title: '📡 Principes du Radar', wiki_radar: 'Le radar (détection et télémétrie par ondes radio) fonctionne en émettant des ondes électromagnétiques et en mesurant les réflexions. Le délai et l\'angle révèlent la position.',
 wiki_polar_title: '🎯 Coordonnées polaires', wiki_polar: 'Contrairement aux grilles cartésiennes (x,y), les coordonnées polaires utilisent l\'angle et la distance depuis un point central. C\'est naturel pour les écrans radar.',
 wiki_em_title: '⚡ Détection EM', wiki_em: 'La détection électromagnétique comprend les méthodes actives (émission et écoute d\'échos) et passives (écoute des signaux émis par les objets).',
 wiki_microbit_title: '🤖 Capteurs micro:bit', wiki_microbit: 'Le micro:bit possède un accéléromètre (mouvement/inclinaison) et un magnétomètre (boussole/direction). Ils peuvent simuler l\'orientation de l\'antenne radar.',
 working: 'En cours…',
 ...
 theory: 'Micro Radar démontre les principes clés de communications satellite. Radar transmits electromagnetic pulses and measures reflections to detect objects. Range, velocity, and angle can be determined from the echo characteristics. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Micro Radar', subtitle: '📡 مسح · 🗺️ خريطة · 🎯 كشف',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'رادار مصغّر — خريطة EM', mainDesc: 'بناء شاشة رادار من بيانات المستشعرات',
 sectionA: 'كيف يعمل', sectionB: 'المختبر', sectionC: 'التحدي',
 startSweep: 'بدء المسح', stopSweep: 'إيقاف',
 rangeLabel: 'المدى:', detectedLabel: 'المكتشفة:', modeLabel: 'الوضع:',
 modeActive: 'نشط', modePassive: 'سلبي',
 noObjects: 'لم يتم اكتشاف أي أجسام بعد.',
 sweepStarted: '📡 بدأ مسح الرادار', sweepStopped: '🛑 توقف مسح الرادار',
 objectDetected: '🎯 تم اكتشاف جسم', objectPlaced: '📍 تم وضع جسم على الخريطة',
 rangeChanged: '📏 تم تغيير المدى إلى', modeChanged: '🔄 تم تغيير الوضع إلى',
 step1: 'يدور خط المسح محاكيًا مسح اتجاه الهوائي عبر 360 درجة.',
 step2: 'عند كل زاوية، تكشف المستشعرات الإشارات الكهرومغناطيسية المنعكسة أو المنبعثة من الأجسام.',
 step3: 'تُرسم الإشارات المكتشفة على إحداثيات قطبية — الزاوية تحدد الاتجاه والمسافة تحدد نصف القطر.',
 step4: 'على مدار دورة كاملة، يبني الرادار خريطة شاملة لجميع الأجسام المحيطة.',
 labIntro: 'جرّب محاكاة الرادار. انقر على اللوحة لوضع أجسام افتراضية ثم شاهدها تظهر أثناء المسح.',
 labPlace: '🎯 وضع الأجسام', labPlaceDesc: 'انقر على لوحة الرادار لوضع أجسام افتراضية في أي موضع. كل نقرة تضيف هدفًا جديدًا.',
 labWatch: '📡 مشاهدة الكشف', labWatchDesc: 'ابدأ المسح وراقب كيف تضيء الأجسام كنقاط مضيئة عندما يمر خط المسح فوقها.',
 labRange: '📏 ضبط المدى', labRangeDesc: 'غيّر محدد المدى للتكبير (10م) أو التصغير (100م). تتغير حلقات المدى تلقائيًا.',
 labMode: '🔄 مقارنة الأوضاع', labModeDesc: 'في الوضع النشط، كل الأجسام مرئية. في الوضع السلبي، فقط الأجسام المُصدرة تظهر على الرادار.',
 ch1Title: 'التعرف الكامل بالمسح', ch1Desc: 'حدد جميع الأجسام في مسح واحد بزاوية 360 درجة. هل يمكنك تسمية كل هدف مكتشف قبل اكتمال المسح؟',
 ch2Title: 'تتبع هدف متحرك', ch2Desc: 'تتبع هدفًا متحركًا عبر عدة عمليات مسح. توقع موقعه التالي بناءً على تغيرات الاتجاه والمسافة.',
 ch3Title: 'كشف التخفي', ch3Desc: 'اكتشف الجسم المتخفي الذي يظهر فقط كنقطة باهتة. بدّل بين الوضعين النشط والسلبي للعثور عليه.',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Micro Radar. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Configure the parameters for Micro Radar. Choose your input ',
 ...
 wiki_radar_title: '📡 مبادئ الرادار', wiki_radar: 'الرادار يعمل بإرسال موجات كهرومغناطيسية وقياس الانعكاسات. التأخير الزمني والزاوية يكشفان موقع الجسم ومسافته.',
 wiki_polar_title: '🎯 الإحداثيات القطبية', wiki_polar: 'على عكس الشبكات الديكارتية (x,y)، تستخدم الإحداثيات القطبية الزاوية والمسافة من نقطة مركزية. هذا طبيعي لشاشات الرادار.',
 wiki_em_title: '⚡ الكشف الكهرومغناطيسي', wiki_em: 'يشمل الكشف الكهرومغناطيسي الطرق النشطة (إرسال إشارات والاستماع للأصداء) والسلبية (الاستماع للإشارات المنبعثة من الأجسام).',
 wiki_microbit_title: '🤖 مستشعرات micro:bit', wiki_microbit: 'يحتوي micro:bit على مقياس تسارع (حركة/ميل) ومقياس مغناطيسي (بوصلة/اتجاه). يمكنهما محاكاة توجيه هوائي الرادار.',
 working: 'جارٍ…',
 ...
 theory: 'Micro Radar يوضح المبادئ الأساسية في اتصالات الأقمار. Radar transmits electromagnetic pulses and measures reflections to detect objects. Range, velocity, and angle can be determined from the echo characteristics. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
const OBJECT_TYPES = ['aircraft', 'ship', 'vehicle', 'drone', 'unknown'];
let radarObjects = [];
let radarSweepAngle = 0;
let radarSweeping = false;
let radarAnimId = null;
let radarBlips = [];
let radarCanvas, radarCtx;
let radarRange = 50;
let radarMode = 'active'; // 'active' | 'passive'
...
function initRadar() {
 ...
 const stopBtn = $('stopSweepBtn');
 const rangeSelect = $('rangeSelect');
 const modeSelect = $('radarMode');

 if (sweepBtn) sweepBtn.onclick = startSweep;
 if (stopBtn) stopBtn.onclick = stopSweep;
 if (rangeSelect) rangeSelect.onchange = () => {
 radarRange = parseInt(rangeSelect.value);
 log(`${LANG[currentLang].rangeChanged} ${radarRange}m`, 'info');
 drawRadar();
 };
 if (modeSelect) modeSelect.onchange = () => {
 radarMode = modeSelect.value;
 const s = LANG[currentLang];
 const label = radarMode === 'active' ? (s.modeActive || 'Active') : (s.modePassive || 'Passive');
 log(`${s.modeChanged} ${label}`, 'info');
 };

 // Click to place objects
 radarCanvas.addEventListener('click', placeObjectOnCanvas);

 // Seed initial random objects
 seedRadarObjects(5);
 drawRadar();
}

function seedRadarObjects(count) {
 radarObjects = [];
 for (let i = 0; i < count; i++) {
 radarObjects.push({
 angle: Math.random() * 360,
 distance: 5 + Math.random() * (radarRange * 0.9),
 type: OBJECT_TYPES[Math.floor(Math.random() * OBJECT_TYPES.length)],
 size: 3 + Math.random() * 4,
 emits: Math.random() > 0.4, // ~60% emit signals (visible in passive mode)
 stealth: Math.random() > 0.9, // ~10% are stealth (faint blip)
 moving: Math.random() > 0.7, // ~30% move
...
function placeObjectOnCanvas(e) {
 const rect = radarCanvas.getBoundingClientRect();
 const cx = radarCanvas.width / 2;
 const cy = radarCanvas.height / 2;
 const x = (e.clientX - rect.left) * (radarCanvas.width / rect.width) - cx;
 const y = (e.clientY - rect.top) * (radarCanvas.height / rect.height) - cy;
 ...
 const distance = (dist / radius) * radarRange;
 ...
 log(`${LANG[currentLang].objectPlaced} — ${angle.toFixed(0)}° / ${distance.toFixed(1)}m`, 'info');
 playSound('click');
 drawRadar();
}
...
function startSweep() {
 ...
 radarSweeping = true;
 radarBlips = [];
 log(LANG[currentLang].sweepStarted, 'success');
 setStatus(true);
 showToast(LANG[currentLang].sweepStarted, 2000);
 sweepLoop();
}
...
function stopSweep() {
 ...
 radarAnimId = null;
 log(LANG[currentLang].sweepStopped, 'info');
 setStatus(false);
}
...
function sweepLoop() {
 ...
 if (obj.moving) {
 obj.angle = (obj.angle + obj.speed) % 360;
 obj.distance += (Math.random() - 0.5) * 0.3;
 obj.distance = Math.max(2, Math.min(radarRange * 0.95, obj.distance));
 }
 });

 // Advance sweep angle
 radarSweepAngle = (radarSweepAngle + 1.5) % 360;

 // Check for objects at current sweep angle
 radarObjects.forEach(obj => {
 const angleDiff = Math.abs(((radarSweepAngle - obj.angle) + 540) % 360 - 180);
 if (angleDiff < 3) {
 // Check visibility
 if (radarMode === 'passive' && !obj.emits) return;
 const brightness = obj.stealth ? 0.3 : 1.0;
 radarBlips.push({
 angle: obj.angle,
 ...
 // Decay old blips (older than 5 seconds)
 radarBlips = radarBlips.filter(b => Date.now() - b.timestamp < 5000);

 drawRadar();
 radarAnimId = requestAnimationFrame(sweepLoop);
}
...
function drawRadar() {
 ...
 radarCtx.strokeStyle = 'rgba(0, 255, 0, 0.15)';
 radarCtx.lineWidth = 1;
 radarCtx.stroke();

 // Range label
 const rangeVal = ((radarRange / rings) * i).toFixed(0);
 radarCtx.fillStyle = 'rgba(0, 255, 0, 0.3)';
 radarCtx.font = '9px Orbitron, monospace';
 radarCtx.fillText(rangeVal + 'm', cx + r - 20, cy - 3);
 }
 ...
 radarCtx.fillText('N', cx, cy - radius + 12);
 radarCtx.fillText('S', cx, cy + radius - 4);
 radarCtx.fillText('E', cx + radius - 8, cy + 4);
 radarCtx.fillText('W', cx - radius + 8, cy + 4);

 // Sweep line with fade trail
 if (radarSweeping) {
 const sweepRad = (radarSweepAngle - 90) * Math.PI / 180;
 // Fade trail (30 degrees behind)
 for (let i = 30; i > 0; i--) {
 const trailAngle = sweepRad - (i * Math.PI / 180);
 const alpha = (1 - i / 30) * 0.15;
 radarCtx.beginPath();
 radarCtx.moveTo(cx, cy);
 radarCtx.lineTo(cx + Math.cos(trailAngle) * radius, cy + Math.sin(trailAngle) * radius);
 radarCtx.strokeStyle = `rgba(0, 255, 0, ${alpha})`;
 radarCtx.lineWidth = 1;
 radarCtx.stroke();
 }
 // Main sweep line
 ...
 radarCtx.strokeStyle = 'rgba(0, 255, 0, 0.9)';
 ...
 const age = (Date.now() - blip.timestamp) / 5000;
 const alpha = blip.brightness * (1 - age);
 if (alpha <= 0) return;

 const angleRad = (blip.angle - 90) * Math.PI / 180;
 const r = (blip.distance / radarRange) * radius;
 const bx = cx + Math.cos(angleRad) * r;
 const by = cy + Math.sin(angleRad) * r;

 // Glow
 const grad = radarCtx.createRadialGradient(bx, by, 0, bx, by, blip.size * 2);
 grad.addColorStop(0, `rgba(0, 255, 0, ${alpha})`);
 grad.addColorStop(1, `rgba(0, 255, 0, 0)`);
 radarCtx.fillStyle = grad;
 radarCtx.beginPath();
 radarCtx.arc(bx, by, blip.size * 2, 0, Math.PI * 2);
 radarCtx.fill();

 // Core dot
 radarCtx.fillStyle = `rgba(0, 255, 0, ${Math.min(1, alpha * 1.5)})`;
 radarCtx.beginPath();
 radarCtx.arc(bx, by, blip.size * 0.6, 0, Math.PI * 2);
 radarCtx.fill();
 });
...
function updateObjectList() {
 ...
 const countEl = $('detectCount');
 if (!listEl) return;

 // Deduplicate blips by proximity
 const unique = [];
 radarBlips.forEach(b => {
 const exists = unique.find(u =>
 Math.abs(u.angle - b.angle) < 5 && Math.abs(u.distance - b.distance) < 3
 );
 if (!exists) unique.push(b);
 else if (b.timestamp > exists.timestamp) {
 Object.assign(exists, b);
 }
 });
 ...
 if (unique.length === 0) {
 listEl.innerHTML = `<em data-i18n="noObjects" style="opacity:0.5;">${LANG[currentLang].noObjects}</em>`;
 return;
 }

 listEl.innerHTML = unique.map(b =>
 `<div class="obj-row">
 <span>${b.angle.toFixed(0)}°</span>
 <span>${b.distance.toFixed(1)}m</span>
 <span>${b.type}</span>
 </div>`
 ).join('');
}
