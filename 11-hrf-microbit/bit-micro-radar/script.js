...
const LANG = {
  en: {
    ...
    howto_4: 'Switch between Active and Passive modes to compare detection capabilities.',
  ...
  fr: {
    ...
    howto_4: 'Basculez entre modes Actif et Passif pour comparer les capacités.',
  ...
  ar: {
    ...
    howto_4: 'بدّل بين الوضعين النشط والسلبي لمقارنة قدرات الكشف.',
