...
const LANG = {
  en: {
    ...
    howto_4: 'Unlock all 4 locks to escape! Try to beat the clock.',
    wiki_cipher_title: '🔤 Caesar Cipher', wiki_cipher: 'A substitution cipher where each letter is shifted by a fixed amount.',
    wiki_logic_title: '🧠 Logic Gates', wiki_logic: 'AND, OR, NOT, XOR — fundamental building blocks of digital circuits.',
