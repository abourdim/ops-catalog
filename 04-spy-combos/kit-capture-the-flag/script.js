/**
 * Workshop DIY — Capture The Flag v1.0
 * ESP32s broadcast clues, teams compete — physical CTF simulation
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-42D6F9',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Capture The Flag \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Capture The Flag', subtitle: '🚩 scan · 🏃 compete · 🏆 capture',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Capture The Flag — Physical CTF', mainDesc: 'ESP32s broadcast clues, teams compete',
 sectionA: 'Game Rules', sectionB: 'Live Game Feed', sectionC: 'Bonus Challenges',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme', settings: '⚙️ Settings', language: 'Language',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Kit Capture The Flag simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 howto_3:'Scroll down to the expandable sections. "Game Rules" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 teamRed: 'Red Team', teamBlue: 'Blue Team', flagsCaptured: 'flags captured',
 joinRed: 'Join Red 🔴', joinBlue: 'Join Blue 🔵',
 gameTimer: 'Game Timer', clueScanner: 'Clue Scanner',
 scanHint: 'Scanning for ESP32 broadcast clues...', waitingClue: 'Waiting for clue broadcast...',
 ...
 gloss4_term: 'Channel Width',
 gloss4_def: 'The frequency span of a communication channel. Wider channels carry more data but are more susceptible to interference. WiFi uses 20, 40, 80, or 160 MHz.',
 gloss5_term: 'Latency',
 ...
 theory: 'Kit Capture The Flag demonstrates key principles from RF intelligence. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-42D6F9',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Capture The Flag \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 wiki_ble_title: '📶 Balises BLE', wiki_ble: 'Les ESP32 agissent comme des balises BLE pour transmettre des indices.',
 wiki_cipher_title: '🔐 Chiffres', wiki_cipher: 'Méthodes de chiffrement simples pour encoder les indices.',
 ...
 ready: '🚩 Capture The Flag prêt !',
 logCleared: 'Journal effacé', copied: 'Copié !', copyFail: 'Échec',
 export: 'Exporter', filterAll: 'Tout',
 soundEffects: '🔊 Effets sonores', whisperMode: 'Mode murmure', breathingGuide: 'Guide respiratoire', dhikrTap: 'Tap',
 musicMode: 'Réactif musique', chatPlaceholder: 'Parle au robot...', splashHint: 'appuyer pour passer',
 newVersion: 'MAJ', langChanged: '🌐 Langue → Français', themeChanged: '🎨 Thème →',
 teamRed: 'Équipe Rouge', teamBlue: 'Équipe Bleue', flagsCaptured: 'drapeaux capturés',
 joinRed: 'Rejoindre Rouge 🔴', joinBlue: 'Rejoindre Bleu 🔵',
 gameTimer: 'Chrono', clueScanner: 'Scanner d\'indices',
 ...
 theory: 'Kit Capture The Flag démontre les principes clés de renseignement RF. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 wiki_ble_title: '📶 إشارات BLE', wiki_ble: 'أجهزة ESP32 تعمل كإشارات BLE لنقل الأدلة.',
 wiki_cipher_title: '🔐 الشفرات', wiki_cipher: 'طرق تشفير بسيطة لتشفير الأدلة.',
 wiki_privacy_title: '🔒 الخصوصية', wiki_privacy: 'محلي أولًا، خصوصية أولًا. كل البيانات تبقى في متصفحك.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس', t_riad: 'رياض', t_medina: 'مدينة', t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🚩 التقط العلم جاهز!',
 ...
 teamRed: 'الفريق الأحمر', teamBlue: 'الفريق الأزرق', flagsCaptured: 'أعلام ملتقطة',
 joinRed: 'انضم للأحمر 🔴', joinBlue: 'انضم للأزرق 🔵',
 gameTimer: 'مؤقت اللعبة', clueScanner: 'ماسح الأدلة',
 ...
 theory: 'Kit Capture The Flag يوضح المبادئ الأساسية في الاستخبارات اللاسلكية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'\\u0639\\u0631\\u0636 \\u0634\\u0644\\u0627\\u0644 RF',related1_desc:'\\u0634\\u0644\\u0627\\u0644 \\u0645\\u0628\\u0627\\u0634\\u0631: WiFi\\u060C Bluetooth\\u060C FM\\u060C \\u0645\\u0641\\u0627\\u062A\\u064A\\u062D',related1_path:'../../10-hrf-sigint/hrf-rf-waterfall/index.html',related2_name:'\\u0645\\u062d\\u0627\\u0643\\u064a \\u0627\\u0644\\u062d\\u0631\\u0628 \\u0627\\u0644\\u0625\\u0644\\u0643\\u062a\\u0631\\u0648\\u0646\\u064a\\u0629',related2_desc:'\\u0645\\u062d\\u0627\\u0643\\u0627\\u0629 \\u0627\\u0644\\u062a\\u0634\\u0648\\u064a\\u0634 \\u0648\\u0627\\u0644\\u0625\\u062c\\u0631\\u0627\\u0621\\u0627\\u062a \\u0627\\u0644\\u0645\\u0636\\u0627\\u062f\\u0629',related2_path:'../../54-rf-warfare/rfw-electronic-warfare-sim/index.html',related3_name:'تحدي ازالة التعديل',related3_desc:'حدد التعديل وفك تشفير الرسالة',related3_path:'../../27-sdr-dsp/sdr-demod-challenge/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'',pathPrev_path:'',pathNext_name:'مقر الهروب — غرفة الهروب التجسسية',pathNext_path:'../../04-spy-combos/kit-escape-hq/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ما بنية معالج ESP32؟',quiz_q1a:'ARM',quiz_q1b:'Xtensa ثنائي النواة',quiz_q1c:'RISC-V فقط',quiz_q1d:'x86',quiz_q1_answer:'1',quiz_q2:'ما هي إخفاء المعلومات؟',quiz_q2a:'اتصال صاخب',quiz_q2b:'إخفاء رسائل داخل بيانات أخرى',quiz_q2c:'حذف ملفات',quiz_q2d:'بث إشارات',quiz_q2_answer:'1',quiz_q3:'ماذا تعني SIGINT؟',quiz_q3a:'تكامل الإشارات',quiz_q3b:'استخبارات الإشارات',quiz_q3c:'اعتراض بسيط',quiz_q3d:'استخبارات النظام',quiz_q3_answer:'1',quiz_q4:'ما هو التعلم الآلي؟',quiz_q4a:'برمجة الروبوتات',quiz_q4b:'أنظمة تتعلم من البيانات',quiz_q4c:'حساب يدوي',quiz_q4d:'تصميم العتاد',quiz_q4_answer:'1',quiz_q5:'ما هي الشبكة العصبية؟',quiz_q5a:'أسلاك مادية',quiz_q5b:'نظام حوسبة مستوحى من الخلايا العصبية',quiz_q5c:'شبكة اجتماعية',quiz_q5d:'شبكة راديو',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'رصد مرصد ليغو موجات الجاذبية عام 2015 مؤكدًا تنبؤ أينشتاين قبل 100 عام. قاست المستشعرات تشوهات في الزمكان بمقدار 10⁻²¹ متر.',realworld2:'يتواصل المسبار فويجر 1 الذي أُطلق عام 1977 من مسافة 24 مليار كم باستخدام مرسل بقدرة 23 واط. تستغرق الإشارات أكثر من 22 ساعة في كل اتجاه.',realworld3:'يولد مصادم الهادرونات الكبير في سيرن 1 بيتابايت في الثانية أثناء التصادمات. في عام 2012 أكد بوزون هيغز مكملاً النموذج القياسي للفيزياء.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في اتصالات مورس معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في اتصالات مورس وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Capture The Flag يوضح مفهومًا أساسيًا في اتصالات مورس. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Capture The Flag لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في اتصالات مورس هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ micro:bit وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال اتصالات مورس يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'تحقق دائمًا من مستوى البطارية قبل العمليات الميدانية. ينتج micro:bit الذي تنفد بطاريته قراءات مستشعر غير موثوقة.',proTip2:'استخدم أرقام مجموعات الراديو فوق 100 لتجنب التداخل مع مستخدمي micro:bit الآخرين. المجموعات الافتراضية 0-10 مزدحمة.',funFactTitle:'🎯 هل تعلم؟',funFact:'النجم النيوتروني كثيف لدرجة أن ملعقة صغيرة من مادته ستزن حوالي 6 مليارات طن على الأرض.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
/* ═══════ CTF SIMULATION ENGINE ═══════ */

let currentTeam = null;
let gameRunning = false;
let gameTimerInterval = null;
let gameTimeLeft = 300; // 5 minutes
let redScore = 0, blueScore = 0, redFlags = 0, blueFlags = 0;
let currentFlag = null;

function randomInt(min, max) { return Math.floor(Math.random() * (max - min + 1)) + min; }

const FLAG_POOL = [
 { code: 'FLAG{ALPHA}', clue: 'The first letter of the Greek alphabet, doubled and wrapped.', points: 100 },
 { code: 'FLAG{BRAVO}', clue: 'NATO phonetic for the letter B. Find it near the north wall.', points: 100 },
 { code: 'FLAG{DELTA}', clue: 'A triangle shape in Greek. Hidden under the third bench.', points: 100 },
 { code: 'FLAG{ECHO}', clue: 'Sound reflection in a canyon. Check the speaker enclosure.', points: 100 },
 { code: 'FLAG{FOXTROT}', clue: 'A dance named after an animal. Behind the red door.', points: 100 },
 { code: 'FLAG{GAMMA}', clue: 'Third Greek letter. Radiation type. Look in the science corner.', points: 100 },
 { code: 'FLAG{HOTEL}', clue: 'NATO phonetic for H. A place to stay overnight.', points: 100 },
 { code: 'FLAG{OSCAR}', clue: 'A golden statue award. Near the trophy case.', points: 100 },
];

function joinTeam(team) {
 const s = LANG[currentLang];
 currentTeam = team;
 const redBtn = $('joinRedBtn'), blueBtn = $('joinBlueBtn');
 if (redBtn) redBtn.classList.toggle('selected', team === 'red');
 if (blueBtn) blueBtn.classList.toggle('selected', team === 'blue');
 log(`${s.joinedTeam} ${team === 'red' ? '🔴 Red' : '🔵 Blue'}`, 'success');
 setStatus(true);
 playSound('click');
}

function updateTimer() {
 const display = $('gameTimer');
 if (!display) return;
...
function updateScoreboard() {
 ...
 const rf = $('redFlags'), bf = $('blueFlags');
 if (rs) rs.textContent = redScore;
 if (bs) bs.textContent = blueScore;
 if (rf) rf.textContent = redFlags;
 if (bf) bf.textContent = blueFlags;
}

function addFeedEvent(text, team) {
 const feed = $('gameFeed');
 if (!feed) return;
 if (feed.querySelector('.hint')) feed.innerHTML = '';
 const div = document.createElement('div');
 div.className = `feed-item ${team ? team + '-event' : ''}`;
 div.innerHTML = `<span class="feed-time">[${new Date().toLocaleTimeString()}]</span> ${text}`;
 feed.insertBefore(div, feed.firstChild);
}

function startGame() {
 const s = LANG[currentLang];
 if (!currentTeam) { log('⚠️ Join a team first!', 'error'); return; }
 gameRunning = true;
 gameTimeLeft = 300;
 redScore = 0; blueScore = 0; redFlags = 0; blueFlags = 0;
 updateScoreboard();
 updateTimer();
 log(s.gameStarted, 'success');
 addFeedEvent('Game started!', null);

 gameTimerInterval = setInterval(() => {
 gameTimeLeft--;
 updateTimer();
 // Random opponent captures
 if (gameTimeLeft % 40 === 0 && gameTimeLeft > 0) {
 const oppTeam = currentTeam === 'red' ? 'blue' : 'red';
 const pts = randomInt(80, 150);
 if (oppTeam === 'red') { redScore += pts; redFlags++; }
 else { blueScore += pts; blueFlags++; }
 updateScoreboard();
 addFeedEvent(`${oppTeam === 'red' ? '🔴' : '🔵'} ${oppTeam.toUpperCase()} captured a flag! (+${pts})`, oppTeam);
 log(`📡 ${oppTeam.toUpperCase()} team captured a flag (+${pts})`, 'rx');
 }
 if (gameTimeLeft <= 0) {
 clearInterval(gameTimerInterval);
 gameRunning = false;
 log(s.gameOver, 'error');
 addFeedEvent(s.gameOver, null);
 const winner = redScore > blueScore ? '🔴 RED' : blueScore > redScore ? '🔵 BLUE' : 'TIE';
 log(`🏆 Winner: ${winner} (Red: ${redScore} vs Blue: ${blueScore})`, 'success');
 addFeedEvent(`Winner: ${winner}!`, null);
 playSound('success');
 }
 }, 1000);
}
...
function scanClue() {
 if (!gameRunning) { log('⚠️ Start the game first!', 'error'); return; }
 const s = LANG[currentLang];
 const flag = FLAG_POOL[randomInt(0, FLAG_POOL.length - 1)];
 currentFlag = flag;
 const display = $('clueDisplay');
 log('📡 Scanning ESP32 beacons...', 'tx');
 showToast(s.working, 1500);

 setTimeout(() => {
 if (display) display.textContent = `📡 ${flag.clue}`;
 log(`📡 Clue received: "${flag.clue}"`, 'rx');
 addFeedEvent(`${currentTeam === 'red' ? '🔴' : '🔵'} Received a clue`, currentTeam);
 }, 1000);
}
...
function submitFlag() {
 ...
 const found = FLAG_POOL.find(f => f.code === code);
 if (found) {
 const pts = found.points + randomInt(0, 25); // speed bonus
 if (currentTeam === 'red') { redScore += pts; redFlags++; }
 else { blueScore += pts; blueFlags++; }
 updateScoreboard();
 log(`${s.flagCorrect} +${pts} pts`, 'success');
 addFeedEvent(`${currentTeam === 'red' ? '🔴' : '🔵'} Captured ${code} (+${pts})`, currentTeam);
 playSound('success');
 } else {
 log(s.flagWrong, 'error');
 playSound('error');
 }
}
...
function resetGame() {
 ...
 updateScoreboard();
 const redBtn = $('joinRedBtn'), blueBtn = $('joinBlueBtn');
 if (redBtn) redBtn.classList.remove('selected');
 if (blueBtn) blueBtn.classList.remove('selected');
 const display = $('clueDisplay');
 if (display) display.textContent = LANG[currentLang].waitingClue || 'Waiting for clue broadcast...';
 const feed = $('gameFeed');
 if (feed) feed.innerHTML = `<div class="hint">${LANG[currentLang].noEvents || 'No events yet.'}</div>`;
 setStatus(false);
 log('🔄 Game reset', 'info');
}

function runSpeedRun() {
 log('⚡ Speed Run challenge — capture 3 flags in 90s!', 'tx');
 const result = $('speedRunResult');
 let count = 0;
 const interval = setInterval(() => {
 count++;
 const flag = FLAG_POOL[randomInt(0, FLAG_POOL.length - 1)];
 log(`🚩 Auto-captured: ${flag.code} (+${flag.points})`, 'success');
 if (count >= 3) {
 clearInterval(interval);
 const time = randomInt(35, 85);
 if (result) result.innerHTML = `<div style="color:var(--accent);font-size:0.75rem;">🏆 3 flags in ${time}s — ${time < 60 ? '200 BONUS POINTS!' : 'Good try!'}</div>`;
 log(`⚡ Speed Run complete: ${time}s`, 'success');
 playSound('success');
 }
 }, randomInt(800, 2000));
}

function runCipherFlag() {
 log('🔐 Cipher Flag challenge — decode the Caesar cipher...', 'tx');
 const result = $('cipherFlagResult');
 const plaintext = 'FLAG{CIPHER}';
 const shift = randomInt(3, 7);
 const encrypted = plaintext.split('').map(c => {
 if (c.match(/[A-Z]/)) return String.fromCharCode(((c.charCodeAt(0) - 65 + shift) % 26) + 65);
 return c;
 }).join('');
 setTimeout(() => {
 if (result) result.innerHTML = `<div style="font-size:0.75rem;"><div>Encrypted: <span style="font-family:monospace;color:var(--accent);">${encrypted}</span></div><div>Shift: ${shift}</div><div style="color:#22c55e;margin-top:4px;">Decoded: <strong>${plaintext}</strong> — 300 BONUS POINTS!</div></div>`;
 log(`🔓 Decoded: ${plaintext} (shift ${shift}) — 300 pts`, 'success');
 playSound('success');
 }, 2000);
}

function runHiddenBeacon() {
 log('📡 Scanning for hidden beacon...', 'tx');
 const result = $('hiddenBeaconResult');
 showToast(LANG[currentLang].working, 0);
 let attempts = 0;
 const interval = setInterval(() => {
 attempts++;
 log(`📡 Scan attempt ${attempts}... nothing yet`, 'info');
 if (attempts >= 3) {
 clearInterval(interval);
 hideToast();
 if (result) result.innerHTML = `<div style="font-size:0.75rem;color:#22c55e;">📡 Hidden beacon found! FLAG{HIDDEN} — 500 BONUS POINTS!</div>`;
 log('📡 Hidden beacon detected! FLAG{HIDDEN} — 500 pts', 'success');
 playSound('success');
 }
 }, 1500);
}
...
function initCTFApp() {
 const joinRed = $('joinRedBtn'), joinBlue = $('joinBlueBtn');
 const startBtn = $('startGameBtn'), resetBtn = $('resetGameBtn');
 const scanBtn = $('scanBtn'), submitBtn = $('submitFlagBtn');
 const flagInput = $('flagInput');
 const speedBtn = $('speedRunBtn'), cipherBtn = $('cipherFlagBtn'), hiddenBtn = $('hiddenBeaconBtn');

 if (joinRed) joinRed.onclick = () => joinTeam('red');
 if (joinBlue) joinBlue.onclick = () => joinTeam('blue');
 if (startBtn) startBtn.onclick = startGame;
 if (resetBtn) resetBtn.onclick = resetGame;
 if (scanBtn) scanBtn.onclick = scanClue;
 if (submitBtn) submitBtn.onclick = submitFlag;
 if (flagInput) flagInput.addEventListener('keydown', e => { if (e.key === 'Enter') submitFlag(); });
 if (speedBtn) speedBtn.onclick = runSpeedRun;
 if (cipherBtn) cipherBtn.onclick = runCipherFlag;
 if (hiddenBtn) hiddenBtn.onclick = runHiddenBeacon;
