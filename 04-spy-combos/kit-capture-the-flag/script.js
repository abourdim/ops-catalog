...
const LANG = {
  en: {
    ...
    howto_4: 'Enter the flag code (FLAG{XXXX}) and click Submit to capture it.',
    wiki_ctf_title: '🚩 CTF', wiki_ctf: 'Capture The Flag — a competition where teams find and capture hidden tokens for points.',
    wiki_ble_title: '📶 BLE Beacons', wiki_ble: 'ESP32s act as BLE beacons to transmit clues via Bluetooth Low Energy.',
    wiki_cipher_title: '🔐 Ciphers', wiki_cipher: 'Simple encryption methods used to encode clues.',
