...
const LANG = {
  ...
  ar: {
    ...
    splashHint: 'انقر للتخطي',step1Title:'تصميم الزرع',step1Desc:'Covert cameras use miniature CMOS sensors (as small as 1mm pinhole) hidden inside everyday objects.',step2Title:'بناء وبرمجة',step2Desc:'Wireless models transmit on 2.4GHz WiFi or analog 1.2GHz/5.8GHz bands, detectable by RF sweeps.',step3Title:'نشر',step3Desc:'IR night-vision LEDs are invisible to the naked eye but visible through phone cameras (purple glow).',step4Title:'مراقبة واستخراج',step4Desc:'Detection combines RF spectrum analysis, lens reflection (laser bounce), and non-linear junction detection.',sectionCode:'كود الجهاز',faq_q1:'ماذا يفعل هذا التطبيق؟',faq_a1:'يحاكي hardware implants! 🔬 يمكنك التجربة مع covert hardware devices في بيئة آمنة.',faq_q2:'كيف يعمل؟',faq_a2:'المحاكاة تعمل في متصفحك. تنمذج covert hardware devices حقيقية خطوة بخطوة.',faq_q3:'ماذا أجرب أولاً؟',faq_a3:'اضغط على الزر الرئيسي وشاهد! 🎯 ثم عدّل الإعدادات لترى التأثير.',faq_q4:'ما العلم الحقيقي؟',faq_a4:'هذا physical security and implant design حقيقي! نفس المبادئ المستخدمة من المحترفين. 🧪',faq_q5:'هل يمكنني كسره؟',faq_a5:'جرب المختبر! ادفع المعلمات للحدود القصوى وشاهد. هكذا يكتشف العلماء! 💡',faq_q6:'ما العتاد المطلوب؟',faq_a6:'للنسخة الحقيقية تحتاج a computer with Python 3. تفقد 📦 كود الجهاز!',faq_q7:'هل هو آمن؟',faq_a7:'آمن تماماً! 🛡️ كل شيء يعمل محلياً. لا حاجة للإنترنت.',faq_q8:'ماذا بعد؟',faq_a8:'جرب Imp Supply Chain Backdoor and Imp Magnetic Stripe Cloner! كل واحد يعلّم شيئاً مختلفاً. 🚀'}
};
let currentLang = 'en';
