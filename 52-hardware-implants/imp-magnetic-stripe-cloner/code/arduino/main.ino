/*
 * imp-magnetic-stripe-cloner — ESP32 Arduino
 * 💳 swipe · 📋 clone · 🛡️ detect
 *
 ...
 *
 * Process:
 *   Step 1: Magnetic stripe cards store data on 3 tracks using magnetic flux patterns encoded at 75/210 BPI.
 *   Step 2: A skimmer reads the magnetic data when a card is swiped — capturing track 1 (name) and track 2 (number, expiry).
 *   Step 3: Cloners write captured data onto blank cards using an MSR device, creating a functional duplicate.
 *   Step 4: Detection uses visual inspection for overlay skimmers, RF scanning for wireless exfiltration, and jitter analysis.
 */
...
// ── Configuration ──
#define APP_NAME "imp-magnetic-stripe-cloner"
#define LED_PIN 2
