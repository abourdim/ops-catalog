/*
 * imp-gps-tracker-builder — ESP32 Arduino
 * 📍 track · 📡 report · 🛡️ detect
 *
 ...
 *
 * Process:
 *   Step 1: Covert GPS trackers use GPS/GLONASS/Galileo satellites to determine position with meter-level accuracy.
 *   Step 2: Position data is transmitted via GSM/4G cellular or satellite modem to a remote monitoring server.
 *   Step 3: Magnetic mount trackers can be hidden under vehicles — powered by lithium batteries lasting weeks to months.
 *   Step 4: Detection uses RF scanning for cellular emissions, physical inspection, and GPS jamming detection.
 */
...
// ── Configuration ──
#define APP_NAME "imp-gps-tracker-builder"
#define LED_PIN 2
