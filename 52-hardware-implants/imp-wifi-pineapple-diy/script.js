...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Padding Oracle Lab',related1_desc:'Simulate PKCS#1 v1.5 padding oracle to decrypt RSA ciphertext',related1_path:'../../53-crypto-attacks/cry-bleichenbacher-attack/index.html',related2_name:'APRS Dashboard',related2_desc:'APRS iGate and digipeater infrastructure node',related2_path:'../../37-pi-core/pi-igate-digipeater/index.html',related3_name:'Credential Harvester',related3_desc:'Understand how fake login pages steal credentials',related3_path:'../../51-social-engineering/se-credential-harvester/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'USB Implant Designer — Payload Sim',pathPrev_path:'../../52-hardware-implants/imp-usb-implant-designer/index.html',pathNext_name:'',pathNext_path:'',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
