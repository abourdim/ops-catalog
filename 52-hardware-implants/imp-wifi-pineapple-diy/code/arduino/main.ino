/*
 * imp-wifi-pineapple-diy — ESP32 Arduino
 * 📶 broadcast · 🎣 capture · 🛡️ detect
 *
 ...
 *
 * Process:
 *   Step 1: A WiFi Pineapple creates an evil twin access point mimicking legitimate networks.
 *   Step 2: Clients auto-connect to the rogue AP, routing all traffic through the attacker.
 *   Step 3: Captive portals capture credentials; SSL stripping downgrades HTTPS connections.
 *   Step 4: Detection uses beacon frame analysis, BSSID monitoring, and wireless IDS (WIDS).
 */
...
// ── Configuration ──
#define APP_NAME "imp-wifi-pineapple-diy"
#define LED_PIN 2
