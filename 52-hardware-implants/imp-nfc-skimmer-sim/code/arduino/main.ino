/*
 * imp-nfc-skimmer-sim — ESP32 Arduino
 * 📡 skim · 🔍 analyze · 🛡️ defend
 *
 ...
 *
 * Process:
 *   Step 1: NFC skimmers exploit the 13.56 MHz contactless protocol used by payment cards and access badges.
 *   Step 2: A hidden reader antenna captures card UIDs and transaction data when cards come within range.
 *   Step 3: Relay attacks extend read range by proxying the NFC signal over a network to a remote emulator.
 *   Step 4: Detection uses RF field analysis, RFID-blocking wallets, and anomaly monitoring on card transactions.
 */
...
// ── Configuration ──
#define APP_NAME "imp-nfc-skimmer-sim"
#define LED_PIN 2
