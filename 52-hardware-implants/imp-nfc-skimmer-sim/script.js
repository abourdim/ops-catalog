...
const LANG = {
  ...
  ,faq_q1:'What is this app?',faq_a1:'An interactive educational simulation from Workshop-DIY. Explore, experiment, and learn!',faq_q2:'How do I use it?',faq_a2:'Use the controls in the main section. Try different settings and watch what happens.',faq_q3:'Can I change the theme?',faq_a3:'Yes! Open Settings and pick a theme. There are 8 to choose from.',faq_q4:'Is my data private?',faq_a4:'Yes. Everything runs locally in your browser. No data is sent anywhere.',step1Title:'Design Implant',step1Desc:'NFC skimmers exploit the 13.56 MHz contactless protocol used by payment cards and access badges.',step2Title:'Build & Program',step2Desc:'A hidden reader antenna captures card UIDs and transaction data when cards come within range.',step3Title:'Deploy',step3Desc:'Relay attacks extend read range by proxying the NFC signal over a network to a remote emulator.',step4Title:'Monitor & Extract',step4Desc:'Detection uses RF field analysis, RFID-blocking wallets, and anomaly monitoring on card transactions.',sectionCode:'Device Code'},
  fr: {
