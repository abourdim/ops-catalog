/*
 * imp-keyboard-logger-pcb — ESP32 Arduino
 * ⌨️ design · 🔍 detect · 🛡️ defend
 *
 ...
 *
 * Process:
 *   Step 1: A hardware keylogger is a small PCB placed between a keyboard and computer.
 *   Step 2: It intercepts USB data lines and stores keystrokes in onboard flash memory.
 *   Step 3: Some variants transmit captured data wirelessly via RF or WiFi modules.
 *   Step 4: Detection involves visual inspection, USB traffic analysis, and firmware verification.
 */
...
// ── Configuration ──
#define APP_NAME "imp-keyboard-logger-pcb"
#define LED_PIN 2
