...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Kiosk Dashboard',related1_desc:'Multi-display RF monitoring dashboard kiosk',related1_path:'../../37-pi-core/pi-kiosk/index.html',related2_name:'Drone Hijacker Sim',related2_desc:'Simulate drone RF link hijacking',related2_path:'../../54-rf-warfare/rfw-drone-hijacker-sim/index.html',related3_name:'Randomness Tester',related3_desc:'Analyze byte sequences for randomness using multiple statistical tests',related3_path:'../../53-crypto-attacks/cry-entropy-analyzer/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'',pathPrev_path:'',pathNext_name:'Evil Maid Toolkit — Physical Access Attack Sim',pathNext_path:'../../52-hardware-implants/imp-evil-maid-toolkit/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 theory: 'Covert Audio Implant يوضح المبادئ الأساسية في الغرسات المادية. WiFi (802.11) operates on 2.4 GHz and 5 GHz bands. It uses OFDM modulation to transmit data across multiple subcarriers simultaneously. The electromagnetic spectrum is divided into bands allocated by regulators. Spectrum is a finite resource — efficient use is critical for modern communications. Frequency measures oscillation rate in Hertz. In RF, frequency determines propagation characteristics: lower frequencies travel farther, higher frequencies carry more data. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
