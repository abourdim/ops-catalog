/*
 * imp-pi-zero-dropbox — ESP32 Arduino
 * 📦 drop · 🔓 pivot · 🛡️ detect
 *
 ...
 *
 * Process:
 *   Step 1: A Pi Zero drop box is a small single-board computer hidden inside a target network via Ethernet.
 *   Step 2: Once connected, it phones home via reverse SSH tunnel or cellular modem, bypassing firewalls.
 *   Step 3: The attacker uses the implant as a pivot point to scan internal subnets and exfiltrate data.
 *   Step 4: Detection relies on 802.1X port authentication, network monitoring, and physical security audits.
 */
...
// ── Configuration ──
#define APP_NAME "imp-pi-zero-dropbox"
#define LED_PIN 2
