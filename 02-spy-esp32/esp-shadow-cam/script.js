...
const LANG = {
 ...
 title: 'Shadow Cam \u2014 Encrypted Surveillance', subtitle: 'Motion-triggered capture with encryption and auto-delete',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Shadow Cam Control', mainDesc: 'Motion detection, encrypted capture & auto-delete',
 sectionA: 'How It Works', sectionB: 'ESP32-CAM Wiring & Code', sectionC: 'Privacy, Ethics & Challenges',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '\u2699\uFE0F Settings', language: 'Language',
 helpSettings: '\u2753 Help & Settings', settingsTab: '\u2699\uFE0F',
 help: '\u2753 Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Shadow Cam simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_motion_title: '\uD83D\uDC41 Motion Detection', wiki_motion: 'Frame differencing compares pixel values between consecutive frames. High delta = motion. ESP32-CAM uses OV2640 sensor with JPEG compression.',
 wiki_xor_title: '\uD83D\uDD12 XOR Encryption', wiki_xor: 'XOR (exclusive or) flips bits using a key stream. plaintext XOR key = ciphertext. ciphertext XOR key = plaintext. Fast, simple, symmetric.',
 wiki_autodel_title: '\u23F0 Auto-Delete', wiki_autodel: 'Ephemeral storage erases data after a time limit. Used in secure messaging (Signal), surveillance regulations, and GDPR compliance.',
 wiki_privacy_title: '\uD83D\uDD10 Privacy', wiki_privacy: 'Face blur, encryption at rest, auto-delete, and consent are pillars of ethical surveillance. Local-first processing prevents data leaks.',
 working: 'Working\u2026',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '\uD83D\uDCF7 Shadow Cam ready! Arm the system to begin.',
 ...
 themeChanged: '\uD83C\uDFA8 Theme \u2192',
 armSystem: 'Arm System', disarmSystem: 'Disarm', manualCapture: 'Capture',
 faceBlur: 'Face Blur: OFF', faceBlurOn: 'Face Blur: ON',
 encryptionLabel: 'Encryption: XOR', noMotion: 'NO MOTION', motionDetected: 'MOTION!',
 motionLevel: 'Motion: 0%', sensitivity: 'Sensitivity',
 gallery: 'Capture Gallery', clearGallery: 'Clear All', noCaptures: 'No captures yet. Arm the system and move your mouse over the viewfinder.',
 armed: '\uD83D\uDEE1\uFE0F System ARMED \u2014 monitoring for motion',
 disarmed: '\uD83D\uDEE1\uFE0F System disarmed',
 captureTriggered: '\uD83D\uDCF7 Motion capture triggered!',
 manualCaptureLog: '\uD83D\uDCF7 Manual capture taken',
 encrypted: '\uD83D\uDD12 Image encrypted with XOR key',
 decrypted: '\uD83D\uDD13 Image decrypted \u2014 viewing...',
 autoDeleted: '\uD83D\uDDD1\uFE0F Capture auto-deleted (expired)',
 galleryCleared: '\uD83D\uDDD1\uFE0F Gallery cleared',
 faceBlurEnabled: '\uD83D\uDC64 Face blur enabled',
 faceBlurDisabled: '\uD83D\uDC64 Face blur disabled',
 howMotionTitle: 'Motion Detection',
 howMotionDesc: 'The ESP32-CAM compares consecutive frames pixel-by-pixel. When the difference exceeds a threshold, motion is detected. In this simulation, mouse movement over the viewfinder triggers the same logic.',
 howEncTitle: 'XOR Image Encryption',
 howEncDesc: 'Each captured image is encrypted using XOR with a pseudorandom key stream. XOR encryption is symmetric \u2014 the same key encrypts and decrypts. Click on an encrypted thumbnail to decrypt and view it.',
 howAutoDelTitle: 'Auto-Delete Mechanism',
 howAutoDelDesc: 'Each capture has a self-destruct timer (default 30s). Once the countdown reaches zero, the image data is permanently erased from memory.',
 howBlurTitle: 'Face Blur (Privacy)',
 howBlurDesc: 'When face blur is enabled, simulated face regions are pixelated before encryption. This demonstrates privacy-preserving surveillance.',
 wiringTitle: 'Wiring Diagram', codeSnippetTitle: 'Arduino Sketch (Key Parts)',
 ethicsTitle: 'Ethical Surveillance',
 ethicsDesc: 'Surveillance technology carries responsibility. Always obtain consent before recording. Use encryption to protect captured data. Auto-delete ensures data minimization.',
 challengesTitle: 'Student Challenges',
 challenge1: 'Modify the sensitivity to detect only large movements.',
 challenge2: 'Add a second encryption layer (double-XOR with different keys).',
 challenge3: 'Implement a "panic button" that instantly deletes all captures.',
 challenge4: 'Add timestamp watermark on each capture before encryption.',
 challenge5: 'Create an alert system that logs motion events with location info.',
 realWorldTitle: 'Real-World Applications',
 realWorldDesc: 'Wildlife cameras, bank security, hospital monitoring \u2014 understanding these systems helps students build responsible IoT devices.',step1Title:'Configure',step1Desc:'Set up the simulation parameters and choose your encryption method. Watch the visualization update in real time as this stage processes. The display shows exactly what is happening internally — each color and movement represents a specific data transformation.',step2Title:'Process',step2Desc:'The data is processed through the chosen algorithm or technique. Notice how the indicators change during this phase. The activity log records every event, letting you trace the exact sequence of operations and verify the results.',step3Title:'Transmit',step3Desc:'The processed signal or message is sent through the communication channel. This stage transforms the input data using the algorithm shown in the visualization. Compare the before and after values to understand the mathematical relationship.',step4Title:'Verify',step4Desc:'The receiver decodes, verifies, and validates the received data. The output of this stage feeds into the next one. Try pausing here to examine the intermediate state — understanding each step separately builds deeper insight.',sectionCode:'Device Code',faq_q1:'What is Shadow Cam \u2014 Encrypted Surveillance?',faq_a1:'Shadow Cam is an interactive simulation that demonstrates covert operations concepts. Motion detection, encrypted capture & auto-delete. Everything runs in your browser — no hardware or installation needed. Adjust the controls, observe the results, and build real understanding through experimentation.',faq_q2:'How does the simulation work?',faq_a2:'The simulation models real covert operations behavior in your browser. You control the inputs using sliders and buttons, and the visualization updates in real time to show you the results.',faq_q3:'What do the controls do?',faq_a3:'Click "Arm System" to enable motion detection on the viewfinder canvas. Each button and slider changes a specific parameter. Hover over controls to see tooltips, and check the How-To tab for a step-by-step walkthrough.',faq_q4:'What is the science behind this?',faq_a4:'\u0645\u0642\u0627\u0631\u0646\u0629 \u0627\u0644\u0625\u0637\u0627\u0631\u0627\u062A \u062A\u0642\u0627\u0631\u0646 \u0642\u064A\u0645 \u0627\u0644\u0628\u0643\u0633\u0644 \u0628\u064A\u0646 \u0627\u0644\u0625\u0637\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u062A\u062A\u0627\u0644\u064A\u0629.',faq_q5:'What should I experiment with?',faq_a5:'Try changing one parameter at a time and observe the effect. Push values to extremes to see what breaks — that teaches you the limits of the system.',faq_q6:'What hardware do I need for the real version?',faq_a6:'The simulation needs no hardware. To build the real project, you need ESP32. See the Device Code section for firmware and wiring instructions.',faq_q7:'Is my data private?',faq_a7:'Yes. Everything runs locally in your browser. No data is sent anywhere, no account is needed, and it works completely offline.',faq_q8:'What should I explore next?',faq_a8:'Try Esp Dark Net Radio and Esp Dead Zone. Each app in this category teaches a different aspect of covert operations. Try systematically: set all controls to their defaults, then change one variable at a time. Record what happens at minimum, midpoint, and maximum values. This methodical approach is exactly how researchers and engineers characterize real systems.',demo_s1:'Welcome to Shadow Cam \u2014 Encrypted Surveillance! Look at the main display — this is where the covert operations simulation runs.',demo_s2:'Click "Arm System" to enable motion detection on the viewfinder canvas. Watch how the visualization reacts.',demo_s3:'Try adjusting the controls. Each slider or button changes a specific parameter of the simulation.',demo_s4:'Scroll down to see "How It Works" for detailed data. The numbers and charts update as the simulation runs.',demo_s5:'Great job! Now try the challenges section to test your understanding of covert operations.',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Cryptography',learn1Desc:'How secret codes protect messages from spies. Watch the simulation to see this happen in real time. The visualization makes the invisible visible.',learn1Tag:'Cybersecurity',learn2Title:'Wireless Communication',learn2Desc:'How devices send invisible signals through the air. The controls let you experiment with different conditions. Each change reveals how this principle responds.',learn2Tag:'Wireless',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Try the challenges section to test your understanding. Real engineers use these same concepts daily.',learn3Tag:'Security',learn4Title:'Math in Security',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare results with different settings to build intuition. The data panels show precise measurements.',learn4Tag:'Math',sectionLearn:'What You Shall Learn',learnLevelVal:'Beginner 🟢',learnLevel:'Level:',learnTimeVal:'15 min ⏱',learnTime:'Time:',learnAgeVal:'10+ 🧒',kidTitle:'For Young Explorers',kidIntro:'Welcome to Shadow Cam! This is like a science experiment on your computer. You get to control a real covert operations simulation — press buttons, move sliders, and watch what happens on screen. Try changing the controls and watch how Set up the simulation parameters and choose your e Nothing can break — it is all just a simulation running safely in your browser!',kidSafe:'Completely safe! Nothing you do here can break anything. It all runs inside your browser like a game.',kidTry:'Press the big Start button and watch the screen change. Then try moving sliders to see what they do.',kidParent:'This app teaches covert operations concepts through hands-on simulation. Suitable for STEM education in physics, electronics, and computer science.',ch1Title:'Encrypt & Decode',ch1Desc:'Encrypt a message using the built-in cipher, then try to decode it manually without looking at the key. What patterns can you spot in the ciphertext?',ch2Title:'Stealth Test',ch2Desc:'Try to complete the mission with the lowest possible signal footprint. Can you reduce emissions below the detection threshold?',ch3Title:'Interception Race',ch3Desc:'Start a transmission and see how quickly you can intercept it from the other side. What affects the detection time?',purpose:'Shadow Cam \\u2014 Encrypted Surveillance: Motion detection, encrypted capture & auto-delete. This simulation lets you experiment hands-on instead of just reading theory. Every parameter you change produces visible results, building real intuition for how the system behaves. The workflow goes from Configure through Process to Transmit and Verify.',guideTitle:'What Am I Looking At?',guideCanvas:'The main area shows a live visualization of the simulation. Colors and movement represent data changing in real time.',guideControls:'The buttons below the main display control the simulation. Start begins it, Stop pauses it, Reset clears everything.',guideSections:'Below the main card, "How It Works" and "ESP32-CAM Wiring & Code" show detailed data and analysis. Click the section headers to expand or collapse them.',guideStatus:'The colored dot in the top-right corner shows the connection status. Green means running, red means stopped.',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'esc-steganography-suite',related1_desc:'',related1_path:'../../55-escape-evasion/esc-steganography-suite/index.html',related2_name:'Anti-Forensics Engine',related2_desc:'Secure wipe, log sanitization & timestamp obfuscation',related2_path:'../../55-escape-evasion/esc-anti-forensics-toolkit/index.html',related3_name:'Wrist Communicator — Tap Code',related3_desc:'Send secret messages through tap patterns',related3_path:'../../40-agent-microbit/bit-wrist-communicator/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'WiFi Packet Radar',pathPrev_path:'../../02-spy-esp32/esp-packet-sniffer/index.html',pathNext_name:'Onion Relay Network',pathNext_path:'../../02-spy-esp32/esp-tor-relay/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-14E88B',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Shadow Cam \u2014 Encrypted Surveillance \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 mainSection: 'Contr\u00f4le Shadow Cam', mainDesc: 'D\u00e9tection de mouvement, capture chiffr\u00e9e et auto-suppression',
 sectionA: 'Comment \u00e7a marche', sectionB: 'ESP32-CAM C\u00e2blage & Code', sectionC: 'Vie priv\u00e9e, \u00c9thique & D\u00e9fis',
 activityLog: 'Journal', eventsMsg: '\u00c9v\u00e9nements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Th\u00e8me',
 settings: '\u2699\uFE0F Param\u00e8tres', language: 'Langue',
 helpSettings: '\u2753 Aide & Param\u00e8tres', settingsTab: '\u2699\uFE0F',
 help: '\u2753 Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Shadow Cam. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_motion_title: '\uD83D\uDC41 D\u00e9tection de mouvement', wiki_motion: 'La diff\u00e9rence entre images compare les pixels entre images cons\u00e9cutives. Delta \u00e9lev\u00e9 = mouvement.',
 wiki_xor_title: '\uD83D\uDD12 Chiffrement XOR', wiki_xor: 'XOR inverse les bits avec un flux de cl\u00e9s. texte XOR cl\u00e9 = chiffr\u00e9. chiffr\u00e9 XOR cl\u00e9 = texte. Rapide et sym\u00e9trique.',
 wiki_autodel_title: '\u23F0 Auto-suppression', wiki_autodel: 'Le stockage \u00e9ph\u00e9m\u00e8re efface les donn\u00e9es apr\u00e8s un d\u00e9lai. Utilis\u00e9 dans Signal, la r\u00e9glementation RGPD.',
 wiki_privacy_title: '\uD83D\uDD10 Vie priv\u00e9e', wiki_privacy: 'Flou de visage, chiffrement, auto-suppression et consentement sont les piliers de la surveillance \u00e9thique.',
 working: 'En cours\u2026',
 t_mosque: 'Mosqu\u00e9e', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'M\u00e9dina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '\uD83D\uDCF7 Shadow Cam pr\u00eat ! Armez le syst\u00e8me pour commencer.',
 ...
 themeChanged: '\uD83C\uDFA8 Th\u00e8me \u2192',
 armSystem: 'Armer', disarmSystem: 'D\u00e9sarmer', manualCapture: 'Capturer',
 faceBlur: 'Flou visage: OFF', faceBlurOn: 'Flou visage: ON',
 encryptionLabel: 'Chiffrement: XOR', noMotion: 'PAS DE MOUVEMENT', motionDetected: 'MOUVEMENT !',
 motionLevel: 'Mouvement: 0%', sensitivity: 'Sensibilit\u00e9',
 gallery: 'Galerie de captures', clearGallery: 'Tout effacer', noCaptures: 'Aucune capture. Armez le syst\u00e8me et bougez la souris sur le viseur.',
 armed: '\uD83D\uDEE1\uFE0F Syst\u00e8me ARM\u00c9 \u2014 surveillance active',
 disarmed: '\uD83D\uDEE1\uFE0F Syst\u00e8me d\u00e9sarm\u00e9',
 captureTriggered: '\uD83D\uDCF7 Capture d\u00e9clench\u00e9e par mouvement !',
 manualCaptureLog: '\uD83D\uDCF7 Capture manuelle prise',
 encrypted: '\uD83D\uDD12 Image chiffr\u00e9e avec cl\u00e9 XOR',
 decrypted: '\uD83D\uDD13 Image d\u00e9chiffr\u00e9e \u2014 affichage...',
 autoDeleted: '\uD83D\uDDD1\uFE0F Capture auto-supprim\u00e9e (expir\u00e9e)',
 galleryCleared: '\uD83D\uDDD1\uFE0F Galerie vid\u00e9e',
 faceBlurEnabled: '\uD83D\uDC64 Flou de visage activ\u00e9',
 faceBlurDisabled: '\uD83D\uDC64 Flou de visage d\u00e9sactiv\u00e9',
 howMotionTitle: 'D\u00e9tection de mouvement',
 howMotionDesc: 'L\'ESP32-CAM compare les images cons\u00e9cutives pixel par pixel. Quand la diff\u00e9rence d\u00e9passe un seuil, le mouvement est d\u00e9tect\u00e9.',
 howEncTitle: 'Chiffrement XOR d\'image',
 howEncDesc: 'Chaque image est chiffr\u00e9e en XOR avec un flux de cl\u00e9s pseudo-al\u00e9atoire. Le chiffrement XOR est sym\u00e9trique.',
 howAutoDelTitle: 'M\u00e9canisme d\'auto-suppression',
 howAutoDelDesc: 'Chaque capture a un minuteur d\'auto-destruction (30s par d\u00e9faut). \u00c0 z\u00e9ro, les donn\u00e9es sont d\u00e9finitivement effac\u00e9es.',
 howBlurTitle: 'Flou de visage (Vie priv\u00e9e)',
 howBlurDesc: 'Quand le flou est activ\u00e9, les zones de visage simul\u00e9es sont pixelis\u00e9es avant le chiffrement.',
 wiringTitle: 'Sch\u00e9ma de c\u00e2blage', codeSnippetTitle: 'Sketch Arduino (Parties cl\u00e9s)',
 ethicsTitle: 'Surveillance \u00e9thique',
 ethicsDesc: 'La technologie de surveillance implique une responsabilit\u00e9. Toujours obtenir le consentement avant d\'enregistrer.',
 challengesTitle: 'D\u00e9fis \u00e9tudiants',
 challenge1: 'Modifier la sensibilit\u00e9 pour ne d\u00e9tecter que les grands mouvements.',
 challenge2: 'Ajouter une deuxi\u00e8me couche de chiffrement (double-XOR).',
 challenge3: 'Impl\u00e9menter un bouton panique qui supprime toutes les captures.',
 challenge4: 'Ajouter un filigrane horodatage sur chaque capture.',
 challenge5: 'Cr\u00e9er un syst\u00e8me d\'alerte qui journalise les \u00e9v\u00e9nements de mouvement.',
 realWorldTitle: 'Applications r\u00e9elles',
 realWorldDesc: 'Cam\u00e9ras de faune, s\u00e9curit\u00e9 bancaire, surveillance hospitali\u00e8re \u2014 comprendre ces syst\u00e8mes aide les \u00e9tudiants.',step1Title:'Configurer',step1Desc:'Configure les paramètres de simulation et choisis ta méthode de chiffrement. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Traiter',step2Desc:'Les données sont traitées par l\'algorithme ou la technique choisie. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Transmettre',step3Desc:'Le signal ou message traité est envoyé par le canal de communication. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Vérifier',step4Desc:'Le récepteur décode, vérifie et valide les données reçues. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que Shadow Cam \u2014 Encrypted Surveillance ?',faq_a1:'Shadow Cam est une simulation interactive qui démontre les concepts de opérations secrètes. Motion detection, encrypted capture & auto-delete. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de opérations secrètes. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de opérations secrètes. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut ESP32. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de opérations secrètes. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans Shadow Cam \u2014 Encrypted Surveillance ! Regarde l\'écran principal — c\'est ici que la simulation de opérations secrètes fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de opérations secrètes.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Cryptographie',learn1Desc:'How secret codes protect messages from spies. Regarde la simulation pour voir ça en temps réel. La visualisation rend visible l\'invisible.',learn1Tag:'Cybersécurité',learn2Title:'Communication sans fil',learn2Desc:'How devices send invisible signals through the air. Les contrôles te permettent d\'expérimenter. Chaque changement révèle comment ce principe réagit.',learn2Tag:'Sans fil',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Sécurité',learn4Title:'Maths en sécurité',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Maths',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Débutant 🟢',learnLevel:'Niveau :',learnTimeVal:'15 min ⏱',learnTime:'Durée :',learnAgeVal:'10+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Shadow Cam ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de opérations secrètes — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how Set up the simulation parameters and choose your e Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de opérations secrètes par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',ch1Title:'Chiffrer et Décoder',ch1Desc:'Chiffre un message puis essaie de le décoder manuellement sans regarder la clé. Quels motifs repères-tu dans le texte chiffré ?',ch2Title:'Test de Furtivité',ch2Desc:'Essaie de compléter la mission avec l\'empreinte signal la plus faible possible. Peux-tu descendre sous le seuil de détection ?',ch3Title:'Course à l\'Interception',ch3Desc:'Lance une transmission et mesure le temps de détection. Qu\'est-ce qui affecte ce délai ?',purpose:'Shadow Cam \\u2014 Encrypted Surveillance : Motion detection, encrypted capture & auto-delete. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'esc-steganography-suite',related1_desc:'',related1_path:'../../55-escape-evasion/esc-steganography-suite/index.html',related2_name:'Moteur Anti-Forensique',related2_desc:'Effacement securise et sanitisation',related2_path:'../../55-escape-evasion/esc-anti-forensics-toolkit/index.html',related3_name:'Communicateur Poignet — Code Tap',related3_desc:'Envoyez des messages secrets par tapotements',related3_path:'../../40-agent-microbit/bit-wrist-communicator/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'Radar de Paquets WiFi',pathPrev_path:'../../02-spy-esp32/esp-packet-sniffer/index.html',pathNext_name:'Réseau de Relais Oignon',pathNext_path:'../../02-spy-esp32/esp-tor-relay/index.html',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Qui a inventé le code Morse ?',quiz_q1a:'Tesla',quiz_q1b:'Samuel Morse',quiz_q1c:'Edison',quiz_q1d:'Bell',quiz_q1_answer:'1',quiz_q2:'Qu\'est-ce qu\'un réseau de neurones ?',quiz_q2a:'Fils physiques',quiz_q2b:'Système informatique inspiré des neurones',quiz_q2c:'Réseau social',quiz_q2d:'Réseau radio',quiz_q2_answer:'1',quiz_q3:'Quelles capacités sans fil a l\'ESP32 ?',quiz_q3a:'Wi-Fi uniquement',quiz_q3b:'Bluetooth uniquement',quiz_q3c:'Wi-Fi et Bluetooth',quiz_q3d:'Aucune',quiz_q3_answer:'2',quiz_q4:'Quelle est l\'architecture CPU de l\'ESP32 ?',quiz_q4a:'ARM',quiz_q4b:'Xtensa double coeur',quiz_q4c:'RISC-V uniquement',quiz_q4d:'x86',quiz_q4_answer:'1',quiz_q5:'Qu\'est-ce que la stéganographie ?',quiz_q5a:'Communication forte',quiz_q5b:'Cacher des messages dans d\'autres données',quiz_q5c:'Supprimer des fichiers',quiz_q5d:'Diffuser des signaux',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'Le botnet Mirai (2016) a asservi 600 000 appareils IoT en utilisant 61 mots de passe par défaut. Son attaque DDoS de 1,2 Tbps a fait tomber Twitter, Netflix et Reddit.',realworld2:'Les fuites de Snowden en 2013 ont révélé que le programme PRISM de la NSA collectait des données directement depuis les serveurs de Google, Facebook, Apple et Microsoft.',realworld3:'Le ransomware Colonial Pipeline (2021) a fermé le plus grand oléoduc américain pendant 5 jours. Un seul mot de passe VPN compromis a causé des pénuries dans 17 états.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En piratage IoT, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en piratage IoT et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'Shadow Cam \u2014 Encrypted Surveillance illustre un concept fondamental en piratage IoT. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans Shadow Cam \u2014 Encrypted Surveillance ont des applications directes dans le monde réel. Les professionnels de piratage IoT utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, ESP32 et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en piratage IoT implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'Activez le mode veille profonde entre les scans pour multiplier l\x27autonomie par 10. L\x27ESP32 consomme 240mA en actif mais seulement 10μA en veille profonde.',proTip2:'Utilisez le saut de canal (canaux 1, 6, 11) pour le scan WiFi — ce sont les seuls canaux 2,4 GHz non chevauchants et ils captent 90% du trafic.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'Le premier virus informatique, Creeper (1971), affichait \\x27I\\x27m the creeper, catch me if you can!\\x27 sur les terminaux ARPANET.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de opérations secrètes',
 wiki_history: 'Encryption dates back to ancient Egypt (1900 BCE). The Caesar cipher, Enigma machine, and modern AES represent key milestones in cryptographic evolution. Shadow Cam s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Shadow Cam',
 wiki_math: 'Les mathématiques derrière Shadow Cam : Modern encryption relies on computational hardness: integer factorization (RSA), discrete logarithms (Diffie-Hellman), and elliptic curves (ECC). Cipher strength is measured in bits of security. AES-256 provides 256-bit security, meaning 2^256 operations to brute-force — more than atoms in the universe. Channel capacity follows Shannon: C = B·log₂(1+S/N). Doubling bandwidth doubles capacity, but doubling signal power only adds one bit per symbol.',
 ...
 theory: 'Shadow Cam démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 mainSection: '\u062A\u062D\u0643\u0645 \u0643\u0627\u0645\u064A\u0631\u0627 \u0627\u0644\u0638\u0644', mainDesc: '\u0643\u0634\u0641 \u0627\u0644\u062D\u0631\u0643\u0629\u060C \u0627\u0644\u062A\u0642\u0627\u0637 \u0645\u0634\u0641\u0631 \u0648\u062D\u0630\u0641 \u062A\u0644\u0642\u0627\u0626\u064A',
 sectionA: '\u0643\u064A\u0641 \u064A\u0639\u0645\u0644', sectionB: '\u062A\u0648\u0635\u064A\u0644 ESP32-CAM \u0648\u0627\u0644\u0643\u0648\u062F', sectionC: '\u0627\u0644\u062E\u0635\u0648\u0635\u064A\u0629 \u0648\u0627\u0644\u0623\u062E\u0644\u0627\u0642 \u0648\u0627\u0644\u062A\u062D\u062F\u064A\u0627\u062A',
 activityLog: '\u0633\u062C\u0644 \u0627\u0644\u0646\u0634\u0627\u0637', eventsMsg: '\u0627\u0644\u0623\u062D\u062F\u0627\u062B \u0648\u0627\u0644\u0631\u0633\u0627\u0626\u0644',
 clear: '\u0645\u0633\u062D', copy: '\u0646\u0633\u062E', theme: '\u0627\u0644\u0645\u0638\u0647\u0631',
 settings: '\u2699\uFE0F \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A', language: '\u0627\u0644\u0644\u063A\u0629',
 helpSettings: '\u2753 \u0645\u0633\u0627\u0639\u062F\u0629 \u0648\u0625\u0639\u062F\u0627\u062F\u0627\u062A', settingsTab: '\u2699\uFE0F',
 help: '\u2753 \u0645\u0633\u0627\u0639\u062F\u0629', faq: '\u0623\u0633\u0626\u0644\u0629 \u0634\u0627\u0626\u0639\u0629', howto: '\u0643\u064A\u0641 \u062A\u0633\u062A\u062E\u062F\u0645', wiki: '\u0648\u064A\u0643\u064A',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Shadow Cam. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_motion_title: '\uD83D\uDC41 \u0643\u0634\u0641 \u0627\u0644\u062D\u0631\u0643\u0629', wiki_motion: '\u0645\u0642\u0627\u0631\u0646\u0629 \u0627\u0644\u0625\u0637\u0627\u0631\u0627\u062A \u062A\u0642\u0627\u0631\u0646 \u0642\u064A\u0645 \u0627\u0644\u0628\u0643\u0633\u0644 \u0628\u064A\u0646 \u0627\u0644\u0625\u0637\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u062A\u062A\u0627\u0644\u064A\u0629.',
 wiki_xor_title: '\uD83D\uDD12 \u062A\u0634\u0641\u064A\u0631 XOR', wiki_xor: 'XOR \u064A\u0639\u0643\u0633 \u0627\u0644\u0628\u062A\u0627\u062A \u0628\u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u062A\u062F\u0641\u0642 \u0645\u0641\u0627\u062A\u064A\u062D. \u0633\u0631\u064A\u0639 \u0648\u0628\u0633\u064A\u0637 \u0648\u0645\u062A\u0645\u0627\u062B\u0644.',
 wiki_autodel_title: '\u23F0 \u0627\u0644\u062D\u0630\u0641 \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A', wiki_autodel: '\u0627\u0644\u062A\u062E\u0632\u064A\u0646 \u0627\u0644\u0645\u0624\u0642\u062A \u064A\u0645\u062D\u0648 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0639\u062F \u0645\u0647\u0644\u0629 \u0632\u0645\u0646\u064A\u0629.',
 wiki_privacy_title: '\uD83D\uDD10 \u0627\u0644\u062E\u0635\u0648\u0635\u064A\u0629', wiki_privacy: '\u062A\u0645\u0648\u064A\u0647 \u0627\u0644\u0648\u062C\u0648\u0647 \u0648\u0627\u0644\u062A\u0634\u0641\u064A\u0631 \u0648\u0627\u0644\u062D\u0630\u0641 \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A \u0648\u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0623\u0631\u0643\u0627\u0646 \u0627\u0644\u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u0623\u062E\u0644\u0627\u0642\u064A\u0629.',
 working: '\u062C\u0627\u0631\u064D\u2026',
 t_mosque: '\u0645\u0633\u062C\u062F', t_zellige: '\u0632\u0644\u064A\u062C', t_andalus: '\u0623\u0646\u062F\u0644\u0633',
 t_riad: '\u0631\u064A\u0627\u0636', t_medina: '\u0645\u062F\u064A\u0646\u0629',
 t_space: '\u0641\u0636\u0627\u0621', t_jungle: '\u0623\u062F\u063A\u0627\u0644', t_robot: '\u0631\u0648\u0628\u0648\u062A',
 ready: '\uD83D\uDCF7 \u0643\u0627\u0645\u064A\u0631\u0627 \u0627\u0644\u0638\u0644 \u062C\u0627\u0647\u0632\u0629! \u0633\u0644\u0651\u062D \u0627\u0644\u0646\u0638\u0627\u0645 \u0644\u0644\u0628\u062F\u0621.',
 ...
 themeChanged: '\uD83C\uDFA8 \u0627\u0644\u0645\u0638\u0647\u0631 \u2190',
 armSystem: '\u062A\u0633\u0644\u064A\u062D', disarmSystem: '\u0625\u064A\u0642\u0627\u0641', manualCapture: '\u0627\u0644\u062A\u0642\u0627\u0637',
 faceBlur: '\u062A\u0645\u0648\u064A\u0647 \u0627\u0644\u0648\u062C\u0647: \u0645\u0639\u0637\u0644', faceBlurOn: '\u062A\u0645\u0648\u064A\u0647 \u0627\u0644\u0648\u062C\u0647: \u0645\u0641\u0639\u0644',
 encryptionLabel: '\u0627\u0644\u062A\u0634\u0641\u064A\u0631: XOR', noMotion: '\u0644\u0627 \u062D\u0631\u0643\u0629', motionDetected: '\u062D\u0631\u0643\u0629!',
 motionLevel: '\u0627\u0644\u062D\u0631\u0643\u0629: 0%', sensitivity: '\u0627\u0644\u062D\u0633\u0627\u0633\u064A\u0629',
 gallery: '\u0645\u0639\u0631\u0636 \u0627\u0644\u0644\u0642\u0637\u0627\u062A', clearGallery: '\u0645\u0633\u062D \u0627\u0644\u0643\u0644', noCaptures: '\u0644\u0627 \u0644\u0642\u0637\u0627\u062A \u0628\u0639\u062F. \u0633\u0644\u0651\u062D \u0627\u0644\u0646\u0638\u0627\u0645 \u0648\u062D\u0631\u0643 \u0627\u0644\u0645\u0627\u0648\u0633 \u0641\u0648\u0642 \u0627\u0644\u0639\u062F\u0633\u0629.',
 armed: '\uD83D\uDEE1\uFE0F \u0627\u0644\u0646\u0638\u0627\u0645 \u0645\u064F\u0633\u0644\u0651\u062D \u2014 \u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u062D\u0631\u0643\u0629',
 disarmed: '\uD83D\uDEE1\uFE0F \u0627\u0644\u0646\u0638\u0627\u0645 \u0645\u0648\u0642\u0641',
 captureTriggered: '\uD83D\uDCF7 \u0627\u0644\u062A\u0642\u0627\u0637 \u0628\u0627\u0644\u062D\u0631\u0643\u0629!',
 manualCaptureLog: '\uD83D\uDCF7 \u0627\u0644\u062A\u0642\u0627\u0637 \u064A\u062F\u0648\u064A',
 encrypted: '\uD83D\uDD12 \u062A\u0645 \u062A\u0634\u0641\u064A\u0631 \u0627\u0644\u0635\u0648\u0631\u0629 \u0628\u0645\u0641\u062A\u0627\u062D XOR',
 decrypted: '\uD83D\uDD13 \u062A\u0645 \u0641\u0643 \u0627\u0644\u062A\u0634\u0641\u064A\u0631 \u2014 \u0639\u0631\u0636...',
 autoDeleted: '\uD83D\uDDD1\uFE0F \u062D\u0630\u0641 \u062A\u0644\u0642\u0627\u0626\u064A (\u0645\u0646\u062A\u0647\u064A \u0627\u0644\u0635\u0644\u0627\u062D\u064A\u0629)',
 galleryCleared: '\uD83D\uDDD1\uFE0F \u062A\u0645 \u0645\u0633\u062D \u0627\u0644\u0645\u0639\u0631\u0636',
 faceBlurEnabled: '\uD83D\uDC64 \u062A\u0645\u0648\u064A\u0647 \u0627\u0644\u0648\u062C\u0647 \u0645\u0641\u0639\u0644',
 faceBlurDisabled: '\uD83D\uDC64 \u062A\u0645\u0648\u064A\u0647 \u0627\u0644\u0648\u062C\u0647 \u0645\u0639\u0637\u0644',
 howMotionTitle: '\u0643\u0634\u0641 \u0627\u0644\u062D\u0631\u0643\u0629',
 howMotionDesc: '\u064A\u0642\u0627\u0631\u0646 ESP32-CAM \u0627\u0644\u0625\u0637\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u062A\u062A\u0627\u0644\u064A\u0629 \u0628\u0643\u0633\u0644 \u0628\u0628\u0643\u0633\u0644. \u0639\u0646\u062F\u0645\u0627 \u064A\u062A\u062C\u0627\u0648\u0632 \u0627\u0644\u0641\u0631\u0642 \u0639\u062A\u0628\u0629 \u0645\u0639\u064A\u0646\u0629 \u064A\u062A\u0645 \u0643\u0634\u0641 \u0627\u0644\u062D\u0631\u0643\u0629.',
 howEncTitle: '\u062A\u0634\u0641\u064A\u0631 XOR \u0644\u0644\u0635\u0648\u0631',
 howEncDesc: '\u0643\u0644 \u0635\u0648\u0631\u0629 \u062A\u064F\u0634\u0641\u0631 \u0628\u0640 XOR \u0628\u062A\u062F\u0641\u0642 \u0645\u0641\u0627\u062A\u064A\u062D \u0634\u0628\u0647 \u0639\u0634\u0648\u0627\u0626\u064A. \u0627\u0644\u062A\u0634\u0641\u064A\u0631 \u0645\u062A\u0645\u0627\u062B\u0644.',
 howAutoDelTitle: '\u0622\u0644\u064A\u0629 \u0627\u0644\u062D\u0630\u0641 \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A',
 howAutoDelDesc: '\u0643\u0644 \u0627\u0644\u062A\u0642\u0627\u0637 \u0644\u0647 \u0645\u0624\u0642\u062A \u062A\u062F\u0645\u064A\u0631 \u0630\u0627\u062A\u064A (30 \u062B\u0627\u0646\u064A\u0629). \u0639\u0646\u062F \u0627\u0644\u0635\u0641\u0631 \u062A\u064F\u0645\u062D\u0649 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0646\u0647\u0627\u0626\u064A\u0627\u064B.',
 howBlurTitle: '\u062A\u0645\u0648\u064A\u0647 \u0627\u0644\u0648\u062C\u0647 (\u062E\u0635\u0648\u0635\u064A\u0629)',
 howBlurDesc: '\u0639\u0646\u062F \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u062A\u0645\u0648\u064A\u0647\u060C \u064A\u062A\u0645 \u062A\u0628\u0643\u0633\u0644 \u0645\u0646\u0627\u0637\u0642 \u0627\u0644\u0648\u062C\u0647 \u0642\u0628\u0644 \u0627\u0644\u062A\u0634\u0641\u064A\u0631.',
 wiringTitle: '\u0645\u062E\u0637\u0637 \u0627\u0644\u062A\u0648\u0635\u064A\u0644', codeSnippetTitle: '\u0643\u0648\u062F Arduino (\u0623\u062C\u0632\u0627\u0621 \u0631\u0626\u064A\u0633\u064A\u0629)',
 ethicsTitle: '\u0627\u0644\u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u0623\u062E\u0644\u0627\u0642\u064A\u0629',
 ethicsDesc: '\u062A\u0643\u0646\u0648\u0644\u0648\u062C\u064A\u0627 \u0627\u0644\u0645\u0631\u0627\u0642\u0628\u0629 \u062A\u062D\u0645\u0644 \u0645\u0633\u0624\u0648\u0644\u064A\u0629. \u0627\u062D\u0635\u0644 \u062F\u0627\u0626\u0645\u0627\u064B \u0639\u0644\u0649 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0642\u0628\u0644 \u0627\u0644\u062A\u0633\u062C\u064A\u0644.',
 challengesTitle: '\u062A\u062D\u062F\u064A\u0627\u062A \u0627\u0644\u0637\u0644\u0627\u0628',
 challenge1: '\u0639\u062F\u0644 \u0627\u0644\u062D\u0633\u0627\u0633\u064A\u0629 \u0644\u0643\u0634\u0641 \u0627\u0644\u062D\u0631\u0643\u0627\u062A \u0627\u0644\u0643\u0628\u064A\u0631\u0629 \u0641\u0642\u0637.',
 challenge2: '\u0623\u0636\u0641 \u0637\u0628\u0642\u0629 \u062A\u0634\u0641\u064A\u0631 \u062B\u0627\u0646\u064A\u0629 (XOR \u0645\u0632\u062F\u0648\u062C).',
 challenge3: '\u0623\u0636\u0641 \u0632\u0631 \u0630\u0639\u0631 \u064A\u062D\u0630\u0641 \u0643\u0644 \u0627\u0644\u0644\u0642\u0637\u0627\u062A \u0641\u0648\u0631\u0627\u064B.',
 challenge4: '\u0623\u0636\u0641 \u0639\u0644\u0627\u0645\u0629 \u0645\u0627\u0626\u064A\u0629 \u0628\u0627\u0644\u062A\u0627\u0631\u064A\u062E \u0639\u0644\u0649 \u0643\u0644 \u0627\u0644\u062A\u0642\u0627\u0637.',
 challenge5: '\u0623\u0646\u0634\u0626 \u0646\u0638\u0627\u0645 \u062A\u0646\u0628\u064A\u0647 \u064A\u0633\u062C\u0644 \u0623\u062D\u062F\u0627\u062B \u0627\u0644\u062D\u0631\u0643\u0629.',
 realWorldTitle: '\u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0648\u0627\u0642\u0639\u064A\u0629',
 realWorldDesc: '\u0643\u0627\u0645\u064A\u0631\u0627\u062A \u0627\u0644\u062D\u064A\u0627\u0629 \u0627\u0644\u0628\u0631\u064A\u0629\u060C \u0623\u0645\u0646 \u0627\u0644\u0628\u0646\u0648\u0643\u060C \u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u0645\u0633\u062A\u0634\u0641\u064A\u0627\u062A \u2014 \u0641\u0647\u0645 \u0647\u0630\u0647 \u0627\u0644\u0623\u0646\u0638\u0645\u0629 \u064A\u0633\u0627\u0639\u062F \u0627\u0644\u0637\u0644\u0627\u0628.',step1Title:'تكوين',step1Desc:'اضبط معلمات المحاكاة واختر طريقة التشفير. شاهد التصور يتحدث في الوقت الفعلي أثناء هذه المرحلة. يعرض الشاشة بالضبط ما يحدث داخلياً — كل لون وحركة يمثل تحولاً محدداً في البيانات.',step2Title:'معالجة',step2Desc:'تتم معالجة البيانات عبر الخوارزمية أو التقنية المختارة. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',step3Title:'إرسال',step3Desc:'يتم إرسال الإشارة أو الرسالة المعالجة عبر قناة الاتصال. تحول هذه المرحلة بيانات الإدخال باستخدام الخوارزمية المعروضة. قارن القيم قبل وبعد لفهم العلاقة الرياضية.',step4Title:'تحقق',step4Desc:'يقوم المستقبل بفك التشفير والتحقق من البيانات المستلمة. ناتج هذه المرحلة يغذي المرحلة التالية. حاول التوقف هنا لفحص الحالة الوسيطة.',sectionCode:'كود الجهاز',faq_q1:'ما هو Shadow Cam \u2014 Encrypted Surveillance؟',faq_a1:'Shadow Cam هي محاكاة تفاعلية توضح مفاهيم العمليات السرية. Motion detection, encrypted capture & auto-delete. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في العمليات السرية. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من العمليات السرية. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج ESP32. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من العمليات السرية. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في Shadow Cam \u2014 Encrypted Surveillance! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة العمليات السرية.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالعمليات السرية.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'التشفير',learn1Desc:'How secret codes protect messages from spies. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'أمن سيبراني',learn2Title:'الاتصال اللاسلكي',learn2Desc:'How devices send invisible signals through the air. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'لاسلكي',learn3Title:'أمن العمليات',learn3Desc:'How to keep your operations secret and secure. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'أمان',learn4Title:'الرياضيات في الأمن',learn4Desc:'How numbers and algorithms make unbreakable codes. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'رياضيات',sectionLearn:'ماذا ستتعلم',learnLevelVal:'مبتدئ 🟢',learnLevel:'المستوى:',learnTimeVal:'15 min ⏱',learnTime:'المدة:',learnAgeVal:'10+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Shadow Cam! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـالعمليات السرية — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how Set up the simulation parameters and choose your e لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم العمليات السرية من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',ch1Title:'تشفير وفك تشفير',ch1Desc:'شفّر رسالة ثم حاول فك تشفيرها يدوياً بدون النظر للمفتاح. ما الأنماط التي تلاحظها؟',ch2Title:'اختبار التخفي',ch2Desc:'حاول إكمال المهمة بأقل بصمة إشارة ممكنة. هل يمكنك النزول تحت عتبة الكشف؟',ch3Title:'سباق الاعتراض',ch3Desc:'ابدأ بثاً وقِس سرعة اعتراضه. ما الذي يؤثر على وقت الكشف؟',purpose:'Shadow Cam \\u2014 Encrypted Surveillance: Motion detection, encrypted capture & auto-delete. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ العمليات السرية',
 wiki_history: 'Encryption dates back to ancient Egypt (1900 BCE). The Caesar cipher, Enigma machine, and modern AES represent key milestones in cryptographic evolution. يبني Shadow Cam على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Shadow Cam',
 wiki_math: 'الرياضيات وراء Shadow Cam: Modern encryption relies on computational hardness: integer factorization (RSA), discrete logarithms (Diffie-Hellman), and elliptic curves (ECC). Cipher strength is measured in bits of security. AES-256 provides 256-bit security, meaning 2^256 operations to brute-force — more than atoms in the universe. Channel capacity follows Shannon: C = B·log₂(1+S/N). Doubling bandwidth doubles capacity, but doubling signal power only adds one bit per symbol.',
 ...
 theory: 'Shadow Cam يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A cipher is a specific algorithm for performing encryption and decryption. Block ciphers process fixed-size chunks; stream ciphers process one bit at a time. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'esc-steganography-suite',related1_desc:'',related1_path:'../../55-escape-evasion/esc-steganography-suite/index.html',related2_name:'محرك مكافحة الطب الشرعي',related2_desc:'مسح آمن وتنظيف السجلات',related2_path:'../../55-escape-evasion/esc-anti-forensics-toolkit/index.html',related3_name:'جهاز المعصم — رمز النقر',related3_desc:'أرسل رسائل سرية عبر أنماط النقر',related3_path:'../../40-agent-microbit/bit-wrist-communicator/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'رادار حزم WiFi',pathPrev_path:'../../02-spy-esp32/esp-packet-sniffer/index.html',pathNext_name:'شبكة مرحلات البصل',pathNext_path:'../../02-spy-esp32/esp-tor-relay/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'من اخترع شيفرة مورس؟',quiz_q1a:'تسلا',quiz_q1b:'صامويل مورس',quiz_q1c:'إديسون',quiz_q1d:'بيل',quiz_q1_answer:'1',quiz_q2:'ما هي الشبكة العصبية؟',quiz_q2a:'أسلاك مادية',quiz_q2b:'نظام حوسبة مستوحى من الخلايا العصبية',quiz_q2c:'شبكة اجتماعية',quiz_q2d:'شبكة راديو',quiz_q2_answer:'1',quiz_q3:'ما إمكانيات ESP32 اللاسلكية؟',quiz_q3a:'واي فاي فقط',quiz_q3b:'بلوتوث فقط',quiz_q3c:'واي فاي وبلوتوث',quiz_q3d:'لا شيء',quiz_q3_answer:'2',quiz_q4:'ما بنية معالج ESP32؟',quiz_q4a:'ARM',quiz_q4b:'Xtensa ثنائي النواة',quiz_q4c:'RISC-V فقط',quiz_q4d:'x86',quiz_q4_answer:'1',quiz_q5:'ما هي إخفاء المعلومات؟',quiz_q5a:'اتصال صاخب',quiz_q5b:'إخفاء رسائل داخل بيانات أخرى',quiz_q5c:'حذف ملفات',quiz_q5d:'بث إشارات',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'استعبد بوتنت ميراي (2016) أكثر من 600 ألف جهاز إنترنت الأشياء باستخدام 61 كلمة مرور افتراضية.',realworld2:'كشفت تسريبات سنودن عام 2013 أن برنامج بريزم التابع لوكالة الأمن القومي جمع البيانات مباشرة من خوادم جوجل وفيسبوك وآبل ومايكروسوفت.',realworld3:'أدى هجوم الفدية على خط أنابيب كولونيال (2021) إلى إغلاق أكبر خط أنابيب وقود في أمريكا لمدة 5 أيام بسبب كلمة مرور VPN واحدة مخترقة.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في اختراق إنترنت الأشياء معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في اختراق إنترنت الأشياء وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Shadow Cam \u2014 Encrypted Surveillance يوضح مفهومًا أساسيًا في اختراق إنترنت الأشياء. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Shadow Cam \u2014 Encrypted Surveillance لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في اختراق إنترنت الأشياء هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ ESP32 وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال اختراق إنترنت الأشياء يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'فعّل وضع النوم العميق بين عمليات المسح لإطالة عمر البطارية 10 أضعاف. يستهلك ESP32 ما يصل إلى 240 مللي أمبير نشط ولكن 10 ميكروأمبير فقط في النوم العميق.',proTip2:'استخدم التنقل بين القنوات (1، 6، 11) لمسح الواي فاي — هذه هي القنوات غير المتداخلة الوحيدة في نطاق 2.4 جيجاهرتز وتلتقط 90% من حركة المرور.',funFactTitle:'🎯 هل تعلم؟',funFact:'عرض أول فيروس كمبيوتر Creeper عام 1971 رسالة على طرفيات ARPANET. وكُتب أول مضاد فيروسات Reaper خصيصًا لملاحقته وحذفه.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
/* ═══════ SHADOW CAM — APP LOGIC ═══════ */

let camArmed = false;
let faceBlurActive = false;
let captures = []; // { id, imageData (Uint8Array), key (Uint8Array), ttl, timer, el, decrypted }
let captureIdCounter = 0;
const AUTO_DELETE_SEC = 30;
const CAPTURE_COOLDOWN = 1500; // ms between auto-captures
...
function initViewfinder() {
 vfCanvas = $('viewfinder');
 if (!vfCanvas) return;
 vfCtx = vfCanvas.getContext('2d', { willReadFrequently: true });
 drawNoise();
 updateCamTimestamp();
...
function updateCamTimestamp() {
 const el = $('camTimestamp');
 if (el) el.textContent = 'CAM-01 ' + new Date().toLocaleTimeString();
}

function drawNoise() {
 if (!vfCtx) return;
 const w = vfCanvas.width, h = vfCanvas.height;
 const img = vfCtx.createImageData(w, h);
 const d = img.data;
 for (let i = 0; i < d.length; i += 4) {
 const v = Math.random() * 40 | 0;
 d[i] = v; d[i+1] = v + 5; d[i+2] = v + 10; d[i+3] = 255;
 }
 vfCtx.putImageData(img, 0, 0);
 // Draw scan lines
 vfCtx.fillStyle = 'rgba(0,255,100,0.02)';
 for (let y = 0; y < h; y += 4) {
 vfCtx.fillRect(0, y, w, 1);
 }
 // Crosshair
 vfCtx.strokeStyle = 'rgba(0,255,100,0.15)';
 vfCtx.lineWidth = 1;
 vfCtx.beginPath();
 vfCtx.moveTo(w/2, 0); vfCtx.lineTo(w/2, h);
 vfCtx.moveTo(0, h/2); vfCtx.lineTo(w, h/2);
 vfCtx.stroke();
 noiseAnim = requestAnimationFrame(drawNoise);
}
...
// Motion detection via mouse movement on canvas
function initMotionDetection() {
 if (!vfCanvas) return;
 let lastMX = -1, lastMY = -1;

 vfCanvas.addEventListener('mousemove', (e) => {
 if (!camArmed) return;
 const rect = vfCanvas.getBoundingClientRect();
 const mx = ((e.clientX - rect.left) / rect.width * vfCanvas.width) | 0;
 const my = ((e.clientY - rect.top) / rect.height * vfCanvas.height) | 0;

 if (lastMX < 0) { lastMX = mx; lastMY = my; return; }

 const dx = Math.abs(mx - lastMX);
 const dy = Math.abs(my - lastMY);
 const dist = Math.sqrt(dx * dx + dy * dy);
 lastMX = mx; lastMY = my;

 // Paint colored region near cursor to simulate scene change
 const hue = (Date.now() / 20) % 360;
 vfCtx.fillStyle = `hsla(${hue}, 60%, 35%, 0.6)`;
 const sz = 20 + Math.random() * 30;
 vfCtx.fillRect(mx - sz/2, my - sz/2, sz, sz);

 // Compute motion level
 const sensitivity = parseInt($('sensitivitySlider')?.value || 40);
 motionPercent = Math.min(100, (dist / (200 - sensitivity * 1.5)) * 100) | 0;
 updateMotionUI(motionPercent);

 // Trigger capture
 if (motionPercent > 60 && Date.now() - lastCaptureTime > CAPTURE_COOLDOWN) {
 lastCaptureTime = Date.now();
 doCapture(true);
 }
 });

 vfCanvas.addEventListener('mouseleave', () => {
 motionPercent = 0;
 updateMotionUI(0);
 });
}
...
function updateMotionUI(pct) {
 ...
 const recDot = $('recDot');
 const s = LANG[currentLang];
 if (level) level.textContent = (s.motionLevel || 'Motion: 0%').replace('0%', pct + '%');
 if (badge) {
 if (pct > 40) {
 badge.textContent = s.motionDetected || 'MOTION!';
 badge.style.background = 'rgba(255,60,60,.85)';
 badge.style.color = '#fff';
 } else {
 badge.textContent = s.noMotion || 'NO MOTION';
 badge.style.background = 'rgba(0,0,0,.6)';
 badge.style.color = 'var(--text-muted)';
 }
 }
 if (recDot) recDot.style.background = pct > 40 ? '#ff3333' : (camArmed ? '#33ff33' : '#555');
}

// Capture: grab viewfinder, optionally face blur, then encrypt
function doCapture(auto) {
 if (!vfCtx) return;
 const s = LANG[currentLang];
 const w = vfCanvas.width, h = vfCanvas.height;

 // Grab current frame as ImageData
 const frame = vfCtx.getImageData(0, 0, w, h);
 const rawData = new Uint8Array(frame.data.buffer.slice(0));

 // Face blur simulation: pixelate a random region
 if (faceBlurActive) {
 const fx = (w * 0.25 + Math.random() * w * 0.4) | 0;
 const fy = (h * 0.15 + Math.random() * h * 0.3) | 0;
 const fw = 50 + Math.random() * 40 | 0;
 const fh = 60 + Math.random() * 40 | 0;
 pixelateRegion(rawData, w, h, fx, fy, fw, fh, 10);
 }

 // XOR encrypt
 const key = generateXORKey(rawData.length);
 const encrypted = xorEncrypt(rawData, key);

 // Create capture record
 const id = ++captureIdCounter;
 let ttl = AUTO_DELETE_SEC;
 const capObj = { id, imageData: encrypted, key, w, h, ttl, timer: null, el: null, decrypted: false };

 // Build gallery thumbnail
 const thumb = document.createElement('div');
 thumb.style.cssText = 'position:relative;width:80px;height:54px;border-radius:6px;overflow:hidden;border:1px solid var(--border);cursor:pointer;flex-shrink:0;background:#111;';
 thumb.title = 'Click to decrypt';

 // Draw encrypted noise thumbnail
 const tc = document.createElement('canvas');
 tc.width = 80; tc.height = 54;
 const tctx = tc.getContext('2d');
 const timg = tctx.createImageData(80, 54);
 for (let i = 0; i < timg.data.length; i += 4) {
 const si = ((i / 4 / 80 | 0) * (w / 54) | 0) * w + ((i / 4 % 80) * (w / 80) | 0);
 const bi = si * 4;
 timg.data[i] = encrypted[bi % encrypted.length];
 timg.data[i+1] = encrypted[(bi+1) % encrypted.length];
 timg.data[i+2] = encrypted[(bi+2) % encrypted.length];
 timg.data[i+3] = 255;
 }
 ...
 lock.style.cssText = 'position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:1.2rem;text-shadow:0 0 4px #000;';
 lock.textContent = '\uD83D\uDD12';
 thumb.appendChild(lock);

 // Countdown badge
 const countdown = document.createElement('div');
 countdown.style.cssText = 'position:absolute;bottom:2px;right:4px;font-size:.55rem;font-family:var(--font-h);color:#ff6;background:rgba(0,0,0,.7);padding:1px 4px;border-radius:3px;';
 countdown.textContent = ttl + 's';
 thumb.appendChild(countdown);

 thumb.addEventListener('click', () => decryptCapture(capObj));
 capObj.el = thumb;

 // Auto-delete timer
 capObj.timer = setInterval(() => {
 capObj.ttl--;
 countdown.textContent = capObj.ttl + 's';
 if (capObj.ttl <= 5) countdown.style.color = '#f44';
 if (capObj.ttl <= 0) {
 removeCapture(capObj);
 log(s.autoDeleted, 'error');
 }
 }, 1000);

 captures.push(capObj);
 const gallery = $('gallery');
 const empty = $('galleryEmpty');
 if (gallery) gallery.appendChild(thumb);
 if (empty) empty.style.display = 'none';

 log(auto ? s.captureTriggered : s.manualCaptureLog, 'success');
 log(s.encrypted, 'info');
 playSound('success');
 setStatus(true);
}
...
function generateXORKey(len) {
 ...
 for (let i = 0; i < len; i++) key[i] = Math.random() * 256 | 0;
 return key;
}
...
function pixelateRegion(data, imgW, imgH, rx, ry, rw, rh, blockSize) {
 for (let by = ry; by < Math.min(ry + rh, imgH); by += blockSize) {
 for (let bx = rx; bx < Math.min(rx + rw, imgW); bx += blockSize) {
 let r = 0, g = 0, b = 0, count = 0;
 for (let y = by; y < Math.min(by + blockSize, imgH); y++) {
 for (let x = bx; x < Math.min(bx + blockSize, imgW); x++) {
...
function decryptCapture(cap) {
 if (cap.decrypted) return;
 cap.decrypted = true;
 const s = LANG[currentLang];
 const decrypted = xorEncrypt(cap.imageData, cap.key); // XOR again = decrypt

 // Replace thumbnail with decrypted view
 const tc = cap.el.querySelector('canvas');
 if (tc) {
 const tctx = tc.getContext('2d');
 const timg = tctx.createImageData(80, 54);
 for (let i = 0; i < timg.data.length; i += 4) {
 const sx = (i / 4 % 80) / 80 * cap.w | 0;
 const sy = (i / 4 / 80 | 0) / 54 * cap.h | 0;
 const si = (sy * cap.w + sx) * 4;
 timg.data[i] = decrypted[si];
 timg.data[i+1] = decrypted[si+1];
 timg.data[i+2] = decrypted[si+2];
 timg.data[i+3] = 255;
 }
 tctx.putImageData(timg, 0, 0);
 }
 ...
 // Remove lock icon
 const lock = cap.el.querySelector('div');
 if (lock && lock.textContent.includes('\uD83D\uDD12')) lock.textContent = '\uD83D\uDD13';

 cap.el.style.border = '1px solid var(--accent)';
 log(s.decrypted, 'success');
 playSound('click');
}

function removeCapture(cap) {
 if (cap.timer) clearInterval(cap.timer);
 if (cap.el && cap.el.parentNode) cap.el.parentNode.removeChild(cap.el);
 captures = captures.filter(c => c.id !== cap.id);
 // Zero out data
 cap.imageData = null; cap.key = null;
...
function clearAllCaptures() {
 ...
 c.imageData = null; c.key = null;
 });
 captures = [];
 const empty = $('galleryEmpty');
 if (empty) empty.style.display = '';
 log(s.galleryCleared, 'info');
 playSound('click');
}
...
function toggleArm() {
 ...
 if (span) span.textContent = camArmed ? (s.disarmSystem || 'Disarm') : (s.armSystem || 'Arm System');
 }
 const recDot = $('recDot');
 if (recDot) recDot.style.background = camArmed ? '#33ff33' : '#555';
 log(camArmed ? s.armed : s.disarmed, camArmed ? 'success' : 'info');
 playSound(camArmed ? 'success' : 'click');
 if (camArmed) setStatus(true); else setStatus(false);
}

function toggleFaceBlur() {
 const s = LANG[currentLang];
 faceBlurActive = !faceBlurActive;
 const btn = $('faceBlurBtn');
 if (btn) {
 const span = btn.querySelector('span:last-child');
 if (span) span.textContent = faceBlurActive ? (s.faceBlurOn || 'Face Blur: ON') : (s.faceBlur || 'Face Blur: OFF');
 }
 log(faceBlurActive ? s.faceBlurEnabled : s.faceBlurDisabled, 'info');
 playSound('click');
}

function initShadowCam() {
 initViewfinder();
 initMotionDetection();

 const armBtn = $('armBtn');
 if (armBtn) armBtn.onclick = toggleArm;

 const captureBtn = $('captureBtn');
 if (captureBtn) captureBtn.onclick = () => doCapture(false);

 const faceBlurBtn = $('faceBlurBtn');
 if (faceBlurBtn) faceBlurBtn.onclick = toggleFaceBlur;

 const clearGalleryBtn = $('clearGalleryBtn');
 if (clearGalleryBtn) clearGalleryBtn.onclick = clearAllCaptures;
 ...
 // Encrypt toggle button just shows info
 const encToggle = $('encryptToggleBtn');
 if (encToggle) encToggle.onclick = () => {
 log('\uD83D\uDD12 Encryption: XOR stream cipher (symmetric)', 'info');
 playSound('click');
 };
}
