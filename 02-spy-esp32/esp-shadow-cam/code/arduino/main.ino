/*
 * Shadow Cam u2014 Encrypted Surveillance — ESP32 Arduino
 * Motion-triggered capture with encryption and auto-delete
 *
 ...
 *
 * Process:
 *   Step 1: Set up the simulation parameters and choose your encryption method.
 *   Step 2: The data is processed through the chosen algorithm or technique.
 *   Step 3: The processed signal or message is sent through the communication channel.
 *   Step 4: The receiver decodes, verifies, and validates the received data.
 */
...
// ── Configuration ──
#define APP_NAME "esp-shadow-cam"
#define LED_PIN 2
