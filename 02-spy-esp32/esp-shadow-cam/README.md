# Shadow Cam u2014 Encrypted Surveillance

> Motion-triggered capture with encryption and auto-delete

**Category:** 02-spy-esp32

## Description
Shadow Cam u2014 Encrypted Surveillance is an interactive educational web app from Workshop-DIY.
It provides a hands-on simulation environment where you can explore,
experiment, and learn about the underlying technology.

## Sections
- How It Works
- ESP32-CAM Wiring & Code
- Privacy, Ethics & Challenges
