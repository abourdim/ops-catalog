...
const LANG = {
  en: {
    ...
    howto_1: 'Type a secret message and select a beacon protocol (iBeacon, Eddystone, or Custom).',
  ...
  fr: {
    ...
    howto_1: 'Tapez un message secret et sélectionnez un protocole (iBeacon, Eddystone ou Personnalisé).',
  ...
  ar: {
    ...
    howto_1: 'اكتب رسالة سرية واختر بروتوكول الإشارة (iBeacon أو Eddystone أو مخصص).',
