...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-317F2E',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master 👻 Ghost Beacon — Hidden BLE Messages \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: '👻 Ghost Beacon — Hidden BLE Messages',
 subtitle: '👻 Broadcast invisible messages in BLE beacons',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Ghost Beacon Broadcaster',
 mainDesc: 'Encode hidden messages into BLE beacon advertisements',
 sectionA: 'How It Works', sectionB: 'Lab — Beacon Experiments', sectionC: 'Challenges',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1: 'The main display shows the Ghost Beacon simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'Choose an encoding method (UUID Steganography, Major/Minor, Namespace, or TX Power).',
 howto_3: 'Click "Encode & Broadcast" to start transmitting. Use the scanner to detect beacons.',
 howto_4: 'Select a detected beacon and click "Decode Message" to reveal the hidden content.',
 wiki_ble_title: '📡 BLE Advertising',
 wiki_ble: 'BLE advertisement packets are 31 bytes max. They contain AD structures with type and data fields. The ESP32 BLE stack allows custom advertisement data for creative applications.',
 wiki_beacon_title: '📍 Beacon Protocols',
 wiki_beacon: 'iBeacon: 0x4C000215 prefix + 16-byte UUID + 2-byte Major + 2-byte Minor + 1-byte TX. Eddystone-UID: 0xAAFE service UUID + 10-byte Namespace + 6-byte Instance ID.',
 wiki_stego_title: '🕵️ Steganography',
 wiki_stego: 'Steganography is the art of hiding information in plain sight. In BLE beacons, we can encode ASCII characters into UUID bytes, spread bits across Major/Minor fields, or modulate TX power patterns.',
 wiki_privacy_title: '🔒 Privacy',
 wiki_privacy: 'This app runs entirely in your browser with simulated BLE. No real Bluetooth signals are transmitted. All data stays local. No tracking, no analytics, no external calls.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '👻 Ghost Beacon ready — start broadcasting!',
 ...
 themeChanged: '🎨 Theme →',
 // Ghost Beacon specific
 broadcasterTitle: '📡 Beacon Broadcaster',
 secretMessage: 'Secret Message', msgPlaceholder: 'Type your hidden message...',
 beaconProtocol: 'Beacon Protocol', encodingMethod: 'Encoding Method',
 encUuidStego: 'UUID Steganography', encMajorMinor: 'Major/Minor Fields',
 encNamespace: 'Namespace Encoding', encTxPower: 'TX Power Modulation',
 txPower: 'TX Power (dBm)', encode: 'Encode & Broadcast', stopBroadcast: 'Stop',
 notBroadcasting: 'Not broadcasting', broadcasting: 'Broadcasting...',
 scannerTitle: '📶 Beacon Scanner', startScan: 'Start Scan', stopScan: 'Stop',
 scanIdle: 'Scanner idle', scanning: 'Scanning for beacons...',
 decoderTitle: '🔓 Hidden Message Decoder', selectBeacon: 'Select a detected beacon to decode',
 noBeacons: '-- No beacons detected --', decodeMessage: 'Decode Message',
 stepA1Title: 'BLE Advertising Basics',
 stepA1Desc: 'BLE devices broadcast advertisement packets every 20ms-10s. These packets contain up to 31 bytes of data visible to any scanner in range. ESP32 can both advertise and scan simultaneously.',
 stepA2Title: 'Beacon Protocols (iBeacon & Eddystone)',
 stepA2Desc: 'iBeacon uses UUID (16 bytes) + Major (2 bytes) + Minor (2 bytes). Eddystone-UID uses Namespace (10 bytes) + Instance (6 bytes). Both protocols have reserved fields we can hide data in.',
 stepA3Title: 'Steganography in Beacons',
 stepA3Desc: 'We encode secret messages into UUID bytes, major/minor fields, or namespace data. A normal scanner sees a valid beacon; only our decoder extracts the hidden message from the right fields.',
 stepA4Title: 'Proximity & RSSI',
 stepA4Desc: 'RSSI (Received Signal Strength Indicator) measures signal power in dBm. Closer beacons have stronger signals (-30 dBm = very close, -90 dBm = far away). We use this for proximity-based message reveal.',
 lab1Title: '📏 RSSI Distance Estimator',
 lab1Desc: 'Adjust RSSI and TX Power to estimate distance. Uses the log-distance path loss model.',
 measuredRssi: 'Measured RSSI (dBm)', refTxPower: 'Reference TX Power at 1m (dBm)',
 estimatedDist: 'Estimated Distance:', zoneImmediate: 'Zone: Immediate',
 zoneNear: 'Zone: Near', zoneFar: 'Zone: Far', zoneUnknown: 'Zone: Unknown',
 lab2Title: '🧬 BLE Packet Builder',
 lab2Desc: 'Build a raw BLE advertisement packet byte by byte. See how iBeacon and Eddystone frames are structured.',
 packetType: 'Packet Type', buildPacket: 'Build Packet',
 lab3Title: '📡 Multi-Beacon Radar',
 lab3Desc: 'Visualize multiple beacons on a radar display. Distance is based on simulated RSSI values.',
 startRadar: 'Start Radar', stopRadar: 'Stop Radar', radarIdle: 'Radar idle',
 ch1Title: '🏅 Challenge 1: Decode the Ghost',
 ch1Desc: 'A mystery beacon is broadcasting. Scan, find the ghost beacon, and decode its hidden message. The message is a secret word.',
 ch2Title: '🏅 Challenge 2: Proximity Treasure Hunt',
 ch2Desc: 'A hidden beacon is out there. Use the RSSI meter to get closer. The message only reveals when you are within 1 meter (simulated).',
 ch3Title: '🏅 Challenge 3: Beacon Flood Detection',
 ch3Desc: 'Someone is flooding the airspace with fake beacons! Identify the suspicious beacon among the legitimate ones. Look for anomalies in UUID patterns and broadcast intervals.',
 startChallenge: 'Start Challenge', submit: 'Submit',
 distance: 'Distance:', walkCloser: 'Walk Closer (simulate)',
 selectSuspect: '-- Select suspicious beacon --', reportBeacon: 'Report Beacon',
 challengeComplete: 'Challenge Complete!', challengeFailed: 'Try again!',
 encodedAs: 'Encoded as', decodedMsg: 'Decoded message',
 beaconDetected: 'Beacon detected', noMessage: 'Enter a message first',
 msgTooLong: 'Message too long for this encoding',step1Title:'Configure',step1Desc:'Set up the simulation parameters and choose your encryption method. Watch the visualization update in real time as this stage processes. The display shows exactly what is happening internally — each color and movement represents a specific data transformation.',step2Title:'Process',step2Desc:'The data is processed through the chosen algorithm or technique. Notice how the indicators change during this phase. The activity log records every event, letting you trace the exact sequence of operations and verify the results.',step3Title:'Transmit',step3Desc:'The processed signal or message is sent through the communication channel. This stage transforms the input data using the algorithm shown in the visualization. Compare the before and after values to understand the mathematical relationship.',step4Title:'Verify',step4Desc:'The receiver decodes, verifies, and validates the received data. The output of this stage feeds into the next one. Try pausing here to examine the intermediate state — understanding each step separately builds deeper insight.',sectionCode:'Device Code',faq_q1:'What is 👻 Ghost Beacon — Hidden BLE Messages?',faq_a1:'Ghost Beacon is an interactive simulation that demonstrates covert operations concepts. Encode hidden messages into BLE beacon advertisements. Everything runs in your browser — no hardware or installation needed. Adjust the controls, observe the results, and build real understanding through experimentation.',faq_q2:'How does the simulation work?',faq_a2:'The simulation models real covert operations behavior in your browser. You control the inputs using sliders and buttons, and the visualization updates in real time to show you the results.',faq_q3:'What do the controls do?',faq_a3:'Press "Start Scan" to begin. Each button and slider changes a specific parameter — the visualization responds immediately so you can see the effect. Check the How-To tab for a step-by-step guide.',faq_q4:'What is the science behind this?',faq_a4:'This app is based on real covert operations principles used by professionals. The simulation applies the same math and physics — the difference is that here you can safely experiment without expensive equipment.',faq_q5:'What should I experiment with?',faq_a5:'Change one parameter at a time and observe the effect. Try extreme values to find the limits. Then combine changes to see how different factors interact. The challenges section gives you specific experiments to try.',faq_q6:'What hardware do I need for the real version?',faq_a6:'The simulation needs no hardware. To build the real project, you need ESP32. See the Device Code section for wiring diagrams and ready-to-use firmware.',faq_q7:'Is my data private?',faq_a7:'Yes. Everything runs locally in your browser using JavaScript. No data is sent to any server, no account is needed, and the app works completely offline. Your experiments stay on your device.',faq_q8:'What should I explore next?',faq_a8:'Try Esp Dark Net Radio and Esp Dead Zone. Each app in this category teaches a different aspect of covert operations. Try systematically: set all controls to their defaults, then change one variable at a time. Record what happens at minimum, midpoint, and maximum values. This methodical approach is exactly how researchers and engineers characterize real systems.',demo_s1:'Welcome to 👻 Ghost Beacon — Hidden BLE Messages! Look at the main display — this is where the covert operations simulation runs.',demo_s2:'Type a secret message and select a beacon protocol (iBeacon, Eddystone, or Custom). Watch how the visualization reacts.',demo_s3:'Try adjusting the controls. Each slider or button changes a specific parameter of the simulation.',demo_s4:'Scroll down to see "How It Works" for detailed data. The numbers and charts update as the simulation runs.',demo_s5:'Great job! Now try the challenges section to test your understanding of covert operations.',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Cryptography',learn1Desc:'How secret codes protect messages from spies. Watch the simulation to see this happen in real time. The visualization makes the invisible visible.',learn1Tag:'Cybersecurity',learn2Title:'Wireless Communication',learn2Desc:'How devices send invisible signals through the air. The controls let you experiment with different conditions. Each change reveals how this principle responds.',learn2Tag:'Wireless',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Try the challenges section to test your understanding. Real engineers use these same concepts daily.',learn3Tag:'Security',learn4Title:'Math in Security',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare results with different settings to build intuition. The data panels show precise measurements.',learn4Tag:'Math',sectionLearn:'What You Shall Learn',learnLevelVal:'Beginner 🟢',learnLevel:'Level:',learnTimeVal:'15 min ⏱',learnTime:'Time:',learnAgeVal:'10+ 🧒',kidTitle:'For Young Explorers',kidIntro:'Welcome to Ghost Beacon! This is like a science experiment on your computer. You get to control a real covert operations simulation — press buttons, move sliders, and watch what happens on screen. Try changing the controls and watch how Set up the simulation parameters and choose your e Nothing can break — it is all just a simulation running safely in your browser!',kidSafe:'Completely safe! Nothing you do here can break anything. It all runs inside your browser like a game.',kidTry:'Press the big Start button and watch the screen change. Then try moving sliders to see what they do.',kidParent:'This app teaches covert operations concepts through hands-on simulation. Suitable for STEM education in physics, electronics, and computer science.',codeTitle:'Starter Code',codeLang:'Arduino (ESP32)',codeSnippet:'#include <WiFi.h>\\n\\nconst char* ssid = "MyNetwork";\\nconst char* pass = "secret123";\\n\\nvoid setup() {\\n Serial.begin(115200);\\n WiFi.mode(WIFI_STA);\\n WiFi.begin(ssid, pass);\\n while (WiFi.status() != WL_CONNECTED) {\\n delay(500);\\n Serial.print(".");\\n }\\n Serial.println("\\nConnected!");\\n Serial.println(WiFi.localIP());\\n}\\n\\nvoid loop() {\\n // Your code here\\n}',codeExplain:'This Arduino sketch connects the ESP32 to a WiFi network. WiFi.mode(WIFI_STA) sets it as a client (station mode). The while loop waits until connected, then prints the IP address. From here you can add HTTP servers, MQTT, UDP packets, or BLE scanning.',purpose:'👻 Ghost Beacon — Hidden BLE Messages: Encode hidden messages into BLE beacon advertisements. This simulation lets you experiment hands-on instead of just reading theory. Every parameter you change produces visible results, building real intuition for how the system behaves. The workflow goes from Configure through Process to Transmit and Verify.',guideTitle:'What Am I Looking At?',guideCanvas:'The main area shows a live visualization of the simulation. Colors and movement represent data changing in real time.',guideControls:'The buttons below the main display control the simulation. Start begins it, Stop pauses it, Reset clears everything.',guideSections:'Below the main card, "How It Works" and "Lab — Beacon Experiments" show detailed data and analysis. Click the section headers to expand or collapse them.',guideStatus:'The colored dot in the top-right corner shows the connection status. Green means running, red means stopped.',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'esc-exfiltration-olympics',related1_desc:'',related1_path:'../../55-escape-evasion/esc-exfiltration-olympics/index.html',related2_name:'Dead Drop — BLE Message Transfer',related2_desc:'Encrypt and exchange secret messages via BLE simulation',related2_path:'../../01-spy-microbit/bit-dead-drop/index.html',related3_name:'esc-stylometry-defeater',related3_desc:'',related3_path:'../../55-escape-evasion/esc-stylometry-defeater/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Frequency Hunter',pathPrev_path:'../../02-spy-esp32/esp-frequency-hunter/index.html',pathNext_name:'WiFi Packet Radar',pathNext_path:'../../02-spy-esp32/esp-packet-sniffer/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 gloss4_term: 'Beacon Interval',
 gloss4_def: 'Time between consecutive beacon transmissions by an access point, typically 100 TU (102.4 ms). Shorter intervals improve discoverability but consume more airtime.',
 gloss5_term: 'Latency',
 ...
 theory: 'Ghost Beacon demonstrates key principles from covert operations. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-317F2E',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez 👻 Ghost Beacon — Hidden BLE Messages \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: '👻 Ghost Beacon — Messages BLE Cachés',
 subtitle: '👻 Diffusez des messages invisibles dans les balises BLE',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Diffuseur Ghost Beacon',
 mainDesc: 'Encodez des messages cachés dans les annonces BLE',
 sectionA: 'Comment ça marche', sectionB: 'Labo — Expériences Beacon', sectionC: 'Défis',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1: 'L écran principal affiche la simulation Ghost Beacon. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'Choisissez une méthode d\'encodage (Stéganographie UUID, Major/Minor, Namespace ou Puissance TX).',
 howto_3: 'Cliquez sur "Encoder & Diffuser" pour commencer. Utilisez le scanner pour détecter les balises.',
 howto_4: 'Sélectionnez une balise détectée et cliquez "Décoder" pour révéler le contenu caché.',
 wiki_ble_title: '📡 Publicité BLE',
 wiki_ble: 'Les paquets publicitaires BLE font 31 octets max. Ils contiennent des structures AD avec type et données. L\'ESP32 permet des données publicitaires personnalisées.',
 wiki_beacon_title: '📍 Protocoles Beacon',
 wiki_beacon: 'iBeacon : préfixe 0x4C000215 + UUID 16 octets + Major 2 octets + Minor 2 octets + TX 1 octet. Eddystone-UID : UUID service 0xAAFE + Namespace 10 octets + Instance 6 octets.',
 wiki_stego_title: '🕵️ Stéganographie',
 wiki_stego: 'La stéganographie est l\'art de cacher de l\'information. Dans les balises BLE, on encode des caractères ASCII dans les octets UUID, on répartit les bits dans les champs Major/Minor, ou on module la puissance TX.',
 wiki_privacy_title: '🔒 Confidentialité',
 wiki_privacy: 'Cette appli fonctionne entièrement dans votre navigateur avec BLE simulé. Aucun signal Bluetooth réel n\'est émis. Toutes les données restent locales.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '👻 Ghost Beacon prêt — commencez à diffuser !',
 ...
 themeChanged: '🎨 Thème →',
 broadcasterTitle: '📡 Diffuseur de Balise',
 secretMessage: 'Message Secret', msgPlaceholder: 'Tapez votre message caché...',
 beaconProtocol: 'Protocole Balise', encodingMethod: 'Méthode d\'Encodage',
 encUuidStego: 'Stéganographie UUID', encMajorMinor: 'Champs Major/Minor',
 encNamespace: 'Encodage Namespace', encTxPower: 'Modulation Puissance TX',
 txPower: 'Puissance TX (dBm)', encode: 'Encoder & Diffuser', stopBroadcast: 'Arrêter',
 notBroadcasting: 'Pas de diffusion', broadcasting: 'Diffusion en cours...',
 scannerTitle: '📶 Scanner de Balises', startScan: 'Démarrer Scan', stopScan: 'Arrêter',
 scanIdle: 'Scanner inactif', scanning: 'Recherche de balises...',
 decoderTitle: '🔓 Décodeur de Messages Cachés', selectBeacon: 'Sélectionnez une balise pour décoder',
 noBeacons: '-- Aucune balise détectée --', decodeMessage: 'Décoder Message',
 stepA1Title: 'Bases de la Publicité BLE',
 stepA1Desc: 'Les appareils BLE diffusent des paquets publicitaires toutes les 20ms-10s. Ces paquets contiennent jusqu\'à 31 octets de données visibles par tout scanner à portée. L\'ESP32 peut diffuser et scanner simultanément.',
 stepA2Title: 'Protocoles Beacon (iBeacon & Eddystone)',
 stepA2Desc: 'iBeacon utilise UUID (16 octets) + Major (2 octets) + Minor (2 octets). Eddystone-UID utilise Namespace (10 octets) + Instance (6 octets). Les deux ont des champs où cacher des données.',
 stepA3Title: 'Stéganographie dans les Balises',
 stepA3Desc: 'On encode des messages secrets dans les octets UUID, les champs major/minor, ou les données namespace. Un scanner normal voit une balise valide ; seul notre décodeur extrait le message caché.',
 stepA4Title: 'Proximité & RSSI',
 stepA4Desc: 'Le RSSI mesure la puissance du signal en dBm. Les balises proches ont un signal plus fort (-30 dBm = très proche, -90 dBm = loin). On l\'utilise pour la révélation de messages basée sur la proximité.',
 lab1Title: '📏 Estimateur de Distance RSSI',
 lab1Desc: 'Ajustez le RSSI et la puissance TX pour estimer la distance. Utilise le modèle de perte de parcours logarithmique.',
 measuredRssi: 'RSSI Mesuré (dBm)', refTxPower: 'Puissance TX Référence à 1m (dBm)',
 estimatedDist: 'Distance Estimée :', zoneImmediate: 'Zone : Immédiate',
 zoneNear: 'Zone : Proche', zoneFar: 'Zone : Loin', zoneUnknown: 'Zone : Inconnue',
 lab2Title: '🧬 Constructeur de Paquets BLE',
 lab2Desc: 'Construisez un paquet publicitaire BLE brut octet par octet. Voyez la structure des trames iBeacon et Eddystone.',
 packetType: 'Type de Paquet', buildPacket: 'Construire Paquet',
 lab3Title: '📡 Radar Multi-Balises',
 lab3Desc: 'Visualisez plusieurs balises sur un radar. La distance est basée sur les valeurs RSSI simulées.',
 startRadar: 'Démarrer Radar', stopRadar: 'Arrêter Radar', radarIdle: 'Radar inactif',
 ch1Title: '🏅 Défi 1 : Décoder le Fantôme',
 ch1Desc: 'Une balise mystérieuse diffuse. Scannez, trouvez la balise fantôme et décodez son message caché.',
 ch2Title: '🏅 Défi 2 : Chasse au Trésor Proximité',
 ch2Desc: 'Une balise cachée est là. Utilisez le RSSI pour vous rapprocher. Le message se révèle à moins d\'1 mètre (simulé).',
 ch3Title: '🏅 Défi 3 : Détection d\'Inondation de Balises',
 ch3Desc: 'Quelqu\'un inonde l\'espace avec de fausses balises ! Identifiez la balise suspecte parmi les légitimes.',
 startChallenge: 'Démarrer Défi', submit: 'Soumettre',
 distance: 'Distance :', walkCloser: 'Se rapprocher (simuler)',
 selectSuspect: '-- Sélectionner la balise suspecte --', reportBeacon: 'Signaler Balise',
 challengeComplete: 'Défi Réussi !', challengeFailed: 'Réessayez !',
 encodedAs: 'Encodé comme', decodedMsg: 'Message décodé',
 beaconDetected: 'Balise détectée', noMessage: 'Entrez un message d\'abord',
 msgTooLong: 'Message trop long pour cet encodage',step1Title:'Configurer',step1Desc:'Configure les paramètres de simulation et choisis ta méthode de chiffrement. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Traiter',step2Desc:'Les données sont traitées par l\'algorithme ou la technique choisie. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Transmettre',step3Desc:'Le signal ou message traité est envoyé par le canal de communication. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Vérifier',step4Desc:'Le récepteur décode, vérifie et valide les données reçues. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que 👻 Ghost Beacon — Hidden BLE Messages ?',faq_a1:'Ghost Beacon est une simulation interactive qui démontre les concepts de opérations secrètes. Encode hidden messages into BLE beacon advertisements. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de opérations secrètes. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de opérations secrètes. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut ESP32. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de opérations secrètes. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans 👻 Ghost Beacon — Hidden BLE Messages ! Regarde l\'écran principal — c\'est ici que la simulation de opérations secrètes fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de opérations secrètes.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Cryptographie',learn1Desc:'How secret codes protect messages from spies. Regarde la simulation pour voir ça en temps réel. La visualisation rend visible l\'invisible.',learn1Tag:'Cybersécurité',learn2Title:'Communication sans fil',learn2Desc:'How devices send invisible signals through the air. Les contrôles te permettent d\'expérimenter. Chaque changement révèle comment ce principe réagit.',learn2Tag:'Sans fil',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Sécurité',learn4Title:'Maths en sécurité',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Maths',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Débutant 🟢',learnLevel:'Niveau :',learnTimeVal:'15 min ⏱',learnTime:'Durée :',learnAgeVal:'10+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Ghost Beacon ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de opérations secrètes — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how Set up the simulation parameters and choose your e Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de opérations secrètes par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',codeTitle:'Code de Démarrage',codeLang:'Arduino (ESP32)',codeSnippet:'#include <WiFi.h>\\n\\nconst char* ssid = "MyNetwork";\\nconst char* pass = "secret123";\\n\\nvoid setup() {\\n Serial.begin(115200);\\n WiFi.mode(WIFI_STA);\\n WiFi.begin(ssid, pass);\\n while (WiFi.status() != WL_CONNECTED) {\\n delay(500);\\n Serial.print(".");\\n }\\n Serial.println("\\nConnected!");\\n Serial.println(WiFi.localIP());\\n}\\n\\nvoid loop() {\\n // Your code here\\n}',codeExplain:'Ce sketch Arduino connecte l\'ESP32 à un réseau WiFi. WiFi.mode(WIFI_STA) le configure en mode client. La boucle while attend la connexion, puis affiche l\'adresse IP. Ensuite tu peux ajouter des serveurs HTTP, MQTT, UDP ou du scan BLE.',purpose:'👻 Ghost Beacon — Hidden BLE Messages : Encode hidden messages into BLE beacon advertisements. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'esc-exfiltration-olympics',related1_desc:'',related1_path:'../../55-escape-evasion/esc-exfiltration-olympics/index.html',related2_name:'Dead Drop — Transfert BLE',related2_desc:'Chiffrez et échangez des messages secrets via simulation BLE',related2_path:'../../01-spy-microbit/bit-dead-drop/index.html',related3_name:'esc-stylometry-defeater',related3_desc:'',related3_path:'../../55-escape-evasion/esc-stylometry-defeater/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'Chasseur de Fréquences',pathPrev_path:'../../02-spy-esp32/esp-frequency-hunter/index.html',pathNext_name:'Radar de Paquets WiFi',pathNext_path:'../../02-spy-esp32/esp-packet-sniffer/index.html',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Qu\'est-ce que la stéganographie ?',quiz_q1a:'Communication forte',quiz_q1b:'Cacher des messages dans d\'autres données',quiz_q1c:'Supprimer des fichiers',quiz_q1d:'Diffuser des signaux',quiz_q1_answer:'1',quiz_q2:'À quelle tension fonctionne l\'ESP32 ?',quiz_q2a:'5V',quiz_q2b:'3,3V',quiz_q2c:'1,8V',quiz_q2d:'12V',quiz_q2_answer:'1',quiz_q3:'Quelles capacités sans fil a l\'ESP32 ?',quiz_q3a:'Wi-Fi uniquement',quiz_q3b:'Bluetooth uniquement',quiz_q3c:'Wi-Fi et Bluetooth',quiz_q3d:'Aucune',quiz_q3_answer:'2',quiz_q4:'Qu\'est-ce que l\'apprentissage automatique ?',quiz_q4a:'Programmer des robots',quiz_q4b:'Systèmes apprenant des données',quiz_q4c:'Calcul manuel',quiz_q4d:'Conception matérielle',quiz_q4_answer:'1',quiz_q5:'Qu\'est-ce qu\'une boîte aux lettres morte ?',quiz_q5a:'Connexion échouée',quiz_q5b:'Lieu secret pour échanger des messages',quiz_q5c:'Antenne cassée',quiz_q5d:'Fréquence vide',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'Les fuites de Snowden en 2013 ont révélé que le programme PRISM de la NSA collectait des données directement depuis les serveurs de Google, Facebook, Apple et Microsoft.',realworld2:'Le ransomware Colonial Pipeline (2021) a fermé le plus grand oléoduc américain pendant 5 jours. Un seul mot de passe VPN compromis a causé des pénuries dans 17 états.',realworld3:'Le botnet Mirai (2016) a asservi 600 000 appareils IoT en utilisant 61 mots de passe par défaut. Son attaque DDoS de 1,2 Tbps a fait tomber Twitter, Netflix et Reddit.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En piratage IoT, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en piratage IoT et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'👻 Ghost Beacon — Hidden BLE Messages illustre un concept fondamental en piratage IoT. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans 👻 Ghost Beacon — Hidden BLE Messages ont des applications directes dans le monde réel. Les professionnels de piratage IoT utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, ESP32 et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en piratage IoT implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'Utilisez le saut de canal (canaux 1, 6, 11) pour le scan WiFi — ce sont les seuls canaux 2,4 GHz non chevauchants et ils captent 90% du trafic.',proTip2:'Ajoutez un condensateur de 10μF aux bornes d\x27alimentation de l\x27ESP32. La transmission WiFi cause des pics de courant qui peuvent planter la carte sans découplage.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'Le premier virus informatique, Creeper (1971), affichait \\x27I\\x27m the creeper, catch me if you can!\\x27 sur les terminaux ARPANET.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de opérations secrètes',
 wiki_history: 'Encryption dates back to ancient Egypt (1900 BCE). The Caesar cipher, Enigma machine, and modern AES represent key milestones in cryptographic evolution. Ghost Beacon s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Ghost Beacon',
 wiki_math: 'Les mathématiques derrière Ghost Beacon : Modern encryption relies on computational hardness: integer factorization (RSA), discrete logarithms (Diffie-Hellman), and elliptic curves (ECC). BLE uses Gaussian Frequency Shift Keying (GFSK) modulation at 1 Mbps. The modulation index of 0.5 provides optimal bandwidth efficiency. Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time.',
 ...
 theory: 'Ghost Beacon démontre les principes clés de opérations secrètes. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: '👻 Ghost Beacon — رسائل BLE مخفية',
 subtitle: '👻 بث رسائل غير مرئية في إشارات BLE',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'بث إشارة الشبح',
 mainDesc: 'شفّر رسائل مخفية في إعلانات إشارات BLE',
 sectionA: 'كيف يعمل', sectionB: 'المختبر — تجارب الإشارات', sectionC: 'التحديات',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Ghost Beacon. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 howto_2: 'اختر طريقة التشفير (إخفاء UUID، حقول Major/Minor، تشفير Namespace، أو تعديل قوة TX).',
 howto_3: 'انقر "تشفير وبث" لبدء الإرسال. استخدم الماسح لاكتشاف الإشارات.',
 howto_4: 'اختر إشارة مكتشفة وانقر "فك التشفير" لكشف المحتوى المخفي.',
 wiki_ble_title: '📡 إعلان BLE',
 wiki_ble: 'حزم إعلان BLE بحد أقصى 31 بايت. تحتوي على هياكل AD مع حقول النوع والبيانات. تسمح حزمة ESP32 BLE ببيانات إعلانية مخصصة.',
 wiki_beacon_title: '📍 بروتوكولات الإشارة',
 wiki_beacon: 'iBeacon: بادئة 0x4C000215 + UUID 16 بايت + Major 2 بايت + Minor 2 بايت + TX 1 بايت. Eddystone-UID: UUID خدمة 0xAAFE + Namespace 10 بايت + Instance 6 بايت.',
 wiki_stego_title: '🕵️ إخفاء المعلومات',
 wiki_stego: 'إخفاء المعلومات هو فن إخفاء المعلومات في العلن. في إشارات BLE، نشفّر أحرف ASCII في بايتات UUID، أو نوزع البتات عبر حقول Major/Minor، أو نعدل أنماط قوة TX.',
 wiki_privacy_title: '🔒 الخصوصية',
 wiki_privacy: 'يعمل هذا التطبيق بالكامل في متصفحك مع BLE محاكاة. لا يتم إرسال إشارات بلوتوث حقيقية. جميع البيانات تبقى محلية.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '👻 Ghost Beacon جاهز — ابدأ البث!',
 ...
 themeChanged: '🎨 المظهر ←',
 broadcasterTitle: '📡 بث الإشارة',
 secretMessage: 'الرسالة السرية', msgPlaceholder: 'اكتب رسالتك المخفية...',
 beaconProtocol: 'بروتوكول الإشارة', encodingMethod: 'طريقة التشفير',
 encUuidStego: 'إخفاء UUID', encMajorMinor: 'حقول Major/Minor',
 encNamespace: 'تشفير Namespace', encTxPower: 'تعديل قوة TX',
 txPower: 'قوة TX (ديسيبل)', encode: 'تشفير وبث', stopBroadcast: 'إيقاف',
 notBroadcasting: 'لا يوجد بث', broadcasting: 'جارٍ البث...',
 scannerTitle: '📶 ماسح الإشارات', startScan: 'بدء المسح', stopScan: 'إيقاف',
 scanIdle: 'الماسح خامل', scanning: 'البحث عن إشارات...',
 decoderTitle: '🔓 فك تشفير الرسائل المخفية', selectBeacon: 'اختر إشارة مكتشفة لفك تشفيرها',
 noBeacons: '-- لم يتم اكتشاف إشارات --', decodeMessage: 'فك تشفير الرسالة',
 stepA1Title: 'أساسيات إعلان BLE',
 stepA1Desc: 'تبث أجهزة BLE حزم إعلانية كل 20 مللي ثانية إلى 10 ثوان. تحتوي هذه الحزم على 31 بايت كحد أقصى من البيانات المرئية لأي ماسح ضمن النطاق.',
 stepA2Title: 'بروتوكولات الإشارة (iBeacon و Eddystone)',
 stepA2Desc: 'يستخدم iBeacon معرف UUID (16 بايت) + Major (2 بايت) + Minor (2 بايت). يستخدم Eddystone-UID حقل Namespace (10 بايت) + Instance (6 بايت).',
 stepA3Title: 'إخفاء المعلومات في الإشارات',
 stepA3Desc: 'نشفّر الرسائل السرية في بايتات UUID أو حقول major/minor أو بيانات namespace. يرى الماسح العادي إشارة صالحة؛ فقط فك التشفير لدينا يستخرج الرسالة المخفية.',
 stepA4Title: 'القرب و RSSI',
 stepA4Desc: 'يقيس RSSI قوة الإشارة بالديسيبل. الإشارات القريبة أقوى (-30 ديسيبل = قريب جداً، -90 ديسيبل = بعيد). نستخدم هذا لكشف الرسائل بناءً على القرب.',
 lab1Title: '📏 مقدّر المسافة RSSI',
 lab1Desc: 'اضبط RSSI وقوة TX لتقدير المسافة. يستخدم نموذج فقدان المسار اللوغاريتمي.',
 measuredRssi: 'RSSI المقاس (ديسيبل)', refTxPower: 'قوة TX المرجعية عند 1م (ديسيبل)',
 estimatedDist: 'المسافة المقدرة:', zoneImmediate: 'المنطقة: فورية',
 zoneNear: 'المنطقة: قريبة', zoneFar: 'المنطقة: بعيدة', zoneUnknown: 'المنطقة: غير معروفة',
 lab2Title: '🧬 بناء حزمة BLE',
 lab2Desc: 'ابنِ حزمة إعلان BLE خام بايت ببايت. شاهد هيكل إطارات iBeacon و Eddystone.',
 packetType: 'نوع الحزمة', buildPacket: 'بناء الحزمة',
 lab3Title: '📡 رادار متعدد الإشارات',
 lab3Desc: 'تصور عدة إشارات على شاشة رادار. المسافة مبنية على قيم RSSI المحاكاة.',
 startRadar: 'تشغيل الرادار', stopRadar: 'إيقاف الرادار', radarIdle: 'الرادار خامل',
 ch1Title: '🏅 التحدي 1: فك شفرة الشبح',
 ch1Desc: 'إشارة غامضة تبث. امسح واعثر على إشارة الشبح وفك شفرة رسالتها المخفية.',
 ch2Title: '🏅 التحدي 2: البحث عن الكنز بالقرب',
 ch2Desc: 'إشارة مخفية موجودة. استخدم مقياس RSSI للاقتراب. تظهر الرسالة فقط عند أقل من 1 متر (محاكاة).',
 ch3Title: '🏅 التحدي 3: كشف فيضان الإشارات',
 ch3Desc: 'شخص ما يغمر الفضاء بإشارات مزيفة! حدد الإشارة المشبوهة بين الشرعية.',
 startChallenge: 'بدء التحدي', submit: 'إرسال',
 distance: 'المسافة:', walkCloser: 'اقترب أكثر (محاكاة)',
 selectSuspect: '-- اختر الإشارة المشبوهة --', reportBeacon: 'الإبلاغ عن الإشارة',
 challengeComplete: 'تم إنجاز التحدي!', challengeFailed: 'حاول مرة أخرى!',
 encodedAs: 'مشفّر كـ', decodedMsg: 'الرسالة المفكوكة',
 beaconDetected: 'تم اكتشاف إشارة', noMessage: 'أدخل رسالة أولاً',
 msgTooLong: 'الرسالة طويلة جداً لهذا التشفير',step1Title:'تكوين',step1Desc:'اضبط معلمات المحاكاة واختر طريقة التشفير. شاهد التصور يتحدث في الوقت الفعلي أثناء هذه المرحلة. يعرض الشاشة بالضبط ما يحدث داخلياً — كل لون وحركة يمثل تحولاً محدداً في البيانات.',step2Title:'معالجة',step2Desc:'تتم معالجة البيانات عبر الخوارزمية أو التقنية المختارة. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',step3Title:'إرسال',step3Desc:'يتم إرسال الإشارة أو الرسالة المعالجة عبر قناة الاتصال. تحول هذه المرحلة بيانات الإدخال باستخدام الخوارزمية المعروضة. قارن القيم قبل وبعد لفهم العلاقة الرياضية.',step4Title:'تحقق',step4Desc:'يقوم المستقبل بفك التشفير والتحقق من البيانات المستلمة. ناتج هذه المرحلة يغذي المرحلة التالية. حاول التوقف هنا لفحص الحالة الوسيطة.',sectionCode:'كود الجهاز',faq_q1:'ما هو 👻 Ghost Beacon — Hidden BLE Messages؟',faq_a1:'Ghost Beacon هي محاكاة تفاعلية توضح مفاهيم العمليات السرية. Encode hidden messages into BLE beacon advertisements. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في العمليات السرية. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من العمليات السرية. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج ESP32. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من العمليات السرية. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في 👻 Ghost Beacon — Hidden BLE Messages! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة العمليات السرية.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالعمليات السرية.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'التشفير',learn1Desc:'How secret codes protect messages from spies. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'أمن سيبراني',learn2Title:'الاتصال اللاسلكي',learn2Desc:'How devices send invisible signals through the air. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'لاسلكي',learn3Title:'أمن العمليات',learn3Desc:'How to keep your operations secret and secure. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'أمان',learn4Title:'الرياضيات في الأمن',learn4Desc:'How numbers and algorithms make unbreakable codes. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'رياضيات',sectionLearn:'ماذا ستتعلم',learnLevelVal:'مبتدئ 🟢',learnLevel:'المستوى:',learnTimeVal:'15 min ⏱',learnTime:'المدة:',learnAgeVal:'10+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Ghost Beacon! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـالعمليات السرية — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how Set up the simulation parameters and choose your e لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم العمليات السرية من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',codeTitle:'كود البداية',codeLang:'Arduino (ESP32)',codeSnippet:'#include <WiFi.h>\\n\\nconst char* ssid = "MyNetwork";\\nconst char* pass = "secret123";\\n\\nvoid setup() {\\n Serial.begin(115200);\\n WiFi.mode(WIFI_STA);\\n WiFi.begin(ssid, pass);\\n while (WiFi.status() != WL_CONNECTED) {\\n delay(500);\\n Serial.print(".");\\n }\\n Serial.println("\\nConnected!");\\n Serial.println(WiFi.localIP());\\n}\\n\\nvoid loop() {\\n // Your code here\\n}',codeExplain:'يوصل هذا الكود ESP32 بشبكة WiFi. الوضع WIFI_STA يضبطه كعميل. حلقة while تنتظر الاتصال ثم تطبع عنوان IP. بعدها يمكنك إضافة خوادم HTTP أو MQTT أو مسح BLE.',purpose:'👻 Ghost Beacon — Hidden BLE Messages: Encode hidden messages into BLE beacon advertisements. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ العمليات السرية',
 wiki_history: 'Encryption dates back to ancient Egypt (1900 BCE). The Caesar cipher, Enigma machine, and modern AES represent key milestones in cryptographic evolution. يبني Ghost Beacon على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Ghost Beacon',
 wiki_math: 'الرياضيات وراء Ghost Beacon: Modern encryption relies on computational hardness: integer factorization (RSA), discrete logarithms (Diffie-Hellman), and elliptic curves (ECC). BLE uses Gaussian Frequency Shift Keying (GFSK) modulation at 1 Mbps. The modulation index of 0.5 provides optimal bandwidth efficiency. Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time.',
 ...
 theory: 'Ghost Beacon يوضح المبادئ الأساسية في العمليات السرية. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. Bluetooth Low Energy uses 40 channels in the 2.4 GHz ISM band. It supports advertising (broadcast) and connection (point-to-point) modes. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'esc-exfiltration-olympics',related1_desc:'',related1_path:'../../55-escape-evasion/esc-exfiltration-olympics/index.html',related2_name:'Dead Drop — نقل رسائل BLE',related2_desc:'شفّر وتبادل رسائل سرية عبر محاكاة BLE',related2_path:'../../01-spy-microbit/bit-dead-drop/index.html',related3_name:'esc-stylometry-defeater',related3_desc:'',related3_path:'../../55-escape-evasion/esc-stylometry-defeater/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'صائد الترددات',pathPrev_path:'../../02-spy-esp32/esp-frequency-hunter/index.html',pathNext_name:'رادار حزم WiFi',pathNext_path:'../../02-spy-esp32/esp-packet-sniffer/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ما هي إخفاء المعلومات؟',quiz_q1a:'اتصال صاخب',quiz_q1b:'إخفاء رسائل داخل بيانات أخرى',quiz_q1c:'حذف ملفات',quiz_q1d:'بث إشارات',quiz_q1_answer:'1',quiz_q2:'على أي جهد يعمل ESP32؟',quiz_q2a:'5 فولت',quiz_q2b:'3.3 فولت',quiz_q2c:'1.8 فولت',quiz_q2d:'12 فولت',quiz_q2_answer:'1',quiz_q3:'ما إمكانيات ESP32 اللاسلكية؟',quiz_q3a:'واي فاي فقط',quiz_q3b:'بلوتوث فقط',quiz_q3c:'واي فاي وبلوتوث',quiz_q3d:'لا شيء',quiz_q3_answer:'2',quiz_q4:'ما هو التعلم الآلي؟',quiz_q4a:'برمجة الروبوتات',quiz_q4b:'أنظمة تتعلم من البيانات',quiz_q4c:'حساب يدوي',quiz_q4d:'تصميم العتاد',quiz_q4_answer:'1',quiz_q5:'ما هو صندوق البريد الميت؟',quiz_q5a:'اتصال فاشل',quiz_q5b:'موقع سري لتبادل الرسائل',quiz_q5c:'هوائي مكسور',quiz_q5d:'تردد فارغ',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'كشفت تسريبات سنودن عام 2013 أن برنامج بريزم التابع لوكالة الأمن القومي جمع البيانات مباشرة من خوادم جوجل وفيسبوك وآبل ومايكروسوفت.',realworld2:'أدى هجوم الفدية على خط أنابيب كولونيال (2021) إلى إغلاق أكبر خط أنابيب وقود في أمريكا لمدة 5 أيام بسبب كلمة مرور VPN واحدة مخترقة.',realworld3:'استعبد بوتنت ميراي (2016) أكثر من 600 ألف جهاز إنترنت الأشياء باستخدام 61 كلمة مرور افتراضية.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في اختراق إنترنت الأشياء معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في اختراق إنترنت الأشياء وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'👻 Ghost Beacon — Hidden BLE Messages يوضح مفهومًا أساسيًا في اختراق إنترنت الأشياء. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في 👻 Ghost Beacon — Hidden BLE Messages لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في اختراق إنترنت الأشياء هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ ESP32 وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال اختراق إنترنت الأشياء يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'استخدم التنقل بين القنوات (1، 6، 11) لمسح الواي فاي — هذه هي القنوات غير المتداخلة الوحيدة في نطاق 2.4 جيجاهرتز وتلتقط 90% من حركة المرور.',proTip2:'أضف مكثفًا بسعة 10 ميكروفاراد عبر دبابيس الطاقة في ESP32. يسبب إرسال الواي فاي ذروات تيار يمكن أن تتسبب في تعطل اللوحة.',funFactTitle:'🎯 هل تعلم؟',funFact:'عرض أول فيروس كمبيوتر Creeper عام 1971 رسالة على طرفيات ARPANET. وكُتب أول مضاد فيروسات Reaper خصيصًا لملاحقته وحذفه.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
/* ═══════ GHOST BEACON — BLE Simulation Engine ═══════ */
...
function textToHexBytes(text) {
 return Array.from(text).map(c => c.charCodeAt(0).toString(16).padStart(2, '0'));
}
function hexBytesToText(hexArr) {
...
// --- Encoding functions ---
function encodeUuidStego(msg) {
 const hex = textToHexBytes(msg).join('');
 const uuid = hex.padEnd(32, randHex(1)).slice(0, 32);
 return { uuid: formatUUID(uuid), major: randInt(1, 65535), minor: randInt(1, 65535), msgLen: msg.length };
}

function encodeMajorMinor(msg) {
 if (msg.length > 4) return null;
 const bytes = textToHexBytes(msg);
 while (bytes.length < 4) bytes.push('00');
 const major = (parseInt(bytes[0], 16) << 8) | parseInt(bytes[1], 16);
 const minor = (parseInt(bytes[2], 16) << 8) | parseInt(bytes[3], 16);
 return { uuid: formatUUID(randHex(32)), major, minor, msgLen: msg.length };
}

function encodeNamespace(msg) {
 if (msg.length > 10) return null;
 const hex = textToHexBytes(msg).join('');
 const ns = hex.padEnd(20, '0').slice(0, 20);
 const instance = randHex(12);
 return { namespace: ns, instance, msgLen: msg.length };
}

function encodeTxPower(msg) {
 // Encode first char as TX power offset pattern
 const hex = textToHexBytes(msg).join('');
 return { uuid: formatUUID(randHex(32)), major: randInt(1, 255), minor: randInt(1, 255), txPattern: hex, msgLen: msg.length };
}

// --- Decoding functions ---
function decodeBeacon(beacon) {
 if (!beacon || !beacon.encoding) return null;
 try {
 switch (beacon.encoding) {
 case 'uuid-stego': {
 const hex = beacon.uuid.replace(/-/g, '').slice(0, beacon.msgLen * 2);
 const bytes = [];
 for (let i = 0; i < hex.length; i += 2) bytes.push(hex.slice(i, i + 2));
 return hexBytesToText(bytes);
 }
 case 'major-minor': {
 const b0 = ((beacon.major >> 8) & 0xFF).toString(16).padStart(2, '0');
 const b1 = (beacon.major & 0xFF).toString(16).padStart(2, '0');
 const b2 = ((beacon.minor >> 8) & 0xFF).toString(16).padStart(2, '0');
 const b3 = (beacon.minor & 0xFF).toString(16).padStart(2, '0');
 const bytes = [b0, b1, b2, b3].slice(0, beacon.msgLen);
 return hexBytesToText(bytes);
 }
 case 'namespace': {
 const hex = beacon.namespace.slice(0, beacon.msgLen * 2);
 const bytes = [];
 for (let i = 0; i < hex.length; i += 2) bytes.push(hex.slice(i, i + 2));
 return hexBytesToText(bytes);
 }
 case 'txpower': {
 const hex = beacon.txPattern.slice(0, beacon.msgLen * 2);
 const bytes = [];
 for (let i = 0; i < hex.length; i += 2) bytes.push(hex.slice(i, i + 2));
 return hexBytesToText(bytes);
 }
...
// --- Generate random "ambient" beacons for realism ---
function generateAmbientBeacon() {
 const names = ['Office-Beacon', 'Entrance-BLE', 'Parking-Sensor', 'Room-Tracker', 'Asset-Tag', 'Temp-Monitor'];
 const name = names[randInt(0, names.length - 1)];
 const proto = Math.random() > 0.5 ? 'ibeacon' : 'eddystone';
 return {
 id: 'amb-' + randHex(6),
 name,
 protocol: proto,
 uuid: proto === 'ibeacon' ? formatUUID(randHex(32)) : null,
 namespace: proto === 'eddystone' ? randHex(20) : null,
 instance: proto === 'eddystone' ? randHex(12) : null,
 major: proto === 'ibeacon' ? randInt(1, 65535) : null,
 minor: proto === 'ibeacon' ? randInt(1, 65535) : null,
 rssi: randInt(-90, -40),
 txPower: randInt(-20, 0),
 encoding: null,
 msgLen: 0,
 isGhost: false,
 lastSeen: Date.now()
...
function startBroadcast() {
 ...
 if (!msg) { log(s.noMessage, 'error'); return; }

 const protocol = $('protocolSelect')?.value || 'ibeacon';
 const encoding = $('encodingSelect')?.value || 'uuid-stego';
 const txPow = parseInt($('txPowerSlider')?.value || '-12');

 let encoded;
 switch (encoding) {
 case 'uuid-stego': encoded = encodeUuidStego(msg); break;
 case 'major-minor':
 encoded = encodeMajorMinor(msg);
 if (!encoded) { log(s.msgTooLong + ' (max 4 chars)', 'error'); return; }
 break;
 case 'namespace':
 encoded = encodeNamespace(msg);
 if (!encoded) { log(s.msgTooLong + ' (max 10 chars)', 'error'); return; }
 break;
 case 'txpower': encoded = encodeTxPower(msg); break;
 default: encoded = encodeUuidStego(msg);
 }

 broadcastBeacon = {
 id: 'ghost-' + randHex(6),
 name: 'GHOST-' + randHex(4).toUpperCase(),
 protocol,
 uuid: encoded.uuid || null,
 namespace: encoded.namespace || null,
 instance: encoded.instance || null,
 major: encoded.major ?? null,
 minor: encoded.minor ?? null,
 txPattern: encoded.txPattern || null,
 rssi: txPow + randInt(-5, 5),
 txPower: txPow,
 encoding,
 msgLen: encoded.msgLen,
 isGhost: true,
 lastSeen: Date.now()
 };
 ...
 const stopBtn = $('stopBroadcastBtn');
 ...
 if (statusEl) statusEl.textContent = s.broadcasting;

 setStatus(true);

 // Log encoded data
 if (protocol === 'ibeacon') {
 log(`📡 TX iBeacon: UUID=${broadcastBeacon.uuid}`, 'tx');
 log(`📡 Major=${broadcastBeacon.major} Minor=${broadcastBeacon.minor} TxPow=${txPow}dBm`, 'tx');
 } else if (protocol === 'eddystone') {
 log(`📡 TX Eddystone-UID: NS=${broadcastBeacon.namespace}`, 'tx');
 log(`📡 Instance=${broadcastBeacon.instance} TxPow=${txPow}dBm`, 'tx');
 } else {
 log(`📡 TX Custom BLE ADV: ${encoding} TxPow=${txPow}dBm`, 'tx');
 }
 log(`🔐 ${s.encodedAs} ${encoding}: "${msg}" → hidden in beacon fields`, 'success');
 playSound('success');

 // Re-broadcast every 2 seconds (simulate)
 broadcastInterval = setInterval(() => {
 if (broadcastBeacon) {
 broadcastBeacon.rssi = txPow + randInt(-8, 3);
 broadcastBeacon.lastSeen = Date.now();
 }
 }, 2000);
}
...
function stopBroadcast() {
 ...
 const statusEl = $('broadcastStatus');
 if (statusEl) statusEl.textContent = LANG[currentLang].notBroadcasting;
 setStatus(false);
 log('⏹️ Broadcast stopped', 'info');
}

function showPulseAnimation(active) {
 for (let i = 1; i <= 3; i++) {
 const ring = $('pulseRing' + i);
 if (ring) ring.style.display = active ? 'block' : 'none';
 }
 if (active) animatePulse();
 else if (pulseAnimFrame) { cancelAnimationFrame(pulseAnimFrame); pulseAnimFrame = null; }
}
...
function animatePulse() {
 ...
 animation:ghostPulse ${1.5 + i * 0.5}s ease-out infinite;
 animation-delay:${i * 0.4}s;
 width:60px;height:60px;opacity:0;
 `;
 }
 // Inject keyframes if not already present
 if (!document.getElementById('ghostPulseStyle')) {
 const style = document.createElement('style');
 style.id = 'ghostPulseStyle';
 style.textContent = `
...
function startScan() {
 ...
 if (statusEl) statusEl.textContent = LANG[currentLang].scanning;

 log('🔍 Scanner started — listening for BLE advertisements...', 'info');

 // Discover beacons periodically
 let scanCount = 0;
 scanInterval = setInterval(() => {
 if (!isScanning) return;

 // Add ambient beacons (first few cycles)
 if (scanCount < 4 && Math.random() > 0.3) {
 const amb = generateAmbientBeacon();
 detectedBeacons.push(amb);
 log(`📶 ${LANG[currentLang].beaconDetected}: ${amb.name} [RSSI: ${amb.rssi} dBm]`, 'rx');
 playSound('click');
 }

 // Detect our ghost beacon if broadcasting
 if (broadcastBeacon && scanCount >= 1) {
 const exists = detectedBeacons.find(b => b.id === broadcastBeacon.id);
 if (!exists) {
 detectedBeacons.push({ ...broadcastBeacon });
 log(`👻 ${LANG[currentLang].beaconDetected}: ${broadcastBeacon.name} [RSSI: ${broadcastBeacon.rssi} dBm] ⚠️`, 'rx');
 playSound('success');
 } else {
 exists.rssi = broadcastBeacon.rssi;
 exists.lastSeen = Date.now();
 }
 }

 // Update RSSI for all beacons (simulate fluctuation)
 detectedBeacons.forEach(b => {
 if (!b.isGhost) b.rssi = b.rssi + randInt(-3, 3);
 });
...
function stopScan() {
 ...
 const statusEl = $('scanStatus');
 if (statusEl) statusEl.textContent = LANG[currentLang].scanIdle;

 log('⏹️ Scanner stopped', 'info');
}
...
function updateBeaconList() {
 ...
 list.innerHTML = '<div style="opacity:0.5;text-align:center;padding:1rem">No beacons detected yet...</div>';
 return;
 }
 list.innerHTML = detectedBeacons.map(b => {
 const rssiColor = b.rssi > -50 ? '#44ff44' : b.rssi > -70 ? '#ffaa00' : '#ff4444';
 const ghostTag = b.isGhost ? ' <span style="color:#ff66ff">👻</span>' : '';
 const proto = b.protocol === 'ibeacon' ? '🍎 iBeacon' : b.protocol === 'eddystone' ? '📍 Eddystone' : '📦 Custom';
 const uid = b.uuid ? b.uuid.slice(0, 18) + '...' : (b.namespace ? b.namespace.slice(0, 12) + '...' : 'N/A');
 const age = Math.round((Date.now() - b.lastSeen) / 1000);
 return `<div style="padding:0.5rem;margin:0.25rem 0;border-radius:6px;background:rgba(0,0,0,0.2);border-left:3px solid ${rssiColor}">
 <div style="display:flex;justify-content:space-between;align-items:center">
 <strong>${b.name}${ghostTag}</strong>
 <span style="color:${rssiColor};font-family:'Orbitron',monospace;font-size:0.75rem">${b.rssi} dBm</span>
 </div>
 <div style="font-size:0.72rem;opacity:0.7;margin-top:2px">${proto} | ${uid} | ${age}s ago</div>
 </div>`;
 }).join('');
}

function updateDecodeSelect() {
 const sel = $('decodeBeaconSelect');
 const decBtn = $('decodeBtn');
 if (!sel) return;
 const ghostBeacons = detectedBeacons.filter(b => b.isGhost);
 const prev = sel.value;
 sel.innerHTML = `<option value="">${LANG[currentLang].noBeacons}</option>`;
 detectedBeacons.forEach(b => {
 const opt = document.createElement('option');
 opt.value = b.id;
 opt.textContent = `${b.name} [${b.rssi} dBm]${b.isGhost ? ' 👻' : ''}`;
 sel.appendChild(opt);
 });
 if (prev) sel.value = prev;
 if (decBtn) decBtn.disabled = detectedBeacons.length === 0;
}

function decodeSelectedBeacon() {
 const sel = $('decodeBeaconSelect');
 const output = $('decodedOutput');
 if (!sel || !output) return;
 const beacon = detectedBeacons.find(b => b.id === sel.value);
 output.style.display = 'block';

 if (!beacon) {
 output.textContent = 'No beacon selected';
 output.style.color = '#ff6666';
 return;
 }

 if (!beacon.encoding) {
 output.textContent = 'Standard beacon — no hidden message detected';
 output.style.color = '#ffaa00';
 log(`🔓 Analyzed ${beacon.name}: no steganographic content found`, 'info');
 return;
 }

 const decoded = decodeBeacon(beacon);
 if (decoded) {
 output.innerHTML = `<span style="color:#44ff44">✅ ${LANG[currentLang].decodedMsg}:</span><br><span style="font-size:1.1rem;color:#ffffff">"${decoded}"</span><br><span style="font-size:0.7rem;opacity:0.6">Method: ${beacon.encoding} | Protocol: ${beacon.protocol}</span>`;
 log(`🔓 ${LANG[currentLang].decodedMsg}: "${decoded}" (via ${beacon.encoding})`, 'success');
 playSound('success');
 } else {
 output.textContent = 'Decoding failed — corrupted or unknown encoding';
 output.style.color = '#ff6666';
 log('🔓 Decode failed', 'error');
 }
}

// --- Lab: RSSI Distance Estimator ---
function calcDistance(rssi, txPower, n) {
 if (rssi === 0) return -1;
 return Math.pow(10, (txPower - rssi) / (10 * n));
}

function updateDistanceEstimator() {
 const rssi = parseInt($('labRssiSlider')?.value || '-65');
 const ref = parseInt($('labRefPowerSlider')?.value || '-59');
 const n = 2.5; // path loss exponent
 const dist = calcDistance(rssi, ref, n);

 const rv = $('labRssiValue');
 const rp = $('labRefPowerValue');
 const dv = $('distValue');
 const dz = $('distZone');
 if (rv) rv.textContent = rssi + ' dBm';
 if (rp) rp.textContent = ref + ' dBm';

 const s = LANG[currentLang];
 if (dv) dv.textContent = dist < 0 ? '—' : dist.toFixed(2) + ' m';
 if (dz) {
 if (dist < 0.5) dz.textContent = s.zoneImmediate;
 else if (dist < 3) dz.textContent = s.zoneNear;
 else if (dist < 20) dz.textContent = s.zoneFar;
 else dz.textContent = s.zoneUnknown;
 }
}

// --- Lab: Packet Builder ---
function buildPacket() {
 const type = $('packetTypeSelect')?.value || 'ibeacon';
 const display = $('packetDisplay');
 const legend = $('packetLegend');
 ...
 const preamble = ['02','01','06']; // Flags
 const header = ['1A','FF','4C','00','02','15']; // Apple iBeacon prefix
 const uuid = Array.from({length:16}, () => randHex(2));
 const major = [randHex(2), randHex(2)];
 const minor = [randHex(2), randHex(2)];
 const tx = [(-59 + 256).toString(16).slice(-2)]; // TX Power

 bytes = [...preamble, ...header, ...uuid, ...major, ...minor, ...tx];
 colors = [
 ...preamble.map(() => '#4488ff'),
 ...header.map(() => '#ff8844'),
 ...uuid.map(() => '#44ff88'),
 ...
 labels = [
 {color:'#4488ff', text:'Flags (3B)'}, {color:'#ff8844', text:'Apple iBeacon Header (6B)'},
 {color:'#44ff88', text:'UUID (16B)'}, {color:'#ffff44', text:'Major (2B)'},
 {color:'#ff44ff', text:'Minor (2B)'}, {color:'#ff4444', text:'TX Power (1B)'}
 ];
 } else if (type === 'eddystone-uid') {
 const preamble = ['02','01','06'];
 const svcData = ['03','03','AA','FE']; // Eddystone service UUID
 const frameHdr = ['15','16','AA','FE','00']; // UID frame
 const txPow = ['EE'];
 const ns = Array.from({length:10}, () => randHex(2));
 const inst = Array.from({length:6}, () => randHex(2));
 const rfu = ['00','00'];

 bytes = [...preamble, ...svcData, ...frameHdr, ...txPow, ...ns, ...inst, ...rfu];
 colors = [
 ...preamble.map(() => '#4488ff'),
 ...svcData.map(() => '#ff8844'),
 ...frameHdr.map(() => '#ff8844'),
 ...
 labels = [
 {color:'#4488ff', text:'Flags (3B)'}, {color:'#ff8844', text:'Eddystone Header (9B)'},
 {color:'#ff4444', text:'TX Power (1B)'}, {color:'#44ff88', text:'Namespace (10B)'},
 {color:'#ffff44', text:'Instance (6B)'}, {color:'#888888', text:'RFU (2B)'}
 ];
 } else { // eddystone-url
 const preamble = ['02','01','06'];
 const svcData = ['03','03','AA','FE'];
 const frameHdr = ['0E','16','AA','FE','10']; // URL frame
 const txPow = ['EE'];
 const scheme = ['03']; // https://
 const url = textToHexBytes('workshop').map(b => b.toUpperCase());
 const suffix = ['01']; // .com/

 bytes = [...preamble, ...svcData, ...frameHdr, ...txPow, ...scheme, ...url, ...suffix];
 colors = [
 ...preamble.map(() => '#4488ff'),
 ...svcData.map(() => '#ff8844'),
 ...frameHdr.map(() => '#ff8844'),
 ...
 labels = [
 {color:'#4488ff', text:'Flags (3B)'}, {color:'#ff8844', text:'Eddystone Header (9B)'},
 {color:'#ff4444', text:'TX Power (1B)'}, {color:'#44ffff', text:'URL Scheme (1B)'},
 {color:'#44ff88', text:'URL Data'}, {color:'#44ffff', text:'URL Suffix (1B)'}
 ];
 }

 display.innerHTML = bytes.map((b, i) =>
 `<span style="background:${colors[i]}33;color:${colors[i]};padding:2px 4px;border-radius:3px;margin:1px;display:inline-block">${b.toUpperCase()}</span>`
 ).join('');

 legend.innerHTML = labels.map(l =>
 `<span style="display:inline-block;margin:2px 6px 2px 0"><span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${l.color};margin-right:3px;vertical-align:middle"></span>${l.text}</span>`
 ).join('');

 log(`🧬 Built ${type} packet: ${bytes.length} bytes`, 'success');
 playSound('click');
}
...
function startRadar() {
 radarRunning = true;
 radarBeacons = [];
 // Generate 5-8 simulated beacons
 const count = randInt(5, 8);
 for (let i = 0; i < count; i++) {
 radarBeacons.push({
 name: (i === 0 && broadcastBeacon) ? broadcastBeacon.name : 'B-' + randHex(3).toUpperCase(),
 angle: Math.random() * Math.PI * 2,
 dist: 0.1 + Math.random() * 0.85, // 0-1 normalized
 rssi: randInt(-85, -35),
 isGhost: i === 0 && !!broadcastBeacon,
 drift: (Math.random() - 0.5) * 0.002
 });
 }

 $('radarStartBtn') && ($('radarStartBtn').disabled = true);
 $('radarStopBtn') && ($('radarStopBtn').disabled = false);
 $('radarInfo') && ($('radarInfo').textContent = `${count} beacons detected`);

 log('📡 Radar started', 'info');
 drawRadar();
}
...
function stopRadar() {
 ...
 $('radarStartBtn') && ($('radarStartBtn').disabled = false);
 $('radarStopBtn') && ($('radarStopBtn').disabled = true);
 $('radarInfo') && ($('radarInfo').textContent = LANG[currentLang].radarIdle);
 log('📡 Radar stopped', 'info');
}
...
function drawRadar() {
 ...
 // Draw beacons
 radarBeacons.forEach(b => {
 b.angle += b.drift;
 const bx = cx + Math.cos(b.angle) * b.dist * r;
 const by = cy + Math.sin(b.angle) * b.dist * r;
 const color = b.isGhost ? '#ff66ff' : accent;
 const sz = b.isGhost ? 6 : 4;
 ...
 ctx.fillText(b.name, bx + 8, by - 4);
 ctx.fillStyle = '#aaa';
 ctx.font = '7px Orbitron, monospace';
 ctx.fillText(`${b.rssi}dBm`, bx + 8, by + 6);
 });
...
// --- Challenges ---
let ch1Active = false, ch2Active = false, ch3Active = false;
let ch2Distance = 15;
let ch3FakeId = '';

function startChallenge1() {
 ch1Active = true;
 const secret = ['GHOST','HAUNT','BLINK','PHANTOM','SHADE'][randInt(0,4)];
 const ghostB = {
 id: 'ch1-ghost',
 name: 'MYSTERY-BEACON',
 protocol: 'ibeacon',
 uuid: formatUUID(textToHexBytes(secret).join('').padEnd(32, '0')),
 namespace: null, instance: null,
 major: randInt(100, 999), minor: randInt(100, 999),
 rssi: randInt(-70, -45),
 txPower: -12,
 encoding: 'uuid-stego',
 msgLen: secret.length,
 isGhost: true,
 lastSeen: Date.now(),
 _secret: secret
 };

 // Add to detected beacons
 detectedBeacons = detectedBeacons.filter(b => b.id !== 'ch1-ghost');
 detectedBeacons.push(ghostB);
 updateBeaconList();
 updateDecodeSelect();

 $('ch1Status') && ($('ch1Status').style.display = 'block');
 $('ch1Status') && ($('ch1Status').innerHTML = '👻 A mystery beacon appeared! Select it in the decoder above and decode its message. Then enter the secret word below.');
 $('ch1Answer') && ($('ch1Answer').style.display = 'block');
 $('ch1SubmitBtn') && ($('ch1SubmitBtn').style.display = 'inline-block');
 $('ch1Result') && ($('ch1Result').style.display = 'none');

 log('🏅 Challenge 1 started — find and decode the ghost beacon!', 'info');

 const submitBtn = $('ch1SubmitBtn');
 if (submitBtn) submitBtn.onclick = () => {
 const answer = $('ch1Answer')?.value.trim().toUpperCase();
 const res = $('ch1Result');
 if (!res) return;
 res.style.display = 'block';
 if (answer === secret) {
 res.style.color = '#44ff44';
 res.textContent = '✅ ' + LANG[currentLang].challengeComplete + ' The word was: ' + secret;
 log('🏅 Challenge 1 PASSED!', 'success');
 playSound('success');
 } else {
 res.style.color = '#ff6666';
 res.textContent = '❌ ' + LANG[currentLang].challengeFailed;
 log('🏅 Challenge 1 failed — try again', 'error');
 }
 };
}
...
function startChallenge2() {
 ch2Active = true;
 ch2Distance = 12 + Math.random() * 8; // 12-20m away
 const secret = 'NEAR-FIELD-OK';

 $('ch2Proximity') && ($('ch2Proximity').style.display = 'block');
 $('ch2Result') && ($('ch2Result').style.display = 'none');
 updateCh2UI();

 log('🏅 Challenge 2 started — walk closer to reveal the message!', 'info');

 const walkBtn = $('ch2WalkBtn');
 if (walkBtn) walkBtn.onclick = () => {
 if (ch2Distance > 0.5) {
 ch2Distance -= (1 + Math.random() * 2);
 if (ch2Distance < 0.3) ch2Distance = 0.3;
 }
 updateCh2UI();
 ...
 res.style.display = 'block';
 res.style.color = '#44ff44';
 res.innerHTML = `✅ ${LANG[currentLang].challengeComplete}<br>🔓 Hidden message: "${secret}"`;
 }
 log(`🏅 Challenge 2 PASSED! Message revealed: "${secret}"`, 'success');
 playSound('success');
 ch2Active = false;
 }
 };
...
function updateCh2UI() {
 const bar = $('ch2ProxBar');
 const label = $('ch2DistLabel');
 if (bar) bar.style.width = Math.max(5, (1 - ch2Distance / 20) * 100) + '%';
 if (label) label.textContent = ch2Distance.toFixed(1) + ' m';
}

function startChallenge3() {
 ch3Active = true;
 const list = $('ch3BeaconList');
 const sel = $('ch3SuspectSelect');
 const submitBtn = $('ch3SubmitBtn');
 if (!list || !sel) return;

 list.style.display = 'block';
 sel.style.display = 'block';
 if (submitBtn) submitBtn.style.display = 'inline-block';
 $('ch3Result') && ($('ch3Result').style.display = 'none');

 // Generate beacons: 4 legit + 1 fake
 const legit = [];
 for (let i = 0; i < 4; i++) {
 legit.push({
 id: 'ch3-legit-' + i,
 name: ['Office-Temp','Door-Sensor','Asset-' + randInt(10,99),'Room-' + randInt(100,999)][i],
 uuid: formatUUID(randHex(32)),
 interval: randInt(900, 1100) + 'ms',
 rssi: randInt(-75, -55),
 suspicious: false
 });
 }
 ch3FakeId = 'ch3-fake-0';
 const fake = {
 id: ch3FakeId,
 name: 'Beacon-' + randHex(2).toUpperCase(),
 uuid: formatUUID('00'.repeat(12) + randHex(8)), // suspicious: lots of zeros
 interval: randInt(50, 150) + 'ms', // abnormally fast
 rssi: randInt(-30, -20), // abnormally strong
 suspicious: true
 };
 const all = [...legit, fake].sort(() => Math.random() - 0.5);

 list.innerHTML = all.map(b => {
 const intMs = parseInt(b.interval);
 const warn = intMs < 200 ? ' ⚡' : '';
 const rssiWarn = b.rssi > -40 ? ' 📶' : '';
 return `<div style="padding:0.4rem;margin:0.2rem 0;border-radius:4px;background:rgba(0,0,0,0.2);font-size:0.76rem">
 <strong>${b.name}</strong>${warn}${rssiWarn}<br>
 UUID: ${b.uuid.slice(0,23)}...<br>
 Interval: ${b.interval} | RSSI: ${b.rssi} dBm
 </div>`;
 }).join('');

 sel.innerHTML = `<option value="">${LANG[currentLang].selectSuspect}</option>`;
 all.forEach(b => {
 const opt = document.createElement('option');
 opt.value = b.id;
 ...
 log('🏅 Challenge 3 started — find the fake beacon!', 'info');
 ...
 if (chosen === ch3FakeId) {
 res.style.color = '#44ff44';
 res.textContent = '✅ ' + LANG[currentLang].challengeComplete + ' You identified the flood beacon!';
 log('🏅 Challenge 3 PASSED! Fake beacon identified.', 'success');
 playSound('success');
 } else {
 res.style.color = '#ff6666';
 res.textContent = '❌ ' + LANG[currentLang].challengeFailed + ' Hint: look for abnormal interval and RSSI.';
 log('🏅 Challenge 3 failed — check interval and signal strength', 'error');
 }
 };
}

// --- Ghost Beacon App Init ---
function initGhostBeacon() {
 // Broadcaster
 const encBtn = $('encodeBtn');
 const stopBcastBtn = $('stopBroadcastBtn');
 if (encBtn) encBtn.onclick = startBroadcast;
 if (stopBcastBtn) stopBcastBtn.onclick = stopBroadcast;

 // TX Power slider
 const txSlider = $('txPowerSlider');
 if (txSlider) txSlider.oninput = () => {
 const v = $('txPowerValue');
 if (v) v.textContent = txSlider.value + ' dBm';
 };
 ...
 if (stopScanBtn) stopScanBtn.onclick = stopScan;
 if (clearScanBtn) clearScanBtn.onclick = clearScan;

 // Decoder
 const decBtn = $('decodeBtn');
 if (decBtn) decBtn.onclick = decodeSelectedBeacon;

 // Lab: RSSI Distance
 const rssiSlider = $('labRssiSlider');
 const refSlider = $('labRefPowerSlider');
 if (rssiSlider) rssiSlider.oninput = updateDistanceEstimator;
 if (refSlider) refSlider.oninput = updateDistanceEstimator;
 updateDistanceEstimator();

 // Lab: Packet Builder
 const buildBtn = $('buildPacketBtn');
 if (buildBtn) buildBtn.onclick = buildPacket;

 // Lab: Radar
 const radarStart = $('radarStartBtn');
 const radarStop = $('radarStopBtn');
 if (radarStart) radarStart.onclick = startRadar;
 if (radarStop) radarStop.onclick = stopRadar;

 // Challenges
 const ch1Btn = $('ch1StartBtn');
 const ch2Btn = $('ch2StartBtn');
 const ch3Btn = $('ch3StartBtn');
 if (ch1Btn) ch1Btn.onclick = startChallenge1;
 if (ch2Btn) ch2Btn.onclick = startChallenge2;
 if (ch3Btn) ch3Btn.onclick = startChallenge3;
}
