...
const LANG = {
 ...
 wiki_deauth_title: '\uD83D\uDEE1\uFE0F Deauth Attacks', wiki_deauth: 'Deauthentication frames are part of IEEE 802.11 management. Attackers exploit unprotected management frames to forcibly disconnect clients.',
 wiki_esp32_title: '\uD83D\uDCBB ESP32 Detection', wiki_esp32: 'The ESP32 WiFi chip supports promiscuous mode, capturing all frames on a channel. Firmware filters for type 0xC0 (deauth) and 0xA0 (disassoc).',
 wiki_defense_title: '\uD83D\uDD12 Defense Strategies', wiki_defense: 'Enable 802.11w (PMF) or upgrade to WPA3. Use channel hopping, MAC randomization, and deploy IDS sensors.',
 ...
 ready: '\uD83D\uDEE1\uFE0F WiFi Jammer Detector ready!',
 ...
 themeChanged: '\uD83C\uDFA8 Theme \u2192',
 threatSafe: 'SAFE', threatSafeDesc: 'No deauth packets detected',
 threatWarning: 'WARNING', threatWarningDesc: 'Suspicious deauth activity detected',
 threatAttack: 'ATTACK', threatAttackDesc: 'Deauth flood detected!',
 deauthPackets: 'Deauth Packets', pktPerSec: 'Pkts/sec',
 attacksDetected: 'Attacks Detected', monitorUptime: 'Uptime',
 attackTimeline: 'Attack Timeline (last 60s)', alertLog: 'Alert Log',
 noAlerts: 'No alerts yet. Start monitoring to begin.',
 attackSources: 'Attack Sources Identified', noSources: 'No sources identified',
 startMonitor: 'Start Monitor', stopMonitor: 'Stop Monitor',
 simAttack: 'Simulate Attack', resetMonitor: 'Reset',
 scanDesc: 'Scan nearby WiFi networks and monitor their security status.',
 scanNetworks: 'Scan Networks', noNetworks: 'Click scan to discover nearby networks',
 defenseDesc: 'Configure defensive measures against deauth attacks.',
 channelHop: 'Auto Channel Hopping', macRandom: 'MAC Randomization',
 alertThreshold: 'Alert Threshold (pkts/s)', autoLog: 'Auto-Log Attacks',
 exportReport: 'Export Security Report',
 learnDesc: 'Learn about WiFi security, deauth attacks, and intrusion detection.',
 learn_q1: 'What is a deauthentication attack?',
 learn_a1: 'A deauth attack sends forged IEEE 802.11 deauthentication frames to disconnect clients from a WiFi network. The attacker spoofs the AP MAC address, making the client believe the AP is asking it to disconnect.',
 learn_q2: 'How does a WiFi jammer work?',
 learn_a2: 'A WiFi jammer floods the 2.4GHz/5GHz spectrum with noise or deauth frames. Deauth-based jammers exploit the IEEE 802.11 protocol weakness where management frames lack authentication.',
 learn_q3: 'How can I protect my network?',
 learn_a3: '1) Use WPA3 with Protected Management Frames (PMF). 2) Enable PMF on your router. 3) Monitor for deauth floods. 4) Use wired connections for critical devices. 5) Deploy an IDS.',
 learn_q4: 'What is 802.11w (PMF)?',
 learn_a4: 'IEEE 802.11w adds protection to management frames. With PMF enabled, deauth and disassoc frames are authenticated, preventing forgery. WPA3 makes PMF mandatory.',
 learn_q5: 'How does the ESP32 detect attacks?',
 learn_a5: 'The ESP32 supports promiscuous mode, capturing all WiFi frames. Firmware filters for type 0xC0 (deauth) and 0xA0 (disassoc). When rate exceeds threshold, it triggers an alert.',
 learn_q6: 'Is this legal?',
 learn_a6: 'Monitoring your own network is legal in most jurisdictions. This tool is purely defensive. Sending deauth frames to disrupt others is illegal. Always use security tools responsibly.',
 monitorStarted: '\uD83D\uDCE1 Monitor started \u2014 scanning for deauth packets...',
 monitorStopped: '\uD83D\uDCE1 Monitor stopped',
 attackSimulated: '\u26A0\uFE0F Simulating deauth flood attack!',
 monitorReset: '\uD83D\uDD04 Monitor reset',
 attackDetected: '\uD83D\uDEA8 ATTACK DETECTED',
 warningDetected: '\u26A0\uFE0F Suspicious activity',
 networkScan: '\uD83D\uDD0D Scanning networks...',
 scanComplete: '\uD83D\uDD0D Scan complete',
 reportExported: '\uD83D\uDCCA Security report exported',step1Title:'Configure',step1Desc:'Set up the simulation parameters and choose your encryption method. Watch the visualization update in real time as this stage processes. The display shows exactly what is happening internally — each color and movement represents a specific data transformation.',step2Title:'Process',step2Desc:'The data is processed through the chosen algorithm or technique. Notice how the indicators change during this phase. The activity log records every event, letting you trace the exact sequence of operations and verify the results.',step3Title:'Transmit',step3Desc:'The processed signal or message is sent through the communication channel. This stage transforms the input data using the algorithm shown in the visualization. Compare the before and after values to understand the mathematical relationship.',step4Title:'Verify',step4Desc:'The receiver decodes, verifies, and validates the received data. The output of this stage feeds into the next one. Try pausing here to examine the intermediate state — understanding each step separately builds deeper insight.',sectionCode:'Device Code',faq_q1:'What is WiFi Jammer Detector?',faq_a1:'Wifi Jammer Detector is an interactive simulation that demonstrates covert operations concepts. Real-time WiFi deauthentication attack detection. Everything runs in your browser — no hardware or installation needed. Adjust the controls, observe the results, and build real understanding through experimentation.',faq_q2:'How does the simulation work?',faq_a2:'The simulation models real covert operations behavior in your browser. You control the inputs using sliders and buttons, and the visualization updates in real time to show you the results.',faq_q3:'What do the controls do?',faq_a3:'Click "Start Monitor" to begin real-time deauth packet monitoring. Each button and slider changes a specific parameter. Hover over controls to see tooltips, and check the How-To tab for a step-by-step walkthrough.',faq_q4:'What is the science behind this?',faq_a4:'\u0625\u0637\u0627\u0631\u0627\u062A \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u0645\u0635\u0627\u062F\u0642\u0629 \u062C\u0632\u0621 \u0645\u0646 \u0625\u062F\u0627\u0631\u0629 IEEE 802.11. \u064A\u0633\u062A\u063A\u0644 \u0627\u0644\u0645\u0647\u0627\u062C\u0645\u0648\u0646 \u0625\u0637\u0627\u0631\u0627\u062A \u0627\u0644\u0625\u062F\u0627\u0631\u0629 \u063A\u064A\u0631 \u0627\u0644\u0645\u062D\u0645\u064A\u0629.',faq_q5:'What should I experiment with?',faq_a5:'Try changing one parameter at a time and observe the effect. Push values to extremes to see what breaks — that teaches you the limits of the system.',faq_q6:'What hardware do I need for the real version?',faq_a6:'The simulation needs no hardware. To build the real project, you need ESP32. See the Device Code section for firmware and wiring instructions.',faq_q7:'Is my data private?',faq_a7:'Yes. Everything runs locally in your browser. No data is sent anywhere, no account is needed, and it works completely offline.',faq_q8:'What should I explore next?',faq_a8:'Try Esp Dark Net Radio and Esp Dead Zone. Each app in this category teaches a different aspect of covert operations. Try systematically: set all controls to their defaults, then change one variable at a time. Record what happens at minimum, midpoint, and maximum values. This methodical approach is exactly how researchers and engineers characterize real systems.',demo_s1:'Welcome to WiFi Jammer Detector! Look at the main display — this is where the covert operations simulation runs.',demo_s2:'Click "Start Monitor" to begin real-time deauth packet monitoring. Watch how the visualization reacts.',demo_s3:'Try adjusting the controls. Each slider or button changes a specific parameter of the simulation.',demo_s4:'Scroll down to see "Network Scanner" for detailed data. The numbers and charts update as the simulation runs.',demo_s5:'Great job! Now try the challenges section to test your understanding of covert operations.',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Cryptography',learn1Desc:'How secret codes protect messages from spies. Watch the simulation to see this happen in real time. The visualization makes the invisible visible.',learn1Tag:'Cybersecurity',learn2Title:'Wireless Communication',learn2Desc:'How devices send invisible signals through the air. The controls let you experiment with different conditions. Each change reveals how this principle responds.',learn2Tag:'Wireless',learn3Title:'OPSEC',learn3Desc:'How to keep your operations secret and secure. Try the challenges section to test your understanding. Real engineers use these same concepts daily.',learn3Tag:'Security',learn4Title:'Math in Security',learn4Desc:'How numbers and algorithms make unbreakable codes. Compare results with different settings to build intuition. The data panels show precise measurements.',learn4Tag:'Math',sectionLearn:'What You Shall Learn',learnLevelVal:'Beginner 🟢',learnLevel:'Level:',learnTimeVal:'15 min ⏱',learnTime:'Time:',learnAgeVal:'10+ 🧒',kidTitle:'For Young Explorers',kidIntro:'Welcome to Wifi Jammer Detector! This is like a science experiment on your computer. You get to control a real covert operations simulation — press buttons, move sliders, and watch what happens on screen. Try changing the controls and watch how Set up the simulation parameters and choose your e Nothing can break — it is all just a simulation running safely in your browser!',kidSafe:'Completely safe! Nothing you do here can break anything. It all runs inside your browser like a game.',kidTry:'Press the big Start button and watch the screen change. Then try moving sliders to see what they do.',kidParent:'This app teaches covert operations concepts through hands-on simulation. Suitable for STEM education in physics, electronics, and computer science.',ch1Title:'Encrypt & Decode',ch1Desc:'Encrypt a message using the built-in cipher, then try to decode it manually without looking at the key. What patterns can you spot in the ciphertext?',ch2Title:'Stealth Test',ch2Desc:'Try to complete the mission with the lowest possible signal footprint. Can you reduce emissions below the detection threshold?',ch3Title:'Interception Race',ch3Desc:'Start a transmission and see how quickly you can intercept it from the other side. What affects the detection time?',codeTitle:'Starter Code',codeLang:'Arduino (ESP32)',codeSnippet:'#include <WiFi.h>\\n\\nconst char* ssid = "MyNetwork";\\nconst char* pass = "secret123";\\n\\nvoid setup() {\\n Serial.begin(115200);\\n WiFi.mode(WIFI_STA);\\n WiFi.begin(ssid, pass);\\n while (WiFi.status() != WL_CONNECTED) {\\n delay(500);\\n Serial.print(".");\\n }\\n Serial.println("\\nConnected!");\\n Serial.println(WiFi.localIP());\\n}\\n\\nvoid loop() {\\n // Your code here\\n}',codeExplain:'This Arduino sketch connects the ESP32 to a WiFi network. WiFi.mode(WIFI_STA) sets it as a client (station mode). The while loop waits until connected, then prints the IP address. From here you can add HTTP servers, MQTT, UDP packets, or BLE scanning.',purpose:'WiFi Jammer Detector: Real-time WiFi deauthentication attack detection. This simulation lets you experiment hands-on instead of just reading theory. Every parameter you change produces visible results, building real intuition for how the system behaves. The workflow goes from Configure through Process to Transmit and Verify.',guideTitle:'What Am I Looking At?',guideCanvas:'The main area shows a live visualization of the simulation. Colors and movement represent data changing in real time.',guideControls:'The buttons below the main display control the simulation. Start begins it, Stop pauses it, Reset clears everything.',guideSections:'Below the main card, "Network Scanner" and "Defense Toolkit" show detailed data and analysis. Click the section headers to expand or collapse them.',guideStatus:'The colored dot in the top-right corner shows the connection status. Green means running, red means stopped.',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'esc-exfiltration-olympics',related1_desc:'',related1_path:'../../55-escape-evasion/esc-exfiltration-olympics/index.html',related2_name:'esc-burner-identity-gen',related2_desc:'',related2_path:'../../55-escape-evasion/esc-burner-identity-gen/index.html',related3_name:'Wrist Communicator — Tap Code',related3_desc:'Send secret messages through tap patterns',related3_path:'../../40-agent-microbit/bit-wrist-communicator/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Vault Control',pathPrev_path:'../../02-spy-esp32/esp-vault/index.html',pathNext_name:'',pathNext_path:'',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 gloss4_term: 'Management Frame',
 gloss4_def: 'WiFi frames used for network management: beacons, probes, authentication, association. Unlike data frames, many management frames are not encrypted.',
 gloss5_term: 'Latency',
 ...
 wiki_deauth_title: '\uD83D\uDEE1\uFE0F Attaques Deauth', wiki_deauth: 'Les trames de d\u00e9sauthentification font partie de la gestion IEEE 802.11. Les attaquants exploitent les trames de gestion non prot\u00e9g\u00e9es.',
 wiki_esp32_title: '\uD83D\uDCBB D\u00e9tection ESP32', wiki_esp32: 'La puce WiFi ESP32 supporte le mode promiscuous, capturant toutes les trames sur un canal.',
 wiki_defense_title: '\uD83D\uDD12 Strat\u00e9gies de D\u00e9fense', wiki_defense: 'Activez 802.11w (PMF) ou passez au WPA3. Utilisez le saut de canal et le MAC al\u00e9atoire.',
 ...
 ready: '\uD83D\uDEE1\uFE0F D\u00e9tecteur WiFi Jammer pr\u00eat !',
 ...
 mainSection: '\u0645\u0631\u0627\u0642\u0628 Deauth', mainDesc: '\u0643\u0634\u0641 \u0647\u062C\u0645\u0627\u062A \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u0645\u0635\u0627\u062F\u0642\u0629 \u0641\u064A \u0627\u0644\u0648\u0642\u062A \u0627\u0644\u0641\u0639\u0644\u064A',
 sectionA: '\u0645\u0627\u0633\u062D \u0627\u0644\u0634\u0628\u0643\u0627\u062A', sectionB: '\u0623\u062F\u0648\u0627\u062A \u0627\u0644\u062F\u0641\u0627\u0639', sectionC: '\u0645\u062E\u062A\u0628\u0631 \u0627\u0644\u062A\u0639\u0644\u0645',
 activityLog: '\u0633\u062C\u0644 \u0627\u0644\u0646\u0634\u0627\u0637', eventsMsg: '\u0627\u0644\u0623\u062D\u062F\u0627\u062B \u0648\u0627\u0644\u0631\u0633\u0627\u0626\u0644',
 clear: '\u0645\u0633\u062D', copy: '\u0646\u0633\u062E', theme: '\u0627\u0644\u0645\u0638\u0647\u0631',
 settings: '\u2699\uFE0F \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A', language: '\u0627\u0644\u0644\u063A\u0629',
 helpSettings: '\u2753 \u0645\u0633\u0627\u0639\u062F\u0629 \u0648\u0625\u0639\u062F\u0627\u062F\u0627\u062A', settingsTab: '\u2699\uFE0F',
 help: '\u2753 \u0645\u0633\u0627\u0639\u062F\u0629', faq: '\u0623\u0633\u0626\u0644\u0629 \u0634\u0627\u0626\u0639\u0629', howto: '\u0643\u064A\u0641 \u062A\u0633\u062A\u062E\u062F\u0645', wiki: '\u0648\u064A\u0643\u064A',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Wifi Jammer Detector. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Set up the simulation parameters and choose your encryption ',
 ...
 wiki_deauth_title: '\uD83D\uDEE1\uFE0F \u0647\u062C\u0645\u0627\u062A Deauth', wiki_deauth: '\u0625\u0637\u0627\u0631\u0627\u062A \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u0645\u0635\u0627\u062F\u0642\u0629 \u062C\u0632\u0621 \u0645\u0646 \u0625\u062F\u0627\u0631\u0629 IEEE 802.11. \u064A\u0633\u062A\u063A\u0644 \u0627\u0644\u0645\u0647\u0627\u062C\u0645\u0648\u0646 \u0625\u0637\u0627\u0631\u0627\u062A \u0627\u0644\u0625\u062F\u0627\u0631\u0629 \u063A\u064A\u0631 \u0627\u0644\u0645\u062D\u0645\u064A\u0629.',
 wiki_esp32_title: '\uD83D\uDCBB \u0643\u0634\u0641 ESP32', wiki_esp32: '\u0634\u0631\u064A\u062D\u0629 ESP32 \u062A\u062F\u0639\u0645 \u0648\u0636\u0639 promiscuous \u0644\u0627\u0644\u062A\u0642\u0627\u0637 \u062C\u0645\u064A\u0639 \u0627\u0644\u0625\u0637\u0627\u0631\u0627\u062A.',
 wiki_defense_title: '\uD83D\uDD12 \u0627\u0633\u062A\u0631\u0627\u062A\u064A\u062C\u064A\u0627\u062A \u0627\u0644\u062F\u0641\u0627\u0639', wiki_defense: '\u0641\u0639\u0651\u0644 802.11w (PMF) \u0623\u0648 \u0627\u0646\u062A\u0642\u0644 \u0625\u0644\u0649 WPA3. \u0627\u0633\u062A\u062E\u062F\u0645 \u0642\u0641\u0632 \u0627\u0644\u0642\u0646\u0648\u0627\u062A \u0648MAC \u0627\u0644\u0639\u0634\u0648\u0627\u0626\u064A.',
 wiki_privacy_title: '\uD83D\uDD12 \u0627\u0644\u062E\u0635\u0648\u0635\u064A\u0629', wiki_privacy: '\u0645\u062D\u0644\u064A \u0623\u0648\u0644\u0627\u064B. \u0643\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u062A\u0628\u0642\u0649 \u0641\u064A \u0645\u062A\u0635\u0641\u062D\u0643.',
 working: '\u062C\u0627\u0631\u064D\u2026',
 t_mosque: '\u0645\u0633\u062C\u062F', t_zellige: '\u0632\u0644\u064A\u062C', t_andalus: '\u0623\u0646\u062F\u0644\u0633',
 t_riad: '\u0631\u064A\u0627\u0636', t_medina: '\u0645\u062F\u064A\u0646\u0629',
 t_space: '\u0641\u0636\u0627\u0621', t_jungle: '\u0623\u062F\u063A\u0627\u0644', t_robot: '\u0631\u0648\u0628\u0648\u062A',
 ready: '\uD83D\uDEE1\uFE0F \u0643\u0627\u0634\u0641 \u062A\u0634\u0648\u064A\u0634 WiFi \u062C\u0627\u0647\u0632!',
...
let totalAttacks = 0;
let currentPPS = 0;
let timelineData = new Array(60).fill(0);
let alertThreshold = 10;
let attackSources = {};
let isAttackSim = false;
let attackSimTimer = null;

const FAKE_MACS = [
 'DE:AD:BE:EF:00:01', 'AA:BB:CC:DD:EE:FF', '66:77:88:99:AA:BB',
 'CA:FE:BA:BE:00:02', 'DE:AD:C0:DE:00:03', 'BA:DC:0F:FE:E0:04',
 'FA:CE:B0:0C:00:05', 'BE:EF:CA:FE:00:06', '13:37:DE:AD:00:07',
 'C0:FF:EE:00:00:08'
];

const FAKE_NETWORKS = [
 { ssid: 'HomeNetwork_5G', bssid: '4A:3B:2C:1D:0E:F1', channel: 6, rssi: -42, security: 'WPA3', pmf: true },
 { ssid: 'TP-Link_Guest', bssid: '5B:4C:3D:2E:1F:A2', channel: 1, rssi: -58, security: 'WPA2', pmf: false },
 { ssid: 'CoffeeShop_Free', bssid: '6C:5D:4E:3F:2A:B3', channel: 11, rssi: -65, security: 'Open', pmf: false },
 { ssid: 'Office_Secure', bssid: '7D:6E:5F:4A:3B:C4', channel: 36, rssi: -50, security: 'WPA3-Enterprise', pmf: true },
 { ssid: 'IoT_Devices', bssid: '8E:7F:6A:5B:4C:D5', channel: 3, rssi: -71, security: 'WPA2', pmf: false },
 { ssid: 'Neighbor_Net', bssid: '9F:8A:7B:6C:5D:E6', channel: 9, rssi: -78, security: 'WPA2', pmf: false },
 { ssid: 'SmartHome_Hub', bssid: 'A1:B2:C3:D4:E5:F7', channel: 44, rssi: -55, security: 'WPA3', pmf: true },
 { ssid: 'Workshop_DIY', bssid: 'B2:C3:D4:E5:F6:08', channel: 6, rssi: -47, security: 'WPA2', pmf: true },
];

function randomMAC() {
 return FAKE_MACS[Math.floor(Math.random() * FAKE_MACS.length)];
}

function generateDeauthPacket() {
 return {
 type: Math.random() > 0.3 ? 0xC0 : 0xA0,
 src: randomMAC(),
 dst: 'FF:FF:FF:FF:FF:FF',
 bssid: FAKE_NETWORKS[Math.floor(Math.random() * FAKE_NETWORKS.length)].bssid,
 reason: Math.random() > 0.5 ? 7 : 6,
...
function updateThreatLevel(pps) {
 const s = LANG[currentLang];
 const el = $('threatLevel');
 const icon = $('threatIcon');
 const text = $('threatText');
 const desc = $('threatDesc');
 if (!el) return;

 if (pps >= alertThreshold) {
 el.style.background = 'rgba(255,0,0,0.12)';
 el.style.borderColor = '#ff3333';
 if (icon) icon.textContent = '\uD83D\uDD34';
 if (text) text.textContent = s.threatAttack;
 if (desc) desc.textContent = s.threatAttackDesc;
 } else if (pps >= alertThreshold * 0.4) {
 el.style.background = 'rgba(255,200,0,0.1)';
 el.style.borderColor = '#ffcc00';
 if (icon) icon.textContent = '\uD83D\uDFE1';
 if (text) text.textContent = s.threatWarning;
 if (desc) desc.textContent = s.threatWarningDesc;
 } else {
 el.style.background = 'rgba(0,255,0,0.08)';
 el.style.borderColor = '#33ff33';
 if (icon) icon.textContent = '\uD83D\uDFE2';
 if (text) text.textContent = s.threatSafe;
 if (desc) desc.textContent = s.threatSafeDesc;
 }
}

function updateStats() {
 const dc = $('deauthCount');
 const pps = $('packetsPerSec');
 const ac = $('attackCount');
 if (dc) dc.textContent = totalDeauth;
 if (pps) pps.textContent = currentPPS;
 if (ac) ac.textContent = totalAttacks;
}
...
function drawTimeline() {
 ...
 const maxVal = Math.max(alertThreshold * 1.5, ...timelineData, 5);
 const barW = w / 60;

 // Threshold line
 const threshY = h - (alertThreshold / maxVal) * h;
 ...
 // Bars
 for (let i = 0; i < 60; i++) {
 const val = timelineData[i];
 const barH = (val / maxVal) * h;
 const x = i * barW;

 if (val >= alertThreshold) {
 ctx.fillStyle = 'rgba(255,50,50,0.8)';
 } else if (val >= alertThreshold * 0.4) {
...
function addAlert(msg, type) {
 const al = $('alertLog');
 if (!al) return;
 if (al.querySelector('[data-i18n="noAlerts"]')) al.innerHTML = '';
 const d = document.createElement('div');
 d.style.cssText = 'padding:3px 6px;border-radius:4px;margin-bottom:3px;' +
 (type === 'attack' ? 'background:rgba(255,0,0,0.15);color:#ff6666;' :
 type === 'warning' ? 'background:rgba(255,200,0,0.1);color:#ffcc00;' :
 'background:rgba(0,255,0,0.08);color:#66ff66;');
...
function updateSources() {
 const el = $('attackSources');
 if (!el) return;
 const entries = Object.entries(attackSources);
 if (entries.length === 0) {
 el.innerHTML = '<div style="opacity:.4;text-align:center;padding:.5rem;">' + (LANG[currentLang].noSources) + '</div>';
 return;
 }
 el.innerHTML = '';
 entries.sort((a, b) => b[1].count - a[1].count);
 entries.slice(0, 8).forEach(([mac, info]) => {
 const d = document.createElement('div');
 d.style.cssText = 'display:flex;justify-content:space-between;padding:3px 6px;border-radius:4px;margin-bottom:2px;background:rgba(255,0,0,0.08);';
 d.innerHTML = `<span style="color:#ff8888;">${mac}</span><span style="opacity:.7;">${info.count} pkts | ch${info.channel}</span>`;
 el.appendChild(d);
 });
}
...
function monitorTick() {
 ...
 // Simulate background noise (0-3 pkts/sec normally)
 let pps = Math.floor(Math.random() * 3);

 // During attack simulation: 15-45 pkts/sec
 if (isAttackSim) {
 pps = Math.floor(Math.random() * 30) + 15;
 }

 // Generate packets
 for (let i = 0; i < pps; i++) {
 const pkt = generateDeauthPacket();
 totalDeauth++;
 if (!attackSources[pkt.src]) {
 attackSources[pkt.src] = { count: 0, channel: pkt.channel, firstSeen: Date.now() };
 }
 attackSources[pkt.src].count++;
 attackSources[pkt.src].channel = pkt.channel;
 }

 currentPPS = pps;
 timelineData.shift();
 timelineData.push(pps);

 // Detect attack patterns
 if (pps >= alertThreshold && !isAttackSim) {
 // This shouldn't happen in normal sim, but keep detection logic
 }
 if (pps >= alertThreshold) {
 const prevWasAttack = timelineData[58] >= alertThreshold;
 if (!prevWasAttack) {
 totalAttacks++;
 addAlert(`${s.attackDetected} | ${pps} pkts/s | src: ${randomMAC()}`, 'attack');
 log(`${s.attackDetected} \u2014 ${pps} pkts/s from ${randomMAC()}`, 'error');
 playSound('error');
 }
 } else if (pps >= alertThreshold * 0.4) {
 if (Math.random() < 0.1) {
 addAlert(`${s.warningDetected} | ${pps} pkts/s`, 'warning');
 }
 }

 updateThreatLevel(pps);
 updateStats();
 updateSources();
 drawTimeline();
}
...
function startMonitor() {
 const s = LANG[currentLang];
 const btn = $('startMonitorBtn');
 if (monitorActive) {
 monitorActive = false;
 clearInterval(monitorInterval);
 clearInterval(uptimeInterval);
 if (btn) {
 btn.querySelector('[data-i18n="startMonitor"], [data-i18n="stopMonitor"]').textContent = s.startMonitor;
 btn.querySelector('[data-i18n="startMonitor"], [data-i18n="stopMonitor"]').dataset.i18n = 'startMonitor';
 }
 setStatus(false);
 log(s.monitorStopped, 'info');
 return;
 }

 monitorActive = true;
 monitorInterval = setInterval(monitorTick, 1000);
 uptimeInterval = setInterval(updateUptime, 1000);
 setStatus(true);

 if (btn) {
 const span = btn.querySelector('[data-i18n="startMonitor"], [data-i18n="stopMonitor"]');
 if (span) { span.textContent = s.stopMonitor; span.dataset.i18n = 'stopMonitor'; }
 }

 log(s.monitorStarted, 'success');
 addAlert(s.monitorStarted, 'info');
 playSound('success');
}
...
function simulateAttack() {
 ...
 if (isAttackSim) return;

 isAttackSim = true;
 log(s.attackSimulated, 'error');
 addAlert(s.attackSimulated, 'attack');
 playSound('error');

 // Attack lasts 5-10 seconds
 const dur = 5000 + Math.random() * 5000;
 attackSimTimer = setTimeout(() => {
 isAttackSim = false;
 }, dur);
}
...
function resetMonitor() {
 ...
 clearInterval(monitorInterval);
 clearInterval(uptimeInterval);
 if (attackSimTimer) clearTimeout(attackSimTimer);
 ...
 const al = $('alertLog');
 if (al) al.innerHTML = '<div style="opacity:.4;text-align:center;padding:.5rem;" data-i18n="noAlerts">' + s.noAlerts + '</div>';

 const src = $('attackSources');
 if (src) src.innerHTML = '<div style="opacity:.4;text-align:center;padding:.5rem;" data-i18n="noSources">' + s.noSources + '</div>';

 const btn = $('startMonitorBtn');
 if (btn) {
 const span = btn.querySelector('[data-i18n="startMonitor"], [data-i18n="stopMonitor"]');
 if (span) { span.textContent = s.startMonitor; span.dataset.i18n = 'startMonitor'; }
 }

 setStatus(false);
 log(s.monitorReset, 'info');
}
...
function scanNetworks() {
 ...
 log(s.networkScan, 'info');
 showToast(s.networkScan, 2000);
 list.innerHTML = '<div style="text-align:center;padding:1rem;opacity:.5;">Scanning...</div>';

 setTimeout(() => {
 list.innerHTML = '';
 const shuffled = [...FAKE_NETWORKS].sort(() => Math.random() - 0.5);
 const count = 4 + Math.floor(Math.random() * 4);

 shuffled.slice(0, count).forEach(net => {
 const rssi = net.rssi + Math.floor(Math.random() * 10 - 5);
 const bars = rssi > -50 ? 4 : rssi > -60 ? 3 : rssi > -70 ? 2 : 1;
 const barStr = '\u2588'.repeat(bars) + '\u2591'.repeat(4 - bars);
 const secColor = net.security.includes('WPA3') ? '#33ff33' : net.security === 'Open' ? '#ff4444' : '#ffcc00';
 const pmfBadge = net.pmf ? '<span style="background:rgba(0,255,0,0.15);color:#33ff33;padding:1px 6px;border-radius:3px;font-size:.65rem;">PMF</span>' : '<span style="background:rgba(255,0,0,0.1);color:#ff6666;padding:1px 6px;border-radius:3px;font-size:.65rem;">No PMF</span>';

 const d = document.createElement('div');
 d.style.cssText = 'padding:.6rem;border-radius:8px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);margin-bottom:.4rem;';
 d.innerHTML = `
 <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.3rem;">
 <strong style="font-size:.85rem;">${net.ssid}</strong>
 <span style="font-family:monospace;letter-spacing:2px;opacity:.5;">${barStr}</span>
 </div>
 <div style="display:flex;gap:.5rem;flex-wrap:wrap;font-size:.7rem;opacity:.7;">
 <span>CH ${net.channel}</span>
 <span>${rssi} dBm</span>
 <span style="color:${secColor};">${net.security}</span>
 ${pmfBadge}
 <span style="opacity:.5;">${net.bssid}</span>
 </div>`;
 list.appendChild(d);
 });

 log(`${s.scanComplete} \u2014 ${count} networks found`, 'success');
 playSound('success');
...
function exportSecurityReport() {
 const s = LANG[currentLang];
 const report = {
 title: 'WiFi Jammer Detector \u2014 Security Report',
 generatedAt: new Date().toISOString(),
 monitorUptime: uptimeSeconds + 's',
 totalDeauthPackets: totalDeauth,
 totalAttacksDetected: totalAttacks,
 peakPPS: Math.max(...timelineData),
 alertThreshold: alertThreshold,
 attackSources: attackSources,
 timelineData: timelineData,
 settings: {
 channelHopping: $('channelHopToggle')?.checked || false,
 macRandomization: $('macRandomToggle')?.checked || false,
 autoLog: $('autoLogToggle')?.checked || true
 }
 };
 const blob = new Blob([JSON.stringify(report, null, 2)], { type: 'application/json' });
 const url = URL.createObjectURL(blob);
...
function init() {
 ...
 // ═══════ APP-SPECIFIC: Deauth Monitor ═══════

 // Monitor controls
 const startBtn = $('startMonitorBtn');
 if (startBtn) startBtn.onclick = startMonitor;

 const simBtn = $('simAttackBtn');
 if (simBtn) simBtn.onclick = simulateAttack;

 const rstBtn = $('resetBtn');
 if (rstBtn) rstBtn.onclick = resetMonitor;
 ...
 const threshVal = $('thresholdValue');
 if (slider) {
 slider.addEventListener('input', () => {
 alertThreshold = parseInt(slider.value, 10);
 if (threshVal) threshVal.textContent = alertThreshold;
 });
 }

 // Export report
 const expBtn = $('exportReportBtn');
 if (expBtn) expBtn.onclick = exportSecurityReport;

 // Toggle slider styling
 document.querySelectorAll('.toggle-slider').forEach(sl => {
 const cb = sl.parentElement.querySelector('input[type="checkbox"]');
 if (cb) {
 const update = () => {
 sl.style.background = cb.checked ? 'var(--accent, #d4a03c)' : 'rgba(255,255,255,0.15)';
 };
