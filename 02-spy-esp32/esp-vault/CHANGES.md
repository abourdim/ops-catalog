# Changelog — Vault u2014 Three-Factor Auth
...
- Fingerprint Scanner step card
- NFC Token step card
- PIN Keypad step card
- Theory: Multi-Factor Authentication section
- Wiring & Hardware section
- ESP32 Code section
