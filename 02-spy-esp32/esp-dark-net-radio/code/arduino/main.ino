/*
 * Dark Net Radio — ESP32 Arduino
 * 📡 Build an offline encrypted WiFi mesh network
 *
 ...
 *
 * Process:
 *   Step 1: Each ESP32 boots as a WiFi Access Point, broadcasting its own SSID. No internet needed.
 *   Step 2: Nodes scan for nearby APs and auto-connect, building a mesh topology dynamically.
 *   Step 3: Messages are encrypted end-to-end using AES-256. Only sender and receiver can read them.
 *   Step 4: If a node fails, the mesh re-routes around it. Messages always find a path if one exists.
 */
...
// ── Configuration ──
#define APP_NAME "esp-dark-net-radio"
#define LED_PIN 2
