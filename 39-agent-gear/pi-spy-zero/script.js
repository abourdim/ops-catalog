...
const LANG = {
 ...
 title: 'Spy Zero', subtitle: '🕵️ Pi Zero spy device — miniature surveillance',
 ...
 howto_1:'The main display shows the Pi Spy Zero simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 howto_3:'Scroll down to the expandable sections. "Sensor Feed" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_pizero_title: '🕵️ Pi Zero', wiki_pizero:'Tiny single-board computer ideal for covert applications. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 wiki_surv_title: '📹 Surveillance', wiki_surv:'Systems combining cameras, mics, and sensors for monitoring. Sensors convert physical phenomena (light, sound, temperature, motion) into electrical signals that a computer can process. The key specifications are sensitivity (smallest change it can detect), range (min to max values), and accuracy (how close to the true value).',
 wiki_covert_title: '🔒 Covert Ops', wiki_covert:'Concealed devices for recon, recording, and intelligence. This concept is fundamental to understanding how the simulation works. Experiment with the controls to see it in action — changing related parameters will show you how different factors interact in the real system.',
 working: 'Working…',
 ...
 theory: 'Pi Spy Zero demonstrates key principles from cryptography. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-B1897C',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Spy Zero \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Spy Zero', subtitle: '🕵️ dispositif espion Pi Zero — surveillance miniature',
 ...
 theory: 'Pi Spy Zero démontre les principes clés de cryptographie. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Spy Zero', subtitle: '🕵️ جهاز تجسس Pi Zero — مراقبة مصغرة',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Spy Zero. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 theory: 'Pi Spy Zero يوضح المبادئ الأساسية في التشفير. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'هجوم اللقاء في المنتصف',related1_desc:'اظهر لماذا 2DES بمفتاح 2n بت لديه فقط n+1 بت من الامان',related1_path:'../../53-crypto-attacks/cry-meet-in-middle-lab/index.html',related2_name:'اختبار العشوائية',related2_desc:'حلل تسلسلات البايت للعشوائية باستخدام اختبارات احصائية متعددة',related2_path:'../../53-crypto-attacks/cry-entropy-analyzer/index.html',related3_name:'هجوم أوراكل الحشو',related3_desc:'حاكي هجوم الحشو على AES-CBC',related3_path:'../../53-crypto-attacks/cry-padding-oracle-lab/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'محطة اعتراض الإشارات',pathPrev_path:'../../39-agent-gear/pi-signal-intercept/index.html',pathNext_name:'القسم الرئيسي',pathNext_path:'../../39-agent-gear/pi-stealth-ap/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ما هي إخفاء المعلومات؟',quiz_q1a:'اتصال صاخب',quiz_q1b:'إخفاء رسائل داخل بيانات أخرى',quiz_q1c:'حذف ملفات',quiz_q1d:'بث إشارات',quiz_q1_answer:'1',quiz_q2:'ما هو التعلم الآلي؟',quiz_q2a:'برمجة الروبوتات',quiz_q2b:'أنظمة تتعلم من البيانات',quiz_q2c:'حساب يدوي',quiz_q2d:'تصميم العتاد',quiz_q2_answer:'1',quiz_q3:'في شيفرة مورس، ما يمثل الحرف E؟',quiz_q3a:'شرطة',quiz_q3b:'نقطة واحدة',quiz_q3c:'نقطتان',quiz_q3d:'نقطة-شرطة',quiz_q3_answer:'1',quiz_q4:'ماذا تعني AI؟',quiz_q4a:'إدخال آلي',quiz_q4b:'الذكاء الاصطناعي',quiz_q4c:'واجهة تناظرية',quiz_q4d:'تكامل نشط',quiz_q4_answer:'1',quiz_q5:'كيف تبدو SOS بشيفرة مورس؟',quiz_q5a:'---...---',quiz_q5b:'...---...',quiz_q5c:'...-...-',quiz_q5d:'-.-.-.',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'رصد مرصد ليغو موجات الجاذبية عام 2015 مؤكدًا تنبؤ أينشتاين قبل 100 عام. قاست المستشعرات تشوهات في الزمكان بمقدار 10⁻²¹ متر.',realworld2:'يتواصل المسبار فويجر 1 الذي أُطلق عام 1977 من مسافة 24 مليار كم باستخدام مرسل بقدرة 23 واط. تستغرق الإشارات أكثر من 22 ساعة في كل اتجاه.',realworld3:'يولد مصادم الهادرونات الكبير في سيرن 1 بيتابايت في الثانية أثناء التصادمات. في عام 2012 أكد بوزون هيغز مكملاً النموذج القياسي للفيزياء.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في تحليل الوقت معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في تحليل الوقت وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Spy Zero يوضح مفهومًا أساسيًا في تحليل الوقت. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Spy Zero لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في تحليل الوقت هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ micro:bit وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال تحليل الوقت يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'تحقق دائمًا من مستوى البطارية قبل العمليات الميدانية. ينتج micro:bit الذي تنفد بطاريته قراءات مستشعر غير موثوقة.',proTip2:'استخدم أرقام مجموعات الراديو فوق 100 لتجنب التداخل مع مستخدمي micro:bit الآخرين. المجموعات الافتراضية 0-10 مزدحمة.',funFactTitle:'🎯 هل تعلم؟',funFact:'النجم النيوتروني كثيف لدرجة أن ملعقة صغيرة من مادته ستزن حوالي 6 مليارات طن على الأرض.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
