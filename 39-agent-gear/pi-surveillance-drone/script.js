...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-261BCF',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Surveillance Drone \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Surveillance Drone', subtitle: '🚁 surveillance drone — aerial reconnaissance',
 ...
 howto_1:'The main display shows the Pi Surveillance Drone simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 howto_3:'Scroll down to the expandable sections. "Aerial Camera" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 gloss3_term: 'Telemetry',
 gloss3_def: 'Real-time data transmitted from drone to ground station: GPS position, altitude, battery voltage, IMU readings, signal strength. Essential for situational awareness.',
 gloss4_term: 'Latency',
 ...
 theory: 'Pi Surveillance Drone demonstrates key principles from cryptography. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Drones use RF links for command/control (typically 900 MHz or 2.4 GHz) and video downlink (5.8 GHz). GPS provides navigation; IMU provides stabilization. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-261BCF',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Surveillance Drone \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Surveillance Drone', subtitle: '🚁 drone de surveillance — reconnaissance aérienne',
 ...
 theory: 'Pi Surveillance Drone démontre les principes clés de cryptographie. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Drones use RF links for command/control (typically 900 MHz or 2.4 GHz) and video downlink (5.8 GHz). GPS provides navigation; IMU provides stabilization. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Surveillance Drone', subtitle: '🚁 طائرة مراقبة — استطلاع جوي',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Surveillance Drone. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 theory: 'Pi Surveillance Drone يوضح المبادئ الأساسية في التشفير. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. Drones use RF links for command/control (typically 900 MHz or 2.4 GHz) and video downlink (5.8 GHz). GPS provides navigation; IMU provides stabilization. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
