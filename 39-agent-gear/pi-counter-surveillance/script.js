...
const LANG = {
 ...
 title: 'Counter Surveillance', subtitle: 'Counter-Surveillance Toolkit — Detect Bugs & Trackers',
 ...
 howto_1:'The main display shows the Pi Counter Surveillance simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 howto_3:'Scroll down to the expandable sections. "RF Scanner" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 gloss3_term: 'Pseudorange',
 gloss3_def: 'The estimated distance between a GPS receiver and a satellite, calculated from signal travel time. Four pseudoranges determine 3D position plus clock correction.',
 gloss4_term: 'Latency',
 ...
 theory: 'Pi Counter Surveillance demonstrates key principles from cryptography. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-87DB92',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Counter Surveillance \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Counter Surveillance', subtitle: 'Kit Contre-Surveillance — Détection Mouchards',
 ...
 theory: 'Pi Counter Surveillance démontre les principes clés de cryptographie. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Counter Surveillance. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select and configure your field equipment for the mission.',
 ...
 theory: 'Pi Counter Surveillance يوضح المبادئ الأساسية في التشفير. A radio channel is a defined frequency range allocated for communication. Adjacent channels can interfere, so proper channel planning is essential. Signals carry information through variations in amplitude, frequency, or phase. Noise and interference degrade signals during transmission. GPS uses 31+ satellites broadcasting precise time signals on L1 (1575.42 MHz) and L2 (1227.60 MHz). Four satellites give 3D position + time. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
