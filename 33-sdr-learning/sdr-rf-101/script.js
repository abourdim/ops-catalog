...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Aircraft Radar — ADS-B Receiver',related1_desc:'Plot every aircraft overhead with altitude, speed, callsign',related1_path:'../../10-hrf-sigint/hrf-aircraft-radar/index.html',related2_name:'Modulation Lab',related2_desc:'Visualize analog and digital modulation schemes',related2_path:'../../27-sdr-dsp/sdr-modulation-lab/index.html',related3_name:'Filter Forge',related3_desc:'Design, visualize and test digital filters',related3_path:'../../27-sdr-dsp/sdr-filter-forge/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Protocol Analyzer',pathPrev_path:'../../33-sdr-learning/sdr-protocol-reverse/index.html',pathNext_name:'Signal Playground',pathNext_path:'../../33-sdr-learning/sdr-sandbox/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
