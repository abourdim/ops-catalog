...
const LANG={
  en:{
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'GSM Tower Mapper',related1_desc:'Scan and map nearby cell towers',related1_path:'../../10-hrf-sigint/hrf-gsm-tower-mapper/index.html',related2_name:'Directed Energy Simulator',related2_desc:'High-power RF beam simulation and phased array steering',related2_path:'../../54-rf-warfare/rfw-directed-energy-sim/index.html',related3_name:'Signal Classifier',related3_desc:'Identify modulation types with AI analysis',related3_path:'../../32-sdr-tools/sdr-signal-classifier/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Server Dashboard',pathPrev_path:'../../34-sdr-godtier/sdr-server/index.html',pathNext_name:'Signal Decoder',pathNext_path:'../../34-sdr-godtier/sdr-universal-decoder/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
