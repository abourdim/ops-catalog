...
const LANG={
 ...
 theory: 'Os demonstrates key principles from advanced SDR. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Aircraft Radar — ADS-B Receiver',related1_desc:'Plot every aircraft overhead with altitude, speed, callsign',related1_path:'../../10-hrf-sigint/hrf-aircraft-radar/index.html',related2_name:'Spectrum Wars',related2_desc:'Two players fight over bands',related2_path:'../../10-hrf-sigint/hrf-spectrum-wars/index.html',related3_name:'Frequency Deconfliction Manager',related3_desc:'Spectrum allocation, conflict detection, and frequency planning',related3_path:'../../54-rf-warfare/rfw-frequency-deconfliction/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'',pathPrev_path:'',pathNext_name:'Server Dashboard',pathNext_path:'../../34-sdr-godtier/sdr-server/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 theory: 'Os démontre les principes clés de SDR avancé. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 theory: 'Os يوضح المبادئ الأساسية في SDR متقدم. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
