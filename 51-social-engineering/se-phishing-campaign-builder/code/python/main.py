...
Design & analyze phishing attack simulations

Workshop-DIY Educational Project

Process:
    Step 1: Attacker crafts a convincing phishing email using social engineering techniques.
    Step 2: The email contains a link to a fake login page mimicking a trusted site.
    Step 3: Victims enter credentials on the fake page, sending data to the attacker.
    Step 4: Harvested credentials are used for unauthorized access or sold on dark web.
...
APP_NAME = "se-phishing-campaign-builder"
