...
const LANG={
 ...
 gloss1_term: 'Domain Spoofing',
 gloss1_def: 'Creating a domain name visually similar to a legitimate one (e.g., goog1e.com). Unicode homoglyph attacks use characters from different alphabets that look identical.',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'NAS Vault Dashboard',related1_desc:'Encrypted network-attached storage server',related1_path:'../../37-pi-core/pi-nas-vault/index.html',related2_name:'Electronic Warfare Simulator',related2_desc:'Simulate jamming, ECM/ECCM and spectrum dominance',related2_path:'../../54-rf-warfare/rfw-electronic-warfare-sim/index.html',related3_name:'Hardware Trojan Designer — IC Backdoor Lab',related3_desc:'Design and detect hardware trojans at the integrated circuit level',related3_path:'../../52-hardware-implants/imp-hardware-trojan-designer/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'OSINT Profile Aggregator',pathPrev_path:'../../51-social-engineering/se-osint-profile-aggregator/index.html',pathNext_name:'Pretexting Simulator',pathNext_path:'../../51-social-engineering/se-pretexting-simulator/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
