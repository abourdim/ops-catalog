...
Process:
    Step 1: Gather information about the target using open sources and social media.
    Step 2: Create a believable cover story or scenario to manipulate the target.
    Step 3: Deploy the social engineering technique and observe the target\
    Step 4: Review what worked, why it worked, and how to defend against it.
...
APP_NAME = "se-shoulder-surfing-lab"
