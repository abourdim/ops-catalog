/**
 * se-shoulder-surfing-lab — Workshop DIY v1.0
 * Practice detecting visual eavesdropping threats
 */
...
en:{
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Factoring Lab',related1_desc:'Enter semiprime N, race Trial Division vs Pollard Rho vs Fermat',related1_path:'../../53-crypto-attacks/cry-rsa-factoring-race/index.html',related2_name:'APRS Dashboard',related2_desc:'APRS iGate and digipeater infrastructure node',related2_path:'../../37-pi-core/pi-igate-digipeater/index.html',related3_name:'imp-rogue-charger-lab',related3_desc:'',related3_path:'../../52-hardware-implants/imp-rogue-charger-lab/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'QR Code Poisoner',pathPrev_path:'../../51-social-engineering/se-qr-code-poisoner/index.html',pathNext_name:'Social Media Recon',pathNext_path:'../../51-social-engineering/se-social-media-recon/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
