...
Build & analyze social engineering pretexts

Workshop-DIY Educational Project

Process:
    Step 1: The attacker creates a false identity and backstory to establish trust.
    Step 2: They research the target using OSINT to make the pretext believable.
    Step 3: During interaction, they manipulate trust and authority biases.
    Step 4: The target reveals sensitive information or performs harmful actions.
...
APP_NAME = "se-pretexting-simulator"
