# 📝 CW Decoder — How-To Guide

## Overview

Real-time Morse decode with waveform and text. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind CW Decoder
