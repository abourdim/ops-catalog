# 🌍 Propagation Monitor — How-To Guide

## Overview

Beacons and solar data propagation monitor. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind Propagation Monitor
