# 🎨 Waterfall Art — How-To Guide

## Overview

Decode SSTV/Hellschreiber to reveal images. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind Waterfall Art
