# 🔑 CW Keyer — How-To Guide

## Overview

Text to CW audio generator with adjustable WPM. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind CW Keyer
