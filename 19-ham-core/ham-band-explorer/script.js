...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-F8C1A4',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Ham Band Explorer \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Ham Band Explorer', subtitle: '🚀 explore · 🎨 create · 💡 innovate',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Band Explorer', mainDesc: 'Describe your project here',
 ...
 howto_1:'The main display shows the Band Explorer simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select the operating band and tune to the target frequency.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-F8C1A4',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Ham Band Explorer \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Band Explorer. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select the operating band and tune to the target frequency.',
...
Object.assign(LANG.en, {"title": "Band Explorer", "subtitle": "📻 Tune all ham bands with band plan overlay on waterfall", "theoryTitle": "Ham Radio Band Plan", "theoryDesc": "Amateur radio bands span from 160m (1.8 MHz) to 23cm (1240 MHz). Each band has allocations for CW, digital, SSB, and FM modes.", "selectBand": "Select Band", "zoom": "Zoom", "start": "Start", "stop": "Stop", "bandCol": "Band", "freqCol": "Frequency", "modeCol": "Modes", "sectionA": "Theory", "sectionB": "Controls", "sectionC": "Waterfall Display", "simStarted": "Simulation started", "simStopped": "Simulation stopped", "bandChanged": "Band changed to", "mainSection": "Band Explorer", "mainDesc": "Tune all ham bands with band plan overlay on waterfall"});
Object.assign(LANG.fr, {"title": "Explorateur de Bandes", "subtitle": "📻 Explorez toutes les bandes avec plan sur cascade", "theoryTitle": "Plan de Bandes Radioamateur", "theoryDesc": "Les bandes radioamateur vont de 160m (1.8 MHz) à 23cm (1240 MHz).", "selectBand": "Sélectionner la Bande", "zoom": "Zoom", "start": "Démarrer", "stop": "Arrêter", "bandCol": "Bande", "freqCol": "Fréquence", "modeCol": "Modes", "sectionA": "Théorie", "sectionB": "Contrôles", "sectionC": "Affichage Cascade", "simStarted": "Simulation démarrée", "simStopped": "Simulation arrêtée", "bandChanged": "Bande changée à", "mainSection": "Explorateur de Bandes", "mainDesc": "Explorez toutes les bandes avec plan sur cascade"});
Object.assign(LANG.ar, {"title": "مستكشف النطاقات", "subtitle": "📻 استكشف جميع نطاقات الهواة", "theoryTitle": "خطة نطاقات الراديو", "theoryDesc": "تمتد نطاقات الهواة من 160m إلى 23cm.", "selectBand": "اختر النطاق", "zoom": "تكبير", "start": "بدء", "stop": "إيقاف", "bandCol": "النطاق", "freqCol": "التردد", "modeCol": "الأوضاع", "sectionA": "النظرية", "sectionB": "أدوات التحكم", "sectionC": "عرض الشلال", "simStarted": "بدأت المحاكاة", "simStopped": "توقفت المحاكاة", "bandChanged": "تغير النطاق إلى", "mainSection": "مستكشف النطاقات", "mainDesc": "استكشف جميع نطاقات الهواة"});
// Re-apply current language to pick up new keys
setLanguage(currentLang);

/* ═══════ BAND EXPLORER SIM ═══════ */
const BANDS={
 '160m':{start:1800,end:2000,label:'160m',segments:[{s:1800,e:1840,m:'CW'},{s:1840,e:2000,m:'SSB'}]},
 '80m':{start:3500,end:4000,label:'80m',segments:[{s:3500,e:3600,m:'CW'},{s:3580,e:3620,m:'Digi'},{s:3600,e:4000,m:'SSB'}]},
 '40m':{start:7000,end:7300,label:'40m',segments:[{s:7000,e:7040,m:'CW'},{s:7040,e:7080,m:'Digi'},{s:7080,e:7300,m:'SSB'}]},
 '20m':{start:14000,end:14350,label:'20m',segments:[{s:14000,e:14070,m:'CW'},{s:14070,e:14112,m:'Digi'},{s:14112,e:14350,m:'SSB'}]},
 '15m':{start:21000,end:21450,label:'15m',segments:[{s:21000,e:21070,m:'CW'},{s:21070,e:21150,m:'Digi'},{s:21150,e:21450,m:'SSB'}]},
 '10m':{start:28000,end:29700,label:'10m',segments:[{s:28000,e:28070,m:'CW'},{s:28070,e:28190,m:'Digi'},{s:28300,e:29100,m:'SSB'},{s:29100,e:29700,m:'FM'}]},
 '2m':{start:144000,end:148000,label:'2m',segments:[{s:144000,e:144100,m:'CW'},{s:144100,e:144400,m:'SSB'},{s:146000,e:148000,m:'FM'}]},
 '70cm':{start:430000,end:440000,label:'70cm',segments:[{s:430000,e:432000,m:'Digi'},{s:433000,e:435000,m:'FM'}]}
};
let bandRunning=false,bandAnim=null;
const wfCanvas=$('waterfallCanvas'),wfCtx=wfCanvas?wfCanvas.getContext('2d'):null;
const spCanvas=$('spectrumCanvas'),spCtx=spCanvas?spCanvas.getContext('2d'):null;
let currentBand='40m';

function getBand(){return BANDS[currentBand]}
function freqStr(khz){return khz>=1e5?(khz/1e3).toFixed(3)+' MHz':(khz/1e3).toFixed(3)+' MHz'}

function drawBandPlan(){
 const ov=$('bandPlanOverlay');if(!ov)return;ov.innerHTML='';
 const b=getBand();const w=b.end-b.start;
 const colors={CW:'#ff6b6b',Digi:'#51cf66',SSB:'#339af0',FM:'#ffd43b'};
 b.segments.forEach(seg=>{
 const pct=((seg.e-seg.s)/w*100);
 const left=((seg.s-b.start)/w*100);
 const d=document.createElement('div');
 d.style.cssText=`position:relative;flex:0 0 ${pct}%;background:${colors[seg.m]||'#888'};padding:2px 4px;border-radius:3px;color:#000;font-weight:600;text-align:center;margin-left:${left>0?'0':'0'}`;
 d.textContent=seg.m;ov.appendChild(d);
 });
}

function updateBandLabel(){
 const b=getBand();
 const lbl=$('bandLabel');if(lbl)lbl.textContent=`${b.label} — ${freqStr(b.start)}-${freqStr(b.end)}`;
}

function simWaterfall(){
 if(!wfCtx||!spCtx)return;
 const W=wfCanvas.width,H=wfCanvas.height;
 const b=getBand(),bw=b.end-b.start;
 // Scroll waterfall down
 const imgData=wfCtx.getImageData(0,0,W,H-1);
 wfCtx.putImageData(imgData,0,1);
 // Draw new line
 for(let x=0;x<W;x++){
 const freq=b.start+(x/W)*bw;
 let sig=Math.random()*15;
 // Add simulated signals at band plan segments
 b.segments.forEach(seg=>{
 if(freq>=seg.s&&freq<=seg.e){
 sig+=Math.random()*30;
 // Occasional strong signals
 if(Math.random()<0.02)sig+=80+Math.random()*40;
 }
 });
 const v=Math.min(255,sig);
 // Blue-to-yellow-to-red colormap
 let r,g,bl;
 if(v<85){r=0;g=0;bl=v*3;}
 else if(v<170){r=(v-85)*3;g=(v-85)*3;bl=255-(v-85)*3;}
 else{r=255;g=255-(v-170)*3;bl=0;}
 wfCtx.fillStyle=`rgb(${r|0},${g|0},${bl|0})`;
 wfCtx.fillRect(x,0,1,1);
 }
 // Spectrum
 spCtx.fillStyle='rgba(0,0,0,0.3)';spCtx.fillRect(0,0,spCanvas.width,spCanvas.height);
 spCtx.strokeStyle=getComputedStyle(document.documentElement).getPropertyValue('--accent').trim()||'#d4a03c';
 spCtx.lineWidth=1.5;spCtx.beginPath();
 for(let x=0;x<spCanvas.width;x++){
 const freq=b.start+(x/spCanvas.width)*bw;
 let sig=10+Math.random()*10;
 b.segments.forEach(seg=>{if(freq>=seg.s&&freq<=seg.e)sig+=15+Math.random()*25;});
 const y=spCanvas.height-(sig/120)*spCanvas.height;
 x===0?spCtx.moveTo(x,y):spCtx.lineTo(x,y);
 }
 spCtx.stroke();
 // Freq display
 const fd=$('freqDisplay');
 if(fd){const cf=b.start+(b.end-b.start)/2;fd.textContent=freqStr(cf);}
 if(bandRunning)bandAnim=requestAnimationFrame(simWaterfall);
}

function startBand(){
 if(bandRunning)return;bandRunning=true;
 log(LANG[currentLang].simStarted||'Simulation started','success');
 setStatus(true);simWaterfall();
}
function stopBand(){
 bandRunning=false;if(bandAnim)cancelAnimationFrame(bandAnim);
 log(LANG[currentLang].simStopped||'Simulation stopped','info');
 setStatus(false);
}

function initBandExplorer(){
 const sel=$('bandSelect');
 if(sel)sel.addEventListener('change',()=>{currentBand=sel.value;updateBandLabel();drawBandPlan();
 log(`${LANG[currentLang].bandChanged||'Band changed to'} ${currentBand}`,'info');});
 const startB=$('startBtn'),stopB=$('stopBtn');
 if(startB)startB.onclick=startBand;
 if(stopB)stopB.onclick=stopBand;
 updateBandLabel();drawBandPlan();
}
initBandExplorer();
