# 📻 Band Explorer — How-To Guide

## Overview

Tune all ham bands with band plan overlay on waterfall. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind Band Explorer
