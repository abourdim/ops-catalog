# 🗼 Repeater Map — How-To Guide

## Overview

2m/70cm repeater scanner with CTCSS/DCS tones. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind Repeater Map
