# 🎤 SSB Visualizer — How-To Guide

## Overview

Audio waveform spectrum and waterfall display. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind SSB Visualizer
