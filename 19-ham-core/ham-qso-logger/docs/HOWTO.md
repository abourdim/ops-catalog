# 📋 QSO Logger — How-To Guide

## Overview

Auto-decode callsigns and log with world map. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind QSO Logger
