# 💬 JS8 Messenger — How-To Guide

## Overview

Weak-signal text chat over HF. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind JS8 Messenger
