# 📶 WSPR Beacon — How-To Guide

## Overview

Milliwatt propagation beacon with world map. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind WSPR Beacon
