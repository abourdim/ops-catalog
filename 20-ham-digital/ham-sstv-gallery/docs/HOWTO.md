# 🖼️ SSTV Gallery — How-To Guide

## Overview

Receive SSTV images line by line. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind SSTV Gallery
