# 🌍 FT8 World Map — How-To Guide

## Overview

Plot FT8 stations globally in real time. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind FT8 World Map
