# 📍 APRS Dashboard — How-To Guide

## Overview

Live APRS packet map with tracking. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind APRS Dashboard
