# 🦁 Digi Mode Zoo — How-To Guide

## Overview

Decode FT8 PSK31 RTTY and more. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind Digi Mode Zoo
