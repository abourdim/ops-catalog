...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-42723A',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Ham Winlink Gateway \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Ham Winlink Gateway', subtitle: '🚀 explore · 🎨 create · 💡 innovate',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Winlink Gateway', mainDesc: 'Describe your project here',
 ...
 howto_1:'The main display shows the Winlink Gateway simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select the operating band and tune to the target frequency.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-42723A',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Ham Winlink Gateway \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Winlink Gateway. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select the operating band and tune to the target frequency.',
...
Object.assign(LANG.en, {"title": "Winlink Gateway", "subtitle": "📧 Email over radio simulation", "sectionA": "Theory", "sectionB": "Controls", "sectionC": "Simulation", "mainSection": "Winlink Gateway", "mainDesc": "Email over radio simulation", "start": "Start", "stop": "Stop", "simStarted": "Simulation started", "simStopped": "Simulation stopped", "theoryTitle": "Winlink Gateway Theory", "theoryDesc": "Email over radio simulation"});
Object.assign(LANG.fr, {"title": "Passerelle Winlink", "subtitle": "📧 Simulation email par radio", "sectionA": "Théorie", "sectionB": "Contrôles", "sectionC": "Simulation", "mainSection": "Passerelle Winlink", "mainDesc": "Simulation email par radio", "start": "Démarrer", "stop": "Arrêter", "simStarted": "Simulation démarrée", "simStopped": "Simulation arrêtée", "theoryTitle": "Théorie Passerelle Winlink", "theoryDesc": "Simulation email par radio"});
Object.assign(LANG.ar, {"title": "بوابة Winlink", "subtitle": "📧 محاكاة البريد عبر الراديو", "sectionA": "النظرية", "sectionB": "أدوات التحكم", "sectionC": "المحاكاة", "mainSection": "بوابة Winlink", "mainDesc": "محاكاة البريد عبر الراديو", "start": "بدء", "stop": "إيقاف", "simStarted": "بدأت المحاكاة", "simStopped": "توقفت المحاكاة", "theoryTitle": "نظرية بوابة Winlink", "theoryDesc": "محاكاة البريد عبر الراديو"});
// Re-apply current language to pick up new keys
setLanguage(currentLang);

/* ═══════ WINLINK GATEWAY SIM ═══════ */
let simRunning=false,simTimer=null,simIdx=0,pktCount=0;
const MSGS=["[WINLINK] Connecting to RMS gateway...", "[WINLINK] Connected to W3QV-10", "[WINLINK] Checking mailbox...", "[WINLINK] 2 new messages", "[WINLINK] From: N1BKE Subject: Field Day Plans", "[WINLINK] From: EMCOMM Subject: Weather Alert", "[WINLINK] Downloading message 1/2...", "[WINLINK] Message 1 received OK", "[WINLINK] Downloading message 2/2...", "[WINLINK] Message 2 received OK", "[WINLINK] Session complete. Disconnecting."];
