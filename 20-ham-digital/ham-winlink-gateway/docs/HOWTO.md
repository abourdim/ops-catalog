# 📧 Winlink Gateway — How-To Guide

## Overview

Email over radio simulation. This app runs entirely in your browser with simulated data.
...
4. **Explore Section A** — Learn the theory behind Winlink Gateway
