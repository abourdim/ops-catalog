...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Baiting Trap Designer',related1_desc:'Design and analyze USB drop & bait attacks',related1_path:'../../51-social-engineering/se-baiting-trap-designer/index.html',related2_name:'Shoulder Surfing Lab',related2_desc:'Practice detecting visual eavesdropping threats',related2_path:'../../51-social-engineering/se-shoulder-surfing-lab/index.html',related3_name:'Radio Telescope — Hydrogen Line',related3_desc:'1420.405 MHz hydrogen emission spectrum',related3_path:'../../10-hrf-sigint/hrf-radio-telescope/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'',pathPrev_path:'',pathNext_name:'Cognitive EW Engine',pathNext_path:'../../54-rf-warfare/rfw-cognitive-ew/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
