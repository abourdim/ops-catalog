...
const LANG={
  en:{
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Tracker Hunter',related1_desc:'Find and disable GPS/Bluetooth trackers',related1_path:'../../13-hrf-spyops/hrf-tracker-hunter/index.html',related2_name:'Jupiter Radio Receiver',related2_desc:'Receive Jupiter radio emissions and Io-induced decametric bursts',related2_path:'../../30-sdr-science/sdr-jupiter-receiver/index.html',related3_name:'Signal Classifier',related3_desc:'Identify modulation types with AI analysis',related3_path:'../../32-sdr-tools/sdr-signal-classifier/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Communications Interception Hub',pathPrev_path:'../../54-rf-warfare/rfw-comms-interception-hub/index.html',pathNext_name:'Drone Hijacker Sim',pathNext_path:'../../54-rf-warfare/rfw-drone-hijacker-sim/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
