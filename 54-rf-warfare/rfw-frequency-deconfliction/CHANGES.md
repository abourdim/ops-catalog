# Changelog — Frequency Deconfliction
...
- Detect RF Threat step card
- Characterize Signal step card
- Deploy Countermeasure step card
- Assess Effectiveness step card
- Frequency Allocations section
- Spectrum Management section
