...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Antenna Profiler',related1_desc:'Visualize gain, radiation pattern and SWR',related1_path:'../../32-sdr-tools/sdr-antenna-profiler/index.html',related2_name:'Keyboard Logger PCB — Implant Design Sim',related2_desc:'Design and analyze hardware keylogger PCB layouts for detection training',related2_path:'../../52-hardware-implants/imp-keyboard-logger-pcb/index.html',related3_name:'AIS Receiver',related3_desc:'Ship positions and vessel data on radar',related3_path:'../../29-sdr-aviation/sdr-ais-maritime/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'IMSI Catcher Sim',pathPrev_path:'../../54-rf-warfare/rfw-imsi-catcher-sim/index.html',pathNext_name:'Radar Jammer Lab',pathNext_path:'../../54-rf-warfare/rfw-radar-jammer-lab/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
