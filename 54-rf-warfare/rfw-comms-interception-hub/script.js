...
const LANG={
  en:{
    ...
    theory: 'Comms Interception Hub demonstrates key principles from RF warfare. The electromagnetic spectrum is divided into bands allocated by regulators. Spectrum is a finite resource — efficient use is critical for modern communications. Tor (The Onion Router) provides anonymous communication by encrypting traffic through three relays. Each relay only knows the previous and next hop, not the full path. RF jamming overwhelms a target signal with noise or interference. Types include barrage (wideband), spot (narrowband), sweep, and deceptive jamming. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
    ...
    glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Capture The Flag — Physical CTF',related1_desc:'ESP32s broadcast clues, teams compete',related1_path:'../../04-spy-combos/kit-capture-the-flag/index.html',related2_name:'Signal Zoo — Modulation Encyclopedia',related2_desc:'Select a modulation to explore its waveform, spectrum, and constellation',related2_path:'../../10-hrf-sigint/hrf-signal-zoo/index.html',related3_name:'Escape HQ — Spy Escape Room',related3_desc:'Solve puzzles with ESP32 locks and micro:bit gadgets',related3_path:'../../04-spy-combos/kit-escape-hq/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Cognitive EW Engine',pathPrev_path:'../../54-rf-warfare/rfw-cognitive-ew/index.html',pathNext_name:'Directed Energy Simulator',pathNext_path:'../../54-rf-warfare/rfw-directed-energy-sim/index.html',
    shortcutsTitle:'⌨️ Keyboard Shortcuts',
    shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
    achieveTitle:'🏆 Achievements',
    achieveExplorer:'Explorer — visited 4+ help tabs',
