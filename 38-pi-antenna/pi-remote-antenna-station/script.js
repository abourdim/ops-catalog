...
const LANG = {
  ...
  ar: {
    ...
    themeChanged: '🎨 المظهر ←',step1Title:'توصيل العتاد',step1Desc:'وصّل المستشعرات أو الوحدات بمنافذ GPIO في Raspberry Pi.',step2Title:'تكوين البرنامج',step2Desc:'ثبّت المكتبات وكوّن سكريبت Python لإعداد العتاد.',step3Title:'مراقبة البيانات',step3Desc:'اقرأ بيانات المستشعرات في الوقت الفعلي وعالجها.',step4Title:'تحكم وتسجيل',step4Desc:'أطلق إجراءات بناءً على حدود البيانات وسجّل النتائج.',sectionCode:'كود الجهاز',faq_q1:'ماذا يفعل هذا التطبيق؟',faq_a1:'يحاكي Raspberry Pi projects! 🔬 يمكنك التجربة مع sensors and GPIO في بيئة آمنة.',faq_q2:'كيف يعمل؟',faq_a2:'المحاكاة تعمل في متصفحك. تنمذج sensors and GPIO حقيقية خطوة بخطوة.',faq_q3:'ماذا أجرب أولاً؟',faq_a3:'اضغط على الزر الرئيسي وشاهد! 🎯 ثم عدّل الإعدادات لترى التأثير.',faq_q4:'ما العلم الحقيقي؟',faq_a4:'هذا physical computing حقيقي! نفس المبادئ المستخدمة من المحترفين. 🧪',faq_q5:'هل يمكنني كسره؟',faq_a5:'جرب المختبر! ادفع المعلمات للحدود القصوى وشاهد. هكذا يكتشف العلماء! 💡',faq_q6:'ما العتاد المطلوب؟',faq_a6:'للنسخة الحقيقية تحتاج Raspberry Pi. تفقد 📦 كود الجهاز!',faq_q7:'هل هو آمن؟',faq_a7:'آمن تماماً! 🛡️ كل شيء يعمل محلياً. لا حاجة للإنترنت.',faq_q8:'ماذا بعد؟',faq_a8:'استكشف التطبيقات الأخرى في هذه الفئة! كل واحد يعلّم جانباً مختلفاً.'}
};
