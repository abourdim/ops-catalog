...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-2D3C98',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Pi Remote Antenna Station \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Pi Remote Antenna Station', subtitle: '📡 remote · 🎛️ control · 🌐 operate',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Remote Station Dashboard', mainDesc: 'Full remote antenna operation and control station',
 sectionA: 'Antenna Control', sectionB: 'Transceiver Panel', sectionC: 'About Remote Operation',
 remInfo1: 'Remote stations allow control of distant radio equipment via the internet.',
 remInfo2: 'A Pi manages the transceiver, rotator, and audio/control links over IP.',
 remInfo3: 'This dashboard simulates a complete remote station with rotator and transceiver.',
 remConnected: '📡 Station connected', remDisconnected: '🔴 Station disconnected',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Pi Remote Antenna Station simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 howto_3:'Scroll down to the expandable sections. "Antenna Control" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 wiki_i18n_title: '🌐 Languages', wiki_i18n: 'Trilingual support: English, Français, Arabic automatically enables right-to-left layout.',
 ...
 themeChanged: '🎨 Theme →',step1Title:'Connect Hardware',step1Desc:'Wire up sensors, displays, or radio modules to the Raspberry Pi GPIO pins. Watch the visualization update in real time as this stage processes. The display shows exactly what is happening internally — each color and movement represents a specific data transformation.',step2Title:'Configure Software',step2Desc:'Install libraries and configure the Python script for your hardware setup. Notice how the indicators change during this phase. The activity log records every event, letting you trace the exact sequence of operations and verify the results.',step3Title:'Monitor Data',step3Desc:'Read sensor data in real time and process it through your algorithms. This stage transforms the input data using the algorithm shown in the visualization. Compare the before and after values to understand the mathematical relationship.',step4Title:'Control & Log',step4Desc:'Trigger actions based on data thresholds and log results for analysis. The output of this stage feeds into the next one. Try pausing here to examine the intermediate state — understanding each step separately builds deeper insight.',sectionCode:'Device Code',faq_q1:'What is Pi Remote Antenna Station?',faq_a1:'Pi Remote Antenna Station is an interactive simulation that demonstrates steganography concepts. Full remote antenna operation and control station. Everything runs in your browser — no hardware or installation needed. Adjust the controls, observe the results, and build real understanding through experimentation.',faq_q2:'How does the simulation work?',faq_a2:'The simulation models real antenna automation behavior in your browser. You control the inputs using sliders and buttons, and the visualization updates in real time to show you the results.',faq_q3:'What do the controls do?',faq_a3:'Press "Start" to begin. Each button and slider changes a specific parameter — the visualization responds immediately so you can see the effect. Check the How-To tab for a step-by-step guide.',faq_q4:'What is the science behind this?',faq_a4:'This app is based on real antenna automation principles used by professionals. The simulation applies the same math and physics — the difference is that here you can safely experiment without expensive equipment.',faq_q5:'What should I experiment with?',faq_a5:'Change one parameter at a time and observe the effect. Try extreme values to find the limits. Then combine changes to see how different factors interact. The challenges section gives you specific experiments to try.',faq_q6:'What hardware do I need for the real version?',faq_a6:'The simulation needs no hardware. To build the real project, you need RPi + antenna. See the Device Code section for wiring diagrams and ready-to-use firmware.',faq_q7:'Is my data private?',faq_a7:'Yes. Everything runs locally in your browser using JavaScript. No data is sent to any server, no account is needed, and the app works completely offline. Your experiments stay on your device.',faq_q8:'What should I explore next?',faq_a8:'Try other apps in this category. Each app in this category teaches a different aspect of antenna automation. Try systematically: set all controls to their defaults, then change one variable at a time. Record what happens at minimum, midpoint, and maximum values. This methodical approach is exactly how researchers and engineers characterize real systems.',demo_s1:'Welcome to Pi Remote Antenna Station! Look at the main display — this is where the antenna automation simulation runs.',demo_s2:'Explore the main section to get started with the app. Watch how the visualization reacts.',demo_s3:'Try adjusting the controls. Each slider or button changes a specific parameter of the simulation.',demo_s4:'Scroll down to see "Antenna Control" for detailed data. The numbers and charts update as the simulation runs.',demo_s5:'Great job! Now try the challenges section to test your understanding of antenna automation.',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'GPIO Programming',learn1Desc:'How to control electronic pins with Python code. Watch the simulation to see this happen in real time. The visualization makes the invisible visible.',learn1Tag:'Electronics',learn2Title:'Sensor Integration',learn2Desc:'How to read temperature, light, and motion data. The controls let you experiment with different conditions. Each change reveals how this principle responds.',learn2Tag:'Sensors',learn3Title:'Python Scripting',learn3Desc:'How to automate hardware with Python programs. Try the challenges section to test your understanding. Real engineers use these same concepts daily.',learn3Tag:'Programming',learn4Title:'Communication',learn4Desc:'How Raspberry Pi talks to radios and networks. Compare results with different settings to build intuition. The data panels show precise measurements.',learn4Tag:'Networking',sectionLearn:'What You Shall Learn',learnLevelVal:'Advanced 🔴',learnLevel:'Level:',learnTimeVal:'30 min ⏱',learnTime:'Time:',learnAgeVal:'14+ 🧒',kidTitle:'For Young Explorers',kidIntro:'Welcome to Pi Remote Antenna Station! This is like a science experiment on your computer. You get to control a real steganography simulation — press buttons, move sliders, and watch what happens on screen. Try changing the controls and watch how Wire up sensors, displays, or radio modules to the Nothing can break — it is all just a simulation running safely in your browser!',kidSafe:'Completely safe! Nothing you do here can break anything. It all runs inside your browser like a game.',kidTry:'Press the big Start button and watch the screen change. Then try moving sliders to see what they do.',kidParent:'This app teaches antenna automation concepts through hands-on simulation. Suitable for STEM education in physics, electronics, and computer science.',ch1Title:'Signal Hunt',ch1Desc:'Tune across the frequency range and find the hidden signal. What frequency is it on? What modulation does it use?',ch2Title:'Noise Floor',ch2Desc:'Measure the noise floor at different frequencies. Where is it lowest? What natural and man-made sources contribute to noise?',ch3Title:'Bandwidth Test',ch3Desc:'Transmit data at different bandwidths. How does bandwidth affect data rate and signal quality? Find the optimal trade-off.',codeTitle:'Starter Code',codeLang:'Python (Raspberry Pi)',codeSnippet:'import subprocess\\nimport json\\nfrom http.server import HTTPServer, SimpleHTTPRequestHandler\\n\\ndef scan_wifi():\\n result = subprocess.run(\\n ["iwlist", "wlan0", "scan"],\\n capture_output=True, text=True\\n )\\n networks = []\\n for line in result.stdout.split("\\\\n"):\\n if "ESSID:" in line:\\n ssid = line.split(\'"\')[1]\\n networks.append(ssid)\\n return networks\\n\\nclass Handler(SimpleHTTPRequestHandler):\\n def do_GET(self):\\n if self.path == "/api/scan":\\n data = json.dumps(scan_wifi())\\n self.send_response(200)\\n self.send_header("Content-Type", "application/json")\\n self.end_headers()\\n self.wfile.write(data.encode())\\n else:\\n super().do_GET()\\n\\nHTTPServer(("0.0.0.0", 8000), Handler).serve_forever()',codeExplain:'This Python script runs on a Raspberry Pi and creates a web server on port 8000. The /api/scan endpoint triggers a WiFi scan using iwlist and returns the list of nearby networks as JSON. Your browser app calls this API to get real data from the Pi hardware. The SimpleHTTPRequestHandler also serves your index.html and script.js files.',purpose:'Pi Remote Antenna Station: Full remote antenna operation and control station. This simulation lets you experiment hands-on instead of just reading theory. Every parameter you change produces visible results, building real intuition for how the system behaves. The workflow goes from Connect Hardware through Configure Software to Monitor Data and Control & Log.',guideTitle:'What Am I Looking At?',guideCanvas:'The main area shows a live visualization of the simulation. Colors and movement represent data changing in real time.',guideControls:'The buttons below the main display control the simulation. Start begins it, Stop pauses it, Reset clears everything.',guideSections:'Below the main card, "Antenna Control" and "Transceiver Panel" show detailed data and analysis. Click the section headers to expand or collapse them.',guideStatus:'The colored dot in the top-right corner shows the connection status. Green means running, red means stopped.',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Padding Oracle Attack',related1_desc:'Simulate padding oracle on AES-CBC',related1_path:'../../53-crypto-attacks/cry-padding-oracle-lab/index.html',related2_name:'Quantum Attack Simulator',related2_desc:'Watch qubits find period via QFT to factor N',related2_path:'../../53-crypto-attacks/cry-quantum-key-cracker/index.html',related3_name:'Birthday Collision Finder',related3_desc:'Generate random hashes and find collisions using the birthday bound',related3_path:'../../53-crypto-attacks/cry-birthday-paradox-demo/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'',pathPrev_path:'',pathNext_name:'',pathNext_path:'',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 achieveExperimenter:'Experimenter — changed 5+ parameters'
 ,
 printBtn: '🖨️ Print Worksheet',quizTab:'Quiz',quizTitle:'Test Your Knowledge',quizRetry:'Retry',quizCorrect:'Correct!',quizWrong:'Wrong!',quizScore:'Score',quiz_q1:'What does antenna gain measure?',quiz_q1a:'Size',quiz_q1b:'Directional efficiency',quiz_q1c:'Color',quiz_q1d:'Weight',quiz_q1_answer:'1',quiz_q2:'What is a neural network?',quiz_q2a:'Physical wires',quiz_q2b:'Computing system inspired by biological neurons',quiz_q2c:'Social network',quiz_q2d:'Radio network',quiz_q2_answer:'1',quiz_q3:'What is the purpose of an antenna?',quiz_q3a:'Store energy',quiz_q3b:'Convert signals between electrical and electromagnetic',quiz_q3c:'Amplify power',quiz_q3d:'Filter noise',quiz_q3_answer:'1',quiz_q4:'What is machine learning?',quiz_q4a:'Programming robots',quiz_q4b:'Systems that learn from data',quiz_q4c:'Manual computation',quiz_q4d:'Hardware design',quiz_q4_answer:'1',quiz_q5:'What does SOS look like in Morse code?',quiz_q5a:'---...---',quiz_q5b:'...---...',quiz_q5c:'...-...-',quiz_q5d:'-.-.-.',quiz_q5_answer:'1',realworldTitle:'🌍 Real-World Stories',realworld1:'Heartbleed (2014) was a buffer overflow in OpenSSL that let attackers read 64KB of server memory per request — potentially grabbing private keys, passwords, and session tokens from any HTTPS server worldwide.',realworld2:'Alan Turing\'s team at Bletchley Park cracked the Enigma machine during WWII, reading 84,000 encrypted German messages per month by 1945. This achievement shortened the war by an estimated 2 years.',realworld3:'The SolarWinds attack (2020) compromised 18,000 organizations by hiding malware inside trusted software updates. Attackers had 9 months of undetected access to US Treasury, Commerce, and Homeland Security systems.',experimentTitle:'🔬 Experiments',experiment_1_title:'Baseline Measurement',experiment_1:'Set all controls to default values and record the initial readings. These are your baseline measurements. Good scientists always establish a baseline before changing variables — it gives you a reference point to measure all future changes against.',experiment_2_title:'Sensitivity Analysis',experiment_2:'Change one parameter to its minimum value, record the result, then set it to maximum. The difference reveals the system\'s sensitivity to that variable. Repeat for each control. In psychological ops, knowing which parameters matter most helps you focus your efforts efficiently.',experiment_3_title:'Interaction Effects',experiment_3:'After testing parameters individually, change two simultaneously. Does the combined effect equal the sum of individual effects? Or is there a synergy (or cancellation)? Non-linear interactions are common in psychological ops and reveal the hidden complexity beneath simple-looking systems.',wiki_concept_title:'💡 Core Concept',wiki_concept:'Pi Remote Antenna Station demonstrates a fundamental concept in psychological ops. At its core, this simulation models how real systems process signals, data, or physical phenomena. The key insight is that complex behaviors emerge from simple rules applied repeatedly. Understanding this principle — that sophisticated outcomes arise from basic building blocks — is the foundation of engineering and scientific thinking.',wiki_realworld_title:'🌐 Real-World Applications',wiki_realworld:'The principles demonstrated in Pi Remote Antenna Station have direct real-world applications. Professionals in psychological ops use these same concepts daily. In industry, browser and similar hardware implement these algorithms in embedded systems. In research, these models help scientists predict and analyze complex phenomena. The skills you develop here — systematic experimentation, parameter tuning, and data interpretation — are exactly what employers seek.',wiki_safety_title:'⚠️ Safety & Responsibility',wiki_safety:'Working with psychological ops carries important responsibilities. Always operate within legal boundaries — many countries regulate equipment and techniques in this field. Never test on systems you do not own without explicit written permission. This simulation is designed for safe educational use — it does not transmit real signals or access real networks. When you progress to real hardware, research your local regulations first.',proTipTitle:'💡 Pro Tips',proTip1:'Export simulation data using the Copy button, paste into a spreadsheet, and create your own charts. Comparing multiple runs in a chart reveals patterns invisible on screen.',proTip2:'Open your browser\\x27s Developer Console (F12) to see the raw data behind the visualization. The simulation logs every calculation — this is how you verify the math.',funFactTitle:'🎯 Did You Know?',funFact:'A 256-bit AES key has more possible combinations (2²⁵⁶) than atoms in the observable universe (≈2²⁶⁶). Even checking a trillion keys per second, brute-forcing would take longer than the age of the universe.',mistakeTitle:'⚠️ Common Mistakes',mistake1:'Changing multiple parameters at once makes it impossible to isolate cause and effect. Always change ONE variable at a time.',mistake2:'Skipping the baseline measurement. Without knowing the default behavior, you cannot measure how your changes affect the system.',mistake3:'Ignoring the activity log. It records every event with timestamps — essential for understanding sequences and debugging unexpected results.'},
 wiki_history_title: '📜 History of Steganography',
 wiki_history: 'Guglielmo Marconi transmitted the first transatlantic radio signal in 1901. Radio evolved from spark-gap transmitters to modern software-defined radios. Pi Remote Antenna Station builds on this foundation, letting you explore these historical concepts through interactive simulation.',
 wiki_math_title: '📐 Mathematics Behind Pi Remote Antenna Station',
 wiki_math: 'The mathematics behind Pi Remote Antenna Station: The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance. Antenna gain G = 4π·Ae/λ² where Ae is the effective aperture. A half-wave dipole has 2.15 dBi gain. Parabolic dishes achieve 30-50 dBi.',
 wiki_advanced_title: '🔬 Advanced Techniques',
 wiki_advanced: 'Beyond the basics demonstrated in this simulation, advanced steganography practitioners use sophisticated techniques. Adaptive algorithms automatically adjust parameters based on environmental conditions. Machine learning classifies signals with high accuracy. Multi-channel correlation detects patterns invisible to single-channel analysis. Distributed sensor networks combine data from multiple locations for triangulation. These techniques build on the fundamentals you learn here.',
 wiki_compare_title: '⚖️ Comparing Approaches',
 wiki_compare: 'There are several approaches to steganography. Hardware-based solutions using browser offer real-time performance and direct signal access. Software simulations (like this app) provide safe experimentation without equipment cost. Cloud-based platforms offer scalability but introduce latency and privacy concerns. Each approach has trade-offs: cost vs. fidelity, speed vs. safety, simplicity vs. capability. This simulation gives you the conceptual foundation to use any approach effectively.',
 wiki_debug_title: '🔧 Troubleshooting Guide',
 wiki_debug: 'Common issues when working with steganography: (1) Unexpected results often come from incorrect parameter settings — reset to defaults and change one variable at a time. (2) If the visualization seems frozen, check that the simulation is running (not paused). (3) Noisy or erratic readings usually indicate interference — in real hardware, move away from electronic devices. (4) If calculations seem wrong, verify your units (Hz vs kHz vs MHz). Systematic debugging is a core skill in steganography.',
 wiki_ethics_title: '⚖️ Ethics & Legal Considerations',
 wiki_ethics: 'Steganography carries important ethical and legal responsibilities. Many countries regulate the use of browser and similar equipment. Always obtain proper authorization before testing on systems you do not own. Respect privacy laws and data protection regulations. This simulation is designed for educational purposes — it demonstrates principles without transmitting real signals or accessing real networks. Responsible use of these skills contributes to security for everyone.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-2D3C98',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Pi Remote Antenna Station \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Station antenne distante Pi', subtitle: '📡 distant · 🎛️ contrôler · 🌐 opérer',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Tableau de bord station distante', mainDesc: 'Station de contrôle et d\'opération d\'antenne distante',
 sectionA: 'Contrôle d\'antenne', sectionB: 'Panneau émetteur-récepteur', sectionC: 'À propos de l\'opération distante',
 remInfo1: 'Les stations distantes permettent de contrôler l\'équipement radio via internet.',
 remInfo2: 'Un Pi gère l\'émetteur-récepteur, le rotateur et les liens audio/contrôle.',
 remInfo3: 'Ce tableau de bord simule une station distante complète.',
 remConnected: '📡 Station connectée', remDisconnected: '🔴 Station déconnectée',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Pi Remote Antenna Station. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 themeChanged: '🎨 Thème →',step1Title:'Connecter le matériel',step1Desc:'Branche les capteurs ou modules radio aux broches GPIO du Raspberry Pi. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Configurer le logiciel',step2Desc:'Installe les bibliothèques et configure le script Python. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Surveiller les données',step3Desc:'Lis les données des capteurs en temps réel et traite-les. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Contrôler et enregistrer',step4Desc:'Déclenche des actions selon les seuils et enregistre les résultats. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que Pi Remote Antenna Station ?',faq_a1:'Pi Remote Antenna Station est une simulation interactive qui démontre les concepts de stéganographie. Full remote antenna operation and control station. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de automatisation d\'antennes. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de automatisation d\'antennes. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut RPi + antenna. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de automatisation d\'antennes. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans Pi Remote Antenna Station ! Regarde l\'écran principal — c\'est ici que la simulation de automatisation d\'antennes fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de automatisation d\'antennes.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'GPIO Programming',learn1Desc:'How to control electronic pins with Python code. Regarde la simulation pour voir ça en temps réel. La visualisation rend visible l\'invisible.',learn1Tag:'Electronics',learn2Title:'Sensor Integration',learn2Desc:'How to read temperature, light, and motion data. Les contrôles te permettent d\'expérimenter. Chaque changement révèle comment ce principe réagit.',learn2Tag:'Sensors',learn3Title:'Python Scripting',learn3Desc:'How to automate hardware with Python programs. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Programming',learn4Title:'Communication',learn4Desc:'How Raspberry Pi talks to radios and networks. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Networking',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Avancé 🔴',learnLevel:'Niveau :',learnTimeVal:'30 min ⏱',learnTime:'Durée :',learnAgeVal:'14+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Pi Remote Antenna Station ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de stéganographie — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how Wire up sensors, displays, or radio modules to the Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de automatisation d\'antennes par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',ch1Title:'Chasse au Signal',ch1Desc:'Balaye les fréquences et trouve le signal caché. Sur quelle fréquence est-il ? Quelle modulation utilise-t-il ?',ch2Title:'Plancher de Bruit',ch2Desc:'Mesure le plancher de bruit à différentes fréquences. Où est-il le plus bas ? Quelles sources contribuent au bruit ?',ch3Title:'Test de Bande Passante',ch3Desc:'Transmets des données à différentes bandes passantes. Comment cela affecte-t-il le débit et la qualité ?',codeTitle:'Code de Démarrage',codeLang:'Python (Raspberry Pi)',codeSnippet:'import subprocess\\nimport json\\nfrom http.server import HTTPServer, SimpleHTTPRequestHandler\\n\\ndef scan_wifi():\\n result = subprocess.run(["iwlist", "wlan0", "scan"], capture_output=True, text=True)\\n networks = []\\n for line in result.stdout.split("\\\\n"):\\n if "ESSID:" in line:\\n networks.append(line.split(\'"\')[1])\\n return networks\\n\\nHTTPServer(("0.0.0.0", 8000), SimpleHTTPRequestHandler).serve_forever()',codeExplain:'Ce script Python tourne sur un Raspberry Pi et crée un serveur web sur le port 8000. L\'endpoint /api/scan déclenche un scan WiFi et retourne la liste des réseaux en JSON. Ton appli navigateur appelle cette API pour obtenir de vraies données du Pi.',purpose:'Pi Remote Antenna Station : Full remote antenna operation and control station. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'Attaque Oracle',related1_desc:'Simulez l\\',related1_path:'../../53-crypto-attacks/cry-padding-oracle-lab/index.html',related2_name:'Simulateur Quantique',related2_desc:'Regardez les qubits trouver la periode via QFT',related2_path:'../../53-crypto-attacks/cry-quantum-key-cracker/index.html',related3_name:'Chercheur de Collisions',related3_desc:'Generez des hachages aleatoires et trouvez des collisions',related3_path:'../../53-crypto-attacks/cry-birthday-paradox-demo/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'',pathPrev_path:'',pathNext_name:'',pathNext_path:'',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Que mesure le gain d\'antenne ?',quiz_q1a:'Taille',quiz_q1b:'Efficacité directionnelle',quiz_q1c:'Couleur',quiz_q1d:'Poids',quiz_q1_answer:'1',quiz_q2:'Qu\'est-ce qu\'un réseau de neurones ?',quiz_q2a:'Fils physiques',quiz_q2b:'Système informatique inspiré des neurones',quiz_q2c:'Réseau social',quiz_q2d:'Réseau radio',quiz_q2_answer:'1',quiz_q3:'Quel est le rôle d\'une antenne ?',quiz_q3a:'Stocker l\'énergie',quiz_q3b:'Convertir les signaux',quiz_q3c:'Amplifier la puissance',quiz_q3d:'Filtrer le bruit',quiz_q3_answer:'1',quiz_q4:'Qu\'est-ce que l\'apprentissage automatique ?',quiz_q4a:'Programmer des robots',quiz_q4b:'Systèmes apprenant des données',quiz_q4c:'Calcul manuel',quiz_q4d:'Conception matérielle',quiz_q4_answer:'1',quiz_q5:'Comment s\'écrit SOS en code Morse ?',quiz_q5a:'---...---',quiz_q5b:'...---...',quiz_q5c:'...-...-',quiz_q5d:'-.-.-.',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'Heartbleed (2014) était un dépassement de tampon dans OpenSSL qui permettait aux attaquants de lire 64 Ko de mémoire serveur par requête.',realworld2:'L\'équipe d\'Alan Turing à Bletchley Park a décrypté la machine Enigma pendant la WWII, lisant 84 000 messages allemands chiffrés par mois en 1945.',realworld3:'L\'attaque SolarWinds (2020) a compromis 18 000 organisations en cachant des malwares dans des mises à jour logicielles de confiance.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En opérations psychologiques, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en opérations psychologiques et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'Pi Remote Antenna Station illustre un concept fondamental en opérations psychologiques. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans Pi Remote Antenna Station ont des applications directes dans le monde réel. Les professionnels de opérations psychologiques utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, browser et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en opérations psychologiques implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'Exportez les données avec le bouton Copier, collez dans un tableur et créez vos propres graphiques.',proTip2:'Ouvrez la console développeur (F12) pour voir les données brutes derrière la visualisation. La simulation enregistre chaque calcul.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'Une clé AES 256 bits a plus de combinaisons possibles (2²⁵⁶) que d\x27atomes dans l\x27univers observable. Même en testant un billion de clés par seconde, le forçage prendrait plus longtemps que l\x27ge de l\x27univers.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de stéganographie',
 wiki_history: 'Guglielmo Marconi transmitted the first transatlantic radio signal in 1901. Radio evolved from spark-gap transmitters to modern software-defined radios. Pi Remote Antenna Station s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Pi Remote Antenna Station',
 wiki_math: 'Les mathématiques derrière Pi Remote Antenna Station : The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance. Antenna gain G = 4π·Ae/λ² where Ae is the effective aperture. A half-wave dipole has 2.15 dBi gain. Parabolic dishes achieve 30-50 dBi.',
 wiki_advanced_title: '🔬 Techniques avancées',
 wiki_advanced: 'Au-delà des bases de cette simulation, les praticiens avancés de stéganographie utilisent des techniques sophistiquées. Les algorithmes adaptatifs ajustent automatiquement les paramètres. L apprentissage automatique classifie les signaux avec précision. La corrélation multi-canaux détecte des motifs invisibles à l analyse mono-canal. Les réseaux de capteurs distribués combinent les données de plusieurs emplacements.',
 wiki_compare_title: '⚖️ Comparaison des approches',
 wiki_compare: 'Il existe plusieurs approches pour stéganographie. Les solutions matérielles avec browser offrent des performances en temps réel. Les simulations logicielles (comme cette app) permettent une expérimentation sûre sans coût de matériel. Les plateformes cloud offrent une évolutivité mais introduisent latence et préoccupations de confidentialité. Cette simulation vous donne les bases pour utiliser efficacement toute approche.',
 wiki_debug_title: '🔧 Guide de dépannage',
 wiki_debug: 'Problèmes courants en stéganographie : (1) Les résultats inattendus proviennent souvent de paramètres incorrects — réinitialisez et modifiez une variable à la fois. (2) Si la visualisation semble gelée, vérifiez que la simulation tourne. (3) Les lectures erratiques indiquent des interférences. (4) Vérifiez vos unités (Hz vs kHz vs MHz). Le débogage systématique est une compétence essentielle.',
 wiki_ethics_title: '⚖️ Éthique et aspects légaux',
 wiki_ethics: 'Stéganographie implique des responsabilités éthiques et légales importantes. De nombreux pays réglementent l utilisation de browser. Obtenez toujours une autorisation avant de tester des systèmes que vous ne possédez pas. Respectez les lois sur la vie privée et la protection des données. Cette simulation est conçue à des fins éducatives — elle démontre des principes sans transmettre de signaux réels ni accéder à de vrais réseaux.',
 gloss1_term: 'Bandwidth',
 gloss1_def: 'The range of frequencies a signal occupies. Wider bandwidth allows more data but requires more spectrum. Measured in Hz (kHz, MHz, GHz).',
 gloss2_term: 'Gain (dBi)',
 gloss2_def: 'A measure of antenna directivity compared to an isotropic radiator. Higher gain means the antenna focuses energy in a narrower beam, increasing range in that direction.',
 ...
 theory: 'Pi Remote Antenna Station démontre les principes clés de stéganographie. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. An antenna converts electrical signals to electromagnetic waves and vice versa. Gain, directivity, and polarization determine its performance characteristics. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 faq_q9: 'Quelles erreurs courantes dois-je éviter ?',
 faq_a9: 'L erreur la plus courante est de modifier plusieurs paramètres simultanément, ce qui rend impossible la compréhension de cause à effet. Modifiez toujours un seul élément à la fois. Une autre erreur est d ignorer le journal d activité — il enregistre chaque événement. Enfin, ne sautez pas la section défis : ces questions testent votre compréhension réelle des concepts.',
 faq_q10: 'Quel est le lien avec steganography dans le monde réel ?',
 ...
 title: 'محطة هوائي عن بعد Pi', subtitle: '📡 بعيد · 🎛️ تحكم · 🌐 تشغيل',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'لوحة تحكم المحطة البعيدة', mainDesc: 'محطة تحكم وتشغيل هوائي عن بعد كاملة',
 sectionA: 'التحكم بالهوائي', sectionB: 'لوحة الإرسال والاستقبال', sectionC: 'حول التشغيل عن بعد',
 remInfo1: 'المحطات البعيدة تسمح بالتحكم في معدات الراديو عبر الإنترنت.',
 remInfo2: 'Pi يدير جهاز الإرسال والاستقبال والمحرك وروابط الصوت/التحكم.',
 remInfo3: 'هذه اللوحة تحاكي محطة بعيدة كاملة مع محرك وجهاز إرسال.',
 remConnected: '📡 تم الاتصال بالمحطة', remDisconnected: '🔴 تم قطع الاتصال',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Pi Remote Antenna Station. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Wire up sensors, displays, or radio modules to the Raspberry',
 ...
 themeChanged: '🎨 المظهر ←',step1Title:'توصيل العتاد',step1Desc:'وصّل المستشعرات أو الوحدات بمنافذ GPIO في Raspberry Pi. شاهد التصور يتحدث في الوقت الفعلي أثناء هذه المرحلة. يعرض الشاشة بالضبط ما يحدث داخلياً — كل لون وحركة يمثل تحولاً محدداً في البيانات.',step2Title:'تكوين البرنامج',step2Desc:'ثبّت المكتبات وكوّن سكريبت Python لإعداد العتاد. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',step3Title:'مراقبة البيانات',step3Desc:'اقرأ بيانات المستشعرات في الوقت الفعلي وعالجها. تحول هذه المرحلة بيانات الإدخال باستخدام الخوارزمية المعروضة. قارن القيم قبل وبعد لفهم العلاقة الرياضية.',step4Title:'تحكم وتسجيل',step4Desc:'أطلق إجراءات بناءً على حدود البيانات وسجّل النتائج. ناتج هذه المرحلة يغذي المرحلة التالية. حاول التوقف هنا لفحص الحالة الوسيطة.',sectionCode:'كود الجهاز',faq_q1:'ما هو Pi Remote Antenna Station؟',faq_a1:'Pi Remote Antenna Station هي محاكاة تفاعلية توضح مفاهيم إخفاء المعلومات. Full remote antenna operation and control station. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في أتمتة الهوائيات. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من أتمتة الهوائيات. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج RPi + antenna. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من أتمتة الهوائيات. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في Pi Remote Antenna Station! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة أتمتة الهوائيات.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـأتمتة الهوائيات.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'GPIO Programming',learn1Desc:'How to control electronic pins with Python code. شاهد المحاكاة لرؤية هذا في الوقت الفعلي. التصور المرئي يجعل غير المرئي مرئياً.',learn1Tag:'Electronics',learn2Title:'Sensor Integration',learn2Desc:'How to read temperature, light, and motion data. أدوات التحكم تتيح لك التجريب. كل تغيير يكشف كيف يستجيب هذا المبدأ.',learn2Tag:'Sensors',learn3Title:'Python Scripting',learn3Desc:'How to automate hardware with Python programs. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'Programming',learn4Title:'Communication',learn4Desc:'How Raspberry Pi talks to radios and networks. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'Networking',sectionLearn:'ماذا ستتعلم',learnLevelVal:'متقدم 🔴',learnLevel:'المستوى:',learnTimeVal:'30 min ⏱',learnTime:'المدة:',learnAgeVal:'14+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Pi Remote Antenna Station! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـإخفاء المعلومات — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how Wire up sensors, displays, or radio modules to the لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم أتمتة الهوائيات من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',ch1Title:'البحث عن الإشارة',ch1Desc:'امسح نطاق الترددات واعثر على الإشارة المخفية. على أي تردد هي؟ أي تعديل تستخدم؟',ch2Title:'أرضية الضوضاء',ch2Desc:'قِس أرضية الضوضاء على ترددات مختلفة. أين هي الأدنى؟ ما المصادر التي تساهم في الضوضاء؟',ch3Title:'اختبار عرض النطاق',ch3Desc:'أرسل بيانات بعرض نطاق مختلف. كيف يؤثر ذلك على معدل البيانات وجودة الإشارة؟',codeTitle:'كود البداية',codeLang:'Python (Raspberry Pi)',codeSnippet:'import subprocess\\nimport json\\nfrom http.server import HTTPServer, SimpleHTTPRequestHandler\\n\\ndef scan_wifi():\\n result = subprocess.run(["iwlist", "wlan0", "scan"], capture_output=True, text=True)\\n networks = []\\n for line in result.stdout.split("\\\\n"):\\n if "ESSID:" in line:\\n networks.append(line.split(\'"\')[1])\\n return networks\\n\\nHTTPServer(("0.0.0.0", 8000), SimpleHTTPRequestHandler).serve_forever()',codeExplain:'يعمل هذا الكود على Raspberry Pi وينشئ خادم ويب على المنفذ 8000. يقوم بمسح شبكات WiFi ويعيد القائمة بصيغة JSON. تطبيق المتصفح يستدعي هذه الواجهة للحصول على بيانات حقيقية.',purpose:'Pi Remote Antenna Station: Full remote antenna operation and control station. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ إخفاء المعلومات',
 wiki_history: 'Guglielmo Marconi transmitted the first transatlantic radio signal in 1901. Radio evolved from spark-gap transmitters to modern software-defined radios. يبني Pi Remote Antenna Station على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Pi Remote Antenna Station',
 wiki_math: 'الرياضيات وراء Pi Remote Antenna Station: The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance. Antenna gain G = 4π·Ae/λ² where Ae is the effective aperture. A half-wave dipole has 2.15 dBi gain. Parabolic dishes achieve 30-50 dBi.',
 ...
 wiki_compare: 'هناك عدة أساليب في إخفاء المعلومات. توفر الحلول المادية باستخدام browser أداءً في الوقت الفعلي. توفر المحاكاة البرمجية (مثل هذا التطبيق) تجربة آمنة بدون تكلفة المعدات. توفر المنصات السحابية قابلية التوسع لكنها تقدم تأخيراً ومخاوف تتعلق بالخصوصية. تمنحك هذه المحاكاة الأساس لاستخدام أي نهج بفعالية.',
 wiki_debug_title: '🔧 دليل استكشاف الأخطاء',
 wiki_debug: 'مشاكل شائعة في إخفاء المعلومات: (1) النتائج غير المتوقعة غالباً ما تأتي من إعدادات معاملات غير صحيحة — أعد التعيين وغير متغيراً واحداً في كل مرة. (2) إذا بدت الرسوم المتحركة متجمدة، تأكد أن المحاكاة تعمل. (3) القراءات المتقطعة تشير عادة إلى التداخل. (4) تحقق من وحداتك (هرتز مقابل كيلوهرتز مقابل ميغاهرتز).',
 wiki_ethics_title: '⚖️ الأخلاقيات والاعتبارات القانونية',
 wiki_ethics: 'إخفاء المعلومات يحمل مسؤوليات أخلاقية وقانونية مهمة. تنظم العديد من الدول استخدام browser والمعدات المماثلة. احصل دائماً على إذن مناسب قبل اختبار أنظمة لا تملكها. احترم قوانين الخصوصية وحماية البيانات. هذه المحاكاة مصممة لأغراض تعليمية — تعرض المبادئ دون إرسال إشارات حقيقية أو الوصول لشبكات فعلية.',
 gloss1_term: 'Bandwidth',
 gloss1_def: 'The range of frequencies a signal occupies. Wider bandwidth allows more data but requires more spectrum. Measured in Hz (kHz, MHz, GHz).',
 gloss2_term: 'Gain (dBi)',
 gloss2_def: 'A measure of antenna directivity compared to an isotropic radiator. Higher gain means the antenna focuses energy in a narrower beam, increasing range in that direction.',
 ...
 theory: 'Pi Remote Antenna Station يوضح المبادئ الأساسية في إخفاء المعلومات. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. An antenna converts electrical signals to electromagnetic waves and vice versa. Gain, directivity, and polarization determine its performance characteristics. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 faq_q9: 'ما الأخطاء الشائعة التي يجب تجنبها؟',
 faq_a9: 'الخطأ الأكثر شيوعاً هو تغيير معاملات متعددة في وقت واحد مما يجعل فهم السبب والنتيجة مستحيلاً. غير دائماً شيئاً واحداً في كل مرة. خطأ شائع آخر هو تجاهل سجل النشاط — فهو يسجل كل حدث ويساعدك على فهم تسلسل العمليات. أخيراً لا تتخط قسم التحديات: تلك الأسئلة تختبر فهمك الحقيقي للمفاهيم.',
 faq_q10: 'كيف يرتبط هذا بـsteganography في العالم الحقيقي؟',
 faq_a10: 'تحاكي هذه المحاكاة نفس الفيزياء والرياضيات المستخدمة في الأنظمة المهنية. تتوافق المعاملات التي تضبطها مع إعدادات المعدات الحقيقية. تعرض الرسوم البيانية أنماط بيانات مطابقة لما تراه على الأجهزة المهنية. الفرق الرئيسي هو أن هذا يعمل بأمان في متصفحك — تستخدم الأنظمة الحقيقية أجهزة browser وقد تتطلب تراخيص قانونية للتشغيل.',
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'هجوم أوراكل الحشو',related1_desc:'حاكي هجوم الحشو على AES-CBC',related1_path:'../../53-crypto-attacks/cry-padding-oracle-lab/index.html',related2_name:'محاكي الهجوم الكمي',related2_desc:'شاهد الكيوبتات تجد الدورة عبر QFT',related2_path:'../../53-crypto-attacks/cry-quantum-key-cracker/index.html',related3_name:'باحث تصادمات عيد الميلاد',related3_desc:'ولد هاشات عشوائية واعثر على تصادمات باستخدام حد عيد الميلاد',related3_path:'../../53-crypto-attacks/cry-birthday-paradox-demo/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'',pathPrev_path:'',pathNext_name:'',pathNext_path:'',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ماذا يقيس كسب الهوائي؟',quiz_q1a:'الحجم',quiz_q1b:'الكفاءة الاتجاهية',quiz_q1c:'اللون',quiz_q1d:'الوزن',quiz_q1_answer:'1',quiz_q2:'ما هي الشبكة العصبية؟',quiz_q2a:'أسلاك مادية',quiz_q2b:'نظام حوسبة مستوحى من الخلايا العصبية',quiz_q2c:'شبكة اجتماعية',quiz_q2d:'شبكة راديو',quiz_q2_answer:'1',quiz_q3:'ما الغرض من الهوائي؟',quiz_q3a:'تخزين الطاقة',quiz_q3b:'تحويل الإشارات',quiz_q3c:'تضخيم الطاقة',quiz_q3d:'تصفية الضوضاء',quiz_q3_answer:'1',quiz_q4:'ما هو التعلم الآلي؟',quiz_q4a:'برمجة الروبوتات',quiz_q4b:'أنظمة تتعلم من البيانات',quiz_q4c:'حساب يدوي',quiz_q4d:'تصميم العتاد',quiz_q4_answer:'1',quiz_q5:'كيف تبدو SOS بشيفرة مورس؟',quiz_q5a:'---...---',quiz_q5b:'...---...',quiz_q5c:'...-...-',quiz_q5d:'-.-.-.',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'كانت ثغرة هارتبليد (2014) تجاوزًا في المخزن المؤقت في OpenSSL سمح للمهاجمين بقراءة 64 كيلوبايت من ذاكرة الخادم لكل طلب.',realworld2:'فك فريق آلان تورينغ في بلتشلي بارك شفرة آلة إنغما خلال الحرب العالمية الثانية وقرأ 84000 رسالة ألمانية مشفرة شهريًا بحلول عام 1945.',realworld3:'اخترق هجوم سولار ويندز (2020) أكثر من 18000 منظمة من خلال إخفاء برامج ضارة داخل تحديثات البرمجيات الموثوقة.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في العمليات النفسية معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في العمليات النفسية وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Pi Remote Antenna Station يوضح مفهومًا أساسيًا في العمليات النفسية. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Pi Remote Antenna Station لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في العمليات النفسية هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ browser وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال العمليات النفسية يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'صدّر بيانات المحاكاة باستخدام زر النسخ والصقها في جدول بيانات وأنشئ مخططاتك الخاصة.',proTip2:'افتح وحدة تحكم المطور في المتصفح (F12) لرؤية البيانات الخام وراء العرض المرئي. تسجل المحاكاة كل عملية حسابية.',funFactTitle:'🎯 هل تعلم؟',funFact:'يحتوي مفتاح AES بطول 256 بت على توليفات ممكنة أكثر من عدد الذرات في الكون المرئي.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
/* ═══════ REMOTE ANTENNA STATION SIMULATION ═══════ */
let remRunning=false, remInterval=null, remCtx=null, wfCtx=null;
let curAz=0, curEl=0;

function initRemoteSim(){
 const btn=$('remConnectBtn'), ptt=$('pttBtn');
 const azS=$('azSlider'), elS=$('elSlider');
 if(btn) btn.onclick=toggleRemote;
 if(ptt) ptt.onmousedown=()=>{if(remRunning){log('📡 PTT ON — Transmitting','tx');ptt.style.background='#f00';}};
 if(ptt) ptt.onmouseup=()=>{ptt.style.background='#c00';};
 if(azS) azS.oninput=()=>{curAz=parseInt(azS.value);$('azVal').textContent=curAz+'°';drawRotator();};
 if(elS) elS.oninput=()=>{curEl=parseInt(elS.value);$('elVal').textContent=curEl+'°';drawRotator();};
 const rc=$('rotatorCanvas'); if(rc) remCtx=rc.getContext('2d');
 const wc=$('remWaterfall'); if(wc) wfCtx=wc.getContext('2d');
 drawRotator();
}
function toggleRemote(){
 if(remRunning){
 remRunning=false; if(remInterval){clearInterval(remInterval);remInterval=null;}
 setStatus(false); log(LANG[currentLang].remDisconnected,'error');
 const ls=$('linkStatus'); if(ls){ls.textContent='OFF';ls.style.color='';}
 } else {
 remRunning=true; setStatus(true); log(LANG[currentLang].remConnected,'success'); playSound('success');
 const ls=$('linkStatus'); if(ls){ls.textContent='ON';ls.style.color='#0f0';}
 remInterval=setInterval(remTick,100);
 }
}
function remTick(){
 if(!remRunning) return;
 drawWaterfall();
 const sm=$('sMeter'); if(sm) sm.textContent='S'+(3+Math.floor(Math.random()*6));
 const swr=$('swrVal'); if(swr) swr.textContent=(1+Math.random()*0.8).toFixed(1)+':1';
 const band=$('bandSelect')?.value||'14.0';
 const rf=$('remFreq'); if(rf) rf.textContent=(parseFloat(band)+Math.random()*0.3).toFixed(3);
 const cm=$('curMode'); if(cm) cm.textContent=$('modeSelectRem')?.value||'SSB';
}
function drawRotator(){
 if(!remCtx) return;
 const c=$('rotatorCanvas'), w=c.width, h=c.height, cx=w/2, cy=h/2, r=w*0.4;
 remCtx.fillStyle='#0a1628'; remCtx.fillRect(0,0,w,h);
 // Compass ring
 remCtx.strokeStyle='rgba(255,255,255,0.2)'; remCtx.lineWidth=2;
 remCtx.beginPath(); remCtx.arc(cx,cy,r,0,Math.PI*2); remCtx.stroke();
 // Cardinal marks
 remCtx.fillStyle='#fff'; remCtx.font='12px Orbitron,monospace'; remCtx.textAlign='center';
 remCtx.fillText('N',cx,cy-r-8); remCtx.fillText('S',cx,cy+r+16);
 remCtx.fillText('E',cx+r+12,cy+4); remCtx.fillText('W',cx-r-12,cy+4);
 // Antenna direction
 const rad=curAz*Math.PI/180-Math.PI/2;
 const ax=cx+Math.cos(rad)*r*0.8, ay=cy+Math.sin(rad)*r*0.8;
 remCtx.strokeStyle='#0ff'; remCtx.lineWidth=3;
 remCtx.beginPath(); remCtx.moveTo(cx,cy); remCtx.lineTo(ax,ay); remCtx.stroke();
 remCtx.beginPath(); remCtx.arc(ax,ay,6,0,Math.PI*2); remCtx.fillStyle='#0ff'; remCtx.fill();
 // Center
 remCtx.beginPath(); remCtx.arc(cx,cy,4,0,Math.PI*2); remCtx.fillStyle='#fff'; remCtx.fill();
 remCtx.fillStyle='rgba(255,255,255,0.5)'; remCtx.font='10px Orbitron';
 remCtx.fillText(`Az:${curAz}° El:${curEl}°`,cx,h-10);
}
function drawWaterfall(){
 if(!wfCtx) return;
 const c=$('remWaterfall'), w=c.width, h=c.height;
 const imgData=wfCtx.getImageData(0,0,w,h-1);
 wfCtx.putImageData(imgData,0,1);
 for(let x=0;x<w;x++){
 const v=Math.random()*0.3+Math.sin(x*0.04+Date.now()*0.001)*0.1;
 const n=Math.min(1,Math.max(0,v+(x>w*0.4&&x<w*0.5?0.3:0)));
 wfCtx.fillStyle=`rgb(${Math.floor(n*200)},${Math.floor(n*100)},${Math.floor((1-n)*200)})`;
