"""
bit-radio-cartographer — micro:bit MicroPython
...
# ── Configuration ──
APP_NAME = "bit-radio-cartographer"
RADIO_GROUP = 224
RADIO_POWER = 6  # 0-7

# ── Process Overview ──
# Step 1: Click on the map to position a radio transmitter. It broadcasts signal in all directions.
# Step 2: Move your cursor across the map to measure the Received Signal Strength Indicator at each point.
# Step 3: The simulation calculates signal strength for every grid cell using the log-distance path loss model.
# Step 4: Each cell is color-coded by signal strength: red (strong) through yellow/green to blue (weak).
