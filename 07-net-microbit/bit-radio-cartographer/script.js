...
const LANG = {
  en: {
    ...
    howto_4: 'Compare 2.4 GHz vs 900 MHz in the Lab to see how frequency affects propagation.',
  ...
  fr: {
    ...
    howto_4: 'Compare 2.4 GHz et 900 MHz dans le Labo pour voir comment la fréquence affecte la propagation.',
  ...
  ar: {
    ...
    howto_4: 'قارن بين 2.4 جيجاهرتز و 900 ميجاهرتز في المختبر لمعرفة تأثير التردد على الانتشار.',
