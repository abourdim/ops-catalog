...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-E4BA89',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Radio Cartographer \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Radio Cartographer', subtitle: '🗺️ map · 📡 measure · 📊 visualize',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Radio Cartographer — Signal Mapping', mainDesc: 'Map radio signal strength across an area',
 ...
 howto_1:'The main display shows the Radio Cartographer simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Click on the map to position a radio transmitter. It broadca',
 ...
 howto_5: 'Export your heatmap as an image to share or analyze.',
 wiki_rssi_title: '📶 RSSI', wiki_rssi: 'Received Signal Strength Indicator measures the power of a received radio signal in dBm. Typical values: -30 dBm (excellent), -67 dBm (good), -80 dBm (weak), -90 dBm (unusable).',
 wiki_propagation_title: '📡 Signal Propagation', wiki_propagation: 'Radio signals weaken with distance following the log-distance path loss model: RSSI = TxPower - 10 * n * log10(d). The exponent n depends on the environment (free space: 2, indoors: 2.5-4).',
 wiki_heatmap_title: '🗺️ Heatmaps', wiki_heatmap: 'A heatmap uses color gradients to show data intensity across a 2D surface. In radio planning, red means strong signal and blue means weak signal.',
 wiki_coverage_title: '📊 Radio Coverage Planning', wiki_coverage: 'Coverage planning involves positioning transmitters to ensure adequate signal across an area. Key goals: minimize dead zones, reduce interference, and optimize transmitter count.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🗺️ Radio Cartographer ready!',
 ...
 themeChanged: '🎨 Theme →',
 // Radio Cartographer specific
 rssiLabel: 'RSSI:', coordLabel: 'Position:',
 txCount: 'Transmitters:', obstacleCount: 'Obstacles:',
 strong: 'Strong', weak: 'Weak',
 placeTx: 'Place Transmitter', addObstacle: 'Add Obstacle',
 clearMap: 'Clear Map', exportMap: 'Export Heatmap',
 step1Title: 'Place Transmitter', step1Desc: 'Click on the map to position a radio transmitter. It broadcasts signal in all directions.',
 step2Title: 'Measure RSSI', step2Desc: 'Move your cursor across the map to measure the Received Signal Strength Indicator at each point.',
 step3Title: 'Interpolate Data', step3Desc: 'The simulation calculates signal strength for every grid cell using the log-distance path loss model.',
 step4Title: 'Generate Heatmap', step4Desc: 'Each cell is color-coded by signal strength: red (strong) through yellow/green to blue (weak).',
 labMultiTx: '📡 Multiple Transmitters', labMultiTxDesc: 'Place several transmitters and observe how combined signal creates coverage areas. Click "Place Transmitter" multiple times.',
 labObstacles: '🧱 Walls & Obstacles', labObstaclesDesc: 'Add wall obstacles that attenuate the signal. Observe how walls create shadow zones and reduce coverage behind them.',
 attenuation: 'Attenuation (dB):',
 labFreq: '📶 Frequency Comparison', labFreqDesc: 'Compare how 2.4 GHz and 900 MHz signals propagate differently. Lower frequencies penetrate obstacles better but have less bandwidth.',
 labDeadZones: '🚫 Find Dead Zones', labDeadZonesDesc: 'Look for blue/dark areas on the heatmap — these are dead zones where signal is too weak. Can you eliminate them by repositioning transmitters?',
 challengeIntro: 'Test your radio planning skills with these challenges:',
 ch1Title: 'Full Coverage', ch1Desc: 'Find the optimal single transmitter placement to achieve full coverage (all cells above -80 dBm). Hint: center is not always best with obstacles!',
 ch2Title: 'Identify the Dead Zone', ch2Desc: 'Place 2 obstacles and 1 transmitter. Find and mark the largest dead zone (area below -90 dBm). How many cells are affected?',
 ch3Title: 'Three-TX Layout', ch3Desc: 'Design a 3-transmitter layout that provides coverage to at least 95% of the area. Minimize overlap and dead zones. Export your best heatmap!',
 txPlaced: '📡 Transmitter placed at',
 obstaclePlaced: '🧱 Obstacle placed',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-E4BA89',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Radio Cartographer \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Radio Cartographer', subtitle: '🗺️ cartographier · 📡 mesurer · 📊 visualiser',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Radio Cartographe — Carte de Signal', mainDesc: 'Cartographier la puissance du signal radio sur une zone',
 ...
 howto_1:'L écran principal affiche la simulation Radio Cartographer. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Click on the map to position a radio transmitter. It broadca',
 ...
 howto_5: 'Exporte ta carte thermique en image pour la partager ou l\'analyser.',
 wiki_rssi_title: '📶 RSSI', wiki_rssi: 'L\'indicateur de puissance du signal reçu mesure la puissance d\'un signal radio en dBm. Valeurs typiques : -30 dBm (excellent), -67 dBm (bon), -80 dBm (faible), -90 dBm (inutilisable).',
 wiki_propagation_title: '📡 Propagation du Signal', wiki_propagation: 'Les signaux radio s\'affaiblissent avec la distance selon le modèle log-distance : RSSI = TxPower - 10 * n * log10(d). L\'exposant n dépend de l\'environnement (espace libre : 2, intérieur : 2.5-4).',
 wiki_heatmap_title: '🗺️ Cartes Thermiques', wiki_heatmap: 'Une carte thermique utilise des gradients de couleur pour montrer l\'intensité des données sur une surface 2D. En planification radio, rouge = signal fort, bleu = signal faible.',
 wiki_coverage_title: '📊 Planification de Couverture', wiki_coverage: 'La planification de couverture consiste à positionner les émetteurs pour assurer un signal adéquat sur une zone. Objectifs : minimiser les zones mortes, réduire les interférences, optimiser le nombre d\'émetteurs.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🗺️ Radio Cartographe prêt !',
 ...
 themeChanged: '🎨 Thème →',
 rssiLabel: 'RSSI :', coordLabel: 'Position :',
 txCount: 'Émetteurs :', obstacleCount: 'Obstacles :',
 strong: 'Fort', weak: 'Faible',
 placeTx: 'Placer émetteur', addObstacle: 'Ajouter obstacle',
 clearMap: 'Effacer carte', exportMap: 'Exporter carte',
 step1Title: 'Placer l\'émetteur', step1Desc: 'Clique sur la carte pour positionner un émetteur radio. Il diffuse le signal dans toutes les directions.',
 step2Title: 'Mesurer le RSSI', step2Desc: 'Déplace ton curseur sur la carte pour mesurer l\'indicateur de puissance du signal reçu à chaque point.',
 step3Title: 'Interpoler les données', step3Desc: 'La simulation calcule la puissance du signal pour chaque cellule de la grille avec le modèle log-distance.',
 step4Title: 'Générer la carte thermique', step4Desc: 'Chaque cellule est colorée selon la puissance du signal : rouge (fort) en passant par jaune/vert jusqu\'à bleu (faible).',
 labMultiTx: '📡 Émetteurs multiples', labMultiTxDesc: 'Place plusieurs émetteurs et observe comment le signal combiné crée des zones de couverture. Clique sur "Placer émetteur" plusieurs fois.',
 labObstacles: '🧱 Murs et Obstacles', labObstaclesDesc: 'Ajoute des murs qui atténuent le signal. Observe comment les murs créent des zones d\'ombre et réduisent la couverture derrière eux.',
 attenuation: 'Atténuation (dB) :',
 labFreq: '📶 Comparaison de Fréquences', labFreqDesc: 'Compare comment les signaux 2.4 GHz et 900 MHz se propagent différemment. Les basses fréquences pénètrent mieux les obstacles mais ont moins de bande passante.',
 labDeadZones: '🚫 Trouver les Zones Mortes', labDeadZonesDesc: 'Cherche les zones bleues/sombres sur la carte — ce sont les zones mortes où le signal est trop faible. Peux-tu les éliminer en repositionnant les émetteurs ?',
 challengeIntro: 'Teste tes compétences en planification radio avec ces défis :',
 ch1Title: 'Couverture Totale', ch1Desc: 'Trouve le placement optimal d\'un seul émetteur pour couvrir toute la zone (toutes les cellules au-dessus de -80 dBm). Indice : le centre n\'est pas toujours le meilleur avec des obstacles !',
 ch2Title: 'Identifier la Zone Morte', ch2Desc: 'Place 2 obstacles et 1 émetteur. Trouve et marque la plus grande zone morte (zone sous -90 dBm). Combien de cellules sont affectées ?',
 ch3Title: 'Plan à 3 Émetteurs', ch3Desc: 'Conçois un plan à 3 émetteurs couvrant au moins 95% de la zone. Minimise les chevauchements et les zones mortes. Exporte ta meilleure carte !',
 txPlaced: '📡 Émetteur placé à',
 obstaclePlaced: '🧱 Obstacle placé',
 mapCleared: '🧹 Carte effacée',
 ...
 title: 'Radio Cartographer', subtitle: '🗺️ رسم خريطة · 📡 قياس · 📊 تصوّر',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'رسام خرائط الراديو — تخطيط الإشارة', mainDesc: 'رسم خريطة قوة إشارة الراديو عبر منطقة',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Radio Cartographer. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Click on the map to position a radio transmitter. It broadca',
 ...
 howto_5: 'صدّر الخريطة الحرارية كصورة لمشاركتها أو تحليلها.',
 wiki_rssi_title: '📶 RSSI', wiki_rssi: 'مؤشر قوة الإشارة المستقبلة يقيس قوة إشارة الراديو بوحدة dBm. قيم نموذجية: -30 dBm (ممتاز)، -67 dBm (جيد)، -80 dBm (ضعيف)، -90 dBm (غير قابل للاستخدام).',
 wiki_propagation_title: '📡 انتشار الإشارة', wiki_propagation: 'تضعف إشارات الراديو مع المسافة وفقًا لنموذج فقدان المسار اللوغاريتمي: RSSI = TxPower - 10 * n * log10(d). الأس n يعتمد على البيئة (فضاء حر: 2، داخلي: 2.5-4).',
 wiki_heatmap_title: '🗺️ الخرائط الحرارية', wiki_heatmap: 'تستخدم الخريطة الحرارية تدرجات الألوان لإظهار كثافة البيانات على سطح ثنائي الأبعاد. في التخطيط الراديوي، الأحمر يعني إشارة قوية والأزرق يعني إشارة ضعيفة.',
 wiki_coverage_title: '📊 تخطيط التغطية الراديوية', wiki_coverage: 'يتضمن تخطيط التغطية وضع أجهزة الإرسال لضمان إشارة كافية عبر المنطقة. الأهداف: تقليل المناطق الميتة، تقليل التداخل، وتحسين عدد أجهزة الإرسال.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🗺️ رسام خرائط الراديو جاهز!',
 ...
 themeChanged: '🎨 المظهر ←',
 rssiLabel: 'RSSI:', coordLabel: 'الموقع:',
 txCount: 'أجهزة الإرسال:', obstacleCount: 'العوائق:',
 strong: 'قوي', weak: 'ضعيف',
 placeTx: 'وضع جهاز إرسال', addObstacle: 'إضافة عائق',
 clearMap: 'مسح الخريطة', exportMap: 'تصدير الخريطة',
 step1Title: 'وضع جهاز الإرسال', step1Desc: 'انقر على الخريطة لوضع جهاز إرسال راديو. يبث الإشارة في جميع الاتجاهات.',
 step2Title: 'قياس RSSI', step2Desc: 'حرّك المؤشر عبر الخريطة لقياس مؤشر قوة الإشارة المستقبلة في كل نقطة.',
 step3Title: 'استيفاء البيانات', step3Desc: 'تحسب المحاكاة قوة الإشارة لكل خلية في الشبكة باستخدام نموذج فقدان المسار اللوغاريتمي.',
 step4Title: 'إنشاء الخريطة الحرارية', step4Desc: 'كل خلية ملوّنة حسب قوة الإشارة: أحمر (قوي) عبر أصفر/أخضر إلى أزرق (ضعيف).',
 labMultiTx: '📡 أجهزة إرسال متعددة', labMultiTxDesc: 'ضع عدة أجهزة إرسال ولاحظ كيف ينشئ الإشارة المشتركة مناطق تغطية. انقر على "وضع جهاز إرسال" عدة مرات.',
 labObstacles: '🧱 جدران وعوائق', labObstaclesDesc: 'أضف عوائق جدارية تُضعف الإشارة. لاحظ كيف تنشئ الجدران مناطق ظل وتقلل التغطية خلفها.',
 attenuation: 'التخفيف (ديسيبل):',
 labFreq: '📶 مقارنة الترددات', labFreqDesc: 'قارن كيف تنتشر إشارات 2.4 جيجاهرتز و 900 ميجاهرتز بشكل مختلف. الترددات المنخفضة تخترق العوائق بشكل أفضل لكن عرض النطاق أقل.',
 labDeadZones: '🚫 إيجاد المناطق الميتة', labDeadZonesDesc: 'ابحث عن المناطق الزرقاء/الداكنة على الخريطة — هذه مناطق ميتة حيث الإشارة ضعيفة جدًا. هل يمكنك القضاء عليها بإعادة وضع أجهزة الإرسال؟',
 challengeIntro: 'اختبر مهاراتك في التخطيط الراديوي مع هذه التحديات:',
 ch1Title: 'تغطية كاملة', ch1Desc: 'اعثر على الموضع الأمثل لجهاز إرسال واحد لتحقيق تغطية كاملة (جميع الخلايا فوق -80 dBm). تلميح: الوسط ليس دائمًا الأفضل مع العوائق!',
 ch2Title: 'تحديد المنطقة الميتة', ch2Desc: 'ضع عائقين وجهاز إرسال واحد. اعثر على أكبر منطقة ميتة (المنطقة تحت -90 dBm) وحددها. كم عدد الخلايا المتأثرة؟',
 ch3Title: 'تخطيط 3 أجهزة إرسال', ch3Desc: 'صمم تخطيطًا بـ 3 أجهزة إرسال يوفر تغطية لـ 95% على الأقل من المنطقة. قلل التداخل والمناطق الميتة. صدّر أفضل خريطة لديك!',
 txPlaced: '📡 تم وضع جهاز إرسال في',
 obstaclePlaced: '🧱 تم وضع عائق',
...
/* ═══════ RADIO CARTOGRAPHER — HEATMAP SIMULATION ═══════ */
...
const HEATMAP = {
 ...
 cols: 0,
 rows: 0,
 transmitters: [], // [{x, y}] in grid coords
 obstacles: [], // [{x, y, w, h}] in grid coords
 txPower: -10, // dBm at 1m
 pathLossExp: 2.8, // n for log-distance model (indoors)
 noiseFloor: -100, // dBm
 obstacleAtt: 15, // dB per obstacle hit
 frequency: 2.4, // GHz (2.4 or 0.9)
 mode: 'idle', // 'idle' | 'placeTx' | 'placeObstacle'
 dragStart: null, // for obstacle drawing
 grid: null, // Float64Array of RSSI values
};

function initHeatmap() {
 HEATMAP.canvas = $('heatmapCanvas');
 if (!HEATMAP.canvas) return;
 HEATMAP.ctx = HEATMAP.canvas.getContext('2d');

 // Size canvas to container
 const container = $('heatmapContainer');
 if (container) {
 const rect = container.getBoundingClientRect();
 HEATMAP.canvas.width = Math.floor(rect.width);
 HEATMAP.canvas.height = 350;
 }

 HEATMAP.cols = Math.floor(HEATMAP.canvas.width / HEATMAP.cellSize);
 HEATMAP.rows = Math.floor(HEATMAP.canvas.height / HEATMAP.cellSize);
 HEATMAP.grid = new Float64Array(HEATMAP.cols * HEATMAP.rows);

 // Canvas events
 HEATMAP.canvas.addEventListener('click', onCanvasClick);
 HEATMAP.canvas.addEventListener('mousemove', onCanvasHover);
 HEATMAP.canvas.addEventListener('mousedown', onCanvasMouseDown);
 HEATMAP.canvas.addEventListener('mouseup', onCanvasMouseUp);
 HEATMAP.canvas.addEventListener('mouseleave', () => {
 const rv = $('rssiValue');
 const cv = $('coordValue');
 if (rv) rv.textContent = '— dBm';
 if (cv) cv.textContent = '—';
 });

 // Touch support for mobile
 HEATMAP.canvas.addEventListener('touchstart', e => {
 e.preventDefault();
 const touch = e.touches[0];
 const fakeEvt = { clientX: touch.clientX, clientY: touch.clientY, preventDefault: () => {} };
 onCanvasMouseDown(fakeEvt);
 }, { passive: false });
 HEATMAP.canvas.addEventListener('touchend', e => {
 e.preventDefault();
 const touch = e.changedTouches[0];
 const fakeEvt = { clientX: touch.clientX, clientY: touch.clientY };
 onCanvasMouseUp(fakeEvt);
 onCanvasClick(fakeEvt);
 }, { passive: false });

 // Buttons
 const txBtn = $('txPlaceBtn');
 const obsBtn = $('obstacleBtn');
 const clearBtn = $('clearMapBtn');
 const exportBtn = $('exportMapBtn');
 const attSlider = $('attenuationSlider');
 const attValue = $('attenuationValue');

 if (txBtn) txBtn.onclick = () => {
 HEATMAP.mode = 'placeTx';
 showToast(LANG[currentLang].placeTxMode, 3000);
 log(LANG[currentLang].placeTxMode, 'info');
 playSound('click');
 };
 if (obsBtn) obsBtn.onclick = () => {
 HEATMAP.mode = 'placeObstacle';
 showToast(LANG[currentLang].placeObstacleMode, 3000);
 log(LANG[currentLang].placeObstacleMode, 'info');
 playSound('click');
 };
 if (clearBtn) clearBtn.onclick = clearHeatmap;
 if (exportBtn) exportBtn.onclick = exportHeatmap;

 if (attSlider) {
 attSlider.oninput = () => {
 HEATMAP.obstacleAtt = parseInt(attSlider.value);
 if (attValue) attValue.textContent = attSlider.value + ' dB';
 recalcHeatmap();
 };
 }

 // Frequency toggle buttons
 const freq24 = $('freq24Btn');
 const freq900 = $('freq900Btn');
 if (freq24) freq24.onclick = () => setFrequency(2.4);
 if (freq900) freq900.onclick = () => setFrequency(0.9);
...
function setFrequency(ghz) {
 HEATMAP.frequency = ghz;
 // Adjust path loss exponent: higher freq = higher loss
 HEATMAP.pathLossExp = ghz >= 2.0 ? 2.8 : 2.2;

 const freq24 = $('freq24Btn');
 const freq900 = $('freq900Btn');
 if (freq24) freq24.classList.toggle('active', ghz >= 2.0);
 if (freq900) freq900.classList.toggle('active', ghz < 2.0);

 recalcHeatmap();
 const label = ghz >= 2.0 ? '2.4 GHz' : '900 MHz';
 log(`${LANG[currentLang].freqChanged} ${label}`, 'info');
 playSound('click');
}

function getCanvasCoords(e) {
 const rect = HEATMAP.canvas.getBoundingClientRect();
 const scaleX = HEATMAP.canvas.width / rect.width;
 const scaleY = HEATMAP.canvas.height / rect.height;
 const px = (e.clientX - rect.left) * scaleX;
 const py = (e.clientY - rect.top) * scaleY;
 return { px, py, col: Math.floor(px / HEATMAP.cellSize), row: Math.floor(py / HEATMAP.cellSize) };
}

function onCanvasClick(e) {
 if (HEATMAP.mode === 'placeTx') {
 const { col, row } = getCanvasCoords(e);
 if (col >= 0 && col < HEATMAP.cols && row >= 0 && row < HEATMAP.rows) {
 HEATMAP.transmitters.push({ x: col, y: row });
 HEATMAP.mode = 'idle';
 recalcHeatmap();
 updateTxInfo();
 log(`${LANG[currentLang].txPlaced} (${col}, ${row})`, 'success');
 playSound('success');
 setStatus(true);
 }
 }
...
function onCanvasMouseDown(e) {
 if (HEATMAP.mode === 'placeObstacle') {
 const { col, row } = getCanvasCoords(e);
 HEATMAP.dragStart = { col, row };
 }
}

function onCanvasMouseUp(e) {
 if (HEATMAP.mode === 'placeObstacle' && HEATMAP.dragStart) {
 const { col, row } = getCanvasCoords(e);
 const x1 = Math.min(HEATMAP.dragStart.col, col);
 const y1 = Math.min(HEATMAP.dragStart.row, row);
 const x2 = Math.max(HEATMAP.dragStart.col, col);
 const y2 = Math.max(HEATMAP.dragStart.row, row);
 const w = Math.max(x2 - x1, 1);
 const h = Math.max(y2 - y1, 1);
 HEATMAP.obstacles.push({ x: x1, y: y1, w, h });
 HEATMAP.dragStart = null;
 HEATMAP.mode = 'idle';
 recalcHeatmap();
 updateTxInfo();
 log(`${LANG[currentLang].obstaclePlaced} (${x1},${y1} ${w}x${h})`, 'info');
 playSound('click');
 }
}
...
function onCanvasHover(e) {
 const { col, row } = getCanvasCoords(e);
 if (col < 0 || col >= HEATMAP.cols || row < 0 || row >= HEATMAP.rows) return;

 const rssi = HEATMAP.grid[row * HEATMAP.cols + col];
 const rv = $('rssiValue');
 const cv = $('coordValue');
 if (rv) {
 const val = HEATMAP.transmitters.length > 0 ? rssi.toFixed(1) + ' dBm' : '— dBm';
 rv.textContent = val;
 rv.style.color = rssiToColor(rssi);
 }
 if (cv) cv.textContent = `(${col}, ${row})`;
}

// Check if line from (x1,y1) to (x2,y2) intersects obstacle rect
function lineIntersectsRect(x1, y1, x2, y2, rx, ry, rw, rh) {
 // Simple: count how many grid cells on the path are inside the obstacle
 ...
 hits++;
 break; // one hit per obstacle is enough
 }
 }
 return hits > 0;
}

function calcRSSI(col, row) {
 if (HEATMAP.transmitters.length === 0) return HEATMAP.noiseFloor;

 // Combined signal from all transmitters (power summing in linear domain)
 let linearSum = 0;

 for (const tx of HEATMAP.transmitters) {
 const dx = col - tx.x;
 const dy = row - tx.y;
 const distCells = Math.sqrt(dx * dx + dy * dy);
 const distMeters = Math.max(distCells * 0.5, 0.5); // each cell ~0.5m, min 0.5m

 // Log-distance path loss: RSSI = txPower - 10 * n * log10(d) + noise
 let rssi = HEATMAP.txPower - 10 * HEATMAP.pathLossExp * Math.log10(distMeters);

 // Add random noise (small)
 rssi += (Math.random() - 0.5) * 2;

 // Check obstacle attenuation
 for (const obs of HEATMAP.obstacles) {
 if (lineIntersectsRect(tx.x, tx.y, col, row, obs.x, obs.y, obs.w, obs.h)) {
 rssi -= HEATMAP.obstacleAtt;
 }
 }

 // Clamp to noise floor
 rssi = Math.max(rssi, HEATMAP.noiseFloor);

 // Convert to linear, sum
 linearSum += Math.pow(10, rssi / 10);
 }
...
function recalcHeatmap() {
 ...
 HEATMAP.grid[row * HEATMAP.cols + col] = calcRSSI(col, row);
 }
 }
 renderHeatmap();
}
...
function rssiToColor(rssi) {
 // Map RSSI range [-100, -10] to color
 const t = Math.max(0, Math.min(1, (rssi - (-100)) / ((-10) - (-100)))); // 0=weak, 1=strong

 let r, g, b;
 if (t > 0.75) {
 // Strong: red
 const u = (t - 0.75) / 0.25;
 r = 255; g = Math.round(255 * (1 - u) * 0.55); b = 0;
 } else if (t > 0.5) {
 // Medium-strong: orange to yellow
 const u = (t - 0.5) / 0.25;
 r = 255; g = Math.round(140 + 115 * (1 - u)); b = 0;
 } else if (t > 0.25) {
 // Medium: green
 const u = (t - 0.25) / 0.25;
 r = Math.round(255 * u); g = Math.round(200); b = Math.round(80 * (1 - u));
 } else {
 // Weak: blue
 const u = t / 0.25;
 r = 0; g = Math.round(100 * u); b = Math.round(200 - 80 * u);
 }
 return `rgb(${r},${g},${b})`;
}

function renderHeatmap() {
 const { ctx, canvas, cols, rows, cellSize, grid, transmitters, obstacles } = HEATMAP;
 ctx.clearRect(0, 0, canvas.width, canvas.height);
 ...
 const rssi = grid[row * cols + col];
 ctx.fillStyle = rssiToColor(rssi);
 ctx.fillRect(col * cellSize, row * cellSize, cellSize, cellSize);
 }
 }
 } else {
 // Draw grid lines when empty
 ...
 ctx.textAlign = 'center';
 ctx.fillText('Click "Place Transmitter" to start', canvas.width / 2, canvas.height / 2);
 }
 ...
 ctx.strokeRect(obs.x * cellSize, obs.y * cellSize, obs.w * cellSize, obs.h * cellSize);
 }

 // Draw transmitters
 for (const tx of transmitters) {
 const cx = tx.x * cellSize + cellSize / 2;
 const cy = tx.y * cellSize + cellSize / 2;
 // Outer ring
 ctx.beginPath();
 ...
 ctx.textAlign = 'center';
 ctx.fillText('TX', cx, cy - 14);
 }
}

function clearHeatmap() {
 HEATMAP.transmitters = [];
 HEATMAP.obstacles = [];
 HEATMAP.mode = 'idle';
 HEATMAP.grid.fill(HEATMAP.noiseFloor);
 renderHeatmap();
 updateTxInfo();
 setStatus(false);
...
function exportHeatmap() {
 ...
 link.download = `heatmap-${new Date().toISOString().slice(0,19).replace(/:/g,'-')}.png`;
 link.href = HEATMAP.canvas.toDataURL('image/png');
 link.click();
 log(LANG[currentLang].heatmapExported, 'success');
 playSound('success');
}

function updateTxInfo() {
 const txVal = $('txCountValue');
 const obsVal = $('obstacleCountValue');
 if (txVal) txVal.textContent = HEATMAP.transmitters.length;
 if (obsVal) obsVal.textContent = HEATMAP.obstacles.length;
}
