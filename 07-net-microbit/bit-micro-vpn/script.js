...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-E3F231',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Micro Vpn \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Micro Vpn', subtitle: '🛡️ encrypt · 🔗 tunnel · 🔐 protect',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Micro VPN — Encrypted Tunnel', mainDesc: 'Build an end-to-end encrypted relay network',
 ...
 howto_1:'The main display shows the Micro Vpn simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_e2e_title: '🔐 E2E Encryption', wiki_e2e: 'End-to-end encryption ensures only the sender and receiver can read the message. Intermediate nodes see only cipher text.',
 wiki_vpn_title: '🛡️ VPN Tunneling', wiki_vpn: 'A VPN creates an encrypted tunnel between two points. All traffic inside the tunnel is protected from eavesdropping.',
 wiki_relay_title: '📡 Relay Nodes', wiki_relay: 'Relays forward encrypted packets between endpoints. They cannot decrypt the payload without the key.',
 wiki_mitm_title: '🕵️ Man-in-the-Middle', wiki_mitm: 'A MITM attack intercepts traffic between two parties. E2E encryption defeats this because the attacker lacks the decryption key.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🛡️ Micro VPN ready!',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-E3F231',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Micro Vpn \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Micro Vpn', subtitle: '🛡️ chiffrer · 🔗 tunneliser · 🔐 protéger',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Micro VPN — Tunnel Chiffré', mainDesc: 'Construis un réseau relais chiffré de bout en bout',
 ...
 wiki_e2e_title: '🔐 Chiffrement E2E', wiki_e2e: 'Le chiffrement de bout en bout garantit que seuls l\'expéditeur et le destinataire peuvent lire le message. Les noeuds intermédiaires ne voient que du texte chiffré.',
 wiki_vpn_title: '🛡️ Tunnel VPN', wiki_vpn: 'Un VPN crée un tunnel chiffré entre deux points. Tout le trafic dans le tunnel est protégé contre l\'écoute.',
 wiki_relay_title: '📡 Noeuds Relais', wiki_relay: 'Les relais transmettent les paquets chiffrés entre les points. Ils ne peuvent pas déchiffrer la charge utile sans la clé.',
 wiki_mitm_title: '🕵️ Man-in-the-Middle', wiki_mitm: 'Une attaque MITM intercepte le trafic entre deux parties. Le chiffrement E2E la déjoue car l\'attaquant n\'a pas la clé.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🛡️ Micro VPN prêt !',
 ...
 theory: 'Micro Vpn démontre les principes clés de analyse spectrale. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 title: 'Micro Vpn', subtitle: '🛡️ شفّر · 🔗 أنشئ نفقًا · 🔐 احمِ',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'مايكرو VPN — نفق مشفّر', mainDesc: 'أنشئ شبكة ترحيل مشفّرة من الطرف إلى الطرف',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Micro Vpn. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_e2e_title: '🔐 تشفير E2E', wiki_e2e: 'التشفير من الطرف إلى الطرف يضمن أن المرسل والمستقبل فقط يمكنهما قراءة الرسالة. العقد الوسيطة ترى فقط نصًا مشفّرًا.',
 wiki_vpn_title: '🛡️ نفق VPN', wiki_vpn: 'VPN ينشئ نفقًا مشفّرًا بين نقطتين. كل حركة المرور داخل النفق محمية من التنصت.',
 wiki_relay_title: '📡 عقد الترحيل', wiki_relay: 'عقد الترحيل تنقل الحزم المشفّرة بين النقاط. لا يمكنها فك تشفير الحمولة بدون المفتاح.',
 wiki_mitm_title: '🕵️ الرجل في المنتصف', wiki_mitm: 'هجوم MITM يعترض حركة المرور بين طرفين. تشفير E2E يهزمه لأن المهاجم لا يملك مفتاح فك التشفير.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🛡️ مايكرو VPN جاهز!',
 ...
 theory: 'Micro Vpn يوضح المبادئ الأساسية في تحليل الطيف. Encryption transforms plaintext into ciphertext using a mathematical algorithm and a key. The strength depends on key length and algorithm choice. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. Scanning probes a system to discover active hosts, open ports, services, and vulnerabilities. Active scans send packets; passive scans only listen. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
...
const VPN_KEY = 'S3cR3tK3y!';
let vpnEncryptionEnabled = true;
let vpnLastCipher = '';
let vpnLastPlain = '';
let vpnHops = 1;
let vpnAnimating = false;
...
// Convert to hex display for relay view
function toHexDisplay(text) {
 let hex = '';
 for (let i = 0; i < text.length; i++) {
 hex += text.charCodeAt(i).toString(16).padStart(2, '0').toUpperCase();
 if (i < text.length - 1) hex += '';
 }
 return hex;
}

// Draw tunnel canvas
function drawTunnel(progress, hopCount, encrypted) {
 ...
 const totalNodes = hopCount + 2; // Alice + relays + Bob
 const nodeSpacing = dw / (totalNodes + 1);
 const nodes = [];
 for (let i = 0; i < totalNodes; i++) {
 nodes.push({ x: nodeSpacing * (i + 1), y: dh / 2 });
 }

 // Draw tunnel pipe
 const pipeY = dh / 2;
 const pipeH = 30;
 const pipeColor = encrypted ? 'rgba(76,175,80,0.15)' : 'rgba(244,67,54,0.15)';
 const pipeBorder = encrypted ? 'rgba(76,175,80,0.5)' : 'rgba(244,67,54,0.5)';

 ctx.fillStyle = pipeColor;
 ctx.strokeStyle = pipeBorder;
 ctx.lineWidth = 2;
 ctx.beginPath();
 ctx.roundRect(nodes[0].x, pipeY - pipeH / 2, nodes[nodes.length - 1].x - nodes[0].x, pipeH, 12);
 ctx.fill();
 ctx.stroke();

 // Dashed center line
 ctx.setLineDash([6, 4]);
 ctx.strokeStyle = encrypted ? 'rgba(76,175,80,0.3)' : 'rgba(244,67,54,0.3)';
 ctx.beginPath();
 ctx.moveTo(nodes[0].x + 10, pipeY);
 ctx.lineTo(nodes[nodes.length - 1].x - 10, pipeY);
 ctx.stroke();
 ctx.setLineDash([]);
 ...
 if (isFirst) ctx.fillStyle = 'rgba(76,175,80,0.3)';
 else if (isLast) ctx.fillStyle = 'rgba(33,150,243,0.3)';
 else ctx.fillStyle = 'rgba(255,152,0,0.3)';
 ctx.fill();

 ctx.strokeStyle = isFirst ? '#4caf50' : isLast ? '#2196f3' : '#ff9800';
 ctx.lineWidth = 2;
 ctx.stroke();

 // Node labels
 ctx.fillStyle = isFirst ? '#4caf50' : isLast ? '#2196f3' : '#ff9800';
 ctx.font = '20px sans-serif';
 ctx.textAlign = 'center';
 ctx.textBaseline = 'middle';
 if (isFirst) ctx.fillText('A', n.x, n.y);
 else if (isLast) ctx.fillText('B', n.x, n.y);
 else ctx.fillText('R' + i, n.x, n.y);

 // Label below
 ctx.font = '11px Tajawal, sans-serif';
 ctx.fillStyle = '#ccc';
 if (isFirst) ctx.fillText('Alice', n.x, n.y + 32);
 else if (isLast) ctx.fillText('Bob', n.x, n.y + 32);
 else ctx.fillText('Relay ' + i, n.x, n.y + 32);
 }

 // Animated packet
 if (progress > 0 && progress <= 1) {
 const totalDist = nodes[nodes.length - 1].x - nodes[0].x;
 const packetX = nodes[0].x + totalDist * progress;

 // Glow
 ctx.shadowColor = encrypted ? '#0f0' : '#f44';
 ctx.shadowBlur = 12;
 ctx.beginPath();
 ctx.arc(packetX, pipeY, 8, 0, Math.PI * 2);
 ctx.fillStyle = encrypted ? '#4caf50' : '#f44336';
 ctx.fill();
 ctx.shadowBlur = 0;
 ...
 ctx.textAlign = 'center';
 ctx.textBaseline = 'middle';
 ctx.fillText(encrypted ? '🔒' : '📄', packetX, pipeY - 16);
 }
 ...
 ctx.textAlign = 'center';
 ctx.fillStyle = encrypted ? '#4caf50' : '#f44336';
 ctx.fillText(encrypted ? ('🔒 ' + s.tunnelSecure) : ('🔓 ' + s.tunnelInsecure), dw / 2, 18);
}

// Animate packet through tunnel
async function animateTunnel(hopCount, encrypted) {
 vpnAnimating = true;
 const steps = 60;
 for (let i = 0; i <= steps; i++) {
 if (!vpnAnimating) break;
 drawTunnel(i / steps, hopCount, encrypted);
 await sleep(25);
 }
 vpnAnimating = false;
}
...
async function vpnSendMessage() {
 const input = $('vpnMsgInput');
 const s = LANG[currentLang];
 if (!input || !input.value.trim()) {
 showToast(s.enterMsg, 2000);
 return;
 }

 const plaintext = input.value.trim();
 vpnLastPlain = plaintext;
 const encrypted = vpnEncryptionEnabled;
 const hops = vpnHops;

 setStatus(true);
 log('🔒 ' + s.aliceEncrypts, 'tx');

 let cipherText = plaintext;
 if (encrypted) {
 cipherText = xorEncrypt(plaintext, VPN_KEY);
 vpnLastCipher = cipherText;
 } else {
 vpnLastCipher = '';
 }
 ...
 if (relayView) {
 if (encrypted) {
 relayView.textContent = toHexDisplay(cipherText);
 relayView.style.color = '#0f0';
 } else {
 relayView.textContent = plaintext;
 relayView.style.color = '#f44';
 }
 }

 // Animate
 showToast(s.packetSent, 2000);
 playSound('click');
 await animateTunnel(hops, encrypted);

 // Log relay status
 for (let i = 1; i <= hops; i++) {
 if (encrypted) {
 log('📡 Relay ' + i + ': ' + s.relayForwarded, 'info');
 } else {
 log('📡 Relay ' + i + ': ' + s.relayReadPlain, 'error');
 }
 }
 ...
 if (receiverView) {
 if (encrypted) {
 const decrypted = xorEncrypt(cipherText, VPN_KEY);
 receiverView.textContent = decrypted;
 receiverView.style.color = '#2196f3';
 log('👤 Bob: ' + s.bobDecrypted, 'success');
 } else {
 receiverView.textContent = plaintext;
 receiverView.style.color = '#ff9800';
 log('👤 Bob: ' + s.bobReceived, 'info');
 }
 }
...
function vpnMitmAttack() {
 const s = LANG[currentLang];
 const result = $('mitmResult');
 if (!result) return;

 if (!vpnLastPlain) {
 showToast(s.noMsgToSniff, 2000);
 return;
 }

 if (vpnEncryptionEnabled && vpnLastCipher) {
 result.innerHTML = '<div class="mitm-indicator mitm-fail">🔒 ' + s.mitmBlocked + '</div>' +
 '<div class="encrypted-text" style="margin-top:6px">' + toHexDisplay(vpnLastCipher) + '</div>';
 log('🕵️ ' + s.mitmBlocked, 'success');
 playSound('success');
 } else {
 result.innerHTML = '<div class="mitm-indicator mitm-success">🔓 ' + s.mitmExposed + '</div>' +
 '<div class="encrypted-text" style="margin-top:6px;color:#f44">' + vpnLastPlain + '</div>';
 log('🕵️ ' + s.mitmExposed, 'error');
 playSound('error');
 }
}

// Toggle encryption state
function vpnToggleEncryption() {
 const toggle = $('encToggle');
 const indicator = $('encIndicator');
 const s = LANG[currentLang];

 vpnEncryptionEnabled = toggle ? toggle.checked : !vpnEncryptionEnabled;

 if (indicator) {
 if (vpnEncryptionEnabled) {
 indicator.textContent = '🔒';
 indicator.className = 'padlock locked';
 } else {
 indicator.textContent = '🔓';
 indicator.className = 'padlock unlocked';
 }
 }

 // Update label text
 const label = toggle ? toggle.parentElement.querySelector('[data-i18n]') : null;
 if (label) {
 label.textContent = vpnEncryptionEnabled ? s.encryptionOn : s.encryptionOff;
 label.dataset.i18n = vpnEncryptionEnabled ? 'encryptionOn' : 'encryptionOff';
 }

 log(vpnEncryptionEnabled ? '🔒 ' + s.encryptionOn : '🔓 ' + s.encryptionOff, vpnEncryptionEnabled ? 'success' : 'error');
 drawTunnel(0, vpnHops, vpnEncryptionEnabled);
 setStatus(vpnEncryptionEnabled);
}

// Initialize VPN controls
function initVPN() {
 // Send button
 const sendBtn = $('vpnSendBtn');
 if (sendBtn) sendBtn.onclick = vpnSendMessage;

 // Enter key on input
 const input = $('vpnMsgInput');
 if (input) input.addEventListener('keydown', e => {
 if (e.key === 'Enter') vpnSendMessage();
 });

 // Encryption toggle
 const encToggle = $('encToggle');
 if (encToggle) encToggle.addEventListener('change', vpnToggleEncryption);

 // Hop slider
 const hopSlider = $('hopSlider');
 const hopCount = $('hopCount');
 if (hopSlider) {
 hopSlider.addEventListener('input', () => {
 vpnHops = parseInt(hopSlider.value);
 if (hopCount) hopCount.textContent = vpnHops;
 drawTunnel(0, vpnHops, vpnEncryptionEnabled);
 });
 }

 // MITM button
 const mitmBtn = $('mitmBtn');
 if (mitmBtn) mitmBtn.onclick = vpnMitmAttack;

 // Initial draw
 setTimeout(() => drawTunnel(0, vpnHops, vpnEncryptionEnabled), 100);
}
