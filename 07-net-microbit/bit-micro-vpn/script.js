...
const LANG = {
  en: {
    ...
    howto_4: 'Try the MITM attack button to simulate an attacker sniffing the relay.',
  ...
  fr: {
    ...
    howto_4: 'Essaie le bouton attaque MITM pour simuler un espion sur le relais.',
  ...
  ar: {
    ...
    howto_4: 'جرّب زر هجوم MITM لمحاكاة تجسس المهاجم على الترحيل.',
