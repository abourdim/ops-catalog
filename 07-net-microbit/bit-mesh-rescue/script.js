/**
 * bit-mesh-rescue — Workshop DIY v1.0
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-00F3DF',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Mesh Rescue \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Mesh Rescue', subtitle: '🔄 mesh · 🛡️ rescue · 💡 resilience',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Mesh Rescue — Self-Healing Network', mainDesc: 'Build networks that survive node failures',
 ...
 howto_1:'The main display shows the Mesh Rescue simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_mesh_title: '🔄 Self-Healing Networks', wiki_mesh: 'A self-healing network detects node or link failures and automatically reconfigures to maintain connectivity without human intervention.',
 wiki_heartbeat_title: '💓 Heartbeat Protocol', wiki_heartbeat: 'Nodes periodically send heartbeat signals to neighbors. Missing heartbeats indicate a failed node, triggering route recalculation.',
 wiki_routing_title: '🔀 Redundant Routing', wiki_routing: 'Mesh networks maintain multiple paths between nodes. When one path fails, traffic is rerouted through alternate paths automatically.',
 wiki_fault_title: '🛡️ Fault Tolerance', wiki_fault: 'A fault-tolerant system continues operating even when components fail. Redundancy and self-healing are key strategies.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🔄 Mesh Rescue ready!',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-00F3DF',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Mesh Rescue \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Mesh Rescue', subtitle: '🔄 mesh · 🛡️ sauvetage · 💡 resilience',
 disconnected: 'Deconnecte', connected: 'Connecte',
 mainSection: 'Mesh Rescue — Reseau Auto-Reparant', mainDesc: 'Construis des reseaux qui survivent aux pannes',
 ...
 wiki_mesh_title: '🔄 Reseaux Auto-Reparants', wiki_mesh: 'Un reseau auto-reparant detecte les pannes de noeuds ou de liens et se reconfigure automatiquement pour maintenir la connectivite.',
 wiki_heartbeat_title: '💓 Protocole Heartbeat', wiki_heartbeat: 'Les noeuds envoient periodiquement des signaux heartbeat a leurs voisins. Des heartbeats manquants indiquent une panne.',
 wiki_routing_title: '🔀 Routage Redondant', wiki_routing: 'Les reseaux mesh maintiennent plusieurs chemins entre les noeuds. Quand un chemin echoue, le trafic est reroute automatiquement.',
 wiki_fault_title: '🛡️ Tolerance aux Pannes', wiki_fault: 'Un systeme tolerant aux pannes continue de fonctionner meme quand des composants tombent en panne. La redondance et l\'auto-reparation sont des strategies cles.',
 working: 'En cours…',
 t_mosque: 'Mosquee', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🔄 Mesh Rescue pret !',
 ...
 themeChanged: '🎨 Theme →',
 addNode: 'Ajouter Noeud', killNode: 'Detruire Noeud', healNetwork: 'Reparer Reseau', testMessage: 'Tester Message',
 networkHealth: 'Sante du Reseau', activePaths: 'Chemins Actifs :', failedNodes: 'Noeuds en Panne :',
 legendActive: 'Actif', legendFailed: 'En panne', legendHealing: 'Reparation',
 howWork1: 'Les noeuds maintiennent une table de voisins listant tous les pairs directement connectes et la qualite du lien.',
 howWork2: 'Chaque noeud envoie des signaux heartbeat periodiques. Si un voisin manque plusieurs battements, il est marque comme en panne.',
 howWork3: 'Quand une panne est detectee, le reseau recalcule les routes alternatives avec un algorithme BFS.',
 howWork4: 'De nouveaux chemins sont etablis a travers les noeuds survivants, restaurant la connectivite — le reseau s\'est auto-repare.',
 lab1: 'Construis un reseau de 5-10 noeuds avec le bouton "Ajouter Noeud". Les noeuds se connectent automatiquement aux voisins.',
 lab2: 'Clique sur "Detruire Noeud" puis clique sur un noeud du canevas pour simuler une panne. Les connexions deviennent rouges.',
 lab3: 'Appuie sur "Reparer Reseau" et observe comment le BFS trouve de nouvelles routes. Mesure le temps de recuperation.',
 lab4: 'Test de stress : detruis rapidement plusieurs noeuds et utilise "Tester Message" pour verifier si le reseau fonctionne encore.',
 challenge1: 'Construis un reseau qui survit a 50% de panne de noeuds et peut encore livrer un message test.',
 challenge2: 'Trouve le point unique de defaillance (SPOF) : identifie quel noeud, s\'il tombe, deconnecte le reseau.',
 challenge3: 'Concois un reseau totalement redondant sans SPOF — chaque noeud doit avoir au moins 2 chemins independants vers chaque autre noeud.',
 nodeAdded: 'Noeud #{id} ajoute',
 nodeKilled: 'Noeud #{id} DETRUIT — connexions perdues',
 healStart: 'Reparation du reseau — recalcul des routes via BFS...',
 healComplete: 'Reseau repare ! {n} nouveaux chemins etablis en {t}ms',
 healNone: 'Aucune reparation necessaire — reseau sain',
 msgSent: 'Message envoye : {from} → {to} via {path}',
 msgFail: 'Message ECHOUE — aucun chemin entre {from} et {to}',
 killModeOn: 'Mode destruction ON — clique sur un noeud pour le detruire',
 killModeOff: 'Mode destruction OFF',
 noNodes: 'Ajoute d\'abord des noeuds !',
 tooFewNodes: 'Il faut au moins 2 noeuds pour tester la messagerie',step1Title:'Scanner',step1Desc:'Le réseau est scanné pour découvrir les appareils et services actifs. Regardez la visualisation se mettre à jour en temps réel pendant cette étape. L affichage montre exactement ce qui se passe en interne — chaque couleur et mouvement représente une transformation.',step2Title:'Capturer',step2Desc:'Les paquets réseau sont interceptés et capturés pour analyse. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',step3Title:'Analyser',step3Desc:'Les données des paquets sont analysées pour révéler protocoles et adresses. Cette étape transforme les données d entrée selon l algorithme affiché. Comparez les valeurs avant et après pour comprendre la relation mathématique.',step4Title:'Rapporter',step4Desc:'Les résultats sont visualisés sous forme de graphiques ou rapports. Le résultat de cette étape alimente la suivante. Essayez de faire pause ici pour examiner l état intermédiaire.',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que Mesh Rescue ?',faq_a1:'Mesh Rescue est une simulation interactive qui démontre les concepts de analyse spectrale. Build networks that survive node failures. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de réseaux. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de réseaux. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut BBC micro:bit V2. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de réseaux. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans Mesh Rescue ! Regarde l\'écran principal — c\'est ici que la simulation de réseaux fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de réseaux.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Protocoles réseau',learn1Desc:'Comment les ordinateurs communiquent avec des protocoles. La simulation donne vie à ce concept par la visualisation interactive. Au lieu de le lire dans un livre, vous le voyez se produire en temps réel et contrôlez les variables.',learn1Tag:'Réseau',learn2Title:'Analyse de paquets',learn2Desc:'Comment les données sont découpées en paquets. Ce principe se connecte à de nombreuses applications réelles. Les ingénieurs et chercheurs utilisent ces connaissances quotidiennement.',learn2Tag:'Données',learn3Title:'Scan réseau',learn3Desc:'How to discover devices and services on a network. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Découverte',learn4Title:'Sécurité réseau',learn4Desc:'How to spot and stop network attacks. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Sécurité',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Débutant 🟢',learnLevel:'Niveau :',learnTimeVal:'15 min ⏱',learnTime:'Durée :',learnAgeVal:'10+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Mesh Rescue ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de analyse spectrale — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how The network is scanned to discover active devices Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de réseaux par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',ch1Title:'Trace de Paquets',ch1Desc:'Envoie un message et trace chaque saut. Combien de nœuds traverse-t-il ? Que se passe-t-il si un tombe ?',ch2Title:'Chasse à la Latence',ch2Desc:'Trouve le goulot d\'étranglement en mesurant la latence à chaque nœud. Quel lien est le plus lent et pourquoi ?',ch3Title:'Audit de Sécurité',ch3Desc:'Trouve le canal non chiffré dans le réseau. Quelles informations vois-tu ? Comment le corriger ?',codeTitle:'Code de Démarrage',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'Ce code active la radio du micro:bit sur le groupe 42 à pleine puissance. Quand le bouton A est pressé, il diffuse "HELLO". Tout message reçu défile sur l\'écran LED. Les numéros de groupe fonctionnent comme des canaux.',purpose:'Mesh Rescue : Build networks that survive node failures. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'Defi Demodulation',related1_desc:'Identifiez la modulation, decodez le message',related1_path:'../../27-sdr-dsp/sdr-demod-challenge/index.html',related2_name:'Carte Foudre',related2_desc:'Détecter les impacts de foudre',related2_path:'../../29-sdr-aviation/sdr-lightning/index.html',related3_name:'Pipeline Recepteur',related3_desc:'DSP etape par etape: antenne vers sortie audio',related3_path:'../../33-sdr-learning/sdr-build-receiver/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'BLE Mesh Chat — Messagerie Multi-Sauts',pathPrev_path:'../../07-net-microbit/bit-ble-mesh-chat/index.html',pathNext_name:'Micro VPN — Tunnel Chiffré',pathNext_path:'../../07-net-microbit/bit-micro-vpn/index.html',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Quel langage est couramment utilisé pour programmer le micro:bit ?',quiz_q1a:'Java',quiz_q1b:'MicroPython',quiz_q1c:'Ruby',quiz_q1d:'Swift',quiz_q1_answer:'1',quiz_q2:'Quel processeur utilise le micro:bit V2 ?',quiz_q2a:'ATmega328',quiz_q2b:'nRF52833',quiz_q2c:'ESP32',quiz_q2d:'STM32',quiz_q2_answer:'1',quiz_q3:'Que signifie IA ?',quiz_q3a:'Entrée automatisée',quiz_q3b:'Intelligence Artificielle',quiz_q3c:'Interface analogique',quiz_q3d:'Intégration active',quiz_q3_answer:'1',quiz_q4:'Combien de LEDs a l\'écran du micro:bit ?',quiz_q4a:'16',quiz_q4b:'25',quiz_q4c:'36',quiz_q4d:'64',quiz_q4_answer:'1',quiz_q5:'Qu\'est-ce qu\'un réseau de neurones ?',quiz_q5a:'Fils physiques',quiz_q5b:'Système informatique inspiré des neurones',quiz_q5c:'Réseau social',quiz_q5d:'Réseau radio',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'Voyager 1, lancé en 1977, communique depuis 24 milliards de km avec un émetteur de 23 watts. Les signaux prennent plus de 22 heures dans chaque sens.',realworld2:'Le LHC du CERN génère 1 pétaoctet par seconde lors des collisions. En 2012, il a confirmé le boson de Higgs, complétant le Modèle standard de la physique.',realworld3:'LIGO a détecté des ondes gravitationnelles en 2015, confirmant la prédiction centenaire d\'Einstein. Les capteurs ont mesuré des distorsions de l\'espace-temps de 10⁻²¹ mètres.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En suivi satellite, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en suivi satellite et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'Mesh Rescue illustre un concept fondamental en suivi satellite. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans Mesh Rescue ont des applications directes dans le monde réel. Les professionnels de suivi satellite utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, SDR et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en suivi satellite implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'Enregistrez d\x27abord les données IQ brutes, analysez ensuite. Vous pouvez toujours retraiter les fichiers IQ sauvegardés avec différents réglages.',proTip2:'Utilisez la moyenne FFT (16-64 trames) pour distinguer les vrais signaux des variations du bruit de fond.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'Une étoile à neutrons est si dense qu\x27une cuillère à café de sa matière pèserait environ 6 milliards de tonnes sur Terre.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de analyse spectrale',
 wiki_history: 'Paul Baran invented packet switching in 1964 for nuclear-survivable communication. ARPANET (1969) proved the concept, evolving into the Internet. Mesh Rescue s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Mesh Rescue',
 wiki_math: 'Les mathématiques derrière Mesh Rescue : Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time. Scanning n ports on m hosts requires n×m probes. Parallelism and timeouts determine scan duration: T = (n×m×timeout)/concurrency. In a mesh of N nodes, maximum links = N(N-1)/2. Routing algorithms (AODV, OLSR) find optimal paths. Flooding requires O(N) transmissions per message.',
 ...
 title: 'Mesh Rescue', subtitle: '🔄 شبكة · 🛡️ إنقاذ · 💡 مرونة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'إنقاذ الشبكة — شبكة ذاتية الإصلاح', mainDesc: 'ابنِ شبكات تصمد أمام فشل العقد',
 sectionA: 'كيف تعمل', sectionB: 'المختبر', sectionC: 'التحدي',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Mesh Rescue. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
 ...
 wiki_mesh_title: '🔄 الشبكات ذاتية الإصلاح', wiki_mesh: 'الشبكة ذاتية الإصلاح تكتشف أعطال العقد أو الروابط وتعيد تكوين نفسها تلقائيًا للحفاظ على الاتصال.',
 wiki_heartbeat_title: '💓 بروتوكول نبضات القلب', wiki_heartbeat: 'ترسل العقد إشارات نبض دورية إلى الجيران. النبضات المفقودة تشير إلى عقدة معطلة، مما يؤدي إلى إعادة حساب المسار.',
 wiki_routing_title: '🔀 التوجيه المتكرر', wiki_routing: 'شبكات الميش تحافظ على مسارات متعددة بين العقد. عندما يفشل مسار، يتم إعادة توجيه حركة المرور تلقائيًا.',
 wiki_fault_title: '🛡️ تحمّل الأعطال', wiki_fault: 'النظام المتحمل للأعطال يستمر في العمل حتى عند فشل المكونات. التكرار والإصلاح الذاتي هما استراتيجيتان رئيسيتان.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🔄 إنقاذ الشبكة جاهز!',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'تحدي ازالة التعديل',related1_desc:'حدد التعديل وفك تشفير الرسالة',related1_path:'../../27-sdr-dsp/sdr-demod-challenge/index.html',related2_name:'خريطة البرق',related2_desc:'كشف ضربات البرق',related2_path:'../../29-sdr-aviation/sdr-lightning/index.html',related3_name:'خط انابيب المستقبل',related3_desc:'DSP خطوة بخطوة: من الهوائي الى الصوت',related3_path:'../../33-sdr-learning/sdr-build-receiver/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'دردشة BLE الشبكية — رسائل متعددة القفزات',pathPrev_path:'../../07-net-microbit/bit-ble-mesh-chat/index.html',pathNext_name:'مايكرو VPN — نفق مشفّر',pathNext_path:'../../07-net-microbit/bit-micro-vpn/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ما اللغة الشائعة لبرمجة micro:bit؟',quiz_q1a:'جافا',quiz_q1b:'مايكروبايثون',quiz_q1c:'روبي',quiz_q1d:'سويفت',quiz_q1_answer:'1',quiz_q2:'ما المعالج الذي يستخدمه micro:bit V2؟',quiz_q2a:'ATmega328',quiz_q2b:'nRF52833',quiz_q2c:'ESP32',quiz_q2d:'STM32',quiz_q2_answer:'1',quiz_q3:'ماذا تعني AI؟',quiz_q3a:'إدخال آلي',quiz_q3b:'الذكاء الاصطناعي',quiz_q3c:'واجهة تناظرية',quiz_q3d:'تكامل نشط',quiz_q3_answer:'1',quiz_q4:'كم عدد مصابيح LED في شاشة micro:bit؟',quiz_q4a:'16',quiz_q4b:'25',quiz_q4c:'36',quiz_q4d:'64',quiz_q4_answer:'1',quiz_q5:'ما هي الشبكة العصبية؟',quiz_q5a:'أسلاك مادية',quiz_q5b:'نظام حوسبة مستوحى من الخلايا العصبية',quiz_q5c:'شبكة اجتماعية',quiz_q5d:'شبكة راديو',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'يتواصل المسبار فويجر 1 الذي أُطلق عام 1977 من مسافة 24 مليار كم باستخدام مرسل بقدرة 23 واط. تستغرق الإشارات أكثر من 22 ساعة في كل اتجاه.',realworld2:'يولد مصادم الهادرونات الكبير في سيرن 1 بيتابايت في الثانية أثناء التصادمات. في عام 2012 أكد بوزون هيغز مكملاً النموذج القياسي للفيزياء.',realworld3:'رصد مرصد ليغو موجات الجاذبية عام 2015 مؤكدًا تنبؤ أينشتاين قبل 100 عام. قاست المستشعرات تشوهات في الزمكان بمقدار 10⁻²¹ متر.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في تتبع الأقمار معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في تتبع الأقمار وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Mesh Rescue يوضح مفهومًا أساسيًا في تتبع الأقمار. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Mesh Rescue لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في تتبع الأقمار هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ SDR وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال تتبع الأقمار يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'سجّل بيانات IQ الخام أولاً وحللها لاحقًا. يمكنك دائمًا إعادة معالجة ملفات IQ المحفوظة بإعدادات مختلفة.',proTip2:'استخدم متوسط FFT من 16-64 إطارًا لتمييز الإشارات الحقيقية عن تغيرات أرضية الضوضاء.',funFactTitle:'🎯 هل تعلم؟',funFact:'النجم النيوتروني كثيف لدرجة أن ملعقة صغيرة من مادته ستزن حوالي 6 مليارات طن على الأرض.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
const CONNECT_DISTANCE = 150; // max px distance for auto-connect
...
class MeshNode {
 ...
 this.x = x;
 this.y = y;
 this.status = 'active'; // active | failed | healing
 this.neighbors = [];
 this.pulseRadius = 0;
 this.pulseAlpha = 0;
 }
...
function initMeshSim() {
 ...
 meshCanvas = $('networkCanvas');
 if (!meshCanvas || !wrap) return;
 ...
 meshCtx.scale(window.devicePixelRatio || 1, window.devicePixelRatio || 1);
 ...
 const killBtn = $('killNodeBtn');
 const healBtn = $('healBtn');
 const testBtn = $('testMsgBtn');

 if (addBtn) addBtn.onclick = () => { addMeshNode(); playSound('click'); };
 if (killBtn) killBtn.onclick = () => {
 killMode = !killMode;
 if (killBtn) killBtn.classList.toggle('active', killMode);
 const s = LANG[currentLang];
 log(killMode ? s.killModeOn : s.killModeOff, killMode ? 'error' : 'info');
 meshCanvas.style.cursor = killMode ? 'crosshair' : 'default';
 playSound('click');
 };
 if (healBtn) healBtn.onclick = () => { healNetwork(); };
 if (testBtn) testBtn.onclick = () => { testMessage(); playSound('click'); };

 // Start heartbeat animation
 heartbeatInterval = setInterval(() => {
 heartbeatPhase = (heartbeatPhase + 1) % 60;
 drawMesh();
 }, 50);

 // Add 5 starter nodes
 for (let i = 0; i < 5; i++) {
 const w = meshCanvas.getBoundingClientRect().width;
 const h = meshCanvas.getBoundingClientRect().height;
 const padding = 40;
 const x = padding + Math.random() * (w - 2 * padding);
 const y = padding + Math.random() * (h - 2 * padding);
 const node = new MeshNode(meshNextId++, x, y);
 meshNodes.push(node);
 }
 autoConnect();
 updateHealthMeter();
...
function addMeshNode() {
 ...
 drawMesh();
 const s = LANG[currentLang];
 log(s.nodeAdded.replace('{id}', node.id), 'success');
}
...
function autoConnectNode(node) {
 ...
 if (!other.neighbors.includes(node.id)) other.neighbors.push(node.id);
 }
 }
}
...
function findNodeAt(mx, my) {
 ...
 const n = meshNodes[i];
 if (Math.hypot(n.x - mx, n.y - my) <= NODE_RADIUS + 4) return n;
 }
 return null;
}
...
function killNodeById(id) {
 ...
 for (const other of meshNodes) {
 other.neighbors = other.neighbors.filter(nid => nid !== id);
 }
 node.neighbors = [];
 updateHealthMeter();
 drawMesh();
 const s = LANG[currentLang];
 log(s.nodeKilled.replace('{id}', id), 'error');
 playSound('error');
}

function healNetwork() {
 const s = LANG[currentLang];
 const failedNodes = meshNodes.filter(n => n.status === 'failed');
 if (failedNodes.length === 0) {
 log(s.healNone, 'info');
 showToast(s.healNone, 2000);
 return;
 }

 log(s.healStart, 'info');
 showToast(s.healStart);
 const startTime = performance.now();

 // Healing animation: transition failed → healing → active
 let newPaths = 0;
 failedNodes.forEach((node, idx) => {
 setTimeout(() => {
 node.status = 'healing';
 drawMesh();
 }, idx * 300);
 ...
 node.status = 'active';
 autoConnectNode(node);
 newPaths += node.neighbors.length;
 updateHealthMeter();
 drawMesh();

 // Last node healed?
 if (idx === failedNodes.length - 1) {
 const elapsed = Math.round(performance.now() - startTime);
 log(s.healComplete.replace('{n}', newPaths).replace('{t}', elapsed), 'success');
 showToast(s.healComplete.replace('{n}', newPaths).replace('{t}', elapsed), 3000);
 playSound('success');
 }
 }, idx * 300 + 500);
 });
...
function testMessage() {
 const s = LANG[currentLang];
 const active = meshNodes.filter(n => n.status === 'active');
 if (active.length < 2) {
 log(s.tooFewNodes, 'error');
 return;
 }

 // Pick two random active nodes
 const fromNode = active[Math.floor(Math.random() * active.length)];
 let toNode;
 do {
 toNode = active[Math.floor(Math.random() * active.length)];
 ...
 log(s.msgSent.replace('{from}', fromNode.id).replace('{to}', toNode.id).replace('{path}', pathStr), 'success');
 animateMessagePath(path);
 playSound('success');
 } else {
 log(s.msgFail.replace('{from}', fromNode.id).replace('{to}', toNode.id), 'error');
 playSound('error');
 }
}
...
function bfsPath(startId, endId) {
 ...
 const node = meshNodes.find(n => n.id === current);
 if (!node) continue;
...
let msgAnimPath = null;
let msgAnimStep = 0;
let msgAnimTimer = null;

function animateMessagePath(path) {
 msgAnimPath = path;
 msgAnimStep = 0;
 if (msgAnimTimer) clearInterval(msgAnimTimer);
 msgAnimTimer = setInterval(() => {
 msgAnimStep++;
 drawMesh();
 if (msgAnimStep >= path.length) {
 clearInterval(msgAnimTimer);
 msgAnimTimer = null;
 setTimeout(() => { msgAnimPath = null; drawMesh(); }, 800);
 }
 }, 400);
}
...
function updateHealthMeter() {
 ...
 const activeCount = meshNodes.filter(n => n.status === 'active').length;
 const failedCount = meshNodes.filter(n => n.status === 'failed').length;
 ...
 // Max possible edges = n*(n-1)/2 for active nodes
 const maxEdges = activeCount > 1 ? (activeCount * (activeCount - 1)) / 2 : 1;
 const health = total > 0 ? Math.round((activeCount / total) * 100) : 100;

 const fill = $('healthFill');
 const label = $('healthLabel');
 const pathVal = $('pathValue');
 const failVal = $('failedValue');

 if (fill) {
 fill.style.width = health + '%';
 if (health > 70) fill.style.background = '#22c55e';
 else if (health > 40) fill.style.background = '#eab308';
 else fill.style.background = '#ef4444';
 }
 if (label) label.textContent = health + '%';
 if (pathVal) pathVal.textContent = activeEdges;
 if (failVal) failVal.textContent = failedCount;
}
...
function drawMesh() {
 ...
 drawnEdges.add(key);
 const other = meshNodes.find(n => n.id === nid);
 if (!other) continue;

 meshCtx.beginPath();
 meshCtx.moveTo(node.x, node.y);
 meshCtx.lineTo(other.x, other.y);

 // Highlight message path
 if (msgAnimPath) {
 const idxA = msgAnimPath.indexOf(node.id);
 const idxB = msgAnimPath.indexOf(nid);
 if (idxA >= 0 && idxB >= 0 && Math.abs(idxA - idxB) === 1 && Math.max(idxA, idxB) <= msgAnimStep) {
 ...
 if (node.status === 'healing' || other.status === 'healing') {
 meshCtx.strokeStyle = '#eab308';
 meshCtx.lineWidth = 1.5;
 meshCtx.setLineDash([4, 4]);
 } else {
 meshCtx.strokeStyle = accent;
 meshCtx.lineWidth = 1;
 meshCtx.setLineDash([]);
 }
 meshCtx.globalAlpha = 0.4;
 meshCtx.stroke();
 ...
 // Draw nodes
 for (const node of meshNodes) {
 const colors = { active: '#22c55e', failed: '#ef4444', healing: '#eab308' };
 const color = colors[node.status] || '#888';

 // Heartbeat pulse for active nodes
 if (node.status === 'active') {
 const pulse = Math.sin(heartbeatPhase * 0.1 + node.id) * 0.5 + 0.5;
 meshCtx.beginPath();
 meshCtx.arc(node.x, node.y, NODE_RADIUS + 4 + pulse * 6, 0, Math.PI * 2);
 meshCtx.fillStyle = color;
 meshCtx.globalAlpha = 0.08 + pulse * 0.07;
 meshCtx.fill();
 meshCtx.globalAlpha = 1;
 }
 ...
 const glow = Math.sin(heartbeatPhase * 0.2) * 0.5 + 0.5;
 meshCtx.beginPath();
 meshCtx.arc(node.x, node.y, NODE_RADIUS + 8, 0, Math.PI * 2);
 meshCtx.fillStyle = '#eab308';
 meshCtx.globalAlpha = glow * 0.2;
 meshCtx.fill();
 meshCtx.globalAlpha = 1;
 }

 // Message packet highlight
 if (msgAnimPath && msgAnimStep < msgAnimPath.length && msgAnimPath[msgAnimStep] === node.id) {
 meshCtx.beginPath();
 meshCtx.arc(node.x, node.y, NODE_RADIUS + 10, 0, Math.PI * 2);
 ...
 // Node circle
 meshCtx.beginPath();
 meshCtx.arc(node.x, node.y, NODE_RADIUS, 0, Math.PI * 2);
 meshCtx.fillStyle = color;
 meshCtx.globalAlpha = node.status === 'failed' ? 0.4 : 0.9;
 meshCtx.fill();
 meshCtx.globalAlpha = 1;
 ...
 meshCtx.font = 'bold 11px Orbitron, monospace';
 meshCtx.textAlign = 'center';
 meshCtx.textBaseline = 'middle';
 meshCtx.fillText(node.id, node.x, node.y);
 }
}
