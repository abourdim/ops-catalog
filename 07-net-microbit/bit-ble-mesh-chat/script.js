...
const LANG = {
  en: {
    ...
    howto_1: 'Adjust the node count slider to create your mesh network, then observe the topology on the canvas.',
  ...
  fr: {
    ...
    howto_1: 'Ajuste le curseur de nœuds pour créer ton réseau maillé, puis observe la topologie sur le canevas.',
  ...
  ar: {
    ...
    howto_1: 'اضبط شريط تمرير العقد لإنشاء شبكتك المعشقة، ثم راقب الطوبولوجيا على اللوحة.',
