...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-02C5F3',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Ble Mesh Chat \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Ble Mesh Chat', subtitle: '🕸️ mesh · 📡 relay · 💬 chat',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'BLE Mesh Chat — Multi-Hop Messaging', mainDesc: 'Relay messages across a mesh network of nodes',
 ...
 howto_1: 'The main display shows the Ble Mesh Chat simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how The network is scanned to discover active devices and servic',
 howto_2: 'Select a source and destination node, set the TTL, type a message and click Send.',
 howto_3: 'Watch the message hop through the network as animated dots. Check the hop counter and delivery status.',
 howto_4: 'Experiment by dragging nodes, breaking links, and adding/removing nodes to explore resilience.',
 wiki_mesh_title: '🕸️ Mesh Networks',
 wiki_mesh: 'A mesh network is a topology where each node relays data for the network. It provides redundancy and self-healing capabilities.',
 wiki_ttl_title: '⏱️ TTL (Time-To-Live)',
 wiki_ttl: 'TTL is a counter attached to each message that decrements at every hop. It prevents messages from circulating forever in the network.',
 wiki_flooding_title: '🌊 Flooding Algorithm',
 wiki_flooding: 'Flooding is a simple routing strategy where every node re-broadcasts received messages to all neighbors. Simple but uses more bandwidth.',
 wiki_ble_title: '📶 BLE Mesh Standard',
 wiki_ble: 'Bluetooth Mesh is an official standard (Mesh Profile 1.0) enabling many-to-many communication over BLE, used in IoT, smart buildings, and sensor networks.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🕸️ Mesh Chat ready!',
 ...
 gloss3_term: 'Self-Healing',
 gloss3_def: 'A mesh network property where if one node fails, traffic automatically reroutes through alternative paths. Recovery time depends on routing protocol convergence speed.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-02C5F3',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Ble Mesh Chat \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Ble Mesh Chat', subtitle: '🕸️ maillage · 📡 relais · 💬 chat',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'BLE Mesh Chat — Messagerie Multi-Sauts', mainDesc: 'Relayez des messages à travers un réseau maillé de nœuds',
 ...
 howto_1: 'L écran principal affiche la simulation Ble Mesh Chat. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how The network is scanned to discover active devices and servic',
 howto_2: 'Sélectionne un nœud source et destination, règle le TTL, tape un message et clique Envoyer.',
 howto_3: 'Regarde le message sauter à travers le réseau sous forme de points animés. Vérifie le compteur de sauts et le statut.',
 howto_4: 'Expérimente en déplaçant les nœuds, en coupant les liens et en ajoutant/supprimant des nœuds.',
 wiki_mesh_title: '🕸️ Réseaux Maillés',
 wiki_mesh: 'Un réseau maillé est une topologie où chaque nœud relaie les données pour le réseau. Il offre redondance et auto-réparation.',
 wiki_ttl_title: '⏱️ TTL (Time-To-Live)',
 wiki_ttl: 'Le TTL est un compteur attaché à chaque message qui décrémente à chaque saut. Il empêche les messages de circuler indéfiniment.',
 wiki_flooding_title: '🌊 Algorithme d\'Inondation',
 wiki_flooding: 'L\'inondation est une stratégie de routage simple où chaque nœud retransmet les messages reçus à tous ses voisins. Simple mais consomme plus de bande passante.',
 wiki_ble_title: '📶 Standard BLE Mesh',
 wiki_ble: 'Bluetooth Mesh est un standard officiel (Mesh Profile 1.0) permettant la communication many-to-many via BLE, utilisé en IoT et btiments intelligents.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '🕸️ Mesh Chat prêt !',
 ...
 title: 'Ble Mesh Chat', subtitle: '🕸️ شبكة · 📡 ترحيل · 💬 دردشة',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'دردشة BLE الشبكية — رسائل متعددة القفزات', mainDesc: 'أعد توجيه الرسائل عبر شبكة من العقد',
 ...
 howto_1: 'تعرض الشاشة الرئيسية محاكاة Ble Mesh Chat. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how The network is scanned to discover active devices and servic',
 howto_2: 'اختر عقدة المصدر والوجهة، اضبط TTL، اكتب رسالة وانقر إرسال.',
 howto_3: 'شاهد الرسالة تقفز عبر الشبكة كنقاط متحركة. تحقق من عداد القفزات وحالة التسليم.',
 howto_4: 'جرّب بسحب العقد، وقطع الروابط، وإضافة/إزالة العقد لاستكشاف المرونة.',
 wiki_mesh_title: '🕸️ الشبكات المعشقة',
 wiki_mesh: 'الشبكة المعشقة هي طوبولوجيا حيث كل عقدة تنقل البيانات للشبكة. توفر التكرار وقدرات الإصلاح الذاتي.',
 wiki_ttl_title: '⏱️ TTL (وقت البقاء)',
 wiki_ttl: 'TTL هو عداد مرفق بكل رسالة ينقص عند كل قفزة. يمنع الرسائل من الدوران للأبد في الشبكة.',
 wiki_flooding_title: '🌊 خوارزمية الإغراق',
 wiki_flooding: 'الإغراق هو استراتيجية توجيه بسيطة حيث كل عقدة تعيد بث الرسائل المستلمة لجميع جيرانها. بسيطة لكنها تستهلك نطاقًا تردديًا أكثر.',
 wiki_ble_title: '📶 معيار BLE Mesh',
 wiki_ble: 'بلوتوث Mesh هو معيار رسمي (Mesh Profile 1.0) يتيح الاتصال متعدد إلى متعدد عبر BLE، يُستخدم في إنترنت الأشياء والمباني الذكية.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '🕸️ دردشة الشبكة جاهزة!',
...
class MeshNode {
 ...
 this.messageQueue = [];
 this.radius = 18;
 this.color = null; // assigned dynamically
 }
}
...
const MESH = {
 nodes: [],
 links: [], // {a, b, broken}
 brokenLinks: new Set(), // "a-b" strings
 animations: [], // traveling dots
 canvas: null,
 ctx: null,
 linkRange: 180, // max distance for auto-link
 nextId: 0,
 dragging: null,
 dragOffX: 0,
 dragOffY: 0,
 animFrame: null,
 nodeColors: ['#d4a03c','#38bdf8','#4ade80','#c084fc','#a3e635','#3b82f6','#f97316','#ef4444'],
};

function meshInit() {
 MESH.canvas = $('meshCanvas');
 if (!MESH.canvas) return;
 MESH.ctx = MESH.canvas.getContext('2d');
 meshResizeCanvas();
 window.addEventListener('resize', meshResizeCanvas);

 // Mouse events
 MESH.canvas.addEventListener('mousedown', meshOnMouseDown);
 MESH.canvas.addEventListener('mousemove', meshOnMouseMove);
 MESH.canvas.addEventListener('mouseup', meshOnMouseUp);
 MESH.canvas.addEventListener('contextmenu', meshOnRightClick);
 MESH.canvas.addEventListener('click', meshOnClick);

 // Touch events
 MESH.canvas.addEventListener('touchstart', meshOnTouchStart, { passive: false });
 MESH.canvas.addEventListener('touchmove', meshOnTouchMove, { passive: false });
 MESH.canvas.addEventListener('touchend', meshOnTouchEnd);

 // Node count slider
 const slider = $('nodeCount');
 const valDisplay = $('nodeCountVal');
 if (slider) {
 slider.addEventListener('input', () => {
 if (valDisplay) valDisplay.textContent = slider.value;
 meshGenerateNodes(parseInt(slider.value));
 });
 }

 // Send button
 const sendBtn = $('meshSendBtn');
 if (sendBtn) sendBtn.addEventListener('click', meshSendMessage);
 const msgInput = $('meshMsgInput');
 if (msgInput) msgInput.addEventListener('keydown', e => { if (e.key === 'Enter') meshSendMessage(); });
...
function meshResizeCanvas() {
 if (!MESH.canvas) return;
 const rect = MESH.canvas.parentElement.getBoundingClientRect();
 MESH.canvas.width = rect.width - 2; // minus border
 MESH.canvas.height = 280;
}

function meshGenerateNodes(count) {
 MESH.nodes = [];
 MESH.links = [];
 MESH.brokenLinks.clear();
 MESH.animations = [];
 MESH.nextId = 0;

 const w = MESH.canvas ? MESH.canvas.width : 400;
 const h = MESH.canvas ? MESH.canvas.height : 280;
 const padding = 40;

 for (let i = 0; i < count; i++) {
 const x = padding + Math.random() * (w - 2 * padding);
 const y = padding + Math.random() * (h - 2 * padding);
 const node = new MeshNode(MESH.nextId++, x, y);
 node.color = MESH.nodeColors[i % MESH.nodeColors.length];
 MESH.nodes.push(node);
 }

 meshRebuildLinks();
 meshUpdateDropdowns();
 meshUpdateStatus('idle');
 if ($('hopCount')) $('hopCount').textContent = '0';
}

function meshRebuildLinks() {
 // Clear neighbor lists
 MESH.nodes.forEach(n => n.neighbors = []);
 MESH.links = [];
 ...
 if (dist <= MESH.linkRange) {
 const key = `${Math.min(a.id, b.id)}-${Math.max(a.id, b.id)}`;
 const broken = MESH.brokenLinks.has(key);
 MESH.links.push({ a: a.id, b: b.id, broken });
 if (!broken) {
...
function meshUpdateDropdowns() {
 const src = $('srcNode'), dest = $('destNode');
 if (!src || !dest) return;
 const prevSrc = src.value, prevDest = dest.value;
 src.innerHTML = '';
 dest.innerHTML = '';
 MESH.nodes.forEach(n => {
 const letter = String.fromCharCode(65 + n.id);
 src.innerHTML += `<option value="${n.id}">Node ${letter}</option>`;
 dest.innerHTML += `<option value="${n.id}">Node ${letter}</option>`;
 });
 // restore or default
 if (MESH.nodes.find(n => n.id == prevSrc)) src.value = prevSrc;
 if (MESH.nodes.find(n => n.id == prevDest)) dest.value = prevDest;
 else if (MESH.nodes.length > 1) dest.value = MESH.nodes[MESH.nodes.length - 1].id;
}

function meshUpdateStatus(status, text) {
 ...
 switch (status) {
 case 'success': el.textContent = s.meshDelivered; break;
 case 'expired': el.textContent = s.meshExpired; break;
 case 'unreachable': el.textContent = s.meshUnreachable; break;
 default: el.textContent = s.statusIdle; break;
 }
 }
}

function meshGetNode(id) {
 return MESH.nodes.find(n => n.id === id);
}

/* ─── Mesh canvas rendering ─── */

function meshStartRender() {
 function frame() {
 meshDraw();
 MESH.animFrame = requestAnimationFrame(frame);
 }
 MESH.animFrame = requestAnimationFrame(frame);
}
...
function meshDraw() {
 const ctx = MESH.ctx;
 if (!ctx || !MESH.canvas) return;
 const w = MESH.canvas.width, h = MESH.canvas.height;
 ctx.clearRect(0, 0, w, h);

 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#d4a03c';
 const textColor = getComputedStyle(document.documentElement).getPropertyValue('--text').trim() || '#e4ddd0';
 const mutedColor = getComputedStyle(document.documentElement).getPropertyValue('--text-muted').trim() || '#8a7e6e';

 // Draw links
 MESH.links.forEach(link => {
 const a = meshGetNode(link.a), b = meshGetNode(link.b);
 if (!a || !b) return;
 ctx.beginPath();
 ctx.moveTo(a.x, a.y);
 ctx.lineTo(b.x, b.y);
 ...
 // Label
 const letter = String.fromCharCode(65 + node.id);
 ...
 // Draw animations (traveling dots)
 const now = Date.now();
 MESH.animations = MESH.animations.filter(anim => {
 const elapsed = now - anim.startTime;
 const progress = Math.min(elapsed / anim.duration, 1);
 const fromNode = meshGetNode(anim.from);
 const toNode = meshGetNode(anim.to);
...
/* ─── Mesh message routing (flooding with TTL) ─── */

function meshSendMessage() {
 const s = LANG[currentLang];
 const msgInput = $('meshMsgInput');
 const srcSel = $('srcNode');
 const destSel = $('destNode');
 const ttlSel = $('ttlSelect');
 if (!msgInput || !srcSel || !destSel || !ttlSel) return;

 const msg = msgInput.value.trim();
 if (!msg) { showToast(s.meshNoMsg, 2000); return; }

 const srcId = parseInt(srcSel.value);
 const destId = parseInt(destSel.value);
 const ttl = parseInt(ttlSel.value);

 if (srcId === destId) {
 meshUpdateStatus('success');
 if ($('hopCount')) $('hopCount').textContent = '0';
 log(`📨 ${s.meshDelivered} (same node)`, 'success');
 showToast(s.meshDelivered, 2000);
 return;
 }

 meshUpdateStatus('idle', s.meshSending);
 if ($('hopCount')) $('hopCount').textContent = '0';

 const srcLetter = String.fromCharCode(65 + srcId);
 const destLetter = String.fromCharCode(65 + destId);
 log(`📤 TX Node ${srcLetter} → Node ${destLetter} | TTL=${ttl} | "${msg}"`, 'tx');

 // BFS-like flooding with animation
 const visited = new Set();
 visited.add(srcId);
 let hopCount = 0;
 let delivered = false;

 function floodStep(currentNodes, currentTTL) {
 if (currentTTL <= 0 || currentNodes.length === 0 || delivered) {
 if (!delivered) {
 // Check if unreachable vs expired
 const reachable = meshCanReach(srcId, destId);
 if (!reachable) {
 meshUpdateStatus('unreachable');
 log(`❌ ${s.meshUnreachable}`, 'error');
 showToast(s.meshUnreachable, 2500);
 } else {
 meshUpdateStatus('expired');
 log(`⏱️ ${s.meshExpired} (hops=${hopCount})`, 'error');
 showToast(s.meshExpired, 2500);
 }
 }
 return;
 }
 ...
 const fromLetter = String.fromCharCode(65 + nodeId);
 const toLetter = String.fromCharCode(65 + neighborId);

 // Create animation
 const anim = {
 from: nodeId,
 to: neighborId,
 startTime: Date.now() + animDelay,
 duration: 400,
 onArrive: null
 };
 ...
 delivered = true;
 hopCount++;
 if ($('hopCount')) $('hopCount').textContent = hopCount;
 meshUpdateStatus('success');
 log(`📥 RX Node ${toLetter} received! | hops=${hopCount}`, 'rx');
 log(`✅ ${s.meshDelivered} (${hopCount} ${s.meshHop}${hopCount > 1 ? 's' : ''})`, 'success');
 showToast(s.meshDelivered, 2500);
 playSound('success');
 };
 } else {
 anim.onArrive = () => {
 log(`🔄 Node ${toLetter} ${s.meshRelaying} | TTL=${currentTTL - 1}`, 'info');
 };
 ...
 setTimeout(() => {
 if (!delivered) {
 floodStep(nextNodes, currentTTL - 1);
 }
 }, 500 + animDelay);
 }
...
function meshCanReach(srcId, destId) {
 ...
 const node = meshGetNode(curr);
 if (!node) continue;
 for (const nId of node.neighbors) {
 if (nId === destId) return true;
 if (!visited.has(nId)) {
 visited.add(nId);
 queue.push(nId);
 }
...
/* ─── Mesh interaction (add, remove, drag, link toggle) ─── */

function meshGetCanvasPos(e) {
 const rect = MESH.canvas.getBoundingClientRect();
 return { x: e.clientX - rect.left, y: e.clientY - rect.top };
}

function meshNodeAt(x, y) {
 for (let i = MESH.nodes.length - 1; i >= 0; i--) {
...
function meshOnMouseDown(e) {
 if (e.button !== 0) return;
 const pos = meshGetCanvasPos(e);
 const node = meshNodeAt(pos.x, pos.y);
 if (node) {
 MESH.dragging = node;
 MESH.dragOffX = pos.x - node.x;
 MESH.dragOffY = pos.y - node.y;
 e.preventDefault();
 }
}

function meshOnMouseMove(e) {
 if (!MESH.dragging) return;
 const pos = meshGetCanvasPos(e);
 MESH.dragging.x = Math.max(20, Math.min(MESH.canvas.width - 20, pos.x - MESH.dragOffX));
 MESH.dragging.y = Math.max(20, Math.min(MESH.canvas.height - 20, pos.y - MESH.dragOffY));
 meshRebuildLinks();
}

function meshOnMouseUp() {
 MESH.dragging = null;
}

function meshOnRightClick(e) {
 e.preventDefault();
 const pos = meshGetCanvasPos(e);
 const node = meshNodeAt(pos.x, pos.y);
 if (node && MESH.nodes.length > 2) {
 MESH.nodes = MESH.nodes.filter(n => n.id !== node.id);
 MESH.brokenLinks = new Set([...MESH.brokenLinks].filter(k => {
 const [a, b] = k.split('-').map(Number);
 return a !== node.id && b !== node.id;
 }));
 meshRebuildLinks();
 meshUpdateDropdowns();
 log(`🗑️ ${LANG[currentLang].meshNodeRemoved} ${String.fromCharCode(65 + node.id)}`, 'info');
 playSound('click');
 // Update slider
 const slider = $('nodeCount');
 if (slider) {
 slider.value = MESH.nodes.length;
 const valDisplay = $('nodeCountVal');
 if (valDisplay) valDisplay.textContent = MESH.nodes.length;
 }
 }
}

function meshOnClick(e) {
 if (e.button !== 0) return;
 const pos = meshGetCanvasPos(e);

 // If clicked on a node, ignore (handled by drag)
 if (meshNodeAt(pos.x, pos.y)) return;

 // Check if clicked on a link to toggle it
 const link = meshLinkAt(pos.x, pos.y);
 if (link) {
 const key = `${Math.min(link.a, link.b)}-${Math.max(link.a, link.b)}`;
 if (link.broken) {
 MESH.brokenLinks.delete(key);
 link.broken = false;
 log(`🔗 ${LANG[currentLang].meshLinkRestored}`, 'success');
 } else {
 MESH.brokenLinks.add(key);
 link.broken = true;
 log(`✂️ ${LANG[currentLang].meshLinkBroken}`, 'info');
 }
 meshRebuildLinks();
 playSound('click');
 return;
 ...
 if (MESH.nodes.length < 12) {
 const newNode = new MeshNode(MESH.nextId++, pos.x, pos.y);
 newNode.color = MESH.nodeColors[MESH.nodes.length % MESH.nodeColors.length];
 MESH.nodes.push(newNode);
 meshRebuildLinks();
 meshUpdateDropdowns();
 log(`➕ ${LANG[currentLang].meshNodeAdded} ${String.fromCharCode(65 + newNode.id)}`, 'info');
 playSound('click');
 // Update slider
 const slider = $('nodeCount');
 if (slider && MESH.nodes.length <= 8) {
 slider.value = MESH.nodes.length;
 const valDisplay = $('nodeCountVal');
 if (valDisplay) valDisplay.textContent = MESH.nodes.length;
 }
...
function meshOnTouchStart(e) {
 if (e.touches.length !== 1) return;
 const touch = e.touches[0];
 const pos = meshGetCanvasPos(touch);
 const node = meshNodeAt(pos.x, pos.y);
 if (node) {
 MESH.dragging = node;
 MESH.dragOffX = pos.x - node.x;
...
function meshOnTouchMove(e) {
 if (!MESH.dragging || e.touches.length !== 1) return;
 e.preventDefault();
 const touch = e.touches[0];
 const pos = meshGetCanvasPos(touch);
 MESH.dragging.x = Math.max(20, Math.min(MESH.canvas.width - 20, pos.x - MESH.dragOffX));
