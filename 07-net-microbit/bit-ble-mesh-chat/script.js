...
const LANG = {
  ...
  fr: {
    ...
    wiki_ble: 'Bluetooth Mesh est un standard officiel (Mesh Profile 1.0) permettant la communication many-to-many via BLE, utilisé en IoT et bâtiments intelligents.',
    working: 'En cours…',
