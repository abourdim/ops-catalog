...
const LANG = {
  en: {
    ...
    howto_4: 'Open the Lab section to generate fake traffic and practice analysis.',
  ...
  fr: {
    ...
    howto_4: 'Ouvrez la section Labo pour générer du trafic simulé.',
  ...
  ar: {
    ...
    howto_4: 'افتح قسم المختبر لتوليد حركة وهمية والتدرب على التحليل.',
