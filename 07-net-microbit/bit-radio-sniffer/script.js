...
const LANG = {
  en: {
    ...
    step2Title: 'Listen for Packets', step2Desc: 'The sniffer monitors the channel and captures any radio traffic it detects.',
  ...
  fr: {
    ...
    step2Title: 'Écouter les paquets', step2Desc: 'Le sniffer surveille le canal et capture tout trafic radio détecté.',
  ...
  ar: {
    ...
    step2Title: 'استمع للحزم', step2Desc: 'يراقب المتتبع القناة ويلتقط أي حركة راديو يكتشفها.',
