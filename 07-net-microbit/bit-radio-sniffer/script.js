 ...
 * Radio Sniffer: Scan micro:bit radio channels & analyze traffic patterns
...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-7A6BC0',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master Radio Sniffer \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 title: 'Radio Sniffer', subtitle: '📻 scan · 📡 capture · 🔍 analyze',
 disconnected: 'Disconnected', connected: 'Connected',
 mainSection: 'Radio Sniffer — Frequency Scanner', mainDesc: 'Scan radio channels and analyze traffic patterns',
 sectionA: 'How It Works', sectionB: 'Lab', sectionC: 'Challenge',
 channelLabel: 'CH', packetsLabel: 'PKT', signalLabel: 'SIG',
 startScan: 'Start Scan', stopScan: 'Stop', autoScan: 'Auto Scan',
 step1Title: 'Tune to Channel', step1Desc: 'Select one of 84 radio groups (0-83). Each group operates on a different frequency.',
 step2Title: 'Listen for Packets', step2Desc: 'The sniffer monitors the channel and captures any radio traffic it detects. Notice how the indicators change during this phase. The activity log records every event, letting you trace the exact sequence of operations and verify the results.',
 step3Title: 'Capture & Decode', step3Desc: 'Raw packet data is captured in hex format, then decoded to reveal readable text.',
 step4Title: 'Display on Spectrum', step4Desc: 'Activity levels are shown as a bar chart and waterfall display for spectrum analysis.',
 labIntro: 'Generate simulated radio traffic to explore how the spectrum scanner works.',
 genTraffic: 'Generate Traffic', burst: 'Burst Mode', clearSpectrum: 'Clear Spectrum', exportCapture: 'Export Capture',
 labTask1Title: '1. Generate Traffic', labTask1Desc: 'Click "Generate Traffic" to inject fake packets on random channels and watch the spectrum fill up.',
 labTask2Title: '2. Watch Spectrum', labTask2Desc: 'Observe how the bar chart shows activity levels and the waterfall scrolls to show history.',
 labTask3Title: '3. Decode Packets', labTask3Desc: 'Check the captured packets list for hex data and decoded readable text messages.',
 labTask4Title: '4. Export Capture', labTask4Desc: 'Save the captured packets as a text file for further analysis or sharing.',
 challengeIntro: 'Test your radio skills! Complete these challenges to become a spectrum analyst.',
 ch1Title: 'Challenge 1: Find the Hidden Message', ch1Desc: 'A secret message is being transmitted on a specific channel. Use Auto Scan to find it and decode the text.',
 ch1Btn: 'Start Challenge', ch1Pending: 'Pending', ch1Complete: 'Completed!',
 ch2Title: 'Challenge 2: Identify Busiest Channel', ch2Desc: 'Generate traffic and find which channel has the highest activity. Enter the channel number to verify.',
 ch2Btn: 'Start Challenge', ch2Pending: 'Pending', ch2Complete: 'Completed!',
 ch3Title: 'Challenge 3: Decode the Transmission', ch3Desc: 'An encoded message uses letter shifting (Caesar cipher). Capture it and crack the code!',
 ch3Btn: 'Start Challenge', ch3Pending: 'Pending', ch3Complete: 'Completed!',
 activityLog: 'Activity Log', eventsMsg: 'Events & messages',
 clear: 'Clear', copy: 'Copy', theme: 'Theme',
 settings: '⚙️ Settings', language: 'Language',
 helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
 help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
 howto_1:'The main display shows the Radio Sniffer simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Select one of 84 radio groups (0-83). Each group operates on',
 ...
 wiki_spectrum_title: '📡 Radio Spectrum', wiki_spectrum: 'The radio spectrum is the range of electromagnetic frequencies used for wireless communication. micro:bit uses the 2.4GHz ISM band.',
 wiki_sniffing_title: '🔍 Packet Sniffing', wiki_sniffing: 'Packet sniffing is the practice of capturing data packets transmitted over a network or radio channel for analysis.',
 wiki_groups_title: '📻 micro:bit Radio Groups', wiki_groups: 'micro:bit supports 84 radio groups (0-83). Devices on the same group can communicate. Each group uses a different frequency offset.',
 wiki_hopping_title: '🔀 Frequency Hopping', wiki_hopping: 'Frequency hopping rapidly switches the carrier frequency among many channels. It improves security and reduces interference.',
 working: 'Working…',
 t_mosque: 'Mosque', t_zellige: 'Zellige', t_andalus: 'Andalus',
 t_riad: 'Riad', t_medina: 'Medina',
 t_space: 'Space', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📻 Radio Sniffer ready!',
 ...
 themeChanged: '🎨 Theme →',
 scanning: 'Scanning channel', autoScanning: 'Auto-scanning...', scanStopped: 'Scan stopped',
 packetCaptured: 'Packet captured', noActivity: 'No activity', trafficGenerated: 'Traffic generated',
 ...
 enterChannel: 'Enter the busiest channel number:', wrongChannel: 'Wrong channel! Try again.', enterDecoded: 'Enter the decoded message:', wrongDecode: 'Wrong decode! Try again.',sectionCode:'Device Code',faq_q1:'What is Radio Sniffer?',faq_a1:'Radio Sniffer is an interactive simulation that demonstrates spectrum analysis concepts. Scan radio channels and analyze traffic patterns. Everything runs in your browser — no hardware or installation needed. Adjust the controls, observe the results, and build real understanding through experimentation.',faq_q2:'How does the simulation work?',faq_a2:'The simulation models real networking behavior in your browser. You control the inputs using sliders and buttons, and the visualization updates in real time to show you the results.',faq_q3:'What do the controls do?',faq_a3:'Press "Start Scan" to begin. Each button and slider changes a specific parameter — the visualization responds immediately so you can see the effect. Check the How-To tab for a step-by-step guide.',faq_q4:'What is the science behind this?',faq_a4:'This app is based on real networking principles used by professionals. The simulation applies the same math and physics — the difference is that here you can safely experiment without expensive equipment.',faq_q5:'What should I experiment with?',faq_a5:'Change one parameter at a time and observe the effect. Try extreme values to find the limits. Then combine changes to see how different factors interact. The challenges section gives you specific experiments to try.',faq_q6:'What hardware do I need for the real version?',faq_a6:'The simulation needs no hardware. To build the real project, you need BBC micro:bit V2. See the Device Code section for wiring diagrams and ready-to-use firmware.',faq_q7:'Is my data private?',faq_a7:'Yes. Everything runs locally in your browser using JavaScript. No data is sent to any server, no account is needed, and the app works completely offline. Your experiments stay on your device.',faq_q8:'What should I explore next?',faq_a8:'Try Bit Ble Mesh Chat and Bit Mesh Rescue. Each app in this category teaches a different aspect of networking. Try systematically: set all controls to their defaults, then change one variable at a time. Record what happens at minimum, midpoint, and maximum values. This methodical approach is exactly how researchers and engineers characterize real systems.',demo_s1:'Welcome to Radio Sniffer! Look at the main display — this is where the networking simulation runs.',demo_s2:'Select a channel (0-83) using the slider or type a number. Watch how the visualization reacts.',demo_s3:'Try adjusting the controls. Each slider or button changes a specific parameter of the simulation.',demo_s4:'Scroll down to see "How It Works" for detailed data. The numbers and charts update as the simulation runs.',demo_s5:'Great job! Now try the challenges section to test your understanding of networking.',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Network Protocols',learn1Desc:'How computers talk to each other using rules called protocols. The simulation brings this concept to life through interactive visualization. Instead of reading about it in a textbook, you see it happen in real time and control the variables yourself.',learn1Tag:'Networking',learn2Title:'Packet Analysis',learn2Desc:'How data is split into tiny packets that travel across the internet. This principle connects to many real-world applications. Engineers, researchers, and security professionals use this knowledge daily. The hands-on experience here builds practical understanding.',learn2Tag:'Data',learn3Title:'Network Scanning',learn3Desc:'How to discover devices and services on a network. Try the challenges section to test your understanding. Real engineers use these same concepts daily.',learn3Tag:'Discovery',learn4Title:'Network Security',learn4Desc:'How to spot and stop network attacks. Compare results with different settings to build intuition. The data panels show precise measurements.',learn4Tag:'Security',sectionLearn:'What You Shall Learn',learnLevelVal:'Beginner 🟢',learnLevel:'Level:',learnTimeVal:'15 min ⏱',learnTime:'Time:',learnAgeVal:'10+ 🧒',kidTitle:'For Young Explorers',kidIntro:'Welcome to Radio Sniffer! This is like a science experiment on your computer. You get to control a real spectrum analysis simulation — press buttons, move sliders, and watch what happens on screen. Try changing the controls and watch how Select one of 84 radio groups (0-83). Each group o Nothing can break — it is all just a simulation running safely in your browser!',kidSafe:'Completely safe! Nothing you do here can break anything. It all runs inside your browser like a game.',kidTry:'Press the big Start button and watch the screen change. Then try moving sliders to see what they do.',kidParent:'This app teaches networking concepts through hands-on simulation. Suitable for STEM education in physics, electronics, and computer science.',codeTitle:'Starter Code',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'This code turns on the micro:bit radio on group 42 at full power. When button A is pressed, it broadcasts "HELLO". Any received message scrolls across the LED display. Group numbers act like channels — only micro:bits on the same group hear each other.',purpose:'Radio Sniffer: Scan radio channels and analyze traffic patterns. This simulation lets you experiment hands-on instead of just reading theory. Every parameter you change produces visible results, building real intuition for how the system behaves. The workflow goes from Tune to Channel through Listen for Packets to Capture & Decode and Display on Spectrum.',guideTitle:'What Am I Looking At?',guideCanvas:'The main area shows a live visualization of the simulation. Colors and movement represent data changing in real time.',guideControls:'The buttons below the main display control the simulation. Start begins it, Stop pauses it, Reset clears everything.',guideSections:'Below the main card, "How It Works" and "Lab" show detailed data and analysis. Click the section headers to expand or collapse them.',guideStatus:'The colored dot in the top-right corner shows the connection status. Green means running, red means stopped.',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Zigbee Sniffer',related1_desc:'Decode Zigbee IoT device communications',related1_path:'../../31-sdr-iot/sdr-zigbee/index.html',related2_name:'Escape HQ — Spy Escape Room',related2_desc:'Solve puzzles with ESP32 locks and micro:bit gadgets',related2_path:'../../04-spy-combos/kit-escape-hq/index.html',related3_name:'DSP Workbench',related3_desc:'Chain DSP blocks: source, filter, FFT, output',related3_path:'../../27-sdr-dsp/sdr-dsp-workbench/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Radio Cartographer — Signal Mapping',pathPrev_path:'../../07-net-microbit/bit-radio-cartographer/index.html',pathNext_name:'',pathNext_path:'',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 achieveExperimenter:'Experimenter — changed 5+ parameters'
 ,
 printBtn: '🖨️ Print Worksheet',quizTab:'Quiz',quizTitle:'Test Your Knowledge',quizRetry:'Retry',quizCorrect:'Correct!',quizWrong:'Wrong!',quizScore:'Score',quiz_q1:'Who invented Morse code?',quiz_q1a:'Tesla',quiz_q1b:'Samuel Morse',quiz_q1c:'Edison',quiz_q1d:'Bell',quiz_q1_answer:'1',quiz_q2:'What is the speed of radio waves in a vacuum?',quiz_q2a:'Speed of sound',quiz_q2b:'Speed of light',quiz_q2c:'Half the speed of light',quiz_q2d:'Twice the speed of light',quiz_q2_answer:'1',quiz_q3:'How many LEDs does the micro:bit display have?',quiz_q3a:'16',quiz_q3b:'25',quiz_q3c:'36',quiz_q3d:'64',quiz_q3_answer:'1',quiz_q4:'What is machine learning?',quiz_q4a:'Programming robots',quiz_q4b:'Systems that learn from data',quiz_q4c:'Manual computation',quiz_q4d:'Hardware design',quiz_q4_answer:'1',quiz_q5:'In Morse code, what represents the letter E?',quiz_q5a:'Dash',quiz_q5b:'Single dot',quiz_q5c:'Two dots',quiz_q5d:'Dot-dash',quiz_q5_answer:'1',realworldTitle:'🌍 Real-World Stories',realworld1:'LIGO detected gravitational waves in 2015, confirming Einstein\'s 100-year-old prediction. The sensors measured spacetime distortions of 10⁻²¹ meters — one ten-thousandth the width of a proton.',realworld2:'Voyager 1, launched in 1977, communicates from 24 billion km away using a 23-watt transmitter — the power of a fridge light bulb. Signals take 22+ hours each way. The Deep Space Network uses 70m dishes to receive them.',realworld3:'CERN\'s LHC generates 1 petabyte/second during collisions. The Worldwide LHC Computing Grid spans 170 centers in 42 countries. In 2012, it confirmed the Higgs boson, completing the Standard Model of physics.',experimentTitle:'🔬 Experiments',experiment_1_title:'Baseline Measurement',experiment_1:'Set all controls to default values and record the initial readings. These are your baseline measurements. Good scientists always establish a baseline before changing variables — it gives you a reference point to measure all future changes against.',experiment_2_title:'Sensitivity Analysis',experiment_2:'Change one parameter to its minimum value, record the result, then set it to maximum. The difference reveals the system\'s sensitivity to that variable. Repeat for each control. In satellite tracking, knowing which parameters matter most helps you focus your efforts efficiently.',experiment_3_title:'Interaction Effects',experiment_3:'After testing parameters individually, change two simultaneously. Does the combined effect equal the sum of individual effects? Or is there a synergy (or cancellation)? Non-linear interactions are common in satellite tracking and reveal the hidden complexity beneath simple-looking systems.',wiki_concept_title:'💡 Core Concept',wiki_concept:'Radio Sniffer demonstrates a fundamental concept in satellite tracking. At its core, this simulation models how real systems process signals, data, or physical phenomena. The key insight is that complex behaviors emerge from simple rules applied repeatedly. Understanding this principle — that sophisticated outcomes arise from basic building blocks — is the foundation of engineering and scientific thinking.',wiki_realworld_title:'🌐 Real-World Applications',wiki_realworld:'The principles demonstrated in Radio Sniffer have direct real-world applications. Professionals in satellite tracking use these same concepts daily. In industry, SDR and similar hardware implement these algorithms in embedded systems. In research, these models help scientists predict and analyze complex phenomena. The skills you develop here — systematic experimentation, parameter tuning, and data interpretation — are exactly what employers seek.',wiki_safety_title:'⚠️ Safety & Responsibility',wiki_safety:'Working with satellite tracking carries important responsibilities. Always operate within legal boundaries — many countries regulate equipment and techniques in this field. Never test on systems you do not own without explicit written permission. This simulation is designed for safe educational use — it does not transmit real signals or access real networks. When you progress to real hardware, research your local regulations first.',proTipTitle:'💡 Pro Tips',proTip1:'Use a bandpass filter before your SDR to reject strong out-of-band signals. A nearby FM station can desensitize your receiver to weak satellite signals.',proTip2:'Record raw IQ data first, analyze later. You can always reprocess saved IQ files with different demodulation settings — you cannot re-capture a missed signal.',funFactTitle:'🎯 Did You Know?',funFact:'Lightning bolts reach temperatures of 30,000°C — five times hotter than the surface of the Sun. Each bolt carries enough energy to toast 100,000 slices of bread.',mistakeTitle:'⚠️ Common Mistakes',mistake1:'Changing multiple parameters at once makes it impossible to isolate cause and effect. Always change ONE variable at a time.',mistake2:'Skipping the baseline measurement. Without knowing the default behavior, you cannot measure how your changes affect the system.',mistake3:'Ignoring the activity log. It records every event with timestamps — essential for understanding sequences and debugging unexpected results.'},
 wiki_history_title: '📜 History of Spectrum Analysis',
 wiki_history: 'Guglielmo Marconi transmitted the first transatlantic radio signal in 1901. Radio evolved from spark-gap transmitters to modern software-defined radios. Radio Sniffer builds on this foundation, letting you explore these historical concepts through interactive simulation.',
 wiki_math_title: '📐 Mathematics Behind Radio Sniffer',
 wiki_math: 'The mathematics behind Radio Sniffer: The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance. Spectral density (W/Hz) measures power distribution across frequencies. The FFT algorithm converts time-domain samples to frequency-domain in O(N·log N) operations. Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time.',
 wiki_advanced_title: '🔬 Advanced Techniques',
 wiki_advanced: 'Beyond the basics demonstrated in this simulation, advanced spectrum analysis practitioners use sophisticated techniques. Adaptive algorithms automatically adjust parameters based on environmental conditions. Machine learning classifies signals with high accuracy. Multi-channel correlation detects patterns invisible to single-channel analysis. Distributed sensor networks combine data from multiple locations for triangulation. These techniques build on the fundamentals you learn here.',
 wiki_compare_title: '⚖️ Comparing Approaches',
 wiki_compare: 'There are several approaches to spectrum analysis. Hardware-based solutions using HackRF SDR offer real-time performance and direct signal access. Software simulations (like this app) provide safe experimentation without equipment cost. Cloud-based platforms offer scalability but introduce latency and privacy concerns. Each approach has trade-offs: cost vs. fidelity, speed vs. safety, simplicity vs. capability. This simulation gives you the conceptual foundation to use any approach effectively.',
 wiki_debug_title: '🔧 Troubleshooting Guide',
 wiki_debug: 'Common issues when working with spectrum analysis: (1) Unexpected results often come from incorrect parameter settings — reset to defaults and change one variable at a time. (2) If the visualization seems frozen, check that the simulation is running (not paused). (3) Noisy or erratic readings usually indicate interference — in real hardware, move away from electronic devices. (4) If calculations seem wrong, verify your units (Hz vs kHz vs MHz). Systematic debugging is a core skill in spectrum analysis.',
 wiki_ethics_title: '⚖️ Ethics & Legal Considerations',
 wiki_ethics: 'Spectrum Analysis carries important ethical and legal responsibilities. Many countries regulate the use of HackRF SDR and similar equipment. Always obtain proper authorization before testing on systems you do not own. Respect privacy laws and data protection regulations. This simulation is designed for educational purposes — it demonstrates principles without transmitting real signals or accessing real networks. Responsible use of these skills contributes to security for everyone.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-7A6BC0',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez Radio Sniffer \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 title: 'Radio Sniffer', subtitle: '📻 scanner · 📡 capturer · 🔍 analyser',
 disconnected: 'Déconnecté', connected: 'Connecté',
 mainSection: 'Radio Sniffer — Scanner de Fréquences', mainDesc: 'Scannez les canaux radio et analysez les schémas de trafic',
 sectionA: 'Comment ça marche', sectionB: 'Labo', sectionC: 'Défi',
 channelLabel: 'CH', packetsLabel: 'PKT', signalLabel: 'SIG',
 startScan: 'Démarrer', stopScan: 'Stop', autoScan: 'Auto Scan',
 step1Title: 'Choisir un canal', step1Desc: 'Sélectionnez un des 84 groupes radio (0-83). Chaque groupe fonctionne sur une fréquence différente.',
 step2Title: 'Écouter les paquets', step2Desc: 'Le sniffer surveille le canal et capture tout trafic radio détecté. Remarquez comment les indicateurs changent pendant cette phase. Le journal d activité enregistre chaque événement pour vérifier les résultats.',
 step3Title: 'Capturer et décoder', step3Desc: 'Les données brutes sont capturées en hex, puis décodées pour révéler le texte lisible.',
 step4Title: 'Afficher le spectre', step4Desc: 'Les niveaux d\'activité sont affichés en diagramme à barres et en cascade pour l\'analyse spectrale.',
 labIntro: 'Générez du trafic radio simulé pour explorer le fonctionnement du scanner de spectre.',
 genTraffic: 'Générer du trafic', burst: 'Mode rafale', clearSpectrum: 'Effacer spectre', exportCapture: 'Exporter capture',
 labTask1Title: '1. Générer du trafic', labTask1Desc: 'Cliquez sur "Générer du trafic" pour injecter des paquets sur des canaux aléatoires.',
 labTask2Title: '2. Observer le spectre', labTask2Desc: 'Observez comment le diagramme à barres montre les niveaux d\'activité.',
 labTask3Title: '3. Décoder les paquets', labTask3Desc: 'Vérifiez la liste des paquets capturés pour les données hex et le texte décodé.',
 labTask4Title: '4. Exporter la capture', labTask4Desc: 'Sauvegardez les paquets capturés comme fichier texte pour analyse.',
 challengeIntro: 'Testez vos compétences radio ! Relevez ces défis pour devenir analyste de spectre.',
 ch1Title: 'Défi 1 : Trouver le message caché', ch1Desc: 'Un message secret est transmis sur un canal spécifique. Utilisez Auto Scan pour le trouver.',
 ch1Btn: 'Commencer', ch1Pending: 'En attente', ch1Complete: 'Terminé !',
 ch2Title: 'Défi 2 : Identifier le canal le plus actif', ch2Desc: 'Générez du trafic et trouvez quel canal a la plus forte activité.',
 ch2Btn: 'Commencer', ch2Pending: 'En attente', ch2Complete: 'Terminé !',
 ch3Title: 'Défi 3 : Décoder la transmission', ch3Desc: 'Un message encodé utilise un décalage de lettres (chiffre de César). Capturez-le et déchiffrez-le !',
 ch3Btn: 'Commencer', ch3Pending: 'En attente', ch3Complete: 'Terminé !',
 activityLog: 'Journal', eventsMsg: 'Événements et messages',
 clear: 'Effacer', copy: 'Copier', theme: 'Thème',
 settings: '⚙️ Paramètres', language: 'Langue',
 helpSettings: '❓ Aide & Paramètres', settingsTab: '⚙️',
 help: '❓ Aide', faq: 'FAQ', howto: 'Guide', wiki: 'Wiki',
 howto_1:'L écran principal affiche la simulation Radio Sniffer. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Select one of 84 radio groups (0-83). Each group operates on',
 ...
 wiki_spectrum_title: '📡 Spectre Radio', wiki_spectrum: 'Le spectre radio est la gamme de fréquences électromagnétiques utilisées pour la communication sans fil. Le micro:bit utilise la bande ISM 2.4GHz.',
 wiki_sniffing_title: '🔍 Sniffing de Paquets', wiki_sniffing: 'Le sniffing de paquets consiste à capturer des paquets de données transmis sur un réseau ou canal radio pour analyse.',
 wiki_groups_title: '📻 Groupes Radio micro:bit', wiki_groups: 'Le micro:bit supporte 84 groupes radio (0-83). Les appareils du même groupe peuvent communiquer. Chaque groupe utilise un décalage de fréquence différent.',
 wiki_hopping_title: '🔀 Saut de Fréquence', wiki_hopping: 'Le saut de fréquence change rapidement la fréquence porteuse parmi plusieurs canaux. Cela améliore la sécurité et réduit les interférences.',
 working: 'En cours…',
 t_mosque: 'Mosquée', t_zellige: 'Zellige', t_andalus: 'Andalous',
 t_riad: 'Riad', t_medina: 'Médina',
 t_space: 'Espace', t_jungle: 'Jungle', t_robot: 'Robot',
 ready: '📻 Radio Sniffer prêt !',
 ...
 themeChanged: '🎨 Thème →',
 scanning: 'Scan du canal', autoScanning: 'Auto-scan en cours...', scanStopped: 'Scan arrêté',
 packetCaptured: 'Paquet capturé', noActivity: 'Aucune activité', trafficGenerated: 'Trafic généré',
 ...
 enterChannel: 'Entrez le numéro du canal le plus actif :', wrongChannel: 'Mauvais canal ! Réessayez.', enterDecoded: 'Entrez le message décodé :', wrongDecode: 'Mauvais décodage ! Réessayez.',sectionCode:'Code Appareil',faq_q1:'Qu\'est-ce que Radio Sniffer ?',faq_a1:'Radio Sniffer est une simulation interactive qui démontre les concepts de analyse spectrale. Scan radio channels and analyze traffic patterns. Tout fonctionne dans votre navigateur — aucun matériel requis. Ajustez les contrôles, observez les résultats et construisez une vraie compréhension par l expérimentation.',faq_q2:'Comment fonctionne la simulation ?',faq_a2:'L\'application modélise un vrai comportement de réseaux. Tu contrôles les entrées et tu observes les sorties changer en temps réel à l\'écran.',faq_q3:'Que font les contrôles ?',faq_a3:'Chaque bouton et curseur modifie un paramètre spécifique. Consulte l\'onglet Guide pour une procédure pas à pas.',faq_q4:'Quelle est la science derrière ?',faq_a4:'Cette application utilise de vrais principes de réseaux. Les mêmes concepts sont utilisés par les professionnels.',faq_q5:'Que dois-je expérimenter ?',faq_a5:'Change un paramètre à la fois et observe l\'effet. Pousse les valeurs à l\'extrême pour voir les limites du système.',faq_q6:'Quel matériel pour la version réelle ?',faq_a6:'La simulation ne nécessite aucun matériel. Pour construire le vrai projet, il te faut BBC micro:bit V2. Voir la section Code Appareil.',faq_q7:'Mes données sont-elles privées ?',faq_a7:'Oui. Tout fonctionne localement dans ton navigateur. Aucune donnée n\'est envoyée, aucun compte nécessaire, et ça marche hors ligne.',faq_q8:'Que découvrir ensuite ?',faq_a8:'Essaie d\'autres applications de cette catégorie. Chacune enseigne un aspect différent de réseaux. Essayez systématiquement : mettez tous les contrôles par défaut, puis changez une variable à la fois. Notez ce qui se passe aux valeurs minimale, médiane et maximale.',demo_s1:'Bienvenue dans Radio Sniffer ! Regarde l\'écran principal — c\'est ici que la simulation de réseaux fonctionne.',demo_s2:'Clique sur Démarrer et regarde la visualisation réagir.',demo_s3:'Essaie d\'ajuster les contrôles. Chaque curseur ou bouton modifie un paramètre spécifique.',demo_s4:'Descends pour voir les données détaillées. Les chiffres et graphiques se mettent à jour en temps réel.',demo_s5:'Bravo ! Maintenant essaie les défis pour tester ta compréhension de réseaux.',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Protocoles réseau',learn1Desc:'Comment les ordinateurs communiquent avec des protocoles. La simulation donne vie à ce concept par la visualisation interactive. Au lieu de le lire dans un livre, vous le voyez se produire en temps réel et contrôlez les variables.',learn1Tag:'Réseau',learn2Title:'Analyse de paquets',learn2Desc:'Comment les données sont découpées en paquets. Ce principe se connecte à de nombreuses applications réelles. Les ingénieurs et chercheurs utilisent ces connaissances quotidiennement.',learn2Tag:'Données',learn3Title:'Scan réseau',learn3Desc:'How to discover devices and services on a network. Essaie les défis pour tester ta compréhension. Les vrais ingénieurs utilisent ces mêmes concepts.',learn3Tag:'Découverte',learn4Title:'Sécurité réseau',learn4Desc:'How to spot and stop network attacks. Compare les résultats avec différents réglages. Les panneaux de données montrent des mesures précises.',learn4Tag:'Sécurité',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Débutant 🟢',learnLevel:'Niveau :',learnTimeVal:'15 min ⏱',learnTime:'Durée :',learnAgeVal:'10+ 🧒',kidTitle:'Pour les Jeunes Explorateurs',kidIntro:'Bienvenue dans Radio Sniffer ! C est comme une expérience scientifique sur ton ordinateur. Tu contrôles une vraie simulation de analyse spectrale — appuie sur les boutons, bouge les curseurs et regarde ce qui se passe. Try changing the controls and watch how Select one of 84 radio groups (0-83). Each group o Rien ne peut casser — tout est une simulation qui tourne en sécurité dans ton navigateur !',kidSafe:'Complètement sûr ! Rien de ce que tu fais ici ne peut casser quoi que ce soit. Tout fonctionne dans ton navigateur comme un jeu.',kidTry:'Appuie sur le gros bouton Démarrer et regarde l\'écran changer. Puis essaie de bouger les curseurs.',kidParent:'Cette appli enseigne des concepts de réseaux par simulation interactive. Adaptée à l\'enseignement STEM en physique, électronique et informatique.',codeTitle:'Code de Démarrage',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'Ce code active la radio du micro:bit sur le groupe 42 à pleine puissance. Quand le bouton A est pressé, il diffuse "HELLO". Tout message reçu défile sur l\'écran LED. Les numéros de groupe fonctionnent comme des canaux.',purpose:'Radio Sniffer : Scan radio channels and analyze traffic patterns. Cette simulation te permet d\'expérimenter au lieu de simplement lire la théorie. Chaque paramètre que tu changes produit des résultats visibles, construisant une vraie intuition du comportement du système.',guideTitle:'Que vois-je à l\'écran ?',guideCanvas:'La zone principale affiche une visualisation en direct de la simulation. Les couleurs et mouvements représentent les données en temps réel.',guideControls:'Les boutons sous l\'écran principal contrôlent la simulation. Démarrer la lance, Arrêter la met en pause, Réinitialiser efface tout.',guideSections:'Sous la carte principale, les sections montrent les données détaillées et l\'analyse. Clique sur les en-têtes pour les déplier.',guideStatus:'Le point coloré en haut à droite montre l\'état. Vert signifie en marche, rouge signifie arrêté.',learnAge:'Âge :',relatedTitle:'\ud83d\udd17 Apps Similaires',related1_name:'Section Principale',related1_desc:'Décrivez votre projet ici',related1_path:'../../31-sdr-iot/sdr-zigbee/index.html',related2_name:'Escape HQ — Salle d\\',related2_desc:'Résolvez des énigmes avec des verrous ESP32 et gadgets micro:bit',related2_path:'../../04-spy-combos/kit-escape-hq/index.html',related3_name:'Atelier DSP',related3_desc:'Chaine DSP: source, filtre, FFT, sortie',related3_path:'../../27-sdr-dsp/sdr-dsp-workbench/index.html',pathTitle:'\ud83d\udee4\ufe0f Parcours',pathPrev_name:'Radio Cartographe — Carte de Signal',pathPrev_path:'../../07-net-microbit/bit-radio-cartographer/index.html',pathNext_name:'',pathNext_path:'',
 printBtn: '🖨️ Imprimer',quizTab:'Quiz',quizTitle:'Testez vos connaissances',quizRetry:'Rejouer',quizCorrect:'Correct !',quizWrong:'Faux !',quizScore:'Score',quiz_q1:'Qui a inventé le code Morse ?',quiz_q1a:'Tesla',quiz_q1b:'Samuel Morse',quiz_q1c:'Edison',quiz_q1d:'Bell',quiz_q1_answer:'1',quiz_q2:'Quelle est la vitesse des ondes radio dans le vide ?',quiz_q2a:'Vitesse du son',quiz_q2b:'Vitesse de la lumière',quiz_q2c:'Moitié de la vitesse de la lumière',quiz_q2d:'Double de la vitesse de la lumière',quiz_q2_answer:'1',quiz_q3:'Combien de LEDs a l\'écran du micro:bit ?',quiz_q3a:'16',quiz_q3b:'25',quiz_q3c:'36',quiz_q3d:'64',quiz_q3_answer:'1',quiz_q4:'Qu\'est-ce que l\'apprentissage automatique ?',quiz_q4a:'Programmer des robots',quiz_q4b:'Systèmes apprenant des données',quiz_q4c:'Calcul manuel',quiz_q4d:'Conception matérielle',quiz_q4_answer:'1',quiz_q5:'En Morse, que représente la lettre E ?',quiz_q5a:'Trait',quiz_q5b:'Un point',quiz_q5c:'Deux points',quiz_q5d:'Point-trait',quiz_q5_answer:'1',realworldTitle:'🌍 Histoires réelles',realworld1:'LIGO a détecté des ondes gravitationnelles en 2015, confirmant la prédiction centenaire d\'Einstein. Les capteurs ont mesuré des distorsions de l\'espace-temps de 10⁻²¹ mètres.',realworld2:'Voyager 1, lancé en 1977, communique depuis 24 milliards de km avec un émetteur de 23 watts. Les signaux prennent plus de 22 heures dans chaque sens.',realworld3:'Le LHC du CERN génère 1 pétaoctet par seconde lors des collisions. En 2012, il a confirmé le boson de Higgs, complétant le Modèle standard de la physique.',experimentTitle:'🔬 Expériences',experiment_1_title:'Mesure de référence',experiment_1:'Réglez tous les contrôles sur les valeurs par défaut et notez les lectures initiales. Ce sont vos mesures de référence. Un bon scientifique établit toujours une référence avant de modifier des variables — cela donne un point de comparaison pour mesurer tous les changements futurs.',experiment_2_title:'Analyse de sensibilité',experiment_2:'Changez un paramètre à sa valeur minimale, notez le résultat, puis réglez-le au maximum. La différence révèle la sensibilité du système à cette variable. En suivi satellite, savoir quels paramètres comptent le plus vous aide à concentrer vos efforts.',experiment_3_title:'Effets d\'interaction',experiment_3:'Après avoir testé les paramètres individuellement, changez-en deux simultanément. L\'effet combiné est-il égal à la somme des effets individuels? Les interactions non linéaires sont courantes en suivi satellite et révèlent la complexité cachée sous des systèmes simples en apparence.',wiki_concept_title:'💡 Concept fondamental',wiki_concept:'Radio Sniffer illustre un concept fondamental en suivi satellite. Cette simulation modélise comment les systèmes réels traitent les signaux, les données ou les phénomènes physiques. L\'idée clé est que des comportements complexes émergent de règles simples appliquées de manière répétée.',wiki_realworld_title:'🌐 Applications réelles',wiki_realworld:'Les principes démontrés dans Radio Sniffer ont des applications directes dans le monde réel. Les professionnels de suivi satellite utilisent ces mêmes concepts quotidiennement. Dans l\'industrie, SDR et du matériel similaire implémentent ces algorithmes dans des systèmes embarqués.',wiki_safety_title:'⚠️ Sécurité et responsabilité',wiki_safety:'Travailler en suivi satellite implique des responsabilités importantes. Opérez toujours dans les limites légales. Cette simulation est conçue pour un usage éducatif sûr — elle ne transmet pas de vrais signaux et n\'accède pas à de vrais réseaux.',proTipTitle:'💡 Conseils de pro',proTip1:'Utilisez un filtre passe-bande avant votre SDR pour rejeter les signaux hors bande. Une station FM proche peut désensibiliser votre récepteur.',proTip2:'Enregistrez d\x27abord les données IQ brutes, analysez ensuite. Vous pouvez toujours retraiter les fichiers IQ sauvegardés avec différents réglages.',funFactTitle:'🎯 Le saviez-vous ?',funFact:'La foudre atteint 30 000°C — cinq fois plus chaud que la surface du Soleil. Chaque éclair transporte assez d\x27énergie pour griller 100 000 tranches de pain.',mistakeTitle:'⚠️ Erreurs courantes',mistake1:'Changer plusieurs paramètres à la fois rend impossible l\x27isolation de la cause et de l\x27effet. Changez toujours UNE seule variable à la fois.',mistake2:'Sauter la mesure de référence. Sans connaître le comportement par défaut, vous ne pouvez pas mesurer l\x27impact de vos changements.',mistake3:'Ignorer le journal d\x27activité. Il enregistre chaque événement avec des horodatages — essentiel pour comprendre les séquences.'},
 wiki_history_title: '📜 Histoire de analyse spectrale',
 wiki_history: 'Guglielmo Marconi transmitted the first transatlantic radio signal in 1901. Radio evolved from spark-gap transmitters to modern software-defined radios. Radio Sniffer s appuie sur ces fondations pour vous permettre d explorer ces concepts historiques par simulation interactive.',
 wiki_math_title: '📐 Mathématiques de Radio Sniffer',
 wiki_math: 'Les mathématiques derrière Radio Sniffer : The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance. Spectral density (W/Hz) measures power distribution across frequencies. The FFT algorithm converts time-domain samples to frequency-domain in O(N·log N) operations. Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time.',
 wiki_advanced_title: '🔬 Techniques avancées',
 wiki_advanced: 'Au-delà des bases de cette simulation, les praticiens avancés de analyse spectrale utilisent des techniques sophistiquées. Les algorithmes adaptatifs ajustent automatiquement les paramètres. L apprentissage automatique classifie les signaux avec précision. La corrélation multi-canaux détecte des motifs invisibles à l analyse mono-canal. Les réseaux de capteurs distribués combinent les données de plusieurs emplacements.',
 wiki_compare_title: '⚖️ Comparaison des approches',
 wiki_compare: 'Il existe plusieurs approches pour analyse spectrale. Les solutions matérielles avec HackRF SDR offrent des performances en temps réel. Les simulations logicielles (comme cette app) permettent une expérimentation sûre sans coût de matériel. Les plateformes cloud offrent une évolutivité mais introduisent latence et préoccupations de confidentialité. Cette simulation vous donne les bases pour utiliser efficacement toute approche.',
 wiki_debug_title: '🔧 Guide de dépannage',
 wiki_debug: 'Problèmes courants en analyse spectrale : (1) Les résultats inattendus proviennent souvent de paramètres incorrects — réinitialisez et modifiez une variable à la fois. (2) Si la visualisation semble gelée, vérifiez que la simulation tourne. (3) Les lectures erratiques indiquent des interférences. (4) Vérifiez vos unités (Hz vs kHz vs MHz). Le débogage systématique est une compétence essentielle.',
 wiki_ethics_title: '⚖️ Éthique et aspects légaux',
 wiki_ethics: 'Analyse spectrale implique des responsabilités éthiques et légales importantes. De nombreux pays réglementent l utilisation de HackRF SDR. Obtenez toujours une autorisation avant de tester des systèmes que vous ne possédez pas. Respectez les lois sur la vie privée et la protection des données. Cette simulation est conçue à des fins éducatives — elle démontre des principes sans transmettre de signaux réels ni accéder à de vrais réseaux.',
 gloss1_term: 'Bandwidth',
 gloss1_def: 'The range of frequencies a signal occupies. Wider bandwidth allows more data but requires more spectrum. Measured in Hz (kHz, MHz, GHz).',
 gloss2_term: 'Spectral Density',
 gloss2_def: 'Power distribution across frequencies, measured in watts per hertz. Shows how signal energy is spread across the spectrum — peaks indicate active transmissions.',
 ...
 title: 'Radio Sniffer', subtitle: '📻 مسح · 📡 التقاط · 🔍 تحليل',
 disconnected: 'غير متصل', connected: 'متصل',
 mainSection: 'متتبع الراديو — ماسح الترددات', mainDesc: 'امسح قنوات الراديو وحلّل أنماط حركة البيانات',
 sectionA: 'كيف يعمل', sectionB: 'المختبر', sectionC: 'التحدي',
 channelLabel: 'قناة', packetsLabel: 'حزمة', signalLabel: 'إشارة',
 startScan: 'بدء المسح', stopScan: 'إيقاف', autoScan: 'مسح تلقائي',
 step1Title: 'اختر القناة', step1Desc: 'اختر واحدة من 84 مجموعة راديو (0-83). كل مجموعة تعمل على تردد مختلف.',
 step2Title: 'استمع للحزم', step2Desc: 'يراقب المتتبع القناة ويلتقط أي حركة راديو يكتشفها. لاحظ كيف تتغير المؤشرات خلال هذه المرحلة. يسجل سجل النشاط كل حدث لتتبع تسلسل العمليات والتحقق من النتائج.',
 step3Title: 'التقط وفك الشفرة', step3Desc: 'يتم التقاط البيانات الخام بتنسيق hex، ثم فك تشفيرها لكشف النص القابل للقراءة.',
 step4Title: 'عرض الطيف', step4Desc: 'تُعرض مستويات النشاط كرسم بياني شريطي وشلال لتحليل الطيف.',
 labIntro: 'أنشئ حركة راديو محاكاة لاستكشاف كيف يعمل ماسح الطيف.',
 genTraffic: 'توليد حركة', burst: 'وضع الدفعة', clearSpectrum: 'مسح الطيف', exportCapture: 'تصدير الالتقاط',
 labTask1Title: '1. توليد حركة', labTask1Desc: 'انقر "توليد حركة" لحقن حزم وهمية على قنوات عشوائية ومشاهدة الطيف يمتلئ.',
 labTask2Title: '2. مراقبة الطيف', labTask2Desc: 'لاحظ كيف يُظهر الرسم البياني مستويات النشاط وكيف يتحرك الشلال لعرض السجل.',
 labTask3Title: '3. فك شفرة الحزم', labTask3Desc: 'تحقق من قائمة الحزم الملتقطة لبيانات hex والنصوص المفكوكة.',
 labTask4Title: '4. تصدير الالتقاط', labTask4Desc: 'احفظ الحزم الملتقطة كملف نصي لمزيد من التحليل أو المشاركة.',
 challengeIntro: 'اختبر مهاراتك في الراديو! أكمل هذه التحديات لتصبح محلل طيف.',
 ch1Title: 'التحدي 1: ابحث عن الرسالة المخفية', ch1Desc: 'رسالة سرية تُبث على قناة محددة. استخدم المسح التلقائي للعثور عليها وفك شفرة النص.',
 ch1Btn: 'ابدأ التحدي', ch1Pending: 'قيد الانتظار', ch1Complete: 'مكتمل!',
 ch2Title: 'التحدي 2: حدد القناة الأكثر نشاطاً', ch2Desc: 'أنشئ حركة وابحث عن القناة ذات أعلى نشاط. أدخل رقم القناة للتحقق.',
 ch2Btn: 'ابدأ التحدي', ch2Pending: 'قيد الانتظار', ch2Complete: 'مكتمل!',
 ch3Title: 'التحدي 3: فك شفرة الإرسال', ch3Desc: 'رسالة مشفرة تستخدم إزاحة الأحرف (شفرة قيصر). التقطها وفك الشفرة!',
 ch3Btn: 'ابدأ التحدي', ch3Pending: 'قيد الانتظار', ch3Complete: 'مكتمل!',
 activityLog: 'سجل النشاط', eventsMsg: 'الأحداث والرسائل',
 clear: 'مسح', copy: 'نسخ', theme: 'المظهر',
 settings: '⚙️ الإعدادات', language: 'اللغة',
 helpSettings: '❓ مساعدة وإعدادات', settingsTab: '⚙️',
 help: '❓ مساعدة', faq: 'أسئلة شائعة', howto: 'كيف تستخدم', wiki: 'ويكي',
 howto_1:'تعرض الشاشة الرئيسية محاكاة Radio Sniffer. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Select one of 84 radio groups (0-83). Each group operates on',
 ...
 wiki_spectrum_title: '📡 طيف الراديو', wiki_spectrum: 'طيف الراديو هو نطاق الترددات الكهرومغناطيسية المستخدمة للاتصال اللاسلكي. يستخدم micro:bit نطاق ISM 2.4GHz.',
 wiki_sniffing_title: '🔍 التقاط الحزم', wiki_sniffing: 'التقاط الحزم هو ممارسة التقاط حزم البيانات المرسلة عبر شبكة أو قناة راديو لتحليلها.',
 wiki_groups_title: '📻 مجموعات راديو micro:bit', wiki_groups: 'يدعم micro:bit 84 مجموعة راديو (0-83). الأجهزة في نفس المجموعة يمكنها التواصل. كل مجموعة تستخدم إزاحة تردد مختلفة.',
 wiki_hopping_title: '🔀 القفز الترددي', wiki_hopping: 'القفز الترددي يبدّل بسرعة تردد الحامل بين عدة قنوات. يحسّن الأمان ويقلل التداخل.',
 working: 'جارٍ…',
 t_mosque: 'مسجد', t_zellige: 'زليج', t_andalus: 'أندلس',
 t_riad: 'رياض', t_medina: 'مدينة',
 t_space: 'فضاء', t_jungle: 'أدغال', t_robot: 'روبوت',
 ready: '📻 متتبع الراديو جاهز!',
 ...
 themeChanged: '🎨 المظهر ←',
 scanning: 'مسح القناة', autoScanning: 'مسح تلقائي جارٍ...', scanStopped: 'توقف المسح',
 packetCaptured: 'تم التقاط حزمة', noActivity: 'لا نشاط', trafficGenerated: 'تم توليد حركة',
 ...
 enterChannel: 'أدخل رقم القناة الأكثر نشاطاً:', wrongChannel: 'قناة خاطئة! حاول مرة أخرى.', enterDecoded: 'أدخل الرسالة المفكوكة:', wrongDecode: 'فك شفرة خاطئ! حاول مرة أخرى.',sectionCode:'كود الجهاز',faq_q1:'ما هو Radio Sniffer؟',faq_a1:'Radio Sniffer هي محاكاة تفاعلية توضح مفاهيم تحليل الطيف. Scan radio channels and analyze traffic patterns. كل شيء يعمل في متصفحك — لا حاجة لأجهزة أو تثبيت. اضبط عناصر التحكم، راقب النتائج، وابنِ فهماً حقيقياً من خلال التجربة.',faq_q2:'كيف تعمل المحاكاة؟',faq_a2:'التطبيق يحاكي سلوكاً حقيقياً في الشبكات. أنت تتحكم في المدخلات وتشاهد المخرجات تتغير في الوقت الفعلي.',faq_q3:'ماذا تفعل أدوات التحكم؟',faq_a3:'كل زر ومنزلق يغيّر معاملاً محدداً. راجع تبويب "كيف تستخدم" للحصول على دليل خطوة بخطوة.',faq_q4:'ما العلم وراء هذا؟',faq_a4:'هذا التطبيق يستخدم مبادئ حقيقية من الشبكات. نفس المفاهيم يستخدمها المحترفون.',faq_q5:'بماذا أجرّب؟',faq_a5:'غيّر معاملاً واحداً في كل مرة وراقب التأثير. ادفع القيم للحدود القصوى لترى حدود النظام.',faq_q6:'ما العتاد المطلوب للنسخة الحقيقية؟',faq_a6:'المحاكاة لا تحتاج عتاداً. لبناء المشروع الحقيقي تحتاج BBC micro:bit V2. راجع قسم كود الجهاز.',faq_q7:'هل بياناتي خاصة؟',faq_a7:'نعم. كل شيء يعمل محلياً في متصفحك. لا تُرسل أي بيانات، لا حاجة لحساب، ويعمل بدون إنترنت.',faq_q8:'ماذا أستكشف بعد ذلك؟',faq_a8:'جرّب تطبيقات أخرى في هذه الفئة. كل تطبيق يعلّم جانباً مختلفاً من الشبكات. جرب بشكل منهجي: اضبط جميع عناصر التحكم على الافتراضي، ثم غير متغيراً واحداً في كل مرة. سجل ما يحدث عند القيم الدنيا والمتوسطة والقصوى.',demo_s1:'مرحباً في Radio Sniffer! انظر إلى الشاشة الرئيسية — هنا تعمل محاكاة الشبكات.',demo_s2:'اضغط بدء وشاهد كيف يتفاعل التصوير المرئي.',demo_s3:'جرّب تعديل أدوات التحكم. كل منزلق أو زر يغيّر معاملاً محدداً.',demo_s4:'انزل للأسفل لرؤية البيانات التفصيلية. الأرقام والرسوم البيانية تتحدث في الوقت الفعلي.',demo_s5:'أحسنت! الآن جرّب قسم التحديات لاختبار فهمك لـالشبكات.',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'بروتوكولات الشبكة',learn1Desc:'كيف تتحدث الحواسيب مع بعضها باستخدام البروتوكولات. تجلب المحاكاة هذا المفهوم إلى الحياة من خلال التصور التفاعلي. بدلاً من القراءة عنه، تراه يحدث في الوقت الفعلي وتتحكم في المتغيرات بنفسك.',learn1Tag:'شبكات',learn2Title:'تحليل الحزم',learn2Desc:'كيف تُقسم البيانات إلى حزم صغيرة تسافر عبر الإنترنت. يرتبط هذا المبدأ بتطبيقات عديدة في العالم الحقيقي. يستخدم المهندسون والباحثون هذه المعرفة يومياً.',learn2Tag:'بيانات',learn3Title:'مسح الشبكة',learn3Desc:'How to discover devices and services on a network. جرّب التحديات لاختبار فهمك. المهندسون الحقيقيون يستخدمون نفس هذه المفاهيم.',learn3Tag:'اكتشاف',learn4Title:'أمن الشبكات',learn4Desc:'How to spot and stop network attacks. قارن النتائج بإعدادات مختلفة لبناء الفهم. لوحات البيانات تعرض قياسات دقيقة.',learn4Tag:'أمان',sectionLearn:'ماذا ستتعلم',learnLevelVal:'مبتدئ 🟢',learnLevel:'المستوى:',learnTimeVal:'15 min ⏱',learnTime:'المدة:',learnAgeVal:'10+ 🧒',kidTitle:'للمستكشفين الصغار',kidIntro:'مرحباً في Radio Sniffer! هذا مثل تجربة علمية على حاسوبك. تتحكم في محاكاة حقيقية لـتحليل الطيف — اضغط الأزرار، حرك المنزلقات وشاهد ما يحدث على الشاشة. Try changing the controls and watch how Select one of 84 radio groups (0-83). Each group o لا شيء يمكن أن ينكسر — كل شيء محاكاة آمنة في متصفحك!',kidSafe:'آمن تماماً! لا شيء تفعله هنا يمكن أن يكسر أي شيء. كل شيء يعمل داخل متصفحك مثل لعبة.',kidTry:'اضغط على زر البدء الكبير وشاهد الشاشة تتغير. ثم جرّب تحريك المنزلقات.',kidParent:'يعلّم هذا التطبيق مفاهيم الشبكات من خلال المحاكاة التفاعلية. مناسب لتعليم STEM في الفيزياء والإلكترونيات وعلوم الحاسوب.',codeTitle:'كود البداية',codeLang:'MicroPython (micro:bit)',codeSnippet:'from microbit import *\\nimport radio\\n\\nradio.on()\\nradio.config(group=42, power=7)\\n\\nwhile True:\\n msg = radio.receive()\\n if msg:\\n display.scroll(msg)\\n if button_a.was_pressed():\\n radio.send("HELLO")\\n display.show(Image.YES)',codeExplain:'يشغّل هذا الكود راديو micro:bit على المجموعة 42 بأقصى طاقة. عند الضغط على الزر A يبث "HELLO". أي رسالة مستلمة تمرر على شاشة LED.',purpose:'Radio Sniffer: Scan radio channels and analyze traffic patterns. هذه المحاكاة تتيح لك التجريب العملي بدلاً من قراءة النظرية فقط. كل معامل تغيّره ينتج نتائج مرئية، مما يبني فهماً حقيقياً لسلوك النظام.',guideTitle:'ماذا أرى على الشاشة؟',guideCanvas:'المنطقة الرئيسية تعرض تصويراً مباشراً للمحاكاة. الألوان والحركة تمثل البيانات المتغيرة في الوقت الفعلي.',guideControls:'الأزرار أسفل الشاشة الرئيسية تتحكم في المحاكاة. بدء يشغلها، إيقاف يوقفها مؤقتاً، إعادة تعيين تمسح كل شيء.',guideSections:'أسفل البطاقة الرئيسية، الأقسام تعرض البيانات التفصيلية والتحليل. انقر على العناوين لطيها أو فتحها.',guideStatus:'النقطة الملونة في أعلى اليمين تُظهر الحالة. أخضر يعني يعمل، أحمر يعني متوقف.',
 wiki_history_title: '📜 تاريخ تحليل الطيف',
 wiki_history: 'Guglielmo Marconi transmitted the first transatlantic radio signal in 1901. Radio evolved from spark-gap transmitters to modern software-defined radios. يبني Radio Sniffer على هذه الأسس ليتيح لك استكشاف هذه المفاهيم التاريخية من خلال المحاكاة التفاعلية.',
 wiki_math_title: '📐 الرياضيات وراء Radio Sniffer',
 wiki_math: 'الرياضيات وراء Radio Sniffer: The Friis transmission equation calculates received power: Pr = Pt·Gt·Gr·(λ/4πd)². Signal strength decreases with the square of distance. Spectral density (W/Hz) measures power distribution across frequencies. The FFT algorithm converts time-domain samples to frequency-domain in O(N·log N) operations. Packet loss probability in a queue follows P(loss) = ρᴺ/(1-ρ) for M/M/1/N queues. Little law: L = λ·W relates queue length to waiting time.',
 wiki_advanced_title: '🔬 تقنيات متقدمة',
 wiki_advanced: 'بما يتجاوز الأساسيات في هذه المحاكاة، يستخدم ممارسو تحليل الطيف المتقدمون تقنيات متطورة. تضبط الخوارزميات التكيفية المعاملات تلقائياً. يصنف التعلم الآلي الإشارات بدقة عالية. يكتشف الارتباط متعدد القنوات أنماطاً غير مرئية للتحليل أحادي القناة. تجمع شبكات الاستشعار الموزعة البيانات من مواقع متعددة.',
 wiki_compare_title: '⚖️ مقارنة الأساليب',
 wiki_compare: 'هناك عدة أساليب في تحليل الطيف. توفر الحلول المادية باستخدام HackRF SDR أداءً في الوقت الفعلي. توفر المحاكاة البرمجية (مثل هذا التطبيق) تجربة آمنة بدون تكلفة المعدات. توفر المنصات السحابية قابلية التوسع لكنها تقدم تأخيراً ومخاوف تتعلق بالخصوصية. تمنحك هذه المحاكاة الأساس لاستخدام أي نهج بفعالية.',
 wiki_debug_title: '🔧 دليل استكشاف الأخطاء',
 wiki_debug: 'مشاكل شائعة في تحليل الطيف: (1) النتائج غير المتوقعة غالباً ما تأتي من إعدادات معاملات غير صحيحة — أعد التعيين وغير متغيراً واحداً في كل مرة. (2) إذا بدت الرسوم المتحركة متجمدة، تأكد أن المحاكاة تعمل. (3) القراءات المتقطعة تشير عادة إلى التداخل. (4) تحقق من وحداتك (هرتز مقابل كيلوهرتز مقابل ميغاهرتز).',
 wiki_ethics_title: '⚖️ الأخلاقيات والاعتبارات القانونية',
 wiki_ethics: 'تحليل الطيف يحمل مسؤوليات أخلاقية وقانونية مهمة. تنظم العديد من الدول استخدام HackRF SDR والمعدات المماثلة. احصل دائماً على إذن مناسب قبل اختبار أنظمة لا تملكها. احترم قوانين الخصوصية وحماية البيانات. هذه المحاكاة مصممة لأغراض تعليمية — تعرض المبادئ دون إرسال إشارات حقيقية أو الوصول لشبكات فعلية.',
 gloss1_term: 'Bandwidth',
 gloss1_def: 'The range of frequencies a signal occupies. Wider bandwidth allows more data but requires more spectrum. Measured in Hz (kHz, MHz, GHz).',
 gloss2_term: 'Spectral Density',
 gloss2_def: 'Power distribution across frequencies, measured in watts per hertz. Shows how signal energy is spread across the spectrum — peaks indicate active transmissions.',
 ...
 theory: 'Radio Sniffer يوضح المبادئ الأساسية في تحليل الطيف. Radio waves are electromagnetic radiation between 3 kHz and 300 GHz. They travel at the speed of light and can reflect, refract, and diffract around obstacles. The electromagnetic spectrum is divided into bands allocated by regulators. Spectrum is a finite resource — efficient use is critical for modern communications. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 faq_q9: 'ما الأخطاء الشائعة التي يجب تجنبها؟',
 faq_a9: 'الخطأ الأكثر شيوعاً هو تغيير معاملات متعددة في وقت واحد مما يجعل فهم السبب والنتيجة مستحيلاً. غير دائماً شيئاً واحداً في كل مرة. خطأ شائع آخر هو تجاهل سجل النشاط — فهو يسجل كل حدث ويساعدك على فهم تسلسل العمليات. أخيراً لا تتخط قسم التحديات: تلك الأسئلة تختبر فهمك الحقيقي للمفاهيم.',
 faq_q10: 'كيف يرتبط هذا بـspectrum analysis في العالم الحقيقي؟',
 faq_a10: 'تحاكي هذه المحاكاة نفس الفيزياء والرياضيات المستخدمة في الأنظمة المهنية. تتوافق المعاملات التي تضبطها مع إعدادات المعدات الحقيقية. تعرض الرسوم البيانية أنماط بيانات مطابقة لما تراه على الأجهزة المهنية. الفرق الرئيسي هو أن هذا يعمل بأمان في متصفحك — تستخدم الأنظمة الحقيقية أجهزة HackRF SDR وقد تتطلب تراخيص قانونية للتشغيل.',
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'القسم الرئيسي',related1_desc:'صِف مشروعك هنا',related1_path:'../../31-sdr-iot/sdr-zigbee/index.html',related2_name:'مقر الهروب — غرفة الهروب التجسسية',related2_desc:'حل الألغاز بأقفال ESP32 وأدوات micro:bit',related2_path:'../../04-spy-combos/kit-escape-hq/index.html',related3_name:'ورشة DSP',related3_desc:'سلسلة DSP: مصدر، مرشح، FFT، مخرج',related3_path:'../../27-sdr-dsp/sdr-dsp-workbench/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'رسام خرائط الراديو — تخطيط الإشارة',pathPrev_path:'../../07-net-microbit/bit-radio-cartographer/index.html',pathNext_name:'',pathNext_path:'',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'من اخترع شيفرة مورس؟',quiz_q1a:'تسلا',quiz_q1b:'صامويل مورس',quiz_q1c:'إديسون',quiz_q1d:'بيل',quiz_q1_answer:'1',quiz_q2:'ما سرعة موجات الراديو في الفراغ؟',quiz_q2a:'سرعة الصوت',quiz_q2b:'سرعة الضوء',quiz_q2c:'نصف سرعة الضوء',quiz_q2d:'ضعف سرعة الضوء',quiz_q2_answer:'1',quiz_q3:'كم عدد مصابيح LED في شاشة micro:bit؟',quiz_q3a:'16',quiz_q3b:'25',quiz_q3c:'36',quiz_q3d:'64',quiz_q3_answer:'1',quiz_q4:'ما هو التعلم الآلي؟',quiz_q4a:'برمجة الروبوتات',quiz_q4b:'أنظمة تتعلم من البيانات',quiz_q4c:'حساب يدوي',quiz_q4d:'تصميم العتاد',quiz_q4_answer:'1',quiz_q5:'في شيفرة مورس، ما يمثل الحرف E؟',quiz_q5a:'شرطة',quiz_q5b:'نقطة واحدة',quiz_q5c:'نقطتان',quiz_q5d:'نقطة-شرطة',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'رصد مرصد ليغو موجات الجاذبية عام 2015 مؤكدًا تنبؤ أينشتاين قبل 100 عام. قاست المستشعرات تشوهات في الزمكان بمقدار 10⁻²¹ متر.',realworld2:'يتواصل المسبار فويجر 1 الذي أُطلق عام 1977 من مسافة 24 مليار كم باستخدام مرسل بقدرة 23 واط. تستغرق الإشارات أكثر من 22 ساعة في كل اتجاه.',realworld3:'يولد مصادم الهادرونات الكبير في سيرن 1 بيتابايت في الثانية أثناء التصادمات. في عام 2012 أكد بوزون هيغز مكملاً النموذج القياسي للفيزياء.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في تتبع الأقمار معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في تتبع الأقمار وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'Radio Sniffer يوضح مفهومًا أساسيًا في تتبع الأقمار. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في Radio Sniffer لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في تتبع الأقمار هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ SDR وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال تتبع الأقمار يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'استخدم مرشح نطاق قبل SDR لرفض الإشارات القوية خارج النطاق. يمكن لمحطة FM قريبة أن تقلل حساسية جهاز الاستقبال.',proTip2:'سجّل بيانات IQ الخام أولاً وحللها لاحقًا. يمكنك دائمًا إعادة معالجة ملفات IQ المحفوظة بإعدادات مختلفة.',funFactTitle:'🎯 هل تعلم؟',funFact:'يصل البرق إلى درجة حرارة 30,000 درجة مئوية — خمس مرات أسخن من سطح الشمس.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
...
/* ═══════ RADIO SNIFFER SIMULATION ═══════ */

const NUM_CHANNELS = 84;
let channelActivity = new Array(NUM_CHANNELS).fill(0);
let waterfallData = [];
const MAX_WATERFALL_ROWS = 40;
let capturedPackets = [];
...
// Challenge state
let challenge1Active = false, challenge1Done = false, challenge1Channel = -1, challenge1Msg = '';
let challenge2Active = false, challenge2Done = false, challenge2BusiestCh = -1;
let challenge3Active = false, challenge3Done = false, challenge3Channel = -1, challenge3Encoded = '', challenge3Decoded = '';

const SAMPLE_MESSAGES = [
 'HELLO', 'MICRO:BIT', 'WORKSHOP', 'DIY', 'SALAM', 'RADIO', 'PING',
 'DATA OK', 'ACK', 'SENSOR 42', 'TEMP 23C', 'LED ON', 'BUTTON A',
 'BISMILLAH', 'ALHAMDULILLAH', 'TEAM ALPHA', 'READY', 'GO', 'STOP'
];

function randomHex(len) {
 let h = '';
 for (let i = 0; i < len; i++) h += Math.floor(Math.random() * 256).toString(16).padStart(2, '0').toUpperCase();
 return h;
}
...
function generatePacket(channel, forceMsg) {
 const hasText = forceMsg || Math.random() < 0.3;
 let hex, decoded;
 if (hasText) {
 const msg = forceMsg || SAMPLE_MESSAGES[Math.floor(Math.random() * SAMPLE_MESSAGES.length)];
 hex = textToHex(msg);
 decoded = msg;
 } else {
 hex = randomHex(Math.floor(Math.random() * 8) + 4);
 decoded = hexToText(hex);
 }
 return { channel, hex, decoded, time: new Date().toLocaleTimeString(), ts: Date.now() };
}

function addPacketToUI(pkt) {
 const list = $('capturedPackets');
 if (!list) return;
 const div = document.createElement('div');
 div.className = 'pkt';
 div.innerHTML = `<span class="pkt-time">${pkt.time}</span><span class="pkt-ch">CH${pkt.channel}</span><span class="pkt-hex">${pkt.hex}</span><span class="pkt-decoded">${pkt.decoded}</span>`;
 list.insertBefore(div, list.firstChild);
 // Keep max 50 packets in view
 while (list.children.length > 50) list.removeChild(list.lastChild);
}

function simulateChannelTraffic() {
 // Randomly add activity to some channels
 for (let i = 0; i < NUM_CHANNELS; i++) {
 channelActivity[i] *= 0.92; // decay
 if (Math.random() < 0.08) {
 channelActivity[i] += Math.random() * 30 + 5;
 }
 }
 // Clamp
 channelActivity = channelActivity.map(v => Math.min(v, 100));
}

function captureOnChannel(ch) {
 if (channelActivity[ch] > 10 || Math.random() < 0.15) {
 const pkt = generatePacket(ch);
 capturedPackets.push(pkt);
 totalPackets++;
 addPacketToUI(pkt);
 const countEl = $('packetCount');
 if (countEl) countEl.textContent = totalPackets;
 const sigEl = $('signalStrength');
 if (sigEl) sigEl.textContent = Math.round(channelActivity[ch]) + '%';
 log(`📡 ${LANG[currentLang].packetCaptured} CH${ch}: ${pkt.hex}`, 'rx');
 playSound('click');
 return pkt;
 }
 return null;
...
function drawSpectrum() {
 ...
 const barW = w / NUM_CHANNELS;
 const barAreaH = h * 0.5;
 const waterfallAreaH = h * 0.5;
 const accent = getComputedStyle(document.documentElement).getPropertyValue('--accent').trim() || '#d4a017';

 // Bar chart (top half)
 for (let i = 0; i < NUM_CHANNELS; i++) {
 const level = channelActivity[i] / 100;
 const barH = level * barAreaH;
 // Color gradient from green to yellow to red based on activity
 const r = Math.min(255, Math.floor(level * 2 * 255));
 const g = Math.min(255, Math.floor((1 - level * 0.5) * 255));
 ctx.fillStyle = `rgb(${r},${g},40)`;
 ctx.fillRect(i * barW, barAreaH - barH, barW - 1, barH);

 // Highlight selected channel
 if (i === selectedChannel) {
 ctx.strokeStyle = accent;
 ctx.lineWidth = 2;
 ctx.strokeRect(i * barW, 0, barW - 1, barAreaH);
 }
 }
 ...
 for (let i = 0; i < NUM_CHANNELS; i += 10) {
 ctx.fillText(i, i * barW + 2, barAreaH - 2);
 }

 // Waterfall (bottom half)
 // Push current activity as a new row
 waterfallData.unshift([...channelActivity]);
 if (waterfallData.length > MAX_WATERFALL_ROWS) waterfallData.pop();

 const rowH = waterfallAreaH / MAX_WATERFALL_ROWS;
 for (let row = 0; row < waterfallData.length; row++) {
 for (let col = 0; col < NUM_CHANNELS; col++) {
 const level = waterfallData[row][col] / 100;
 const alpha = Math.max(0.05, level);
 const intensity = Math.floor(level * 255);
 ctx.fillStyle = `rgba(${intensity}, ${Math.floor(intensity * 0.6)}, ${Math.floor(255 - intensity * 0.5)}, ${alpha})`;
 ctx.fillRect(col * barW, barAreaH + row * rowH, barW - 1, rowH);
 }
 }
 ...
 ctx.lineWidth = 1;
 ctx.beginPath();
 ctx.moveTo(0, barAreaH);
 ctx.lineTo(w, barAreaH);
 ctx.stroke();
}
...
function startScan() {
 ...
 const s = LANG[currentLang];
 setStatus(true);
 log(`📻 ${s.scanning} ${selectedChannel}`, 'info');
 showToast(s.scanning + '' + selectedChannel, 2000);

 scanInterval = setInterval(() => {
 simulateChannelTraffic();
 captureOnChannel(selectedChannel);
 drawSpectrum();
 const chEl = $('currentChannel');
 if (chEl) chEl.textContent = selectedChannel;
 }, 300);
}
...
function stopScan() {
 ...
 setStatus(false);
 const s = LANG[currentLang];
 log(`⏹ ${s.scanStopped}`, 'info');
 showToast(s.scanStopped, 1500);
}
...
function startAutoScan() {
 ...
 setStatus(true);
 const s = LANG[currentLang];
 log(`🔄 ${s.autoScanning}`, 'info');
 showToast(s.autoScanning, 2000);

 let ch = 0;
 autoScanInterval = setInterval(() => {
 selectedChannel = ch;
 const slider = $('channelSelect');
 ...
 // Inject challenge packets if active
 if (challenge1Active && !challenge1Done && ch === challenge1Channel) {
 channelActivity[ch] += 50;
 const pkt = generatePacket(ch, challenge1Msg);
 capturedPackets.push(pkt);
 totalPackets++;
 addPacketToUI(pkt);
 const countEl = $('packetCount');
 if (countEl) countEl.textContent = totalPackets;
 log(`📡 ${s.packetCaptured} CH${ch}: ${pkt.hex} → "${pkt.decoded}"`, 'rx');
 challenge1Done = true;
 const status1 = $('ch1Status');
 if (status1) { status1.textContent = s.ch1Complete || 'Completed!'; status1.className = 'ch-status completed'; }
 log(`🏆 ${s.hiddenMsgFound} "${challenge1Msg}" on CH${challenge1Channel}`, 'success');
 playSound('success');
 }

 if (challenge3Active && !challenge3Done && ch === challenge3Channel) {
 channelActivity[ch] += 40;
 const pkt = generatePacket(ch, challenge3Encoded);
 capturedPackets.push(pkt);
 totalPackets++;
 addPacketToUI(pkt);
 const countEl = $('packetCount');
 if (countEl) countEl.textContent = totalPackets;
 log(`📡 ${s.packetCaptured} CH${ch}: "${challenge3Encoded}" (encoded)`, 'rx');
 }
...
function generateTraffic() {
 const s = LANG[currentLang];
 for (let i = 0; i < 15; i++) {
 const ch = Math.floor(Math.random() * NUM_CHANNELS);
 channelActivity[ch] += Math.random() * 50 + 20;
 if (Math.random() < 0.4) {
 const pkt = generatePacket(ch);
 capturedPackets.push(pkt);
 totalPackets++;
 ...
 if (countEl) countEl.textContent = totalPackets;
 drawSpectrum();
 log(`📡 ${s.trafficGenerated}`, 'success');
 showToast(s.trafficGenerated, 1500);
 playSound('success');
}

function generateBurst() {
 const s = LANG[currentLang];
 // Concentrate heavy traffic on a few channels
 const burstChannels = [];
 for (let i = 0; i < 5; i++) burstChannels.push(Math.floor(Math.random() * NUM_CHANNELS));
 for (const ch of burstChannels) {
 channelActivity[ch] = 80 + Math.random() * 20;
 for (let j = 0; j < 4; j++) {
 const pkt = generatePacket(ch);
 capturedPackets.push(pkt);
 totalPackets++;
 ...
 // Set busiest channel for challenge 2
 if (challenge2Active && !challenge2Done) {
 challenge2BusiestCh = burstChannels.reduce((a, b) => channelActivity[a] >= channelActivity[b] ? a : b);
 }
 const countEl = $('packetCount');
 if (countEl) countEl.textContent = totalPackets;
 drawSpectrum();
 log(`💥 ${s.burstGenerated} (${burstChannels.length} channels)`, 'success');
 showToast(s.burstGenerated, 1500);
 playSound('success');
}

function clearSpectrum() {
 const s = LANG[currentLang];
 channelActivity.fill(0);
 waterfallData = [];
 capturedPackets = [];
 totalPackets = 0;
 const list = $('capturedPackets');
 ...
 drawSpectrum();
 log(`🧹 ${s.spectrumCleared}`, 'info');
 showToast(s.spectrumCleared, 1500);
}

function exportCapture() {
 const s = LANG[currentLang];
 if (capturedPackets.length === 0) { log(`📋 No packets to export`, 'error'); return; }
 const lines = capturedPackets.map(p => `${p.time}\tCH${p.channel}\t${p.hex}\t${p.decoded}`);
 const header = 'Time\tChannel\tHex Data\tDecoded\n';
 const blob = new Blob([header + lines.join('\n')], { type: 'text/plain' });
 const url = URL.createObjectURL(blob);
 const a = document.createElement('a');
 a.href = url;
 a.download = `capture-${new Date().toISOString().slice(0, 10)}.txt`;
 a.click();
 URL.revokeObjectURL(url);
 log(`💾 ${s.captureExported} (${capturedPackets.length} packets)`, 'success');
 playSound('success');
}

// Challenge 1: Hidden message
function startChallenge1() {
 const s = LANG[currentLang];
 challenge1Active = true;
 challenge1Done = false;
 challenge1Channel = Math.floor(Math.random() * NUM_CHANNELS);
 challenge1Msg = 'SALAM FROM MICRO:BIT';
 log(`🏆 ${s.challengeStarted}: Find the hidden message!`, 'info');
 log(`🔍 Hint: Use Auto Scan to sweep all channels`, 'info');
 showToast(s.challengeStarted, 2000);
 const status1 = $('ch1Status');
 if (status1) { status1.textContent = s.ch1Pending || 'Pending'; status1.className = 'ch-status pending'; }
}

// Challenge 2: Busiest channel
function startChallenge2() {
 const s = LANG[currentLang];
 challenge2Active = true;
 challenge2Done = false;
 challenge2BusiestCh = -1;
 log(`🏆 ${s.challengeStarted}: Find the busiest channel!`, 'info');
 log(`💡 Hint: Use Burst Mode in the Lab, then identify the tallest bar`, 'info');
 showToast(s.challengeStarted, 2000);
 const status2 = $('ch2Status');
 if (status2) { status2.textContent = s.ch2Pending || 'Pending'; status2.className = 'ch-status pending'; }

 // Generate burst and then ask for answer
 generateBurst();
 setTimeout(() => {
 if (challenge2Done) return;
 const answer = prompt(s.enterChannel);
 if (answer !== null && parseInt(answer) === challenge2BusiestCh) {
 challenge2Done = true;
 if (status2) { status2.textContent = s.ch2Complete || 'Completed!'; status2.className = 'ch-status completed'; }
 log(`🏆 ${s.busiestFound} CH${challenge2BusiestCh}`, 'success');
 playSound('success');
 } else {
 log(`❌ ${s.wrongChannel} (was CH${challenge2BusiestCh})`, 'error');
 playSound('error');
 }
 }, 2000);
}
...
function startChallenge3() {
 ...
 challenge3Channel = Math.floor(Math.random() * NUM_CHANNELS);
 const shift = Math.floor(Math.random() * 5) + 3;
 challenge3Decoded = 'WORKSHOP DIY';
 challenge3Encoded = caesarEncode(challenge3Decoded, shift);
 log(`🏆 ${s.challengeStarted}: Decode the Caesar cipher!`, 'info');
 log(`🔍 Hint: Letters are shifted by ${shift} positions. Use Auto Scan to find the transmission.`, 'info');
 showToast(s.challengeStarted, 2000);
 const status3 = $('ch3Status');
 if (status3) { status3.textContent = s.ch3Pending || 'Pending'; status3.className = 'ch-status pending'; }

 // After some time, prompt for the decoded message
 setTimeout(() => {
 if (challenge3Done) return;
 const answer = prompt(s.enterDecoded + ` (encoded: "${challenge3Encoded}", shift: ${shift})`);
 if (answer !== null && answer.trim().toUpperCase() === challenge3Decoded) {
 challenge3Done = true;
 if (status3) { status3.textContent = s.ch3Complete || 'Completed!'; status3.className = 'ch-status completed'; }
 log(`🏆 ${s.cipherCracked} "${challenge3Decoded}"`, 'success');
 playSound('success');
 } else {
 log(`❌ ${s.wrongDecode}`, 'error');
 playSound('error');
 }
 }, 5000);
}
...
function initSpectrumCanvas() {
 ...
 spectrumCanvas.width = container.offsetWidth;
 spectrumCanvas.height = container.offsetHeight;
 spectrumCtx = spectrumCanvas.getContext('2d');
 drawSpectrum();

 window.addEventListener('resize', () => {
 if (!spectrumCanvas || !spectrumCanvas.parentElement) return;
...
function initRadioSniffer() {
 ...
 selectedChannel = parseInt(slider.value);
 const chEl = $('currentChannel');
 if (chEl) chEl.textContent = selectedChannel;
 });
 }
 ...
 if (scanBtn) scanBtn.onclick = () => { playSound('click'); startScan(); };
 if (stopBtn) stopBtn.onclick = () => { playSound('click'); stopScan(); };
 if (autoScanBtn) autoScanBtn.onclick = () => { playSound('click'); startAutoScan(); };

 // Lab buttons
 const genBtn = $('genTrafficBtn');
 const burstBtn = $('burstBtn');
 const clearBtn = $('clearSpectrumBtn');
 const exportBtn = $('exportCaptureBtn');
 if (genBtn) genBtn.onclick = () => { playSound('click'); generateTraffic(); };
 if (burstBtn) burstBtn.onclick = () => { playSound('click'); generateBurst(); };
 if (clearBtn) clearBtn.onclick = () => { playSound('click'); clearSpectrum(); };
 if (exportBtn) exportBtn.onclick = () => { playSound('click'); exportCapture(); };

 // Challenge buttons
 const ch1Btn = $('ch1Btn');
 const ch2Btn = $('ch2Btn');
 const ch3Btn = $('ch3Btn');
 if (ch1Btn) ch1Btn.onclick = () => { playSound('click'); startChallenge1(); };
 if (ch2Btn) ch2Btn.onclick = () => { playSound('click'); startChallenge2(); };
 if (ch3Btn) ch3Btn.onclick = () => { playSound('click'); startChallenge3(); };
}
