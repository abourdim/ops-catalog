...
const LANG = {
  en: {
    ...
    themeChanged: '🎨 Theme →',step1Title:'Input Data',step1Desc:'Agent A writes a secret message and enters a shared key.',step2Title:'Train Model',step2Desc:'The message is encrypted using XOR cipher with the shared key.',step3Title:'Classify',step3Desc:'The encrypted message is "dropped" via BLE broadcast into the air.',step4Title:'Evaluate',step4Desc:'Agent B scans, receives the drop, and decrypts with the same key.',sectionCode:'Device Code',faq_q1:'What does this app do?',faq_a1:'It simulates AI-powered radio! 🔬 You get to experiment with machine learning for signals in a safe sandbox.',faq_q2:'How does it work?',faq_a2:'The simulation runs in your browser. It models real machine learning for signals so you can see what happens step by step.',faq_q3:'What should I try first?',faq_a3:'Press the main button and watch! 🎯 Then tweak the settings to see how different parameters change the results.',faq_q4:'What\'s the real science?',faq_a4:'This is real neural networks and radio! The same principles are used by professionals in the field. 🧪',faq_q5:'Can I break it?',faq_a5:'Try the Lab section! Push the parameters to extremes and see what happens. That\'s how scientists discover new things! 💡',faq_q6:'What hardware do I need?',faq_a6:'For the real version, you\'ll need a computer with Python 3. Check the 📦 Device Code section for ready-to-use firmware!',faq_q7:'Is it safe to use?',faq_a7:'Absolutely safe! 🛡️ Everything runs locally in your browser. No internet required, no data leaves your device.',faq_q8:'What should I try next?',faq_a8:'Try Ai Deepfake Voice Detector and Ai Material Identifier Rf! Each teaches something different. 🚀',demo_s1:'Welcome! Let\'s explore this simulation together. Look at the main section above. 🔬',demo_s2:'Click the primary action button to start. Watch the visualization respond in real time! ⚡',demo_s3:'Now change a setting — try a slider or dropdown. See how the output changes? 🔄',demo_s4:'Check the results — the graphs and numbers show what\'s happening under the hood. 📊',demo_s5:'Awesome! 🎉 You\'ve got the basics. Try the Lab section below for deeper experiments!',sectionDemo:'Watch Demo',demoPlay:'Play',demoPause:'Pause',demoPrev:'Prev',demoNext:'Next',learn1Title:'Neural Networks',learn1Desc:'How AI learns patterns from data',learn1Tag:'Machine Learning',learn2Title:'Signal Classification',learn2Desc:'How AI identifies radio signals automatically',learn2Tag:'AI+Radio',learn3Title:'Training & Testing',learn3Desc:'How to teach and evaluate AI models',learn3Tag:'Data Science',learn4Title:'Pattern Recognition',learn4Desc:'How AI finds hidden patterns in noise',learn4Tag:'AI',sectionLearn:'What You Shall Learn',learnLevelVal:'Advanced 🔴',learnLevel:'Level:',learnTimeVal:'30 min ⏱',learnTime:'Time:',learnAgeVal:'14+ 🧒',learnAge:'Ages:'},
  fr: {
    ...LANG_BASE.fr,
    ...
    themeChanged: '🎨 Thème →',step1Title:'Données d\'entrée',step1Desc:'L\'agent A écrit un message secret et entre une clé partagée.',step2Title:'Entraîner le modèle',step2Desc:'Le message est chiffré avec le chiffrement XOR et la clé partagée.',step3Title:'Classifier',step3Desc:'Le message chiffré est "déposé" par diffusion BLE dans les airs.',step4Title:'Évaluer',step4Desc:'L\'agent B scanne, reçoit le drop et déchiffre avec la même clé.',sectionCode:'Code Appareil',faq_q1:'Que fait cette appli ?',faq_a1:'Elle simule AI-powered radio ! 🔬 Tu peux expérimenter avec machine learning for signals en toute sécurité.',faq_q2:'Comment ça marche ?',faq_a2:'La simulation tourne dans ton navigateur. Elle modélise de vrais machine learning for signals.',faq_q3:'Que dois-je essayer ?',faq_a3:'Appuie sur le bouton principal et regarde ! 🎯 Puis change les réglages pour voir l\'effet.',faq_q4:'C\'est quoi la vraie science ?',faq_a4:'C\'est du vrai neural networks and radio ! Les mêmes principes utilisés par les professionnels. 🧪',faq_q5:'Je peux le casser ?',faq_a5:'Essaie le Labo ! Pousse les paramètres à l\'extrême et observe. C\'est comme ça qu\'on découvre ! 💡',faq_q6:'Quel matériel ?',faq_a6:'Pour la version réelle, il te faut a computer with Python 3. Regarde 📦 Code Appareil !',faq_q7:'C\'est sûr ?',faq_a7:'Absolument sûr ! 🛡️ Tout tourne localement. Pas d\'internet requis.',faq_q8:'Que faire ensuite ?',faq_a8:'Essaie Ai Deepfake Voice Detector and Ai Material Identifier Rf ! Chacune enseigne quelque chose de différent. 🚀',demo_s1:'Bienvenue ! Explorons cette simulation ensemble. Regarde la section principale. 🔬',demo_s2:'Clique sur le bouton d\'action pour démarrer. Regarde la visualisation réagir ! ⚡',demo_s3:'Change un réglage — essaie un curseur ou une liste. Tu vois le changement ? 🔄',demo_s4:'Vérifie les résultats — les graphiques montrent ce qui se passe. 📊',demo_s5:'Super ! 🎉 Tu connais les bases. Essaie le Labo pour aller plus loin !',sectionDemo:'Voir la Démo',demoPlay:'Jouer',demoPause:'Pause',demoPrev:'Préc',demoNext:'Suiv',learn1Title:'Neural Networks',learn1Desc:'How AI learns patterns from data',learn1Tag:'Machine Learning',learn2Title:'Signal Classification',learn2Desc:'How AI identifies radio signals automatically',learn2Tag:'AI+Radio',learn3Title:'Training & Testing',learn3Desc:'How to teach and evaluate AI models',learn3Tag:'Data Science',learn4Title:'Pattern Recognition',learn4Desc:'How AI finds hidden patterns in noise',learn4Tag:'AI',sectionLearn:'Ce que tu vas apprendre',learnLevelVal:'Avancé 🔴',learnLevel:'Niveau :',learnTimeVal:'30 min ⏱',learnTime:'Durée :',learnAgeVal:'14+ 🧒',learnAge:'Âge :'},
  ar: {
    ...LANG_BASE.ar,
    ...
    themeChanged: '🎨 المظهر ←',step1Title:'بيانات الإدخال',step1Desc:'العميل أ يكتب رسالة سرية ويدخل مفتاحًا مشتركًا.',step2Title:'تدريب النموذج',step2Desc:'يتم تشفير الرسالة باستخدام شيفرة XOR مع المفتاح المشترك.',step3Title:'تصنيف',step3Desc:'الرسالة المشفرة تُودَع عبر بث BLE في الهواء.',step4Title:'تقييم',step4Desc:'العميل ب يمسح ويستقبل الإيداع ويفك تشفيره بنفس المفتاح.',sectionCode:'كود الجهاز',faq_q1:'ماذا يفعل هذا التطبيق؟',faq_a1:'يحاكي AI-powered radio! 🔬 يمكنك التجربة مع machine learning for signals في بيئة آمنة.',faq_q2:'كيف يعمل؟',faq_a2:'المحاكاة تعمل في متصفحك. تنمذج machine learning for signals حقيقية خطوة بخطوة.',faq_q3:'ماذا أجرب أولاً؟',faq_a3:'اضغط على الزر الرئيسي وشاهد! 🎯 ثم عدّل الإعدادات لترى التأثير.',faq_q4:'ما العلم الحقيقي؟',faq_a4:'هذا neural networks and radio حقيقي! نفس المبادئ المستخدمة من المحترفين. 🧪',faq_q5:'هل يمكنني كسره؟',faq_a5:'جرب المختبر! ادفع المعلمات للحدود القصوى وشاهد. هكذا يكتشف العلماء! 💡',faq_q6:'ما العتاد المطلوب؟',faq_a6:'للنسخة الحقيقية تحتاج a computer with Python 3. تفقد 📦 كود الجهاز!',faq_q7:'هل هو آمن؟',faq_a7:'آمن تماماً! 🛡️ كل شيء يعمل محلياً. لا حاجة للإنترنت.',faq_q8:'ماذا بعد؟',faq_a8:'جرب Ai Deepfake Voice Detector and Ai Material Identifier Rf! كل واحد يعلّم شيئاً مختلفاً. 🚀',demo_s1:'مرحباً! لنستكشف هذه المحاكاة معاً. انظر إلى القسم الرئيسي أعلاه. 🔬',demo_s2:'اضغط زر الإجراء الرئيسي للبدء. شاهد التصور يستجيب! ⚡',demo_s3:'غيّر إعداداً — جرب شريط تمرير أو قائمة منسدلة. هل ترى التغيير؟ 🔄',demo_s4:'تحقق من النتائج — الرسوم البيانية تُظهر ما يحدث. 📊',demo_s5:'رائع! 🎉 أنت تعرف الأساسيات. جرب المختبر للتعمق أكثر!',sectionDemo:'شاهد العرض',demoPlay:'تشغيل',demoPause:'إيقاف',demoPrev:'السابق',demoNext:'التالي',learn1Title:'Neural Networks',learn1Desc:'How AI learns patterns from data',learn1Tag:'Machine Learning',learn2Title:'Signal Classification',learn2Desc:'How AI identifies radio signals automatically',learn2Tag:'AI+Radio',learn3Title:'Training & Testing',learn3Desc:'How to teach and evaluate AI models',learn3Tag:'Data Science',learn4Title:'Pattern Recognition',learn4Desc:'How AI finds hidden patterns in noise',learn4Tag:'AI',sectionLearn:'ماذا ستتعلم',learnLevelVal:'متقدم 🔴',learnLevel:'المستوى:',learnTimeVal:'30 min ⏱',learnTime:'المدة:',learnAgeVal:'14+ 🧒',learnAge:'العمر:'}
};
