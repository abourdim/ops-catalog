...
const LANG = {
  ...
  ar: {
    ...
    themeChanged: '🎨 المظهر ←',step1Title:'بيانات الإدخال',step1Desc:'العميل أ يكتب رسالة سرية ويدخل مفتاحًا مشتركًا.',step2Title:'تدريب النموذج',step2Desc:'يتم تشفير الرسالة باستخدام شيفرة XOR مع المفتاح المشترك.',step3Title:'تصنيف',step3Desc:'الرسالة المشفرة تُودَع عبر بث BLE في الهواء.',step4Title:'تقييم',step4Desc:'العميل ب يمسح ويستقبل الإيداع ويفك تشفيره بنفس المفتاح.',sectionCode:'كود الجهاز',faq_q1:'ماذا يفعل هذا التطبيق؟',faq_a1:'يحاكي AI-powered radio! 🔬 يمكنك التجربة مع machine learning for signals في بيئة آمنة.',faq_q2:'كيف يعمل؟',faq_a2:'المحاكاة تعمل في متصفحك. تنمذج machine learning for signals حقيقية خطوة بخطوة.',faq_q3:'ماذا أجرب أولاً؟',faq_a3:'اضغط على الزر الرئيسي وشاهد! 🎯 ثم عدّل الإعدادات لترى التأثير.',faq_q4:'ما العلم الحقيقي؟',faq_a4:'هذا neural networks and radio حقيقي! نفس المبادئ المستخدمة من المحترفين. 🧪',faq_q5:'هل يمكنني كسره؟',faq_a5:'جرب المختبر! ادفع المعلمات للحدود القصوى وشاهد. هكذا يكتشف العلماء! 💡',faq_q6:'ما العتاد المطلوب؟',faq_a6:'للنسخة الحقيقية تحتاج a computer with Python 3. تفقد 📦 كود الجهاز!',faq_q7:'هل هو آمن؟',faq_a7:'آمن تماماً! 🛡️ كل شيء يعمل محلياً. لا حاجة للإنترنت.',faq_q8:'ماذا بعد؟',faq_a8:'جرب Ai Deepfake Voice Detector and Ai Material Identifier Rf! كل واحد يعلّم شيئاً مختلفاً. 🚀'}
};
