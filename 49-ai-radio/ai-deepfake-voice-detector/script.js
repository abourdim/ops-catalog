...
const LANG = {
  en: {
    ...
    howto_4: 'Click Receive or Scan in the Lab to intercept and decrypt drops.',
  ...
  fr: {
    ...
    howto_4: 'Cliquez Recevoir ou Scanner dans le Labo pour intercepter et déchiffrer.',
  ...
  ar: {
    ...
    howto_4: 'انقر استقبال أو مسح في المختبر لاعتراض وفك تشفير الإيداعات.',
