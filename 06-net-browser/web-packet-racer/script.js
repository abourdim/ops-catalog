...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'ESP Honeypot — Fake Services',related1_desc:'Fake SSH, HTTP, FTP that log every connection',related1_path:'../../05-net-esp32/esp-honeypot/index.html',related2_name:'Signal Ghost — MAC Phantom',related2_desc:'Rapidly switch MAC addresses to appear as hundreds of devices',related2_path:'../../05-net-esp32/esp-signal-ghost/index.html',related3_name:'Dead Drop — BLE Message Transfer',related3_desc:'Encrypt and exchange secret messages via BLE simulation',related3_path:'../../50-civilization-hacks/civ-diy-starlink-tracker/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Play as Eve',pathPrev_path:'../../06-net-browser/web-mitm-sim/index.html',pathNext_name:'Virtual Nmap',pathNext_path:'../../06-net-browser/web-port-scanner/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
