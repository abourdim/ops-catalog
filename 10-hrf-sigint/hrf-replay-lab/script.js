...
const LANG={
 ...
 wiki_math: 'The mathematics behind Replay Lab: Key mathematical tools include Fourier analysis, probability theory, and linear algebra — all demonstrated visually in this simulation.',
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'GPS Spoofing Simulator',related1_desc:'Simulate satellite spoofing and position manipulation',related1_path:'../../54-rf-warfare/rfw-gps-spoofing-sim/index.html',related2_name:'RF Remote Control — Build Your Protocol',related2_desc:'Design custom radio commands to control devices',related2_path:'../../11-hrf-microbit/bit-rf-remote-control/index.html',related3_name:'Meaconing Attack Simulator',related3_desc:'Capture, delay, and rebroadcast navigation signals',related3_path:'../../54-rf-warfare/rfw-meaconing-attack/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Radio Telescope — Hydrogen Line',pathPrev_path:'../../10-hrf-sigint/hrf-radio-telescope/index.html',pathNext_name:'RF Fingerprinter',pathNext_path:'../../10-hrf-sigint/hrf-rf-fingerprinter/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
 ...
 wiki_math: 'Les mathématiques derrière Replay Lab : Les outils mathématiques clés incluent l analyse de Fourier, la théorie des probabilités et l algèbre linéaire.',
 ...
 theory: 'Replay Lab démontre les principes clés de renseignement électronique. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 wiki_math: 'الرياضيات وراء Replay Lab: تشمل الأدوات الرياضية الأساسية تحليل فورييه ونظرية الاحتمالات والجبر الخطي.',
 ...
 theory: 'Replay Lab يوضح المبادئ الأساسية في الاستخبارات الإلكترونية. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
