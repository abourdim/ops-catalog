...
const LANG={
 ...
 glossTitle: '📚 Key Terms',learnAge:'Ages:',relatedTitle:'\ud83d\udd17 Related Apps',related1_name:'Drone Hijacker Sim',related1_desc:'Simulate drone RF link hijacking',related1_path:'../../54-rf-warfare/rfw-drone-hijacker-sim/index.html',related2_name:'Covert Channel',related2_desc:'Embed hidden messages in RF signals',related2_path:'../../13-hrf-spyops/hrf-covert-channel/index.html',related3_name:'RF Remote Control — Build Your Protocol',related3_desc:'Design custom radio commands to control devices',related3_path:'../../11-hrf-microbit/bit-rf-remote-control/index.html',pathTitle:'\ud83d\udee4\ufe0f Learning Path',pathPrev_name:'Signal Hunter',pathPrev_path:'../../10-hrf-sigint/hrf-signal-hunter/index.html',pathNext_name:'Spectrum Wars',pathNext_path:'../../10-hrf-sigint/hrf-spectrum-wars/index.html',
 shortcutsTitle:'⌨️ Keyboard Shortcuts',
 shortcutsInfo:'? = Help, Esc = Close, S = Start, R = Reset, 1-9 = Tabs',
 achieveTitle:'🏆 Achievements',
 achieveExplorer:'Explorer — visited 4+ help tabs',
