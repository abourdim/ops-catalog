...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-0B41FF',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master SDR Zigbee Sniffer \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 howto_1:'The main display shows the Zigbee simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Configure the parameters for SDR Zigbee Sniffer. Choose your',
 ...
 howto_3:'Scroll down to the expandable sections. "Network Analysis" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 gloss1_term: 'Promiscuous Mode',
 gloss1_def: 'A network interface mode that captures all packets on the network segment, not just those addressed to the device. Essential for network monitoring and analysis.',
 gloss2_term: 'Coordinator',
 gloss2_def: 'The Zigbee node that forms the network, assigns addresses, and manages security keys. Every Zigbee network has exactly one coordinator.',
 ...
 theory: 'Zigbee demonstrates key principles from EMC testing. Packet sniffing captures network traffic for analysis. Promiscuous mode lets a network interface capture all packets, not just those addressed to it. Zigbee (IEEE 802.15.4) operates at 2.4 GHz with 250 kbps data rate. Designed for low-power, short-range IoT with mesh networking. Supports up to 65,000 nodes. IoT connects everyday objects to the internet via sensors, processors, and wireless links. Security challenges include limited resources, unpatched firmware, and physical access. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-0B41FF',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez SDR Zigbee Sniffer \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 howto_1:'L écran principal affiche la simulation Zigbee. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for SDR Zigbee Sniffer. Choose your',
 ...
 theory: 'Zigbee démontre les principes clés de tests CEM. Packet sniffing captures network traffic for analysis. Promiscuous mode lets a network interface capture all packets, not just those addressed to it. Zigbee (IEEE 802.15.4) operates at 2.4 GHz with 250 kbps data rate. Designed for low-power, short-range IoT with mesh networking. Supports up to 65,000 nodes. IoT connects everyday objects to the internet via sensors, processors, and wireless links. Security challenges include limited resources, unpatched firmware, and physical access. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Zigbee. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Configure the parameters for SDR Zigbee Sniffer. Choose your',
 ...
 theory: 'Zigbee يوضح المبادئ الأساسية في اختبارات التوافق. Packet sniffing captures network traffic for analysis. Promiscuous mode lets a network interface capture all packets, not just those addressed to it. Zigbee (IEEE 802.15.4) operates at 2.4 GHz with 250 kbps data rate. Designed for low-power, short-range IoT with mesh networking. Supports up to 65,000 nodes. IoT connects everyday objects to the internet via sensors, processors, and wireless links. Security challenges include limited resources, unpatched firmware, and physical access. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
