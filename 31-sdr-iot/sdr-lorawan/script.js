...
const LANG = {
 ...
 missionTitle:'MISSION BRIEFING',missionClassified:'CLASSIFIED',missionObjective:'Your mission objective:',missionAgent:'AGENT-68E668',missionSkip:'Skip',missionGo:'ACCEPT MISSION',mission_obj:'Explore and master SDR LoRaWAN Decoder \u2014 analyze, experiment, and complete all challenges.',nightVisionTitle:'Night Vision Mode',nightVisionOn:'NV ON',nightVisionOff:'NV OFF',nightVisionAuto:'Auto NV',
 ...
 howto_1:'The main display shows the Lorawan simulation. At the top you see the live visualization — colors and animations represent real data changing in real time. Below it, the control panel has buttons and sliders that each adjust a specific parameter. Start by looking at how Configure the parameters for SDR LoRaWAN Decoder. Choose you',
 ...
 howto_3:'Scroll down to the expandable sections. "Packet Analysis" shows detailed measurements and charts that update in real time. Click section headers to expand or collapse them. The data here helps you understand what the visualization is showing.',
 ...
 gloss2_term: 'Spreading Factor',
 gloss2_def: 'A LoRa parameter (SF7-SF12) that controls the chirp rate. Higher SF means more chips per bit — longer range and better noise immunity at the cost of slower data rate.',
 ...
 theory: 'Lorawan demonstrates key principles from EMC testing. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. LoRa uses chirp spread spectrum modulation for long-range (10+ km), low-power communication. LoRaWAN adds a network layer for managing IoT devices. IoT connects everyday objects to the internet via sensors, processors, and wireless links. Security challenges include limited resources, unpatched firmware, and physical access. The simulation models these real-world mechanisms using mathematical equations running in your browser. Every control maps to a real parameter that engineers tune in professional settings. By experimenting here, you build the same intuition that professionals develop through years of hands-on experience.',
 ...
 missionTitle:'BRIEFING DE MISSION',missionClassified:'CLASSIFI\xc9',missionObjective:'Objectif de mission :',missionAgent:'AGENT-68E668',missionSkip:'Passer',missionGo:'ACCEPTER LA MISSION',mission_obj:'Explorer et ma\xeetrisez SDR LoRaWAN Decoder \u2014 analysez, exp\xe9rimentez et compl\xe9tez tous les d\xe9fis.',nightVisionTitle:'Mode Vision Nocturne',nightVisionOn:'VN ON',nightVisionOff:'VN OFF',nightVisionAuto:'VN Auto',
 ...
 howto_1:'L écran principal affiche la simulation Lorawan. En haut, la visualisation en direct — les couleurs et animations représentent des données réelles changeant en temps réel. En dessous, le panneau de contrôle a des boutons et curseurs qui ajustent chaque paramètre. Start by looking at how Configure the parameters for SDR LoRaWAN Decoder. Choose you',
 ...
 theory: 'Lorawan démontre les principes clés de tests CEM. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. LoRa uses chirp spread spectrum modulation for long-range (10+ km), low-power communication. LoRaWAN adds a network layer for managing IoT devices. IoT connects everyday objects to the internet via sensors, processors, and wireless links. Security challenges include limited resources, unpatched firmware, and physical access. La simulation modélise ces mécanismes à l aide d équations mathématiques dans votre navigateur. Chaque contrôle correspond à un paramètre réel. En expérimentant ici, vous développez l intuition que les professionnels acquièrent après des années d expérience pratique.',
 ...
 howto_1:'تعرض الشاشة الرئيسية محاكاة Lorawan. في الأعلى ترى التصور المباشر — الألوان والرسوم المتحركة تمثل بيانات حقيقية تتغير في الوقت الفعلي. أسفلها لوحة التحكم بها أزرار ومنزلقات تضبط كل معامل. Start by looking at how Configure the parameters for SDR LoRaWAN Decoder. Choose you',
 ...
 theory: 'Lorawan يوضح المبادئ الأساسية في اختبارات التوافق. A packet is a formatted unit of data with headers (addressing, control) and payload (actual data). Packet switching enables efficient sharing of network resources. LoRa uses chirp spread spectrum modulation for long-range (10+ km), low-power communication. LoRaWAN adds a network layer for managing IoT devices. IoT connects everyday objects to the internet via sensors, processors, and wireless links. Security challenges include limited resources, unpatched firmware, and physical access. تحاكي هذه المحاكاة الآليات الحقيقية باستخدام معادلات رياضية في متصفحك. كل عنصر تحكم يتوافق مع معامل حقيقي. بالتجربة هنا تبني نفس الحدس الذي يطوره المحترفون عبر سنوات من الخبرة العملية.',
 ...
 glossTitle: '📚 مصطلحات أساسية',learnAge:'العمر:',relatedTitle:'\ud83d\udd17 تطبيقات ذات صلة',related1_name:'عباءة RF',related1_desc:'محاكاة إخفاء الإشارات وقفز الترددات',related1_path:'../../13-hrf-spyops/hrf-rf-cloak/index.html',related2_name:'صياد التداخل',related2_desc:'تحديد وتوطين مصادر التداخل الراديوي',related2_path:'../../30-sdr-science/sdr-rfi-hunter/index.html',related3_name:'شلال طيف Chirp المنتشر',related3_desc:'ESP32 LoRa يرسل لمسافات كيلومترات',related3_path:'../../12-hrf-esp32/esp-lora-lab/index.html',pathTitle:'\ud83d\udee4\ufe0f مسار التعلم',pathPrev_name:'القسم الرئيسي',pathPrev_path:'../../31-sdr-iot/sdr-keyfob/index.html',pathNext_name:'القسم الرئيسي',pathNext_path:'../../31-sdr-iot/sdr-smart-meter/index.html',
 printBtn: '🖨️ طباعة',quizTab:'اختبار',quizTitle:'اختبر معلوماتك',quizRetry:'إعادة',quizCorrect:'صحيح!',quizWrong:'خطأ!',quizScore:'النتيجة',quiz_q1:'ماذا تعني SDR؟',quiz_q1a:'مرحل بيانات الإشارة',quiz_q1b:'الراديو المعرف بالبرمجيات',quiz_q1c:'مستقبل رقمي آمن',quiz_q1d:'معدل بيانات قياسي',quiz_q1_answer:'1',quiz_q2:'في شيفرة مورس، ما يمثل الحرف E؟',quiz_q2a:'شرطة',quiz_q2b:'نقطة واحدة',quiz_q2c:'نقطتان',quiz_q2d:'نقطة-شرطة',quiz_q2_answer:'1',quiz_q3:'ما الذي يستبدله SDR بالبرمجيات؟',quiz_q3a:'الهوائي',quiz_q3b:'مكونات الراديو المادية',quiz_q3c:'مصدر الطاقة',quiz_q3d:'الشاشة',quiz_q3_answer:'1',quiz_q4:'كيف تبدو SOS بشيفرة مورس؟',quiz_q4a:'---...---',quiz_q4b:'...---...',quiz_q4c:'...-...-',quiz_q4d:'-.-.-.',quiz_q4_answer:'1',quiz_q5:'ماذا تعني AI؟',quiz_q5a:'إدخال آلي',quiz_q5b:'الذكاء الاصطناعي',quiz_q5c:'واجهة تناظرية',quiz_q5d:'تكامل نشط',quiz_q5_answer:'1',realworldTitle:'🌍 قصص واقعية',realworld1:'في عام 2017 جعل انتحال GPS في البحر الأسود أكثر من 20 سفينة تعتقد أنها على بعد 25 ميلاً داخل البر في مطار.',realworld2:'في عام 2015 أثبت باحثون أن جهاز SDR بقيمة 20 دولارًا يمكنه تتبع كل طائرة في النطاق عبر فك تشفير إشارات ADS-B غير المشفرة.',realworld3:'دمرت دودة ستكسنت (2010) ألف جهاز طرد مركزي نووي إيراني من خلال التلاعب بوحدات التحكم المنطقية عبر أقراص USB مصابة.',experimentTitle:'🔬 تجارب',experiment_1_title:'القياس المرجعي',experiment_1:'اضبط جميع عناصر التحكم على القيم الافتراضية وسجّل القراءات الأولية. هذه هي قياساتك المرجعية. يقوم العالم الجيد دائمًا بتحديد خط الأساس قبل تغيير المتغيرات — فهو يمنحك نقطة مرجعية لقياس جميع التغييرات المستقبلية.',experiment_2_title:'تحليل الحساسية',experiment_2:'غيّر معلمة واحدة إلى قيمتها الدنيا وسجّل النتيجة ثم اضبطها على الحد الأقصى. يكشف الفرق عن حساسية النظام لهذا المتغير. في أنظمة الرادار معرفة المعلمات الأكثر أهمية تساعدك على تركيز جهودك بكفاءة.',experiment_3_title:'تأثيرات التفاعل',experiment_3:'بعد اختبار المعلمات بشكل فردي غيّر اثنتين في وقت واحد. هل التأثير المشترك يساوي مجموع التأثيرات الفردية؟ التفاعلات غير الخطية شائعة في أنظمة الرادار وتكشف التعقيد الخفي تحت أنظمة تبدو بسيطة.',wiki_concept_title:'💡 المفهوم الأساسي',wiki_concept:'SDR LoRaWAN Decoder يوضح مفهومًا أساسيًا في أنظمة الرادار. تحاكي هذه المحاكاة كيفية معالجة الأنظمة الحقيقية للإشارات والبيانات أو الظواهر الفيزيائية. الفكرة الرئيسية هي أن السلوكيات المعقدة تنشأ من قواعد بسيطة تُطبق بشكل متكرر.',wiki_realworld_title:'🌐 التطبيقات الواقعية',wiki_realworld:'المبادئ المعروضة في SDR LoRaWAN Decoder لها تطبيقات مباشرة في العالم الحقيقي. يستخدم المحترفون في أنظمة الرادار هذه المفاهيم نفسها يوميًا. في الصناعة يُنفذ HackRF وأجهزة مماثلة هذه الخوارزميات في أنظمة مدمجة.',wiki_safety_title:'⚠️ السلامة والمسؤولية',wiki_safety:'العمل في مجال أنظمة الرادار يحمل مسؤوليات مهمة. تعمل دائمًا ضمن الحدود القانونية. هذه المحاكاة مصممة للاستخدام التعليمي الآمن — لا ترسل إشارات حقيقية ولا تصل إلى شبكات حقيقية.',proTipTitle:'💡 نصائح احترافية',proTip1:'قم بمعايرة انحراف التردد في HackRF باستخدام إشارة معروفة. معظم الوحدات بها خطأ كريستال من 1-20 جزء في المليون.',proTip2:'استخدم دائمًا مضخم ضوضاء منخفض خارجي لاستقبال الإشارات الضعيفة. يتميز المضخم المدمج في HackRF بعامل ضوضاء عالٍ.',funFactTitle:'🎯 هل تعلم؟',funFact:'الشمس هي أقوى مصدر راديوي في سمائنا. يمكن للانفجارات الشمسية تعطيل اتصالات HF في جميع أنحاء العالم لساعات.',mistakeTitle:'⚠️ أخطاء شائعة',mistake1:'تغيير عدة معلمات في وقت واحد يجعل من المستحيل عزل السبب والنتيجة. غيّر دائمًا متغيرًا واحدًا فقط في كل مرة.',mistake2:'تخطي القياس المرجعي. بدون معرفة السلوك الافتراضي لا يمكنك قياس تأثير تغييراتك على النظام.',peerTitle:'👥 \u0648\u0636\u0639 \u0627\u0644\u0646\u0638\u064a\u0631',peerConnect:'\u0627\u062a\u0635\u0627\u0644',peerDisconnect:'\u0642\u0637\u0639',peerStatus:'\u062d\u0627\u0644\u0629 \u0627\u0644\u0646\u0638\u064a\u0631',peerSend:'\u0623\u0631\u0633\u0644',peerReceive:'\u0627\u0633\u062a\u0644\u0645',peerInfo:'\u0627\u0641\u062a\u062d \u0647\u0630\u0627 \u0627\u0644\u062a\u0637\u0628\u064a\u0642 \u0641\u064a \u062a\u0628\u0648\u064a\u0628\u064a\u0646 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629',heatmapTitle:'📅 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0646\u0634\u0627\u0637',heatmapToday:'\u0627\u0644\u064a\u0648\u0645',heatmapStreak:'\u0633\u0644\u0633\u0644\u0629',heatmapTotal:'\u0627\u0644\u0645\u062c\u0645\u0648\u0639',heatmapLegend:'\u0623\u0642\u0644 \u2192 \u0623\u0643\u062b\u0631',mistake3:'تجاهل سجل النشاط. يسجل كل حدث مع طوابع زمنية — ضروري لفهم التسلسلات وتصحيح النتائج غير المتوقعة.'}
